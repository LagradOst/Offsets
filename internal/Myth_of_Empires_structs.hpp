...
struct FMsgClientSetCheatAdminLevel {
...
struct FItemAuctionSellRowBase {
...
struct FMsgRecord_StructureBannerCreate {
...
struct FMsgClientGetOccupyDetailInfo {
	TArray<FOccupyDetailInfo> OccupyDetailInfos; // 0x8
};

struct FMsgRecord_Drop {
	FString PlayerName; // 0x10
	FVector Location; // 0x20
};
...
struct FNotifyDisplayInfoRowBase {
...
struct FMsgClientAppearanceData {
	int32_t Result; // 0x8
	bool bInBattle; // 0xc
...
struct FMsgRecord_StructureBannerEffectOwner {
...
struct FGivePerkMiniMapPOIData {
...
struct FMsgRecord_LoseXianChengOwner {
...
struct FMsgClientServerInfo {
	TArray<FGameServerInfo> GameServerInfoList; // 0x8
};

struct FMsgServerSystem {
...
struct FPlayerStartLocalizationRowBase {
...
struct FStructureCheckVolumeLocalizationRowBase {
...
struct FSGAnimNode_SpineSolver {
...
struct FMsgClientSetDeviceIdResult {
...
struct FNews_OccupyProtectSetting {
...
struct FWeatherControlLocalizationConfig {
...
struct FHuangLiEffectNameDetail {
...
struct FSGAnimNode_LayeredBoneBlend {
...
struct FBaoZangPositionRowBase {
...
struct FDBLogSwitchDefaultSetting {
...
struct FItemStrengthenProperty {
	int32_t Level; // 0x8
...
struct FRegionRespawnPointConfig {
...
struct FMsgClientCreateRoleResult {
	int32_t Result; // 0x8
	FString AccountID; // 0x10
	FString RoleID; // 0x20
...
struct FWeatherLinearColorTrack {
...
struct FGuildSkillRequireConfig {
	ESkillType SkillType; // 0x8
...
struct FMsgRecord_GuildWillDead {
	EAttackerType AttackerType; // 0x10
	FString AttackerOwnerName; // 0x18
	FString AttackerName; // 0x28
	bool IsAttackerInGuild; // 0x38
...
struct FMsgRecord_GetXianChengOwner {
...
struct FMsgClientServerErrorMessage {
	FString Msg; // 0x8
};
...
struct FSessionNameLocalization {
...
struct FMsgClientEnterLogicServerResult {
...
struct FNews_GetRankReward_Activity {
...
struct FMsgClientServerPassportMessage {
...
struct FMsgServerGetOccupyDetailInfo {
...
struct FMsgClientCheckDeviceIdResult {
...
struct FItemTransportPriceRowBase {
...
struct FMsgServerEnterLogicServer {
...
struct FCharacterLimitSkillLevel {
...
struct FMsgClientDeleteRoleResult {
	int32_t Result; // 0x8
...
struct FMsgServerCancelPlayerQueue {
...
struct FMsgRecord_StructureBannerEffectOther {
	FString OtherGuildName; // 0x10
	int32_t EffectPrestigeValue; // 0x20
};
...
struct FStructureMiniMapPOIStyle {
...
struct FCharacterAppearanceTemplate {
	FString Description; // 0x8
...
struct FAnimalFurRelationTableRow {
...
struct FAnimalSpeciesItemTable {
...
struct FGuildStructureShowData {
...
struct FScalabilitySettingsConfig {
...
struct FNPCDeathExtraDropItemTable {
...
struct FMsgClientGetOfficialSealInfos {
...
struct FNews_TerritoryFlagInvalidation {
...
struct FCustomSoundSettingGroup {
	FCustomSoundSettingArray SoundSetting[0x2]; // 0x8
};
...
struct FKongmingLanternRowBase {
...
struct FAchievementDamageMultiplyData {
	TSoftObjectPtr<UTexture2D> IconTexture; // 0x8
...
struct FGuanAiActivityUIJunInfo {
