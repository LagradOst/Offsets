...
struct ABP_WindowFrameWallBase_C {
	UBP_BuildJointComponent_C* WindowSocket; // 0x8e0
};

struct ABP_StairLBuildPart_C {
	UBP_BuildJointComponent_C* Bolt; // 0x860
};

struct AMeleeWeaponBase {
	float Range; // 0x5b8
...
struct UWBP_Radiogram_6010109_C {
...
struct UBTService_DetactingTarget_C {
...
struct UWBP_Function_Equipment_C {
...
struct URMHttpRequest_Post_Dedi_ListInfos {
...
struct ABP_WindowBuildPartBase_C {
...
struct ABP_BeckenRangeAttackActor_C {
...
struct UMachineArm_01_SK_Skeleton_AnimBlueprint_C {
...
struct ABP_NPCSpawnerByLandmarkStatus_C {
...
struct UInventoryComponentBase {
...
struct UBP_SkillActionTaskBase_C {
...
struct UFacility_Pannel_SK_Skeleton_AnimBlueprint_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	FAnimNode_Root AnimGraphNode_Root; // 0x2c8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x2f8
	bool Connect; // 0x340
...
struct UBTService_StressReducer_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x98
...
struct UBP_HealingFactor_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x40
	float HealingFactor; // 0x48
};

struct ABP_EscapeRocket_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x220
...
struct UWBP_Main_CraftingListing_C {
...
struct ABP_HologramTrap_SquareCeiling_C {
...
struct UWBP_Radiogram_1010101_C {
...
struct UWBP_Objective_SupplyDrop_C {
...
struct UWBP_Radiogram_6010219_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x298
	UTextBlock* TextBlock; // 0x2a0
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x2a8
	UWBP_RadiogramListing_C* WBP_RadiogramListing_2; // 0x2b0
...
struct UCloudWatchLogsDescribeSubscriptionFilters {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UWBP_Radiogram_6010211_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x298
	UTextBlock* TextBlock; // 0x2a0
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x2a8
	UWBP_RadiogramListing_C* WBP_RadiogramListing_2; // 0x2b0
...
struct UCustomizableObjectInstance {
...
struct UBTTask_ResetAIPerception_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
};
...
struct ABP_EarthDecreaseDecayEffect_C {
...
struct UCloudWatchDeleteInsightRules {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct ULowEntryLatentActionString {
	bool Finished; // 0x28
	FString Result; // 0x30
...
struct USurvivalVehicleSyncComponent {
...
struct ABP_InventorySaveSystem_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x220
...
struct ABP_ThrownFragGrenade_C {
...
struct UBP_WoodResourceFoliageComponent_C {
...
struct UWBP_Main_Ranking_Description_C {
	UWBP_MainFrame_C* BP_UI_Frame; // 0x260
	UImage* Image; // 0x268
...
struct UCloudWatchLogsListTagsLogGroup {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct ABP_ProcessingFacilityBase_C {
...
struct UWBP_Main_MachineArmListing_L_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UBTService_Juggernaut_Junior_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x98
...
struct ABP_GeometryDamageZone_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x220
	USceneComponent* DefaultSceneRoot; // 0x228
...
struct UWBP_LandmarkTargetPoint_C {
...
struct UCloudWatchDeleteAlarms {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UWBP_HUD_Held_InteractionListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_Radiogram_4020205_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x260
...
struct ABP_EnterEscapeRocketConsole_C {
...
struct UBTTask_WalkingAttack_Juggernaut_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
...
struct UWBP_Radiogram_6010102_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x298
	UTextBlock* TextBlock; // 0x2a0
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x2a8
	UWBP_RadiogramListing_C* WBP_RadiogramListing_2; // 0x2b0
...
struct UWBP_Scene_Landing_LocationButton_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_Radiogram_4010101_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x260
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x268
	UWBP_RadiogramListing_C* WBP_RadiogramListing_2; // 0x270
	UWBP_RadiogramListing_C* WBP_RadiogramListing_3; // 0x278
...
struct UMaverick_SK_Skeleton_AnimBlueprint_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	FAnimNode_Root AnimGraphNode_Root; // 0x2c8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x2f8
};
...
struct UBP_ObjectiveBroadcaster_C {
...
struct ABP_OceanologyAdvanced_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x220
...
struct UBP_SurvivalGameViewportClient_C {
...
struct UBTDecorator_IsFalling_C {
...
struct USurvivalGameUserSettings {
...
struct UWBP_HUD_CompassMarker_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_Functionality_TransferTerrasite_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x270
...
struct UCommonAI_BTTask_SetWalkSpeed_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	float SpeedRatio; // 0xb0
};

struct USurvivalAIStateMachine_Relax {
...
struct UWBP_Functionality_ConsoleListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ABP_InteractionableActor_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x220
...
struct UBTService_PlayerReactionForBoss_C {
...
struct UWBP_AdminUserManagement_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ABP_ElectricTrap_AttachFloorBuildPart_C {
...
struct UCloudWatchDescribeAnomalyDetectors {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UWBP_Functionality_Turret_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x270
...
struct UCommonAI_BTTask_ReportNoise_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
...
struct UBTTask_SetIgnoreNearPlayer_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
...
struct ABP_SurvivalPlayerController_C {
...
struct USpitter_SK_Skeleton_AnimBlueprint_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	FAnimNode_Root AnimGraphNode_Root; // 0x2c8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x2f8
};

struct ABP_ThrownFlareDisc_C {
...
struct ULowEntryLatentActionFloat {
	bool Finished; // 0x28
	float Result; // 0x2c
...
struct UWBP_Radiogram_6010101_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x298
	UTextBlock* TextBlock; // 0x2a0
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x2a8
...
struct UAnimNotify_CameraShake_C {
	USVCameraShake* CameraShake; // 0x38
	bool bPlayOnlyOwner; // 0x40
};

struct UBTService_FriendReaction_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x98
...
struct UWBP_Radiogram_4020301_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x260
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x268
	UWBP_RadiogramListing_C* WBP_RadiogramListing_2; // 0x270
	UWBP_RadiogramListing_C* WBP_RadiogramListing_3; // 0x278
...
struct ABP_SurvivalPlayerState_C {
...
struct URMHttpRequest_Get_Op_Info {
	FMulticastInlineDelegate OnSuccess; // 0x48
	FMulticastInlineDelegate OnFailure; // 0x58
};

struct ABP_LandingPOD_C {
...
struct UBTService_Juggernaut_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x98
	FBlackboardKeySelector TargetActor; // 0xa0
	FBlackboardKeySelector Aggro; // 0xc8
	FBlackboardKeySelector IsRangeAttack; // 0xf0
...
struct UWBP_AdminConsole_UserListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UBorder* Border_1; // 0x268
...
struct UCloudWatchLogsPutRetentionPolicy {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UBP_BuildJointComponent_C {
...
struct UCloudWatchLogsPutResourcePolicy {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct ULowEntryExecutionQueue {
	int32_t Count; // 0x28
	bool Next; // 0x2c
};
...
struct UWBP_ObjectiveCheckbox_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Anim_Checked; // 0x268
...
struct UAN_BeckenPatternAttack_C {
...
struct UWBP_DeathRecapListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UBorder* Border_Frame; // 0x268
...
struct UWBP_HUD_Interaction_Target_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_Main_Radiogram_Description_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_Radiogram_4020206_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x260
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x268
	UWBP_RadiogramListing_C* WBP_RadiogramListing_2; // 0x270
	UWBP_RadiogramListing_C* WBP_RadiogramListing_3; // 0x278
...
struct UWBP_RadiogramCraftingListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UBTTask_MoveBackFromTarget_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
...
struct UCloudWatchLogsStartQuery {
	FMulticastInlineDelegate Callback; // 0x30
};

struct UCloudWatchGetMetricWidgetImage {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UWBP_Radiogram_4020302_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x260
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x268
	UWBP_RadiogramListing_C* WBP_RadiogramListing_2; // 0x270
	UWBP_RadiogramListing_C* WBP_RadiogramListing_3; // 0x278
...
struct UWBP_Main_Radiogram_TreeListing_S_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UBorder* Border_1; // 0x268
...
struct UBTTask_BossGrogging_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
};

struct UAutoResizedWidgetComponent_C {
...
struct USurvivalReplicationGraphConnection {
...
struct UBP_HitCapsule_Compoent_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UWBP_Functionality_ConversionListing_C {
...
struct UFlare_Disc_SK_Skeleton_AnimBlueprint_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	FAnimNode_Root AnimGraphNode_Root; // 0x2c8
...
struct AFieldNPC_BaseCharacter_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xe28
...
struct ABP_SurvivalGameModeForWorldTutorial_C {
...
struct UExtCharacterMovementComponent {
...
struct UWBP_Main_Landmark_RewardListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UImage* Image; // 0x268
...
struct ABP_MaintainConvertBuildParts_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x890
...
struct UWBP_Functionality_TransferTerrasiteList_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ABP_ActorSpawnManager_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x220
	USceneComponent* DefaultSceneRoot; // 0x228
...
struct UCloudWatchPutDashboard {
	FMulticastInlineDelegate Callback; // 0x30
};

struct ABP_CeilingBuildPartBase1_C {
...
struct UCloudWatchLogsStopQuery {
	FMulticastInlineDelegate Callback; // 0x30
};

struct UWBP_Radiogram_6010110_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x298
	UTextBlock* TextBlock; // 0x2a0
...
struct UWBP_Radiogram_4010103_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x260
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x268
	UWBP_RadiogramListing_C* WBP_RadiogramListing_2; // 0x270
	UWBP_RadiogramListing_C* WBP_RadiogramListing_3; // 0x278
...
struct UCommonAI_BTDecorator_CheckTargetSurvivalCharacterDead_C {
	FBlackboardKeySelector KEYTargetActor; // 0xa0
	FBlackboardKeySelector KEYStress; // 0xc8
	bool IsAggro; // 0xf0
};
...
struct URokita_AnimBlueprint_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	FAnimNode_Root AnimGraphNode_Root; // 0x2c8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x2f8
...
struct AInfinityFireAIController {
...
struct UWBP_MapMarker_Landmark_C {
...
struct UBTService_BossPhaseUpdator_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x98
	APawn* MyPawn; // 0xa0
...
struct ACommonAI_BaseAICharacter_C {
...
struct UWBP_DescRadiogramGroup_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UCloudWatchDisableInsightRules {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UWBP_Radiogram_6010210_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x298
	UTextBlock* TextBlock; // 0x2a0
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x2a8
	UWBP_RadiogramListing_C* WBP_RadiogramListing_2; // 0x2b0
...
struct UCloudWatchGetDashboard {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct ABP_StaticMeshBuildPartBase_C {
...
struct UWBP_Popup_ForbiddenNick_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWBP_MainFrame_C* BP_UI_Frame; // 0x268
	UImage* Image; // 0x270
...
struct UWBP_Radiogram_6010213_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x298
	UTextBlock* TextBlock; // 0x2a0
...
struct UCallbackProxySubscribeUnsubscribeWorkshopItem {
	FMulticastInlineDelegate OnSuccess; // 0x30
	FMulticastInlineDelegate OnFailure; // 0x40
...
struct USVCH_Male_ModelViewer_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
...
struct UWBP_TutorialQuestMain_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Anim_Open; // 0x268
	UImage* Image; // 0x270
...
struct UWBP_Radiogram_6010217_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x298
	UTextBlock* TextBlock; // 0x2a0
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x2a8
	UWBP_RadiogramListing_C* WBP_RadiogramListing_2; // 0x2b0
...
struct UBP_AvgFrameCheckComponent_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UWBP_Functionality_ElectricTrap_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x270
...
struct ABP_FoldingDoorBuildPartBase_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x860
...
struct ABP_LevelTimeOfDayManager_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x220
	USceneComponent* DefaultSceneRoot; // 0x228
...
struct ABP_SquareCeilingBuildPartBase_C {
...
struct UC_Manager-RespawnMap_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct ULocationInfo_Gamepad_C {
	ULocationInfo_C* LocationInfo; // 0x260
};

struct UCloudWatchDescribeInsightRules {
	FMulticastInlineDelegate Callback; // 0x30
};

struct ABP_ThermalShock_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x368
...
struct UCloudWatchLogsDeleteSubscriptionFilter {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct ACommonAI_BaseAIController_C {
...
struct ABP_LandmarkAIControellr_Boss_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x4a0
};
...
struct UBTTask_MoveToForward_Juggernaut_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
...
struct UBTTask_ReloadRangeWeapon_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
};
...
struct ACustomizableSkeletalMeshActor {
...
struct UWBP_Popup_UserSearch_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct AAIController_Mutation_C {
...
struct UObjectiveSystemManagerComponent_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UWBP_FunctionalityInfo_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ABP_CraftingFunctionalityBase_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x890
...
struct USurvivalOutgameSubsystemInitializer {
	FMulticastInlineDelegate OnSuccess; // 0x30
...
struct UBP_FunctionalityHandleComponent_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UCloudWatchLogsPutQueryDefinition {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UWBP_Radiogram_4020304_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x260
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x268
	UWBP_RadiogramListing_C* WBP_RadiogramListing_2; // 0x270
	UWBP_RadiogramListing_C* WBP_RadiogramListing_3; // 0x278
...
struct ABP_CorePermissionRepeater_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x860
...
struct UWBP_Main_Inventory_External_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_Main_RadiogramListing_M_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UBorder* Border_Group; // 0x268
...
struct UCloudWatchLogsDeleteLogStream {
	FMulticastInlineDelegate Callback; // 0x30
};

struct UBP_SurvivalSteamConnectorDediServer_C {
...
struct UWBP_Functionality_Retriever_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x270
...
struct UCloudWatchLogsDeleteResourcePolicy {
	FMulticastInlineDelegate Callback; // 0x30
};

struct USurvivalAIStateMachine {
...
struct UBP_SurvivalSteamConnectorClient_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x90
...
struct UWBP_Radiogram_Crafting_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_HUD_ConditionListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UBTTask_RangeAttackOther_Juggernaut_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	float DelayTime; // 0xb0
...
struct ABP_MasterRangeWeapon_C {
...
struct UAN_CameraShakeAtLocation_C {
...
struct ULowEntryLatentActionNone {
	bool Finished; // 0x28
	int32_t KeepAliveCount; // 0x2c
};

struct UWBP_MapMarker_RespawnPoint_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct AAIContoller_Juggernaut_Hover_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x498
};

struct UBP_KeyCombination_C {
	FString Name; // 0x28
...
struct UCommonAI_BTTask_GetNearLocation_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
...
struct UCloudWatchDisableAlarmActions {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UWBP_Radiogram_6010108_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x298
	UTextBlock* TextBlock; // 0x2a0
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x2a8
};
...
struct UBP_StorageInventoryComponent_C {
...
struct UWBP_Main_Radiogram_TreeListing_M_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UBPANS_JuggernautMeleeAttack_C {
...
struct UCloudWatchListDashboards {
	FMulticastInlineDelegate Callback; // 0x30
};

struct UFAI_BTTask_AttackState_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	FBlackboardKeySelector KEYTargetActor; // 0xb0
...
struct UCloudWatchGetInsightRuleReport {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UCallbackProxyGetUserVoteOnWorkshopItem {
	FMulticastInlineDelegate OnSuccess; // 0x30
	FMulticastInlineDelegate OnFailure; // 0x40
	FMulticastInlineDelegate OnSteamInitFailure; // 0x50
};
...
struct ABP_PlayerAIController_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x4a0
	float Duration; // 0x4a8
	UBehaviorTree* Behavior Tree; // 0x4b0
};

struct UWBP_Main_RadiogramListing_L_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UBorder* Border_Group; // 0x268
...
struct UWBP_MapMarker_Waypoint_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x4a8
...
struct UParticleModuleEventReceiverPlaySound {
...
struct ABP_RespawnBuildPartBase_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x860
...
struct UFAI_BTTask_AttackState_Bear_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	FBlackboardKeySelector KEYTargetActor; // 0xb0
	FBlackboardKeySelector KEYTargetLocation; // 0xd8
	float PlayRate; // 0x100
...
struct UCloudWatchLogsAssociateKmsKey {
	FMulticastInlineDelegate Callback; // 0x30
};

struct UCustomizableSkeletalComponent {
...
struct UWBP_MainFrame_Toolbar_C {
...
struct UBP_SkillSystemComponent_C {
...
struct ABP_DoorBuildPartBase_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x890
...
struct UWBP_TutorialObjectiveListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_RadiogramObjectiveMain_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Anim_Open; // 0x268
...
struct URMNPC_AnimBP_BlackBear_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x310
...
struct UWBP_Main_MachineArmListing_S_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ABP_ThermalEquilibration_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x368
...
struct UBP_ConvertInventoryComponent_C {
...
struct ASurvivalAICharacterBase {
...
struct UBP_DeathRecapComponent_C {
...
struct UWBP_Main_Description_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ABP_RampBuildPartBase_C {
...
struct UWBP_AdminConsole_ItemListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UBorder* Border_1; // 0x268
...
struct UCloudWatchLogsDeleteDestination {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UWBP_Toolbar_Dropdown_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_radiogram_CustomBase_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	FText Text; // 0x268
...
struct AAIController_Juggernaut_Type00_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x498
};

struct UBTTask_MoveToLocation_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	FBlackboardKeySelector KEYTargetActorOrLocation; // 0xb0
...
struct UAnimNotify_FireMonsterProjectile_C {
...
struct UBoss_Spider_Move_AnimBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
...
struct UCallbackProxyQueryWorkshopForItemDetails {
	FMulticastInlineDelegate OnSuccess; // 0x30
	FMulticastInlineDelegate OnFailure; // 0x40
	FMulticastInlineDelegate OnSteamInitFailure; // 0x50
};
...
struct UCloudWatchLogsPutSubscriptionFilter {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct ASurvivalPlayerController {
...
struct UBTTask_InitData_Juggernaut_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
...
struct UPlayerInfo_C {
	UTextBlock* HoverName; // 0x260
};

struct AInfinityFireProjectile_Bullet {
...
struct UWBP_Popup_UserSearchListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_Main_QueueListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct USpotEventTypeData_SpawnFieldNPC_C {
	FS_FieldNPCInfo DetailInfo; // 0xc8
};

struct USQSRemovePermission {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct USurvivalCharacterMovementComponent {
...
struct UBTTask_FindAttackTarget_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	AAIController* OwnerController; // 0xb0
	APawn* ControlledPawn; // 0xb8
...
struct UFAI_BTTask_SpecialAttackStateRandomly_C {
...
struct UBP_EnvironmentEffectComponent_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x460
...
struct ULowEntryByteDataWriter {
	TArray<char> Bytes; // 0x28
};
...
struct UWBP_Main_DescriptionListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct USurvivalWebsocketConnectionDedicatedServer {
...
struct ABP_StairUBuildPart_C {
	UBP_BuildJointComponent_C* Bolt; // 0x860
};

struct ULocalMap_Image_C {
	UImage* Map; // 0x260
};

struct UWBP_UserBan_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ULowEntryParsedHashcash {
	bool Valid; // 0x28
...
struct UWidgetInteractionWithRay {
...
struct UWBP_MapMarker_LandmarkEffect_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x4a8
...
struct ABP_ElectricFenceGate_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x890
...
struct UCloudWatchLogsCreateLogGroup {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UWBP_WeaponInterfaceMaster_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ABP_SessionDataManager_C {
...
struct UWBP_Main_MachineArmListing_M_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UBorder* Border_1; // 0x268
...
struct ABP_Juggernaut_Type00_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xe28
...
struct UAnimNotify_MuzzleParticleRangeWeapon_C {
	FName SocketName; // 0x38
	FVector LocationOffset; // 0x40
	FRotator RotationOffset; // 0x4c
	FVector Scale; // 0x58
...
struct UBTTask_GetFarLocationFromTarget_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	FBlackboardKeySelector KEYTargetActorOrLocation; // 0xb0
...
struct ABP_HologramTrapBuildPartBase_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x890
...
struct UBP_UnlcokEscapeCode_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x40
};

struct UCallbackProxyUpdateWorkshopItem {
...
struct UBP_QuickGen_C {
	TArray<FItemInventory> History; // 0x28
};

struct UCallbackProxyStartStopWorkshopItemsPlaytimeTracking {
	FMulticastInlineDelegate OnSuccess; // 0x30
	FMulticastInlineDelegate OnFailure; // 0x40
	FMulticastInlineDelegate OnSteamInitFailure; // 0x50
};
...
struct UWBP_Radiogram_4020203_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x260
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x268
	UWBP_RadiogramListing_C* WBP_RadiogramListing_2; // 0x270
	UWBP_RadiogramListing_C* WBP_RadiogramListing_3; // 0x278
...
struct UDistributionVectorUniformParam {
...
struct UWBP_AdminConsole_QuickListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct USurvivalReplicationGraph {
...
struct UCloudWatchDeleteDashboards {
	FMulticastInlineDelegate Callback; // 0x30
};

struct UCloudWatchLogsDescribeQueryDefinitions {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct URMHttpRequest_Get_Client_Info {
	FMulticastInlineDelegate OnSuccess; // 0x48
	FMulticastInlineDelegate OnFailure; // 0x58
};
...
struct UAnimBP_Juggernaut_Type00_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x310
...
struct UBP_CraftingComponent_C {
...
struct ABP_HousingTurret_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x400
	FFloatValueFromDataTable PVPDamageMultiplier; // 0x408
};

struct UXRVisualizationLoadHelper {
...
struct USQSDeleteMessageBatch {
	FMulticastInlineDelegate Callback; // 0x30
};

struct UWBP_Radiogram_6010100_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x298
	UTextBlock* TextBlock; // 0x2a0
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x2a8
};
...
struct UCloudWatchListMetrics {
	FMulticastInlineDelegate Callback; // 0x30
};

struct UBP_ResourceGatherAmountFactor_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x40
...
struct UWBP_Objective_Indicator_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UAnimNotify_SpawnAKForRangeWeapon_C {
	FName BoneName; // 0x38
...
struct UMachineArmAbilityComponent {
...
struct ULowEntryLatentActionObject {
	bool Finished; // 0x28
	UObject* Result; // 0x30
...
struct URMHttpRequest_Put_Client_Name {
	FMulticastInlineDelegate OnSuccess; // 0x48
	FMulticastInlineDelegate OnFailure; // 0x58
};

struct UWBP_RadiogramConvertListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_Tooltip_FunctionListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct USurvivalWebsocketConnectionClient {
...
struct UGlee_SK_Skeleton_AnimBlueprint_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	FAnimNode_Root AnimGraphNode_Root; // 0x2c8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x2f8
};

struct UWBP_Radiogram_6010106_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x298
	UTextBlock* TextBlock; // 0x2a0
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x2a8
	UWBP_RadiogramListing_C* WBP_RadiogramListing_49; // 0x2b0
...
struct UWBP_Functionality_ItemLogListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ABP_lantern_landBuildpart_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x860
	UPointLightComponent* PointLight; // 0x868
	bool SwichOn; // 0x870
};

struct UBP_SurvivalStatFactor_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x40
	float Factor; // 0x48
};
...
struct ABP_LandmarkAIControellr_C {
	float ForgettingTargetTime; // 0x498
};

struct UWBP_PopUp_Button_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UButton* Button; // 0x268
...
struct UBP_WidgetIndicatorManager_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct ABP_ScreenIndicatorActor_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x220
...
struct UWBP_Main_LandmarkListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ULowEntryLatentActionInteger {
	bool Finished; // 0x28
	int32_t Result; // 0x2c
	int32_t KeepAliveCount; // 0x30
};

struct ABP_ElectricTrap_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x890
...
struct ABP_EscapeRocketInnerDoor_C {
...
struct USpotEventTypeData_SpawnNPC_C {
...
struct UCommonAI_BTTask_LookTargetByAttackIndex_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	FBlackboardKeySelector KEYTargetActorOrLocation; // 0xb0
	bool Reset; // 0xd8
...
struct ABP_FoundationBuildPartBase_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x860
...
struct ULowEntryLatentActionBoolean {
	bool Finished; // 0x28
	bool Result; // 0x29
	int32_t KeepAliveCount; // 0x2c
};
...
struct UCloudWatchLogsPutLogEvents {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UBP_RadiogramSortObject_C {
	FItemGeneralInfo ItemInfo; // 0x30
	int32_t UID; // 0x180
};

struct ABP_WaterPoolBase_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x220
...
struct AOnlineBeaconHostObjectDynamic {
...
struct USQSDeleteQueue {
	FMulticastInlineDelegate Callback; // 0x30
};

struct UCloudWatchDescribeAlarmsForMetric {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct AAIContoller_Juggernaut_Junior_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x498
};
...
struct UBPANS_BossSpecialAttack_C {
...
struct UFAI_BTTask_SetFlyLocationByAttackRange_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	FBlackboardKeySelector KEYTargetActor; // 0xb0
	FBlackboardKeySelector KEYTargetLocation; // 0xd8
...
struct ABP_EnergyCoreBuildPart_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x890
...
struct ABP_SkeletalMeshBuildPartBase_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x840
...
struct UWBP_RadiogramListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWB_ClassicSettingsDev_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UButton* Button; // 0x268
	UButton* Button_2; // 0x270
	UButton* Button_3; // 0x278
...
struct ABP_ThrownSmokeGrenade_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x3c8
	int32_t SoundLoopCount; // 0x3d0
};

struct ABP_NPCSpawnLooperBox_C {
...
struct UValueFromDataTableRepository {
	FSoftObjectPath DataTable; // 0x78
	UDataTable* SourceDataTable; // 0x90
};

struct ABP_LandmarkActionActor_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x220
	USceneComponent* DefaultSceneRoot; // 0x228
	bool IsActionActivate; // 0x230
};

struct UWBP_HUD_Fake_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct AInfinityFireProjectile {
...
struct UWBP_Main_RadiogramListing_S_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UBorder* Border_1; // 0x268
...
struct UWBP_Radiogram_4020204_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x260
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x268
	UWBP_RadiogramListing_C* WBP_RadiogramListing_2; // 0x270
	UWBP_RadiogramListing_C* WBP_RadiogramListing_3; // 0x278
...
struct ABP_MasterMeleeWeapon_C {
...
struct USQSDeleteMessage {
	FMulticastInlineDelegate Callback; // 0x30
};

struct UWBP_Main_TeamListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_HUD_GuideListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct USurvivalWebsocketConnectorBase {
...
struct UWBP_CraftingCostListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ABP_RetrieveSystemDesc_C {
...
struct UBTDecorator_IsTargetClosedEnough_C {
...
struct UWBP_Radiogram_6010212_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x298
	UTextBlock* TextBlock; // 0x2a0
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x2a8
	UWBP_RadiogramListing_C* WBP_RadiogramListing_2; // 0x2b0
...
struct UThumper_AnimBlueprint_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	FAnimNode_Root AnimGraphNode_Root; // 0x2c8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x2f8
...
struct UCloudWatchGetMetricStatistics {
	FMulticastInlineDelegate Callback; // 0x30
};

struct UBTTask_FindLocationToMoveForward_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	AAIController* OwnerController; // 0xb0
	APawn* ControlledPawn; // 0xb8
	FBlackboardKeySelector MoveLocation; // 0xc0
...
struct UCloudWatchPutAnomalyDetector {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UWBP_Radiogram_Distribution_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UCallbackProxyQueryWorkshopForAllItems {
	FMulticastInlineDelegate OnSuccess; // 0x30
	FMulticastInlineDelegate OnFailure; // 0x40
	FMulticastInlineDelegate OnSteamInitFailure; // 0x50
};

struct ASurvivalPlayerState {
	bool bAdmin; // 0x320
...
struct UBreakableTreeCollisionComponent {
...
struct UCloudWatchLogsDeleteLogGroup {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UBP_EnergyRecoverFactor_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x40
...
struct UBP_AbnormalStateComponent_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb8
...
struct UCloudWatchPutMetricData {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UWBP_UI_ListingHovering_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Anim_Hovered; // 0x268
	bool Mouse Over; // 0x270
	FItemInventory Item; // 0x278
...
struct UWBP_FunctionalityBase_C {
...
struct UCloudWatchPutMetricAlarm {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UCloudWatchPutCompositeAlarm {
	FMulticastInlineDelegate Callback; // 0x30
};

struct UWBP_Functionality_TransferTerrasite_Resource_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_ShortRankingListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UBorder* Border_Frame; // 0x268
...
struct UBTTask_ExecutionAttack_Juggernaut_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	float DelayTime; // 0xb0
...
struct UWBP_MachineArm_CostListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UCloudWatchEnableInsightRules {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UParticleEventReceiverAkPostEvent {
	UAkAudioEvent* AkEvent; // 0x40
};

struct USurvivalGameInstance {
...
struct UCloudWatchDescribeAlarms {
	FMulticastInlineDelegate Callback; // 0x30
};

struct UCloudWatchLogsCreateExportTask {
	FMulticastInlineDelegate Callback; // 0x30
};

struct UWBP_Slot_Quick_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UBorder* Border; // 0x268
...
struct USQSListDeadLetterSourceQueues {
	FMulticastInlineDelegate Callback; // 0x30
};

struct UBTTask_BeckenReturnToCenter_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
};
...
struct UBTTask_Juggernaut_Barrier_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
...
struct UWBP_Functionality_Core_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x270
...
struct UCloudWatchListTagsForResource {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UWBP_Radiogram_1010102_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x260
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x268
	UWBP_RadiogramListing_C* WBP_RadiogramListing_58; // 0x270
};

struct UWBP_Radiogram_6010218_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x298
	UTextBlock* TextBlock; // 0x2a0
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x2a8
	UWBP_RadiogramListing_C* WBP_RadiogramListing_2; // 0x2b0
...
struct UCloudWatchLogsDescribeLogGroups {
	FMulticastInlineDelegate Callback; // 0x30
};

struct UWBP_HoldableKeyGuide_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x268
...
struct ABP_MasterThrowWeapon_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x5c0
...
struct UCloudWatchLogsUntagLogGroup {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UCustomizableObjectImageProviderArray {
...
struct UBP_LandmarkHandleComponent_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UWBP_RetrieverRegisterSlot_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UBorder* Border; // 0x268
...
struct USupplyTurret_SK_Skeleton_AnimBlueprint_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
...
struct UWBP_Radiogram_6010214_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x298
	UTextBlock* TextBlock; // 0x2a0
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x2a8
	UWBP_RadiogramListing_C* WBP_RadiogramListing_2; // 0x2b0
...
struct USQSChangeMessageVisibility {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UWBP_PopUp_TransferTerrasite_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_HUD_NotificationListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UM4A1_SK_Skeleton_AnimBlueprint_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
...
struct USQSAddPermission {
	FMulticastInlineDelegate Callback; // 0x30
};

struct UCloudWatchLogsGetLogEvents {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UCloudWatchSetAlarmState {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UWBP_Functionality_Core_OwnerListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct URMHttpRequest_Get_Client_VivoxToken {
...
struct UMachineArmAbilityBase {
	FText Description; // 0x28
};

struct UWBP_HUD_Durability_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ABP_NPCSpawnerByLandmarkStatusBoxBound_C {
	UBoxComponent* RoamBound; // 0x4a8
};

struct UWBP_Radiogram_6010103_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x298
	UTextBlock* TextBlock; // 0x2a0
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x2a8
	UWBP_RadiogramListing_C* WBP_RadiogramListing_2; // 0x2b0
...
struct UWBP_MapMarkerTooltip_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Anim_Open; // 0x268
...
struct UBTTask_SetRandomFloat_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
...
struct ABP_FunctionalityBuildPartBase_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x860
...
struct ABP_SurvivalBeforeIngameBeaconClient_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	USceneComponent* DefaultSceneRoot; // 0x2c8
};

struct URMNPC_AnimBP_Elk_M_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x310
...
struct UBP_MasterResourceFoliageComponent_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x6a0
...
struct UWBP_Radiogram_1010105_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x260
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x268
	UWBP_RadiogramListing_C* WBP_RadiogramListing_2; // 0x270
};

struct UWBP_Main_Ranking_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UScrollBox* ScrollBox_Leaderboard; // 0x268
	UWBP_MainFrame_C* WBP_MainFrame; // 0x270
	UWBP_MainFrame_Header_C* WBP_MainFrame_Header; // 0x278
...
struct UWBP_Main_CraftingV2_Queue_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UGoofy_S_SK_Skeleton_AnimBlueprint_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	FAnimNode_Root AnimGraphNode_Root; // 0x2c8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x2f8
};
...
struct ABP_SquareFoundationBase_C {
...
struct UWBP_Functionality_WaterGenerator_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x270
...
struct ABP_BreakableSpruceTree_F_C {
...
struct UCloudWatchLogsPutDestinationPolicy {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UWBP_HUD_Notification_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_RadiogramObjectiveListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ULowEntryByteDataReader {
	TArray<char> Bytes; // 0x28
...
struct ABP_NavigationInvoker_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x220
...
struct UBP_InventoryComponentBase_C {
...
struct UWBP_Radiogram_4010102_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x260
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x268
	UWBP_RadiogramListing_C* WBP_RadiogramListing_2; // 0x270
};

struct UBTTask_MeleeAttack_Juggernaut_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	float DelayTime; // 0xb0
...
struct UCloudWatchLogsDescribeLogStreams {
	FMulticastInlineDelegate Callback; // 0x30
};

struct ABP_SmallStorageBoxBuildPart_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x890
};
...
struct ABP_Juggernaut_Ridable_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x4c0
...
struct UCloudWatchLogsCreateLogStream {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UCallbackProxySetUserVoteOnWorkshopItem {
	FMulticastInlineDelegate OnSuccess; // 0x30
	FMulticastInlineDelegate OnFailure; // 0x40
	FMulticastInlineDelegate OnSteamInitFailure; // 0x50
};
...
struct UCloudWatchLogsPutMetricFilter {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UBP_WidgetIndicatorComponentHasIndex_C {
	int32_t CustomIndex; // 0x618
};

struct UBP_MasterCraftingListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct USpotEventTypeData_SupplyDrop_C {
...
struct UWB_ClassicComboBoxItem_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct USpotEventTypeData_IncomingDropship_C {
	TArray<FItemCodeValue> RandItemGenerate; // 0xc8
...
struct UWBP_Functionality_Repair_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x270
...
struct UWBP_Function_Inventory_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UCloudWatchLogsDeleteRetentionPolicy {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct ABP_TriangleCeilingBuildPartBase_C {
...
struct UWBP_Functionality_ConversionSlot_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ABP_Juggernaut_Junior_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xe28
	UParticleSystemComponent* DeathEffect; // 0xe30
...
struct UCloudWatchDescribeAlarmHistory {
	FMulticastInlineDelegate Callback; // 0x30
};

struct UCloudWatchLogsCancelExportTask {
	FMulticastInlineDelegate Callback; // 0x30
};

struct UWBP_Radiogram_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UCallbackProxyStopWorkshopItemsPlaytimeTrackingAllItems {
	FMulticastInlineDelegate OnSuccess; // 0x30
	FMulticastInlineDelegate OnFailure; // 0x40
	FMulticastInlineDelegate OnSteamInitFailure; // 0x50
};
...
struct UWBP_Radiogram_3020313_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x260
	UWBP_RadiogramImage_C* Radiogram_Image; // 0x268
	UWBP_RadiogramImage_C* Radiogram_Image_2; // 0x270
...
struct UCloudWatchLogsGetLogGroupFields {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UWBP_MapMarker_LandmarkEffectCauser_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct USurvivalVehicleMovementComponent4W {
...
struct ABP_InsertBatteryPackBase_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x4b0
...
struct UWBP_HUD_InteractionListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UAnimNotify_FireHomingMissileToNearPlayer_C {
	FName EffectSocketName; // 0x38
	float NearRange; // 0x40
};

struct USpotEventCondition_Periodic_C {
...
struct UTurret_SK_Skeleton_AnimBlueprint_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	FAnimNode_ModifyBone AnimGraphNode_ModifyBone_2; // 0x2c8
	FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace; // 0x3d0
	FAnimNode_ModifyBone AnimGraphNode_ModifyBone; // 0x3f0
...
struct UWBP_Main_Mail_Listing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UBorder* Border_1; // 0x268
	UBorder* Border_Ring; // 0x270
	UImage* Image_Item; // 0x278
...
struct UWBP_MainFrame_Header_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UArmor_Crafting_Table_SK_Skeleton_AnimBlueprint_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	FAnimNode_Root AnimGraphNode_Root; // 0x2c8
...
struct UCloudWatchLogsDeleteMetricFilter {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct USurvivalRankStructWrapper_C {
...
struct UBTService_KeepControllerLookAtTargetOrLocation_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x98
	FBlackboardKeySelector KEYTargetActorOrLocation; // 0xa0
};
...
struct USK_Electronic_Fence_Door_02_Skeleton_AnimBlueprint_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	FAnimNode_Root AnimGraphNode_Root; // 0x2c8
...
struct UBP_MachineArmAbilityComponent_C {
...
struct UWBP_Main_RankingListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UBorder* Border_1; // 0x268
...
struct UBTTask_FocusRandomLocationNearMe_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
};
...
struct UCloudWatchLogsTagLogGroup {
	FMulticastInlineDelegate Callback; // 0x30
};

struct UBP_VaultComponent_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UBTTask_RangeAttack_Juggernaut_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	float DelayTime; // 0xb0
	FBlackboardKeySelector IsRangeAttack; // 0xb8
	FBlackboardKeySelector TargetActor; // 0xe0
...
struct UWBP_Radiogram_6010215_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x298
	UTextBlock* TextBlock; // 0x2a0
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x2a8
};

struct UWBP_Main_Radiogram_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UCloudWatchLogsDeleteQueryDefinition {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UAnimNotify_PlayAKSound_C {
	FName SocketName; // 0x38
	bool Attach; // 0x40
...
struct UWBP_ChatCategoryButtons_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ABP_HologramTrap_CeilingBase_C {
...
struct UWaypointMarkerInfo_C {
	UTextBlock* HoverName; // 0x260
};

struct AResourceBase {
	TMap<FString, FGatherLogCachedData> GatherLogCachedDataMap; // 0x220
	int32_t UID; // 0x270
};

struct UWBP_Radiogram_6010104_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x298
	UTextBlock* TextBlock; // 0x2a0
	UWBP_RadiogramListing_C* WBP_RadiogramListing_2; // 0x2a8
...
struct ABP_WallBuildPartBase_C {
...
struct ABP_PillarBuildPartBase_C {
	UBP_BuildJointComponent_C* Bolt; // 0x860
...
struct UBP_OccupyFunctionComponent_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
	bool IsIn; // 0xb8
...
struct UWBP_Function_Display_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWBP_Button_Function_C* Button_Radiogram; // 0x268
...
struct UWBP_Functionality_Conversion_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x270
...
struct UCloudWatchLogsDescribeResourcePolicies {
	FMulticastInlineDelegate Callback; // 0x30
};

struct URMHttpRequest_Post_Client_Name {
	FMulticastInlineDelegate OnSuccess; // 0x48
	FMulticastInlineDelegate OnFailure; // 0x58
};
...
struct UBP_IngamePopupUIManager_C {
	TMap<int32_t, UUserWidget*> IngameLayer; // 0xb0
	int32_t CurrentTopZOrder; // 0x100
};

struct UBPANS_LandmarkMonsterMeleeAttack_C {
	UAkAudioEvent* HitAkEvent; // 0x30
	UAkSwitchValue* HitAkSwitch; // 0x38
	int32_t SpecialAttackIndex; // 0x40
};
...
struct UCallbackProxyAddRemoveWorkshopItemFavorite {
	FMulticastInlineDelegate OnSuccess; // 0x30
	FMulticastInlineDelegate OnFailure; // 0x40
	FMulticastInlineDelegate OnSteamInitFailure; // 0x50
};
...
struct ABP_HologramTrap_CeilingBase_TriangleCeiling_C {
...
struct UBP_PlayerInventoryComponent_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x138
...
struct UCloudWatchLogsFilterLogEvents {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct USQSChangeMessageVisibilityBatch {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct Ux_WBP_Functionality_WaterPurifier_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x270
	UWBP_Functionality_ConversionSlot_C* BP_ConvertContainer; // 0x278
	UWBP_Slot_Inventory_C* BP_InventorySlot; // 0x280
...
struct ABP_LandmarkEffectRangeActor_C {
...
struct UAssetUserData_FieldNPCSpawner_C {
	AActor* Owner; // 0x28
...
struct ABP_StorageBoxBuildPartBase_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x860
...
struct UCallbackProxyCreateWorkshopItem {
	FMulticastInlineDelegate OnSuccess; // 0x30
	FMulticastInlineDelegate OnFailure; // 0x40
	FMulticastInlineDelegate OnSteamInitFailure; // 0x50
};

struct UWBP_DebugWidget_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UTextBlock* TextBlock_135; // 0x268
	BP_SurvivalCharacter_C* TSVC; // 0x270
};
...
struct UBP_GameSettingsWrapper_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x28
	UBP_GameSettings_C* Game Settings; // 0x30
};

struct UWBP_Radiogram_Convert_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UVerticalBox* list; // 0x268
	int32_t UID; // 0x270
...
struct UWBP_FunctionalityMainButton_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_HoldableGuideUIBase_C {
...
struct UWBP_Radiogram_6010216_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x298
	UTextBlock* TextBlock; // 0x2a0
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x2a8
};
...
struct UFAI_BTDecorator_CanAttack_C {
	FBlackboardKeySelector KEYTargetActor; // 0xa0
};

struct UBP_SurvivalGameInstance_C {
...
struct UBTTask_RangeAttack_Hover_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	float DelayTime; // 0xb0
	FBlackboardKeySelector TargetActor; // 0xb8
...
struct UCloudWatchGetMetricData {
	FMulticastInlineDelegate Callback; // 0x30
};

struct UWBP_MapMarker_EventPoint_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x4a8
	UWidgetAnimation* Appear; // 0x4b0
	BP_SpotEventBase_C* MySpotRef; // 0x4b8
};

struct UWBP_Radiogram_4010104_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x260
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x268
	UWBP_RadiogramListing_C* WBP_RadiogramListing_2; // 0x270
	UWBP_RadiogramListing_C* WBP_RadiogramListing_3; // 0x278
...
struct UWBP_Functionality_CarManage_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct AFunctionalHoldableBase {
...
struct USurvivalReplicationGraphNode_AlwaysRelevant_ForConnection {
...
struct UCloudWatchLogsTestMetricFilter {
	FMulticastInlineDelegate Callback; // 0x30
};

struct Ualloy_FoldingDoor_SK_Skeleton_AnimBlueprint_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	FAnimNode_Root AnimGraphNode_Root; // 0x2c8
...
struct UBTTask_LookAround_Juggernaut_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
...
struct UCloudWatchLogsGetLogRecord {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UCloudWatchLogsDescribeExportTasks {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UWBP_Functionality_TransferTerrasiteMenu_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ABP_StickyBomb_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x8c0
};

struct UVehicleSkidData {
	UParticleSystem* WaterFX; // 0x30
	UParticleSystem* DirtFX; // 0x38
	UParticleSystem* AsphaltFX; // 0x40
	float WaterMinSpeed; // 0x48
...
struct UBP_SkillAcitvationConditionBase_C {
	FS_ConditionParam Param; // 0x28
};

struct UWBP_HackingBox_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_ObjectiveProgress_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_Tooltip_DescriptionListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_Radiogram_6010107_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x298
	UTextBlock* TextBlock; // 0x2a0
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x2a8
};
...
struct UWBP_ObjectiveListing_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Anim_Attention; // 0x268
...
struct UCloudWatchUntagResource {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct USurvivalOutgameSubsystem {
...
struct UCloudWatchLogsGetQueryResults {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UWidgetComponentEx {
	TextureFilter RenderTargetFilter; // 0x590
};

struct UWBP_Slot_Equipment_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UBorder* Border; // 0x268
...
struct UWBP_Main_Crafting_InfoV2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UBorder* Border_1; // 0x268
...
struct UFAI_BTDecorator_CheckTooFarFromHome_C {
...
struct UBTTask_CheckJuggernautSpawner_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	float FarLimit; // 0xb0
...
struct UCloudWatchLogsDisassociateKmsKey {
	FMulticastInlineDelegate Callback; // 0x30
};

struct ABP_ThrownGrenade_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x378
...
struct UWBP_Function_Crafting_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWBP_Button_Function_C* Button_Radiogram; // 0x268
	UVerticalBox* OptionBox; // 0x270
...
struct AInfinityFireProjectileBase {
...
struct UBP_VehicleHandleComponent_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
	bool Notification; // 0xb8
	TArray<FItemCodeValue> ItemList; // 0xc0
};

struct UWBP_UI_Tooltip_TextOnly_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UBP_IncreaseMaxHP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x40
	float HPAmount; // 0x48
};

struct UWBP_Main_Description_Attachment_C {
	UWBP_MainFrame_C* BP_UI_Frame; // 0x260
...
struct UCloudWatchLogsDescribeQueries {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UCallbackProxyQueryWorkshopForUserItems {
	FMulticastInlineDelegate OnSuccess; // 0x30
	FMulticastInlineDelegate OnFailure; // 0x40
	FMulticastInlineDelegate OnSteamInitFailure; // 0x50
};

struct UFAI_BTTask_SetRandomPointFromSpawner_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
...
struct UWBP_Radiogram_MachineArmAbility_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_MainFrame_Toolbar_Checkbox_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct URepair_Table_SK_Skeleton_AnimBlueprint_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	FAnimNode_Root AnimGraphNode_Root; // 0x2c8
	FAnimNode_BlendListByBool AnimGraphNode_BlendListByBool; // 0x2f8
...
struct UCloudWatchEnableAlarmActions {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct UWBP_Main_Crafting_ListingV2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UCustomizableInstancePrivateData {
...
struct UWBP_HUD_DamagedDirection_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Anim_Play; // 0x268
...
struct UWBP_Slot_Functionality_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UBTService_PlayerReaction_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x98
	FBlackboardKeySelector KEYTargetActor; // 0xa0
	FBlackboardKeySelector KEYTargetLocation; // 0xc8
	FBlackboardKeySelector KEYStress; // 0xf0
...
struct UBTTask_ChooseAttackTypeByDistance_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	FBlackboardKeySelector KEYTargetActor; // 0xb0
	FBlackboardKeySelector KEYTargetLocation; // 0xd8
...
struct ABP_Survival_Sky_Sphere_C {
...
struct ABP_BreakableResource_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x440
...
struct UAnimBP_Juggernaut_Ridable_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x310
...
struct UCloudWatchDeleteAnomalyDetector {
	FMulticastInlineDelegate Callback; // 0x30
};

struct UWBP_Radiogram_4020303_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x260
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x268
	UWBP_RadiogramListing_C* WBP_RadiogramListing_2; // 0x270
	UWBP_RadiogramListing_C* WBP_RadiogramListing_3; // 0x278
...
struct UBP_PlayerBuildingComponent_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb8
...
struct UCloudWatchPutInsightRule {
	FMulticastInlineDelegate Callback; // 0x30
};

struct USQSSendMessage {
	FMulticastInlineDelegate Callback; // 0x30
};

struct UBottle_SK_Skeleton_AnimBlueprint_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	FAnimNode_Root AnimGraphNode_Root; // 0x2c8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x2f8
};

struct UWBP_Functionality_Hologram_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x270
...
struct UWBP_Radiogram_6010105_C {
	UWBP_RadiogramBase_C* Radiogram_Base; // 0x298
	UTextBlock* TextBlock; // 0x2a0
	UWBP_RadiogramListing_C* WBP_RadiogramListing; // 0x2a8
	UWBP_RadiogramListing_C* WBP_RadiogramListing_2; // 0x2b0
...
struct UDrescher_SK_Skeleton_AnimBlueprint_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	FAnimNode_Root AnimGraphNode_Root; // 0x2c8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x2f8
};
...
struct ABP_WreckedCarResource_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x440
...
struct UAgon_SK_Skeleton_AnimBlueprint_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	FAnimNode_Root AnimGraphNode_Root; // 0x2c8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x2f8
};

struct ABP_NPCSpawnerBase_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x220
...
struct UWBP_Functionality_Refinery_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x270
...
struct USpotEventTypeData_Base_C {
	float ActivationDelay; // 0x30
	FSlateBrush SpotIcon; // 0x38
	bool ShowRange; // 0xc0
};

struct UXRVisualizationFunctionLibrary {
...
struct UCloudWatchLogsDescribeMetricFilters {
	FMulticastInlineDelegate Callback; // 0x30
};
...
struct AAutoShapeRemoverInEditorActor {
...
struct UBTTask_MeleeAttack_JuggernautJunior_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	float DelayTime; // 0xb0
	FBlackboardKeySelector IsMeleeAttack; // 0xb8
	FBlackboardKeySelector TargetActor; // 0xe0
