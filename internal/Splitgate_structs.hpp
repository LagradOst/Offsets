...
struct FPlayerStatsInfo_Career {
...
struct FPlayerStatsInfo_MatchSummary {
	int32_t Points; // 0xc8
...
struct FCustomGameJoinedEventArgs {
...
struct FPlaylistGameModeInfo {
	...
	EPlaylistGameModeType Type; // 0x10
	int32_t MaxPartySize; // 0x14
	int64_t EndAtMs; // 0x18
	int32_t MinProgressionLevel; // 0x20
};
...
struct FUserRaceCourseInfo {
	TMap<FString, int32_t> Times; // 0x0
};
...
struct FGameConfig {
	...
	int32_t MatchTime; // 0x150
	bool BotsEnabled; // 0x154
	EBotDifficulty BotDifficulty; // 0x155
};
...
struct FNameTagCustomizationItem {
...
struct FGetFriendLeaderboardRequestArgs {
	TArray<FString> EncodedCompositePlatformIds; // 0x28
};
...
struct FEmoteCustomizationItem {
...
struct FStoreCustomizationItemInfo {
...
struct FPlaylistStatusInfo {
	...
	int32_t MinNumGameModesToSelect; // 0x40
	bool IsCrossplayRequired; // 0x44
	FText Title; // 0x48
...
struct FSprayCustomizationItem {
...
struct FPortalCustomizationItem {
...
struct FBannerCustomizationItem {
