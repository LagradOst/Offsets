...
struct FArmourData {
	...
	TSoftObjectPtr<UTexture2D> Image; // 0x20
	EItemClass ItemClass; // 0x48
	TSoftClassPtr<UObject> Blueprint; // 0x50
};
...
struct FHm_InventoryInformation {
	ABaseItem* Class; // 0x0
	TArray<float> Magazines; // 0x8
	int32_t MagIndex; // 0x18
};
...
struct FSpawnPoints {
	...
	TSoftObjectPtr<UTexture2D> SpawnImage; // 0x18
	FText SpawnDescription; // 0x40
	TArray<FLevelDeployableData> RecommendedDeployables; // 0x58
	int32_t PlanningFloorNum; // 0x68
	float PlanningZoomLevel; // 0x6c
	FVector2D PlanningShift; // 0x70
	FVector2D PlanningCoordinate; // 0x78
	int32_t PtsCost; // 0x80
	bool bSpawnDisabled; // 0x84
	FName SpawnLabel; // 0x88
};
...
struct FSavedLoadout {
	...
	ABaseItem* Grenade; // 0xd0
	ABaseItem* TacticalDevice; // 0xd8
	ABaseItem* Armor; // 0xe0
	ABaseItem* Helmet; // 0xe8
	ABaseItem* RandomGear; // 0xf0
	TArray<ABaseItem*> Miscelaneous; // 0xf8
	USkinComponent* PlayerSkin; // 0x108
	FString CharacterLookOverride; // 0x110
	EArmourCoverage ArmorCoverage; // 0x120
	EArmourLevel ArmorLevel; // 0x121
};
...
struct FLevelDataLookupTable : FTableRowBase {
	...
	TSoftObjectPtr<UTexture2D> LevelPicture; // 0x38
	FText LevelDesignation; // 0x60
	FText TimeOfDayText; // 0x78
	FText Description; // 0x90
	TMap<ECOOPMode, FString> COOPModesLevelMap; // 0xa8
	TMap<ECOOPMode, FLoadAdditionalLevels> COOPModesLevelAdditionalMaps; // 0xf8
	FUnlockRequirements UnlockRequirements; // 0x148
	FMapLayout MapLayout; // 0x160
	FLoadingScreenAnimated LoadingScreen; // 0x1e8
	FNVGPostProcessSettings NVG_PostProcessOverride; // 0x238
	bool bHasDesignerNotes; // 0x290
	FText DesignerNoteTitle; // 0x298
	FText DesignerNoteText; // 0x2b0
	TArray<TSoftClassPtr<UObject>> SupportedGameModes; // 0x2c8
	FText Author; // 0x2d8
	FText AuthorContact; // 0x2f0
	FText RecommendedPlayerCount; // 0x308
	bool bIsTestLevel; // 0x320
	bool bVisible; // 0x321
	FVector MVPSequenceLocation; // 0x324
	TArray<TSoftClassPtr<UObject>> Objectives; // 0x330
	TArray<TSoftClassPtr<UObject>> Challenges; // 0x340
	FText LevelLocationText; // 0x350
	FText LevelMonthNum; // 0x368
	FText LevelDayNum; // 0x380
	FText LevelYearNum; // 0x398
	FMissionAudio TocBriefingAudio; // 0x3b0
	TArray<FMissionAudio> MissionAudio; // 0x408
	TArray<FMissionDoc> Documents; // 0x418
	TArray<FMissionPhoto> Photos; // 0x428
	TArray<FCharacterBio> SuspectsBios; // 0x438
	TArray<FCharacterBio> CiviliansBios; // 0x448
	FMissionTimeline MissionTimeline; // 0x458
	int32_t BaseSquadPts; // 0x468
	TArray<FLevelFloorData> MapFloors; // 0x470
	FSpawnPoints Spawn_2; // 0x480
	FSpawnPoints Spawn_3; // 0x510
	FSpawnPoints Spawn_4; // 0x5a0
	FSpawnPoints Spawn_5; // 0x630
	TArray<FAIRoster> AISpawnRosters; // 0x6c0
	TArray<FDynamicLevelRoster> DynamicLevelSpawnRosters; // 0x6d0
	TArray<FTrapRoster> TrapRosters; // 0x6e0
	TArray<FPersonnelMapPoint> AllPersonnelMapPoints; // 0x6f0
	TArray<FPersonnelEntry> AllPersonnel; // 0x700
	TArray<FLevelDeployableData> Deployables; // 0x710
	TArray<FLevelDeployableDepot> DeployableDepots; // 0x720
	AMusicSequencerBase* MusicSequencerClass; // 0x730
	bool bUseMissionDispatch; // 0x738
	bool bUnskippableDispatch; // 0x739
	TSoftObjectPtr<USoundBase> DispatchAudio; // 0x740
	UUserWidget* DispatchWidget; // 0x768
};
...
struct FLoadingScreenAnimated {
	TSoftObjectPtr<UTexture2D> Foreground; // 0x0
	TSoftObjectPtr<UTexture2D> Background; // 0x28
};
...
struct FCharacterMesh {
	FGuid Guid; // 0x0
	TSoftObjectPtr<USkeletalMesh> Body; // 0x10
	TSoftObjectPtr<USkeletalMesh> Head; // 0x38
	UPoseAsset* FaceROM; // 0x60
	FString CharacterSpeechHandle; // 0x68
	TArray<FAttachedMeshData> AttachedMeshData; // 0x78
	TArray<FAttachedSkeletalMeshData> AttachedSkeletalMeshData; // 0x88
};
...
struct FRoNStyleSlotData {
	FRoNStyleIdleData IdleData; // 0x0
	FRoNStyleTurnData TurnData; // 0x10
	FRoNGaitTransitionData TransitionData; // 0x58
	FRoNGaitLocomotionData LocomotionData; // 0x178
	UAnimSequence* IdleReference; // 0x238
};
...
struct FDeviceData {
	...
	TSoftObjectPtr<UTexture2D> CarouselImage1; // 0x38
	TSoftObjectPtr<UTexture2D> CarouselImage2; // 0x60
	TSoftObjectPtr<UTexture2D> CarouselImage3; // 0x88
	FText EffectiveRange; // 0xb0
	FText Use; // 0xc8
	FText Effects; // 0xe0
	FText Risk; // 0xf8
	FText ToMitigate; // 0x110
	EItemClass ItemClass; // 0x128
	int32_t MaxInInventory; // 0x12c
	TSoftClassPtr<UObject> Blueprint; // 0x130
};
...
struct FItemLookupTable : FTableRowBase {
	...
	float ItemWeight; // 0xb8
	float HolsterPlayRate; // 0xbc
	float DrawPlayRate; // 0xc0
	bool bUseLowReady; // 0xc4
	float PushbackRange; // 0xc8
	float LowReadyRange; // 0xcc
	float LowReadyRangeSightsModifier; // 0xd0
	float LowReadyPitchThreshold; // 0xd4
	float MovementSpeedMultiplier; // 0xd8
	float LeanOffset; // 0xdc
	float ADSZoom; // 0xe0
	float ADSZoomInSpeed; // 0xe4
	float ADSZoomOutSpeed; // 0xe8
	AImpactEffect* ImpactEffects; // 0xf0
	AImpactEffect* RicochetEffects; // 0xf8
	AImpactEffect* ExitEffects; // 0x100
	float MagazineWeightFull; // 0x108
	float MagazineWeightEmpty; // 0x10c
	bool bADSCountsAsAbuse; // 0x110
	float HesitationBoostMultiplier; // 0x114
	TArray<char> AvailableFireModes; // 0x118
	float BurstBulletCount; // 0x128
	FRuntimeFloatCurve DamageOverRange; // 0x130
	float Damage; // 0x1b8
	float DamageSeverityMultiplier; // 0x1bc
	float DamageSeverityChance; // 0x1c0
	float BleedoutDamageMultiplier; // 0x1c4
	float BleedoutDamageChance; // 0x1c8
	UDamageType* DefaultDamageType; // 0x1d0
	UDamageType* ArmorPiercingDamageType; // 0x1d8
	float MagazineCountDefault; // 0x1e0
	float MagazineCountMin; // 0x1e4
	float MagazineCountMax; // 0x1e8
	FName MagazineLabel; // 0x1ec
	float ProjectileMovementSpeed; // 0x1f4
	float PenetrationDistance; // 0x1f8
	ABulletProjectile* FakeBulletProjectile; // 0x200
	ABulletProjectile* BulletProjectile; // 0x208
	ABulletProjectile* ArmorPiercingBulletProjectile; // 0x210
	int32_t MagazineSize; // 0x218
	float FireRate; // 0x21c
	float Range; // 0x220
	float Accuracy; // 0x224
	float MinFireRateAI; // 0x228
	float MaxFireRateAI; // 0x22c
	int32_t BulletsFiredUntilFullyAccurate; // 0x230
	FRotator SpreadPattern; // 0x234
	float SpreadReturnRate; // 0x240
	float ADSSpreadMultiplier; // 0x244
	TArray<FRotator> RecoilPattern; // 0x248
	float RecoilReturnRate; // 0x258
	float RecoilInterpSpeed; // 0x25c
	float ADSRecoilMultiplier; // 0x260
	float LockIntegrityMinDamage; // 0x264
	float LockIntegrityMaxDamage; // 0x268
	float BulletDrag; // 0x26c
	bool bHitScan; // 0x270
	bool bSpawnTracer; // 0x271
	bool bNoSpawnTracerForFiringPlayer; // 0x272
	int32_t SpawnProjectileCount; // 0x274
	float Wobble; // 0x278
	float InitialWobbleDelay; // 0x27c
	UMatineeCameraShake* FireCameraShake; // 0x280
	float FirstShotRecoil; // 0x288
	float FirstShotSpread; // 0x28c
	float FirstShotResetTime; // 0x290
	float RecoilReturnInterpSpeed; // 0x294
	float RecoilReturnPercentage; // 0x298
	float VelocitySpreadMultiplier; // 0x29c
	float VelocityRecoilMultiplier; // 0x2a0
	float RecoilMultiplierPitch; // 0x2a4
	float RecoilMultiplierYaw; // 0x2a8
	float RefireDelay; // 0x2ac
	TArray<UWeaponWheel_ItemStat_Base*> ItemStats; // 0x2b0
	int32_t AttachmentPoints; // 0x2c0
	bool bAcceptsScopeAttachments; // 0x2c4
	TArray<UScopedWeaponAttachment*> AvailableScopeAttachments; // 0x2c8
	bool bAcceptsMuzzleAttachments; // 0x2d8
	TArray<UWeaponAttachment*> AvailableMuzzleAttachments; // 0x2e0
	bool bAcceptsUnderbarrelAttachments; // 0x2f0
	TArray<UWeaponAttachment*> AvailableUnderbarrelAttachments; // 0x2f8
	bool bAcceptsOverbarrelAttachments; // 0x308
	TArray<UWeaponAttachment*> AvailableOverbarrelAttachments; // 0x310
	bool bAcceptsStockAttachments; // 0x320
	TArray<UWeaponAttachment*> AvailableStockAttachments; // 0x328
	bool bAcceptsGripAttachments; // 0x338
	TArray<UWeaponAttachment*> AvailableGripAttachments; // 0x340
	bool bAcceptsIlluminatorAttachments; // 0x350
	TArray<UWeaponAttachment*> AvailableIlluminatorAttachments; // 0x358
	bool bAcceptsAmmunitionAttachments; // 0x368
	TArray<UWeaponAttachment*> AvailableAmmunitionAttachments; // 0x370
	bool bCalculateProcRecoil; // 0x380
	float RecoilDampStrength; // 0x384
	float RecoilFireTime; // 0x388
	float RecoilFireStrength; // 0x38c
	float RecoilFireStrengthFirst; // 0x390
	float RecoilAngleStrength; // 0x394
	float RecoilRandomness; // 0x398
	float RecoilADSModfier; // 0x39c
	float RecoilAngleADSModifier; // 0x3a0
	FRotator RecoilRotationBuildup; // 0x3a4
	FVector RecoilPositionBuildup; // 0x3b0
	float RecoilBuildupADSMultiplier; // 0x3bc
	bool RecoilHasBuildup; // 0x3c0
	float RecoilBuildupDampStrength; // 0x3c4
	float FreeAimLimit; // 0x3c8
	float FreeAimLimitADS; // 0x3cc
	float LazySpringStrength; // 0x3d0
	float LazySpringStrengthADS; // 0x3d4
	float FPADSMotionWeight; // 0x3d8
	float FreeAimInterpSpeed; // 0x3dc
	float FreeAimInterpADSModifier; // 0x3e0
	float FreeAimInterpHipModifier; // 0x3e4
	float FreeAimSlowMoveModifier; // 0x3e8
	float FreeAimSlowMoveTolerance; // 0x3ec
	bool bDisableMeshspaceMovement; // 0x3f0
	FTransform MeshspaceTransform_Default; // 0x400
	FTransform MeshspaceTransform_Aiming; // 0x430
	FTransform MeshspaceTransform_Back; // 0x460
	FVector MovementSpeedScale; // 0x490
	FRotator MovementSpeedRotationScalePitchYawRoll; // 0x49c
	float MeshSpaceAimInterp; // 0x4a8
	FTransform MeshspaceTransform_OnDraw; // 0x4b0
	float OnDrawMeshspaceInterp; // 0x4e0
	FTransform MeshspaceTransform_OnHolster; // 0x4f0
	float OnHolsterMeshspaceInterp; // 0x520
	float InertiaDragAimRotation; // 0x524
	float InertiaDragAimLocation; // 0x528
	float InertiaDragStrafeRotation; // 0x52c
	float InertiaDragStrafeLocation; // 0x530
	FName BodySocket; // 0x534
	FName HandsSocket; // 0x53c
	float CameraBobScaleH; // 0x544
	float CameraBobScaleV; // 0x548
	float CameraBobSpeedScaleH; // 0x54c
	float CameraBobSpeedScaleV; // 0x550
	float CameraBobAmplitudeBaseSpeed; // 0x554
	float CameraBobIntensitySprintScale; // 0x558
	float CameraBobAmplitudeWalkScale; // 0x55c
	float CameraBobAmplitudeSprintScale; // 0x560
	float WeaponBobScaleH; // 0x564
	float WeaponBobScaleV; // 0x568
	float WeaponBobScaleInjured; // 0x56c
	float WeaponBobSpeedScaleH; // 0x570
	float WeaponBobSpeedScaleV; // 0x574
	float WeaponBobSpeedScaleInjured; // 0x578
	float WeaponBobCrouchModifier; // 0x57c
	float WeaponBobADSModifier; // 0x580
	float WeaponBobRotPitchScale; // 0x584
	float WeaponBobRotRollScale; // 0x588
	float WeaponBobRotPitchSpeed; // 0x58c
	float WeaponBobRotRollSpeed; // 0x590
	float WeaponBobRotCrouchModifier; // 0x594
	float WeaponBobRotADSModifier; // 0x598
};
...
struct FCharacterData {
	...
	FText Name; // 0x8
	FText Title; // 0x20
	TSoftObjectPtr<UTexture2D> CharacterIcon; // 0x38
	EItemClass ItemClass; // 0x60
	TSoftObjectPtr<UPlayableCharacterData> Blueprint; // 0x68
};
...
struct FHm_DoorInformation {
	FString Name; // 0x0
	bool bIsBroken; // 0x10
	float OpenCloseAmount; // 0x14
	FTransform DoorMeshTransform; // 0x20
	bool bIsSimulatingPhysics; // 0x50
	TArray<FHm_DoorChunkInformation> DoorChunkInformations; // 0x58
	FName TrapName; // 0x68
};
...
struct FAIDataLookupTable : FTableRowBase {
	...
	ETeamType SpawningTeamType; // 0x1f8
	AAICharacter* CharacterClass; // 0x200
	TArray<FCharacterMesh> RandomCharacterMesh; // 0x208
	AAIController* ControllerClass; // 0x218
	ECyberneticsLevel CyberneticsLevel; // 0x220
	TArray<FName> Tags; // 0x228
	bool bIsFemale; // 0x238
	bool bIsChild; // 0x239
	bool bUnconsciousSpawnBleedout; // 0x23a
};
...
struct FCharacterBio {
	...
	FText Bio; // 0x30
	TSoftObjectPtr<UTexture2D> ProfileImage; // 0x48
	FText Sex; // 0x70
	FText Build; // 0x88
	FText Height; // 0xa0
	FText Weight; // 0xb8
	FText Hair; // 0xd0
	FText Eyes; // 0xe8
	FText DateOfBirth; // 0x100
	FText Age; // 0x118
	TArray<FCriminalRecord> CriminalRecord; // 0x130
};
...
struct FScriptedFireAt {
	...
	float AccuracyPenaltyMultiplier; // 0x10
};
...
struct FHm_CyberneticsInformation {
	FTransform CharacterTransform; // 0x0
	ETeamType TeamType; // 0x30
	float Health; // 0x34
	bool bIsArrested; // 0x38
	bool bIsSurrendered; // 0x39
	bool bHasBeenReported; // 0x3a
	TArray<FName> Tags; // 0x40
	ABaseItem* EquippedItemClass; // 0x50
	FCharacterMesh CharacterMeshData; // 0x58
};
...
struct FMapLayout {
	...
	float MapSize; // 0x8
	TSoftObjectPtr<UTexture2D> MapOverviewTexture; // 0x10
	TMap<FString, TSoftObjectPtr<UTexture2D>> MapCells; // 0x38
};
...
struct FImpactFx {
	...
	TSoftObjectPtr<UTexture2D> PaintMaterialTexture; // 0x28
};
...
struct FNVGPostProcessSettings {
	TSoftObjectPtr<UTexture2D> DirtMaskTexture; // 0x0
	EDepthOfFieldMethod DepthOfFieldMethod; // 0x28
	float BloomIntensity; // 0x2c
	float BloomThreshold; // 0x30
	EAutoExposureMethod AutoExposureMethod; // 0x34
	float BloomDirtMaskIntensity; // 0x38
	float DepthOfFieldFstop; // 0x3c
	float LensFlareIntensity; // 0x40
	float LensFlareBokehSize; // 0x44
	float AmbientOcclusionIntensity; // 0x48
	float IndirectLightingIntensity; // 0x4c
	float FilmSlope; // 0x50
	float FilmToe; // 0x54
};
...
struct FMirrorReflectionSettings {
	float MirrorResolutionScale; // 0x0
	char bShowAntiAliasing : 1; // 0x4
	char bShowDecals : 1; // 0x4
	char bShowDynamicShadows : 1; // 0x4
};
...
struct FAttachmentUIElements {
	TSoftObjectPtr<UTexture2D> ImageOfScope; // 0x0
	TSoftObjectPtr<UTexture2D> SightPicture; // 0x28
	TSoftObjectPtr<UTexture2D> AttachmentIcon; // 0x50
};
...
struct FHm_BombInformation {
	FString BombName; // 0x0
	EBombState BombState; // 0x10
	float TimeRemaining; // 0x14
};
...
struct FGrenadeData {
	FString Name; // 0x0
	TSoftObjectPtr<UTexture2D> Image; // 0x10
	EItemClass ItemClass; // 0x38
	TSoftClassPtr<UObject> Blueprint; // 0x40
};
...
struct FLoadAdditionalLevels {
	TArray<FString> SubLevelNames; // 0x0
};
...
struct FItemSelectionPanelSetting_ItemGroup {
	...
	TSoftObjectPtr<UTexture2D> ItemGroupIcon; // 0x28
	TArray<ABaseItem*> Items; // 0x50
};
...
struct FUniformData {
	FText Name; // 0x0
	TSoftObjectPtr<UTexture2D> Image; // 0x18
...
struct FHm_PlayerInformation {
	...
	TArray<char> SaveData; // 0x10
	FTransform CharacterTransform; // 0x20
	FRotator ControlRotation; // 0x50
	float Health; // 0x5c
	ABaseItem* EquippedItemClass; // 0x60
	TArray<FHm_InventoryInformation> Inventory; // 0x68
	int32_t TotalGrenades; // 0x78
	int32_t TotalDevices; // 0x7c
	bool bHasBeenReported; // 0x80
};
...
struct FCharacterLookOverride : FTableRowBase {
	...
	TSoftObjectPtr<UTexture2D> BodyIcon; // 0x38
	FText FriendlyHeadName; // 0x60
	UTexture2D* HeadIcon; // 0x78
	TMap<ABaseArmour*, USkeletalMesh*> ArmorOverrideMap; // 0x80
	TSoftObjectPtr<USkeletalMesh> FPMeshOverride; // 0xd0
	TSoftObjectPtr<USkeletalMesh> FPBodyMeshOverride; // 0xf8
	TSoftObjectPtr<USkeletalMesh> FaceMeshOverride; // 0x120
	TSoftObjectPtr<USkeletalMesh> BodyMeshOverride; // 0x148
};
...
struct FItemVisualData {
	TSoftObjectPtr<UTexture2D> ItemIcon; // 0x0
	TSoftObjectPtr<UTexture2D> PremissionPlanningItemIcon; // 0x28
	TSoftObjectPtr<UTexture2D> RadialItemIcon; // 0x50
	USkeletalMesh* ItemMesh; // 0x78
	TArray<TSoftObjectPtr<UTexture2D>> AmmoIcons; // 0x80
};
...
struct FLevelFloorData {
	...
	TSoftObjectPtr<UTexture2D> FloorLayout; // 0x30
	TSoftObjectPtr<UMaterialInterface> FloorplanMaterial; // 0x58
};
...
struct FWeaponData {
	...
	FString Name; // 0x10
	TSoftObjectPtr<UTexture2D> Image; // 0x20
	FText WeaponType; // 0x48
	EItemClass ItemClass; // 0x60
	TSoftClassPtr<UObject> Blueprint; // 0x68
	EAmmoType SelectedAmmoType; // 0x90
	float PointsAvailable; // 0x94
	TSoftObjectPtr<UTexture2D> FactorySkinImage; // 0x98
	TArray<USkinComponent*> AvailableSkins; // 0xc0
	USkinComponent* CurrentSkin; // 0xd0
};
...
struct FAttachedSkeletalMeshData {
	TSoftObjectPtr<USkeletalMesh> SkeletalMesh; // 0x0
	bool bUseMasterPose; // 0x28
	FName Socket; // 0x2c
	USkeletalMeshComponent* SkeletalMeshComponent; // 0x38
};
