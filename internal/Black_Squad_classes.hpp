...
struct UCCSBTCombatMelee {
	ObjectProperty CAIP; // 0xcc
};

struct ACombatPawn_TrophyTurret {
...
struct UCBUIDataStore_PendingDialogMessage {
	TArray<FDialogMessage> DialogMessageList; // 0x98
};

struct UCombatHUD_MarkerMenu {
...
struct UCombatHUD_ObserverInfo {
...
struct UCombatDataTableRefPenaltyBind {
	FString Penalty; // 0x6c
	FString ModeGroup; // 0x7c
};

struct ACombatStaticMeshActor {
	WordProperty MeshActorIndex; // 0x250
};

struct USeqAct_CombatTutorial_HideHUD {
...
struct UCombatAnimNodeSequenceByBoneRotation {
...
struct UCombatDataTableRefCompetitivePenalty {
...
struct ACombatWeaponBase_Melee {
...
struct UCombatWeaponRISBase_GrenadeLauncher {
...
struct USeqAct_CombatTutorial_Dialogue {
	TArray<FTutorial_Dialogue> Dialogues; // 0x108
	int32_t Cnt; // 0x118
};

struct ACombatSeizeGameBase {
...
struct UCombatAnimNotify_MaterialParam {
...
struct UCombatFrontEnd_AwaitList {
...
struct UParticleModuleKillVolume {
...
struct UCombatHUD_MagazineState {
...
struct UCombatDataTableRefItemOption {
	FString OPCode; // 0x6c
	int32_t OPSlot; // 0x7c
...
struct ACombatDroppedSupplies_MediKit {
	int32_t HealRate; // 0x35c
};

struct UCombatDataTableRefAIRewardRank {
...
struct UCombatDataTableRefGameChannel {
	int32_t Index; // 0x6c
...
struct UCombatUIDataProvider_MenuOption {
...
struct UCombatAnimNodeAdditveBlending {
...
struct UCombatDataTableRefHelpTab {
...
struct UCombatPracticeGameMovie {
...
struct UCombatDataTableRefClanColor {
	int32_t Idx; // 0x6c
	int32_t R; // 0x70
	int32_t G; // 0x74
	int32_t B; // 0x78
...
struct UCombatDataTableRefKillCombo {
	FString ModeCodeName; // 0x6c
...
struct UCombatHUD_HitDamageBoard {
...
struct UCombatDataTableRefLimitSale {
...
struct UCombatFrontEnd_Event_MissionTab {
...
struct UCombatDataTableRefPingGroup {
...
struct UCombatDataTableRefPublisherWorld {
...
struct UCombatFrontEnd_Object {
	uint32_t bPopUp : 1; // 0xcc
	uint32_t bDisplayed : 1; // 0xcc
};

struct UCombatCharacterTransaction {
...
struct UGripCondNode_TargetDirection {
...
struct UCombatFrontEnd_ItemSellPopup {
	FInvenItemInfo SellItemInfo; // 0xd0
	TArray<int32_t> SellSlotList; // 0x108
};

struct UMaterialExpressionTextureSampleParameterCubeLOD {
...
struct UGripBTEventCondition {
	EventLifetime Lifetime; // 0xc0
	FString EventType; // 0xc4
};

struct UCombatDataTableRefPreset {
...
struct ACombatWeapAttachMeshActor {
...
struct ACombatDroppedSupplies_AmmoKit {
...
struct UCombatDataTableRefClanMark {
	int32_t Idx; // 0x6c
...
struct UCombatFrontEnd_ClanJoinPopup {
...
struct ACombatVolumetricsActor {
...
struct UCombatDataTableRefCallingCard {
...
struct UCombatAIDecisionComponent {
	uint32_t bTriggered : 1; // 0x88
};

struct UCombatHUD_KillMark {
...
struct UCombatHUD_HitIndicator {
	ObjectProperty Direction[0x7]; // 0xc0
};

struct UCombatFrontEnd_Exchange {
...
struct UInterpGroupTimeDilation {
...
struct UCombatUIDataStore_StringAliasMap {
...
struct UCombatAnimNotify_HideBoneForAttachedMesh {
...
struct ACombatPlayerReplicationInfoBase {
...
struct UCombatStatisticsTransaction {
...
struct UCombatHUD_CTFPointArea {
...
struct UCombatHUD_TacticalMapAndScoreboard {
...
struct USeqEvent_InGameClientEvent {
	FName EventName; // 0x128
	Team TeamIndex; // 0x130
};

struct UCombatAnimNodeSequence {
...
struct ACombatDummyClientController {
...
struct UCombatHUD_VoiceChatTalking {
	TArray<FString> CurrentTalkingUsers; // 0xc0
};

struct ACombatSEIGamePC {
...
struct UCombatAnimBlendByDeath {
...
struct UCCSBTOrientTowardTarget {
	ECCSAlertnessState Alertness; // 0xbc
};

struct ACombatBusterActor {
...
struct UCombatSkelCtrl_WeaponLag {
...
struct UGripBTClearState {
	FString StateName; // 0xbc
};

struct USeqAct_ToggleOutLine {
...
struct UGripBlackboard {
	FPointer BB; // 0x60
};

struct UCombatDataTableRefMatchMakingOption {
	FString CodeName; // 0x6c
...
struct UCombatAnimBlendDirectional {
...
struct UCombatSceneCapture2DComponent {
...
struct UCombatHandGripController {
...
struct UCombatDataTableRefMatchMaking {
	int32_t Id; // 0x6c
...
struct UCombatDataTableRefStat {
	int32_t Index; // 0x6c
	FString CodeName; // 0x70
...
struct UCombatChampionshipObserverInput {
...
struct ACBInventoryManager {
	uint32_t bInfiniteAmmo : 1; // 0x270
	ObjectProperty PreviousWeapon; // 0x274
};

struct UGripBTSetState {
	FString StateName; // 0xbc
};

struct UGripActionNode_AimingFocus {
...
struct UCombatFrontEnd_MakeRoom {
...
struct UCombatFrontEnd_MatchroomPopup {
...
struct UCombatDataTableRefEvolveEquip {
...
struct UCombatFrontEnd_MainLobby {
...
struct USeqAct_CombatSetGravity {
	float Gravity; // 0x108
};

struct ACombatWeapon_Bomb {
...
struct UCCSBTCombatThrowGrenade {
	ObjectProperty CAIP; // 0xcc
...
struct UCombatDataTableRefSkillLicense {
	int32_t Index; // 0x6c
	int32_t GRADE; // 0x70
...
struct USeqAct_CCSTriggerEvent {
...
struct ACombatAmmoPickupFactory {
...
struct ACombatWeaponBase_MiniGunBase {
...
struct USeqAct_CombatTutorial_PointAI {
	ObjectProperty AIPawn; // 0x108
};

struct UCBUIDataStore_HUD {
...
struct ACBWeaponAttachment_DualWeaponBase {
...
struct UCombatAIActionNode_SelectTarget {
...
struct UCombatDataTableRefBoosterItem {
	int32_t Index; // 0x6c
	FString CodeName; // 0x70
...
struct UCombatDataTableRefAchievement {
	int32_t Index; // 0x6c
	FString CodeName; // 0x70
	FString Stat; // 0x80
	int32_t Type; // 0x90
...
struct UCombatDataTableRefPickUpDisplay {
	int32_t Min; // 0x6c
	int32_t Max; // 0x70
	int32_t String_ID; // 0x74
};

struct ACombatSEIModePRI {
...
struct UCombatDataTableRefCrosshair {
	int32_t Id; // 0x6c
...
struct UCombatFrontEnd_Inventory {
...
struct UGripCondNode_TargetReachable {
	ECurAITarget CurAITarget; // 0xec
	uint32_t bNegative : 1; // 0xf0
};

struct UCombatDataTableRefEvolveLevelup {
...
struct UCombatDataTableRefPenalty {
	int32_t Idx; // 0x6c
	FString CodeName; // 0x70
...
struct ACombatEvolveGunSupplyPointActor {
...
struct UCombatFrontEndLocalSoundGroup_Base {
...
struct UCombatHUD_Bombsite {
	ObjectProperty BombsiteObject; // 0x1b0
};

struct ACombatTeamGame {
...
struct UCombatAnimBlendByDamage {
	ObjectProperty Owner; // 0x144
...
struct UCombatDataTableRefRank {
	int32_t Index; // 0x6c
	FString CodeName; // 0x70
...
struct UCombatDataTableRefDecomposition {
...
struct UCombatAnimNodeSeqDirection {
...
struct UCombatDataTableRefExtendPeriodBind {
	FString ItemCodeName; // 0x6c
...
struct UCombatDataTableRefHelpDetailInfo {
	FString CodeName; // 0x6c
...
struct UCombatAnimNotify_CameraEffect {
...
struct UCCSBTCombatSwitchWeapon {
	EWeaponGroup WeaponSlotIndex; // 0xcc
	ObjectProperty bc; // 0xd0
};

struct UCombatSkill_UAVPatrol {
...
struct UCombatFrontEnd_AttendanceEvent {
	int32_t CurrentAttendID; // 0xd0
	uint32_t bShow : 1; // 0xd4
};

struct UCombatFrontEnd_BaseShop {
...
struct UCombatFrontEnd_CreateCharacter {
...
struct UCBUIDataStore_QuickstartSetting {
...
struct UCombatDataTableRefShopCategory {
	int32_t Index; // 0x6c
	FString CodeName; // 0x70
...
struct UCombatServerRewardData {
...
struct UCombatHUD_SelectPosition {
...
struct UCombatDataTableRefModeGroupBindMode {
	FString ModeCodeName; // 0x6c
	FString ModeGroupCodename; // 0x7c
...
struct UGripCondNode_TargetHealth {
	ECurAITarget CurAITarget; // 0xec
	BTConditionOperator Op; // 0xed
	int32_t Health; // 0xf0
};
...
struct UCombatAnimBlendBaseByZoom {
	ObjectProperty Weapon; // 0x144
};

struct ACombatEvolveGunSupplyPointActorManager {
...
struct UCombatDataTableRefDrop {
	int32_t Index; // 0x6c
	FString CodeName; // 0x70
...
struct ACombatDemGameReplicationInfo {
...
struct UMaterialExpressionTextureSampleLOD {
...
struct UCombatDataTableRefMatchMakingByRating {
	FString CodeName; // 0x6c
...
struct UCombatHUD_MarkerContainer {
...
struct UCombatLobbyTransaction {
...
struct ACombatAIGameReplicationInfo {
...
struct UCombatDataTableRefFrontEndMode {
	FString CodeName; // 0x6c
	char ActivationType; // 0x7c
};

struct UCombatMeshBuilder {
	EMeshCompositionType MeshCompositionType; // 0x60
};

struct UCombatHUD_IFFContainer {
	ObjectProperty AttachLayerMC; // 0xc0
...
struct AComBatPC_AIGame {
	ObjectProperty AIAggroMeSound; // 0xbe4
	ObjectProperty AIAggroMeReleaseSound; // 0xbec
};

struct UMaterialExpressionTextureSampleParameterEnvCube {
...
struct UCombatDataTableRefItemDetailinfo {
	int32_t Index; // 0x6c
	FString CodeName; // 0x70
...
struct UCombatInGameLocalSoundGroup_Base {
...
struct UActorFactoryCombatWeapAttachMeshActor {
	FString DefaultSkeletalMesh; // 0xb4
};

struct UCombatMain_FrontEnd {
...
struct UCombatDataTableRefDefine {
	int32_t Index; // 0x6c
...
struct UCombatAnimNotify_StopFrame {
	float PassedTime; // 0x60
};

struct UGripBTDummyAction {
...
struct UCombatDataTableRefExchangeCash {
	int32_t Id; // 0x6c
...
struct UCombatVoiceInterfaceVivox {
...
struct UCombatDataTableRefMarkerOption {
...
struct UCombatDataTableRefShopItem {
	int32_t Index; // 0x6c
	FString CodeName; // 0x70
...
struct UCombatAnimNodeSeq_Offset {
...
struct ACombatOccupiedAreaData {
...
struct UCombatDialogCombiinationAudio {
...
struct UCombatHUD_RadioMessage {
...
struct UActorFactoryTutorialAI {
...
struct UCombatFrontEnd_Channel {
...
struct UCombatHUD_CharacterInfo {
	int32_t LastHealth; // 0xc0
...
struct AAIDebugCameraController {
...
struct UCombatRandomBoxTransaction {
	TArray<FRandomBoxPickUpInfo> RandomBoxPickUpList; // 0x60
};

struct UCombatAnimNotify_HideBone {
...
struct UCombatDataTableRefEvolveModeOption {
...
struct UCombatAnim_TurnInPlace_Player {
...
struct UCombatHUD_KillDeathList {
	FString KillDeathList_KillTypeIcons[0x7]; // 0xc0
};

struct UCombatHUD_RoundStatusBar {
...
struct UCombatDataTableRefModeOption {
	int32_t Index; // 0x6c
	FString CodeName; // 0x70
	int32_t Show; // 0x80
...
struct UCombatSkill_AirStrike {
	EAnnounceableSkillType AnnounceSkill; // 0xc8
};

struct UCombatDataTableRefGear {
	int32_t Index; // 0x6c
	int32_t Cost; // 0x70
	int32_t NameID; // 0x74
...
struct UCombatWeaponRISBase_Scope {
...
struct ACombatCTFGameReplicationInfo {
	int32_t VC_FlagScore; // 0x380
	int32_t PM_FlagScore; // 0x384
};

struct ACombatAIPawn_TDMBase {
...
struct UCombatInstanceItem_ArmorBase {
...
struct UCombatFrontEnd_CallingCardPage {
...
struct UCombatDataTableRefShopTab {
	int32_t Index; // 0x6c
	FString MainTab; // 0x70
	FString SubTab; // 0x80
};

struct UCombatFrontEnd_MatchResult {
...
struct UCombatDataTableRefCompetitiveRewardPopup {
...
struct UCombatFrontEnd_SpecialGoodsInfoPopup {
...
struct UParticleModuleSizeScaleByDistance {
...
struct USeqAct_CombatTutorial_QuestOff {
...
struct ACombatPlayerControllerBase {
...
struct ACombatBotReplicationInfo {
...
struct UCombatFrontEnd_CharacterInfo {
	ObjectProperty TabList[0x4]; // 0xd0
};

struct UCombatHUD_BlockAndReport {
...
struct ACombatDroppedEvolvePoint {
	int32_t GRADE; // 0x320
...
struct ACombatPawn_AttackSkillActor {
...
struct UInterpTrackInstTimeDilation {
	float OldTimeDilation; // 0x60
};

struct UCombatSkelCtrl_Recoil {
...
struct UCombatWeaponRISBase_LaserPoint {
...
struct UCombatMatchroomClanMatching {
...
struct UCombatDataTableRefRankUp {
	int32_t Id; // 0x6c
	int32_t Rank; // 0x70
...
struct UCombatDataTableRefInitItem {
	FString CodeName; // 0x6c
...
struct UCombatDataTableRefModeTip {
	int32_t Index; // 0x6c
	FString CodeName; // 0x70
...
struct UCombatFrontEnd_Event_AttendanceCheckTab {
	TArray<FRewardItemStruct> RewardItemList; // 0x6c
};

struct ACombatRadarCore {
...
struct UCombatAnimNodeCopyBoneTranslation {
...
struct UCombatFrontEnd_ClausePopup {
	FString URL; // 0xd0
};
...
struct AComBatPC_AIGameTDMStandAlone {
...
struct ACombatASAGameReplicationInfo {
...
struct ACombatTutorialGameReplicationInfo {
...
struct UCombatAnim_TurnInPlace_Rotator {
...
struct UCombatAnimNodeJumpLeanOffset {
...
struct ACombatProj_SmokeGrenade {
...
struct UCombatDataTableRefTierSeason {
	FString ModeCodeName; // 0x6c
...
struct ACombatAIPawn_SelfDestuctBase {
...
struct UCombatDataTableRefReward {
	int32_t Index; // 0x6c
	FString CodeName; // 0x70
...
struct UCombatHUD_CompetitionWarmUp {
	int32_t UI_ReaminSecond; // 0xc0
};

struct UCombatCommon_Option {
...
struct UCombatRadialBlurComponent {
	float LifeSpan; // 0xf8
...
struct UCombatFrontEnd_ClanInfoChangePopup {
...
struct UCombatHUDOption_AIWaveRoundStatus {
...
struct UCombatDataTableRefShopRotation {
	FString ItemCodeName; // 0x6c
...
struct UCombatHUD_BombsitesContainer {
...
struct UCombatAnimBlend_SimpleJump {
...
struct ACBWeaponAttachment_ParachuteBase {
...
struct UCombatDataTableRefShop {
	int32_t Index; // 0x6c
	FString CodeName; // 0x70
...
struct UCombatFrontEnd_Dashboard {
...
struct UCombatDataTableRefGameScoring {
	int32_t Index; // 0x6c
	FString CodeName; // 0x70
	int32_t Score; // 0x80
...
struct UCombatGameViewportClient {
...
struct ACombatWavePawn_JuggernautBase {
...
struct UCombatDataTableRefShopValue {
	int32_t Index; // 0x6c
...
struct UCombatDataTableRefModeMap {
	FString ModeCodeName; // 0x6c
...
struct UCombatTutorialGameMovie {
	ObjectProperty BombContainer; // 0xad0
...
struct UCombatDataTableRefARaceLevelUp {
	int32_t Id; // 0x6c
	int32_t Rank; // 0x70
...
struct ACombatTDMGameBase {
	WordProperty SuddenDeathTime; // 0x788
};

struct UMaterialExpressionTextureSampleParameterFlipbook {
...
struct UCombatAnimMetaData_SkelControl {
...
struct ACombatWeapon_Skill_Weapon {
...
struct ACombatPawn_PracticeGame {
...
struct UCombatChampionshipManager {
	TArray<FChampionshipTeamData> ChampionshipTeamList; // 0x60
};

struct UCombatWeaponRISBase_modifiedIronSight {
	uint32_t IronSight : 1; // 0xd08
};

struct UCombatHUD_GameModeHelp {
...
struct UCombatFrontEnd_UserInfo {
...
struct UCombatDataTableRefItem {
	int32_t Index; // 0x6c
...
struct ACombatWeapon_Shotgun_Base {
	int32_t TransientShotgunDamage; // 0x1ec8
};

struct ACombatBombardActor {
...
struct UCombatAnim_TurnInPlace {
...
struct UCCSAFFireBurst {
	ObjectProperty Target; // 0x64
};

struct ACombatRepairingArea {
	ComponentProperty Mesh; // 0x244
};

struct UCombatItemTransaction {
...
struct UCombatAIActionNodeBase {
...
struct UGripCondNode_WeaponPossession {
	EWeaponGroup WeaponGroup; // 0xec
	uint32_t bNegative : 1; // 0xf0
};

struct UCombatAIAction_SelectTarget {
	ObjectProperty ActionNode; // 0x78
};

struct ACombatEffectKillZoneVolume {
...
struct UCombatDataTableRefRandomBox {
	FString ItemCodeName; // 0x6c
...
struct UCombatDataTableRefSupportUserGroup {
	FString CodeName; // 0x6c
	int32_t UserCount; // 0x7c
};

struct UCombatAnimNodeScaleRateBySpeed {
...
struct UCombatHUD_ExitContainer {
...
struct UCombatDataTableRefQuest {
	int32_t Index; // 0x6c
...
struct ACombatPlayerReplicationInfo {
...
struct UCCSBTCombatTargetExistence {
...
struct UCombatFrontEnd_Community {
...
struct UGripAction_MoveRightAndLeft {
	ObjectProperty ActionNode; // 0x78
	char CurDir; // 0x80
...
struct UCombatFPMuzzleFlashLight {
...
struct ACombatProj_FlashBang {
	float fFlashbangSoundTime; // 0x3f4
};

struct UCombatFrontEnd_MatchRoom {
...
struct UCombatFrontEnd_TacticalGear {
...
struct UCombatDataTableRefQuestShortcut {
	FString CodeName; // 0x6c
...
struct UCombatDataTableRefSystemImage {
	int32_t ImageID; // 0x6c
	int32_t GRADE; // 0x70
	E_SYSTEM_IMAGE_TYPE ImageType; // 0x74
};

struct UCombatAIActionNode_Roamming {
	uint32_t bIsWalking : 1; // 0xf4
...
struct UCombatDataRefDecorationColor {
	int32_t Index; // 0x6c
	char Color_R; // 0x70
	char Color_G; // 0x71
	char Color_B; // 0x72
...
struct UCombatHUDEntity_Base {
	EActivateType LastActivateType; // 0xbc
};

struct UCombatCameraThirdPersonCameraMode_default {
	uint32_t bResetInterpolationOnActive : 1; // 0x264
};

struct ACombatDemModePRI {
...
struct UCombatDataTableRefItemOptionBind {
...
struct UCombatDataTableRefClanExp {
	int32_t Level; // 0x6c
	int32_t GoalExp; // 0x70
...
struct UGripActionNode_MoveToward {
...
struct UCombatCommon_SystemCounter {
...
struct UCombatDataTableRefPingGroupBindRegion {
	int32_t Index; // 0x6c
	int32_t ServiceRegionID; // 0x70
	int32_t PingGroupID; // 0x74
};

struct UCombatFrontEnd_Event_TabBase {
	ObjectProperty ParentMoviePlayer; // 0x60
	uint32_t bShowTab : 1; // 0x68
};

struct ACombatProj_Rocket {
	float RocketLifetime; // 0x3e4
};

struct UCombatDataTableRefMailCategory {
...
struct UCombatDataTableRefSeasonPass {
	int32_t Season; // 0x6c
...
struct ACombatProj_SpecialGrenade {
...
struct UCombatWeaponRISBase_Aiming {
...
struct UCombatDataTableRefBasicChat {
	int32_t Index; // 0x6c
	FString CodeName; // 0x70
	int32_t Size; // 0x80
...
struct UCombatDataTableRefRandomBoxCost {
	FString ItemCodeName; // 0x6c
	int32_t BoxResourceIndex; // 0x7c
	uint32_t bChangeScene : 1; // 0x80
};

struct UCombatLocaizedChatCommandData {
	int32_t Index; // 0x6c
...
struct ACombatWeaponPickupFactory {
...
struct USeqAct_SpawnGroupIndex {
...
struct UCombatDataTableRefServiceRegion {
	int32_t Id; // 0x6c
	FString CodeName; // 0x70
	FString URL; // 0x80
	int32_t Port; // 0x90
...
struct UCombatTestRTMoviePlayer {
	ObjectProperty MyRenderTarget; // 0x308
};

struct UCombatFrontEnd_Chat {
...
struct UCombatDataTableRefCubeBox {
...
struct UCombatDataTableRefARaceEquip {
...
struct UCombatGameOptionTransaction {
...
struct UCombatAnimBlendByDamageType {
	ObjectProperty Owner; // 0x120
};

struct ACombatHUD_PracticeGame {
...
struct ACombatFlashExplosionActor {
...
struct UCombatFrontEnd_RotationInfoPopup {
...
struct ACombatWaveBotController {
...
struct UCombatDataTableRefFilter {
	int32_t Index; // 0x6c
...
struct USeqAct_CombatDisplayMessage {
...
struct UCombatDataTableRefPickup {
	int32_t Index; // 0x6c
	FString CodeName; // 0x70
...
struct UGripCondNode_TargetRange {
	ECurAITarget CurAITarget; // 0xec
	BTConditionOperator Op; // 0xed
...
struct UCombatDataTableRefNation {
	FString CodeName; // 0x6c
	int32_t Order; // 0x7c
...
struct UCombatDataTableRefClanRegion {
	int32_t Index; // 0x6c
...
struct UCombatFrontEnd_Achieve {
...
struct ACombatRescueGameBase {
	WordProperty LastMissionTime; // 0x788
};

struct UCombatChannelTransaction {
...
struct UCombatFrontEnd_MedalShop {
...
struct ACombatRSCGameReplicationInfo {
...
struct UCombatAnimBlendByRISSlot {
	ObjectProperty Owner; // 0x144
	RISSlot ActivatedSlot; // 0x14c
};

struct ACombatSentinelManager {
	uint32_t bDoingASentinelRun : 1; // 0x244
...
struct ACombatGamePlayerCamera {
...
struct UCombatWeaponRISBase_SkeletalmeshComponent {
...
struct UCombatPracticePlayerInput {
...
struct UCombatCameraThirdPersonCameraMode_Dead {
...
struct UCombatLockedPresetScene {
...
struct UCombatAnimNotify_SwitchAnim {
...
struct UCombatFrontEndMoviePlayer {
...
struct ACombatSEIGameReplicationInfo {
...
struct UCombatDataTableRefTier {
...
struct UCombatUIDataStore_StringAliasBindingMap {
	int32_t FakePlatform; // 0xf4
	FMap_Mirror CommandToBindNames; // 0xf8
	TArray<FControllerMap> ControllerMapArray; // 0x140
};

struct UCombatDataTableRefTypeDefine {
	int32_t CodeID; // 0x6c
	char BUY_AFTER; // 0x70
...
struct UCombatDataTableRefSystemTextColor {
	int32_t GRADE; // 0x6c
...
struct UCombatGameThirdPersonCamera {
...
struct UGripCondNode_TargetVisible {
	ECurAITarget CurAITarget; // 0xec
	uint32_t bNegative : 1; // 0xf0
};
...
struct UGripCondNode_TargetExistence {
	ECurAITarget CurAITarget; // 0xec
	uint32_t bNegative : 1; // 0xf0
};
...
struct ACombatArmsRaceGameReplicationInfo {
...
struct UCombatDemolitionGameMessage {
	int32_t BombPickupTextID; // 0x84
	int32_t BombDropTextID; // 0x88
};

struct UCombatDataTableRefShopSellItem {
...
struct ACombatOccupiedAreaVolume {
...
struct UCombatHUD_MarkerObject {
...
struct UCombatDataTableRefCompetitiveBindMode {
	FString SeasonCodeName; // 0x6c
...
struct UCombatHUD_ChampionshipSpectatedPlayerInfo {
...
struct UCombatAnimNotify_AttachStaticMesh {
	FName SocketName; // 0x60
	FName TargetBoneName; // 0x68
	ObjectProperty StaticMesh; // 0x70
...
struct UGripActionNode_SelectEnemy {
...
struct UCombatCommon_OverImmersionGuard {
...
struct UCombatFrontEnd_ClanHome {
...
struct UGripActionNode_MoveRightAndLeft {
	uint32_t bIsWalking : 1; // 0xf4
	float DirChangeTime; // 0xf8
};

struct UCombatStatDataStore {
...
struct ACombatProj_ExplosiveBase {
...
struct UCombatFrontEnd_RandomBoxShopBuyPopup {
...
struct UCombatHUD_Message_RoundOver {
...
struct UCCSAFEnterCover {
	ObjectProperty CoverLink; // 0x64
	ObjectProperty Target; // 0x6c
};

struct UCombatFrontEnd_MatchMember {
...
struct UCombatDataTableRefItemUnLockRecipe {
	FString ItemCodeName; // 0x6c
...
struct ACombatChampionshipObserverPC {
...
struct UCombatAnimBlendByParts {
	ObjectProperty Owner; // 0x120
...
struct UCombatAIActionNode_Sleep {
	float SleepTime; // 0xf4
};

struct UCombatEvolveGunGameScore {
...
struct ACombatTeamBlockingVolume {
	Team IgnoreBlockTeam; // 0x284
};

struct UGamePlayEvent_Action {
...
struct UCombatDataTableRefTodayGameBindMode {
...
struct USeqAct_SetPawnSpeed {
	float GroundSpeed; // 0x108
	TArray<ObjectProperty> Actors; // 0x10c
};

struct UCombatFirstAnimBlendByIdle {
	ObjectProperty Weapon; // 0x144
};

struct UCombatHUD_Aim {
...
struct UParticleModuleEventReceiverSound {
...
struct UCombatAnimBlendBySlotActive {
	ObjectProperty ChildSlot; // 0x144
};

struct UCombatDataTableRefGameChannelProperty {
...
struct UCCSATBlendListBase {
	float BlendTime; // 0x120
};

struct ACombatAIGameRadarCore {
	UObject* BotClass; // 0x46c
};

struct UCombatObjectPool {
...
struct UCombatInGameResourcePool {
...
struct UCBPhysicalMaterialProperty {
...
struct UCombatSteamAchivementManager {
	TArray<FSteamAchievementData> SteamAchievements; // 0x60
};

struct UCombatHUD_OccupiedArea {
	ObjectProperty AreaVolume; // 0x1b0
};
...
struct UCombatDataTableRefMoneyDisplay {
...
struct UCombatCTFGameScore {
	FScoreStruct FlagHoistedScore; // 0x60
};

struct ACombatMinimapActor {
...
struct UGripBTBooleanCondition {
...
struct UCombatFrontEnd_CharacterInfo_TabBase {
	ObjectProperty ParentMoviePlayer; // 0x60
};
...
struct ACombatIngameVoteManager {
...
struct UParticleModuleRadialBlur {
...
struct UCombatInGameOptionMenu {
...
struct USeqAct_CombatTutorial_QuestOn {
	FString QuestID; // 0x108
...
struct UCombatDataTableRefMode {
	int32_t Index; // 0x6c
	FString CodeName; // 0x70
...
struct ACombatStaticMeshReplicationInfo {
...
struct UCombatFrontEnd_Repurchase {
...
struct UCombatUserInfoTransaction {
...
struct UCombatDataRefDecorationParticle {
	int32_t Index; // 0x6c
...
struct UCombatHUD_NoticePosition {
	EUIGameStatus CurrentStatus; // 0xc0
...
struct UCombatDataTableRefWeaponGroup {
	int32_t Id; // 0x6c
...
struct UCombatHUD_BigSizeStringTextBox {
...
struct ACombatWeaponBase_Parachute {
...
struct UCombatDemoRecSpectatorMovie {
...
struct UCombatHUD_ObserverHelp {
	uint32_t bInitKeyData : 1; // 0xc0
};

struct UGripBTNumericCondition {
...
struct UCombatCommunityTransaction {
...
struct UCombatAIAction_MoveToward {
	ObjectProperty ActionNode; // 0x78
...
struct UCombatDataTableRefTodayGame {
	int32_t Idx; // 0x6c
	FString CodeName; // 0x70
...
struct UCombatFrontEnd_WeaponTuningPopup {
...
struct UCombatStaticMeshManager {
	ObjectProperty CBGRI; // 0x60
	TArray<ObjectProperty> SMRIList; // 0x68
};

struct ACombatPawn_FlyingVehicle {
...
struct UCombatFrontEnd_ClanList {
...
struct UCombatDataTableRefClanSeasonReward {
	int32_t Season; // 0x6c
	int32_t GRADE; // 0x70
...
struct UCombatDataTableRefShortcut {
	FString ChannelCodeName; // 0x6c
...
struct UCombatDataTableType {
	int32_t EntryIndex; // 0x60
	ObjectProperty DataTable; // 0x64
};

struct UCombatRewardDataBase {
	ObjectProperty Owner; // 0x60
...
struct UCombatAnimBlendPerBone_Multi {
...
struct UCombatAnimBlendByMovement {
	ObjectProperty Owner; // 0x144
};
...
struct UCombatVoiceChatUserList {
...
struct UCombatDataTableRefClanAttendanceReward {
	int32_t Idx; // 0x6c
...
struct UCombatFrontEnd_QuickStart {
...
struct UCombatDataTableRefClanSection {
	char GRADE; // 0x6c
...
struct UCombatFrontEnd_RandomBoxShop {
...
struct UCombatInstanceItem_Spray {
...
struct ACombatWeapon_Plant {
	uint32_t bMartyrdom : 1; // 0x1ee8
};

struct AGroupActorBase {
...
struct ACombatDroppedEvolvePoint_Supply {
...
struct UCCSBTCombatReloadWeapon {
...
struct UCombatHUD_NoticeHotKey {
...
struct USeqAct_SetInitialCover {
	TArray<ObjectProperty> Actors; // 0x108
};

struct UCombatDataTableRefFormula {
	FString CodeName; // 0x6c
	FString Params[0xa]; // 0x7c
};

struct UCombatFrontEnd_Login {
...
struct UCombatAnimNodeSeqHitDirection {
	FName DefaultAnim; // 0x16c
...
struct UCombatHUD_KickUserSelect {
...
struct UHttpResponseWindows {
	FPointer Response; // 0x60
	TArray<char> Payload; // 0x68
};

struct UCombatLocaizedTextData {
	int32_t Index; // 0x6c
	FString StringVal; // 0x70
};

struct ACombatWeapon_Grenade {
...
struct UCCSAFOrientToward {
	FVector Target; // 0x64
	ECCSAlertnessState Alertness; // 0x70
};

struct UCombatFrontEnd_BuyItem {
...
struct UCombatChampionshipCameraManager {
	FString filePath; // 0x60
	FString Section_MapName; // 0x70
	TArray<FString> Key_SpotName; // 0x80
};

struct UCombatFrontEnd_CharacterInfo_BattleTab {
	TArray<int32_t> BattleTabList; // 0x68
};

struct UCCSVisualizationComponent {
	FPointer SceneProxy; // 0x250
};

struct UCombatDataTableRefModeGuide {
	int32_t Index; // 0x6c
	FString CodeName; // 0x70
	int32_t Type; // 0x80
...
struct UCombatFrontEnd_ExtendPeriodItemPopup {
...
struct UCombatHUD_EvolveSupply {
	ObjectProperty TargetActor; // 0x1b0
	int32_t TargetIndex; // 0x1b8
	int32_t LastDisplayHealth; // 0x1bc
	MissionActorUIState LastUIState; // 0x1c0
...
struct ACombatDestructibleObject {
...
struct UCombatDataTableRefSeasonInfo {
...
struct UCombatDataTableRefImagePath {
	int32_t Index; // 0x6c
	FString FullImagePath; // 0x70
};

struct UCCSBTCombatChangeBTTree {
	ObjectProperty bc; // 0xcc
...
struct UCCSBTCombatMovementOnlyNode {
...
struct UCombatFrontEnd_ChangePropernounPopup {
	char PopupMode; // 0xd0
	TArray<FSendTextInfo> SendTextList; // 0xd4
	FString SendText; // 0xe4
};

struct UCombatInGameBattleLog {
...
struct UCBUIDataStore_TacticalGear {
...
struct UCombatDataRefDecorationDecal {
	int32_t Index; // 0x6c
...
struct UCombatGameTrophyTouchComponent {
...
struct UCombatDataTableRefSkill {
	int32_t Index; // 0x6c
	FString CodeName; // 0x70
