...
struct UHeader-Tab-OPTIONS-Promod_C : UUserWidget {
...
struct ABattalionWeapon_Projectile : ABattalionWeapon {
	FProjectileWeaponData ProjectileConfig; // 0x7c0
};

struct UMedalStolen : UMedalBase {
...
struct UABP_Karambit_C : UWeaponAnimInstance {
...
struct UCourseTimesSaveData : UPromodSaveData {
	TMap<FString, FPromodCourseTimeData> CourseTimeData; // 0x50
};

struct ATugOfWarMonorailPath : AMonorailPath {
...
struct UWBP_StaminaBar_C : UStaminaBar {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UPromodGamePadSettingsDataAsset : UDataAsset {
...
struct UWBP_Overtime_Title_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_JumperHUD_C : UHUDMaster {
...
struct ABattalionPlayerSpawn : APlayerStart {
...
struct UWBP_HUDEquipment_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UNUIWelcomeScreen : UNUIScreen {
...
struct ATDMGameMode : ABattalionGameMode {
...
struct ALiveFireGameMode : ATUTGameMode {
...
struct ABombPlayerState : ABattalionPlayerState {
...
struct UMedalStealthCapture : UMedalBase {
	ACTFGameMode* CTFGameMode; // 0x48
};
...
struct AMapEditorObject_Checkpoint : AMapEditorObject {
	AJumperCourse* CourseClass; // 0x318
	int32_t ObjectValue_CheckpointIndex; // 0x320
};

struct UABP_ThrowingAxe_C : UAnimInstance {
...
struct UBP_DashCameraModifier_C : UGuardianCameraModifier {
...
struct UWBP_CargoVictoryProgress_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UBotThirdPersonAnimInstance : UThirdPersonAnimInstance {
...
struct ABattalionTeamStart : APlayerStart {
...
struct UMedal20BombFFA : UMedalBase {
...
struct UABP_Deagle_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
...
struct ABP_StickyGrenade_C : ABattalionGrenade {
	FPointerToUberGraphFrame UberGraphFrame; // 0x3d0
};

struct UWBP_CompleteScreenPB_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UNUISettingsMenu : UNUIScreen {
...
struct ABattalionReplaySpectatorPlayerController : ABattalionPlayerControllerGMBase {
...
struct AVaultAllowVolume : AActor {
...
struct UWBP_Interaction_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_KillfeedEntry_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct AMapEditorController : APlayerController {
...
struct UNUIScoreboardGroup : UNUIBaseUIElement {
...
struct UABP_UNDCKnife_TP_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
...
struct AOneInTheChamberPlayerState : AFFAPlayerState {
...
struct UABP_Offensive_Incendiary_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x308
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x350
...
struct UMedal50BombCTF : UMedalBase {
	ACTFGameMode* CTFGameMode; // 0x48
};

struct ABP_SND_BombZone_C : ABombMode_Zone {
...
struct UBIPF_PlatformHelper : UObject {
	UPlayFabSubsystem* PlayFabSubsystem; // 0x28
};

struct UBattalionOnline : UObject {
...
struct UWBP_Message_C : UGameModeMessage {
...
struct UMedalKillSurvivor : UMedalBase {
	AInfectionGameMode* INFGameMode; // 0x48
};

struct UPromodFireUpActionDataAsset : UDataAsset {
...
struct UNUIRoundResult : UNUIBaseHUDElement {
...
struct USNDLeaderBoard : UUserWidget {
...
struct UJumperMapPackManager : UDataAsset {
...
struct UWBP_GenericBlockedMessage_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ABattalionPlayerController_Menu : APlayerController {
...
struct AHeadquartersPlayerController : ATDMPlayerController {
...
struct AScaledMapBeacon : ABeacon {
...
struct UNUISpectatorStatBar : UNUIBaseHUDElement {
...
struct UHUDTextDataAsset : UDataAsset {
...
struct APromodPlayerState : AWartidePlayerState {
...
struct UBattalionNationDataAsset : UDataAsset {
	TArray<FNationDataEntity> Nations; // 0x30
};

struct UNUIPickup : UNUIBaseHUDElement {
...
struct UWBP_HardpointOverviewScore_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UABP_AmmoBox_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
...
struct UNUIExperienceBar : UNUIBaseUIElement {
...
struct UMedalCapture : UMedalBase {
	ACTFGameMode* CTFGameMode; // 0x48
};

struct UWBP_SNDHUD_C : UHUDMaster {
	FPointerToUberGraphFrame UberGraphFrame; // 0x268
...
struct UPlatformKeyImage : UUserWidget {
...
struct UNUISettingsMenuHeader : UUserWidget {
...
struct UABP_AK47_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_2; // 0x308
	FAnimNode_Slot AnimGraphNode_Slot_2; // 0x388
...
struct UWBP_Announcement_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UCrateDataAsset : UDataAsset {
...
struct USettingsHeader_C : UNUISettingsMenuHeader {
	FPointerToUberGraphFrame UberGraphFrame; // 0x268
...
struct AKillRunWeaponPickup : ABattalionTutorialPickup {
	UAkComponent* DefaultAkComp; // 0x248
	USaveGame* SaveData; // 0x258
	USelectedKitSaveData* KitSaveData; // 0x260
};

struct ADOMPlayerController : ATDMPlayerController {
...
struct UBreadcrumbDataAsset : UDataAsset {
	TArray<FString> breadCrumbs; // 0x30
};

struct AWorldCollapse : AActor {
...
struct UPromodMainMenuScreen : UNUIScreen {
...
struct UDeathCamCameraModifier : UCameraModifier {
	UPromodDeathCamera* DeathCameraComponent; // 0x48
};

struct UADSCameraModifier : UCameraModifier {
...
struct UGrenadeIndicator : UUserWidget {
...
struct ABattalionWeapon_Melee : ABattalionWeapon_Instant {
...
struct UWBP_DamageTakenIndicator_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ABattalionPlayerCameraManager : APlayerCameraManager {
...
struct UPromodAllFireUpsDataAsset : UDataAsset {
...
struct ADOMPlayerState : ATDMPlayerState {
...
struct UVQ3CharacterMovementComponent : UBattalionCharacterMovementBase {
...
struct UABP_WW2Rifle_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x308
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x350
...
struct UWBP_CargoAdvantageAnimWidget_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_BlitzSpectating_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ABP_SnapshotGrenade_C : ASnapshotGrenade {
...
struct UWBP_HUDMasterWidget_C : UHUDMaster {
	FPointerToUberGraphFrame UberGraphFrame; // 0x268
...
struct UWBP_BlitzPlayerAliveIcon_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UNUIDOMScores : UNUIObjectiveScores {
...
struct AOneInTheChamberHUD : AFFAHUD {
...
struct UMedalShutdown : UMedalBase {
...
struct ABattalionStunGrenade : ABattalionGrenade {
...
struct ABP_PlaceableDeployableCover_C : APlaceableTrophySystem {
...
struct UMedalAce : UMedalBase {
	AWartideGameMode* WartideGameMode; // 0x48
	TArray<FAceTracker> AceTrackers; // 0x50
};

struct UNUIScreenEffects : UNUIBaseHUDElement {
...
struct USaveDataManager : UObject {
...
struct UNUIScoreboardRow : UNUIBaseUIElement {
...
struct UPromodOffensiveUtilDataAsset : UDataAsset {
...
struct UABP_UNDCSidearm_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
...
struct AAnimAudioVolume : AActor {
	UBoxComponent* BoxComponent; // 0x220
...
struct UWBP_Overtime_Shootout_Title_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Show; // 0x268
	UImage* Mov_Title; // 0x270
	UMediaPlayer* MP_Title; // 0x278
...
struct UJumperLevelSelect : UUserWidget {
	UMapPackManager* MapPackManager; // 0x260
};

struct UNUIBombMatchResultScreen : UNUIBaseUIElement {
...
struct ABombPlayerController : ABattalionPlayerControllerGMBase {
...
struct ACargoGameMode : APromodTDMGameMode {
...
struct UMedal30BombCTF : UMedalBase {
	ACTFGameMode* CTFGameMode; // 0x48
};
...
struct ABattalionIncendiaryEffect : AActor {
...
struct UServerDirectorySystem : UGameInstanceSubsystem {
...
struct UWBP_HardpointZoneListEntry_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_LoadoutListItem_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UNUIScoreboard : UNUIBaseUIElement {
...
struct ABP_ThrowingKnife_C : ABattalionGrenade {
	FPointerToUberGraphFrame UberGraphFrame; // 0x3d0
...
struct ACTFGameState : ATDMGameState {
...
struct UMedalAggressor : UMedalBase {
...
struct UAB_WW2Knife_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x308
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x350
...
struct ABP_ThrowableDeployableCover_C : AActor {
...
struct UNUIFloatingCard : UNUILoadoutCard {
...
struct UWBP_ClassChanged_C : UUserWidget {
...
struct UNUIWeaponPrompt : UNUIBaseHUDElement {
	FText PromptText; // 0x278
};

struct UWBP_BlitzSpatialMarker_C : UBlitzSpatialMarker {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UImage* Background; // 0x268
	UImage* Icon; // 0x270
...
struct UPromodPingablesDataAsset : UDataAsset {
...
struct UThirdPersonAnimInstance : UAnimInstance {
...
struct UNUIDamageIndicator : UNUIBaseHUDElement {
...
struct UWBP_HardpointGameOverview_C : UHardpointGameOverviewWidget {
...
struct UNUISpectatorTeamLoadout : UNUIBaseUIElement {
	int32_t Team; // 0x278
...
struct UNUINadeControlInfo : UNUIBaseHUDElement {
...
struct UNUIPlayerAvatar : UNUIBaseHUDElement {
...
struct UWBP_SplitsListItem_C : UUserWidget {
...
struct UBattalionSettings : UObject {
...
struct USettings_Backdrop__Option_Unselected_C : UUserWidget {
...
struct UNUIReadyPrompt : UNUIBaseHUDElement {
	bool ReadyState; // 0x278
	FText BindName; // 0x280
	FText RequiredPlayersRemainingText; // 0x298
};

struct UGameLiftSystem : UGameInstanceSubsystem {
...
struct USETTINGS-MM-Button_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_FullscreenMovie_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct AKillRunCourse : AJumperCourse {
...
struct UWBP_WartideOverviewScore_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UHUDGrenadeIcon : UUserWidget {
...
struct UMedalHQAttacker : UMedalBase {
	AHQGameMode* HQGameMode; // 0x48
};

struct UMapSmokeWidget : UUserWidget {
...
struct UMinimapInternal_Icon_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ABP_BlinkFireUp_C : AFireUpAction {
...
struct UWBP_SystemTimeDisplay_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UMinimapInternal_Tooltip_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_CompletionFeedbackButton_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UBattalionWeaponNationDataAsset : UDataAsset {
	TArray<FWeaponNationEntity> weaponNations; // 0x30
};

struct UABP_HandCannon_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x308
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x350
...
struct UWBP_BlitzHUD_C : UBlitzHUDMaster {
	FPointerToUberGraphFrame UberGraphFrame; // 0x268
...
struct ADOMGameState : ATDMGameState {
	TArray<ADOMMode_Zone*> Zones; // 0x4a0
	float CaptureTime; // 0x4b0
};

struct UMedalNeutralised : UMedalBase {
	ADOMGameMode* DOMGameMode; // 0x48
};
...
struct UNUIFFAObjectiveScores : UNUIObjectiveScores {
...
struct ABP_CargoFirstTeamProgressPoint_C : ACargoFirstTeamProgressPoint {
...
struct UNuclearOnlineSystem : UGameInstanceSubsystem {
...
struct UTP_PromodAnimInstance_C : UThirdPersonAnimInstance {
...
struct UWBP_BlitzRoundTracker_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UNUI_ColourPicker : UUserWidget {
	FLinearColor Colour; // 0x270
	bool bSkipAnimationOnConstruction; // 0x280
};

struct UPromodMetricsSystem : UGameInstanceSubsystem {
...
struct UWBP_Flipbook_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct AReplayDataActor : AActor {
...
struct UTextButton_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ABP_MonorailCarriage_C : AMonorailCarriage {
...
struct UMedalTacNade : UMedalBase {
	TArray<FOneTapKillerExpiry> KillerExpiryArray; // 0x48
};

struct UHeader-Bar-Temp_C : UUserWidget {
...
struct ABP_TrophyFireUp_C : AFireUpAction {
	FPointerToUberGraphFrame UberGraphFrame; // 0x3c8
...
struct URarityColourDataAsset : UDataAsset {
	TArray<FRarityColourEntity> RarityColours; // 0x30
};

struct UAB_UNDCSniper_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
...
struct UTutorial-MM-Button_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Simulation-text-off; // 0x268
	UWidgetAnimation* Simulation-activated; // 0x270
	UWidgetAnimation* Pulse; // 0x278
...
struct APerfTestLocation : APlayerStart {
	FString LocationName; // 0x250
};

struct ABP_PlaceableTrophySystem_C : APlaceableTrophySystem {
	FPointerToUberGraphFrame UberGraphFrame; // 0x270
...
struct UABP_StickyGrenade_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x308
	FAnimNode_Slot AnimGraphNode_Slot; // 0x388
...
struct UMedalAnotherNotch : UMedalBase {
	AFFAGameMode* FFAGameMode; // 0x48
};
...
struct UWBP_StaminaAndHealthBars_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ABP_ThrowableTrophySystem_C : ASnapshotGrenade {
	FPointerToUberGraphFrame UberGraphFrame; // 0x298
	FMulticastInlineDelegate OnImpact; // 0x2a0
};
...
struct UWBP_GrenadeIndicator_C : UGrenadeIndicator {
...
struct UPlayFabSubsystemSettings : UObject {
...
struct UMedalBiteBack : UMedalBase {
	AInfectionGameMode* INFGameMode; // 0x48
};
...
struct UPromodActionPrompt : UUserWidget {
...
struct UPromodSaveData : USaveGame {
...
struct UWBP_Inventory_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_KillRunGameOverview_C : UKillRunGameOverviewWidget {
...
struct UABP_Gizmo_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x308
	FAnimNode_Slot AnimGraphNode_Slot; // 0x388
...
struct ABattalionFlashGrenade : ABattalionGrenade {
	FVector2D EffectivenessRange; // 0x3d0
...
struct UBattalionSubtitlesDataAsset : UDataAsset {
...
struct AIncendiaryGrenadePickup : ABattalionGrenadePickup {
...
struct UFPAnimInstance : UAnimInstance {
...
struct UMedalIAmLegend : UMedalBase {
	AInfectionGameMode* INFGameMode; // 0x48
};
...
struct UNUIDOMZoneStates : UNUIBaseHUDElement {
...
struct ABattalionGrenade : AActor {
...
struct UHUDRichTextBlock : URichTextBlock {
...
struct UNUIVault : UNUIBaseHUDElement {
	FText BindName; // 0x278
	FString ButtonProfile; // 0x290
};

struct UWBP_RadialMenuItem_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Selected; // 0x268
	UImage* IMG_ItemImage; // 0x270
};

struct UWBP_SNDLeaderboardItem_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_GrenadeMarker_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UBattalionCharacterComponent : USceneComponent {
...
struct UJumper_LevelSelectPage_C : UUserWidget {
...
struct ASpecialGrenadePickup : ABattalionGrenadePickup {
...
struct UWBP_VersusNotification_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_CargoPlayerIcons_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UMedalDomination : UMedalBase {
	ADOMGameMode* DOMGameMode; // 0x48
};
...
struct UBulkheadAudioEventWrapper : UObject {
	bool bIsLooped; // 0x28
...
struct UHUDWorldMarker : UUserWidget {
...
struct APromodCharacter : ABattalionCharacter {
...
struct UNUIMiniMap : UNUIBaseHUDElement {
...
struct UPromodClassDataAsset : UDataAsset {
...
struct ABP_AmmoBoxFireUp_C : AFireUpAction {
	FPointerToUberGraphFrame UberGraphFrame; // 0x3c8
...
struct UNUIBombRoundResult : UNUIBaseHUDElement {
	FText ResultText; // 0x278
	FText ReasonText; // 0x290
	FLinearColor ResultColor; // 0x2a8
};

struct USettingsItem_C : UNUISettingsMenuItem {
...
struct UComboItemList_C : UUserWidget {
...
struct UMedalInvincible : UMedalBase {
...
struct ABattalionBaseLevel : ALevelScriptActor {
...
struct UWBP_JumperTipIntro_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct USettingSlider_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_JumperGameOverview_C : UJumperGameOverviewWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2f0
...
struct UWeaponOrderDataAsset : UDataAsset {
...
struct ACTFGameMode : ATDMGameMode {
...
struct UMedal40BombHQ : UMedalBase {
	AHQGameMode* HQGameMode; // 0x48
};
...
struct UWBP_BlitzCanRespawnIndicator_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UTextBlock* OutCanRespawn; // 0x268
};

struct UNUIGenericPopup : UUserWidget {
...
struct AShooterBot : APromodCharacter {
	UBehaviorTree* BotBehavior; // 0x2dd0
};

struct AFFAGameMode : ABattalionGameMode {
	bool EndOnMatchPointWin; // 0x838
	float WeaponSelectGracePeriod; // 0x83c
	float RoundTimeLeftUntilStopBackfill; // 0x840
	float ScorePctToStopBackfill; // 0x844
...
struct ABlitzGameState : APromodGameState {
...
struct UPromodMetricsSubsystem : UGameInstanceSubsystem {
...
struct UPromodWeaponDataAsset : UDataAsset {
...
struct UWBP_ClosedPrototypeVersion_C : UNUIClosedPrototypeVersion {
	FPointerToUberGraphFrame UberGraphFrame; // 0x290
...
struct APromodBotController : AAIController {
	UPromodBotSMInstance* StateMachineInstance; // 0x328
};

struct UABP_M4_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_2; // 0x308
	FAnimNode_Slot AnimGraphNode_Slot_2; // 0x388
...
struct UNUISettings : UDeveloperSettings {
...
struct UNUIReplayControls : UNUIBaseHUDElement {
...
struct UNUIJumperCourseComplete : UUserWidget {
...
struct ACargoPlayerState : APromodTDMPlayerState {
	float ObjectiveTime; // 0x908
	float CurrentContestingTimer; // 0x90c
};

struct AFireUp_HandCannon : AFireUpAction {
...
struct UCTFCharacterComponent : UBattalionCharacterComponent {
...
struct AMapEditorHUD : AHUD {
	UMapEditorWidget* MapEditorWidget; // 0x310
	UMapEditorWidget* MapEditorWidgetClass; // 0x318
};

struct UMedalWeaponsSpecialist : UMedalBase {
	AFFAGameMode* FFAGameMode; // 0x48
};

struct UMedalBlowout : UMedalBase {
	AWartideGameMode* WartideGameMode; // 0x48
};

struct ABattalionSmokeGrenade : ABattalionGrenade {
...
struct UDebug_Button-LIGHT-LEFT-JUSTIFIED_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UAPB_UNDCRifle_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
...
struct UNUITwoTeamScores : UNUIBaseHUDElement {
...
struct ULeftRight_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct USandbox-MM-Button_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Simulation-text-off; // 0x268
	UWidgetAnimation* Simulation-activated; // 0x270
	UWidgetAnimation* Pulse; // 0x278
...
struct UNUILoadoutCard : UNUIBaseUIElement {
...
struct UWBP_SniperVignette_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UAnimNotify_ScreenSwayCurve : UAnimNotify {
...
struct ABP_DashFireUp_C : AFireUp_Dash {
...
struct UWBP_StyleScoreAwardEntry_C : UStyleScoreEntryWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UPromodClassManagerDataAsset : UDataAsset {
	TArray<UPromodClassDataAsset*> ClassDataAssets; // 0x30
	UPromodAllFireUpsDataAsset* AllFireUps; // 0x40
};

struct UABP_Intervention_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
	FAnimNode_Slot AnimGraphNode_Slot_2; // 0x308
...
struct AAimTrainingTarget : AActor {
...
struct UABP_Gadget_Rcon_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x308
	FAnimNode_Slot AnimGraphNode_Slot; // 0x388
...
struct UBP_PlayerOutlineCameraModifier_C : UGuardianCameraModifier {
...
struct ATDMPlayerState : ABattalionPlayerState {
...
struct UWBP_CargoHUD_C : UHUDMaster {
	FPointerToUberGraphFrame UberGraphFrame; // 0x268
	UWidgetAnimation* FlashBang; // 0x270
	UWidgetAnimation* Kill+15-And-Beyond; // 0x278
	UWidgetAnimation* Kill+10; // 0x280
...
struct ATUTPlayerState : ABattalionPlayerState {
	FString PendingInventory; // 0x590
...
struct ACTFPlayerController : ATDMPlayerController {
	bool ShowActionTakeFlag; // 0xc08
};

struct UOnFireAwardsDataAsset : UDataAsset {
...
struct UMedalJustKeepShootin : UMedalBase {
	AInfectionGameMode* INFGameMode; // 0x48
};

struct UMedalLoneSurvivor : UMedalBase {
	AInfectionGameMode* INFGameMode; // 0x48
};

struct UWBP_BombRespawnTimer_C : UBombSpatialMarker {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UMedalHQCaptured : UMedalBase {
	AHQGameMode* HQGameMode; // 0x48
};

struct AJumperCourse : AActor {
...
struct UMedal10BombWartide : UMedalBase {
	AWartideGameMode* WartideGameMode; // 0x48
};
...
struct ABP_SnapshotFireUp_C : AFireUpAction {
	FPointerToUberGraphFrame UberGraphFrame; // 0x3c8
...
struct UWBP_BombInfo_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UHeader-Tab-LEADERBOARDS-Promod_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Default; // 0x268
	UWidgetAnimation* Clicked; // 0x270
	UWidgetAnimation* Unselected; // 0x278
...
struct UInGameLeaderboard_C : UNUIJumperLeaderboard {
	FPointerToUberGraphFrame UberGraphFrame; // 0x3c8
...
struct UMedalFlagDomination : UMedalBase {
	ACTFGameMode* CTFGameMode; // 0x48
};

struct UPromodWeaponStatsDataAsset : UDataAsset {
...
struct UWBP_RespawnTimer_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct APlaceableTrophySystem : AActor {
...
struct UMedal1v4Clutch : UMedalBase {
	AWartideGameMode* WartideGameMode; // 0x48
...
struct UFP_PromodAnimInstance_C : UFirstPersonAnimInstance {
...
struct ACTFMode_FlagZone : AActor {
...
struct AInfectionPlayerState : ATDMPlayerState {
...
struct UNUISpectatorIconGroup : UNUIBaseHUDElement {
...
struct AFFAPlayerState : ABattalionPlayerState {
...
struct USettings_Backdrop__Option_Selected_C : UUserWidget {
	UImage* Backdrop-colour-image; // 0x260
	UImage* Breaker; // 0x268
	UImage* Line; // 0x270
	UImage* slant; // 0x278
...
struct ABattalionWeapon_Instant : ABattalionWeapon {
...
struct UABP_MP5_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_2; // 0x308
	FAnimNode_Slot AnimGraphNode_Slot_2; // 0x388
...
struct UAB_WW2SMG_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_2; // 0x308
	FAnimNode_Slot AnimGraphNode_Slot_2; // 0x388
...
struct UMedalWaitForThisToBlowOver : UMedalBase {
	AInfectionGameMode* INFGameMode; // 0x48
};
...
struct UNUITeamMatchResultScreen : UNUIMatchResultScreen {
...
struct UWBP_StrafeJumpSpeedFeedback_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UABP_Socom_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_2; // 0x308
	FAnimNode_Slot AnimGraphNode_Slot_2; // 0x388
...
struct UNUIVotingMenu : UNUIBaseHUDElement {
	char VotesYes; // 0x278
	char VotesNo; // 0x279
	bool bVoted; // 0x27a
...
struct ADOMGameMode : ATDMGameMode {
...
struct ABattalionLoadoutSystem : AInfo {
...
struct UPromodGameModeScoreAwardsDataAsset : UDataAsset {
...
struct UWBP_FireUpProgress_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UPromodMetric : UObject {
	bool bSmoothSamples; // 0x28
	float SmoothingFactor; // 0x2c
};

struct UFriendlyTemplate : UUserWidget {
...
struct UABP_STimshot_C : UAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	FAnimNode_Root AnimGraphNode_Root; // 0x2c8
...
struct UMedalKingSlayer : UMedalBase {
	AFFAGameMode* FFAGameMode; // 0x48
};

struct APromodPlayerCameraManager : ABattalionPlayerCameraManager {
...
struct UMedalTeamPlayer : UMedalBase {
	AInfectionGameMode* INFGameMode; // 0x48
};
...
struct USkinDataAsset : UDataAsset {
...
struct UWBP_PlayerLoadoutModificationScreen_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_IDontKnow_PopupButton_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Clicked; // 0x268
	UWidgetAnimation* Default; // 0x270
	UWidgetAnimation* Selected; // 0x278
...
struct UPFRegionManager : UObject {
...
struct UWBP_CheckpointComparison_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_CargoCheckpointPip_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_PromodSpatialMarker_C : UPromodSpatialMarker {
...
struct UWBP_BlitzTeamRole_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UPromodSpatialMarker : UUserWidget {
...
struct ABP_HandCannonFireUp_C : AFireUp_HandCannon {
...
struct UAB_WW2_Sniper_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_2; // 0x308
	FAnimNode_Slot AnimGraphNode_Slot_2; // 0x388
...
struct UHeader-Tab-WEAPONS-Promod_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Default; // 0x268
	UWidgetAnimation* Clicked; // 0x270
	UWidgetAnimation* Unselected; // 0x278
...
struct ULevelSelect-Arrow-button-Promod_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ABattalionPlayerController : APlayerController {
...
struct AHQGameMode : ATDMGameMode {
	float CaptureTime; // 0x878
	float CooldownTime; // 0x87c
...
struct UWBP_Vault_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Glitch; // 0x268
	UWidgetAnimation* Intro; // 0x270
	UTextBlock* descriptiontext; // 0x278
...
struct UVODataAsset : UDataAsset {
	TArray<FVOCategory> Category; // 0x30
};

struct UWBP_CargoObjectiveProgress_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Anim_Show; // 0x268
...
struct UNUIWidgetReferences : UObject {
...
struct UWBP_BasicScoreAward_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Glitch; // 0x268
	UWidgetAnimation* FadeOut; // 0x270
...
struct UMedalBombTechnician : UMedalBase {
	AWartideGameMode* WartideGameMode; // 0x48
};

struct AMapEditorObjectPreview : AActor {
	UChildActorComponent* ChildActorComponent; // 0x220
	FMapEditorObjectData PreviewObject; // 0x228
};

struct UCheatCodeManager : UObject {
...
struct UMedal1v2Clutch : UMedalBase {
	AWartideGameMode* WartideGameMode; // 0x48
	ABattalionPlayerControllerGMBase* ClutcherPC; // 0x50
};
...
struct UWBP_SNDLeaderboard_C : USNDLeaderBoard {
...
struct UPLAY-MM-Button_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Simulation-text-off; // 0x268
	UWidgetAnimation* Simulation-activated; // 0x270
	UWidgetAnimation* Pulse; // 0x278
...
struct AStaticSpectatorCameraActor : ACameraActor {
	int32_t CameraID; // 0x7a0
	FName Name; // 0x7a4
};

struct ACTFMode_Flag : AActor {
...
struct UABP_DeployableCover_C : UAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	FAnimNode_Root AnimGraphNode_Root; // 0x2c8
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x2f8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x378
...
struct UMinimapInternal_BoxSelect_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_WeaponPickup_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Glitch; // 0x268
...
struct UNUIFullScreenMap : UNUIBaseUIElement {
	TArray<ABattalionSmokeGrenade*> Smokes; // 0x278
	TArray<UMapSmokeWidget*> SmokeWidgets; // 0x288
	TArray<UWorldMarkerComponent*> WorldMarkers; // 0x298
	TArray<UMapMarkerWidget*> MarkerWidgets; // 0x2a8
...
struct UMedalRainingLimbs : UMedalBase {
	AInfectionGameMode* INFGameMode; // 0x48
};
...
struct UWBP_InventoryItem_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ULeaderboardMapButton_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UHorizontalBox* ContentHorizontalBox; // 0x268
	UTextBlock* ContentTextBlock; // 0x270
	UImage* NewContentImage; // 0x278
...
struct UABP_AK74u_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_2; // 0x308
	FAnimNode_Slot AnimGraphNode_Slot_2; // 0x388
...
struct UABP_KaBar_OffHand_C : UAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	FAnimNode_Root AnimGraphNode_Root; // 0x2c8
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x2f8
};
...
struct UCircularProgressBar_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ABombCarrierTracker : AActor {
...
struct UAsyncActionShowPrompt : UBlueprintAsyncActionBase {
...
struct UJumper_LevelSelect_C : UJumperLevelSelect {
	FPointerToUberGraphFrame UberGraphFrame; // 0x278
...
struct ABombMode_BombSpawn : AActor {
	int32_t StageID; // 0x220
};

struct AFFAPlayerController : ABattalionPlayerControllerGMBase {
...
struct UMedal50BombHQ : UMedalBase {
	AHQGameMode* HQGameMode; // 0x48
};
...
struct UWBP_MiniMap_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UPromodWeaponArchetypeDataAsset : UDataAsset {
	EWeaponArchetype WeaponArchetype; // 0x30
...
struct UWBP_ServerBrowserItem_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UBattalionMedalsDataAsset : UDataAsset {
	TArray<FBattalionMedalEntity> Medals; // 0x30
};

struct UNUIBattleHub : UNUIScreen {
...
struct UNUIBombGameOverview : UNUIGameOverview {
...
struct UNUICardsSelection : UNUIBaseUIElement {
	int32_t Team; // 0x278
...
struct UKillrunLevelStarsSaveData : UPromodSaveData {
...
struct UBattalionCommandManager : UObject {
	ABattalionGameMode* GameMode; // 0x28
};
...
struct APromodShootoutSpawn : ABattalionPlayerSpawn {
	bool bAllowed; // 0x278
...
struct UWBP_PingSelection_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UPromodInventoryComponent : UActorComponent {
...
struct UWBP_JumperCompleteScreen_C : UNUIJumperCourseComplete {
	FPointerToUberGraphFrame UberGraphFrame; // 0x290
...
struct UWBP_LoadoutItem_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_ChatEntry_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ACargoCheckpoint : AActor {
...
struct UNUIGameOverview : UNUIBaseHUDElement {
...
struct UNUITimedPopup : UNUIGenericPopup {
...
struct UWBP_ActionPrompt_C : UPromodActionPrompt {
...
struct ACamPathSplineActor : AActor {
	USplineComponent* SplineCompLoc; // 0x220
	USplineComponent* SplineCompRot; // 0x228
};

struct UWBP_CargoResultScreen_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UJumper_LevelSelectBox_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_HardpointZoneList_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct AInfectionGameState : ATDMGameState {
	int32_t SurvivorTeamSize; // 0x4a0
	int32_t InfectedAlive; // 0x4a4
};

struct UReset-Legend-button-Promod_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Default; // 0x268
	UWidgetAnimation* Clicked; // 0x270
	UWidgetAnimation* Unselected; // 0x278
...
struct UWBP_RadialMenu_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UMedalKillInfected : UMedalBase {
	AInfectionGameMode* INFGameMode; // 0x48
};
...
struct UMedalLastMinuteSavior : UMedalBase {
	ATDMGameMode* TDMGameMode; // 0x48
...
struct USndGameOverviewWidget : UUserWidget {
...
struct UCustomIpNetDriver : UIpNetDriver {
	int32_t Counter; // 0x7b8
};

struct UNUIProneBlockPrompt : UNUIBaseHUDElement {
...
struct UWBP_ChatFeed_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* FadeOut; // 0x268
...
struct UWBP_InteractionEvent_C : UPromodInteractionEvent {
...
struct UPromodFireUpDataAsset : UDataAsset {
...
struct UBombCharacterComponent : UBattalionCharacterComponent {
...
struct UABP_Regen_C : UAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	FAnimNode_Root AnimGraphNode_Root; // 0x2c8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x2f8
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x340
...
struct UNUIMainMenu : UNUIScreen {
	bool IsInitialEntry; // 0x291
};

struct UMedalDreamkiller : UMedalBase {
	AWartideGameMode* WartideGameMode; // 0x48
};
...
struct UNUICasterGraphs : UNUIBaseUIElement {
...
struct ABattalionCharacter : ACharacter {
...
struct UKillFeedTimeDisplay_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UBattalionAudio : UObject {
...
struct ABattalionDeathSpectatorPawn : ASpectatorPawn {
...
struct UWBP_CargoObjectiveProgressBar_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UBP_RegenCameraModifier_C : UGuardianCameraModifier {
	float FovAddition; // 0x48
...
struct UMinimapInternal_Camera_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UPromodTacticalUtilDataAsset : UDataAsset {
...
struct UWBP_InGameLoadoutSelection_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UNUIInteract : UNUIBaseHUDElement {
...
struct UWBP_BombProgressBar_C : UWBP_PlantProgressBar_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2a8
};
...
struct UMedal1v3Clutch : UMedalBase {
	AWartideGameMode* WartideGameMode; // 0x48
	ABattalionPlayerControllerGMBase* ClutcherPC; // 0x50
};
...
struct UWBP_JumperMovementHUD_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct APromodPlayerController : AWartidePlayerController {
...
struct UNUIINFGameOverview : UNUIGameOverview {
...
struct UBP_PlayerSilhouetteCameraModifier_C : UCameraModifier {
	UMaterialInstanceDynamic* PostProcessMaterialNew; // 0x48
	float Radius; // 0x50
	float Intensity; // 0x54
};

struct UNUIPauseMenu : UNUIScreen {
...
struct UMedal30BombFFA : UMedalBase {
	AFFAGameMode* FFAGameMode; // 0x48
};
...
struct UAB_WW2Sidearm_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_2; // 0x308
	FAnimNode_Slot AnimGraphNode_Slot_2; // 0x388
...
struct UNUIGenericActionPrompt : UNUIBaseHUDElement {
...
struct UWBP_PlayerAliveIcon_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UImage* Background; // 0x268
...
struct UWBP_WartideWorldMarker_C : UHUDWorldMarker {
...
struct UPlatformKeyImage_C : UPlatformKeyImage {
	FPointerToUberGraphFrame UberGraphFrame; // 0x270
...
struct UMedal30BombTDM : UMedalBase {
	ATDMGameMode* TDMGameMode; // 0x48
};

struct AMapEditorGizmo : AActor {
...
struct UWishlist-button-Promod-LARGER_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Default; // 0x268
	UWidgetAnimation* Clicked; // 0x270
	UWidgetAnimation* Unselected; // 0x278
...
struct AKillRunGameMode : ATUTGameMode {
...
struct ABlitzMode_Bomb : ABombMode_Bomb {
...
struct UPromodCrosshair : UUserWidget {
...
struct UJumper-MM-Button_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Simulation-text-off; // 0x268
	UWidgetAnimation* Simulation-activated; // 0x270
	UWidgetAnimation* Pulse; // 0x278
...
struct UPlayFabSubsystem : UGameInstanceSubsystem {
...
struct UHideWeaponNotify_C : UAnimNotify {
	bool Show; // 0x38
	bool ThirdPerson; // 0x39
};

struct UMainMenuLeaderboard_C : UNUIJumperLeaderboard {
	FPointerToUberGraphFrame UberGraphFrame; // 0x3c8
	UWidgetAnimation* Intro; // 0x3d0
...
struct UDebug_Button-BLACK-LEFT-JUSTIFIED_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* TEXT_MOTION; // 0x268
	UWidgetAnimation* UNHOVER; // 0x270
	UWidgetAnimation* HOVER; // 0x278
...
struct ULeaderboardItem_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UPromodCameraModifier : UCameraModifier {
...
struct UNUIConsoleGeneralOverview : UNUIGameOverview {
...
struct UNUIStyleScore : UUserWidget {
...
struct UTimeDisplay_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UMapPlayerWidget : UUserWidget {
	ABattalionCharacter* LinkedCharacter; // 0x268
	UMaterialInstanceDynamic* CachedMaterial; // 0x270
	ABeacon* Beacon; // 0x278
	float BeaconScaleX; // 0x280
...
struct UBattalionVideosDataAsset : UDataAsset {
	TArray<FBattalionVideoDataEntity> Videos; // 0x30
};

struct ABlitzBombBP_C : ABlitzMode_Bomb {
...
struct UNUIJumperLeaderboard : UNUIBaseUIElement {
...
struct UNUIMapPlacement : UNUIBaseHUDElement {
...
struct UPopupSaveData : UPromodSaveData {
...
struct UMedalWorldWarZ : UMedalBase {
	AInfectionGameMode* INFGameMode; // 0x48
};
...
struct ABombHUD : ABattalionHUD {
	UNUIBombIcon* bombicon; // 0x5f8
	UNUIBombIcon* BombIconClass; // 0x600
};

struct ABattalionImpactEffect : AActor {
...
struct UWBP_CustomLoadoutButton_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UComboItem_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_StyleScoreAwardFeed_C : UNUIStyleScore {
	FPointerToUberGraphFrame UberGraphFrame; // 0x270
...
struct ATugOfWarMonorail : AMonorail {
...
struct AJumperGameMode : ATUTGameMode {
...
struct AWorldVFXManager : AActor {
...
struct UJumperGameOverviewWidget : UUserWidget {
...
struct UWBP_TugOfWarOverview_C : UTugOfWarGameOverviewWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x3b8
...
struct UFOVSkeletalMeshComponent : USkeletalMeshComponent {
	float FOV; // 0xed0
};
...
struct UWBP_CargoProgress_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UCanvasPanel* CP_Main; // 0x268
...
struct ACargoPlayerSpawn : ABattalionPlayerSpawn {
	int32_t Checkpoint; // 0x278
};

struct AHardpointGameMode : APromodTDMGameMode {
...
struct UNUITDMObjectiveScores : UNUIObjectiveScores {
	int32_t AllyTeamNumber; // 0x2f8
	int32_t EnemyTeamNumber; // 0x2fc
	ENationType AllyNationType; // 0x300
	ENationType EnemyNationType; // 0x301
...
struct UWBP_CallOutName_C : UNUICallOutName {
...
struct UWBP_AmmoAndNades_C : UNUIAmmoCount {
	FPointerToUberGraphFrame UberGraphFrame; // 0x268
...
struct AGrenadeFollowActor : AActor {
	UBoxComponent* RootBox; // 0x220
...
struct ABattalionSpectatorPawn : ASpectatorPawn {
...
struct UMedalDisruptive : UMedalBase {
	AWartideGameMode* WartideGameMode; // 0x48
};

struct UHUDSpectator : UNUIBaseUIElement {
...
struct UMainMenuLevelSelectMapDataAsset : UDataAsset {
	bool bIsEnabled; // 0x30
	FString MapPackName; // 0x38
	TArray<FLevelSelectMapEntity> Maps; // 0x48
};

struct UWBP_HardpointPlayerIcons_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UImage* BlueBar; // 0x268
	UInvalidationBox* InvalidationBox_1; // 0x270
...
struct UDebug_Button_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* TEXT_MOTION; // 0x268
	UWidgetAnimation* UNHOVER; // 0x270
	UWidgetAnimation* HOVER; // 0x278
...
struct UMedal20BombTDM : UMedalBase {
	ATDMGameMode* TDMGameMode; // 0x48
};

struct UWBP_ProneBlock_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Glitch; // 0x268
	UWidgetAnimation* Intro; // 0x270
	UTextBlock* descriptiontext; // 0x278
...
struct UKillRunGameOverviewWidget : UUserWidget {
...
struct UAkPlayerSound_C : UAnimNotify {
...
struct AWartidePlayerState : ABombPlayerState {
...
struct ABattalionGrenadePickup : AActor {
...
struct APostProcessingSettings : AActor {
...
struct UWBP_CargoProgressCheckpoint_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UNUIFFAPlayerScore : UNUIBaseHUDElement {
...
struct UNUIBuyScreen : UNUIBaseUIElement {
...
struct ABP_ThrowableAmmoBox_C : ASnapshotGrenade {
	FPointerToUberGraphFrame UberGraphFrame; // 0x298
	FMulticastInlineDelegate OnImpact; // 0x2a0
};
...
struct UWBP_CustomLoadoutContainer_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UPromodQuickUtilDataAsset : UDataAsset {
	TArray<FQuickUtilItem> QuickUtils; // 0x30
};

struct APromodPawn_C : APromodCharacter {
...
struct UNUIScoreboardTeamMember : UNUIScoreboardRow {
...
struct UFOVParticleSystemComponent : UParticleSystemComponent {
	float FOV; // 0x698
};
...
struct UWBP_Overtime_Shootout_Victory_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UHUDUseProgressWidget : UUserWidget {
...
struct UWBP_VictoryState_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* FadeOut; // 0x268
...
struct UMedalFastDenial : UMedalBase {
	ACTFGameMode* CTFGameMode; // 0x48
};
...
struct UWBP_Hitmarker_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UAudioPassByComponent : USceneComponent {
...
struct UNUIMapSelectDisplay : UUserWidget {
	FString MapName; // 0x260
};

struct AFFAHUD : ABattalionHUD {
...
struct UWBP_HeaderTab_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UHorizontalBox* ContentHorizontalBox; // 0x268
	UTextBlock* ContentTextBlock; // 0x270
	UImage* NewContentImage; // 0x278
...
struct UNUIBaseHUDElement : UUserWidget {
	UBattalionGameInstance* BattInstance; // 0x268
	UBattalionSettings* BattSettings; // 0x270
};

struct AOneInTheChamberGamemode : AFFAGameMode {
...
struct UMedal30BombHQ : UMedalBase {
	AHQGameMode* HQGameMode; // 0x48
};
...
struct UWeaponNameDataAsset : UDataAsset {
...
struct APromodBouncePad : AActor {
...
struct UBP_HandCannonCameraModifier_C : UCameraModifier {
	float FovAddition; // 0x48
	UCurveFloat* FovCurve; // 0x50
	float Intensity; // 0x58
};
...
struct UPromodDeathCamera : UActorComponent {
	float Duration; // 0xb0
...
struct UMedalLastStand : UMedalBase {
	AInfectionGameMode* INFGameMode; // 0x48
};

struct ABP_RegenFireUp_C : AFireUpAction {
	FPointerToUberGraphFrame UberGraphFrame; // 0x3c8
...
struct UMapNameToImageDataAsset : UDataAsset {
...
struct ABattalionExplosionEffect : AActor {
...
struct UMinimapInternal_IconMouseCapture_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UPromodCharacterMovementComponent : UBattalionCharacterMovementBase {
...
struct AFireUp_Dash : AFireUpAction {
...
struct UWBP_CargoSingleTeamProgress_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct USettings_C : UNUISettingsMenu {
...
struct AVaultAntiVolume : AActor {
	UBoxComponent* BoxComponent; // 0x220
};
...
struct UWelcomePopup_C : UWelcomePopupWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x270
...
struct UPlayerSceneCaptureComponent2D : USceneCaptureComponent2D {
...
struct UBotNamesDataAsset : UDataAsset {
	TArray<FString> BotNames; // 0x30
};

struct AInfectionGameMode : ATDMGameMode {
...
struct UMapBombSiteWidget : UUserWidget {
...
struct UBattalionDamageType : UDamageType {
...
struct ACTFPlayerState : ATDMPlayerState {
...
struct UWBP_CircularProgressBar_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UImage* CPB_Image; // 0x268
	USizeBox* CPB_SizeBox; // 0x270
	float Scale; // 0x278
...
struct UMinimapInternal_Fog_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UNUICallOutName : UNUIBaseHUDElement {
...
struct UClassSelectionScreen : UUserWidget {
...
struct UMedalHugeDenial : UMedalBase {
	ACTFGameMode* CTFGameMode; // 0x48
};

struct ABattalionWeapon : AActor {
...
struct UMenu-Button-Promod_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UHorizontalBox* ContentHorizontalBox; // 0x268
	UTextBlock* ContentTextBlock; // 0x270
	UImage* NewContentImage; // 0x278
...
struct UNuclearInputSystem : UGameInstanceSubsystem {
...
struct UWorldMarkerComponent : USceneComponent {
...
struct ULeftRightConfig_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_ServerBrowserFilterOption_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UButton* BTN_Main; // 0x268
...
struct UHUDDeathRow : UUserWidget {
...
struct AWeapGun_ImpactsFailed_C : ABattalionImpactEffect {
...
struct ABattalionGameState : AGameStateBase {
...
struct ABombGameState : ABattalionGameState {
...
struct UWBP_TugOfWarProgress_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UCanvasPanel* CP_Main; // 0x268
	UImage* Image; // 0x270
...
struct UNuclearAnalyticsSystem : UEngineSubsystem {
...
struct UNUIPlayerLoadout : UNUIBaseUIElement {
	ABattalionPlayerState* PlayerState; // 0x278
...
struct UWBP_CargoPayloadStatus_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UBattalionCharacterMovementBase : UCharacterMovementComponent {
...
struct UPromodMetricWidget : UUserWidget {
	FName MetricName; // 0x260
	UPromodMetric* Metric; // 0x268
};

struct AMonorailPath : AActor {
...
struct UWBP_KillSuccess_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UBigTimeDisplay_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UImage* IMG_ComparisonIndicator; // 0x268
	UImage* IMG_PlusIcon; // 0x270
	UTextBlock* TimeDisplayText; // 0x278
...
struct AAimTrainingManager : AActor {
...
struct UABP_UNDCKnife_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x308
	FAnimNode_Slot AnimGraphNode_Slot; // 0x388
...
struct UMedal25BombFFA : UMedalBase {
	AFFAGameMode* FFAGameMode; // 0x48
};

struct UHUDMaster : UUserWidget {
...
struct UNUIEquippedWeapons : UNUIBaseHUDElement {
	int32_t PreviousWeaponIndex; // 0x278
};

struct UMedal25BombDOM : UMedalBase {
	ADOMGameMode* DOMGameMode; // 0x48
};

struct UHUDChatController : UUserWidget {
...
struct UControllerLayoutLabel_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ABattalionGameSession : AGameSession {
...
struct UMedalHQDefender : UMedalBase {
	AHQGameMode* HQGameMode; // 0x48
};
...
struct UNUISniperScreenEffects : UNUIBaseHUDElement {
...
struct UMedal20BombWartide : UMedalBase {
	AWartideGameMode* WartideGameMode; // 0x48
};
...
struct ABattalionProfilingSpectatorPawn : ASpectatorPawn {
...
struct UPFPlayerIdCache : UObject {
	UPlayFabSubsystem* PlayFabSubsystem; // 0x30
};

struct ABombMode_Bomb : AActor {
...
struct UWBP_ModKitWeaponButton_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UMedal15BombWartide : UMedalBase {
	AWartideGameMode* WartideGameMode; // 0x48
};
...
struct UGameOverScreen : UUserWidget {
	FText ResultText; // 0x260
	FText ScoreText; // 0x278
};

struct UBack-Legend-button-Promod_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Default; // 0x268
	UWidgetAnimation* Clicked; // 0x270
	UWidgetAnimation* Unselected; // 0x278
...
struct ABlitzGameMode : APromodGameMode {
...
struct UJumper_MainMenu_C : UPromodMainMenuScreen {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2f0
...
struct UMapEditorObjectDetailsWidget : UUserWidget {
...
struct UNUISettingsMenuItem : UUserWidget {
...
struct UMedalReturn : UMedalBase {
	ACTFGameMode* CTFGameMode; // 0x48
};
...
struct APromodGameState : AWartideGameState {
...
struct UWBP_SndGameoverviewWidget_C : USndGameOverviewWidget {
...
struct UWBP_BlitzGameoverviewWidget_C : USndGameOverviewWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x390
...
struct UNUIAnnouncement : UNUIBaseHUDElement {
	FString Text; // 0x278
...
struct UBattalionExperience : UDataAsset {
...
struct UBattalionMapToGMDataAsset : UDataAsset {
	TArray<FMapList> Maps; // 0x30
};

struct AAkSplineAmbientSound : AAkAmbientSound {
...
struct UPFServerSlotManager : UObject {
...
struct UABP_TrophySystem_C : UAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	FAnimNode_Root AnimGraphNode_Root; // 0x2c8
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x2f8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x378
...
struct UPlayerLoadoutsSaveData : UPromodSaveData {
...
struct AHeadquarters_Zone : AActor {
	float ZoneRadius; // 0x220
	UStaticMeshComponent* ZoneMesh; // 0x228
	UBoxComponent* CollisionComp; // 0x230
	int32_t CurrentTeamAllegiance; // 0x238
...
struct UNUIScoreboardScreen : UNUIBaseUIElement {
...
struct UMinimapInternal_Background_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct APromodWorldSettings : AWorldSettings {
...
struct UPFMatchmakingManager : UObject {
...
struct UNUIBombIcon : UNUIBaseHUDElement {
...
struct UMenu-Background_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UImage* MediaTexture; // 0x268
	UMediaPlayer* MediaPlayer; // 0x270
};

struct UWBP_BlitzBombProgress_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UTextBlock* Percentage; // 0x268
	UWBP_BombProgressBar_C* ProgressBar; // 0x270
};

struct ABattalionIncendiaryGrenade : ABattalionGrenade {
...
struct UMedalZombieland : UMedalBase {
	AInfectionGameMode* INFGameMode; // 0x48
};
...
struct UNUINetworkStatus : UNUIBaseHUDElement {
...
struct UDebugReticle : UUserWidget {
...
struct UMapBombWidget : UUserWidget {
	ABattalionCharacter* LinkedCharacter; // 0x268
...
struct UNUIFFAGameOverview : UNUIGameOverview {
...
struct UWBP_Overtime_Shootout_Transition_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Show; // 0x268
...
struct UCONTINUE-Legend-button-Promod_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Default; // 0x268
	UWidgetAnimation* Clicked; // 0x270
	UWidgetAnimation* Unselected; // 0x278
...
struct UApply-Legend-button-Promod_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Default; // 0x268
	UWidgetAnimation* Clicked; // 0x270
	UWidgetAnimation* Unselected; // 0x278
...
struct UCoinDataAsset : UDataAsset {
...
struct AMapEditorPawn : ASpectatorPawn {
...
struct URESTART-Legend-button-Promod_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Default; // 0x268
	UWidgetAnimation* Clicked; // 0x270
	UWidgetAnimation* Unselected; // 0x278
...
struct USelectedKitSaveData : UPromodSaveData {
...
struct APushPlayerVolume : AActor {
	UBoxComponent* BoxComponent; // 0x220
...
struct UMapMarkerWidget : UUserWidget {
...
struct UPFPlayerDataManager : UObject {
...
struct UAB_Tactical_Flashbang_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x308
	FAnimNode_Slot AnimGraphNode_Slot; // 0x388
...
struct UMedalArtilleryStrike : UMedalBase {
	ADOMGameMode* DOMGameMode; // 0x48
};

struct UPFMatchmakingInterop : UObject {
	UPlayFabSubsystem* PlayFabSubsystem; // 0x30
...
struct UNUIClosedPrototypeVersion : UUserWidget {
	FText MilestoneText; // 0x260
	FText MatchIdText; // 0x278
};

struct ABP_PlaceableAmmoBox_C : APlaceableTrophySystem {
	FPointerToUberGraphFrame UberGraphFrame; // 0x270
...
struct UWallrunFOVCameraModifier : UCameraModifier {
	UBattalionGameInstance* BattInstance; // 0x48
	ABattalionPlayerCameraManager* BattCameraManager; // 0x50
	UBattalionSettings* BattSettings; // 0x58
};
...
struct UBattalionStatManager : UObject {
...
struct UMedal1v5Clutch : UMedalBase {
	AWartideGameMode* WartideGameMode; // 0x48
	ABattalionPlayerControllerGMBase* ClutcherPC; // 0x50
};
...
struct UControllerLayoutSettingsItem_C : UNUISettingsMenuItem {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2f8
	UWidgetAnimation* DoSetDisabled; // 0x300
...
struct ABP_BlitzBombTracker_C : ABombCarrierTracker {
...
struct UBindingImageText_C : UBindingImageText {
	FPointerToUberGraphFrame UberGraphFrame; // 0x278
...
struct UNuclearAssetManager : UAssetManager {
...
struct ABattalionGameMode : AGameModeBase {
...
struct UHUDPlayerName_C : UHUDPlayerName {
...
struct UAB_Offensive_Frag_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x308
	FAnimNode_Slot AnimGraphNode_Slot; // 0x388
...
struct AWeapGun_Impacts_C : ABattalionImpactEffect {
	FPointerToUberGraphFrame UberGraphFrame; // 0x470
	USceneComponent* DefaultSceneRoot; // 0x478
	FHitResult HitResult; // 0x480
};

struct AKillRunGrenadePickup : ABattalionTutorialPickup {
...
struct UMedal40BombCTF : UMedalBase {
	ACTFGameMode* CTFGameMode; // 0x48
};
...
struct UPromodTeam : UBattalionTeam {
	TArray<FLiveClassData> LiveClassUsage; // 0x170
};

struct ASnapshotGrenade : AActor {
...
struct UWBP_HardpointHUD_C : UHUDMaster {
	FPointerToUberGraphFrame UberGraphFrame; // 0x268
	UWidgetAnimation* FlashBang; // 0x270
	UWidgetAnimation* Kill+15-And-Beyond; // 0x278
	UWidgetAnimation* Kill+10; // 0x280
...
struct UNUIMatchResultScreen : UNUIBaseUIElement {
...
struct UPromodBotSMInstance : USMInstance {
...
struct ABattalionBloodEffect : AActor {
...
struct UWBP_SP_HUDEquipment_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Anim_AmmoAdded; // 0x268
	UHorizontalBox* HB_Ammo; // 0x270
	UInvalidationBox* IB_Ammo; // 0x278
...
struct AHeadquartersGameState : ATDMGameState {
...
struct AMapEditorObject : AActor {
...
struct UNuclearAsset : UPrimaryDataAsset {
	FGuid UUID; // 0x30
};
...
struct UMedalMoneySaver : UMedalBase {
	AWartideGameMode* WartideGameMode; // 0x48
	TArray<FDefaultKillTracker> DefaultKillTrackers; // 0x50
};

struct UMedalOneManArmy : UMedalBase {
	ATDMGameMode* TDMGameMode; // 0x48
	TArray<FOneManArmyTracker> Trackers; // 0x50
};

struct ABombGameMode : ABattalionGameMode {
...
struct UMedalHQDestroyed : UMedalBase {
	AHQGameMode* HQGameMode; // 0x48
};

struct ABP_SmokeGrenade_C : ABattalionSmokeGrenade {
	FPointerToUberGraphFrame UberGraphFrame; // 0x420
};

struct UGameEventRecorder : UObject {
...
struct UMapEditorSaveData : UPromodSaveData {
...
struct UNUIAnnouncementList : UNUIBaseHUDElement {
...
struct UNUIFpsCounter : UNUIBaseHUDElement {
	FText FpsText; // 0x278
};

struct ATUTPlayerController : ABattalionPlayerControllerGMBase {
	bool bHasDied; // 0xc00
...
struct ACTFMode_FlagZoneLocation : AActor {
...
struct UABP_r700_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
	FAnimNode_Slot AnimGraphNode_Slot_2; // 0x308
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer_2; // 0x350
...
struct ABattalionTutorialPickup : AActor {
...
struct UNUILineGraph : UNUIGraphBase {
	TArray<FLineGraphPointArray> Lines; // 0x278
};

struct UMedalLastMinuteHero : UMedalBase {
	ATDMGameMode* TDMGameMode; // 0x48
...
struct ACargoGameState : APromodTDMGameState {
...
struct UPromodCosmeticsDataAsset : UDataAsset {
...
struct AWartidePlayerController : ABombPlayerController {
...
struct UNUI_RightClickableButton : UButton {
...
struct UABP_UNDC_SMG_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
	FAnimNode_Slot AnimGraphNode_Slot_2; // 0x308
...
struct ABombBP_C : ABombMode_Bomb {
...
struct UWBP_CargoGameoverviewWidget_C : UCargoGameOverviewWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x3e8
...
struct UWBP_RoundPip_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_PlantProgressBar_C : UStaminaBar {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Default; // 0x268
...
struct ABP_IncendiaryEffect_C : ABattalionIncendiaryEffect {
...
struct UHUDPlayerName : UUserWidget {
...
struct UNUIVideoTrainingPlaying : UNUIScreen {
...
struct UPFGroupManager : UObject {
...
struct UControllerLayoutLabelText_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ATUTGameMode : ABattalionGameMode {
...
struct UNUILevelUp : UNUIBaseHUDElement {
...
struct UNUIWeaponSwapPrompt : UNUIBaseHUDElement {
	FText BindName; // 0x278
};
...
struct ABP_DeployableCoverFireUp_C : AFireUpAction {
	FPointerToUberGraphFrame UberGraphFrame; // 0x3c8
...
struct UMedalCarrierKill : UMedalBase {
	ACTFGameMode* CTFGameMode; // 0x48
};

struct ABattalionPlayerControllerGMBase : ABattalionPlayerController {
...
struct UCargoGameOverviewWidget : USndGameOverviewWidget {
...
struct UUnlockedLevelsSaveData : UPromodSaveData {
...
struct UNUIAmmoCount : UUserWidget {
...
struct UNUICTFFlagStates : UNUIBaseHUDElement {
...
struct AVaultVolume : AActor {
	UBoxComponent* BoxComponent; // 0x220
	UArrowComponent* ArrowComponent; // 0x228
};

struct AAkIndoorReverbVolume : AAkReverbVolume {
...
struct UHUD_LINES_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_ShootoutOverview_C : USndGameOverviewWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x390
...
struct UGameModeMessage : UUserWidget {
...
struct UBattalionPathFollowingComponent : UPathFollowingComponent {
...
struct AMonorailCarriage : AActor {
	UStaticMeshComponent* MeshComp; // 0x220
...
struct UNUIRoundStartCountdown : UNUIBaseHUDElement {
...
struct UNUIWartideRoundResult : UNUIBaseHUDElement {
	FText ResultText; // 0x278
	FText ReasonText; // 0x290
	FLinearColor ResultColor; // 0x2a8
...
struct UMedalHQSecured : UMedalBase {
	AHQGameMode* HQGameMode; // 0x48
};
...
struct UNUIGameTimer : UNUIBaseHUDElement {
	FString GameTimer; // 0x278
	FLinearColor Color; // 0x288
};
...
struct UNUIInputKeySelector : UWidget {
	FButtonStyle WidgetStyle; // 0x108
	FTextBlockStyle TextStyle; // 0x380
	FInputChord SelectedKey; // 0x5f0
	FSlateFontInfo Font; // 0x610
...
struct UNUISpectatorStatBars : UNUIBaseHUDElement {
...
struct UPlatformKeyGeneral : UUserWidget {
	FString CurrentForcingPlatform; // 0x260
};

struct UBattalionChallengeManager : UObject {
	UBattalionGameInstance* BattInstance; // 0x28
...
struct UNUISpectatorLoadoutScreen : UNUIBaseUIElement {
...
struct UBattalionMedalManager : UObject {
	UBattalionGameInstance* BattInstance; // 0x28
	UPFPlayerDataManager* PFPlayerData; // 0x30
	UPFPlayerIdCache* PFPlayerCache; // 0x38
...
struct UWBP_Crosshair_C : UPromodCrosshair {
...
struct UMedalDefender : UMedalBase {
	ADOMGameMode* DOMGameMode; // 0x48
};
...
struct UWBP_Killfeed_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UMedal20BombDOM : UMedalBase {
	ADOMGameMode* DOMGameMode; // 0x48
};
...
struct ABP_MapEditorGizmo_C : AMapEditorGizmo {
...
struct AHeadquartersHUD : ATDMHUD {
...
struct UWBP_Metric_C : UPromodMetricWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x270
...
struct UNuclearAssetHandle : UObject {
	UNuclearAsset* Asset; // 0x48
};

struct UNUICallVoteMenu : UNUIBaseHUDElement {
...
struct UMedal25BombTDM : UMedalBase {
	ATDMGameMode* TDMGameMode; // 0x48
};
...
struct UHeader-Tab-HUB-Promod_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Default; // 0x268
	UWidgetAnimation* Clicked; // 0x270
	UWidgetAnimation* Unselected; // 0x278
...
struct ABlitzPlayerSpawn : ABattalionPlayerSpawn {
...
struct AWartideGameState : ABombGameState {
	TArray<FTeamLedger> TeamLedgers; // 0x530
};

struct UNUIFlagIcon : UNUIBaseHUDElement {
	ESlateVisibility IconVisibility; // 0x278
	float AmmoWidgetWidth; // 0x27c
};
...
struct UGrenadeMarker : UUserWidget {
...
struct UNUIBreadCrumb : UUserWidget {
	FString Name; // 0x260
};
...
struct UAB_Tactical_Smoke_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
...
struct UABP_Bomb_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x308
	FAnimNode_Slot AnimGraphNode_Slot; // 0x388
...
struct UWBP_TimedConfirm_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UButton* BTN_Main; // 0x268
...
struct UBattalionColoursDataAsset : UDataAsset {
	TArray<FBattalionColourEntity> Colours; // 0x30
};

struct UWeaponSlot : UPromodReplicatedObject {
...
struct UABP_KaBar_C : UWeaponAnimInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2d0
	FAnimNode_Root AnimGraphNode_Root; // 0x2d8
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x308
	FAnimNode_Slot AnimGraphNode_Slot; // 0x388
...
struct UWBP_ServerBrowser_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_Spectating_C : UUserWidget {
...
struct UBattalionCharacterMovement : UBattalionCharacterMovementBase {
...
struct UFOVFixedStaticMeshComponent : UStaticMeshComponent {
	float FOV; // 0x4d0
};

struct UNUIObjectiveScores : UNUIBaseHUDElement {
...
struct UFirstPersonAnimInstance : UAnimInstance {
	UAnimSequence* AnimHipIdle; // 0x2b8
	UAnimSequence* AnimSprint; // 0x2c0
	UAnimSequence* AnimSprintIn; // 0x2c8
	UAnimSequence* AnimHipAdditiveAltIdle; // 0x2d0
...
struct UNUIOneInTheChamberLivesLeft : UNUIBaseHUDElement {
...
struct UTugOfWarGameOverviewWidget : USndGameOverviewWidget {
...
struct USettings_Backdrop__Config_Selected_C : UUserWidget {
	UImage* Backdrop-colour-image; // 0x260
	UImage* Breaker; // 0x268
	UImage* Line; // 0x270
	UImage* slant; // 0x278
...
struct ABattalionProjectile : AActor {
...
struct UNUIHQGameOverview : UNUIGameOverview {
...
struct UMedal30BombDOM : UMedalBase {
	ADOMGameMode* DOMGameMode; // 0x48
};

struct ABattalionSpawnInfluencer : AActor {
	USceneComponent* RootSceneComponent; // 0x220
...
struct UBP_StunnedCameraModifier_C : UGuardianCameraModifier {
	UMaterialInstanceDynamic* PostProcessMaterial; // 0x48
	float Strength; // 0x50
};
...
struct UWBP_CargoOverviewScore_C : UUserWidget {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ABattalionPlayerState : APlayerState {
...
struct APromodGameMode : AWartideGameMode {
...
struct UBulkheadMulticastAudioEventWrapper : UBulkheadAudioEventWrapper {
	APawn* OwningPawn; // 0x58
};

struct UNUIScoreboardTeam : UNUIScoreboardGroup {
