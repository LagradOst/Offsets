...
enum class ENUIScreen : uint8_t {
	...
	NUI_BATTLERANK = 6,
	NUI_MAP_SELECT = 7,
	NUI_TRAINING_VIDEO = 8,
	NUI_TRAINING_VIDEO_PLAYING = 9,
	NUI_VS_BOTS = 10,
	NUI_PARTY = 11,
	NUI_PREMIUMSALES = 12,
	NUI_CREDITS = 13,
	NUI_PREVIOUS_SCREEN = 14,
	NUI_MAX = 15,
};
...
enum class EFireUpCanUseBombMode : uint8_t {
	Always = 0,
	Conditional = 1,
	Never = 2,
	EFireUpCanUseBombMode_MAX = 3,
};
...
enum class EBombModeZoneName : uint8_t {
	None = 0,
	A = 1,
	B = 2,
	C = 3,
	EBombModeZoneName_MAX = 4,
};

enum class EFireUpType : uint8_t {
	None = 0,
	Dash = 1,
	Regen = 2,
	Reveal = 3,
...
enum class ESettingSection : uint8_t {
	ESS_GENERAL = 0,
	ESS_XBOXCONTROLS = 1,
	ESS_PCCONTROLS = 2,
	ESS_VIDEO = 3,
...
enum class EAdminCommandsFilter : uint8_t {
	All = 0,
	Config = 1,
	FireUps = 2,
	Performance = 3,
...
enum class EIncendiaryGrenadeType : uint8_t {
	IGT_Incendiary = 0,
	IGT_MAX = 1,
};
...
enum class EMedalEvent : uint8_t {
	ME_RoundStart = 0,
	ME_RoundEnd = 1,
	ME_BombPlanted = 2,
	ME_BombDefused = 3,
	...
	ME_HQDestroyed = 12,
	ME_HQSecured = 13,
	ME_JustKeepShootin = 14,
	ME_WaitForThisToBlowOver = 15,
	ME_Zombieland = 16,
	ME_WorldWarZ = 17,
	ME_IAmLegend = 18,
	ME_MAX = 19,
...
enum class EFireUpSlotType : uint8_t {
	Ultimate = 0,
	QuickUtil = 1,
	EFireUpSlotType_MAX = 2,
};
...
enum class EGameOverview : uint8_t {
	EGO_Wartide = 0,
	EGO_FFA = 1,
	EGO_TDM = 2,
	EGO_Dom = 3,
...
enum class ENUILayerBP : uint8_t {
	HUDWorld = 0,
	HUDScreenEffects = 1,
	HUDCrosshair = 2,
	HUDOverlays = 3,
...
enum class EPFInteropCommand : uint8_t {
	Heartbeat = 0,
	Server_ReadyForMatch = 1,
	PlayFab_MatchStarted = 2,
	PlayFab_BackfilledPlayers = 3,
	PlayFab_TimedOutPlayers = 4,
	Server_PlayerJoined = 5,
	Server_PlayerLeft = 6,
	Server_StopBackfill = 7,
	Server_ResetBackfill = 8,
	EPFInteropCommand_MAX = 9,
};
...
enum class ELifetimeCondition : uint8_t {
	...
	COND_Never = 14,
	Cond_MAX = 15,
	ELifetimeCondition_MAX = 16,
};

enum class EDOMZoneStatus : uint8_t {
	DOMZoneStatus_Contested = 0,
	DOMZoneStatus_Neutralising = 1,
	DOMZoneStatus_Capturing = 2,
	DOMZoneStatus_Captured = 3,
	DOMZoneStatus_MAX = 4,
};

enum class ECargoCheckpointType : uint8_t {
	Default = 0,
	Objective = 1,
	TugOfWar_MidPoint = 2,
	TugOfWar_EndPoint = 3,
	ECargoCheckpointType_MAX = 4,
};

enum class EFillStage : uint8_t {
	Score = 0,
	Medals = 1,
	Challenges = 2,
	MatchResult = 3,
...
enum class EHardpointState : uint8_t {
	NEUTRAL = 0,
	CONTESTED = 1,
	CAPTURED = 2,
	LOCKED = 3,
	NEXT = 4,
	EHardpointState_MAX = 5,
};
...
enum class EFireUpWeaponEquipTiming : uint8_t {
	NoHolster = 0,
	PostDeploy = 1,
	PostActivation = 2,
	PostDeployAnimation = 3,
	PostActivationAnimation = 4,
	Custom = 5,
	Manual = 6,
	EFireUpWeaponEquipTiming_MAX = 7,
};
...
enum class EPromodCustomMovementType : uint8_t {
	CUSTOM_MOVEMENT_LADDER = 0,
	CUSTOM_MOVEMENT_VAULT = 1,
	CUSTOM_MOVEMENT_MAX = 2,
};
...
enum class EBCBPreview : uint8_t {
	BCBP_Normal = 0,
	BCBP_Hover = 1,
	BCBP_Pressed = 2,
	BCBP_Disabled = 3,
...
enum class ERoundWinCondition : uint8_t {
	Att_Killed = 0,
	Def_Killed = 1,
	Bomb_Exploded = 2,
	Bomb_Defused = 3,
...
enum class EVoteType : uint8_t {
	Vote_Kick = 0,
	Vote_OfferSurrender = 1,
	Vote_Surrender = 2,
	Vote_KnifeWinners = 3,
	Vote_TechnicalTimeout = 4,
	Vote_TacticalTimeout = 5,
	Vote_MAX = 6,
};
...
enum class EVideoTrainingType : uint8_t {
	Wartide = 0,
	Arcade = 1,
	Movement = 2,
	Weapons = 3,
...
enum class EFireUpState : uint8_t {
	None = 0,
	Deploying = 1,
	Activated = 2,
	Completed = 3,
...
enum class EWeaponHold : uint8_t {
	Default = 0,
	Alternate = 1,
	Long = 2,
	Pistol = 3,
...
enum class EScoreAwardType : uint8_t {
	KEY_DEFAULT = 0,
	BATT_Generic_Kill = 1,
	BATT_Generic_Assist = 2,
	BATT_Generic_Death = 3,
	HP_Generic_Kill = 4,
	HP_Generic_Assist = 5,
	HP_Generic_Death = 6,
	HP_Objective_Kill = 7,
	HP_Objective_Assist = 8,
	HP_Zone_Capture = 9,
	HP_Zone_Contesting = 10,
	HP_In_Owned_Zone = 11,
	CGO_Generic_Kill = 12,
	CGO_Generic_Assist = 13,
	CGO_Generic_Death = 14,
	CGO_Objective_Kill = 15,
	CGO_Objective_Enabled = 16,
	CGO_Objective_Disabled = 17,
	CGO_Objective_Contested = 18,
	CGO_Objective_Checkpoint_Reached = 19,
	CGO_Offensive_In_Enabled_Payload_Zone = 20,
	CGO_Defensive_In_Disabled_payload_Zone = 21,
	WRT_Generic_Kill = 22,
	WRT_Generic_Assist = 23,
	WRT_Generic_Death = 24,
	WRT_Bomb_Plant = 25,
	WRT_Bomb_Diffuse = 26,
	WRT_Bomb_Carrier_Kill = 27,
	WRT_Bomb_Planted_By_Team = 28,
	WRT_Bomb_Diffused_By_Team = 29,
	KEY_MAX = 30,
	EScoreAwardType_MAX = 31,
};

enum class EDefaultPromptButtonSelection : uint8_t {
	NONE = 0,
	ACCEPT = 1,
	CANCEL = 2,
	MAX = 3,
...
enum class ELiveFireTrainingDifficulty : uint8_t {
	EASY = 0,
	MEDIUM = 1,
	HARD = 2,
	ELiveFireTrainingDifficulty_MAX = 3,
};
...
enum class ENuclearSortDirection : uint8_t {
	Ascending = 0,
	Descending = 1,
	ENuclearSortDirection_MAX = 2,
};

enum class ESpawnWeight : uint8_t {
	TooNear = 0,
	TooFar = 1,
	UnsafeSpawn = 2,
	ClearSpawn = 3,
...
enum class EParentModKit : uint8_t {
	Default = 0,
	Infiltrator = 1,
	UNDC = 2,
	WW2 = 3,
...
enum class EPromodActionPrompt : uint8_t {
	AP_PlantBomb = 0,
	AP_QuickPlantBomb = 1,
	AP_DefuseBomb = 2,
	AP_None = 3,
...
enum class EMovementJumpMode : uint8_t {
	JUMP_None = 0,
	JUMP_Queued = 1,
	JUMP_AutoBunny = 2,
	JUMP_MAX = 3,
...
enum class EOnFireAwardType : uint8_t {
	None = 0,
	Kill = 1,
	AirKill = 2,
	CollateralKill = 3,
...
enum class ETeamSwitchValues : uint8_t {
	Friendly = 0,
	Enemy = 1,
	ETeamSwitchValues_MAX = 2,
};
...
enum class EDashDirection : uint8_t {
	CameraDirection = 0,
	MovementDirection = 1,
	EDashDirection_MAX = 2,
};

enum class EDOMZoneState : uint8_t {
	DOMZoneState_Neutral = 0,
	DOMZoneState_Captured = 1,
	DOMZoneState_Losing = 2,
	DOMZoneState_Lost = 3,
	DOMZoneState_MAX = 4,
};
...
enum class ECommandLevel : uint8_t {
	Base = 0,
	Admin = 1,
	Cheat = 2,
	Debug = 3,
...
enum class EFireUpComboType : uint8_t {
	RefreshDuration = 0,
	ProvideAnotherUse = 1,
	EFireUpComboType_MAX = 2,
};
...
enum class ESpatialMarkerOptions : uint8_t {
	NONE = 0,
	Healthbar = 1,
	Outline = 2,
	Icon = 3,
	ESpatialMarkerOptions_MAX = 4,
};
...
enum class ENUIButtonStyle : uint8_t {
	None = 0,
	Normal = 1,
	Hovered = 2,
	Pressed = 3,
	ENUIButtonStyle_MAX = 4,
};
...
enum class EPromodEvents : uint8_t {
	Event_BombPlanted = 0,
	Event_BomdDefused = 1,
	Event_SwappingSides = 2,
	Event_Default = 3,
	Event_MAX = 4,
};
...
enum class EProScoreType : uint8_t {
	Unranked = 0,
	Bronze = 1,
	Silver = 2,
	Gold = 3,
...
enum class ELoadoutCardType : uint8_t {
	Blank = 0,
	Class = 1,
	Accessory = 2,
	ELoadoutCardType_MAX = 3,
};
...
enum class ENetworkStatus : uint8_t {
	Good = 0,
	Poor = 1,
	VeryPoor = 2,
	ENetworkStatus_MAX = 3,
};
...
enum class EMapSelectType : uint8_t {
	InGameVote = 0,
	GrenadeTraining = 1,
	VSBots = 2,
	EMapSelectType_MAX = 3,
};

enum class ENuclearSessionSettingType : uint8_t {
	Invalid = 0,
	Empty = 1,
	Int32 = 2,
	UInt32 = 3,
	...
	Json = 11,
	Count = 12,
	ENuclearSessionSettingType_MAX = 13,
};
...
enum class EFireUpActionType : uint8_t {
	None = 0,
	Kill = 1,
	Death = 2,
	Plant = 3,
	Defuse = 4,
	EFireUpActionType_MAX = 5,
};
...
enum class EBattalionMedalCategory : uint8_t {
	Uncategorised = 0,
	Generic = 1,
	Killstreak = 2,
	Multikill = 3,
	...
	Special = 10,
	FFA = 11,
	EBattalionMedalCategory_MAX = 12,
};
...
enum class EQuickUtilType : uint8_t {
	QuickUtil_Stun = 0,
	QuickUtil_MAX = 1,
};
...
enum class EClassChangeCondition : uint8_t {
	Cond_Always = 0,
	Cond_Preround = 1,
	Cond_MAX = 2,
};
...
enum class EOnFireAwardTiming : uint8_t {
	Instant = 0,
	ScalingOverTime = 1,
	ScalingCustom = 2,
	EOnFireAwardTiming_MAX = 3,
};
...
enum class EPFMatchmakingState : uint8_t {
	NotLoggedIn = 0,
	NoServerBuildId = 1,
	ReadyToStart = 2,
	TestingRegions = 3,
	CancellingTickets = 4,
	CreatingTicket = 5,
	CreatingPartyTicket = 6,
	JoiningPartyTicket = 7,
	WaitingForMatch = 8,
	GettingMatchInfo = 9,
	EPFMatchmakingState_MAX = 10,
};
...
enum class EWeaponCondition : uint8_t {
	War_Torn = 0,
	Battle_Hardened = 1,
	Flawless = 2,
	EWeaponCondition_MAX = 3,
};
...
enum class ESpecialGrenadeType : uint8_t {
	SGT_WhiteSmoke = 0,
	FlashBang = 1,
	Stun = 2,
	ESpecialGrenadeType_MAX = 3,
};
...
enum class EMatchmakingQueue : uint8_t {
	Arcade = 0,
	Wartide = 1,
	EMatchmakingQueue_MAX = 2,
};
...
enum class EWorldCollapseType : uint8_t {
	Bomb = 0,
	Shootout = 1,
	EWorldCollapseType_MAX = 2,
};
...
enum class EHardpointWorldMarkers : uint8_t {
	LOCKED = 0,
	CAPTURE_NEUTRAL = 1,
	CAPTURE_ENEMY = 2,
	DEFEND = 3,
...
enum class EMatchAchievementStat : uint8_t {
	WartideWins = 0,
	PlayWartide = 1,
	TDMWins = 2,
	DomWins = 3,
...
enum class ELogSubsystem : uint8_t {
	ONLINE = 0,
...
enum class ESkinRarity : uint8_t {
	Stock = 0,
	Common = 1,
	Uncommon = 2,
	Rare = 3,
...
enum class EBattleHubTabType : uint8_t {
	Rewards = 0,
	Armoury = 1,
	Medals = 2,
	Overview = 3,
	Leaderboards = 4,
	EBattleHubTabType_MAX = 5,
};
...
enum class EForcedPlatform : uint8_t {
	FP_None = 0,
	FP_XBOX = 1,
	FP_PS4 = 2,
	FP_PC = 3,
...
enum class EVoiceKey : uint8_t {
	Empty = 0,
	FriendlyThrowingGrenade = 1,
	FriendlyThrowingSmoke = 2,
	FriendlyReloading = 3,
	GrenadeIncoming = 4,
	FriendlyGettingHit = 5,
	FriendlyGettingShotAt = 6,
	FriendlyGettingShotAt_Sniper = 7,
	FriendlyDiesNearby = 8,
	YouGetHit = 9,
	YouGettingShotAt = 10,
	YouGettingShotAt_Sniper = 11,
	YouGetAKill = 12,
	YouGetAKill_Naded = 13,
	YouGetAKill_Headshot = 14,
	YouGetAKill_Knifed = 15,
	Promoted = 16,
	DOMStartInstructions = 17,
	DOMBeingDominated = 18,
	DOMHoldingAllFlags = 19,
	DOMTakenA = 20,
	DOMTakenB = 21,
	DOMTakenC = 22,
	DOMLostA = 23,
	DOMLostB = 24,
	DOMLostC = 25,
	CTFStartInstructions = 26,
	CTFYourTeamCaptures = 27,
	CTFTheirTeamCaptures = 28,
	CTFTheyPickupYourFlag = 29,
	CTFYouPickupTheirFlag = 30,
	WRTStartInstructions = 31,
	TDMStartInstructions = 32,
	HQStartInstructions = 33,
	HQYourTeamCaptures = 34,
	HQTheirTeamCaptures = 35,
	HQObjectiveLocated = 36,
	HQObjectiveUnlocked = 37,
	HQYourTeamDestroyed = 38,
	HQTheirTeamDestroyed = 39,
	HQYourTeamSecured = 40,
	HQTheirTeamSecured = 41,
	GlobalHalfwayToVictory = 42,
	GlobalEnemyHalfwayToVictory = 43,
	GlobalOneMinuteLeftWinning = 44,
	GlobalOneMinuteLeftLosing = 45,
	GlobalLeadLost = 46,
	GlobalLeadTaken = 47,
	EVoiceKey_MAX = 48,
};
...
enum class ELastKeyAction : uint8_t {
	LKA_Sprint = 0,
	LKA_Target = 1,
	LKA_MAX = 2,
};
...
enum class ELoadoutWeaponType : uint8_t {
	None = 0,
	MainWeapon = 1,
	Sidearm = 2,
	ELoadoutWeaponType_MAX = 3,
};
...
enum class EPingCategory : uint8_t {
	None = 0,
	Enemy = 1,
	Info = 2,
	EPingCategory_MAX = 3,
...
enum class ELastProneKeyAction : uint8_t {
	LPKA_WASD = 0,
	LPKA_Target = 1,
	LPKA_MAX = 2,
};
...
enum class EGameActionsAllowed : uint8_t {
	GAE_ALL = 0,
	GAE_SWAP = 1,
	GAE_NONE = 2,
	GAE_LOOK = 3,
...
enum class ECargoPlayerSideState : uint8_t {
	ATTACKING = 0,
	DEFENDING = 1,
	ECargoPlayerSideState_MAX = 2,
};
...
enum class EPlatformOriginationType : uint8_t {
	Global = 0,
	Xbox = 1,
	PSN = 2,
	EPlatformOriginationType_MAX = 3,
};
...
enum class EInGameAchievementStat : uint8_t {
	KillDiffusingWithGrenade = 0,
	WartidePlantBomb = 1,
	WartideConsecutiveRoundGrenadeKills = 2,
	KillBombCarriers = 3,
	DomOwnAllObjectives = 4,
	Kills = 5,
	DiffuseBomb = 6,
	ShotgunKills = 7,
	SniperKills = 8,
	...
	CollateralKills = 13,
	KillStreak = 14,
	MultipleKillsWithGrenade = 15,
	DomKillNeutralising = 16,
	DomKillObjectiveGrenade = 17,
	Wartide3ShotgunKillsInRound = 18,
	WartideRoundWinWhenPlanted = 19,
	WartideAceRound = 20,
	ClutchAllies = 21,
	ClutchAxis = 22,
	EInGameAchievementStat_MAX = 23,
};

enum class EHardpointSounds : uint8_t {
	FIRST_SPAWN = 0,
	POINT_UNLOCKED = 1,
	CAPTURE_ENEMY = 2,
	CAPTURE_FRIENDLY = 3,
...
enum class EMapEditorTransformSpace : uint8_t {
	WorldSpace = 0,
	LocalSpace = 1,
	EMapEditorTransformSpace_MAX = 2,
};

enum class EBombZoneWorldMarkerState : uint8_t {
	ATTACK = 0,
	DEFEND = 1,
	NONE = 2,
	EBombZoneWorldMarkerState_MAX = 3,
};
...
enum class ECargoWorldMarkers : uint8_t {
	ATTACK = 0,
	ESCORT = 1,
	DEFEND = 2,
	CAPTURE = 3,
...
enum class ECharacterTeam : uint8_t {
	CHR_FRIENDLY = 0,
	CHR_ENEMY = 1,
	CHR_MAX = 2,
};

enum class EActionPrompt : uint8_t {
	AP_PlantBomb = 0,
	AP_DefuseBomb = 1,
	AP_TakeBomb = 2,
	AP_TakeFlag = 3,
...
enum class ECargoContentionState : uint8_t {
	Unoccupied = 0,
	AttackersOccupy = 1,
	DefendersOccupy = 2,
	BothOccupy = 3,
	ECargoContentionState_MAX = 4,
};
...
enum class ELoadoutItem : uint8_t {
	NewEnumerator0 = 0,
	NewEnumerator1 = 1,
	NewEnumerator2 = 2,
	NewEnumerator3 = 3,
...
enum class EAimTrainingMode : uint8_t {
	AT_None = 0,
	AT_Regular = 1,
	AT_Reflex = 2,
	AT_Moving = 3,
...
enum class ECargoHideMarkersType : uint8_t {
	Checkpoint = 0,
	Capture = 1,
	Both = 2,
	ECargoHideMarkersType_MAX = 3,
};
...
enum class ENUM_MovementState : uint8_t {
	NewEnumerator0 = 0,
	NewEnumerator1 = 1,
	NewEnumerator2 = 2,
	NewEnumerator3 = 3,
...
enum class EMapEditorTransformMode : uint8_t {
	Translation = 0,
	Rotation = 1,
	Scale = 2,
	EMapEditorTransformMode_MAX = 3,
};
...
enum class EVersusNotificationWidgetState : uint8_t {
	EVNWS_Idle = 0,
	EVNWS_FadeIn = 1,
	EVNWS_ShowNewNumber = 2,
	ENVWS_FadeOut = 3,
	EVersusNotificationWidgetState_MAX = 4,
};

enum class ELoadoutSlotType : uint8_t {
	Empty = 0,
	Used = 1,
	Fixed = 2,
	Unavailable = 3,
	ELoadoutSlotType_MAX = 4,
};
...
enum class EMapEditorAxis : uint8_t {
	X = 0,
	Y = 1,
	Z = 2,
	XY = 3,
	...
	YZ = 5,
	XYZ = 6,
	EMapEditorAxis_MAX = 7,
};

enum class ENuclearSessionType : uint8_t {
	Lobby = 0,
	ListenServer = 1,
	DedicatedServer = 2,
	ENuclearSessionType_MAX = 3,
};
...
enum class EMonorailWorldMarkerStates : uint8_t {
	ATTACK_ESCORT = 0,
	DISABLING_ESCORT = 1,
	REPAIRING_DISABLED = 2,
	NONE = 3,
	EMonorailWorldMarkerStates_MAX = 4,
};
...
enum class EBattalionMedalRarity : uint8_t {
	Common = 0,
	Uncommon = 1,
	Rare = 2,
	UltraRare = 3,
	Godlike = 4,
	EBattalionMedalRarity_MAX = 5,
};
...
enum class EBattalionLoadoutClaimType : uint8_t {
	Null = 0,
	Equip = 1,
	Hold = 2,
	Pickup = 3,
	EBattalionLoadoutClaimType_MAX = 4,
};
...
enum class ENationType : uint8_t {
	Nation_FRIENDLY = 0,
	Nation_ENEMY = 1,
	Nation_Invalid = 2,
	Nation_MAX = 3,
...
enum class EBattalionLoadoutClaimOverflowBehaviour : uint8_t {
	Deny = 0,
	Clamp = 1,
	EBattalionLoadoutClaimOverflowBehaviour_MAX = 2,
};
...
enum class EBattalionState : uint8_t {
	None = 0,
	Entry = 1,
	MainMenu = 2,
	Playing = 3,
	EBattalionState_MAX = 4,
};
...
enum class EBattalionColour : uint8_t {
	Friendly = 0,
	Enemy = 1,
	Neutral = 2,
	Self = 3,
...
enum class ENUM_MovementAction : uint8_t {
	NewEnumerator0 = 0,
	NewEnumerator1 = 1,
	NewEnumerator2 = 2,
	NewEnumerator3 = 3,
...
enum class ECargoCheckpointState : uint8_t {
	Unoccupied = 0,
	AttackersOccupy = 1,
	DefendersOccupy = 2,
	BothOccupy = 3,
	ECargoCheckpointState_MAX = 4,
};
...
enum class EMapViewRotationMode : uint8_t {
	UseFixedRotation = 0,
	InheritYaw = 1,
...
enum class ENuclearInputType : uint8_t {
	None = 0,
	KeyboardAndMouse = 1,
	GenericGamepad = 2,
	Xbox360Controller = 3,
	...
	SteamController = 7,
	SwitchController = 8,
	SwitchProController = 9,
	ENuclearInputType_MAX = 10,
};
...
enum class EMapPackGamemode : uint8_t {
	Jumper = 0,
	KillRun = 1,
	SearchAndDestroy = 2,
	EMapPackGamemode_MAX = 3,
};

enum class EStanceType : uint8_t {
	ST_Standing = 0,
	ST_Crouching = 1,
	ST_Prone = 2,
	ST_MAX = 3,
...
enum class ENuclearMacroEvent : uint8_t {
	None = 0,
	KeyDown = 1,
	KeyUp = 2,
	Analog = 3,
...
enum class KillfeedEntryType : uint8_t {
	NewEnumerator0 = 0,
	NewEnumerator1 = 1,
	NewEnumerator2 = 2,
	KillfeedEntryType_MAX = 3,
};

enum class ETeamVisibility : uint8_t {
	VisibleToNone = 0,
	VisibleToAll = 1,
	VisibleToAllies = 2,
	VisibleToEnemies = 3,
	ETeamVisibility_MAX = 4,
};
...
enum class EProgressTimer : uint8_t {
	None = 0,
	Planting = 1,
	Defusing = 2,
	Capturing = 3,
	EProgressTimer_MAX = 4,
};
...
enum class EWeaponArchetype : uint8_t {
	SMG = 0,
	Rifle = 1,
	Sniper = 2,
	Pistol = 3,
	Melee = 4,
	EWeaponArchetype_MAX = 5,
};
...
enum class ECargoNotificationState : uint8_t {
	Attack = 0,
	Complete = 1,
	Hide = 2,
	ECargoNotificationState_MAX = 3,
};
...
enum class ENuclearAssetResult : uint8_t {
	Valid = 0,
	Invalid = 1,
	ENuclearAssetResult_MAX = 2,
};
