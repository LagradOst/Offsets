...
struct USFPSUserWidget_EquipItem {
...
struct USFPSACCraftKit {
	ASFPSBaseLocationCraftItem* LocationCraftItem; // 0xb0
};

struct USFPSAI_TSetSightResolution {
...
struct UDcxVehicleNoDriveComponent {
...
struct USFPSUserWidget_SpriteViewInv {
...
struct Ascope_opt_hamr_4x_empty_C {
...
struct Aweapon_firearms_rifle_groza_C {
...
struct Aweapon_firearms_gun_M9_C {
...
struct Aweapmf_DTK_556x45_01_C {
	USceneComponent* Muzzle; // 0x390
};

struct Arecoveryitem_medikit_rag_C {
	float Timer; // 0x420
};
...
struct UABP_weapon_firearms_smg_mp5_C {
...
struct USFPSAnimEvent_PlaySound {
...
struct Aweapon_firearms_smg_hkump_C {
...
struct UFormMap_C {
	...
	UButton* btnExit; // 0x268
	UCheckBox* btnLocation; // 0x270
	UButton* btnMain; // 0x278
	UCheckBox* btnRandom; // 0x280
	UButton* btnRespawn; // 0x288
	UImage* imgRespawn; // 0x290
	UTextBlock* lbExit; // 0x298
	UNamedSlot* nsHint; // 0x2a0
	USFPSUserWidget_MapElement* SelectedMapElement; // 0x2a8
	bool WheelUp; // 0x2b0
};

struct ABM_WallTriaWindow_02_C {
	USFPSACBaseCollision* SFPSACBaseCollision; // 0x358
	USFPSACSnapComponent* SFPSACSnap; // 0x360
};
...
struct AProjectile_C {
	USceneComponent* DefaultSceneRoot; // 0x310
};

struct UABP_weapon_firearms_supp_rgm40_C {
...
struct UABP_weapon_firearms_rifle_scar_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
	FAnimNode_Root AnimGraphNode_Root; // 0x2e8
...
struct Aweapon_firearms_gun_pm_C {
...
struct UfrmAAdminPanelGroup_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2b0
	UCheckBox* btnOpen; // 0x2b8
	UImage* imgBackground0; // 0x2c0
	UImage* imgIcon; // 0x2c8
	UScrollBox* sbMain; // 0x2d0
};

struct ASFPSBaseCharacter {
...
struct USFPSUserWidget_ServerListItem {
	FDelegate OnSelectEvent; // 0x2f8
	FDelegate OnDblClickedEvent; // 0x308
	FDelegate OnAddFavoriteEvent; // 0x318
};
...
struct USFPSAnimEvent_InverseKinematics {
...
struct Aweapon_firearms_rifle_famas_C {
	UStaticMeshComponent* DTK; // 0x7e0
...
struct ASFPSGameplayEventPoint {
...
struct Aweapon_steelarms_axe_01_C {
...
struct USFPSHiddenStash {
	ASFPSLootBoxSpawner* LootBoxSpawner; // 0x30
};

struct ASFPSSmallArms {
...
struct ASFPSWeaponMF_AdditionalCartridge {
...
struct UABP_weapon_firearms_smg_scorpion_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
	FAnimNode_Root AnimGraphNode_Root; // 0x2e8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x318
	FAnimNode_TransitionResult AnimGraphNode_TransitionResult_2; // 0x360
...
struct USimpleFTPClientBPLibrary {
...
struct UMainMenu_C {
	UButton* btnContinue_Steam; // 0x260
	UButton* btnDiscord; // 0x268
	UButton* btnExit; // 0x270
	UButton* btnFacebook; // 0x278
	UButton* btnJoinServer_LoginPassword; // 0x280
	UButton* btnJoinServer_Steam; // 0x288
	UButton* btnSettings; // 0x290
	UButton* btnSteam; // 0x298
	UButton* btnTwitch; // 0x2a0
	UButton* btnTwitter; // 0x2a8
	UButton* btnVK; // 0x2b0
};
...
struct Aweapon_firearms_rifle_steyraug_C {
	UStaticMeshComponent* DTK; // 0x7e0
	UStaticMeshComponent* DeviceLeftMount; // 0x7e8
...
struct ABMF_Sandbags_03_C {
	USFPSACBaseCollision* SFPSACBaseCollision1; // 0x358
	USFPSACBaseCollision* SFPSACBaseCollision; // 0x360
};

struct USFPSUserWidget_RadialMenu {
	int32_t SelectedIndex; // 0x268
};

struct UFormInGameMenu_C {
	UButton* btnDiscord; // 0x260
	UButton* btnFacebook; // 0x268
	UButton* btnGreenAreaTeleport; // 0x270
	UButton* btnLeaveServer; // 0x278
	UButton* btnQuitGame; // 0x280
	UButton* btnResume; // 0x288
	UButton* btnSettings; // 0x290
	UButton* btnSteam; // 0x298
	UButton* btnSuicide; // 0x2a0
...
struct Aweapon_firearms_sg_mp133_C {
	UStaticMeshComponent* DeviceLeftMount; // 0x7e0
	USFPSACWeaponMFInventory* SFPSACWeaponMFInventory; // 0x7e8
...
struct USFPSAI_TClearTargetAndFocus {
	bool bClearTarget; // 0x70
	bool bClearFocus; // 0x71
};

struct USFPSLockBreakingHandler {
...
struct ASFPSOnlineBeaconClient {
...
struct USFPSAmbientSoundManager {
...
struct UFormDlg_ItemList_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UButton* btnOk; // 0x268
	UTextBlock* lbOk; // 0x270
	UfrmSpriteViewInv_C* sv0; // 0x278
	UfrmSpriteViewInv_C* sv1; // 0x280
	UfrmSpriteViewInv_C* sv2; // 0x288
	UfrmSpriteViewInv_C* sv3; // 0x290
	UfrmSpriteViewInv_C* sv4; // 0x298
	UfrmSpriteViewInv_C* sv5; // 0x2a0
	UfrmSpriteViewInv_C* sv6; // 0x2a8
};

struct USFPSBaseHandler {
...
struct UFormDlg_Timer_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UButton* btnCancel; // 0x268
	UImage* imgProrgess; // 0x270
	UMaterialInstanceDynamic* Progress; // 0x278
};
...
struct UABP_weapon_firearms_gun_c1911_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
	FAnimNode_Root AnimGraphNode_Root; // 0x2e8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x318
...
struct At_AdditionalCartridge_C {
...
struct UFormLockBreaking_C {
	UImage* Image_85; // 0x260
};
...
struct UABP_weapon_firearms_rifle_steyraug_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
	FAnimNode_Root AnimGraphNode_Root; // 0x2e8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x318
	FAnimNode_TransitionResult AnimGraphNode_TransitionResult_2; // 0x360
...
struct Aweapon_firearms_rifle_m4a1_C {
	UStaticMeshComponent* DTK; // 0x7e0
	UStaticMeshComponent* DeviceLeftMount; // 0x7e8
	UStaticMeshComponent* SightClose; // 0x7f0
	UStaticMeshComponent* SightOpen; // 0x7f8
...
struct UABP_weapon_firearms_rifle_hunter85_C {
...
struct Ascope_opt_elcan_4x_C {
	UStaticMeshComponent* hamr_4x_reticles; // 0x3d0
};

struct UABP_weapon_firearms_rifle_famas_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
	FAnimNode_Root AnimGraphNode_Root; // 0x2e8
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x318
	FAnimNode_Slot AnimGraphNode_Slot; // 0x398
...
struct USFPSUserWidget_TraderItem {
	ASFPSBaseItem* ItemClass; // 0x260
	int32_t ActorGroupItemIndex; // 0x26c
	int32_t ActorLibraryItemIndex; // 0x270
...
struct UABP_weapon_firearms_snip_svd_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
	FAnimNode_Root AnimGraphNode_Root; // 0x2e8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x318
	FAnimNode_TransitionResult AnimGraphNode_TransitionResult_2; // 0x360
...
struct UFormSettings_C {
	UComboBoxString* cbVideo_Mode; // 0x260
	UComboBoxString* cbVideo_Resolution; // 0x268
};
...
struct UABP_weapon_firearms_rifle_aksu_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
	FAnimNode_Root AnimGraphNode_Root; // 0x2e8
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x318
	FAnimNode_Slot AnimGraphNode_Slot; // 0x398
...
struct UABP_weapon_firearms_snip_mosin_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x300
	FAnimNode_Root AnimGraphNode_Root; // 0x308
...
struct UfrmFilterCombobox_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UButton* btnFitlter; // 0x268
	UTextBlock* lbText; // 0x270
	FString FComboboxString; // 0x278
	UComboBoxString* FParentCombobox; // 0x288
};

struct ASFPSCommonGameState {
...
struct Aweapmf_DTK_5-7x28_01_C {
	USceneComponent* Muzzle; // 0x390
};
...
struct AShootingRangeTarget01_C {
...
struct Adevice_flashlight_02_C {
...
struct UfrmQuickSlot_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	UButton* btnMain; // 0x2c8
	USFPSUserWidget_EquipItem* pnMain; // 0x2d0
};
...
struct UfrmAdminPanelDeathRecord_C {
	UButton* btnSelected; // 0x2e0
};
...
struct Aweapmf_DTK_762x25_01_C {
	USceneComponent* Muzzle; // 0x390
};
...
struct Aweapmf_DTK_545x39_02_C {
	USceneComponent* Muzzle; // 0x390
};
...
struct Ascope_opt_cod_4x_C {
	UStaticMeshComponent* cod_4x_reticles; // 0x3d0
};

struct ABP_SFPSAIController_C {
...
struct Aweapon_firearms_rifle_aks74u_mod_C {
	UStaticMeshComponent* DTK; // 0x7e0
...
struct USFPSAISenseConfig_Sight {
...
struct ASFPSMovingAmbientSound {
	float Speed; // 0x230
};
...
struct UFormChat_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UfrmPopupMenu_C* frmPopupMenu; // 0x268
	UNamedSlot* nsPopupMenu; // 0x270
	USFPSUserWidget_ChatItem* FSelectedChatItem; // 0x278
	bool FMouseRightButtonIsDowned; // 0x280
	bool FMouseLeftButtonIsDowned; // 0x281
};
...
struct UDcxVehicleWheelsRawInput {
...
struct USFPSMainInterfaceHandler {
	ASFPSHUD* HUD; // 0x110
...
struct USoundNodeModulOuterParam {
...
struct USFPSAI_TSwitchFromPeace {
...
struct UfrmPopupMenu_C {
	UImage* imgBackgroun1; // 0x260
	UImage* imgBackgroun2; // 0x268
	UImage* imgBackgroun3; // 0x270
	UImage* imgBackgroun4; // 0x278
	UImage* imgBackgroun5; // 0x280
	UImage* imgBackgroun6; // 0x288
	UImage* imgBackgroun7; // 0x290
	UImage* imgBackgroun8; // 0x298
	UCanvasPanel* pnBackGround; // 0x2a0
};
...
struct Arecoveryitem_medikit_painkillers_C {
	float Timer; // 0x420
};
...
struct Aweapmf_DTK_556x45_03_C {
	USceneComponent* Muzzle; // 0x390
};
...
struct USFPSAdminHandler {
	TArray<FString> CurrentDeathLog; // 0x620
...
struct UFormDlg_OkCancel_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UButton* btnCancel; // 0x268
	UButton* btnOk; // 0x270
	UTextBlock* lbCancel; // 0x278
	UTextBlock* lbOk; // 0x280
};
...
struct USFPSBaseWeaponAnimInstance {
...
struct UModulatorContOuterParams {
...
struct At_Equipment_WithoutInventory_C {
	UStaticMeshComponent* Mesh; // 0x3a8
	UBoxComponent* Trace; // 0x3b0
};
...
struct Aweapmf_DTK_556x45_02_C {
	USceneComponent* Muzzle; // 0x390
};

struct ARespawnActor_C {
	USceneComponent* DefaultSceneRoot; // 0x220
};

struct UfrmPopupMenuItem_C {
	UImage* imgSeparator; // 0x290
};
...
struct USFPSUserWidget_AdminPanel_Player {
	FDelegate OnSelectEvent; // 0x2a0
};
...
struct UABP_weapon_firearms_gun_PM_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
	FAnimNode_Root AnimGraphNode_Root; // 0x2e8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x318
	FAnimNode_TransitionResult AnimGraphNode_TransitionResult_6; // 0x360
...
struct UfrmRadialMenu_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x270
	UUMG_RadialMenu_C* rmMotions_Start; // 0x278
};

struct USFPSAI_SSetRandomFocusPoint {
	float MaxAngle; // 0x70
};
...
struct UABP_weapon_firearms_rifle_groza_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
	FAnimNode_Root AnimGraphNode_Root; // 0x2e8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x318
...
struct Aweapon_firearms_snip_mosin_long_C {
	UStaticMeshComponent* DeviceLeftMount; // 0x7e0
...
struct UFormDlg_TimerInf_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UImage* imgBackground; // 0x268
	UImage* imgProrgess; // 0x270
	UMaterialInstanceDynamic* Progress; // 0x278
};
...
struct UABP_weapon_firearms_sg_mp133_C {
...
struct USFPSUserWidget_CraftRollout {
	FDelegate OnBeginCraftEvent; // 0x2e0
};
...
struct UfrmAdminPanelPlayer_C {
	UButton* btnSelected; // 0x2b0
};
...
struct Ascope_col_deltapoint_C {
...
struct USFPSAnimEvent_Weap_Steel_Damage {
...
struct Aweapmf_silencer_762x39_01_C {
	USceneComponent* Muzzle; // 0x390
};

struct ASFPSBaseMissileProjectile {
...
struct USFPSAnimEvent_WC_ChangingFlag {
	bool bWeaponChanging; // 0x38
	bool bForCursor; // 0x39
};

struct ABM_WallBig_01_C {
...
struct ASFPSWeaponMF_MuzzleAttachment {
...
struct Aweapmf_DTK_762x39_01_C {
	USceneComponent* Muzzle; // 0x390
};
...
struct Aweapon_firearms_snip_svd_C {
	UStaticMeshComponent* DeviceLeftMount; // 0x7e0
	UStaticMeshComponent* MagazineFull; // 0x7e8
	UStaticMeshComponent* MagazineEmpty; // 0x7f0
	UStaticMeshComponent* SightClose; // 0x7f8
...
struct Amat_wood_logs_01_C {
	USceneComponent* Scene1; // 0x320
	USceneComponent* Scene; // 0x328
};

struct Aweapmf_DTK_762x39_02_C {
	USceneComponent* Muzzle; // 0x390
};
...
struct AResonanceAudioDirectivityVisualizer {
	UMaterial* Material; // 0x290
	UResonanceAudioSpatializationSourceSettings* Settings; // 0x298
};
...
struct ASFPSAirDropCargo {
	UProjectileMovementComponent* MovementComponent; // 0x240
	USoundCue* LandedSound; // 0x248
};

struct Arecoveryitem_medikit_bandage_C {
	float Timer; // 0x420
};

struct ABMF_Gates_01_C {
...
struct USFPSGameInstance {
	...
	UUserWidget* FormMainMenu; // 0x648
	UUserWidget* FormLoadingScreen; // 0x650
	TArray<FText> KickMSGList; // 0x6b0
	bool bIsClientKick; // 0x6c0
	ASFPSOnlineBeaconHost* BeaconHost; // 0x6c8
	ASFPSOnlineBeaconHostObject* BeaconHostObject; // 0x6d0
	USFPSInventoryHandler* InventoryHandler; // 0x6d8
	USFPSMessageHandler* MessageHandler; // 0x6e0
	USFPSFontHandler* FontHandler; // 0x6e8
	USFPSUseObjectHandler* UseObjectHandler; // 0x6f0
	USFPSSplitHandler* SplitHandler; // 0x6f8
	USFPSMainInterfaceHandler* MainInterfaceHandler; // 0x700
	USFPSSettingsHandler* SettingsHandler; // 0x708
	USFPSLockBreakingHandler* LockBreakingHandler; // 0x710
	USFPSDebrisHandler* DebrisHandler; // 0x718
	USFPSMapHandler* MapHandler; // 0x720
	USFPSCraftEditor* CraftEditor; // 0x728
	USFPSSoundHandler* SoundHandler; // 0x730
	USFPSServerListHandler* ServerListHandler; // 0x738
	USFPSChatHandler* ChatHandler; // 0x740
	USFPSCreatePlayerHandler* CreatePlayerHandler; // 0x748
	USFPSAdminHandler* AdminHandler; // 0x750
	USFPSBaseHandler* BaseHandler; // 0x758
	bool b_dbg_BallisticsTracesEnabled; // 0x760
	bool b_dbg_CraftDebugEnabled; // 0x761
	UMaterialParameterCollection* ParametersCollection; // 0x768
	AActor* BaseSphere; // 0x770
	USFPSUISoundTable* UISounds; // 0x8c8
	UAudioComponent* MusicAudioComponent; // 0x8d0
	UObject* AfterDeathActorClass; // 0x8d8
};
...
struct ASFPSShootingRangeTarget {
...
struct Ascope_opt_pso_C {
	UStaticMeshComponent* cod_4x_reticles; // 0x3d0
};

struct Aweapmf_DTK_762x39_03_C {
	USceneComponent* Muzzle; // 0x390
};
...
struct ABM_WallTriaWindow_01_C {
	USFPSACBaseCollision* SFPSACBaseCollision; // 0x358
	USFPSACSnapComponent* SFPSACSnap; // 0x360
};
...
struct UABP_weapon_firearms_gun_TT_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
	FAnimNode_Root AnimGraphNode_Root; // 0x2e8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x318
	FAnimNode_TransitionResult AnimGraphNode_TransitionResult_6; // 0x360
...
struct UFormBase_C {
	UButton* btnClose; // 0x260
	UButton* btnDelete; // 0x268
	UCheckBox* btnRegistration; // 0x270
	UButton* Registration_btnAdd; // 0x278
	UButton* Registration_btnCopy; // 0x280
	UButton* Registration_btnCopyAdded; // 0x288
	UButton* Registration_btnDel; // 0x290
	UButton* Registration_btnSteamProfile; // 0x298
	UButton* Registration_btnSteamProfileAdded; // 0x2a0
};

struct UfrmAllSettingsComboboxes_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UButton* btnMain; // 0x268
	UTextBlock* lbText; // 0x270
	UComboBoxString* FParentCombobox; // 0x278
	FString FComboboxString; // 0x280
};

struct UModulatorOuterParams {
	float ValueMin; // 0x28
	float ValueMax; // 0x2c
};

struct USFPSAnimEvent_Weap_ReloadingFlag {
...
struct UFormNDA_C {
	UButton* btnAccept; // 0x260
};

struct Aweapmf_silencer_556x45_01_C {
	USceneComponent* Muzzle; // 0x390
};
...
struct Aweapon_firearms_rifle_aks74u_C {
	UStaticMeshComponent* DTK; // 0x7e0
	UStaticMeshComponent* DeviceLeftMount; // 0x7e8
	UStaticMeshComponent* SightOpen; // 0x7f0
	USFPSACWeaponMFInventory* SFPSACWeaponMFInventory; // 0x7f8
...
struct UABP_weapon_firearms_sg_mp43_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x310
	FAnimNode_Root AnimGraphNode_Root; // 0x318
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x348
	FAnimNode_Slot AnimGraphNode_Slot; // 0x3c8
...
struct Aweapon_firearms_gun_tt_C {
	USFPSACWeaponMFInventory* SFPSACWeaponMFInventory; // 0x7e0
	UStaticMeshComponent* MagazineFull; // 0x7e8
	UStaticMeshComponent* MagazineEmpty; // 0x7f0
};
...
struct UfrmChatItem_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x310
	UButton* btnMain; // 0x318
};
...
struct UResonanceAudioSettings {
...
struct Aweapon_firearms_rifle_akm_C {
	UStaticMeshComponent* DeviceLeftMount; // 0x7e0
...
struct At_Material_C {
	UBoxComponent* Trace; // 0x310
	UStaticMeshComponent* Mesh; // 0x318
};

struct Aweapon_firearms_mg_rpk_C {
	UStaticMeshComponent* DeviceLeftMount; // 0x7e0
	UStaticMeshComponent* SideBracket_base; // 0x7e8
	UStaticMeshComponent* SightClose; // 0x7f0
	USFPSACWeaponMFInventory* SFPSACWeaponMFInventory; // 0x7f8
...
struct UDcxVehicleDriveComponentTank {
...
struct USFPSMapHandler {
	bool bVisible; // 0x298
	UUserWidget* FormMap; // 0x2a0
	USFPSUserWidget_MapElement* MapElement_Player; // 0x2a8
	USFPSUserWidget_MapElement* MapElement_Mission; // 0x2b0
	USFPSUserWidget_MapElement* MapElement_SaveScaleMission; // 0x2b8
	USFPSUserWidget_MapElement* MapElement_AllPlayersMarker; // 0x2c0
	USFPSUserWidget_MapElement* MapElement_AllBasesMarker; // 0x2c8
	USFPSUserWidget_MapElement* MapElement_AllBotsMarker; // 0x2d0
	USFPSUserWidget_MapElement* MapElement_TacticalMarker; // 0x2d8
	USFPSUserWidget_MapElement* MapElement_DeadMarker; // 0x2e0
	USFPSUserWidget_MapElement* MapElement_LootStash; // 0x2e8
	USFPSUserWidget_MapElement* MapElement_GreenArea; // 0x2f0
	USFPSUserWidget_MapElement* MapElement_RedArea; // 0x2f8
	USFPSUserWidget_MapElement* MapElement_Base; // 0x300
	USFPSUserWidget_MapElement* MapElement_Location; // 0x308
	USFPSUserWidget_MapElement* MapElement_SquadMarker; // 0x310
	USFPSUserWidget_MapElement* MapElement_TripwireTrap; // 0x318
	TArray<USFPSTacticalMarker*> TacticalMarkers; // 0x320
	USFPSTacticalMarker* DeadMarker; // 0x330
	TArray<USFPSLootStashMarker*> LootStashMarkers; // 0x338
	TArray<USFPSMissionMarker*> MissionMarkers; // 0x348
	TArray<USFPSSaveScaleMissionMarker*> SaveScaleMissionMarkers; // 0x358
	TArray<USFPSAllPlayersMarker*> AllPlayersMarkers; // 0x368
	TArray<USFPSAllBasesMarker*> AllBasesMarkers; // 0x378
	TArray<USFPSAllBotsMarker*> AllBotsMarkers; // 0x388
	TArray<USFPSGreenAreaMarker*> GreeenAreaMarkers; // 0x398
	TArray<USFPSRedAreaMarker*> RedAreaMarkers; // 0x3a8
	TArray<USFPSBaseMarker*> BaseMarkers; // 0x3b8
	TArray<USFPSLocationMarker*> LocalitiesMarkers; // 0x3c8
	TArray<USFPSSquadMarker*> SquadMarkers; // 0x3d8
	TArray<USFPSTripwireTrapMarker*> TripwireTrapMarkers; // 0x3e8
};
...
struct AUltra_Dynamic_Sky_BP_C {
...
struct ASFPSInventoryDeviceItem {
	int32_t ID; // 0x310
...
struct Aweapmf_DTK_545x39_01_C {
	USceneComponent* Muzzle; // 0x390
};
...
struct Adevice_flashlight_01_C {
	UStaticMeshComponent* Glow; // 0x4a0
	USpotLightComponent* Light; // 0x4a8
};

struct UABP_weapon_firearms_smg_p90_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
	FAnimNode_Root AnimGraphNode_Root; // 0x2e8
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x318
	FAnimNode_Slot AnimGraphNode_Slot; // 0x398
...
struct USFPSUserWidget_ChatItem {
	FSFPSChatItemInfo Info; // 0x290
	FDelegate OnDblClickedEvent; // 0x300
};
...
struct ASFPSWeaponMF_HandguardDeviceLeft {
...
struct Ascope_col_walter_mrs_C {
...
struct USFPSUserWidget_ChatBox {
	FSlateFontInfo Font; // 0x2a0
	float ViewportScale; // 0x2f8
	bool bUseCustomPanel; // 0x2fc
};

struct USFPSAI_DRandom {
	int32_t Chance; // 0x68
};
...
struct Aweapon_firearms_smg_bizon_C {
	UStaticMeshComponent* DTK; // 0x7e0
	UStaticMeshComponent* DeviceLeftMount; // 0x7e8
	UStaticMeshComponent* SightClose; // 0x7f0
	USFPSACWeaponMFInventory* SFPSACWeaponMFInventory; // 0x7f8
...
struct UFormAdmin_C {
	UButton* Base_btnCopyPlayer; // 0x260
	UButton* Base_btnDelBase; // 0x268
	UButton* Base_btnDelBoxes; // 0x270
	UButton* Base_btnKeyChance; // 0x278
	UButton* Base_btnSteamProfile; // 0x280
	UButton* Base_btnStromTime; // 0x288
	UCheckBox* btnBase; // 0x290
	UCheckBox* btnBattlePVEOnly; // 0x298
	UCheckBox* btnBattlePVPPVE; // 0x2a0
	UButton* btnBuyServer; // 0x2a8
	UCheckBox* btnCameraFPS; // 0x2b0
	UCheckBox* btnCameraFPSTPS; // 0x2b8
	UCheckBox* btnCameraTPS; // 0x2c0
	UCheckBox* btnDeathLog; // 0x2c8
	UCheckBox* btnGameplay; // 0x2d0
	UCheckBox* btnItems; // 0x2d8
	UCheckBox* btnMessages; // 0x2e0
	UCheckBox* btnPlayers; // 0x2e8
	UCheckBox* btnServer; // 0x2f0
	UButton* btnServer_Teleport0; // 0x2f8
	UButton* btnServer_Teleport1; // 0x300
	UButton* btnServer_Teleport2; // 0x308
	UButton* btnServer_Teleport3; // 0x310
	UButton* btnServer_Teleport4; // 0x318
	UButton* btnServer_TeleportDead; // 0x320
	UCheckBox* btnVACNo; // 0x328
	UCheckBox* btnVACYes; // 0x330
	UButton* DeathLog_btnCopy; // 0x338
	UButton* DeathLog_btnDownload; // 0x340
	UfrmAdminPanelDeathRecord_C* frmAdminPanelDeathRecord; // 0x348
	UfrmAdminPanelDeathRecord_C* frmAdminPanelDeathRecord_125; // 0x350
	UImage* Gameplay_Background_2; // 0x358
	UImage* Gameplay_BackLine_2; // 0x360
	UImage* Gameplay_BackLine_3; // 0x368
	UImage* Gameplay_BackLine_4; // 0x370
	UImage* Gameplay_BackLine_5; // 0x378
	UImage* Gameplay_BackLine_6; // 0x380
	UImage* Gameplay_BackLine_7; // 0x388
	UImage* Gameplay_BackLine_8; // 0x390
	UImage* Gameplay_BackLine_9; // 0x398
	UButton* Gameplay_btnApplyAISettings; // 0x3a0
	UButton* Gameplay_btnApplyEventsSettings; // 0x3a8
	UCheckBox* Gameplay_btnDynamicTimeScaleOff; // 0x3b0
	UCheckBox* Gameplay_btnDynamicTimeScaleOn; // 0x3b8
	UCheckBox* Gameplay_btnPatrolOff; // 0x3c0
	UCheckBox* Gameplay_btnPatrolOn; // 0x3c8
	UImage* imgButtonsBackground; // 0x3d0
	UButton* Messages_btnMsgTimer; // 0x3d8
	UButton* Messages_btnSaveMOTD; // 0x3e0
	UButton* Messages_btnSaveMsg; // 0x3e8
	UButton* Messages_btnSendMOTD; // 0x3f0
	UButton* Messages_btnSendMsg; // 0x3f8
	UMultiLineEditableTextBox* Messages_mMOTD; // 0x400
	UMultiLineEditableTextBox* Messages_mMsg; // 0x408
	UButton* Players_btnAddToAdmins; // 0x410
	UButton* Players_btnBan; // 0x418
	UButton* Players_btnCopyBanned; // 0x420
	UButton* Players_btnCopyPlayer; // 0x428
	UButton* Players_btnDelFromAdmins; // 0x430
	UButton* Players_btnHandBan; // 0x438
	UButton* Players_btnSteamProfile; // 0x440
	UButton* Players_btnSteamProfileAdmins; // 0x448
	UButton* Players_btnSteamProfileBanned; // 0x450
	UButton* Players_btnSteamProfileHandBan; // 0x458
	UButton* Players_btnUnban; // 0x460
	UButton* Server_btnAdminRespawnDeadMarkerDist; // 0x468
...
struct USFPSACLocality {
	...
	int32_t RespawnPoints; // 0x23c
	bool bBase; // 0x240
};

struct ASFPSBaseLocationCraftItem {
...
struct UFormDead_C {
	UImage* imgBlackBackground; // 0x260
};

struct USFPSSettingsHandler {
...
struct Aweapmf_flashlight_02_C {
	UStaticMeshComponent* Glow; // 0x358
	USpotLightComponent* Light; // 0x360
};

struct UResonanceAudioReverbPluginPreset {
...
struct Ascope_opt_hamr_4x_col_C {
	UStaticMeshComponent* hamr_4x_reticles; // 0x3d0
};
...
struct UABP_weapon_firearms_mg_mg36_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
	FAnimNode_Root AnimGraphNode_Root; // 0x2e8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x318
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x360
...
struct Aweapon_firearms_gun_fiveseven_C {
	UStaticMeshComponent* DeviceLeftMount; // 0x7e0
	USFPSACWeaponMFInventory* SFPSACWeaponMFInventory; // 0x7e8
	UStaticMeshComponent* MagazineFull; // 0x7f0
	UStaticMeshComponent* MagazineEmpty; // 0x7f8
...
struct Aweapon_firearms_sg_m4_C {
	UStaticMeshComponent* DeviceLeftMount; // 0x7e0
	USFPSACWeaponMFInventory* SFPSACWeaponMFInventory; // 0x7e8
	UStaticMeshComponent* Shell; // 0x7f0
};
...
struct UABP_weapon_firearms_rifle_m4a1_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
	FAnimNode_Root AnimGraphNode_Root; // 0x2e8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x318
	FAnimNode_TransitionResult AnimGraphNode_TransitionResult_2; // 0x360
...
struct USFPSWeaponAnimInstance_SG {
...
struct USFPSUserWidget_GroundItem {
	TWeakObjectPtr<ASFPSBaseItem> TagObject0; // 0x260
	TWeakObjectPtr<ASFPSBaseItem> TagObject1; // 0x268
	TWeakObjectPtr<ASFPSBaseItem> TagObject2; // 0x270
	bool bUsedObject0; // 0x278
	bool bUsedObject1; // 0x279
	bool bUsedObject2; // 0x27a
	ESFPSGroundScrollBoxType ScrollBoxType; // 0x27b
	float DblClickTimer; // 0x27c
};
...
struct Aweapon_steelarms_knife_01_C {
	USceneComponent* DamagePoint2; // 0x620
	USceneComponent* DamagePoint1; // 0x628
	USceneComponent* DamagePoint0; // 0x630
};

struct USFPSACBoxCollisionComponent {
	USFPSPhysicalMaterial* PhysicalMaterial; // 0x478
};

struct AFlashGrenade_C {
...
struct Aweapon_firearms_sg_mp43_C {
	UStaticMeshComponent* DeviceLeftMount; // 0x7e0
	USFPSACWeaponMFInventory* SFPSACWeaponMFInventory; // 0x7e8
...
struct Aweapon_firearms_snip_barrettm99_C {
...
struct UABP_weapon_firearms_gun_M9_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
	FAnimNode_Root AnimGraphNode_Root; // 0x2e8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x318
	FAnimNode_TransitionResult AnimGraphNode_TransitionResult_6; // 0x360
...
struct USFPSTradeList {
	FSFPSTradeGroupList SellList; // 0x28
	FSFPSTradeGroupList BuyList; // 0x38
};

struct USFPSUserWidget_HUDChatBox {
	int32_t LabelsCount; // 0x2d4
	FSlateFontInfo Font; // 0x2d8
	float ViewportScale; // 0x330
};
...
struct USFPSACVehicleSoundSystem {
...
struct Aweapon_firearms_mg_mg36_C {
	UStaticMeshComponent* DTK; // 0x7e0
...
struct UFormSplit_C {
	UButton* btnCancel; // 0x260
	UButton* btnDown; // 0x268
	UButton* btnMax; // 0x270
	UButton* btnMin; // 0x278
	UButton* btnOk; // 0x280
	UButton* btnUp; // 0x288
	UEditableTextBox* edText; // 0x290
	UImage* imgBackground0; // 0x298
	UfrmSpriteViewInv_C* svItem; // 0x2a0
};
...
struct UCreatePlayer_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UCheckBox* btnAfro01; // 0x268
	UCheckBox* btnArab01; // 0x270
	UCheckBox* btnArab02; // 0x278
	UButton* btnCreate; // 0x280
	UCheckBox* btnEast01; // 0x288
	UCheckBox* btnEuro01; // 0x290
	UCheckBox* btnEuro02; // 0x298
	UCheckBox* btnEuro03; // 0x2a0
	UButton* btnMenu; // 0x2a8
	UImage* imgBackground; // 0x2b0
	UTextBlock* lbButtonLogin; // 0x2b8
	UTextBlock* lbMenu; // 0x2c0
};
...
struct Arecoveryitem_medikit_sterilizedrag_C {
	float Timer; // 0x420
};

struct ASFPSRecoveryItem {
...
struct Aweapon_firearms_smg_scorpion_C {
	UStaticMeshComponent* DeviceLeftMount; // 0x7e0
	USFPSACWeaponMFInventory* SFPSACWeaponMFInventory; // 0x7e8
	UStaticMeshComponent* MagazineFull; // 0x7f0
	UStaticMeshComponent* MagazineEmpty; // 0x7f8
...
struct Aweapon_firearms_gun_c1911_C {
	USFPSACWeaponMFInventory* SFPSACWeaponMFInventory; // 0x7e0
	UStaticMeshComponent* MagazineFull; // 0x7e8
	UStaticMeshComponent* MagazineEmpty; // 0x7f0
};
...
struct USFPSACWeaponMFInventory {
...
struct UfrmAdminPanelStartKitItem_C {
	UButton* btnAction0; // 0x310
};
...
struct USFPSACSoundSystem {
	...
	FTimerHandle TimerTalkDelHandle; // 0xf8
	bool bUnderwaterIsActive; // 0x100
	bool bDebug; // 0x102
	bool bDebugTrace; // 0x103
	USoundCue* CharDieCue; // 0x108
	USoundCue* CharBreathCue; // 0x110
	USoundCue* CharHeartCue; // 0x118
	USoundCue* CharacterRollCue; // 0x120
	USoundCue* CharPainShout; // 0x128
	USoundCue* NoiceCue; // 0x130
	USoundCue* NoiseBreathCue; // 0x138
	USoundCue* CharBackMovCue; // 0x140
	USoundCue* WeaponPressedCue; // 0x148
	bool bUseCertainVoice; // 0x150
	USFPSSoundTalkSet* STS_Voice; // 0x158
	USFPSVoiceList* VoiceList; // 0x160
	int32_t VoiceNumber; // 0x168
	float FallHeight; // 0x1a0
	USFPSPhysicalMaterial* CharacterPM; // 0x1a8
	USoundCue* SwimmingCue; // 0x1c0
	UParticleSystem* SwimmingIdleParticle; // 0x1c8
	UParticleSystem* SwimmingParticle; // 0x1d0
	UParticleSystem* SwimmingFastParticle; // 0x1d8
	USoundCue* UnderwaterStep; // 0x1e0
	UReverbEffect* UnderwaterReverbEffect; // 0x1e8
	UReverbEffect* InVehicleReverbEffect; // 0x1f0
};
...
struct UDcxVehicleDriveRawInput {
...
struct At_LocationCraftActor_C {
...
struct Aweapon_firearms_smg_fnp90_C {
	UStaticMeshComponent* DTK; // 0x7e0
	UStaticMeshComponent* DeviceLeftMount; // 0x7e8
	UStaticMeshComponent* SightOpen; // 0x7f0
	USFPSACWeaponMFInventory* SFPSACWeaponMFInventory; // 0x7f8
...
struct UABP_weapon_firearms_smg_ump_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
	FAnimNode_Root AnimGraphNode_Root; // 0x2e8
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x318
	FAnimNode_Slot AnimGraphNode_Slot; // 0x398
...
struct UServerList_C {
	UButton* btnBack; // 0x260
	UButton* btnBuyServer; // 0x268
	UButton* btnIP; // 0x270
	UButton* btnJoin; // 0x278
	UButton* btnRefresh; // 0x280
	UfrmServerListItem_C* frmServerListItem; // 0x288
	UImage* spGPortal; // 0x290
	UImage* spVivox; // 0x298
};
...
struct UDcxVehicleDriveComponent {
...
struct UABP_weapon_firearms_smg_Bizon_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
	FAnimNode_Root AnimGraphNode_Root; // 0x2e8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x318
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x360
...
struct UFormHUD_C {
	UfrmCompass_C* frmCompass; // 0x260
	UImage* imgNoPVP; // 0x268
	UfrmRadialMenu_C* rmMain; // 0x270
	UfrmHUDChatBox_C* uwChat; // 0x278
	ESlateVisibility imgShot0Visible; // 0x280
	ESlateVisibility imgShot1Visible; // 0x281
	ESlateVisibility imgShot2Visible; // 0x282
};
...
struct Aweapon_firearms_smg_hkmp5_C {
	UStaticMeshComponent* DTK; // 0x7e0
...
struct UABP_weapon_firearms_snip_barrettm99_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x300
	FAnimNode_Root AnimGraphNode_Root; // 0x308
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x338
	FAnimNode_Slot AnimGraphNode_Slot; // 0x3b8
...
struct UUMG_RadialMenu_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UImage* RadialBackground; // 0x268
	UImage* RadiusDebug; // 0x270
	UOverlay* RootOverlay; // 0x278
	int32_t Segments; // 0x280
	UMaterialInterface* MaterialBase; // 0x288
	float IndexRaw; // 0x290
	int32_t Index; // 0x294
	UMaterialInstanceDynamic* dynaMat; // 0x298
	TArray<UUserWidget*> Children; // 0x2a0
	bool AllowResizing; // 0x2b0
	float ItemOffsetRadius; // 0x2b4
	FMulticastInlineDelegate SelectionChanged; // 0x2b8
	APlayerController* InputController; // 0x2c8
	EJoystickTypes JoystickToUse; // 0x2d0
	float MouseDeadzone; // 0x2d4
	bool bInDeadzone; // 0x2d8
	FMulticastInlineDelegate EnteredDeadzone; // 0x2e0
	FMulticastInlineDelegate ExitedDeadzone; // 0x2f0
	FVector2D CurrentInput; // 0x300
	float JoystickDeadzone; // 0x308
	bool DefaultToMouseIfNoJoystick; // 0x30c
	int32_t DefaultPlayerIndex; // 0x310
	bool UseDeadzoneEvents; // 0x314
	USoundBase* SelectionChangedSound; // 0x318
	bool AutoCenterMouse; // 0x320
	bool AutoRotateForUp; // 0x321
	bool bUseCustomInput; // 0x322
	FVector2D CustomInput; // 0x324
	bool UseCustomTexture; // 0x32c
	UTexture* RadialTexture; // 0x330
	bool UseCustomColors; // 0x338
	FLinearColor InnterRingColor; // 0x33c
	FLinearColor OuterRingColor; // 0x34c
	FLinearColor RingMainColor; // 0x35c
	FLinearColor UnhighlightColor; // 0x36c
	FVector2D CorrectionVector; // 0x37c
	bool bForceSetIndex; // 0x384
};
...
struct UShootCrossfadeOuterParams {
...
struct UDcxVehicleWheelsComponent {
...
struct UABP_weapon_firearms_sg_m4_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x310
	FAnimNode_Root AnimGraphNode_Root; // 0x318
...
struct UfrmCraftItem_C {
	UButton* btnCraft; // 0x2f0
};
...
struct UABP_weapon_firearms_rifle_akm_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
	FAnimNode_Root AnimGraphNode_Root; // 0x2e8
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x318
	FAnimNode_Slot AnimGraphNode_Slot; // 0x398
...
struct Aweapon_steelarms_axe_02_C {
	USceneComponent* DamagePoint2; // 0x620
	USceneComponent* DamagePoint1; // 0x628
	USceneComponent* DamagePoint0; // 0x630
};

struct Ascope_col_eotech_C {
...
struct USFPSGameplayEventManager {
...
struct UResonanceAudioSpatializationSourceSettings {
...
struct ASFPSProjectileGrenade {
	float Damage; // 0x428
	bool bCanDamageBase; // 0x42c
};

struct UfrmGroundItem_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x280
	UButton* btnItem0; // 0x288
	UButton* btnItem1; // 0x290
	UButton* btnItem2; // 0x298
};

struct Aweapon_firearms_supp_rgm40_C {
...
struct Aweapon_steelarms_knife_02_C {
	USceneComponent* DamagePoint2; // 0x620
	USceneComponent* DamagePoint1; // 0x628
	USceneComponent* DamagePoint0; // 0x630
};
...
struct USFPSAI_TSwitchMoveMode {
...
struct UABP_weapon_firearms_gun_fiveseven_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
	FAnimNode_Root AnimGraphNode_Root; // 0x2e8
	FAnimNode_Slot AnimGraphNode_Slot; // 0x318
	FAnimNode_TransitionResult AnimGraphNode_TransitionResult_6; // 0x360
...
struct USoundNodeModulContOuterParam {
...
struct USFPSHiddenStashManager {
...
struct USFPSInventoryHandler {
	UUserWidget* FormInventory; // 0x580
	USFPSUserWidget_GroundItem* FormGroundItem; // 0x588
	USFPSUserWidget_PopupMenuItem* FormPopupMenuItem; // 0x590
	USFPSUserWidget_CraftRolloutMan* FormCraftGroup; // 0x598
	USFPSUserWidget_CraftRollout* FormCraftItem; // 0x5a0
	USFPSUserWidget_TraderItem* FormTradeItem; // 0x5a8
	UUserWidget* frmHintPanelUse; // 0x5b0
	UUserWidget* frmHintPanelMove; // 0x5b8
	UUserWidget* frmHintPanelDrop; // 0x5c0
	TArray<UPaperSprite*> FPopupMenuIcons; // 0x5c8
};
...
struct UABP_weapon_firearms_sg_mossberg590_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x310
	FAnimNode_Root AnimGraphNode_Root; // 0x318
	FAnimNode_SequencePlayer AnimGraphNode_SequencePlayer; // 0x348
	FAnimNode_Slot AnimGraphNode_Slot; // 0x3c8
...
struct UFormInventory_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UCheckBox* btnCar; // 0x268
	UCheckBox* btnCell; // 0x270
	UCheckBox* btnCorpse; // 0x278
	UCheckBox* btnCraft; // 0x280
	UCheckBox* btnGround; // 0x288
	UCheckBox* btnLootBox; // 0x290
	UCheckBox* btnSteamInventory; // 0x298
	UButton* btnSteamInventoryRefresh; // 0x2a0
	UCheckBox* btnTrader; // 0x2a8
	UComboBoxString* cbFilterLeft; // 0x2b0
	UComboBoxString* cbFilterSteamInventory; // 0x2b8
	UfrmPopupMenu_C* frmPopupMenu; // 0x2c0
	UImage* imgBackgroundAvailable; // 0x2c8
	UImage* imgBackgroundAvailableSteam; // 0x2d0
	UImage* imgBackgroundNotAvailableSteam; // 0x2d8
	UTextBlock* lbCar; // 0x2e0
	UTextBlock* lbCell; // 0x2e8
	UTextBlock* lbCorpse; // 0x2f0
	UTextBlock* lbCraft; // 0x2f8
	UTextBlock* lbGround; // 0x300
	UTextBlock* lbLootBox; // 0x308
	UTextBlock* lbSteamInventory; // 0x310
	UTextBlock* lbTakeAll; // 0x318
	UTextBlock* lbTrader; // 0x320
	UNamedSlot* nsDraggingItem; // 0x328
	UNamedSlot* nsHint; // 0x330
	UNamedSlot* nsPopupMenu; // 0x338
	UfrmSpriteViewEquip_C* svBackPack; // 0x340
	UfrmSpriteViewInv_C* svBackPack0; // 0x348
	UfrmSpriteViewInv_C* svBackPack1; // 0x350
	UfrmSpriteViewInv_C* svBackPack10; // 0x358
	UfrmSpriteViewInv_C* svBackPack11; // 0x360
	UfrmSpriteViewInv_C* svBackPack12; // 0x368
	UfrmSpriteViewInv_C* svBackPack13; // 0x370
	UfrmSpriteViewInv_C* svBackPack14; // 0x378
	UfrmSpriteViewInv_C* svBackPack15; // 0x380
	UfrmSpriteViewInv_C* svBackPack16; // 0x388
	UfrmSpriteViewInv_C* svBackPack17; // 0x390
	UfrmSpriteViewInv_C* svBackPack18; // 0x398
	UfrmSpriteViewInv_C* svBackPack19; // 0x3a0
	UfrmSpriteViewInv_C* svBackPack2; // 0x3a8
	UfrmSpriteViewInv_C* svBackPack3; // 0x3b0
	UfrmSpriteViewInv_C* svBackPack4; // 0x3b8
	UfrmSpriteViewInv_C* svBackPack5; // 0x3c0
	UfrmSpriteViewInv_C* svBackPack6; // 0x3c8
	UfrmSpriteViewInv_C* svBackPack7; // 0x3d0
	UfrmSpriteViewInv_C* svBackPack8; // 0x3d8
	UfrmSpriteViewInv_C* svBackPack9; // 0x3e0
	UfrmSpriteViewInv_C* svCar0; // 0x3e8
	UfrmSpriteViewInv_C* svCar1; // 0x3f0
	UfrmSpriteViewInv_C* svCar10; // 0x3f8
	UfrmSpriteViewInv_C* svCar11; // 0x400
	UfrmSpriteViewInv_C* svCar12; // 0x408
	UfrmSpriteViewInv_C* svCar13; // 0x410
	UfrmSpriteViewInv_C* svCar14; // 0x418
	UfrmSpriteViewInv_C* svCar15; // 0x420
	UfrmSpriteViewInv_C* svCar16; // 0x428
	UfrmSpriteViewInv_C* svCar17; // 0x430
	UfrmSpriteViewInv_C* svCar18; // 0x438
	UfrmSpriteViewInv_C* svCar19; // 0x440
	UfrmSpriteViewInv_C* svCar2; // 0x448
	UfrmSpriteViewInv_C* svCar20; // 0x450
	UfrmSpriteViewInv_C* svCar21; // 0x458
	UfrmSpriteViewInv_C* svCar22; // 0x460
	UfrmSpriteViewInv_C* svCar23; // 0x468
	UfrmSpriteViewInv_C* svCar24; // 0x470
	UfrmSpriteViewInv_C* svCar25; // 0x478
	UfrmSpriteViewInv_C* svCar26; // 0x480
	UfrmSpriteViewInv_C* svCar27; // 0x488
	UfrmSpriteViewInv_C* svCar28; // 0x490
	UfrmSpriteViewInv_C* svCar29; // 0x498
	UfrmSpriteViewInv_C* svCar3; // 0x4a0
	UfrmSpriteViewInv_C* svCar30; // 0x4a8
	UfrmSpriteViewInv_C* svCar31; // 0x4b0
	UfrmSpriteViewInv_C* svCar32; // 0x4b8
	UfrmSpriteViewInv_C* svCar33; // 0x4c0
	UfrmSpriteViewInv_C* svCar34; // 0x4c8
	UfrmSpriteViewInv_C* svCar35; // 0x4d0
	UfrmSpriteViewInv_C* svCar4; // 0x4d8
	UfrmSpriteViewInv_C* svCar5; // 0x4e0
	UfrmSpriteViewInv_C* svCar6; // 0x4e8
	UfrmSpriteViewInv_C* svCar7; // 0x4f0
	UfrmSpriteViewInv_C* svCar8; // 0x4f8
	UfrmSpriteViewInv_C* svCar9; // 0x500
	UfrmSpriteViewInv_C* svCell0; // 0x508
	UfrmSpriteViewInv_C* svCell1; // 0x510
	UfrmSpriteViewInv_C* svCell10; // 0x518
	UfrmSpriteViewInv_C* svCell11; // 0x520
	UfrmSpriteViewInv_C* svCell12; // 0x528
	UfrmSpriteViewInv_C* svCell13; // 0x530
	UfrmSpriteViewInv_C* svCell14; // 0x538
	UfrmSpriteViewInv_C* svCell15; // 0x540
	UfrmSpriteViewInv_C* svCell16; // 0x548
	UfrmSpriteViewInv_C* svCell17; // 0x550
	UfrmSpriteViewInv_C* svCell18; // 0x558
	UfrmSpriteViewInv_C* svCell19; // 0x560
	UfrmSpriteViewInv_C* svCell2; // 0x568
	UfrmSpriteViewInv_C* svCell20; // 0x570
	UfrmSpriteViewInv_C* svCell21; // 0x578
	UfrmSpriteViewInv_C* svCell22; // 0x580
	UfrmSpriteViewInv_C* svCell23; // 0x588
	UfrmSpriteViewInv_C* svCell24; // 0x590
	UfrmSpriteViewInv_C* svCell25; // 0x598
	UfrmSpriteViewInv_C* svCell26; // 0x5a0
	UfrmSpriteViewInv_C* svCell27; // 0x5a8
	UfrmSpriteViewInv_C* svCell28; // 0x5b0
	UfrmSpriteViewInv_C* svCell29; // 0x5b8
	UfrmSpriteViewInv_C* svCell3; // 0x5c0
	UfrmSpriteViewInv_C* svCell30; // 0x5c8
	UfrmSpriteViewInv_C* svCell31; // 0x5d0
	UfrmSpriteViewInv_C* svCell32; // 0x5d8
	UfrmSpriteViewInv_C* svCell33; // 0x5e0
	UfrmSpriteViewInv_C* svCell34; // 0x5e8
	UfrmSpriteViewInv_C* svCell35; // 0x5f0
	UfrmSpriteViewInv_C* svCell4; // 0x5f8
	UfrmSpriteViewInv_C* svCell5; // 0x600
	UfrmSpriteViewInv_C* svCell6; // 0x608
	UfrmSpriteViewInv_C* svCell7; // 0x610
	UfrmSpriteViewInv_C* svCell8; // 0x618
	UfrmSpriteViewInv_C* svCell9; // 0x620
	UfrmSpriteViewInv_C* svGadget0; // 0x628
	UfrmSpriteViewInv_C* svGadget1; // 0x630
	UfrmSpriteViewInv_C* svGadget2; // 0x638
	UfrmSpriteViewInv_C* svGadget3; // 0x640
	UfrmSpriteViewInv_C* svGlasses; // 0x648
	UfrmSpriteViewInv_C* svGloves; // 0x650
	UfrmSpriteViewInv_C* svHelmet; // 0x658
	UfrmSpriteViewEquip_C* svJacket; // 0x660
	UfrmSpriteViewInv_C* svJacket0; // 0x668
	UfrmSpriteViewInv_C* svJacket1; // 0x670
	UfrmSpriteViewInv_C* svJacket2; // 0x678
	UfrmSpriteViewInv_C* svJacket3; // 0x680
	UfrmSpriteViewInv_C* svLootBox0; // 0x688
	UfrmSpriteViewInv_C* svLootBox1; // 0x690
	UfrmSpriteViewInv_C* svLootBox10; // 0x698
	UfrmSpriteViewInv_C* svLootBox11; // 0x6a0
	UfrmSpriteViewInv_C* svLootBox12; // 0x6a8
	UfrmSpriteViewInv_C* svLootBox13; // 0x6b0
	UfrmSpriteViewInv_C* svLootBox14; // 0x6b8
	UfrmSpriteViewInv_C* svLootBox15; // 0x6c0
	UfrmSpriteViewInv_C* svLootBox16; // 0x6c8
	UfrmSpriteViewInv_C* svLootBox17; // 0x6d0
	UfrmSpriteViewInv_C* svLootBox18; // 0x6d8
	UfrmSpriteViewInv_C* svLootBox19; // 0x6e0
	UfrmSpriteViewInv_C* svLootBox2; // 0x6e8
	UfrmSpriteViewInv_C* svLootBox20; // 0x6f0
	UfrmSpriteViewInv_C* svLootBox21; // 0x6f8
	UfrmSpriteViewInv_C* svLootBox22; // 0x700
	UfrmSpriteViewInv_C* svLootBox23; // 0x708
	UfrmSpriteViewInv_C* svLootBox24; // 0x710
	UfrmSpriteViewInv_C* svLootBox25; // 0x718
	UfrmSpriteViewInv_C* svLootBox26; // 0x720
	UfrmSpriteViewInv_C* svLootBox27; // 0x728
	UfrmSpriteViewInv_C* svLootBox28; // 0x730
	UfrmSpriteViewInv_C* svLootBox29; // 0x738
	UfrmSpriteViewInv_C* svLootBox3; // 0x740
	UfrmSpriteViewInv_C* svLootBox30; // 0x748
	UfrmSpriteViewInv_C* svLootBox31; // 0x750
	UfrmSpriteViewInv_C* svLootBox32; // 0x758
	UfrmSpriteViewInv_C* svLootBox33; // 0x760
	UfrmSpriteViewInv_C* svLootBox34; // 0x768
	UfrmSpriteViewInv_C* svLootBox35; // 0x770
	UfrmSpriteViewInv_C* svLootBox4; // 0x778
	UfrmSpriteViewInv_C* svLootBox5; // 0x780
	UfrmSpriteViewInv_C* svLootBox6; // 0x788
	UfrmSpriteViewInv_C* svLootBox7; // 0x790
	UfrmSpriteViewInv_C* svLootBox8; // 0x798
	UfrmSpriteViewInv_C* svLootBox9; // 0x7a0
	UfrmSpriteViewInv_C* svMask; // 0x7a8
	UfrmQuickSlot_C* svQuickSlot0; // 0x7b0
	UfrmQuickSlot_C* svQuickSlot1; // 0x7b8
	UfrmQuickSlot_C* svQuickSlot10; // 0x7c0
	UfrmQuickSlot_C* svQuickSlot2; // 0x7c8
	UfrmQuickSlot_C* svQuickSlot3; // 0x7d0
	UfrmQuickSlot_C* svQuickSlot4; // 0x7d8
	UfrmQuickSlot_C* svQuickSlot5; // 0x7e0
	UfrmQuickSlot_C* svQuickSlot6; // 0x7e8
	UfrmQuickSlot_C* svQuickSlot7; // 0x7f0
	UfrmQuickSlot_C* svQuickSlot8; // 0x7f8
	UfrmQuickSlot_C* svQuickSlot9; // 0x800
	UfrmSpriteViewEquip_C* svTrous; // 0x808
	UfrmSpriteViewInv_C* svTrous0; // 0x810
	UfrmSpriteViewInv_C* svTrous1; // 0x818
	UfrmSpriteViewInv_C* svTrous2; // 0x820
	UfrmSpriteViewInv_C* svTrous3; // 0x828
	UfrmSpriteViewEquip_C* svVest; // 0x830
	UfrmSpriteViewInv_C* svVest0; // 0x838
	UfrmSpriteViewInv_C* svVest1; // 0x840
	UfrmSpriteViewInv_C* svVest10; // 0x848
	UfrmSpriteViewInv_C* svVest11; // 0x850
	UfrmSpriteViewInv_C* svVest2; // 0x858
	UfrmSpriteViewInv_C* svVest3; // 0x860
	UfrmSpriteViewInv_C* svVest4; // 0x868
	UfrmSpriteViewInv_C* svVest5; // 0x870
	UfrmSpriteViewInv_C* svVest6; // 0x878
	UfrmSpriteViewInv_C* svVest7; // 0x880
	UfrmSpriteViewInv_C* svVest8; // 0x888
	UfrmSpriteViewInv_C* svVest9; // 0x890
	UfrmSpriteViewInv_C* svWeapon0; // 0x898
	UfrmSpriteViewInv_C* svWeapon0_SubItem0; // 0x8a0
	UfrmSpriteViewInv_C* svWeapon0_SubItem1; // 0x8a8
	UfrmSpriteViewInv_C* svWeapon0_SubItem2; // 0x8b0
	UfrmSpriteViewInv_C* svWeapon0_SubItem3; // 0x8b8
	UfrmSpriteViewInv_C* svWeapon0_SubItem4; // 0x8c0
	UfrmSpriteViewInv_C* svWeapon1; // 0x8c8
	UfrmSpriteViewInv_C* svWeapon1_SubItem0; // 0x8d0
	UfrmSpriteViewInv_C* svWeapon1_SubItem1; // 0x8d8
	UfrmSpriteViewInv_C* svWeapon1_SubItem2; // 0x8e0
	UfrmSpriteViewInv_C* svWeapon1_SubItem3; // 0x8e8
	UfrmSpriteViewInv_C* svWeapon1_SubItem4; // 0x8f0
	UfrmSpriteViewInv_C* svWeapon2; // 0x8f8
	UfrmSpriteViewInv_C* svWeapon2_SubItem0; // 0x900
	UfrmSpriteViewInv_C* svWeapon2_SubItem1; // 0x908
	UfrmSpriteViewInv_C* svWeapon2_SubItem2; // 0x910
	UfrmSpriteViewInv_C* svWeapon2_SubItem3; // 0x918
	UfrmSpriteViewInv_C* svWeapon2_SubItem4; // 0x920
	UfrmGroundItem_C* FSelectedGroundSpriteView_ForHint; // 0x928
	UfrmGroundItem_C* FSelectedGroundSpriteView_ForDraggingItem; // 0x930
	USFPSUserWidget_EquipItem* FSelectedEquipSpriteView_ForDraggingItem; // 0x938
	USFPSUserWidget_EquipItem* FSelectedEquipSpriteView_ForHint; // 0x940
	bool FMouseRightButtonIsDowned; // 0x948
	bool FMouseLeftButtonIsDowned; // 0x949
};
...
struct Aweapon_firearms_snip_mosin_short_C {
	UStaticMeshComponent* DeviceLeftMount; // 0x7e0
	UStaticMeshComponent* ShellMagazine; // 0x7e8
	UStaticMeshComponent* ShellBarrelEmpty; // 0x7f0
	UStaticMeshComponent* ShellBarrelFull; // 0x7f8
...
struct USFPSCreatePlayerHandler {
...
struct Aweapon_firearms_sg_mossberg590_C {
	UStaticMeshComponent* DeviceLeftMount; // 0x7e0
	USFPSACWeaponMFInventory* SFPSACWeaponMFInventory; // 0x7e8
	UStaticMeshComponent* SightOpen; // 0x7f0
...
struct UfrmChatBox_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x300
	UScrollBox* sbMain; // 0x308
};
...
struct Arecoveryitem_medikit_medx_C {
	float Timer; // 0x420
};
...
struct ASFPSCharacter {
	...
	int32_t ReputationPoints; // 0xdb4
	int32_t Steamcoins; // 0xdb8
	FVector BaseCenter; // 0xdc4
...
struct UMainGameInstance_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x8e0
};
...
struct USFPSUserWidget_QuickSlot {
	bool bAvailable; // 0x2b8
};
...
struct USFPSAnimEvent_Weap_SRReloadFlag {
...
struct Aweapon_firearms_sg_mp43_sawed_off_C {
	USFPSACWeaponMFInventory* SFPSACWeaponMFInventory; // 0x7e0
	UStaticMeshComponent* DeviceLeftMount; // 0x7e8
	UStaticMeshComponent* RightShell; // 0x7f0
	UStaticMeshComponent* LeftShellEmpty; // 0x7f8
...
struct At_HandguardDeviceLeft_C {
...
struct Aweapon_firearms_snip_s85_C {
	UStaticMeshComponent* DeviceLeftMount; // 0x7e0
	UStaticMeshComponent* ShellMagazine; // 0x7e8
	UStaticMeshComponent* MagazineEmpty; // 0x7f0
...
struct UDcxVehicleDriveComponent4W {
...
struct UFormItemMessage_C {
	UfrmSpriteViewMessage_C* svItem; // 0x260
};

struct USFPSUserWidget_AdminPanel_DeathL {
	FDelegate OnSelectEvent; // 0x2d0
};
...
struct ABMF_Sandbags_01_C {
	USFPSACBaseCollision* SFPSACBaseCollision; // 0x358
};

struct ABM_Wall_01_C {
	USFPSACBaseCollision* SFPSACBaseCollision; // 0x358
	USFPSACSnapComponent* SFPSACSnap; // 0x360
};

struct ASFPSItemSkin {
...
struct Aweapon_firearms_rifle_scar_C {
	UStaticMeshComponent* DTK; // 0x7e0
	UStaticMeshComponent* DeviceLeftMount; // 0x7e8
	UStaticMeshComponent* SightClose; // 0x7f0
	UStaticMeshComponent* SightOpen; // 0x7f8
...
struct USoundNodeCrossfadeShootByDistanceOuterParam {
...
struct USFPSACLootBoxInventory {
...
struct ABM_WallTria_01_C {
	USFPSACBaseCollision* SFPSACBaseCollision; // 0x358
	USFPSACSnapComponent* SFPSACSnap; // 0x360
};

struct USFPSAnimEvent_StairStepSound {
	bool IsRightLeg; // 0x38
};

struct UResonanceAudioSoundfieldSettings {
