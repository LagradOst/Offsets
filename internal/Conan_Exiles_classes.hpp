...
struct UPartyGameState : UObject {
	...
	APartyBeaconClient* ReservationBeaconClientClass; // 0x2c8
	APartyBeaconClient* ReservationBeaconClient; // 0x2d0
};
...
struct UW_RadialMenuSegment_C : URadialMenuSegment {
	UImage* EndCapRenderer; // 0x360
	UImage* IconView; // 0x368
	UNamedSlot* IconWidgetContainer; // 0x370
	UPieRenderWidget* PieRenderer; // 0x378
	UImage* StartCapRenderer; // 0x380
};
...
struct AServerSettings : AInfo {
	...
	bool EnableLoginQueue; // 0x8a1
	int32_t DisconnectionGraceTime; // 0x8a4
};
...
struct UConanGameInstance : UDWGameInstance {
	...
	UShowLoginUICallbackProxy* m_ShowLoginUIProxy; // 0xc50
	UConanOnlineEventsLibrary* m_OnlineEventsLibrary; // 0xc60
	UInGameJoinOrInvite* m_InGameJoinOrInvite; // 0xc68
	UInviteControllerParing* m_InviteParing; // 0xc70
	TArray<UMessageBoxWidget*> ErrorMessageBoxStack; // 0xca0
	TArray<UGraniteTileSet*> PreloadedGraniteTilesets; // 0xd20
	FScriptMulticastDelegate ActiveDeviceProfileChanged; // 0xda8
	UDataTable* m_SpawnProfessionTable; // 0xdb8
	UDataTable* m_SpawnThrallTierTable; // 0xdc0
};
...
struct UW_ExilesJourneyTrial_C : UExilesJourneyTrial {
	FPointerToUberGraphFrame UberGraphFrame; // 0x3b0
	UWidgetAnimation* Anim_Update; // 0x3b8
	UImage* Image_1; // 0x3c0
	UW_HotkeyIcon_C* W_HotkeyIcon; // 0x3c8
};
...
struct AConanPlayerController : ADWPlayerController {
	...
	FScriptMulticastDelegate SignalInteractionRadialMenuOpened; // 0xa00
	TArray<UCameraComponent*> m_OwnedCameraComponents; // 0xa10
	AActor* InitialPlayerStart; // 0xa20
	bool CanBypassBuildingBlockerVolumes; // 0xa28
	FString UserIDFromURLOptions; // 0xa70
	FScriptMulticastDelegate SignalCheatStatus; // 0xa80
	bool bDebugIgnoreBuildingCosts; // 0xa90
	float NetConnectionLostTimeout; // 0xa94
	float NetConnectionLostForcedKickTimeout; // 0xa98
	FScriptMulticastDelegate SignalPlayerListDataReady; // 0xaa0
	FScriptMulticastDelegate SignalBannedPlayerListReady; // 0xab0
	FScriptMulticastDelegate SignalWhiteListChanged; // 0xac0
	UConanCheatManager* ConanCheatManager; // 0xad0
	bool AllowInteraction; // 0xad8
	ACorpseBase* CorpseToFreeze; // 0xae0
	UMessageBoxWidget* PullFollowerMessage; // 0xb80
	TArray<TWeakObjectPtr<AConanCharacter>> ForcedNetRelevantActors; // 0xb88
	TArray<AConanCharacter*> m_NearbyNPCs; // 0xd28
	TSet<FPendingStreamOperation> m_PendingNPCStreamOperations; // 0xd38
	TArray<FPendingInventoryUpdate> m_PendingInventoryRequests; // 0xd88
	TMap<int32_t, FPendingInventoryUnregistration> m_PendingInventoryUnregisterRequests; // 0xd98
	TMap<int32_t, UGameItem*> m_UniqueIDToInventoryItemMap; // 0xe08
	bool m_bShowDebugText; // 0xeb8
	bool m_IsAdmin; // 0xeb9
	FPropertyDestructionHistory m_PropertyDestructionHistory; // 0xf60
	FString m_RandomDLCKey; // 0x10b0
	FString m_RandomRewardsKey; // 0x10c0
	bool m_HasRequestedDLCs; // 0x10d0
	bool m_HasRequestedRewards; // 0x10d1
	bool m_HasOngoingDLCRequest; // 0x10d2
	bool m_HasOngoingRewardsRequest; // 0x10d3
	TSet<FName> m_OwnedDLCs; // 0x10d8
	TSet<FName> m_OwnedRewards; // 0x1128
	URandomBuildingGeneratorProxy* m_RandomBuildingGenerator; // 0x1280
	UBuildingStressTesterProxy* m_BuildingStressTester; // 0x1288
	UBuildingRecordingRebuilderProxy* m_BuildingRecordingRebuilder; // 0x1290
	UTargetingSystemComponent* TargetingComponent; // 0x12a0
	UBuildingReplicationComponent* m_BuildingReplicationComponent; // 0x12a8
};
...
struct ABaseGameState_C : AConanGameState {
	FPointerToUberGraphFrame UberGraphFrame; // 0x1300
	USceneComponent* DefaultSceneRoot; // 0x1308
	float GlobalImpulseMultiplier; // 0x1310
	TArray<AAvatarCharacter*> SummonedAvatarTypes; // 0x1318
	TArray<AConanCharacter*> SummonedAvatarSummoners; // 0x1328
	bool AllowBuildingOutsideSplines; // 0x1338
};
...
struct UServerInfoBase : URootWidget {
	...
	bool m_IsBattlEyeEnabled; // 0x400
	bool m_ServerTransferEnabled; // 0x401
	FServerModList m_ServerModList; // 0x408
	bool m_IsValid; // 0x420
	USoundBase* HoveredSound; // 0x428
	FScriptMulticastDelegate SignalServerEntrySelected; // 0x458
	FScriptMulticastDelegate SignalServerListDeselected; // 0x468
	FScriptMulticastDelegate SignalServerEntryInvoked; // 0x478
};
...
struct UBP_ConanGameInstance_C : UConanGameInstance {
	FPointerToUberGraphFrame UberGraphFrame; // 0xdd0
	FScriptMulticastDelegate SignalStreamingFinished; // 0xdd8
	FTimerHandle LoadingProgress; // 0xde8
	float Timeout; // 0xdf0
	UMessageBoxWidget* Message_Disconnecting; // 0xdf8
	FBlueprintSessionResult JoiningSession; // 0xe00
	APlayerController* JoiningPlayerController; // 0xee8
	bool NoConnectionError; // 0xef0
};
...
struct AConanGameMode : ADWGameMode {
	USpawnTableComponent* SpawnTableSystem; // 0x660
	bool m_DatabaseOK; // 0x668
	bool RunInsideCollisionCheckOnLoad; // 0x669
	APurgeVolume* PurgeVolumeClass; // 0x670
	ASharedDebugInfo* SharedDebugInfoClass; // 0x678
	UConanProjectileRegistry* ConanProjectileRegistry; // 0x6c0
	TArray<FString> CountryBlackList; // 0x6e8
	bool BlockVPNConnections; // 0x6f8
	uint32_t MaxPeriodicBackupsToKeep; // 0x6fc
	float PeriodicBackupInterval; // 0x700
	int32_t MaxUpgradeBackupstoKeep; // 0x704
	UFrameRateReporter* m_ServerFrameRateReporter; // 0x708
	float CorpsesHarvestTimeLockSeconds; // 0x8dc
	FTimerHandle m_TickServerPopulationTimer; // 0x900
	FTimerHandle m_VerifyAttributesTimer; // 0x908
	FTimerHandle m_GetServerRatingRetryTimer; // 0x910
	URatingServerRequestConnection* m_RatingServerConnection; // 0x918
	FTimerHandle m_GuildMemberCountReportTimer; // 0x920
	FTimerHandle m_GuildThrallCountReportTimer; // 0x928
	FTimerHandle m_AttributeDistributionReportTimer; // 0x930
	FTimerHandle m_ServerMergeExportTimer; // 0x938
	TArray<ABuildingBase*> m_BuildingsBeingRecorded; // 0xa10
	TMap<int32_t, UObject*> m_BuildingRecordingPieceTypesIdToClass; // 0xa20
	TMap<UObject*, int32_t> m_BuildingRecordingPieceTypesClassToId; // 0xa70
	TSet<ABuildingBase*> m_BuildingsNeedingReplicationRebuild; // 0xb68
	TMap<int64_t, ULoadCharacterCallProxy*> m_LoadOfflineCharacterCallbacks; // 0xbb8
	TMap<int64_t, ULoadInventoryCallProxy*> m_LoadOfflineInventoryCallbacks; // 0xc08
	TArray<UUniqueID*> m_LoadOfflineInventoryActiveUIDs; // 0xc58
	TSet<APlaceableBase*> m_PlaceablesForValidation; // 0xd08
	TArray<APlaceableBase*> m_PlaceablesForStabilityCheck; // 0xd58
	TSet<ABuildingBase*> m_BuildingsForValidation; // 0xd68
	TSet<ABuildingBase*> m_AllMasterBuildings; // 0xe08
	UDbTransfer* DbTransfer; // 0xe58
};
...
struct UW_ServerList_C : UServerListBase {
	...
	UModDetailsRequest* ModDetailsRequest; // 0x8c0
	bool ClientIsAmerican; // 0x8c8
	int32_t LastSelection; // 0x8cc
	bool ValidJoiningSession; // 0x8d0
	float ScrollOffset; // 0x8d4
	URootWidget* NextWidget; // 0x8d8
	FWidgetTransform GPortalTransformDefault; // 0x8e0
	FWidgetTransform GPortalTransformController; // 0x8fc
	TArray<EServerType> CombatTypeIndexes; // 0x918
};
...
struct UJoinSessionCallbackProxy : UOnlineBlueprintCallProxyBase {
	FScriptMulticastDelegate onSuccess; // 0x28
	FScriptMulticastDelegate onFailure; // 0x38
	UObject* WorldContextObject; // 0x188
};
...
struct AGameModeBase : AInfo {
	...
	FTimerHandle LoginQueueTimer; // 0x480
	FTimerHandle DisconnectionGraceTimer; // 0x488
};
...
struct AAvatarCharacter : AConanCharacter {
	FText AvatarName; // 0x16d8
	AConanCharacter* m_Summoner; // 0x16f0
	bool m_AvatarTimerStarted; // 0x16fc
};
...
struct AStartupGameMode_C : AGameMode {
	USceneComponent* DefaultSceneRoot; // 0x4d0
};
...
struct UW_Settings_Control_C : USettingsControlBase {
	...
	UTextBlock* Category; // 0x398
	UW_ButtonNormal_C* CB_InvertBowControls; // 0x3a0
	UW_ButtonNormal_C* CB_MouseInvertY; // 0x3a8
	UW_ButtonNormal_C* CB_RightAxisInvertY; // 0x3b0
	UTextBlock* ControllerCategory; // 0x3b8
	UGridPanel* MouseSettings; // 0x3c0
	UW_EditableLabeledSlider_C* S_AimSensitivity; // 0x3c8
	UW_EditableLabeledSlider_C* S_LeftAxisDeadzone; // 0x3d0
	UW_EditableLabeledSlider_C* S_RightAxisAimSensitivity; // 0x3d8
	UW_EditableLabeledSlider_C* S_RightAxisDeadzone; // 0x3e0
	UW_EditableLabeledSlider_C* S_RightAxisSensitivity; // 0x3e8
	UW_EditableLabeledSlider_C* S_Sensitivity; // 0x3f0
};
...
struct UW_ServerInfo_C : UServerInfoBase {
	...
	UWidgetAnimation* Anim_FavoriteAdded; // 0x538
	UButton* B_SelectThis; // 0x540
	UBorder* Border_2; // 0x548
	UBorder* Brd_ActiveIndicator; // 0x550
	UImage* I_Battleye; // 0x558
	UImage* I_Favorite; // 0x560
	UImage* I_Password; // 0x568
	UImage* I_Upload; // 0x570
	UTextBlock* T_Age; // 0x578
	UTextBlock* T_CombatMode; // 0x580
	UTextBlock* T_Level; // 0x588
	UTextBlock* T_Map; // 0x590
	UTextBlock* T_Name; // 0x598
	UTextBlock* T_Ping; // 0x5a0
	UTextBlock* T_Players; // 0x5a8
	UTextBlock* T_Region; // 0x5b0
	UTextBlock* TextBlock_1; // 0x5b8
	FButtonStyle ValidStyle; // 0x5c0
	FButtonStyle InvalidStyle; // 0x868
};
...
struct UInGameJoinOrInvite : UObject {
	UMessageBoxWidget* m_MessageBox; // 0x130
};
...
struct UEmotesMenu : UWindowRoot {
	UTexture2D* cancelIcon; // 0x398
	UTexture2D* backIcon; // 0x3a0
	UItemInventory* m_Inventory; // 0x3a8
};
...
struct UGrassOcclusionComponent : UActorComponent {
	TArray<ABuildableBase*> BuildableQueue; // 0x218
};
...
struct URadialMenuSegment : URootWidget {
	UTexture2D* m_StartCapTexture; // 0x348
	UTexture2D* m_EndCapTexture; // 0x350
};
...
struct ULoginQueueBase : UWindowRoot {
	UFCButton* CancelButton; // 0x398
	UTextBlock* QueuePosition; // 0x3a0
};
...
struct UConanBTService_ChangeBBBool : UBTService_BlackboardBase {
	FBlackboardKeySelector BlackboardKey; // 0x70
};
...
struct AConanGameState : ADWGameState {
	...
	TArray<FServerGameTweakValue> ServerGameTweaks; // 0x4b8
	...
	float FloatServerRuntime; // 0x600
	UChatCommandHelper* m_ChatCommandHelper; // 0x608
	TArray<AGuild*> GuildList; // 0x610
	TMap<int64_t, FTimerHandle> m_PendingMinionCleanups; // 0x620
	UDataTable* m_SpawnDataTable; // 0x688
	UDataTable* m_AIDataTable; // 0x690
	UDataTable* m_DungeonLocations; // 0x698
	UDataTable* m_MountMovementRates; // 0x6a0
	TMap<EEmoteCategories, FEmotesMenuCategoryNode> m_CachedEmoteCategories; // 0x6a8
	AServerSettings* ServerSettingsClass; // 0x6f8
	TArray<UUniqueID*> ReplicatedIds; // 0x700
	AServerSettings* ServerSettings; // 0x710
	AVaultManager* m_VaultManager; // 0x10b0
	char ListenServerWorldIsLoaded : 1; // 0x10c8
	TArray<AConanCharacter*> SecondTickingCharacters; // 0x1258
};
...
struct ADWGameMode : AGameMode {
	FString DatabaseHost; // 0x4d0
	int32_t DatabasePort; // 0x4e0
	bool DatabaseVerbose; // 0x4e4
	UWorldPersistenceComponent* WorldPersistence; // 0x4e8
};
...
struct UBuildSystemComponent : UActorComponent {
	...
	UMaterialInterface* DebugMaterial; // 0x190
	UStaticMesh* debugArrowMesh; // 0x198
	UInstancedStaticMeshComponent* m_GhostBuildingComponent; // 0x1a0
	UInstancedStaticMeshComponent* m_GhostBuildingUpgradeablesComponent; // 0x1a8
	UInstancedStaticMeshComponent* m_InvalidGhostBuildingComponent; // 0x1b0
	TArray<FPotentialBuildGhost> m_GhostSocketIndexedResults; // 0x1b8
	TArray<FPotentialBuildGhost> m_GhostUpgradeSocketIndexedResults; // 0x1c8
	TArray<FPotentialBuildGhost> m_GhostInvalidSocketIndexedResults; // 0x1d8
	TArray<FPotentialBuildGhost> m_DistanceSortedQueuedPotentialGhosts; // 0x1e8
	TMap<UBuildingSocketComponent*, FBuildingModulesArray> m_SocketComponentToModules; // 0x278
	FVector m_LastGhostOrigin; // 0x2cc
	bool m_bDirtyGhosts; // 0x2d8
	bool m_bStillDirtyGhosts; // 0x2f4
	UWidgetComponent* m_BuildingTextWidgetComponent; // 0x3d0
};
...
struct UW_ExilesJourneyTrialStep_C : UExilesJourneyTrialStep {
	UWidgetAnimation* Anim_Completed; // 0x3a8
	UImage* Background; // 0x3b0
	UInventoryIconView_C* ItemIcon; // 0x3b8
	UTextBlock* Label; // 0x3c0
};
...
struct UFastTravelHandler : UActorComponent {
	TMap<FString, FTravelPointsContainer> AllMapsDiscoveredTravelPoints; // 0xf8
};
...
struct APlaceableBase : ABuildableBase {
	...
	bool OccludesGrass; // 0x5bc
	bool WasPlacedAsUpgrade; // 0x5bd
	bool DisableDecayWhenOnGround; // 0x5be
	AConanCharacter* returningToInventoryCharacter; // 0x5c0
};
...
struct UOnlineSessionClient : UOnlineSession {
	bool bIsFromInvite; // 0x2c0
	bool bHandlingDisconnect; // 0x2c1
};
...
struct AGameMode : AGameModeBase {
	FName MatchState; // 0x490
	char bDelayedStart : 1; // 0x498
	int32_t NumSpectators; // 0x49c
	int32_t NumPlayers; // 0x4a0
	int32_t NumBots; // 0x4a4
	float MinRespawnDelay; // 0x4a8
	int32_t NumTravellingPlayers; // 0x4ac
	ULocalMessage* EngineMessageClass; // 0x4b0
	TArray<APlayerState*> InactivePlayerArray; // 0x4b8
	float InactivePlayerStateLifeSpan; // 0x4c8
	bool bHandleDedicatedServerReplays; // 0x4cc
};
...
struct AConanCharacter : ACharacter {
	...
	UGrassOcclusionComponent* GrassOcclusionComponent; // 0x9b0
	bool bThrallAsyncLoadDone; // 0x9d0
	FScriptMulticastDelegate OnSecondTick; // 0x9d8
	AActor* m_InteractingActor; // 0x9e8
	bool WeaponChangeDisabled; // 0x9f8
	bool FreezeAllItems; // 0x9f9
	bool m_IsReparing; // 0x9fa
	bool HasTimeCatchedUp; // 0x9fb
	int32_t FeatVersion; // 0x9fc
	UObject* m_CurrentTarget; // 0xa00
	int32_t m_CurrentSubTargetIndex; // 0xa08
	UUniqueID* CharacterUniqueID; // 0xa10
	UUniqueID* CharacterGuildID; // 0xa18
	UUniqueID* CharacterIDOverride; // 0xa20
	int64_t m_LastEnteredLandClaimOwnerId; // 0xa28
	FName SourceSpawnTable; // 0xa30
	TMap<WeaponArcheTypes, FComboPresetTableRow> ComboPresetsMap; // 0xa38
	bool isAlive; // 0xa88
	int32_t community; // 0xa8c
	bool IsAggressive; // 0xa90
	bool IsThrall; // 0xa91
	bool IsPet; // 0xa92
	bool IsDialogNPC; // 0xa93
	float MinEmoteTime; // 0xa94
	float MaxEmoteTime; // 0xa98
	float EmoteChance; // 0xa9c
	bool HasCombatTarget; // 0xaa0
	float WaypointAcceptanceRange; // 0xaa4
	FVector CombatTargetLocation; // 0xab4
	UEmoteController* EmoteController; // 0xac0
	UTargetDistributionComponent* TargetingComponent; // 0xac8
	UAvoidanceComponent* AvoidanceComponent; // 0xad0
	FDateTime LastFollowerRescueTimestamp; // 0xae8
	int32_t WalkSpeed; // 0xaf0
	int32_t RunSpeed; // 0xaf4
	FTimespan MaxKnockbackChainTime; // 0xaf8
	FTimespan KnockbackImmunityPeriod; // 0xb00
	bool IsInStunBreakWindow; // 0xb08
	float CurrentRotationMultiplier; // 0xb0c
	float SteeringRotationRate; // 0xb10
	float DefaultRotationRate; // 0xb14
	float DoubleJumpTimeoutTime; // 0xb18
	bool isDoubleJumpTimoutTimerActive; // 0xb1c
	bool HasDoubleJumped; // 0xb1d
	EPhysicalSurface currentSurfaceType; // 0xb1e
	FHitResult CachedHitResultForGroundSurface; // 0xb20
	FScriptMulticastDelegate OnActionStart; // 0xba8
	FScriptMulticastDelegate OnActionEnd; // 0xbb8
	bool SprintNoCost; // 0xbe0
	bool SenseDetection; // 0xbe1
	bool PlayerInvisibility; // 0xbe2
	bool IsDemiGod; // 0xbe3
	FScriptMulticastDelegate OnCharacterStateChanged; // 0xbe8
	float AdditionalInteractionExtent; // 0xc70
	AConanCharacter* LastDamageCauserCharacter; // 0xc78
	float DisengagementDistance; // 0xc80
	float EngagementDistance; // 0xc84
	FScriptMulticastDelegate SignalClientOnDamageTaken; // 0xc88
	FScriptMulticastDelegate SignalOnKilled; // 0xc98
	TArray<AConanCharacter*> CarriedPeople; // 0xea0
	float BeingCarriedWeight; // 0xeb0
	bool EnableFloorTilt; // 0xeb4
	bool EnableTiltRoll; // 0xebc
	float TiltAdjust; // 0xec0
	float MaxTiltPitch; // 0xec4
	float MaxTiltRoll; // 0xec8
	bool bRootMotionAutoFreeze; // 0xecc
	FScriptMulticastDelegate OnRootMotionAutoFrozen; // 0xed0
	int32_t ClimbingBlockingVolumeCount; // 0xee0
	FCharacterIKCollection CharacterIKCollection; // 0xef0
	bool ReplicatedHangingFromCeiling; // 0x1180
	bool ReplicatedIsInSlidingMode; // 0x1181
	bool NavMeshIgnoreComponentUpdate; // 0x1182
	bool NavMeshIgnoreChildComponentUpdate; // 0x1183
	FScriptMulticastDelegate OnCharacterPossessedOnClient; // 0x1188
	float LastCryForHelp; // 0x1198
	bool AllowCryForHelp; // 0x119c
	bool AllowTargetSpottedCry; // 0x119d
	float CryForHelpRange; // 0x11a0
	float TargetSpottedCryRange; // 0x11a4
	float AdditionalFollowingDistance; // 0x11a8
	FScriptMulticastDelegate SignalCharacterIsBuilding; // 0x11b0
	FScriptMulticastDelegate SignalCharacterIsBuildingThrall; // 0x11c0
	FScriptMulticastDelegate SignalMountReplicated; // 0x11d0
	float SecondTickRate; // 0x11e0
	bool m_CreatedFromCharacterCreation; // 0x11e4
	bool WasKilledByItself; // 0x11e5
	bool HungerEnabled; // 0x11e6
	bool ThirstEnabled; // 0x11e7
	FScriptMulticastDelegate OnCharacterMoved; // 0x11e8
	FScriptMulticastDelegate OnMountStaggered; // 0x11f8
	float HeightToSaddle; // 0x1208
	FRotator MountCameraOrientation; // 0x120c
	bool IsMount; // 0x1218
	int64_t MountedNPCID; // 0x1220
	bool IsSpeaking; // 0x1270
	FScriptMulticastDelegate OnCharacterOverridePvPChanged; // 0x12f0
	UConanTetheringController* m_TetheringController; // 0x1300
	TSet<TWeakObjectPtr<AConanPlayerController>> ForcedNetRelevantObservers; // 0x1308
	EAIEngagementBehavior EngagementBehavior; // 0x1358
	EAIFollowerTacticType FollowerTactic; // 0x1359
	TSet<UObject*> m_PendingStreams; // 0x1368
	FText m_CharacterBio; // 0x13b8
	EBiographyAccess m_AllowedBioAccess; // 0x13d0
	EBiographySharing m_AllowedBioSharing; // 0x13d1
	bool CharacterLayoutSanitized; // 0x13d2
	ECharacterState m_CharacterState; // 0x1428
	FText m_KillerName; // 0x1440
	FUniqueNetIdRepl m_KillerId; // 0x1458
	UStatHolder* m_StatHolder; // 0x1470
	AConanGameState* m_GameState; // 0x1478
	UHungerSystem* m_HungerSystem; // 0x1480
	FEnduranceData m_EnduranceData; // 0x14a0
	UActorPersistenceComponent* m_ActorPersistence; // 0x14b0
	UEmoteInventory* m_EmoteInventory; // 0x14b8
	UBuildSystemComponent* m_BuildSystem; // 0x14c0
	FText m_CharacterName; // 0x14c8
	EGUIControlMode m_GUIControlMode; // 0x14e8
	char m_OverridePvP : 1; // 0x1500
	char m_BlockGuildInvites : 1; // 0x1500
	UMessageBoxWidget* m_BattleStandardDialog; // 0x1508
	float SprintStaminacost; // 0x1688
	float SwimStaminacost; // 0x168c
	float MaxLoadingInvulnerabilityTime; // 0x16b0
	float LoadingInvulnerabilityGraceTime; // 0x16b4
	bool IsLoadingInvulnerable; // 0x16b8
	bool IsCombatConcussiveRegenInterrupted; // 0x16b9
	float CombatConcussiveRegen; // 0x16bc
	float CombatConcussiveAccumulation; // 0x16c0
	float CombatStaminaRegenMod; // 0x16c4
	bool IsCombatPossessed; // 0x16c8
	UPerkSystemComponent* PerkSystemComponent; // 0x16d0
};
