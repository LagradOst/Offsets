...
struct ULoadCharacterCallProxy {
...
struct UInventoryFilterSelector {
...
struct UW_RadialSBItemInfoPanel_C {
...
struct APreCullTrianglesVolume {
	EBrushType BrushType; // 0x3d0
	FColor BrushColor; // 0x3d4
	int32_t PolyFlags; // 0x3d8
	char bColored : 1; // 0x3dc
...
struct UGetUserUniqueIDCallProxy {
	FScriptMulticastDelegate onSuccess; // 0x28
	FScriptMulticastDelegate onFailure; // 0x38
};
...
struct UAISenseConfig_NewSight {
...
struct UMaterialExpressionGraniteTexture {
...
struct USkeletalMeshReductionSettings {
...
struct UConanCharacterPersistenceComponent {
...
struct UW_CC_KeyNavIndicator_C {
...
struct UBuildingBoundsComponent {
	USceneComponent* AttachParent; // 0xf8
	TArray<USceneComponent*> AttachChildren; // 0x100
	TSet<USceneComponent*> ClientAttachedChildren; // 0x110
	FName AttachSocketName; // 0x160
...
struct UConanAdaptiveSystemComponent {
	FActorComponentTickFunction PrimaryComponentTick; // 0x30
	TArray<FName> ComponentTags; // 0x88
	TArray<UAssetUserData*> AssetUserData; // 0x98
	char bReplicates : 1; // 0xa8
...
struct UApplyRadialDamageWithFalloffProxy {
...
struct UW_FCMultiLineEditableTextBox_C {
...
struct UW_ItemIconTooltipView_C {
...
struct USettingsEventDispatchers {
...
struct UServerRentalRequestConnection {
...
struct UFCBloodCommunityButton {
...
struct UDeleteCharacterCallProxy {
	FScriptMulticastDelegate onSuccess; // 0x28
	FScriptMulticastDelegate onFailure; // 0x38
};
...
struct UThrallHungerSystemComponent {
...
struct UMaterialExpressionGraniteNoise {
	float VarZ; // 0xf8
	int32_t UScale; // 0xfc
	int32_t VScale; // 0x100
};

struct UHoudiniAssetParameterRampCurveColor {
...
struct USiegeWeaponInventoryView {
...
struct UW_RadialShortcutbarIconSlot_C {
...
struct UW_HUD_NotificationEntry_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x240
...
struct UAsyncGetPlaceablesInAreaProxy {
...
struct UConanBTDecorator_WeaponStatus {
	float UpdateRate; // 0x68
};

struct UServerRentalServerDetails {
...
struct UPeerConnectionNetConnection {
	TArray<UChildConnection*> Children; // 0x48
	UNetDriver* Driver; // 0x58
	UPackageMap* PackageMap; // 0x60
	TArray<UChannel*> OpenChannels; // 0x68
...
struct UGetGuildMembersListCallProxy {
	FScriptMulticastDelegate onSuccess; // 0x28
	FScriptMulticastDelegate onFailure; // 0x38
};
...
struct AConanPlayerCameraManager {
...
struct USettingsGamepadPresetBase {
...
struct UEnergyReceiverComponent {
...
struct UStringEnumDataTableDataprovider {
...
struct UConsoleUserSettingsSave {
...
struct USoundEffectLowPassFilterPreset {
...
struct UHighlightsSummaryAsync {
	FScriptMulticastDelegate onSuccess; // 0x28
	FScriptMulticastDelegate onFailure; // 0x38
};
...
struct UW_Friends_FriendRequests_C {
...
struct UProperyDestructionHistoryBase {
...
struct UInventoryItemInfoPanel {
...
struct AStartupGameMode_C {
	USceneComponent* DefaultSceneRoot; // 0x4a0
};

struct UW_ServerList_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x520
...
struct UCollisionSystemComponent {
...
struct UExilesJourneyComponent {
...
struct UCharacterRecustomizationBase {
	bool CanRandomize; // 0x398
};

struct UW_PatchNotesView_C {
...
struct UInventoryIconTooltipView {
...
struct UHoudiniAttributeDataComponent {
	FActorComponentTickFunction PrimaryComponentTick; // 0x30
	TArray<FName> ComponentTags; // 0x88
	TArray<UAssetUserData*> AssetUserData; // 0x98
	char bReplicates : 1; // 0xa8
...
struct UMouseBlockWindowBase {
	USoundBase* dropItemSound; // 0x398
};

struct UW_RatingResultView_C {
	FScriptMulticastDelegate KeyNavOnSelectedEvent; // 0x240
	TWeakObjectPtr<URootWidget> KeyNavLeft; // 0x250
	TWeakObjectPtr<URootWidget> KeyNavRight; // 0x258
	TWeakObjectPtr<URootWidget> KeyNavAbove; // 0x260
...
struct UExilesJourneyItem {
	FName TemplateName; // 0x248
};

struct UNiagaraEmitterProperties {
...
struct UW_Friends_FriendList_C {
...
struct UCharacterInventoryView {
	bool CanItemBeDropedOn; // 0x318
	FScriptMulticastDelegate SignalCouldNotDrop; // 0x320
	DelegateProperty DelegateGetTargetInventory; // 0x330
	AActor* m_Actor; // 0x370
...
struct UKeyBindingsCommandEntryBase {
	FScriptMulticastDelegate KeyNavOnSelectedEvent; // 0x240
	TWeakObjectPtr<URootWidget> KeyNavLeft; // 0x250
	TWeakObjectPtr<URootWidget> KeyNavRight; // 0x258
	TWeakObjectPtr<URootWidget> KeyNavAbove; // 0x260
...
struct UChestInventoryGUI {
	UItemInventory* m_ChestInventory; // 0x3a8
};

struct UW_RadialShortcutBar_C {
...
struct UW_ButtonNormal_C {
	UNamedSlot* ButtonOverlay; // 0xc28
	UNamedSlot* CheckboxOverlay; // 0xc30
	UW_HotkeyIcon_C* HotkeyIcon; // 0xc38
};

struct ACharacterCreationActorBase {
...
struct AConanCritterAIController {
...
struct UAvoidanceComponent {
	float NotifyApproachRange; // 0xf8
};

struct UConanBuildingPersistenceComponent {
...
struct UStringEnumFixedListDataprovider {
...
struct UBuildingReplicationComponent {
...
struct AScreenshotFunctionalTest {
...
struct UW_LevelUpFIFOMessageView_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x358
	UWidgetAnimation* FadeOut; // 0x360
	UWidgetAnimation* FadeIn; // 0x368
	UTextBlock* textView; // 0x370
...
struct UAsyncLineTraceByChannelProxy {
...
struct UGUIModuleController_Activate_CallProxy {
...
struct UPetAttributeEntryView {
	FSlateBrush Icon; // 0x318
	FText Label; // 0x3a8
	ECharIntStatID AttributeID; // 0x3c0
};

struct UBP_UIResourceSingleton_C {
...
struct UCharacterMapMarkerComponent {
...
struct USubmixEffectTestPreset {
...
struct UW_PurgeFIFOMessageView_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x358
...
struct UW_FriendRequestEntry_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x470
	UHorizontalBox* ActionsBox; // 0x478
...
struct UInteractableFoliageBase {
...
struct UFuncomSkeletalMeshComponent {
...
struct UExilesJourneyTrial {
	UUserWidget* m_JourneyStepClass; // 0x3a8
};

struct UNpcSpawnerComponent {
	FActorComponentTickFunction PrimaryComponentTick; // 0x30
	TArray<FName> ComponentTags; // 0x88
	TArray<UAssetUserData*> AssetUserData; // 0x98
	char bReplicates : 1; // 0xa8
...
struct UW_GamepadHelpOverlay_C {
	UHorizontalBox* LeftHelp; // 0x3c0
	UHorizontalBox* RightHelp; // 0x3c8
};

struct UActorPersistenceComponent {
	bool SaveOnSpawn; // 0xf8
	float SaveFrequency; // 0xfc
	bool SkipSaving; // 0x100
	UUniqueID* UID; // 0x108
...
struct UConanCharacterComponent {
	FActorComponentTickFunction PrimaryComponentTick; // 0x30
	TArray<FName> ComponentTags; // 0x88
	TArray<UAssetUserData*> AssetUserData; // 0x98
	char bReplicates : 1; // 0xa8
...
struct UTemplateIdTableAccessor {
	UDataTable* table; // 0x28
};

struct UFCEditableTextBase {
	FScriptMulticastDelegate KeyNavOnSelectedEvent; // 0x240
	TWeakObjectPtr<URootWidget> KeyNavLeft; // 0x250
	TWeakObjectPtr<URootWidget> KeyNavRight; // 0x258
	TWeakObjectPtr<URootWidget> KeyNavAbove; // 0x260
...
struct UFunctionalTestingManager {
...
struct USceneCaptureComponentImprints {
...
struct UMaterialExpressionGraniteBake {
...
struct UStringEnumDataprovider {
...
struct UAddMemberBase {
	UUserWidget* ListEntryClass; // 0x3e0
};

struct USettingsGameplayBase {
...
struct UGUIModule_Activate_CallProxy {
	FScriptMulticastDelegate OnActivate; // 0x28
...
struct ABuildingBlockerVolumeBase {
...
struct UCollisionStaticMeshComponent {
...
struct UHighlightsGetNumberAsync {
	FScriptMulticastDelegate onSuccess; // 0x28
	FScriptMulticastDelegate onFailure; // 0x38
};
...
struct UW_IngameLoadingScreen_C {
	UTextBlock* TextTemplate; // 0x520
};

struct AFunctionalTest {
...
struct UTwitchPatchNotesEntryView {
...
struct UConanGameViewportClient {
...
struct UAsyncTaskShowStoreForCensoredDlc {
	FScriptMulticastDelegate OnReturned; // 0x28
};

struct UCraftingIngredientsInventory {
	FScriptMulticastDelegate SignalItemsRequestedFromClient; // 0x170
	FScriptMulticastDelegate SignalInventoryRecivedOnClient; // 0x180
	FScriptMulticastDelegate SignalItemAdded; // 0x190
	FScriptMulticastDelegate SignalItemRemoved; // 0x1a0
...
struct UW_SessionInviteEntry_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x490
...
struct UW_KeyBindings_Category_C {
...
struct AConanHumanAIController {
...
struct UW_KeyBindings_Commands_C {
...
struct ULoadGuildsCallProxy {
	FScriptMulticastDelegate onSuccess; // 0x28
	FScriptMulticastDelegate onFailure; // 0x38
};

struct URandomBuildingGeneratorProxy {
...
struct UEgocentricParticleSpawnerComponent {
...
struct AConanAttackerAIController {
	bool ShouldChangeRotationRateFromCode; // 0x678
	bool PickRandomWeaponAfterAttack; // 0x679
	bool PickBestWeapon; // 0x67a
	bool PickBestWeaponAfterAttack; // 0x67b
...
struct UTableAccessor {
	UDataTable* table; // 0x28
};

struct AModController {
...
struct USceneCaptureComponentWater {
...
struct USmoketestFrameworkWorldDataObject {
	UWorld* m_World; // 0x28
};

struct UTargetingSystemComponent {
...
struct AFunctionalTestGameMode {
	FString OptionsString; // 0x3d0
	AGameSession* GameSessionClass; // 0x3e0
	AGameStateBase* GameStateClass; // 0x3e8
	APlayerController* PlayerControllerClass; // 0x3f0
...
struct UGameplayTickGroupScheduler {
	AGameplayScheduler* Scheduler; // 0xf8
};

struct UEscapeStackNode {
...
struct UW_HUD_LootLogElement_C {
...
struct UW_FCEditableTextBlock_C {
...
struct UUtilityMatrix {
	FBoxBounds Bounds; // 0x28
	float UnitsPerCell; // 0x40
};

struct APhasedAutomationActorBase {
	FActorTickFunction PrimaryActorTick; // 0x28
	float CustomTimeDilation; // 0x80
	char bHidden : 1; // 0x84
	char bNetTemporary : 1; // 0x84
...
struct UFloatStatChangeSignalNode {
...
struct UInventoryGridSlotViewBase {
...
struct UHighlightsConfigureAsync {
	FScriptMulticastDelegate onSuccess; // 0x28
	FScriptMulticastDelegate onFailure; // 0x38
};
...
struct UConanBehaviorTreeComponent {
...
struct UHoudiniRuntimeSettings {
...
struct UPushOutCapsuleComponent {
...
struct UServerRentalServerSetupBase {
...
struct UShowVirtualKeyboardCallProxy {
...
struct UHoudiniInstancedActorComponent {
...
struct UCharacterListEntryBase {
...
struct UW_MouseBlockWindow_C {
	USpacer* MouseBlocker; // 0x3b8
};

struct UMaterialExpressionGraniteStreamTextures {
	FExpressionInput Originals[0x4]; // 0x1b0
	FExpressionInput SizeInput; // 0x290
	char bUseBaked : 1; // 0x2c8
	char bIsBakeDirty : 1; // 0x2c8
...
struct UInventoryItemActionBar {
...
struct UConanCharacterMovementComponent {
...
struct UW_PatchNotesEntryView_C {
...
struct AFunctionalTestLevelScript {
	char bInputEnabled : 1; // 0x3d0
};
...
struct UW_HUD_NotificationList_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x240
...
struct AConanLevelScriptActor {
	char bInputEnabled : 1; // 0x3d0
};

struct UConanIngameLoadingScreen {
...
struct UMaterialExpressionGraniteTextureParameter {
	FName ParameterName; // 0x190
	FGuid ExpressionGUID; // 0x198
	FName Group; // 0x1a8
};

struct APoiProtection {
...
struct UW_EditableLabeledSlider_C {
...
struct UTargetDistributionComponent {
...
struct USlateDataSheet {
	UTexture2D* DataTexture; // 0x28
};

struct UW_RadialMenu_C {
...
struct AConanBasicAIController {
	float FleeRange; // 0x568
	float MaxRoamingRange; // 0x56c
	bool CanRoam; // 0x570
	bool PurgeShouldReturnHome; // 0x571
...
struct AConanPlayerState {
	FString MasterAccountId; // 0x468
};

struct AConanTimeOfDayManager {
...
struct UW_HUD_FriendsNotificationEntry_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x240
	UWidgetAnimation* Anim_Fade; // 0x248
	UWidgetAnimation* Anim_SlideIn; // 0x250
	UTextBlock* Message; // 0x258
...
struct UW_SettingsGamepadPreset_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x3d0
...
struct UW_DiscoveryFIFOMessageView_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x358
	UWidgetAnimation* FadeInOut; // 0x360
...
struct UItemInventoryReplicateToAll {
	FScriptMulticastDelegate SignalItemsRequestedFromClient; // 0x170
	FScriptMulticastDelegate SignalInventoryRecivedOnClient; // 0x180
	FScriptMulticastDelegate SignalItemAdded; // 0x190
	FScriptMulticastDelegate SignalItemRemoved; // 0x1a0
...
struct AConanHeightmapLevelScriptActor {
	char bInputEnabled : 1; // 0x3d0
};

struct UHighlightsSetScreenshotAsync {
	FScriptMulticastDelegate onSuccess; // 0x28
	FScriptMulticastDelegate onFailure; // 0x38
};

struct UFuncTestRenderingComponent {
	float MinDrawDistance; // 0x308
	float LDMaxDrawDistance; // 0x30c
	float CachedMaxDrawDistance; // 0x310
	ESceneDepthPriorityGroup DepthPriorityGroup; // 0x314
...
struct UWorldPersistenceComponent {
...
struct ULoadGuildIdCallProxy {
	FScriptMulticastDelegate onSuccess; // 0x28
	FScriptMulticastDelegate onFailure; // 0x38
};

struct UHotkeyIconPlatforms {
	TArray<FHotkeyIconPlatform> Platforms; // 0x28
};
...
struct UInventoryGridSlotView_C {
...
struct UCharHealthStaminaThirstHungerViewer {
...
struct UKeyBindingsCommandBase {
	FScriptMulticastDelegate KeyNavOnSelectedEvent; // 0x240
	TWeakObjectPtr<URootWidget> KeyNavLeft; // 0x250
	TWeakObjectPtr<URootWidget> KeyNavRight; // 0x258
	TWeakObjectPtr<URootWidget> KeyNavAbove; // 0x260
...
struct UHoudiniHandleComponent {
	EHoudiniHandleType HandleType; // 0x3b0
};

struct UHighlightsSetVideoAsync {
	FScriptMulticastDelegate onSuccess; // 0x28
	FScriptMulticastDelegate onFailure; // 0x38
};
...
struct UGamepadHelpOverlayBase {
	UGamepadHelpEntryBase* GamepadHelpEntryClass; // 0x398
};
...
struct UW_JourneyStepFIFOMessageView2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x358
	UWidgetAnimation* FadeInOut; // 0x360
...
struct UBaseVoiceTransmissionIndicator {
	bool CloseOnClick; // 0x318
	bool BlockPlayerInput; // 0x319
	FSlateSound OpeningSlateSound; // 0x320
	FSlateSound ClosingSlateSound; // 0x338
...
struct UAsyncTaskQueryPurchases {
...
struct UWebSocketNetDriver {
	int32_t WebSocketPort; // 0x4f8
};

struct UConanProjectileMovementComponent {
	float InitialSpeed; // 0x150
	float MaxSpeed; // 0x154
	char bRotationFollowsVelocity : 1; // 0x158
	char bShouldBounce : 1; // 0x158
...
struct UHighlightsCloseGroupAsync {
	FScriptMulticastDelegate onSuccess; // 0x28
	FScriptMulticastDelegate onFailure; // 0x38
};
...
struct ATowerOfSiptah_SurgeSpawnHolder {
	FActorTickFunction PrimaryActorTick; // 0x28
	float CustomTimeDilation; // 0x80
	char bHidden : 1; // 0x84
	char bNetTemporary : 1; // 0x84
...
struct UConanOnlineEventsLibrary {
...
struct UAnimalPenInventoryView {
...
struct UBuildingRecordingRebuilderProxy {
	FScriptMulticastDelegate BuildingCreated; // 0x28
	FScriptMulticastDelegate BuildingFailed; // 0x38
	FScriptMulticastDelegate BuildingProgressUpdate; // 0x48
...
struct UW_Settings_KeyBindings_C {
...
struct UGuildLogBase {
	UUserWidget* ListEntryClass; // 0x328
};

struct UServerListView {
...
struct AQosBeaconClient {
	AOnlineBeaconHostObject* BeaconOwner; // 0x3f0
	UNetConnection* BeaconConnection; // 0x3f8
	EBeaconConnectionState ConnectionState; // 0x400
};

struct UCraftingGUIBase {
...
struct UMaterialExpressionGraniteTextureObject {
...
struct AConanSandboxLevelScriptActor {
	char bInputEnabled : 1; // 0x3d0
};
...
struct UImprintReceiverComponent {
...
struct UW_ItemTemperatureBar_C {
...
struct UNiagaraEffectRendererProperties {
	FName Dummy; // 0x28
};

struct UAsyncSpawnNPCProxy {
...
struct UConanNewPathFollowingComponent {
...
struct UConanBTTask_ConanMoveTo {
	FVector2D MoveSpeedPercentageRange; // 0xb0
	bool bIntermediatePathsIfCantReachTarget; // 0xb8
};
...
struct USceneCaptureComponentSand {
...
struct UHoudiniSplineComponent {
	USceneComponent* AttachParent; // 0xf8
	TArray<USceneComponent*> AttachChildren; // 0x100
	TSet<USceneComponent*> ClientAttachedChildren; // 0x110
	FName AttachSocketName; // 0x160
...
struct UW_Friends_BlockedPlayers_C {
...
struct ULocalPlayerNameCallProxy {
	FScriptMulticastDelegate onSuccess; // 0x28
};
...
struct UIntStatChangeSignalNode {
	FScriptMulticastDelegate SignalStatChanged; // 0x28
};

struct UHoudiniAssetComponent {
...
struct UVoiceChatWindow {
	UUserWidget* ChatLineClass; // 0x398
};

struct UWeaponCollisionAnimNotifyState {
	bool bDefaultTriggerOnDedicatedServer; // 0x28
};
...
struct UBuildingSocketComponent {
	TArray<FSocketStaticData> PerInstanceStaticSocketData; // 0x8c8
};

struct UPlayerListGameEntry {
	FScriptMulticastDelegate KeyNavOnSelectedEvent; // 0x240
	TWeakObjectPtr<URootWidget> KeyNavLeft; // 0x250
	TWeakObjectPtr<URootWidget> KeyNavRight; // 0x258
	TWeakObjectPtr<URootWidget> KeyNavAbove; // 0x260
...
struct UAdjustableCameraComponent {
...
struct UConanProjectileRegistry {
...
struct UFCEditableMultiLineText {
	FText Text; // 0x338
...
struct UBuildingMasterActorComponent {
	FActorComponentTickFunction PrimaryComponentTick; // 0x30
	TArray<FName> ComponentTags; // 0x88
	TArray<UAssetUserData*> AssetUserData; // 0x98
	char bReplicates : 1; // 0xa8
...
struct ULoadInventoryCallProxy {
	FScriptMulticastDelegate onSuccess; // 0x28
	FScriptMulticastDelegate onFailure; // 0x38
};
...
struct UMaterialExpressionGraniteTextureBase {
	UGraniteTexture* Texture; // 0x60
	int32_t PreviewLayer; // 0x68
};

struct UInstancedBuildingComponent {
...
struct UW_Keybindings_Command_C {
...
struct UItemDistributorComponent {
...
struct UHUDCharacterStatIndicators {
...
struct UFindSessionsInExternalDirectoryCallbackProxy {
	FScriptMulticastDelegate onSuccess; // 0x28
	FScriptMulticastDelegate onFailure; // 0x38
};

struct UPeerConnectionNetDriver {
	char LogPortUnreach : 1; // 0x4f8
	char AllowPlayerPortUnreach : 1; // 0x4f8
	uint32_t MaxPortCountToTry; // 0x4fc
};

struct UThrallViewBase {
	bool CloseOnClick; // 0x318
	bool BlockPlayerInput; // 0x319
	FSlateSound OpeningSlateSound; // 0x320
	FSlateSound ClosingSlateSound; // 0x338
...
struct UW_FCComboBoxString_C {
	UComboBoxString* ComboBox; // 0x3d0
};

struct UFrameRateReporter {
	FString ScopeName; // 0x50
	bool Compact; // 0x60
	EDebugLevel DebugLevel; // 0x61
};

struct UCharacterPersistenceComponent {
	bool SaveOnSpawn; // 0xf8
	float SaveFrequency; // 0xfc
	bool SkipSaving; // 0x100
	UUniqueID* UID; // 0x108
...
struct UNavigatableVerticalBox {
	FScriptMulticastDelegate SignalEntrySelected; // 0x318
	FScriptMulticastDelegate SignalSelected; // 0x328
	FScriptMulticastDelegate SignalNavigateVerticaly; // 0x338
	FScriptMulticastDelegate SignalDeselected; // 0x348
...
struct UCharacterStatsWindow {
	AConanCharacter* m_Character; // 0x398
};

struct AHoudiniAssetActor {
...
struct UMaterialExpressionGraniteBakeBase {
	FExpressionInput Originals[0x4]; // 0x1b0
	FExpressionInput SizeInput; // 0x290
	char bUseBaked : 1; // 0x2c8
	char bIsBakeDirty : 1; // 0x2c8
...
struct UW_NavigatableGridPanel_C {
	int32_t RowLength; // 0x3a8
	TArray<float> ColumnFill; // 0x3b0
	TArray<float> RowFill; // 0x3c0
};
...
struct UCharacterEncumbranceBar {
...
struct UAdminPanelInventoryCheats {
...
struct UExilesJourneyTrialStep {
	bool CloseOnClick; // 0x318
	bool BlockPlayerInput; // 0x319
	FSlateSound OpeningSlateSound; // 0x320
	FSlateSound ClosingSlateSound; // 0x338
...
struct UConanPathFollowingComponent {
	float PathWidth; // 0x3a8
	float BreakAngle; // 0x3ac
	float AccelerationFactor; // 0x3b0
	float AccelerationMinSpeed; // 0x3b4
...
struct UExilesJourneyInfoPanel {
	FScriptMulticastDelegate KeyNavOnSelectedEvent; // 0x240
	TWeakObjectPtr<URootWidget> KeyNavLeft; // 0x250
	TWeakObjectPtr<URootWidget> KeyNavRight; // 0x258
	TWeakObjectPtr<URootWidget> KeyNavAbove; // 0x260
...
struct UFeatResultRecipeInfoView {
...
struct UAddGuildMemberCallProxy {
	FScriptMulticastDelegate onSuccess; // 0x28
	FScriptMulticastDelegate onFailure; // 0x38
};
...
struct UMaterialExpressionGraniteTextureObjectParameter {
	FName ParameterName; // 0x190
	FGuid ExpressionGUID; // 0x198
	FName Group; // 0x1a8
};
...
struct UGetUserCharacterListCallProxy {
	FScriptMulticastDelegate onSuccess; // 0x28
	FScriptMulticastDelegate onFailure; // 0x38
...
struct UHoudiniAssetParameterRampCurveFloat {
	FRichCurve FloatCurve; // 0x30
	bool bIsEventCurve; // 0xa0
};
...
struct UBuildingStressTesterProxy {
...
struct UBattleStandardZoneComponent {
...
struct UBP_ConanGameInstance_C {
...
struct UKeyBindingsCategoryBase {
	UUserWidget* m_EntryClass; // 0x4b0
};

struct UW_Friends_SessionInvites_C {
...
struct UHighlightsOpenGroupAsync {
	FScriptMulticastDelegate onSuccess; // 0x28
	FScriptMulticastDelegate onFailure; // 0x38
};
...
struct UW_NavigatableVerticalBox_C {
...
struct UCharacterCustomizationComponent {
