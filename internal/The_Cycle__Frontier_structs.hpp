...
struct FYLeaderboardPlacementToRewardsDataTableRow {
...
struct FYMetaDataTableRowSettings {
...
struct FYNotificationItemDataTableRow {
...
struct FYCharacterExplicitCustomizationDataRow {
...
struct FYWeaponModCombinationWithDamage {
...
struct FYActivityAnalyticsEvent {
	EYActivityType Activity; // 0xb8
	FString activitySubType; // 0xc0
};

struct FYMatchPhaseGameplayRow {
...
struct FYChallengeProgressedEvent {
	FName quest_id; // 0xa8
...
struct FYBIHook_LootAreaPhases {
...
struct FYWeaponImpactDataTableRow {
...
struct FYMaterialVariationDataRowBase {
...
struct FYInventoryInsuranceDataTableRow {
	float m_cost; // 0x10
	float m_payout; // 0x14
};
...
struct FYBossEncounterActivityStats {
...
struct FYDurabilityAnalyticsEvent {
	FString Status; // 0xa8
...
struct FHorizonTweenEventWidgetScaleFromToParameters {
	TWeakObjectPtr<UWidget> TweenTargetWeakPtr; // 0xb8
};

struct FYLootContainerDefinitionRow {
...
struct FHorizonTweenEventActorMoveSplinePathParameters {
...
struct FYDropAbilityAnalyticsPerPlayer {
...
struct FYChatSettingsDataTableRow {
...
struct FYProspectorLevelXpGained {
	int32_t Amount; // 0xa8
	FString Source; // 0xb0
...
struct FYStationInteractionEvent {
...
struct FYAbilityActionBombardmentData {
	float m_radius; // 0x78
...
struct FYRebindableInputAction {
...
struct FYAICombatAnalyticsEvent {
...
struct FYAITuningCallReinforcementsRow {
...
struct FHorizonTweenEventSceneComponentColorFromToParameters {
...
struct FYPlayerTuningDataTableRow {
...
struct FYTechTreeNodeUpgradeLevelRow {
...
struct FYVPToRewarsdDataTableRow {
	FText m_rewardsPackageName; // 0x10
...
struct FYPlayerQuarterUpgradeType {
	FText m_name; // 0x10
...
struct FYAudioTagRow {
	TMap<FGameplayTag, USoundBase*> m_sounds; // 0x10
};

struct FAnimNode_BankWarp {
...
struct FYAbilityActionSurveillanceData {
	float m_radius; // 0x78
};
...
struct FYDropWeaponAnalyticsPerPlayer {
	FName weapon_id; // 0xa8
	FString weapon_name; // 0xb0
...
struct FYDistanceTravelledAnalyticsEvent {
	int32_t position_x; // 0xa8
	int32_t position_y; // 0xac
...
struct FYPlayerAwarenessTuningDataTableRow {
...
struct FHorizonTweenEventWidgetColorFromToParameters {
...
struct FHorizonTweenEventRotatorParameters {
...
struct FYAIHitReactionAnimationRow {
...
struct FYAbilityAnalyticsEvent {
...
struct FYWeaponAudioDataTableRow {
...
struct FYBundleDataTableRowBase {
...
struct FYMetaDefaultItemDataTableRow {
...
struct FYKilledAIAnalyticsEvent {
	int32_t location_x; // 0xa8
	int32_t location_y; // 0xac
...
struct FYKeybindingAnalyticsEvent {
...
struct FHorizonTweenEventSceneComponentMoveFromToParameters {
	TWeakObjectPtr<USceneComponent> TweenTargetWeakPtr; // 0x148
};

struct FYAbilityActionHealWardData {
...
struct FYAbilityActionCloakData {
...
struct FHorizonTweenEventFloatParameters {
...
struct FYProspectorBadgeRow {
	TSoftObjectPtr<UTexture2D> m_hudIconBig; // 0x310
	TSoftObjectPtr<UObject> m_mesh; // 0x338
};

struct FAnimNode_SlopeWarp {
...
struct FYControlsSettingsChangedEvent {
...
struct FYServerPerformanceTuningRow {
...
struct FHorizonTweenEventSplinePathParameters {
...
struct FYCreditIncomeAnalyticsData {
...
struct FYItemRarityDataTableRow {
...
struct FYDeveloperCreditsCategoriesDataTableRow {
...
struct FYCollectibleLootPoolRow {
...
struct FYWeaponTuningDataTableRow {
...
struct FHorizonTweenEventTweenListImplementParameters {
...
struct FYAITuningBuffAlliesTuning {
...
struct FYTechTreeNodeUpgradeDependencyRow {
...
struct FYAudioSettingsChangedEvent {
...
struct FYOnboardingBlockedFeaturesDataTableRow {
...
struct FYCharacterCustomizationSetRow {
...
struct FYContractsInteractionAnalyticsEvent {
...
struct FYQuestDataDataTableRow {
...
struct FYRewardsPoolGrantTupleRow {
...
struct FHorizonTweenEventSlateWidgetMoveSplinePathParameters {
...
struct FYProspectorLevelRewardsDataTableRow {
...
struct FHorizonTweenEventWidgetSheerFromToParameters {
	TWeakObjectPtr<UWidget> TweenTargetWeakPtr; // 0xb8
};
...
struct FAnimNode_PowerIK_Ground {
	FName CharacterRoot; // 0xc8
...
struct FYQuestTaskDataDataTableRow {
...
struct FYCharacterCustomizationRowBase {
...
struct FYAbilityActionDataTableRow {
...
struct FYPlayerAwarenessNotificationDataTableRow {
...
struct FYPlayerQuartersLevelUpBI {
...
struct FYPlayerInitialConnectEvent {
...
struct FHorizonTweenEventSceneComponentRotatorFromToParameters {
...
struct FYDeathEmoteDataTableRow {
...
struct FYAIRangedAttackDefinitionNew {
...
struct FYWeaponTransportDataTableRow {
...
struct FYLocationData {
	FText m_locationName; // 0x10
};

struct FYNPCAnimationAssetDataRow {
...
struct FHorizonTweenEventWidgetVector2DParameters {
...
struct FYMatchmakingSetupMatchEntry {
	bool Enabled; // 0x1c
...
struct FYAnalyticsHardwareStats {
...
struct FYBIHook_EscapeTriggered {
	int32_t time_since_match_start; // 0xa8
...
struct FAnimNode_AccelerationWarp {
	FPoseLink InputPose; // 0x10
...
struct FYGeneratorCrateLevelToRewardsDataTableRow {
	FText m_rewardsPackageName; // 0x10
...
struct FYAITuningSnipedReactionTuning {
	TArray<FDataTableRowHandle> m_perks; // 0x8
...
struct FYCharacterCustomizationSelected {
	bool gender; // 0xa8
...
struct FYAbilityActionBlinkData {
...
struct FYCharacterCustomizationDefaultDataRow {
	FDataTableRowHandle m_defaultArchetype; // 0x10
	int32_t m_maxAmountOfSlots; // 0x20
};

struct FYCollectibleLootBucketRow {
...
struct FHorizonTweenEventWidgetMoveFromToParameters {
	TWeakObjectPtr<UWidget> TweenTargetWeakPtr; // 0xb8
};
...
struct FYExperienceRow {
	EYExperienceType m_experienceType; // 0x310
};

struct FYLootTuningRow {
...
struct FYGameplayAttributeModifier {
...
struct FYContractsBoardsSettingsRow {
...
struct FHorizonTweenEventLinearColorParameters {
...
struct FYModSettingsDataTableRow {
...
struct FHorizonTweenEventVectorParameters {
...
struct FYChallengeCompletedEvent {
	FName quest_id; // 0xa8
	int32_t quest_category; // 0xb0
...
struct FYWeaponCharmVanityItemRowBase {
...
struct FAnimNode_OrientationWarp {
	FPoseLink InputPose; // 0x10
...
struct FYCharacterCustomizationSlotRow {
	FText m_name; // 0x10
	TSoftObjectPtr<UTexture2D> m_icon; // 0x28
...
struct FHorizonTweenEventWidgetMoveSplinePathParameters {
...
struct FYPlayerAudioDataTableRow {
...
struct FHorizonTweenEventActorScaleFromToParameters {
...
struct FYClientMapLoadingStats {
...
struct FHorizonTweenEventActorMoveFromToParameters {
	TWeakObjectPtr<AActor> TweenTargetWeakPtr; // 0x148
};
...
struct FYActivityBigDrillFlyToAnalyticsEvent {
...
struct FYSettingEntryDescriptionDataTableRow {
...
struct FYAISquadDifficultyDefinitionTableRow {
...
struct FYCharacterCustomizationArchetypeRow {
...
struct FHorizonTweenEventWidgetRotatorFromToParameters {
...
struct FHorizonTweenEventSlateWidgetRotatorFromToParameters {
	bool bShortestPath; // 0xb8
};
...
struct FYProspectorLevelProgressionDataTableRow {
...
struct FYGlobalVanityDefaultsData {
...
struct FHorizonTweenEventSceneComponentScaleFromToParameters {
	TWeakObjectPtr<USceneComponent> TweenTargetWeakPtr; // 0x148
};
...
struct FYVehicleVanityDataTableRow {
...
struct FYPainTrainActivityStats {
...
struct FYSprayVanityItemRowBase {
...
struct FHorizonTweenEventSceneComponentMoveSplinePathParameters {
	TWeakObjectPtr<USceneComponent> TweenTargetWeakPtr; // 0x138
};

struct FYAbilityActionKineticShieldData {
...
struct FHorizonTweenEventActorRotatorFromToParameters {
...
struct FYMatchPhaseDefinitionRow {
...
struct FHorizonTweenEventActorColorFromToParameters {
...
struct FYProfanityTableRow {
	FName m_name; // 0x8
};

struct FYTutorialFunnelStats {
...
struct FYClientDisconnectedEvent {
...
struct FYHitZoneDataTableRow {
	TArray<FName> m_bones; // 0x10
};

struct FYFPSMatchSummaryServerEvent {
	int32_t time_seconds; // 0xa8
