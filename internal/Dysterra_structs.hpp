...
struct FDummySequenceAction : FDummySequenceBase {
	int32_t UID; // 0x4
...
struct FMachinArmAbilityMain : FTableRowBase {
...
struct FSteamUGCQueryParameterDetails : FSteamUGCQueryParameterAllUserDetails {
...
struct FIntValueFromDataTable : FValueFromDataTableBase {
	int32_t Value; // 0x20
};
...
struct FDonNavigationQueryTask : FDonNavigationTask {
...
struct FNPCSpawnInfoLandmarkStatus : FTableRowBase {
...
struct FObjectRankData : FTableRowBase {
...
struct FSteamUGCQueryParameterTagsAllUser : FSteamUGCQueryParameterTagsAllUserDetails {
...
struct FSteamUGCQueryParameterUser : FSteamUGCQueryParameterAllUser {
...
struct FQueryWorkshopForItemsResult : FSteamResult {
...
struct FUIDTable : FTableRowBase {
	FString UID; // 0x8
};
...
struct FFloatValueFromDataTable : FValueFromDataTableBase {
	float Value; // 0x20
};
...
struct FWeaponAttachmentMagazine : FTableRowBase {
...
struct FLandmarkDialogueByStatus : FTableRowBase {
...
struct FLandmarkSetupInfo : FTableRowBase {
	int32_t UID; // 0x8
	FText Name; // 0x10
...
struct FResourceInfo : FTableRowBase {
	FString Name; // 0x8
...
struct FDummySequenceMovment : FDummySequenceBase {
	FVector Location; // 0x4
...
struct FAttachmentSlot : FTableRowBase {
...
struct FItemGeneralInfo : FTableRowBase {
	FText Name; // 0x8
...
struct FRMRemoteRequest_SetIngameNotice : FRMRemoteStructBase {
	int32_t Index; // 0x10
	FString notice; // 0x18
	float CycleSec; // 0x28
};
...
struct FMachinArmAbilityItem : FTableRowBase {
	FText ItemName; // 0x8
...
struct FItemCodeValueArray : FTableRowBase {
...
struct FItemRepairInfo : FTableRowBase {
...
struct FAddRemoveAppDependencyResult : FDownloadItemResult {
	bool bAddDependency; // 0x18
};

struct FSVWeaponTable : FTableRowBase {
...
struct FQueryWorkshopForItemDetailsResult : FQueryWorkshopForItemsResult {
...
struct FResourceDropItem : FTableRowBase {
	int32_t Less; // 0x8
	int32_t Larger; // 0xc
...
struct FNPCWeaponInfo : FTableRowBase {
...
struct FQueryWorkshopForUserItemsResult : FQueryWorkshopForItemsResult {
...
struct FBT_FlyToTarget_DebugParams : FDoNNavigationDebugParams {
...
struct FRMRemoteResponse_ResultOnly : FRMRemoteStructBase {
	FString Result; // 0x10
};
...
struct FSVWeaponPartsTable : FTableRowBase {
...
struct FNPCRangeAttackInfo : FTableRowBase {
...
struct FRMRemoteResponse_GetIngameNotice : FRMRemoteStructBase {
	FString Result; // 0x10
...
struct FHarverstResource : FTableRowBase {
	int32_t Damage; // 0x8
...
struct FDownloadItemResult : FGeneralWorkshopItemResult {
	FUInt32 appId; // 0x10
};
...
struct FConvertItem : FTableRowBase {
	float Total; // 0x8
...
struct FRandomItemGenerate : FTableRowBase {
...
struct FNickNameTable : FTableRowBase {
...
struct FWeaponAttachmentForeGrip : FTableRowBase {
	FWeaponAttachmentAbility BaseAbility; // 0x8
...
struct FLandmarkMonsterSpawnInfo : FTableRowBase {
	ELMStatus Status; // 0x8
	int32_t Phase; // 0xc
...
struct FSetUserVoteOnWorkshopItemResult : FGeneralWorkshopItemResult {
	bool bVoteUp; // 0x10
};
...
struct FNPCShieldInfo : FTableRowBase {
...
struct FQueryWorkshopForAllItemsResult : FQueryWorkshopForItemsResult {
...
struct FSteamUGCQueryParameterAll : FSteamUGCQueryParameterAllUser {
...
struct FNPCMeleeAttackInfo : FTableRowBase {
...
struct FUserFavoriteItemChangedResult : FGeneralWorkshopItemResult {
...
struct FAddRemoveItemDependencyResult : FGeneralWorkshopItemResult {
...
struct FGetAppdependencyResult : FGeneralWorkshopItemResult {
...
struct FGetUserVoteOnWorkshopItemResult : FGeneralWorkshopItemResult {
...
struct FCreateWorkshopItemResult : FUpdateWorkshopItemResult {
...
struct FWorkshopItemUpdateInfo : FWorkshopItemDownloadInfo {
...
struct FGeneralWorkshopItemResult : FSteamResult {
	FSteamUGCItemId workshopItemID; // 0x8
};
...
struct FValueInDataTable : FTableRowBase {
	FString Value; // 0x8
...
struct FWeaponAttachmentScope : FTableRowBase {
	FWeaponAttachmentAbility BaseAbility; // 0x8
...
struct FAnimNode_BonesLookAt : FAnimNode_SkeletalControlBase {
	FBoneReference BoneToModify; // 0xc8
...
struct FTerraShopDataInfo : FTableRowBase {
...
struct FMachinArmAbilitySub : FTableRowBase {
...
struct FWeaponAttachmentMuzzle : FTableRowBase {
	FWeaponAttachmentAbility BaseAbility; // 0x8
	float RecoilMultiply; // 0xc0
...
struct FSteamUGCQueryParameterAllUser : FSteamUGCQueryParameterAllUserDetails {
...
struct FUpdateWorkshopItemResult : FGeneralWorkshopItemResult {
...
struct FDialogueTable : FTableRowBase {
	int32_t Order; // 0x8
