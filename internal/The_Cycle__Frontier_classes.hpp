...
struct UYWidget_OutpostSquadNotificationOverview {
...
struct UAnimNotify_PlayEffort_C {
...
struct UYPlayersStatsComponent {
	FMulticastInlineDelegate BP_OnTrySendingPlayerStatsEvent; // 0xd0
};

struct UWBP_Disconnected_Menu_C {
...
struct UYBackendAuthorizationSettings {
...
struct UYWidget_ArchetypesOverview {
...
struct UYWidget_LimitedSpaceGrantEntry {
...
struct UWBP_InputKeyNavigation_Btn_C {
...
struct UYLocalPlayerProximityComponent {
...
struct UWBP_Contract_Tooltip_C {
...
struct APRO_PlayerController_C {
...
struct AYProjectile_Rocket_BP_C {
...
struct UUI_PlayerHealthBar_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UReportPlayerButtonType_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UYWidgetController_ItemsOverview {
...
struct UWBP_SelectionBracket_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ABP_ImpactMarkerHeavy01_BP_C {
...
struct ABP_ImpactMarkerLight01_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x240
	USceneComponent* DefaultSceneRoot; // 0x248
...
struct UWBP_Contracts_Active_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
...
struct UYWidget_ItemComponentTextRarity {
	UTextBlock* m_rarityText; // 0x300
};

struct UYDismissedSeasonPassPurchases {
...
struct UYAnalyticsSender {
	FString m_url; // 0x50
};

struct UYWidget_Inventory_Base {
...
struct UYPlayerGameDataComponent {
...
struct UWBP_HeaderSlim_Panel_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	UWidgetAnimation* WidgetIn_Anim; // 0x2c8
...
struct UItemComponent_StackAmountBase_WBP_C {
...
struct UYWidget_SetItemFilterButton {
...
struct UYWidget_LootNotification {
...
struct UYOnlineSubsystemPlayfabExternalFunctions {
	FYPlayfabCommonSettings m_commonSettings; // 0x28
};

struct UHorizonTweenEvent {
...
struct UYWidget_LegalAgreements {
...
struct UBTTask_ClearAllAggroTargets_C {
...
struct UYWidget_ItemCategoryEntry {
...
struct UYPlayerSFXComponent_BP_C {
...
struct UWBP_Inventory_PlayerSet_DropArea_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UYWidget_SeasonCategories {
...
struct UBTTask_PlayScanAnimation_C {
...
struct UYControllerCustomizationPreviewComponent {
...
struct UYObjectCustomizationRotationComponent {
...
struct UYWidget_RankedLeaderboardSmall {
	FMulticastInlineDelegate OnClickedExpandRanked; // 0x2c8
};

struct UBP_RichTextDecorator_InputAction_C {
...
struct UWBP_Social_User_Entry_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x340
...
struct UPlayerBotEvacuateTask_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
};
...
struct UYOpenDeveloperCreditsCommand {
...
struct UWBP_DragAndDrop_HighlightArea_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
...
struct UYWidget_ItemComponentTextDeviceCategory {
...
struct UScannerWeaponComponent_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct AYLootContainer_Variation_BP_C {
...
struct UYWidget_InteractionMessage {
...
struct UYWidget_InputKeySelector {
...
struct UMapMarker_NoiseSource_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
...
struct UOnboarding_01_TalkToBadum_C {
...
struct ABP_Door_Transition_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x240
...
struct UAnimNotifyState_RotationControl_C {
...
struct AYActivityLocationLinked {
...
struct UYSplineMovementComponent {
...
struct UOpenDeveloperCreditsCommand_BP_C {
...
struct AYAIEQSTargetDummy {
	AYAIEQSTestingPawn* m_associatedEqsTestingPawn; // 0x240
};

struct UDatasmithC4DImportOptions {
...
struct UYCharacterRevivingComponent {
...
struct UBTDecorator_SetSenseTuning_C {
...
struct UWBP_Headline_Panel_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	UNamedSlot* TextSlot; // 0x2c8
	FText HeadlineLabel; // 0x2d0
};

struct UUI_ChatMessage_WBP_C {
...
struct UYAICharacterMovementComponent {
...
struct UPlayerBotTeleportToTargetTask_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
...
struct UYWidget_FpsCounter {
	TWeakObjectPtr<UYUserSettings> m_userSettings; // 0x2c8
};

struct UYWidget_SocialUserEntry {
	FYOutpostFriendInfo m_cachedUserInfo; // 0x2c0
};

struct UBTTask_FindIdleMoveToLocation_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
...
struct UYCharacterVehicleComponent {
...
struct UWBP_Item_InsuranceTag_C {
...
struct AYAbilityActor {
	FDataTableRowHandle m_spawnedRowHandle; // 0x248
};

struct UYWidget_ItemComponentStats {
...
struct ASoakTestAutomationManager_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x240
	USceneComponent* DefaultSceneRoot; // 0x248
...
struct UYPersistentDataAISquad {
...
struct UPlayerBotDoPerformanceCaptureTask_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
};
...
struct UPlayerBotUpdateTargetVisibilityTask_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
...
struct UYServerPerformanceDataComponent {
...
struct UBTDecorator_MinDistance_C {
...
struct UYPlayerCharacterEffortsComponent_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UYControllerInventoryInsuranceComponent {
...
struct UYWidgetView_StationHUD {
...
struct UOnboarding_05_CraftingStation_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x1b0
...
struct UYWidget_OutpostSquadOverviewEntry {
...
struct UYStormSurgeMapMarkerData {
...
struct UYInitializationManager {
	TMap<int32_t, FYInitializationRequestEntry> m_requests; // 0x28
};

struct UYWidget_NotificationPanel {
...
struct UWBP_BlurBacker_Panel_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	UWidgetAnimation* ScreenIn_Anim; // 0x2c8
...
struct UItemComponent_StatsEntryText_WBP_C {
...
struct UUI_MasterBackButton_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
...
struct UYGameplayAttributesComponent {
...
struct UYMatchScreenEndOfMatch {
...
struct UYWidget_SetItemActiveSetView {
...
struct UYWeaponAnalyticsComponent {
...
struct UWBP_Divider_Vertical_Panel_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	UWidgetAnimation* ScreenIn_Anim; // 0x2c8
...
struct UYWidget_ItemComponentLostOnDeath {
	FMulticastInlineDelegate OnItemLostOnDeathSet; // 0x300
};

struct UYWidget_DropDown {
	UComboBoxString* m_comboBox; // 0x2c0
};

struct UDatasmithMesh {
...
struct UWBP_Common_Empty_Btn_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x398
	UWidgetAnimation* Release_Anim; // 0x3a0
	UWidgetAnimation* Press_Anim; // 0x3a8
...
struct UYWidget_ItemComponentStatsEntry {
...
struct UYHierarchicalStateBase {
...
struct UYWidget_InboxTopMenu {
	UYWidget_NotificationNumber* m_notificationNumber; // 0x2c0
};

struct UWBP_SettingsContent_Keybindings_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x338
...
struct AOnboardingHintIndicator_C {
...
struct UWBP_Contract_Active_Entry_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x340
...
struct UYPassiveGeneratorsManager {
...
struct UWBP_ItemStatPrimary_Entry_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
...
struct UYSoundNodeInteriorSetting {
...
struct UYWidget_OutpostSquadNotification {
...
struct UYWidget_ProspectorLevel_Small_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_CelebrationBacker_Panel_B_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
...
struct AYAIPlayerController_Match {
...
struct UYControllerCharacterCustomizationPersistentComponent {
...
struct UYInputKeySelector {
	FButtonStyle m_conflictingInputButtonStyle; // 0x738
};

struct UYWidget_Disconnected {
...
struct UYWidgetController_Login {
	UYAuthorization* m_authorization; // 0x30
};

struct UYWidget_HitIndicator {
...
struct UYWidget_ItemComponentUpgradeButton {
	FMulticastInlineDelegate OnGotEnoughResourcesForUpgrade; // 0x300
};

struct UYCharacterBagComponent {
...
struct UYWidget_NotificationsManager {
...
struct UBTTask_FinishMontage_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x110
...
struct UWBP_StartupMessagesContainer_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x338
...
struct UYBackendInventoryModel {
...
struct UYInventoryDragAndDropPayload {
...
struct UYWidget_CurrentRankedSeasonTopPlayers {
...
struct UWBP_Options_Provider_C {
...
struct UYWidget_LootNotificationsContainer {
...
struct UYAIUpdateManager {
	TArray<UYAIAggroComponent*> m_aiAggroComponents; // 0xb0
};

struct UYNotificationsManager {
...
struct UYWeaponTransportComponent {
...
struct UYGameStateSessionComponent {
...
struct UYInventoryComponentManager {
	TMap<int32_t, FYInventoryLink> m_inventoryComponents; // 0xb8
};

struct UBP_AimAssist_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UYWidgetProvider_Station {
...
struct UMapMarker_StaticIcon_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
...
struct UYWidgetView_SettingEntry {
...
struct AYCharacterCustomizationActor {
...
struct UYWidget_ValueCompareDisplay {
	UTextBlock* m_shouldValueText; // 0x338
};

struct UDebug_ReplayMenu_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UYDataTableRowAssociationComponent {
...
struct UZipFileFunctionInternalCallback {
...
struct UYRebuildNavMeshReportComponent {
...
struct UYWidget_Interaction {
	UImage* m_progressBarXHair; // 0x2c0
};

struct UYWidgetController_ItemsOverviewMods {
...
struct UWeaponScopeComponent_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
	UMaterialInstanceDynamic* ThermalScopeMat; // 0xb8
};

struct UWBP_TabElementBase_TabElem_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c8
...
struct UYWidget_SocialMapMarker {
...
struct AYCharacterCustomizationPreviewActor {
...
struct UYControllerSessionComponent {
...
struct UYWidget_BinaryOptionToggle {
...
struct UYWidget_SocialOverviewDEPRECATED {
...
struct UWBP_LegalAgreements_Menu_C {
...
struct UYProgressBarProspectorLevel_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
...
struct UAsyncConnectToDatabase {
	FMulticastInlineDelegate onSuccess; // 0x30
	FMulticastInlineDelegate OnFail; // 0x40
};
...
struct UYPlayerEscapeComponent_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
	bool CanEscape; // 0xb8
...
struct UYCharacterCustomizationComponent {
...
struct UYAnimNotifyState_PlayLoopingSound {
...
struct UYWeaponPlayerControllerInventoryComponent {
...
struct UYWidget_ItemDetailOverview {
...
struct UYCharacterScopeGlintComponent_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UWBP_Item_Preview_Btn_C {
...
struct UYWidget_SeasonOffersOverview {
...
struct UYCharacterCosmeticVisualizationComponent {
...
struct UYWidget_ItemComponentInsured {
	FMulticastInlineDelegate OnItemInsuredSet; // 0x300
};

struct UAnimNotifyState_TargetConvergence_C {
...
struct AYPlayerController_Match {
...
struct UYCharacterBannerComponent {
...
struct UConstructionSystemRemoveTool {
...
struct UWBP_SettingSectionHeader_Item_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UTextBlock* Txt_SettingLabel; // 0x268
	FText SettingSectionLabel; // 0x270
};

struct UWBP_Footer_B_Panel_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	UWidgetAnimation* WidgetIn_Anim; // 0x2c8
	UImage* Gfx_ArrowSmall; // 0x2d0
...
struct UYWidget_ItemComponentLore {
...
struct UYWidget_ItemComponentButtonModTune {
...
struct UModalDialogOkCancelItem_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x340
...
struct UWBP_Inventory_DragItem_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UMapMarker_PlayerSpawn_WBP_C {
	UImage* m_iconImage; // 0x2e0
	UImage* m_offscreenArrow; // 0x2e8
};

struct UCH_PlayerStation_ABP_C {
...
struct UInteractionAnimComponent_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UYAccountLinkingManager {
...
struct UYWidget_ItemsImprovementScreen {
...
struct UYWidget_NotificationItem {
...
struct UYNotificationComponent {
...
struct AYPerformanceResourceManager {
...
struct UMapMarker_Social_WBP_C {
...
struct UCarryableComponent_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UYWidget_ShopContainer {
	UYWidget_ShopItemEntry* m_entryWBP; // 0x2c0
};

struct UYWidget_SpecialOffersOverview {
...
struct UYControllerHeatMapComponent {
...
struct UYWidget_RankedCategories {
...
struct UAIAttackComponent_BP_C {
...
struct AYGPAComponentTestActor {
...
struct UYPlayerCharacterStateComponent {
...
struct UYPlayerRenderTargetVfxMovementComponent_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UWBP_TabNavigationBase_C {
...
struct UYPlayerUIAudioTriggerComponent {
...
struct UMapMarkerMovementNoise_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
...
struct UYWidget_ProgressBarWithDelta {
	UProgressBar* m_progressBar; // 0x2c0
...
struct UYWidget_RankedHallOfFame {
	int32_t m_amountofTopPlayersToShow; // 0x2c0
...
struct AYPickup_QuestItem_BP_C {
...
struct UYWidget_BlueprintsOverview {
...
struct APlayerCustomizationPreview_BP_C {
...
struct UYLiveEventModifiers_DeveloperSettings {
...
struct UYWidget_ArchetypeEntry {
	FMulticastInlineDelegate OnItemClicked; // 0x2c0
};

struct UYWidget_ItemComponentSubItems {
...
struct UBTTask_SetBB_Bool_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	bool New Value; // 0xb0
	FBlackboardKeySelector Key Bool; // 0xb8
};

struct UYDestructibleMeshComponent {
...
struct AStationLocationActor_BP_C {
...
struct UYCharacterLandingComponent {
...
struct UYBTService_AIActionContextName {
...
struct UYPlayerDropPodIntroComponent_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UPlayerBotRotateClockwiseTask_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
};
...
struct UYWidget_ItemComponentBase {
...
struct UAnimNotifier_PlayAISoundByTag_C {
	FGameplayTag AudioTag; // 0x38
	bool SuppressWhenDead; // 0x40
};

struct APRO_PlayerController_Login_BP_C {
...
struct UYControllerContractsBoardsDataComponent {
...
struct UYWidget_DismissivePopup {
...
struct UYBBObject_StabilityAnimationInfo {
...
struct UYIdleDetectionComponent_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UYHierarchicalStateMachine {
	TArray<UYHierarchicalStateBase*> m_stateStack; // 0x28
};

struct AScannerProjectile_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x398
...
struct AYCharacterCustomizationExplicitCustomizationActor {
...
struct UYWidget_LobbyFactionList {
...
struct UHelmetGoggleComponent_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
	UMaterialInstanceDynamic* GoggleMat; // 0xb8
	bool IsEnabled; // 0xc0
};

struct UYSceneManager {
...
struct UYMatchLevelActorContainer {
...
struct UOnboarding_03_MatchPickUpAndEscape_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x1b0
	FName SceneToInteract; // 0x1b8
...
struct UYAssetCheckerDataAsset {
...
struct UYCustomizationCameraComponent {
...
struct UYWidget_ItemComponentTextOfferCategory {
	UTextBlock* m_offerCategoryText; // 0x300
};

struct UYWidget_DamageNumberManager {
...
struct UYControllerContractsBoardsDataComponent_BP_C {
...
struct UYWidgetProvider_BugReporter {
...
struct UYCharacterDBNOComponent {
...
struct UYWidget_FactionContract {
...
struct UYWidget_ItemTooltipEntryDescription {
...
struct UMapMarker_AreaName_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
...
struct UYWidget_ItemComponentTextType {
...
struct UYWidget_ItemComponentImageFaction {
	UYWidget_ImageBase* m_factionImage; // 0x300
	bool m_useLargeIcon; // 0x308
};

struct UYDebugActivityLocationMapMarkerData {
...
struct UBTTask_PlaySpawnAnimation_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x110
...
struct UYControllerWeaponInspectionComponent {
...
struct UYLegalAgreementsManager {
...
struct UYPlayerVFXComponent_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
	UParticleSystemComponent* interaction01_PS; // 0xb8
	UYPlayerCharacterStateComponent* playerCharacter_StateComp; // 0xc0
	APRO_PlayerCharacter_C* playerCharacter; // 0xc8
...
struct UYCharacterCustomizationModel {
...
struct UYWidget_MatchResult {
	UYWidget_EomResultHeader* m_resultHeader; // 0x2c0
};

struct ASocialActor_BP_C {
...
struct UEQSContext_CombatTarget_C {
	FName KeyNameCombatTarget; // 0x30
};

struct UYWidget_InventorySlotItem {
...
struct UYRewardsRollManagerComponent {
...
struct UYMatchDifficultyComponent {
...
struct UTacticalFlashLightComponent_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UYWidget_AlivePlayers {
	UTextBlock* m_alivePlayersText; // 0x2c0
};

struct UTestScreenRoot {
	TSoftClassPtr<UObject> m_widgetBp; // 0x58
};

struct UWBP_CelebrationBacker_Panel_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
...
struct UYSoundNodeModulatorContinuous {
...
struct UYTutorialStepsPlayerComponent_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UYWidget_NotificationNumber {
...
struct UYPlayerFactionsProgressionComponent {
...
struct AYProjectile_CreatureGrenade_BP_C {
	UAudioComponent* Audio_AI_GrenadeLoop; // 0x3a0
};

struct UYWidget_FounderPackEntry {
...
struct UYBigDrillMapMarkerData {
...
struct UWBP_RadialSelection_Item_C {
...
struct UYPlayerSocialStationComponent {
...
struct UYWidget_VanityOverview {
...
struct UYWidget_RankedLeaderboardBig {
...
struct UYParticleModuleSizeMultiplyLife {
	char bEmitterTime : 1; // 0x80
};

struct UConstructionSystemComponent {
...
struct UYTutorialComponent_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UYControllerAnnouncementComponent {
...
struct UYSpawnManagerComponent {
...
struct UBTTask_PlayMontageAnimation_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x110
...
struct UWBP_Credits_Headline_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct AYPlayersMapDataManager {
...
struct UWBP_SettingsContent_Video_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x340
...
struct UYActivities_DeveloperSettings {
...
struct UOpenPlayerSupportCommand_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x28
};

struct UYVehicleMovementComponent {
	FRotator m_cachedVehicleHeightAlignmentData; // 0xb20
};

struct UMapMarker_Escape_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
...
struct UYNotificationDataCollection {
...
struct UBTTask_PreShareSenseBool_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	float Distance; // 0xb0
	FBlackboardKeySelector WillShareSense Key; // 0xb8
};

struct AYBagContainer_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x480
	float LifeTime; // 0x488
	bool OffsetEnabled; // 0x48c
};

struct UPlayerBotBuyGearsetTask_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
};
...
struct AYConditionLocationActor {
...
struct UYWidget_VanityCustomizationCategory {
...
struct UYGameStateCustomizationComponent {
...
struct UMapMarker_Sabotage_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
...
struct UYWidget_ItemComponentTextForArchetype {
	UTextBlock* m_archetypeText; // 0x300
};

struct UYWidget_ModalDialogOKCancelItem {
...
struct UPlayerBotMoveToInteractibleTask_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	int32_t counter; // 0xb0
	AActor* Owner; // 0xb8
...
struct UYProjectileMovementComponent {
...
struct UYStateCharacterCustomizationDataComponent {
...
struct UPlayerBotMoveToTargetTask_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	int32_t counter; // 0xb0
	AActor* Owner; // 0xb8
	FName combatTarget; // 0xc0
...
struct ULightningComponent_BP_C {
...
struct UEQSContext_HigherBetweenCombatTargetAndQuerier_C {
	FName KeyNameCombatTarget; // 0x30
};
...
struct UNotificationSocialEntry_WBP_C {
...
struct UFlinchesComponent_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
};
...
struct UYPlayerCharacterWeaponComponent {
...
struct UYWidgetProvider_Settings {
...
struct UPlayerBotAimAtTargetTask_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	FName combatTarget; // 0xb0
...
struct UOpenBugReporterCommand_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x28
};

struct UYWidget_LobbyFactionDetail {
	FMulticastInlineDelegate OnFactionSelected; // 0x2c0
...
struct UDeveloperCreditsMenu_SBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
};

struct AYPerkComponentTestActor {
...
struct UYPlayerInputStackComponent {
...
struct UYWidget_ItemComponentTextAmount {
...
struct UYWidget_TopMenuSubButton {
...
struct UConstructionSystemBuildTool {
	float TraceDistance; // 0x30
...
struct UYTextBlockWidgetStyle {
	FTextBlockStyle m_textBlockStyle; // 0x30
};

struct AYPickUp_Mineral_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x490
};

struct AYProjectile_Crusher_RockHeavy_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x3a0
	UStaticMeshComponent* StaticMesh; // 0x3a8
	bool hasBeenThrown; // 0x3b0
};
...
struct UYPlayerProximityManagerComponent {
...
struct UYWidget_ItemComponentClickable {
	UYButton* m_button; // 0x300
	bool m_allowHoverOnly; // 0x308
};

struct UPlayerBotStopPerformanceCaptureTask_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
...
struct ASprayActor_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2f0
};

struct AYAudioVolume {
...
struct UYWidget_ModalDialogShopOfferPurchase {
...
struct UYCharacterAbilityComponent {
...
struct UWBP_SelectionHighlight_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UWidgetAnimation* Idle_Anim; // 0x268
...
struct UWBP_HeaderComplex_Panel_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	UWidgetAnimation* ScreenIn_Anim; // 0x2c8
...
struct UYPlayerCharacterAnimInstance {
...
struct UWBP_ProgressBarNameValue_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
...
struct UYKilledEventAnalyticsComponent {
...
struct UYSkeletalMeshComponentFOV {
...
struct UYWidget_ItemComponentTextFlavor {
...
struct UPlayerBotAquireTargetTask_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	int32_t counter; // 0xb0
	AActor* Owner; // 0xb8
	FName combatTarget; // 0xc0
...
struct UAB_OSI_Syringe_SK_Skeleton_ABP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	FAnimNode_Root AnimGraphNode_Root; // 0x2c8
};

struct UYPlayerPassiveGeneratorsComponent {
...
struct UYAISenseConfig_AllyAlert {
...
struct UYWidget_RankedLeaderboardBase {
	int32_t m_amountOfFriendsToShow; // 0x2c0
};

struct AYPlayerStateBase {
...
struct UItemComponent_Clickable_WBP_C {
...
struct UYPlayerEOSStatsDataComponent {
...
struct UDebug_ReplaySlot_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UMapMarker_DeliveryStation_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
	UWidgetAnimation* Warning; // 0x2e8
...
struct UWBP_HealthBar_HUD_Item_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_Subtitles_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
	UImage* Gfx_SubtitleBacker; // 0x268
	UTextBlock* Txt_Subtitles; // 0x270
};

struct UYWidgetController_InvitesUserList {
...
struct UUI_RadialStationMinimap_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
...
struct UYWidget_ModalDialogExitGame {
...
struct UYVirtualCursorSettings {
...
struct UMatchPhaseListenerComponent_BP_C {
...
struct UYControllerCraftingComponent {
...
struct UYMultiDataTableRowAssociationComponent {
...
struct UWBP_Inventory_SplitItem_Modal_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x580
...
struct UYActivityProgressActorWidget {
...
struct UWBP_RadialSelection_Panel_C {
...
struct UWBP_Notification_Panel_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UYControllerReleaseNotesComponent {
...
struct UBTService_Bot_NoMovement_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x98
	EYAIState aiState; // 0xa0
};

struct UWBP_BugReporter_Provider_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x90
	FString AdditionalFilePath; // 0x98
};

struct UWBP_Keybinding_Btn_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
...
struct UOpenSettingsCommand_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x38
};

struct UWBP_SettingsContent_Controls_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x340
...
struct UWBP_Pickups_HUD_Item_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x580
...
struct UItemComponent_TextOfferPrice_WBP_C {
...
struct UYWidget_ItemComponentTextUpgradePrice {
	UYWidget_PriceGeneric* m_priceWidget; // 0x300
};

struct UYHideableBushManagerComponent {
...
struct UYControllerContractsActivesDataComponent {
...
struct UYCharacterEmoteComponent {
...
struct UYPlayerRewardsComponent {
...
struct UYWidget_ItemComponentModEntry {
...
struct UWBP_Notification_Item_C {
...
struct UYControllerInventoryBackendComponent {
...
struct UYControllerInventoryRuntimeComponent {
...
struct UPlayerBotDoScreenshotTask_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
};
...
struct UYBTService_EvaluateMeleeAttacks {
...
struct UWBP_InteractionPlate_C {
...
struct UYWidget_OfferDetailOverview {
...
struct UYActivityLocationsManager {
...
struct UAIHitReactionComponent_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UYWidget_ItemComponentTextModType {
	UTextBlock* m_modTypeText; // 0x300
};

struct UYExcelConverterDataAsset {
...
struct UYWidget_ItemActionsPanel {
...
struct UYWidget_QuickMatchInfo {
...
struct UYLiveEventModifiersManager {
...
struct UNotificationYesNo_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x3b0
...
struct UOnboarding_06_TalkToBadumCraftingStation_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x1b0
	FDataTableRowHandle badumSceneRowHandle; // 0x1b8
	FName badumId; // 0x1c8
	FName SceneToInteract; // 0x1d0
...
struct UYAuthenticationManager {
	UYLegalAgreementsManager* m_legalAgreementsManager; // 0x28
};

struct UYControllerStateInputComponent {
...
struct UMapMarker_DebugActivityLocation_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
	UWidgetAnimation* Warning; // 0x2e8
...
struct UYWidget_ItemComponentDragAndDropable {
...
struct AAA_EscapeShipTerminal_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x240
	UParticleSystemComponent* BloomParticle; // 0x248
	UPointLightComponent* PointLight; // 0x250
...
struct UMapMarker_Vehicle_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
	UWidgetAnimation* Warning; // 0x2e8
	UImage* m_iconImage; // 0x2f0
...
struct UBTTask_SetAIReactionContext_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	EYAIReactionContext AIReactionState; // 0xb0
};

struct UUI_ScannerPing_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ULightningTypeManager_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x28
...
struct UYFallingDamageComponent {
...
struct UYCharacterCloakComponent {
...
struct UBTService_ResetCheck_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x98
...
struct UYCharacterCustomizationManager {
...
struct UAsyncExecutePreparedQuery {
	FMulticastInlineDelegate onSuccess; // 0x30
	FMulticastInlineDelegate OnFail; // 0x40
};
...
struct UWBP_GenericContent_Panel_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	UWidgetAnimation* ScreenIn_Anim; // 0x2c8
...
struct UYSkillCalcManagerComponent {
...
struct UYMenuScreenHomeSubScreen {
	UYScreenBase* m_entryScreenBP; // 0xb0
};

struct UConstructionSystemItemUserData {
	int32_t Seed; // 0x28
};
...
struct UYWidget_CurrencyOffersOverview {
...
struct UAbility_Action_Cloak_BP_C {
...
struct UWBP_FTUE_NextStep_Widget_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x338
...
struct UWBP_Common_Simple_Btn_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x398
	UWidgetAnimation* Release_Anim; // 0x3a0
	UWidgetAnimation* Press_Anim; // 0x3a8
	UWidgetAnimation* HighlightSheen_Anim; // 0x3b0
...
struct AYTCCodeConventionActor {
...
struct UYWidget_ItemComponentTextOfferItemsCategory {
...
struct UYWidget_LanguageSelection {
...
struct UYSprintDashComponent {
	UYPlayerCharacterStateComponent* m_ownerStateComponent; // 0xc0
};

struct UUI_RegisterScreen_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x310
	UWidgetAnimation* FadeIn; // 0x318
};

struct UWBP_SettingsContent_Game_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x340
...
struct UYWidget_ItemComponentCraftingPrice {
...
struct UYWidget_EomFactionProgressPanel {
...
struct UPlayer_InventoryAudioComponent_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UYWidget_LaunchGameModeEntry {
...
struct UWBP_Objective_HUD_Item_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct ASceneQuickMenuBase_BP_C {
...
struct UYWidgetController_EscapeMenu {
...
struct UPlayerBotAquireInteractibleTask_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	int32_t counter; // 0xb0
	AActor* Owner; // 0xb8
	FName InteractTarget; // 0xc0
...
struct UPlayerCharacterCombatAwarenessComponent_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UYRichTextBlockHyperlinkDecorator {
...
struct UYWidgetController_EndOfMatch {
...
struct UYWidgetProvider_HUDInfo {
...
struct UYActorDespawningComponent {
...
struct UYWidget_SeasonOverview {
...
struct UOnboarding_04_PlayerQuarter_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x1b0
	FName SceneToInteract; // 0x1b8
...
struct UYOSSFunctionLibrary {
	FMulticastInlineDelegate OnPlayerIdQueryDone; // 0x28
};

struct UMapMarkerPlayer_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
...
struct UYPlayerControllerHelperComponent {
...
struct UYWidgetProvider_WeaponShops {
	FName m_shopId; // 0x40
...
struct UWBP_CelebrationBacker_Panel_C_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
...
struct UYWidget_MenuTestScreen1Widget {
	UButton* m_openScreenButton; // 0x2c0
	UButton* m_closeScreenButton; // 0x2c8
};

struct UPlayerBotResetRotatorTask_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
};
...
struct UBTService_AIState_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x98
	EYAIState NewAIState; // 0xa0
	FBlackboardKeySelector AIStateKey; // 0xa8
};

struct UYControllerPlayerQuarterComponent {
...
struct UItem_Component_ScrapValue_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x300
...
struct UYMetaQuestPlayerDataComponent {
...
struct UYRichTextBlockDecorator_InputAction {
...
struct UConstructionSystemUIAsset {
...
struct UYPlayerTriggerAISenseComponent_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UYSocialCompatibilityManager {
...
struct UYMenuScreenLegalAgreements {
...
struct UYWidgetProvider_Options {
	TMap<FName, FYOptionsMenuData> m_menuData; // 0x40
};

struct AYHUD_Login_BP_C {
...
struct UYWidget_OutpostSquadToggle {
...
struct UWelcomePackage_Category_Item_C {
...
struct UYWidget_GeneralGameSettings {
	UYWidget_SettingsToggle* m_minimapRotationToggle; // 0x2c0
};

struct UWBP_SettingsContent_Audio_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x340
...
struct UYMineralActorWidget {
	UEditableText* m_statusText; // 0x388
	UProgressBar* m_progressBar; // 0x390
};

struct UYWidgetProvider_InMatchHUD {
...
struct APRO_ProjectileBounce_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x398
...
struct UPlayerStationComponent_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UYBugReporterComponent_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UModalDialogScrapItem_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x340
	UWidgetAnimation* AnimateOut; // 0x348
...
struct UYWeaponPlayerControllerRuntimeComponent {
...
struct UYWidget_SpecificOffersOverview {
...
struct UItemComponent_Highlight_Stash_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x300
	UWidgetAnimation* Anim_Highlight; // 0x308
	UImage* BackgroundImage; // 0x310
};

struct UWBP_Friends_MiniWidget_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
...
struct AMeleeWeaponCustomization_BP_C {
...
struct AYGameMode_Login_BP_C {
	USceneComponent* DefaultSceneRoot; // 0x360
};

struct UWBP_Contract_Entry_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x340
...
struct UYActorWidgetController {
	AActor* m_actor; // 0x38
};

struct UYEncumbranceEffects_DataAsset {
...
struct UYWidget_EomRewardsPanel {
...
struct UYWidget_ItemTooltipEntryHeader {
...
struct UYControllerPlayerMapMarkerComponent {
...
struct UMapMarker_SurveillanceBubble_WBP_C {
...
struct UYControllerStationComponent {
...
struct UYWidget_ApperenceCategories {
	TArray<EYApperenceCategoriesTypes> m_supportedCategories; // 0x2d0
	UYWidget_ItemCategoryEntry* m_selectedItemCategory; // 0x2e0
};

struct UYWidget_ItemComponentBaseMods {
	TArray<UYWidget_ModEntry*> m_itemModWidgets; // 0x300
};

struct UModalDialogShopOfferPurchase_WBP_C {
...
struct UYWidget_TopMenuBarButton {
	FMulticastInlineDelegate OnButtonClickedDelegate; // 0x2c0
...
struct UYWidget_PlayerItemsOverview {
...
struct UYWidget_InboxMessageEntry {
...
struct UWBP_ScannerInterface_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWBP_Authorization_Screen_C {
...
struct UWBP_CompatibleWeapon_Entry_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	UWidgetAnimation* ScreenIn_Anim; // 0x2c8
...
struct UItemComponent_Tooltip_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x300
...
struct UYWidget_ImageCarrousel {
...
struct UWBP_Station_Provider_C {
...
struct UBTDecorator_DistanceToTarget_C {
	FBlackboardKeySelector combatTarget; // 0xa0
	float MaxDistance; // 0xc8
};

struct UCH_PlayerCustomization_ABP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	FAnimNode_Root AnimGraphNode_Root; // 0x2c8
...
struct UWBP_BlurFullScreenBacker_Panel_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UYControllerItemHoverComponent {
...
struct UBTService_Bot_AquireCloseTarget_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x98
	EYAIState aiState; // 0xa0
...
struct AYProjectile_NoPawnCollision_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x398
};
...
struct UWBP_PlayerCharacterPlate_C {
...
struct UYWidget_SimpleHeadline {
...
struct UYControllerUIActivityComponent {
...
struct UYPlayerRenderTargetVfxManagerComponent_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UYWidget_EscapeMenuItem {
	UYButton* m_button; // 0x2d0
};

struct UBTTask_Dodge_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x110
...
struct UYRankedSeasonsDataManager {
...
struct UWBP_DividerHorizontal_Panel_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	UWidgetAnimation* ScreenIn_Anim; // 0x2c8
	UImage* Edge; // 0x2d0
...
struct UYWidget_StatusPage {
	FString m_statusPageURL; // 0x2c0
};

struct UCH_Player_ABP_Clean_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x350
...
struct UYWidget_EomActionsPanel {
...
struct UNotificationNumber_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c8
...
struct UYLedgeClimbingComponent {
...
struct UWBP_ItemStatBonus_Entry_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct AAL_Location_Escape_BP_C {
...
struct UAICharExplosionComponent_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UYWidget_ItemTooltipEntryImage {
...
struct UYResourceFarmingMapMarkerData {
...
struct UYLightManagerComponent {
...
struct UYWidgetView_CustomerSupport {
...
struct UWBP_RetentionBonusItem_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UYProgressDisplayComponent {
...
struct UWBP_AimAssistDebugUI_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UYControllerTravelComponent {
...
struct UYWidget_InventoryWeaponReorderButton {
...
struct UYWidget_SettingsToggle {
...
struct UPlayerCarryingComponent_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x200
...
struct UPlayerBotFireTaskNoTP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	int32_t counter; // 0xb0
	AActor* Owner; // 0xb8
...
struct UYCharacterVanityDataComponent {
...
struct UAbility_Action_Stim_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x180
...
struct UWBP_Item_Preview_Attachments_Btn_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x5d8
...
struct AYPerformanceCaptureCameraActor {
	FName m_capturePointName; // 0x7c0
};

struct UYParticleSystemComponentFOV {
...
struct UYTCCodeConventionComponent {
...
struct UYWidget_ShopCategories {
...
struct UYEnvQueryTest_TraceMaterial {
	FEnvTraceData TraceData; // 0x1f8
...
struct UPlayerCharacterOutlineComponent_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UWBP_Attachments_List_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x448
...
struct UPlayerBotCloseAllWidgetsTask_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	AActor* Owner; // 0xb0
...
struct UModalDialogConnectionLost_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
...
struct UYPlayerControllerAwarenessComponent {
	FMulticastInlineDelegate m_onNotificationTriggered; // 0xb0
};

struct UWBP_FullMessage_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	UWidgetAnimation* WidgetIn_Anim; // 0x2c8
...
struct UYWidget_ModalDialogScrapItem {
...
struct UWBP_SquadOverview_Entry_C {
...
struct UWBP_BlurBackerSimple_Panel_C {
	UImage* Gfx_DarkenFillColor; // 0x260
};

struct UYWidget_FullScreenCrosshairManager {
...
struct UBTDecorator_ShouldAIRoar_C {
...
struct UYWidget_MenuTestRootWidget {
	UButton* m_openScreenButton; // 0x2c0
	UButton* m_closeScreenButton; // 0x2c8
...
struct UYWidgetController_Timer {
...
struct UYWidget_PerformantScroll {
...
struct ASoakTestStationAutomationManager_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x240
	USceneComponent* DefaultSceneRoot; // 0x248
...
struct UYWidget_CraftItemDetailOverview {
	FMulticastInlineDelegate OnBackButtonClicked; // 0x2c8
};

struct UYWidget_ItemComponentUpgradePrice {
	TMap<FString, UYWidget_ItemContainer*> m_materialsMap; // 0x300
};

struct AIntroActor_Base_BP_C {
...
struct UWBP_Inventory_PlayerSet_DropArea_Attachments_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UYWidget_SquadContainer {
...
struct UWBP_Settings_Provider_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x130
...
struct UWBP_SingleRowScroll_Panel_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
	UWidgetAnimation* WidgetIn_Anim; // 0x2c8
...
struct UYReplicationConnectionGraph {
...
struct UYWidget_ItemComponentVanity {
...
struct UYControllerChatComponent {
...
struct UWBP_LanguageSelection_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2f0
};
...
struct UYObjectInteractionComponent {
...
struct UYPlayerControllerDebugComponent {
...
struct UPlayerDBNOComponent_BP_C {
...
struct UModalDialogExitGame_WBP_C {
...
struct UConstructionSystemCursor {
...
struct UYDefaultInventoryDataAsset {
...
struct UYWidget_ProspectorLevelRewardsPopup {
...
struct UYWidget_ItemComponentTextAmountCompare {
	UTextBlock* m_compareValueText; // 0x320
	int32_t m_compareValue; // 0x328
};

struct UYWidget_Composite {
...
struct AYProjectile_Bullet_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x398
...
struct UWBP_PlayerQuartersLevel_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2c0
...
struct UYWidget_ModalDialogOkCancel {
...
struct UYMetaQuestPlayerInstanceComponent {
...
struct UContextMenu_FriendsList_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2f0
	UWidgetAnimation* FadeIn; // 0x2f8
...
struct UYPlayerMovementComponent {
...
struct UYWidget_PlayerCharacterPlate {
...
struct UBackgroundDropPodSpawner_BP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xb0
...
struct UAICharacterPlate_WBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x3a8
...
struct UPlayerBotStationInteractWithActorTask_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
	AActor* Owner; // 0xb0
	FName InteractTarget; // 0xb8
	APRO_PlayerController_C* PROPlayerController; // 0xc0
...
struct UBTTask_HandleResetFailure_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
...
struct UWBP_InputKeyNavigation_C {
...
struct UEQSContext_AllyLocationAndCombatLocations_C {
	FName KeyCombatMoveToLocation; // 0x30
	float NearbyAIRadius; // 0x38
};

struct UBTTask_MeleeAttackCombo_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa8
...
struct UBTDecorator_SetAIState_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0xa0
	EYAIState NewAIState; // 0xa8
	FBlackboardKeySelector AIStateKey; // 0xb0
};

struct UYWidget_HardCurrencyDisplay {
	UYWidget_PriceGeneric* m_priceWidget; // 0x2c0
};
...
struct UYWidget_SocialUserList {
...
struct UYWidget_SeasonRewardsPopup {
...
struct UYWidget_MessageGrantEntry {
...
struct UYServerResourceManagerComponent {
	TArray<UObject*> m_hardRefrencedObjects; // 0xb0
};

struct UWBP_Footer_A_Panel_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UMatchPhaseDirectorComponent_BP_C {
...
struct UYAbilityAnalyticsComponent {
...
struct UYWidget_ItemComponentTextBlueprintPrice {
	UYWidget_PriceGeneric* m_priceWidget; // 0x300
};
