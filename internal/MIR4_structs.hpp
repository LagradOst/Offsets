...
struct FBattlePassRewardTemplate {
	int32_t ID; // 0x8
	int32_t GroupId; // 0xc
...
struct FCustomizingTypeTemplate {
...
struct FGuildDominionPBSTemplate {
...
struct FItemDurabilityRepairCostTemplate {
...
struct FPawnMovementComponentPostPhysicsTickFunction {
	ETickingGroup TickGroup; // 0x8
	ETickingGroup EndTickGroup; // 0x9
	char bTickEvenWhenPaused : 1; // 0xa
	char bCanEverTick : 1; // 0xa
...
struct FTotalMenuFrameTemplate {
	int32_t UniqueId; // 0x8
...
struct FUIShopItemPackageTemplate {
...
struct FServerChangeUITemplate {
	int32_t ID; // 0x8
	int32_t IsShow; // 0xc
...
struct FGuildFameCategoryTemplate {
...
struct FItemXDRACOSealingTemplate {
	int32_t Name; // 0x8
	int32_t ID; // 0xc
...
struct FItemGetWayListTemplate {
	int32_t UniqueId; // 0x8
...
struct FSmallTalkDialogueTemplate {
...
struct FCustomizingCategoryTemplate {
	int32_t CategoryID; // 0x8
...
struct FBattlePassGroupTemplate {
	int32_t ID; // 0x8
	int32_t GroupId; // 0xc
...
struct FGuildContributeRewardTemplate {
...
struct FGreatBuildingStepTemplate {
...
struct FRankingCategoryTemplate {
	int32_t CategoryID; // 0x8
...
struct FCharacterEmoteTemplate {
	int32_t IconID; // 0x8
	int32_t EmoteID; // 0xc
...
struct FInstanceDungeonSettingTemplate {
	int32_t StageId; // 0x8
...
struct FGuildDevUnLockTemplate {
	int32_t Name; // 0x8
	int32_t DevId; // 0xc
...
struct FGuildDailyMissionTemplate {
...
struct FCharacterForceTemplate {
...
struct FGuildMoneyExchangeTemplate {
	int32_t Name; // 0x8
...
struct FIconTemplate {
	int32_t IconID; // 0x8
	FString Path; // 0x10
	bool IsMultiLanguage; // 0x20
};

struct FItemTransferTemplate {
	int32_t Name; // 0x8
...
struct FItemXDRACOMakeTemplate {
	int32_t Name; // 0x8
	int32_t ItemMakeId; // 0xc
	int32_t ContentsId; // 0x10
...
struct FQuestRelationRewardTemplate {
...
struct FInstanceDungeonInfoTemplate {
...
struct FCustomizingComponentTemplate {
...
struct FGameOptionSettingTemplate {
	int32_t Name; // 0x8
...
struct FCharacterForceLevelTemplate {
...
struct FInventoryExtendValueTemplate {
...
struct FBattlePassInfoTemplate {
	int32_t ID; // 0x8
...
struct FGuildAuthorityTemplate {
	int32_t Name; // 0x8
...
struct FSchedulerCycleTemplate {
	int32_t ID; // 0x8
	int32_t ScheduleType; // 0xc
	int32_t ScheduleHour; // 0x10
};

struct FUserEventSiegeeveTemplate {
	int32_t ID; // 0x8
...
struct FGameOptionKeySettingTemplate {
	int32_t Name; // 0x8
	int32_t KeyId; // 0xc
...
struct FGuildDominionExchangeTemplate {
	int32_t Name; // 0x8
	int32_t ExchangeId; // 0xc
...
struct FSmallTalkSettingTemplate {
	int32_t UniqueId; // 0x8
	int32_t StageId; // 0xc
...
struct FGuildDominionPkGradeTemplate {
...
struct FCustomizingPresetTemplate {
...
struct FDailyWorkPlusRewardTemplate {
...
struct FRankingSchedulerTemplate {
...
struct FDropRewardBoxTypeGroupTemplate {
...
struct FItemSmeltingEffectTemplate {
...
struct FGuildDominionPrizeTemplate {
...
struct FDropRewardObjectGroupTemplate {
...
struct FNpcItemMakeListTemplate {
	int32_t Name; // 0x8
	int32_t NpcItemMakeListId; // 0xc
	int32_t ItemMakeId; // 0x10
};

struct FQuestTagSetTemplate {
	int32_t TagId; // 0x8
...
struct FItemInfoSummaryTemplate {
...
struct FItemSmeltingAttributeTemplate {
	int32_t RowId; // 0x8
	int32_t Class; // 0xc
	int32_t Grade; // 0x10
	int32_t Tier; // 0x14
...
struct FGuildGiftLevelTemplate {
	int32_t Name; // 0x8
...
struct FClosedTrainingStatusTemplate {
	int32_t Name; // 0x8
...
struct FCharacterMasteryLevelLimitTemplate {
	int32_t ClassID; // 0x8
...
struct FSkillSpecialAbilityTemplate {
	int32_t ID; // 0x8
	int32_t SkillId; // 0xc
...
struct FGuildWarRevivalTemplate {
...
struct FMonsterRareActionTemplate {
...
struct FItemSubCoolTimeTemplate {
...
struct FGuildWarObjectTemplate {
...
struct FBoneCustomizingTemplate {
...
struct FCharacterMasteryTemplate {
	int32_t RowId; // 0x8
	int32_t ClassID; // 0xc
...
struct FItemTranscendenceDefineTemplate {
	int32_t TranID; // 0x8
...
struct FStatusCalculateTemplate {
	int32_t StatusId; // 0x8
...
struct FDropRewardBoxTypePIETemplate {
...
struct FServerChangeConditionTemplate {
	int32_t ID; // 0x8
...
struct FEvent_SchedulerTemplate {
	int32_t SchedulerID; // 0x8
...
struct FGuildMarkTemplate {
	int32_t MarkId; // 0x8
	int32_t MarkType; // 0xc
	int32_t ResourceId; // 0x10
};

struct FItemMaterialComposePointTemplate {
	int32_t Name; // 0x8
...
struct FItemBlessIncreaseRateTemplate {
	int32_t Name; // 0x8
	int32_t RowId; // 0xc
...
struct FGuildWarMonsterTemplate {
	int32_t MonsterId; // 0x8
...
struct FCharacterPartsDefinesTemplate {
...
struct FGuildWarCostumeTemplate {
...
struct FClosedTrainingCollectTemplate {
	int32_t Name; // 0x8
...
struct FCustomizingSettingTemplate {
...
struct FGuildDominionBuffTemplate {
...
struct FSpawnObjectDataTemplate {
	int32_t TargetID; // 0x8
...
struct FItemUnsealingAccelerationTemplate {
	int32_t RowId; // 0x8
	int32_t ItemId; // 0xc
...
struct FMagicSquareStageTemplate {
...
struct FStagePreloadTemplate {
	int32_t StageId; // 0x8
	TArray<FPreloadData> PreloadData; // 0x10
};

struct FPhasingTemplate {
...
struct FCinematicDialogueTemplate {
...
struct FInventoryExtendItemTemplate {
...
struct FItemOptionPassiveTemplate {
...
struct FBuffOverlapCallTemplate {
...
struct FGuildMemberGradeTemplate {
...
struct FItemSPTreasureTranceTemplate {
...
struct FCharacterMasterySlotTemplate {
	int32_t SlotID; // 0x8
...
struct FCostumePaletteTemplate {
	int32_t RowId; // 0x8
...
struct FSequenceDialogueTemplate {
...
struct FMonsterResourceTemplate {
...
struct FBattlePassMissionTemplate {
	int32_t ID; // 0x8
	int32_t GroupId; // 0xc
...
struct FGlobalFontRangeTemplate {
...
struct FItemMysticalPieceTranceTemplate {
	int32_t TranceID; // 0x8
...
struct FGameDefineOptionTemplate {
	int32_t ID; // 0x8
...
struct FAreaNameTemplate {
	int32_t RowId; // 0x8
	int32_t TargetName; // 0xc
	int32_t Cooltime; // 0x10
};

struct FItemMakeAgencyTemplate {
...
struct FQuestCombatDeviationTemplate {
...
struct FItemGetWayInfoTemplate {
	int32_t UniqueId; // 0x8
	int32_t StageId; // 0xc
	int32_t NpcID; // 0x10
	int32_t LinkID; // 0x14
...
struct FMonsterColorGroupTemplate {
	FString Color01; // 0x8
	FString Color02; // 0x18
	FString Color03; // 0x28
};

struct FNpcShowScheduleTemplate {
...
struct FItemMagicStoneTranceTemplate {
	int32_t TranceID; // 0x8
	int32_t TranceStep; // 0xc
	int32_t StatusId; // 0x10
...
struct FCharacterExpBoosterItemTemplate {
	int32_t Name; // 0x8
	int32_t ItemId; // 0xc
...
struct FItemCollectionTemplate {
...
struct FAutoFlightPathTemplate {
...
struct FItemOptionGradeTemplate {
	int32_t Name; // 0x8
...
struct FAutoMoveDirectingTemplate {
	int32_t StageId; // 0x8
	FVector StartCoordinate; // 0xc
	FVector EndCoordinate; // 0x18
...
struct FItemOptionRandomTemplate {
	int32_t Name; // 0x8
...
struct FDominionStorageHistoryTemplate {
...
struct FCharacterExpBoosterTemplate {
	int32_t Name; // 0x8
	int32_t RowId; // 0xc
...
struct FCharacterForceBloodTemplate {
	int32_t UniqueId; // 0x8
...
struct FItemMaterialComposeTemplate {
	int32_t Name; // 0x8
	int32_t MainType; // 0xc
...
struct FClientErrorStringTemplate {
	FString ErrorString; // 0x8
};

struct FGuildWarSiegeRewardTemplate {
...
struct FUserEventBenedictionTemplate {
	int32_t Name; // 0x8
	int32_t ID; // 0xc
...
struct FItemRandomGetInfoTemplate {
	int32_t Name; // 0x8
...
struct FClosedTrainingTemplate {
	int32_t Name; // 0x8
...
struct FGachaGroupTemplate {
	int32_t Name; // 0x8
	int32_t GroupId; // 0xc
	int32_t ListGroupId; // 0x10
};

struct FItemRandomGetTemplate {
	int32_t Name; // 0x8
...
struct FMonsterPhasingTemplate {
	int32_t MonsterId; // 0x8
	int32_t MonsterResourceID; // 0xc
	int32_t GroupId; // 0x10
	int32_t NameSId; // 0x14
...
struct FRankingSeasonRewardTemplate {
...
struct FServerChangeCostTemplate {
	int32_t ID; // 0x8
	int32_t ChangeCondtionType; // 0xc
...
struct FItemRandomExchangeEquipTemplate {
...
struct FItemRandomExchangeTemplate {
	int32_t ExchangeId; // 0x8
	int32_t Item_Main_Type; // 0xc
	int32_t Item_Sub_type; // 0x10
	int32_t Item_Grade; // 0x14
...
struct FMovieSceneSkeletalAnimationOptimizedSectionTemplate {
	EMovieSceneCompletionMode CompletionMode; // 0x10
	TWeakObjectPtr<UMovieSceneSection> SourceSectionPtr; // 0x14
};
...
struct FItemDurabilityBrokenlvTemplate {
...
struct FDeathPenaltyExpTemplate {
...
struct FDungeonTicketChargeTemplate {
...
struct FClientDataTablesTemplate {
...
struct FGuildExpeditionTemplate {
	int32_t ExpdId; // 0x98
...
struct FItemMaterialComposeListTemplate {
	int32_t Name; // 0x8
...
struct FItemSmeltingRateTemplate {
	int32_t RowId; // 0x8
...
struct FTotalMenuContentsTemplate {
	int32_t ContentsId; // 0x8
...
struct FClosedTrainingLevelTemplate {
	int32_t Name; // 0x8
	int32_t UniqueId; // 0xc
...
struct FCustomizingCameraTemplate {
...
struct FInventoryExtendTemplate {
