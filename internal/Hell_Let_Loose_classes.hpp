...
struct UHLLVehicleForceFeedbackData {
...
struct UHTP_Widget_Topic_Generic_C {
...
struct AHLLAbilityDrop_BombingRun {
...
struct UPlatoonInvitationDialog {
...
struct UWGT_BrowserSortButton_V2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
...
struct AMapData_SectorBooster_C {
...
struct UW_GH_GameProgress_Offensive_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
...
struct AHLLSupplyDrop_Crate {
	UHLLSupplyComponent* SupplyComponent; // 0x2e0
};

struct AHLLRecoilTester {
...
struct USoundNodeParameterDelay {
	FName ParamName; // 0x48
	float DefaultDelay; // 0x50
	float MaxDelay; // 0x54
};

struct UWGT_UseContext_UseHealWeapon_C {
...
struct UWGT_RoundSummaryDetails_V2_C {
...
struct UHLLUI_CreditsOrganisation {
	UTextBlock* OrganisationName; // 0x230
	UImage* OrganisationLogo; // 0x238
};

struct UWGT_CosmeticItem_Small_V2_C {
...
struct AHLLDispenserItem_Garrison {
	char bAutoDestroyGarrisonsPlacedByOtherOfficers : 1; // 0x4c8
};

struct UHLLMapIcon_ResourceNode {
...
struct UHLLArmourHealthComponent {
...
struct UHTP_Widget_Role_Loadout_Spotter_C {
...
struct UHLLUI_CreditsCategory_RoleAndMembers {
...
struct UWGT_BrowserFilterButton_V2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
...
struct UWGT_MapIcon_Garrison_C {
...
struct UHLLRoundSummaryDetails {
...
struct UHLLDispenserListItem_Satchel {
...
struct UWGT_UseContext_Resupply_C {
...
struct UClientBotInputComponent {
	TArray<UClientBotProcessor*> m_processors; // 0x138
};

struct UHLLCommanderUISubCategory {
...
struct UWBP_ResolutionComboBox_C {
...
struct UHLLSeatHealthStatusItem {
...
struct UHLLGunnerUI_HowitzerRangeItem {
...
struct UHLLBallisticsComponent {
...
struct UBPW_PlatoonInvitationDialogPlayer_V2_C {
...
struct USoundNodeDistanceDelay {
	float SpeedOfSound; // 0x48
	float BypassDistance; // 0x4c
	float MaxDelay; // 0x50
};

struct UGameplayMessages_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
	UVerticalBox* MessageList; // 0x238
};

struct UHLLAnimNotify_Footstep {
	EFoot Foot; // 0x38
...
struct ATankSeatBase {
	char bOnlyAllowArmourUnitsIn : 1; // 0x978
};

struct USmoothNetworkedMovement {
...
struct UHLLRoundSummaryProgression {
...
struct UArtyBarrelControllerComponent {
...
struct UHLLCosmeticCharacterAnimInstance {
...
struct UHLLIndicatorComponent_Sector {
...
struct UHLLMapTooltip_SeatBaseItem {
...
struct UMainMenuNavigationScreen_V2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
...
struct AHLLDispenserItem_StructureAdv {
...
struct AFlamethrowerBurningCharacter {
	ACharacter* BurningCharacter; // 0x220
};

struct UHLLTeamLoadouts {
...
struct UHLLRadialMenu_WeaponSegment {
	EWeaponType WeaponType; // 0x2c4
	UImage* WeaponIcon; // 0x2c8
};

struct UPlatoonMemberWidget {
...
struct UHLLDispenserListItem_Outpost {
...
struct AMapData_Sector_C {
	USceneComponent* DefaultSceneRoot; // 0x240
};

struct UHTP_Widget_Role_Loadout_AntiTank_C {
...
struct UVehicleAntiFlipComponent {
...
struct UHLLMapIcon_SectorBooster {
...
struct AHLLSeat_ArtilleryGunner {
...
struct UW_GH_GameProgress_Offensive_Objective_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
...
struct UBPW_PlatoonInvitationDialog_V2_C {
...
struct UWGT_ReplenishAmmoNotification_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
...
struct UBPW_SpeakingPlayersListItem_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x248
...
struct UBPW_ArmyCommanderRole_V2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UHLLVehicleVibrationData {
...
struct UWGT_RconConsoleWindow_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x248
...
struct UHLLMedicIndicator {
	UTextBlock* DistanceText; // 0x2a8
	UTextBlock* PlayerName; // 0x2b0
};

struct UHLLVehicleInactivityComponent {
...
struct UHLLMapTooltip_SeatBase {
	UVerticalBox* SeatVBox; // 0x260
};

struct UIngameCompass {
...
struct AShooterWeapon_Ballistic {
...
struct UHLLUseContext_DismantleItem {
	UImage* RadialProg; // 0x238
...
struct UHLLArmourWeaponUI_AmmoItem {
...
struct UHLLDamageVolumeComponent {
...
struct UHTP_Widget_Role_Loadout_Crewman_C {
...
struct AShooterWeapon_HealBase {
...
struct AServerQueueBeaconClient {
...
struct AMapData_Recon_C {
	USceneComponent* DefaultSceneRoot; // 0x268
};

struct USectorCompassIndicator {
	int32_t SectorIndex; // 0x250
};

struct UBPW_PlatoonManagementStack_Invite_V2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x270
...
struct UNearbySpawnEnemyDetection {
...
struct AShooterWeapon_Dispenser {
...
struct UWGT_UseContext_Dismantle_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x248
};
...
struct UWGT_UnitDesignationButton_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
	UButton* RootButton; // 0x238
...
struct UW_GH_GameProgress_Offensive_Sector_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
...
struct UWGT_ServerQueueProgress_C {
...
struct AHLL_GameHUD_C {
	USceneComponent* DefaultSceneRoot; // 0x788
};

struct APlayerPawn_Anim_V2_C {
...
struct AHLLCommanderAbility_Placeable {
...
struct UHLLMapIcon_AdminCam {
	UWidget* RotationContainer; // 0x368
};

struct UHLLArmourCollisionMesh {
...
struct UHLLRadialMenu_ChatSegment {
	EHLLChat ChatType; // 0x278
	UImage* ChatIcon; // 0x280
};

struct UHTP_Widget_Role_Loadout_Engineer_C {
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Item_C_3; // 0x230
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Item_C_4; // 0x238
...
struct UAvailablePlatoonTypes_V2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
...
struct UWGT_PlayerVoteButton_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
...
struct UHLLUseContext_MountWeapon {
...
struct UGamepadLayoutsScreen_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
...
struct UHLLSimpleHealthComponent {
...
struct UHLLUseContext_Dispenser {
...
struct UTrackedVehicleMovementComponent {
...
struct UWGT_HealthCircular_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x270
	FSlateBrush Brush; // 0x278
};

struct UHTP_Widget_Role_Loadout_Sniper_C {
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Item_C_2; // 0x230
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Item_C_4; // 0x238
...
struct UHTP_Widget_Role_Loadout_AutomaticRifleman_C {
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Item_C_2; // 0x230
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Item_C_4; // 0x238
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Primary; // 0x240
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Primary_3; // 0x248
...
struct UTrackedVehicleAnimInstance {
...
struct UHLLDial_Tachometer {
	UTextBlock* GearText; // 0x258
};

struct UWGT_AdminCamPlayerEntry_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x268
...
struct UABP_CosmeticCharacter_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x280
...
struct UTorsionBarSuspensionsComponent {
...
struct AHLLAbilityDrop_ParachuteBase {
...
struct UGamepadRTBImageDecorator {
...
struct UGlobalGrenadeThrowSettings {
...
struct AFlamethrowerBurningSpot {
	float Power; // 0x220
};
...
struct UPlatoonMemberCommander {
...
struct UMainMenuVerticalNavigationScreen_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
	UbtnNav_V2_C* btnNav_Barracks; // 0x238
	UbtnNav_V2_C* btnNav_Credits; // 0x240
...
struct UWGT_RoundSummaryPlatoon_C {
...
struct USpeakingPlayersListItem {
	UTextBlock* PlayerName; // 0x230
...
struct UVehiclePassengerAnimInstance {
...
struct UBPW_SpeakingPlayersList_C {
...
struct UHLLUI_CosmeticItemTooltip {
...
struct UW_GH_GameProgress_Sector_new_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
...
struct UWGT_CosmeticItem_Large_V2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x278
	UWidgetAnimation* Hover; // 0x280
	UImage* EquipedIndicator; // 0x288
	UBorder* SelectBorder; // 0x290
...
struct UHLLNameplateIndicatorBase {
...
struct UHLLMapTooltip_ResourceNode {
...
struct UHLLAnimNotify_CasingEject {
	char NumToPlay; // 0x38
};

struct UWGT_Disclaimer_V2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
...
struct UWGT_RadialInventory_Base_V2_C {
...
struct UWGT_DeployRoleSelection_V2_C {
...
struct AHLLCommanderAbility_StrafingRun {
...
struct UHLLRepairIndicator {
	UBorder* RepairBorder; // 0x2a8
};

struct UGameplayMessage_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
...
struct UWidget_DebugPlayerStates_C {
...
struct UWGT_BarracksPanel_V2_C {
...
struct UHTP_Widget_Role_Loadout_Assault_C {
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Item_C_2; // 0x230
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Item_C_4; // 0x238
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Primary; // 0x240
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Primary_3; // 0x248
...
struct UWBP_RoundSummaryKeyDetails_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
...
struct UWGT_UseContext_MountMG_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x240
};
...
struct UHLLWeaponCasingSettings {
...
struct UWGT_UseContext_LetGo_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x250
	UWidgetAnimation* Pulse; // 0x258
	UImage* Image_1; // 0x260
};

struct UHLLUI_CreditsCategory_Department {
	UTextBlock* TitleText; // 0x230
};
...
struct UWGT_LoadoutEntry_Large_C {
	USizeBox* RootSizer; // 0x268
};

struct AMainMenuLogic_C {
...
struct UWGT_UseContext_BandageSelf_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x360
};
...
struct AHLLCommanderAbility_DropperPlane {
...
struct UHLLAnimInstance_ArtilleryBase {
...
struct UHLLParachuteMeshComponent {
...
struct UWGT_CommanderListItem_V2_C {
...
struct UWGT_UseContext_UseDispenserWeapon_C {
...
struct UTeamSelectionOption_V2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x268
...
struct UHTP_Widget_Role_Loadout_Medic_C {
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Item_C_2; // 0x230
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Item_C_3; // 0x238
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Item_C_5; // 0x240
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Item_C_6; // 0x248
...
struct UWGT_OverviewMapWidget_C {
...
struct UHLLUI_AvailableRoleItem {
...
struct UWGT_ServerBrowser_V2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x328
...
struct UWGT_MapIcon_AdminCam_C {
...
struct UHTP_Widget_Role_Loadout_Item_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
...
struct UPlayerManagementActionsBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
...
struct UHLLSeatNameplateContainer {
...
struct AHLLCommanderAbility_GhostPlane {
...
struct UHLLCriticalPlayerIndicator {
...
struct UHLLRadialMenu_WeaponBase {
...
struct UHLLMapTooltip_Supplies {
...
struct AReconVehiclePassengerSeat {
	USceneComponent* InteriorMeshAttachmentRoot; // 0x978
	UStaticMeshComponent* InteriorMesh; // 0x980
	USeatCameraController* CameraController; // 0x988
};

struct UMapLoadingScreenData {
	FText MapName; // 0x30
	FText Date; // 0x48
	FText Location; // 0x60
...
struct UWGT_DialogBoxButton_V2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x258
...
struct UWGT_ServerListItem_V2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2b0
	UBorder* RootBorder; // 0x2b8
...
struct UHLLParticleModule_KillSphere {
	FRawDistributionFloat SphereRadius; // 0x30
};

struct AHLLSupplyDropBase {
...
struct AHLLArmourWeapon_Ballistic {
...
struct AHLLCommanderAbility_PlaneBase {
...
struct UHLLMainMenuBase {
	char bCanZoom : 1; // 0x230
};

struct UHLLRoleProgressionItem {
...
struct UHLLUseContext_HealWeapon {
...
struct UWGT_CommendTooltip_List_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
	UTextBlock* 1; // 0x238
	UTextBlock* 2; // 0x240
	UTextBlock* 3; // 0x248
...
struct UWGT_ReplenishAmmoCooldownNotification_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
	UWidgetAnimation* Pulse; // 0x238
...
struct UArtyTurnControllerComponent {
	AHLLSeat_ArtilleryGunner* GunnerSeat; // 0x488
	AHLLSeat_ArtilleryLoader* LoaderSeat; // 0x490
	UCapsuleComponent* CharacterTurretGuard; // 0x498
...
struct AHLLAbility_PassiveBase {
...
struct ABaseLineSectorSpawn {
	int32_t Group; // 0x3f0
};

struct AHLLArmourDebugger {
...
struct UHTP_Widget_Role_Loadout_MachineGunner_C {
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Primary; // 0x230
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Primary_3; // 0x238
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Primary_16; // 0x240
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Primary_17; // 0x248
...
struct UWGT_UseContext_EnterSeat_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x250
};
...
struct USoundPlayedOnlyWhileAnimationRuns {
...
struct UHLLDeployment_TeamSelect {
...
struct UWGT_RoleProgressionItem_C {
...
struct UHLLResourceNodeIndicator {
	UTextBlock* GenerationText; // 0x2a8
};

struct UPlatoonManagementStackKickRequest {
...
struct UHLLUseContextContainer {
...
struct UWGT_DeployRoleItem_V2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2a8
...
struct AProneMechanicsTestLogic {
...
struct UWGT_SocialLink_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
	UButton* Button; // 0x238
	ESocialMedia Type; // 0x240
};

struct UHLLSatchelIndicator {
	UImage* CountdownProg; // 0x2a8
};

struct UHTP_Widget_Role_Loadout_Officer_C {
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Item_C_3; // 0x230
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Item_C_4; // 0x238
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Item_C_5; // 0x240
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Item_C_8; // 0x248
...
struct UPitchYawControllerComponent {
	float YawRate; // 0xb0
...
struct UWGT_MapSelectButton_V2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
	UWidgetAnimation* Hover; // 0x238
...
struct AHLLAbility_ProjectileStrike {
...
struct UTankAudioComponent {
	UCurveFloat* EngineDuckingCurve; // 0xb0
};

struct ATankDriverSeat {
	UStaticMeshComponent* InteriorMesh; // 0x990
	USeatCameraController* CameraController; // 0x998
};
...
struct UHLLAdminCameraMovement {
...
struct AHLLCosmeticCharacterRenderer {
...
struct AHLLGhostAbilitySafezone {
	USceneComponent* DummyRoot; // 0x220
	UStaticMeshComponent* Mesh; // 0x228
};

struct UHLLUI_CosmeticCategory {
	TWeakObjectPtr<UHLLUI_CharacterSelection> ParentPanel; // 0x230
...
struct UPlatoonManagementStackInvite {
...
struct UHLLRadialMenu_ChildBase {
...
struct ABP_Powerline_Child2_EF_C {
...
struct ACinematicShermanJumboStub {
	USkeletalMeshComponent* TankMesh; // 0x220
	TArray<UStaticMeshComponent*> AllLeftTrackTiles; // 0x228
	TArray<UStaticMeshComponent*> AllRightTrackTiles; // 0x238
	UStaticMeshComponent* RightTrackTile_000; // 0x248
...
struct UHTP_Widget_Role_Loadout_Commander_C {
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Item_C_2; // 0x230
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Item_C_3; // 0x238
...
struct UHLLRadialMenu_ChatBase {
...
struct UHalftrackWheelsComponent {
...
struct UWGT_RoundSummaryStat_C {
...
struct UHLLRadialMenu_MarkersBase {
...
struct UBPW_HoverTintedImageButton_V2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
...
struct UHTP_Widget_Role_Loadout_Support_C {
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Primary; // 0x230
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Primary_3; // 0x238
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Primary_16; // 0x240
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Primary_17; // 0x248
...
struct UHLLUseContext_Supplies {
...
struct UMatchmakingScreen_V2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
...
struct UHTP_Widget_Role_Loadout_Rifleman_C {
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Item_C_2; // 0x230
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Item_C_4; // 0x238
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Primary; // 0x240
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Primary_3; // 0x248
...
struct AHLLAbilityDrop_Supplies {
...
struct UHLLUseContext_SwitchOrExitSeat {
	UImage* SwitchProgress; // 0x238
	URichTextBlock* SwitchText; // 0x240
};

struct UUseableWeaponFPPAnimationSet {
...
struct UWGT_RadialMarkers_Segment_C {
...
struct UForceFeedbackEventController {
...
struct UPlatoonManagementStack {
...
struct UHLLUISettings {
	TSoftObjectPtr<USlateWidgetStyleAsset> UIStyleSet; // 0x38
};

struct UHLLUI_RoleSelection_InGame {
...
struct UHLLAnimNotify_VibrationEvent {
...
struct UHLLGlobalVibrationConfig {
...
struct UTabbedButtonContainer_V2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x240
...
struct UHLLUpgradeGhostComponent {
...
struct UHLLRadialMenu_MarkersSegment {
...
struct APreplacedGarrisonSpawn {
...
struct AHLLArtillerySpawner {
	USceneComponent* DummyRoot; // 0x220
	AHLLArtilleryBase* ArtilleryClass; // 0x228
};

struct AHLLExplosive {
...
struct UButtonPromptsInfo_V2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
...
struct UWGT_MapIcon_BaseLineSectorSpawn_V2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x4a8
	UBorder* Icon; // 0x4b0
	UScaleBox* Scaler; // 0x4b8
	UW_HoverToolTip_Explained_C* Widget_TooltipRef; // 0x4c0
...
struct UWGT_RadialChat_Segment_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x288
	USizeBox* IconSizer; // 0x290
	UImage* SegmentBG; // 0x298
...
struct AHLLArmourWeapon_Howitzer {
...
struct AHLLArmourWeapon_Projectile {
...
struct UHLLAdminCameraSpringArm {
	AActor* TraceIgnoreActor; // 0x280
};

struct ASphereSectorCaptureBooster {
...
struct USoundNodeHLLDistanceCrossFade {
	TArray<FDistanceDatum> CrossFadeInput; // 0x48
};

struct UABP_Wrench_FPP_V2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x270
	FAnimNode_Root AnimGraphNode_Root; // 0x278
...
struct UHLLAudioVolumeComponent {
...
struct UTurretControllerComponent2 {
...
struct AHLLArmourWeapon_ReconGun {
...
struct AHLLAbility_SpawnVehicle {
...
struct UHLLAimAssistSettingsDataAsset {
...
struct UHLLUseContext_EnterSeat {
	UImage* IconImage; // 0x238
	UImage* RadialProg; // 0x240
	URichTextBlock* DisplayText; // 0x248
};

struct UHLLUpgradeData_Structure {
	UStaticMesh* UpgradeMesh; // 0x150
};

struct AVehicleSeatBase {
...
struct AHLLCommanderAbility_ReconPlane {
...
struct UBPW_PlatoonManagementStack_KickRequest_V2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x290
...
struct UHLLDispenserListItem_StructureBase {
...
struct UHLLUI_ServerBrowserItem {
...
struct UWGT_LoadoutOption_V2_C {
...
struct UHLLAmmoDepotIndicator {
	UBorder* ReplenishBorder; // 0x2a8
};

struct UPlayerManagementButtonBP_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
	UButton* btn; // 0x238
	USizeBox* SB_ROOT; // 0x240
	UTextBlock* txt_btn_Label; // 0x248
...
struct UWGT_Disclaimer_tipColumn_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
	UWidgetAnimation* FadeIn; // 0x238
	UImage* img_icon; // 0x240
...
struct AHLLVehicleSpawner_PrePlaced {
...
struct AHLLMapData_AdminCamera {
...
struct UHLLAdminCamPlayerEntry {
...
struct UBPW_ArmyLogo_C {
	UOverlay* USArmyForce; // 0x248
};

struct UWGT_DialogBox_V2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2f0
};
...
struct AHLLDispenserItem_Outpost {
	char bAutoDestroyOutpostsPlacedByOtherOfficers : 1; // 0x4c8
};

struct UHLLMapMetaTemplate {
...
struct UW_GH_GameProgress_PopIndicator_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
...
struct ABoxSectorCaptureBooster {
...
struct UWGT_LoadoutEntry_Small_C {
	USizeBox* RootSizer; // 0x268
};
...
struct UBaseVehicleMovementComponent {
	FVehicleEngineData EngineSetup; // 0x2f0
...
struct UWGT_CommanderSubCategory_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x258
...
struct UW_HoverToolTip_Explained_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
	UBorder* Alert; // 0x238
...
struct UTabbedButtonContainer {
	UShooterGameViewportClient* ViewportClient; // 0x230
};

struct ABP_StartScreenAnimation_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x220
...
struct UBPW_PlatoonManagementStack_Notification_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x260
};
...
struct AShooterWeapon_TravelTime {
...
struct UHTP_Widget_DeploymentScreen_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
	UImage* Image_1; // 0x238
	UImage* Image_2; // 0x240
	UImage* Image_3; // 0x248
...
struct AHLLMapData_Player_Replicator {
...
struct UHLLUI_LoadoutEntryTooltip {
	UTextBlock* ItemName; // 0x230
...
struct AHLLTurnBackVolume {
	int32_t AffectedTeams; // 0x258
};

struct UW_HotkeyPanelElement_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
...
struct UHLLDispenserListItem_Garrison {
...
struct UWGT_RoleSelectItem_V2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x268
...
struct UHLLDeployment_TeamSelectItem {
...
struct AMapStartCameraManager {
	ACameraActor* MapStartCamera; // 0x2738
};

struct UOffensiveWarfareGameStateComponent {
...
struct UHTP_Widget_Role_Commander_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
...
struct UHLLWeaponForceFeedbackData {
...
struct UVehicleExitLocationComponent {
...
struct AHLLSeat_ArtilleryBase {
	USoundBase* HitSound; // 0x970
};

struct UStartScreen_V2_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x238
...
struct UWGT_UseContext_Repair_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x250
};
...
struct UHLLCharacterAnimInstance {
...
struct UWGT_RoundTeamContainer_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x2e0
...
struct UHLLAnimNotify_CameraAnim {
...
struct UHLLUI_CharacterSelection {
...
struct UHTP_Widget_Role_Loadout_TankCommander_C {
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Primary; // 0x230
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Primary_3; // 0x238
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Primary_16; // 0x240
	UHTP_Widget_Role_Loadout_Item_C* HTP_Widget_Role_Loadout_Primary_17; // 0x248
...
struct AHLLDispenserItem_TimedSatchel {
	TArray<char> TimeValues; // 0x470
};

struct UWGT_GameWarmup_C {
	FPointerToUberGraphFrame UberGraphFrame; // 0x230
	UTextBlock* Timer; // 0x238
};

struct UHLLRoundSummaryPlatoon {
