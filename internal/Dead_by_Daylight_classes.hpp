...
struct UCurrencyProgressionTooltipWidget : UCoreBaseUserWidget {
...
struct UUMGMonthlyPassRewardsPopup : UUMGGenericPopup {
...
struct ULocalPlayerTrackerComponent : USceneComponent {
...
struct UPortalPlacerStateComponent : UActorComponent {
...
struct UDemogorgonPortalEffectComponent : UActorComponent {
...
struct UWorldRunawayMeshComponent : USkeletalMeshComponent {
...
struct UPortalRadiusDetectorComponent : UActorComponent {
...
struct UNotModifierCondition : UEventDrivenModifierCondition {
...
struct UUMGPlayerNameInputPopup : UUMGGenericPopup {
	UEditableTextBox* NameInputTextBox; // 0x3e8
};

struct UUMGAtlantaFreeTicketConfirmToUsePopup : UUMGGenericPopup {
...
struct AScreenIndicatorWorldMarker : AActor {
...
struct UUMGAtlantaTutorialGenericPopup : UUMGGenericPopup {
...
struct UNavigationScreenUMG : UNavigationScreen {
...
struct ASplineAudioEmitterActor : AActor {
...
struct USplashScreenUMG : USplashScreen {
...
struct UUMGPerkSelectionPopup : UUMGGenericPopup {
...
struct UOverlayMenuScreenUMG : UOverlayMenuScreen {
	UUMGAtlantaSettingScreen* _atlOverlayMenuScreen; // 0x300
};

struct AUIScreenshotTool : ACharacterTool {
...
struct UPortalTargetingComponent : UActorComponent {
...
struct ULegalMenuScreenUMG : ULegalMenuScreen {
...
struct UDBDAtlantaStructuredData : UObject {
...
struct UMaterialPerThemeSettings : UDataAsset {
...
struct UToastNotificationScreenUMG : UToastNotificationScreen {
...
struct UDBDAtlantaDesignTunables : UObject {
...
struct AAtlantaHeartbeatActor : AActor {
...
struct UDBDCheatManager : UCheatManager {
...
struct UHudScreenUMG : UHudScreen {
...
struct UTallyScreenUMG : UTallyScreen {
...
struct UAtlantaCamperInitializer : UActorComponent {
...
struct UUMGAtlantaTallyScreen : UMobileBaseUserWidget {
...
struct UWinter2021PlayerComponent : UActorComponent {
...
struct UPanelScreenUMG : UPanelScreen {
...
struct AShopCameraManager : AInfo {
...
struct UUMGAtlantaPromoCodePopup : UUMGGenericPopup {
...
struct UAchievementHandlerComponent : UActorComponent {
...
struct ASpiritPassivePhaseWalkHusk : ABaseVFX {
...
struct URitualHandlerComponent : UActorComponent {
...
struct USnowmanAttackableComponent : UAttackableComponent {
...
struct UPortalOutlineUpdateStrategy : UOutlineUpdateStrategy {
...
struct UHudScreenCoreUMG : UHudScreen {
...
struct UBlinkComponent : UActorComponent {
...
struct UUMGRichTextFreeTicketDecorator : URichTextBlockDecorator {
...
struct UBlinkerComponent : UActorComponent {
	float _rayCastZOffet; // 0xb8
	float _rayCastLength; // 0xbc
...
struct UMaterialPerThemeData : UDataAsset {
...
struct ULoadingScreenUMG : ULoadingScreen {
...
struct UHISMMaterialHelperComponent : UHierarchicalInstancedStaticMeshComponent {
...
struct UCoreKeyListenerButtontWidget : UCoreButtonWidget {
...
struct UUMGRefundPopup : UUMGGenericPopup {
...
struct UGPUCullingInstancedStaticMeshComponent : UInstancedStaticMeshComponent {
...
struct UCoreRewardWidget : UCoreButtonWidget {
...
struct UGlyphNavMovementComponent : UNavMovementComponent {
...
struct UFootstepsPerceptionComponent : UActorComponent {
...
struct UCamperAnimInstance : UAnimInstance {
...
struct UWinter2021EventComponent : UActorComponent {
...
struct UNatObjectRandomizer : UObjectRandomizer {
...
struct USpiritDynamicAccessoryAnimInstance : UDynamicAccessoryAnimInstance {
...
struct AK25AnimationFollowerActor : AActor {
...
struct UUMGBloodStoreMysteryBoxPopup : UUMGGenericPopup {
...
struct UStoreScreenUMG : UStoreScreen {
