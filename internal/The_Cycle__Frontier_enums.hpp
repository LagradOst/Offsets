...
enum class EYItemStatsType : uint8_t {
	...
	BagCapacity = 7,
	Cooldown = 8,
	ChainReactionActive = 9,
	DamageApplication = 10,
	DamageAgainstEnemy = 11,
	DamageAgainstPlayer = 12,
	DamageResistancePlayer = 13,
	DamageResistanceEnemy = 14,
	DamageSelfInvincibility = 15,
	Durability = 16,
	Duration = 17,
	DefaultSpread = 18,
	DPS = 19,
	DirectCloseRange = 20,
	DirectMaximumDistance = 21,
	DirectDamageFalloff = 22,
	Equip = 23,
	Health = 24,
	MaxSpread = 25,
	MaximumDistanceByActivation = 26,
	MaximumDistance = 27,
	MovementSpeedChange = 28,
	NumberApplied = 29,
	PerShotDamage = 30,
	ProjectileSpeed = 31,
	ProjectileLifetime = 32,
	ProjectileGravityScale = 33,
	Piercing = 34,
	Penetration = 35,
	ExplosiveCorpse = 36,
	RadialDamage = 37,
	Radius = 38,
	RadiusDamageEnabled = 39,
	Range = 40,
	RefireTime = 41,
	Reload = 42,
	Recoil = 43,
	...
	Shield = 50,
	TargetingSpeed = 51,
	TimeToActivateFromReady = 52,
	TotalDamage = 53,
	WeakAreaDamage = 54,
	WeaponSprintBufferTime = 55,
	WeaponBurstInterval = 56,
	WeaponRecoilCompenstationStartTime = 57,
	WeaponRecoilCompensationAmountX = 58,
	WeaponRecoilCompensationAmountY = 59,
	WeaponRecoilCompensationSpeedX = 60,
	WeaponRecoilCompensationSpeedY = 61,
	WeaponScaleOffset = 62,
	WeaponSpreadIncrease = 63,
	WeaponSpreadDecrease = 64,
	RadialDamageFalloffMultiplier = 65,
	RadialDamageStartFalloffRange = 66,
	VehicleBoostCooldown = 67,
	VehicleBoostSpeed = 68,
	VehicleBoostDuration = 69,
	AccelerationMultiplier = 70,
	EYItemStatsType_MAX = 71,
};
...
enum class EYChannelContext : uint8_t {
	...
	Voice = 2,
	All = 3,
	EYChannelContext_MAX = 4,
};

enum class AnimArchetypeEnum : uint8_t {
	NewEnumerator0 = 0,
	NewEnumerator1 = 1,
	NewEnumerator2 = 2,
	NewEnumerator3 = 3,
...
enum class EYCustomizationCategory : uint8_t {
	...
	Vehicle = 22,
	Droppod = 23,
	EYCustomizationCategory_MAX = 24,
};

enum class EYCodeConventionStandardEnum : uint8_t {
	ValueA = 0,
	ValueB = 1,
	ValueC = 2,
	Count = 3,
...
enum class ScannerInterfaceStates : uint8_t {
	NewEnumerator0 = 0,
	NewEnumerator1 = 1,
	NewEnumerator2 = 2,
	NewEnumerator3 = 3,
...
enum class AC_EscapeShip_State : uint8_t {
	NewEnumerator4 = 0,
	NewEnumerator5 = 1,
	NewEnumerator0 = 2,
	NewEnumerator7 = 3,
...
enum class EYFriendsImportResultCode : uint8_t {
	...
	Failure_PlayFab = 5,
	Failure_Unknown = 6,
	EYFriendsImportResultCode_MAX = 7,
};
...
enum class EYInventoryAudioActionPerformed : uint8_t {
	...
	Swapped = 1,
	Dropped = 2,
	EYInventoryAudioActionPerformed_MAX = 3,
};
...
enum class ENUM_CharacterAimState : uint8_t {
	NewEnumerator0 = 0,
	NewEnumerator1 = 1,
	ENUM_MAX = 2,
};
...
enum class EYHideableBushType : uint8_t {
	...
	Crouch = 1,
	Prone = 2,
	EYHideableBushType_MAX = 3,
};

enum class EN_EffortTypes : uint8_t {
	NewEnumerator11 = 0,
	NewEnumerator0 = 1,
	NewEnumerator1 = 2,
	NewEnumerator2 = 3,
...
enum class EYActivityType : uint8_t {
	...
	Escape = 9,
	Hunt = 10,
	Mineral_AlienCrystals = 11,
	Mineral_BasicOres = 12,
	Mineral_HeavyMetals = 13,
	Mineral_Radioactive = 14,
	Mineral_Veltecite = 15,
	MonsterNest = 16,
	PowerUp = 17,
	StormSurge = 18,
	Tracking = 19,
...
enum class EYCustomizationMode : uint8_t {
	...
	Pet = 10,
	Melee = 11,
	CharacterCustomizationPreview = 12,
	MAX = 13,
};
...
enum class EYPlayerInitializationType : uint8_t {
	...
	ServerIntialized = 6,
	LevelsLoaded = 7,
	EYPlayerInitializationType_MAX = 8,
};
...
enum class EYStartItemCraftingResultStatus : uint8_t {
	UNKNOWN_ERROR = 0,
	OK = 1,
	ANOTHER_ITEM_IS_ALREADY_BEING_CRAFTED = 2,
	NOT_ENOUGH_RESOURCES = 3,
	PLAYER_INVENTORY_NOT_FOUND = 4,
	RECIPE_DATA_NOT_FOUND = 5,
	STASH_FULL = 6,
	WRONG_ITEMID = 7,
	WRONG_PURCHASE_AMOUNT = 8,
	WRONG_RARITY = 9,
	WRONG_SHOPITEMBELONGSTO = 10,
	WRONG_USERID = 11,
	MAX = 12,
};
...
enum class En_FilterCategoryCollection : uint8_t {
	NewEnumerator0 = 0,
	NewEnumerator1 = 1,
	NewEnumerator2 = 2,
	NewEnumerator3 = 3,
...
enum class EYClaimCraftedItemStatus : uint8_t {
	UNKNOWN_ERROR = 0,
	OK = 1,
	BLUEPRINT_DATA_NOT_FOUND = 2,
	FAILED_GETTING_INVENTORY = 3,
	FAILED_GETTING_ITEM_CUSTOM_DATA = 4,
	FAILED_GETTING_PLAYER_SET = 5,
	FAILED_GRANTING_OR_UPDATING_ITEM = 6,
	ITEM_CURRENTLY_CRAFTED_NOT_FOUND = 7,
	NOT_ENOUGH_RESOURCES = 8,
	NO_ITEMS_GRANTED_OR_UPDATED = 9,
	PRICE_CRAFTING_STATION_NOT_FOUND = 10,
	RECIPE_DATA_NOT_FOUND = 11,
	WRONG_ITEMID = 12,
	WRONG_RARITY = 13,
	WRONG_SHOPITEMBELONGSTO = 14,
	WRONG_USERID = 15,
	MAX = 16,
};
...
enum class EYInsuranceStatus : uint8_t {
	...
	Pending = 1,
	InsuredByOwner = 2,
	InsuredByAnotherPlayer = 3,
	EYInsuranceStatus_MAX = 4,
};
...
enum class EYPlayerSessionMatchState : uint8_t {
	...
	Escape = 2,
	Pending = 3,
	EYPlayerSessionMatchState_MAX = 4,
};
...
enum class EYClaimGeneratorIncomeStatus : uint8_t {
	UNKNOWN_ERROR = 0,
	OK = 1,
	FAILED_SETTING_LASTCLAIM_TIME = 2,
	MISSING_GENERATOR_ID = 3,
	NO_STATIC_DATA_GENERATOR = 4,
	NO_REWARDS_ACCRUED = 5,
	NO_REWARDS_DATA_FOUND = 6,
	NO_REWARDS_FOUND_IN_CRATE = 7,
	STASH_FULL = 8,
	MAX = 9,
};
...
enum class EY_AttachmentItemState : uint8_t {
	NewEnumerator0 = 0,
	NewEnumerator1 = 1,
	NewEnumerator2 = 2,
	EY_MAX = 3,
...
enum class EYClassRepNodeMapping : uint8_t {
	...
	SpatializedOwnerConnection = 5,
	PlayerCharacter = 6,
	Spatialize_Static = 7,
	Spatialize_Dynamic = 8,
	Spatialize_Dormancy = 9,
	EYClassRepNodeMapping_MAX = 10,
};
...
enum class AC_EscapeShipTerminal_Actor_ENUM : uint8_t {
	NewEnumerator0 = 0,
	NewEnumerator1 = 1,
	NewEnumerator2 = 2,
...
enum class EYGameplayAttribute : uint8_t {
	...
	BombardmentDamage = 6,
	ChainReactionActive = 7,
	ChainReactionDamagePercentReduction = 8,
	ChainReactionRadius = 9,
	CurrentHealth = 10,
	CurrentShield = 11,
	DamageEnemyMultiplier = 12,
	DamageEnemyWeakAreaMultiplier = 13,
	DamageOverTimeEnabled = 14,
	DamagePlayerMultiplier = 15,
	DamageRadius = 16,
	DamageScalingDealt = 17,
	DamageScalingDealtAgainstAI = 18,
	DamageScalingDealtAgainstPlayers = 19,
	DamageScalingReceived = 20,
	DamageScalingReceivedFromAI = 21,
	DamageScalingReceivedFromPlayers = 22,
	DamageSelf = 23,
	DamageSelfInvincibility = 24,
	FallingDamageReduction = 25,
	FallingVelocityReduction = 26,
	GravityScaling = 27,
	HardLandingDistance = 28,
	HealingWardPower = 29,
	HealthDegenerationRate = 30,
	HealthPlateSightAngle = 31,
	HealthRegenerationDelay = 32,
	HealthRegenerationRate = 33,
	InteractionInteruptTime = 34,
	HelmetNV = 35,
	HelmetThermal = 36,
	KineticShieldHealth = 37,
	MaxHealth = 38,
	MaxShield = 39,
	MaxSlideSpeed = 40,
	MaxSpeed = 41,
	MaxSprintSpeed = 42,
	OverallMovementSpeed = 43,
	Piercing = 44,
	ProjectileAcceleration = 45,
	ProjectileAccelerationDelay = 46,
	ProjectileAccelerationMovementSpeed = 47,
	ProjectileArmingTime = 48,
	ProjectileGravityScale = 49,
	ProjectileInitialSpeed = 50,
	ProjectileLifeSpan = 51,
	ProjectileMaxSpeed = 52,
	RadialFalloffMultiplier = 53,
	RadialStartFalloffRange = 54,
	SpinupDuration = 55,
	SprintWhileReloading = 56,
	StaminaConsumptionPerWeaponFire = 57,
	SuperJumpCooldown = 58,
	SuperJumpSpeed = 59,
	TargetingFOVSpeed = 60,
	TargetingTime = 61,
	TargetingTimeFOV = 62,
	VehicleBoostCooldown = 63,
	VehicleBoostDuration = 64,
	VehicleHealth = 65,
	VehicleMovementSpeed = 66,
	WeakAreaDamageScaling = 67,
	WeaponAmmoOnSwitch = 68,
	WeaponAmmoConsumptionOnShot = 69,
	WeaponAmountOfShots = 70,
	WeaponBurstCount = 71,
	WeaponBurstInterval = 72,
	WeaponClipSize = 73,
	WeaponCrouchingRecoil = 74,
	WeaponDamageDirect = 75,
	WeaponDamageFalloffMultiplier = 76,
	WeaponDamageRadial = 77,
	WeaponDamageRange = 78,
	WeaponDotDamage = 79,
	WeaponDotDuration = 80,
	WeaponDotInterval = 81,
	WeaponEquipTime = 82,
	WeaponHideFullScreenWidget = 83,
	WeaponIsLooping = 84,
	WeaponMaxTraceRange = 85,
	WeaponPenetration = 86,
	WeaponRecoilCompenstationAmountX = 87,
	WeaponRecoilCompenstationAmountY = 88,
	WeaponRecoilCompenstationSpeedX = 89,
	WeaponRecoilCompenstationSpeedY = 90,
	WeaponRecoilCompenstationStartTime = 91,
	WeaponRecoilHorizontal = 92,
	WeaponRecoilVertical = 93,
	WeaponRecoilIncreaseRate = 94,
	WeaponRefireAnimationRateScaleMultiplier = 95,
	WeaponRefireTime = 96,
	WeaponReloadTime = 97,
	WeaponScaleOffset = 98,
	WeaponSpreadDecreaseRate = 99,
	WeaponSpreadIncreaseRate = 100,
	WeaponSpreadMax = 101,
	WeaponSpreadUnaimed = 102,
	WeaponSprintBufferTime = 103,
	WeaponTargetingFOV = 104,
	WeaponTargetingRecoil = 105,
	WeaponTargetingSpreadMultiplier = 106,
	WeaponTargetingMaxSpreadMultiplier = 107,
	WeaponTargetingSpreadIncreaseMultiplier = 108,
	WeaponUnequipTime = 109,
	WeaponRadialDamageImpulse = 110,
	WeaponRadialDamageSelfImpulseMultiplier = 111,
	WeaponIsSilenced = 112,
	WorldTargetingFOV = 113,
	ScopeThermal = 114,
	ScopeNV = 115,
	XPIncrease = 116,
	StaminaConsumptionRate = 117,
	MaxStamina = 118,
	GPA_HAS_BEEN_REMOVED = 119,
	EYGameplayAttribute_MAX = 120,
};
