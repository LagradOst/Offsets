...
struct FActorCountItem : FFastArraySerializerItem {
...
struct FHLLForceFeedbackEvent : FHLLVibrationEvent {
...
struct FActorCounter : FFastArraySerializer {
...
struct FPlayerVoteContainer : FFastArraySerializer {
...
struct FVoteDataContainer_Static : FFastArraySerializer {
...
struct FGamepadLayoutData : FTableRowBase {
...
struct FTankAnimInstanceProxy : FTrackedVehicleAnimInstanceProxy {
...
struct FRepMarkerInfo : FFastArraySerializer {
	TArray<FRepMarkerItem> Items; // 0x108
};

struct FLoadoutPreviewData : FTableRowBase {
...
struct FHLLCosmeticItemData_Helmet : FHLLCosmeticItemData_CharacterBase {
...
struct FHLLAdminPunishmentDamageEvent : FDamageEvent {
	FString Reason; // 0x10
};
...
struct FWeaponForceFeedbackProfile : FWeaponVibrationProfile {
...
struct FHLLWeaponForceFeedbackEvent : FHLLForceFeedbackEvent {
...
struct FMapDataPlayer : FFastArraySerializerItem {
...
struct FDLCMetaData : FTableRowBase {
	FText DisplayName; // 0x8
...
struct FVoteData_Dynamic : FFastArraySerializerItem {
...
struct FHLLActionScore : FTableRowBase {
	int32_t Combat; // 0x8
	int32_t Offense; // 0xc
...
struct FM3HalftrackAnimInstanceProxy : FHalftrackAnimInstanceProxy {
...
struct FHLLDustTrail : FTableRowBase {
...
struct FHLLUI_OrganisationCreditsInfo : FTableRowBase {
	FText Name; // 0x8
...
struct FVoteDataContainer_Dynamic : FFastArraySerializer {
...
struct FDispensedItemDataContainer : FFastArraySerializer {
...
struct FTrackedVehicleAnimInstanceProxy : FVehicleAnimInstanceProxy {
...
struct FDispensedItemData : FFastArraySerializerItem {
	char GhostIndex; // 0xc
	char ItemIndex; // 0xd
};
...
struct FReconVehicleAnimInstanceProxy : FVehicleAnimInstanceProxy {
...
struct FReconDataItem : FFastArraySerializerItem {
...
struct FHLLArmourDamageFX : FTableRowBase {
...
struct FVehicleSpawnData : FTableRowBase {
...
struct FVehicleForceFeedbackProfile : FVehicleVibrationProfile {
...
struct FHLLWaterEffectsData : FTableRowBase {
...
struct FHLLCosmeticItemData_CharacterBase : FHLLCosmeticItemData {
...
struct FHLLCosmeticItemData_Head : FHLLCosmeticItemData_CharacterBase {
...
struct FHLLUI_CreditsInfo : FTableRowBase {
...
struct FReconDataContainer : FFastArraySerializer {
...
struct FLoadoutItem : FTableRowBase {
...
struct FWeaponAnim : FWeaponFPPAnim {
...
struct FSdKfz251HalftrackAnimInstanceProxy : FHalftrackAnimInstanceProxy {
...
struct FMiscFeedbackProfile : FMiscVibrationProfile {
...
struct FRepMarkerItem : FFastArraySerializerItem {
...
struct FPlayerVote : FFastArraySerializerItem {
...
struct FVoteData_Static : FFastArraySerializerItem {
	FVoteHandle VoteHandle; // 0xc
...
struct FHLLCosmeticItemData_Uniform : FHLLCosmeticItemData_CharacterBase {
...
struct FMapTableDataRow : FTableRowBase {
...
struct FHLLUIStyle : FSlateWidgetStyle {
...
struct FHLLVehicleForceFeedbackEvent : FHLLForceFeedbackEvent {
...
struct FGamepadLayout : FTableRowBase {
...
struct FHLLUI_ServerBrowserMapInfo : FTableRowBase {
...
struct FHLLDecalSet : FTableRowBase {
...
struct FHalftrackAnimInstanceProxy : FVehicleAnimInstanceProxy {
...
struct FMapDataPlayerArray : FFastArraySerializer {
...
struct FHLLCosmeticItemData : FTableRowBase {
