...
enum class EDamageChannel : uint8_t {
	...
	DamageToBases = 12,
	DamageToVehicles = 13,
	BaseDefenseDamage = 14,
	Count = 15,
	EDamageChannel_MAX = 16,
};
...
enum class ECharacterActionNotifyType : uint8_t {
	...
	ShowPenis = 29,
	HidePenis = 30,
	ECharacterActionNotifyType_MAX = 31,
};
...
enum class EInteractionType : uint8_t {
	...
	Deposit100Money = 217,
	Deposit250Money = 218,
	Deposit1000Money = 219,
	DepositAllMoney = 220,
	EInteractionType_MAX = 221,
};
...
enum class ECraftingIngredientConsumptionHint : uint8_t {
	...
	Use = 1,
	Destroy = 2,
	ECraftingIngredientConsumptionHint_MAX = 3,
};
