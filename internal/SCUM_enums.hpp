...
enum class EAquaticIndividualSize : uint8_t {
	None = 0,
	S = 1,
	M = 2,
	L = 3,
...
enum class EWeaponActionNotifyType : uint8_t {
	...
	SetupForReload = 18,
	DrumRolled = 19,
	EWeaponActionNotifyType_MAX = 20,
};
...
enum class EInteractionType : uint8_t {
	...
	AddToQuickAccess = 53,
	AddToThrowAccess = 54,
	RemoveFromQuickAccess = 55,
	RemoveFromThrowAccess = 56,
	ChamberBullet = 57,
	LoadAmmo = 58,
	UnloadAmmo = 59,
	CheckAmmo = 60,
	...
	ClaimKill = 92,
	Disarm = 93,
	GestureShowFinger = 94,
	GestureStandSurrender = 95,
	GestureWaveHi = 96,
	GestureYouAreDead = 97,
	GestureFY = 98,
	GesturePoint = 99,
	GestureHeart = 100,
	GestureBallpalm = 101,
	GestureFacepalm = 102,
	GestureFingerGun = 103,
	GestureLaughing = 104,
	GestureSmellWave = 105,
	GestureSquat = 106,
	GestureCharge = 107,
	GestureFreeze = 108,
	GestureGetDown = 109,
	...
	GestureRally = 115,
	GestureThumbsUp = 116,
	GestureThumbsDown = 117,
	GestureUnderstandNot = 118,
	GestureUnderstandYes = 119,
	PlayInstrument = 120,
	Whistle = 121,
	CutHair = 122,
	CutFacialHair = 123,
	...
	Lockpick = 132,
	RemoveLocks = 133,
	RemoveLocksAdmin = 134,
	ForceUnlock = 135,
	AddUpgrade = 136,
	RadioTurnOn = 137,
	RadioTurnOff = 138,
	RadioIncreaseVolume = 139,
	RadioDecreaseVolume = 140,
	RadioChangeRadioStation = 141,
	StackAdd = 142,
	StackSplit = 143,
	RepairBaseElement = 144,
	RepairBaseElementArea = 145,
	RepairBaseElementsUnder25Percent = 146,
	RepairBaseElementsUnder50Percent = 147,
	RepairBaseElementsUnder75Percent = 148,
	ClaimBase = 149,
	ShowBaseFlagInfluence = 150,
	HideBaseFlagInfluence = 151,
	StartBaseFlagOvertake = 152,
	StopBaseFlagOvertake = 153,
	UpgradeBaseElement = 154,
	FlipPlaceable = 155,
	OpenContainer = 156,
	ChangeItemText = 157,
	CommitItemText = 158,
	...
	IncreaseAngle = 161,
	DecreaseAngle = 162,
	IncreaseLightIntensity = 163,
	DecreaseLightIntensity = 164,
	AddMotionTrigger = 165,
	AddLaserTrigger = 166,
	AddTripwireTrigger = 167,
	AddTimedTrigger = 168,
	RemoveTrigger = 169,
	ShowTrigger = 170,
	ArmTrap = 171,
	...
	StartFishing = 174,
	ActivateKillbox = 175,
	FillItemWithReplenishableResource = 176,
	FillItemWithInfiniteResource = 177,
	DrinkFromReplenishableResource = 178,
	WashClothWithReplenishableResource = 179,
	WashClothAllWithReplenishableResource = 180,
	Spill = 181,
	CheckResourceType = 182,
	SetPrivateAccess = 183,
	SetPublicAccess = 184,
	SetRank1Access = 185,
	SetRank2Access = 186,
	SetRank3Access = 187,
	SetRank4Access = 188,
	MusicPlayerTurnOn = 189,
	MusicPlayerPlay = 190,
	MusicPlayerNext = 191,
	MusicPlayerPrevious = 192,
	MusicPlayerShuffle = 193,
	MusicPlayerRepeat = 194,
	MusicPlayerIncreaseVolume = 195,
	MusicPlayerDecreaseVolume = 196,
	MusicPlayerRadio = 197,
	BasicDance1 = 198,
	BasicDance2 = 199,
	BasicDance3 = 200,
	BasicDance4 = 201,
	...
	TradeSell = 211,
	OpenBankAccount = 212,
	Withdraw100Money = 213,
	Withdraw250Money = 214,
	Withdraw1000Money = 215,
	Deposit100Money = 216,
	Deposit250Money = 217,
	Deposit1000Money = 218,
	DepositAllMoney = 219,
	EInteractionType_MAX = 220,
};
...
enum class ECharacterActionConstraint : uint8_t {
	...
	ProneInOut = 4,
	Lean = 5,
	ECharacterActionConstraint_MAX = 6,
};
...
enum class EBackgroundInteractionType : uint8_t {
	...
	Parting = 4,
	Angry = 5,
	GreetingSpecialOffer = 6,
	Num = 7,
	EBackgroundInteractionType_MAX = 8,
};
...
enum class EPrisonerMountFlags : uint8_t {
	None = 0,
	HasMountedSlot = 1,
	UnmountWithAnimation = 2,
	ShouldHideAttachedItems = 3,
	EPrisonerMountFlags_MAX = 4,
};
...
enum class EEquipmentMeshComponent : uint8_t {
	...
	Count = 24,
	EEquipmentMeshComponent_MAX = 25,
};
...
enum class ECharacterActionNotifyType : uint8_t {
	...
	DestroyParticles = 26,
	StartFire = 27,
	ECharacterActionNotifyType_MAX = 28,
};
...
enum class EWidgetType : uint8_t {
	...
	InventoryPanelSideLayerWidget = 49,
	ItemWidget2 = 50,
	ItemWidget2VicinityContainer = 51,
	ItemTooltipWidget = 52,
	TooltipPanelFoodOverview = 53,
	TooltipPanelFoodNutritionsSingle = 54,
	TooltipPanelFoodNutritionsFull = 55,
	TooltipPanelFoodGraphs = 56,
	TooltipPanelWeaponAbsolute = 57,
	TooltipPanelWeaponRelative = 58,
	StatisticsListRow = 59,
	RewardItemWidget = 60,
	ThrowingQuickAccessMenu = 61,
	ItemSplitWidgetClass = 62,
	EWidgetType_MAX = 63,
};
...
enum class EPrisonerNearbyFoliageType : uint8_t {
	...
	Tree = 1,
	Bush = 2,
	EPrisonerNearbyFoliageType_MAX = 3,
};
...
enum class EPlacementAllowedStatus : uint8_t {
	...
	NotAllowedNotSnapping = 20,
	NotAllowedCantPlaceAtLocation = 21,
	NotAllowedLocationMask = 22,
	NotAllowedLocationDupFlag = 23,
	NotAllowedLocationEnemyFlag = 24,
	NotAllowedLocationFoundation = 25,
	NotAllowedLocationOtherElement = 26,
	NotAllowedLocationNoBase = 27,
	NotAllowedLocationNoFlag = 28,
	NotAllowedLocationMaxInstances = 29,
	NotAllowedEnemyFlag = 30,
	NotAllowedBaseBuildingMask = 31,
	NotAllowedInBuilding = 32,
	NotAllowedActorTag = 33,
	NotAllowedVehicleCorpse = 34,
	NotAllowedPointsTooClose = 35,
	NotAllowedTwoPointsConstaints = 36,
	NotAllowedHeightDifference = 37,
	NotAllowedTopSweep = 38,
	NotAllowedMidSweep = 39,
	NotAllowedTilesNotGrounded = 40,
	NotAllowedPlacedDistance = 41,
	NotAllowedUnknown = 42,
	EPlacementAllowedStatus_MAX = 43,
};
...
enum class EElementSnapMarkerSocketType : uint8_t {
	...
	EmptySocket14 = 15,
	EmptySocket15 = 16,
	EElementSnapMarkerSocketType_MAX = 17,
};
...
enum class EGameResourceConsumptionMethod : uint8_t {
	Eating = 0,
	Drinking = 1,
	EGameResourceConsumptionMethod_MAX = 2,
};
...
enum class ECustomZoneEventHandlingMethod : uint8_t {
	...
	Allow = 1,
	Block = 2,
	ECustomZoneEventHandlingMethod_MAX = 3,
};
...
enum class SortByTypes : uint8_t {
	NewEnumerator0 = 0,
	NewEnumerator1 = 1,
	NewEnumerator2 = 2,
	SortByTypes_MAX = 3,
...
enum class EMultiplayerDisabledReason : uint8_t {
	...
	MasterServerHandshakePending = 3,
...
enum class ECharacterActionTerminatingEvent : uint8_t {
	...
	ToolUnavailable = 2,
	FirePressed = 3,
	ECharacterActionTerminatingEvent_MAX = 4,
};
...
enum class EPrisonerUIAffectsSectionName : uint8_t {
	None = 0,
	Affects = 1,
	AffectedBy = 2,
	CausedBy = 3,
	Count = 4,
	EPrisonerUIAffectsSectionName_MAX = 5,
};
...
enum class BorderSizes : uint8_t {
	NewEnumerator0 = 0,
	NewEnumerator1 = 1,
	NewEnumerator2 = 2,
	BorderSizes_MAX = 3,
...
enum class EPrisonerAnimationCurve : uint8_t {
	...
	Count = 26,
	EPrisonerAnimationCurve_MAX = 27,
};
...
enum class EPrisonerFirstPersonSubview : uint8_t {
	...
	Count = 17,
	EPrisonerFirstPersonSubview_MAX = 18,
};
