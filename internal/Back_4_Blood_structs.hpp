...
struct FGameplayEval_HitReactionWeakSpot {
...
struct FScenarioHeroEval_PathDistance {
	float MaxRange; // 0x40
...
struct FDialogueResponseGroupRow {
...
struct FNetGameplayEffectArray {
...
struct FGameplayEval_MatchState {
...
struct FAIDataProviderGameplayTagQueryContainerValue {
...
struct FCustomDataProviderAkAudioEventArray {
...
struct FCharacterCustomizationRow {
...
struct FGameplayEval_ClingLocation {
...
struct FCustomDataProviderGameplayTagContainer {
...
struct FAddSessionToPoolFilteredData {
...
struct FCustomDataProviderVector2D {
	FVector2D Value; // 0x4
};
...
struct FGameplayEval_HitReactionDamageAmount {
	float Damage; // 0x48
...
struct FGameplayEval_IsCrouching {
...
struct FWeaponSoundCollectionRow {
...
struct FHeroLedgeHangLocations {
	bool bIsValid; // 0x8
...
struct FGobiNavLinkInstanceData {
...
struct FGameplayEval_ClosestCharacter {
...
struct FGameplayEval_IsUsingItem {
...
struct FAISpawnEval_RotatingCooldown {
...
struct FGameplayEval_ActorClass {
...
struct FGameplayEval_IsGameModeClassification {
...
struct FCinematicSubtitleTimingRow {
	FText Speaker; // 0x8
	FText Subtitle; // 0x20
...
struct FGameplayEval_CanUseUsable {
...
struct FGameplayEval_IsHeroPreviousLifeState {
...
struct FGameplayEval_PlayerStaminaState {
...
struct FDialogueResponseVariantRow {
...
struct FAISpawnEval_CheckCardTags {
...
struct FGameplayEval_SelectedItemAnimationStance {
...
struct FGameplayModTagDisplayPolicy {
...
struct FGameplayEval_DamageAmount {
	float Damage; // 0x48
	FAIDataProviderFloatValue DamageAmount; // 0x50
	bool bAsPercent; // 0x88
	ECompareOp CompareOperation; // 0x89
...
struct FPlayerProfileTableRedirectionRow {
	FName TablePath; // 0x8
};

struct FGameplayEval_HitReactionBone {
...
struct FSafeRoomVendorCondition {
...
struct FUnlockStartingLocationCommand {
	FName MapSlug; // 0x8
...
struct FTrackRecentCharacterCommand {
...
struct FHealthPercentCondition {
	bool bRequired; // 0x28
...
struct FScenarioEval_PacingPhase {
...
struct FGameplayEval_HasHeroTeammate {
	FDataTableRowHandle HeroTeammate; // 0x48
};

struct FAnimEval_MontageLength {
...
struct FGobiGameCoachEval_Health {
	float TestHealthPercent; // 0x48
	bool bCheckTempHealth; // 0x4c
	ECompareOp CompareOperation; // 0x4d
};
...
struct FCutsceneDefinitionRow {
	FCutsceneDefinition CutsceneDefinition; // 0x8
};

struct FZombieMutationGameplayCardRow {
...
struct FGameplayEval_HeroHealthState {
	bool bIsRangeCheck; // 0x48
...
struct FCustomDataProviderAnimSequence {
...
struct FGameplayEval_PounceTrace {
...
struct FWeaponCustomizationRow {
	FText DisplayName; // 0x8
	FText Description; // 0x20
	EItemQuality Quality; // 0x38
...
struct FBadgeEmblemRow {
	FText Name; // 0x8
	UTexture2D* Emblem; // 0x20
};

struct FCustomDataProviderFNameArray {
	TArray<FName> Value; // 0x8
};

struct FNPCMissionDataRow {
...
struct FCustomDataProviderFloat {
	float Value; // 0x4
};
...
struct FCompleteAchievementCommand {
...
struct FTableOfGameplayCardTablesRow {
...
struct FDialogueEventDefinitionRow {
...
struct FAISpawnEval_CheckGameModeTags {
...
struct FGameplayEval_NavCastDistance {
...
struct FGameplayEval_MantleHeight {
...
struct FGobiGameCoachEval_IsInSafeRoom {
...
struct FGameplayEval_NearbyCharacters {
...
struct FCustomDataProviderInt32 {
	int32_t Value; // 0x4
};
...
struct FGameplayEval_HasHeroTeammateInLifeState {
...
struct FAdjustStatValueCommand {
...
struct FCustomDataProviderFloatCurve {
...
struct FAdjustSupplyPointsCommand {
	int32_t Delta; // 0x8
};
...
struct FGameplayEval_DirectorPacingPhase {
...
struct FAdjustConsumableQuantityCommand {
	FDataTableRowHandle Product; // 0x8
	int32_t Delta; // 0x28
};
...
struct FGameplayEval_CurrentMap {
...
struct FGameplayEval_HitReactionHealth {
	float TestHealthPercent; // 0x48
...
struct FLootSystemMapChainConfig {
...
struct FMissionObjectiveCondition {
...
struct FGameplayEval_MantleDepth {
...
struct FAkPellegrinoAdvancedInitializationSettings {
	uint32_t ACPBatchBufferSize; // 0x38
	bool UseHardwareCodecLowLatencyMode; // 0x3c
};
...
struct FDialogueEval_CheckTargetLastDamagedBy {
...
struct FGameplayEval_OverlapActor {
...
struct FWeakSpotAttachmentTuning {
...
struct FAISpawnEval_PacingPhaseTime {
	float RemainingTimePct; // 0x40
	ECompareOp Op; // 0x44
};

struct FGameplayEval_DamageRange {
...
struct FTriggerHordeTuning {
	float Cooldown; // 0x8
	TArray<UAnimMontage*> Montages; // 0x10
};

struct FCustomDataProviderFName {
	FName Value; // 0x4
};
...
struct FDialogueEval_IsInSaferoom {
...
struct FAnimNode_DistanceMatching {
	float Distance; // 0x78
...
struct FAISpawnEval_PacingPhase {
	char RequiredPacing; // 0x40
	ECompareOp Op; // 0x41
};
...
struct FCustomDataProviderVector {
	FVector Value; // 0x4
};
...
struct FAISpawnEval_CheckCharacterTags {
	int32_t TestValue; // 0x40
	ECompareOp Op; // 0x44
...
struct FGameplayEval_SpeedRange {
...
struct FGameplayEval_ReviveSource {
...
struct FAISpawnEval_ChanceByDifficulty {
...
struct FAISpawnEval_InViewOfSafeRoom {
...
struct FScenarioEval_HeroPathDistance {
	float MaxRange; // 0x40
...
struct FGameplayEval_HasPounceTarget {
...
struct FDirectorCardWeightsRow {
...
struct FAISpawnEval_TimeSinceLastHorde {
...
struct FDialogueEval_SpeakerDistanceToTarget {
...
struct FAISpawnEval_GrowingChanceByDifficulty {
...
struct FGameplayEval_ReachedClimbLocation {
...
struct FGameplayEval_DamageWeakSpot {
	EPhysicalSurface WeakSpotSurface; // 0x48
...
struct FGameplayEval_ClingAttached {
...
struct FGameplayEval_IsSpeakerAvailable {
...
struct FAnimNode_FocusTracking {
...
struct FGameplayEval_GameplayTags {
	UAnimContext_Actor* Actor; // 0x48
...
struct FDialogueEval_CheckLastResponse {
	bool bCheckTarget; // 0x48
...
struct FGameplayEval_LeapVelocityPitch {
	float IdealPitch; // 0x48
	float MaxPitchFromIdealPitch; // 0x4c
};

struct FGameplayEval_VelocityPitch {
	float IdealPitch; // 0x48
	float MaxPitchFromIdealPitch; // 0x4c
};
...
struct FAIDataProviderUObjectValue {
...
struct FAnimNode_BlendListByGameplayTag {
...
struct FAnimNode_GobiRandomSequencePlayer {
...
struct FAISpawnEval_PlayerIntensity {
...
struct FGobiGameCoachEval_BotHealth {
	float TestHealthPercent; // 0x48
	bool bCheckTempHealth; // 0x4c
	ECompareOp CompareOperation; // 0x4d
};
...
struct FGameplayEval_MantleRemainingClimbHeight {
	float DesiredRemainingClimbHeight; // 0x48
};

struct FAIDataProviderTraceDataValue {
...
struct FGobiGameCoachEval_TraumaKitState {
...
struct FDialogueEval_InstigatorIs {
...
struct FScenarioEval_AllUsablesUsed {
...
struct FDialoguePriorityRow {
	FString Comments; // 0x8
};

struct FMOTDTiledLayout {
	FText Title; // 0x8
	FText Description; // 0x20
...
struct FAIDataProviderGameplayTagContainerValue {
...
struct FLightingScenarioMapData {
...
struct FGameplayEval_Dismembered {
...
struct FCustomDataProviderMontageArray {
...
struct FGameplayEval_HasContext {
...
struct FAISpawnEval_GrowingChance {
...
struct FEntitlementContentPackageRow {
	TArray<FDataTableRowHandle> Products; // 0x8
};
...
struct FGameplayEval_DamageType {
...
struct FGameplayEval_CheckLastDamagedBy {
...
struct FGameplayEval_CanRupture {
...
struct FAnalyticsGenericAggregationRow {
	FName System; // 0x8
...
struct FGameplayEval_PingTarget {
...
struct FScenarioEval_HerosInVolume {
...
struct FAISpawnEval_CheckGeneratingDeckTags {
	int32_t TestValue; // 0x40
	ECompareOp Op; // 0x44
...
struct FAnimEval_MontageLastPlayed {
	float MaxTime; // 0x48
...
struct FGameplayEval_ClimbLink {
	float MaxStartingDistance; // 0x48
	float MinClimbUp; // 0x4c
	float MaxClimbUp; // 0x50
	float MinTopDistance; // 0x54
...
struct FAISpawnEval_TeamInPreparationArea {
...
struct FUsableInventoryCondition {
...
struct FDialogueEval_IsConversationPlaying {
...
struct FGameplayEval_BlockedByPawn {
...
struct FDialogueEval_CompareLastSpeaker {
...
struct FGameplayEval_DroppedItem {
...
struct FDialogueConversationRow {
	FDialogueConversation Conversation; // 0x8
};

struct FUIMaterialColorRow {
...
struct FGamepadPresetConfigRemapping {
	FName NewInput; // 0x8
	float NewScale; // 0x10
};
...
struct FCinematicDefinitionRow {
...
struct FDialogueEval_ConversationHasPlayed {
...
struct FCustomDataProviderAkAudioEvent {
...
struct FGameplayEval_LineOfSight {
	UAnimContext_Trace* Trace; // 0x48
};

struct FRemoveDeckCommand {
	int32_t DeckId; // 0x8
};
...
struct FGameplayEval_HeroDefinition {
...
struct FAISpawnEval_Difficulty {
...
struct FScenarioEval_TimeSinceActivation {
	float Time; // 0x40
	ECompareOp Op; // 0x44
};

struct FGameplayEval_RandomChanceByTag {
	UAnimContext_Actor* Actor; // 0x48
...
struct FAnimNode_FocusTrackingSequencePlayer {
...
struct FGameplayEval_CommWheelAction {
...
struct FGameplayEval_HasSelectedItem {
	FGameplayTagQuery SelectedItemTag; // 0x48
};
...
struct FAISpawnEval_ScenarioCausedInterruption {
...
struct FDialogueEval_CheckHasGameplayTag {
	bool bCheckTarget; // 0x48
...
struct FGameplayEval_IsHeroLifeState {
...
struct FScenarioHeroEval_FixedScore {
...
struct FAnimNode_FocusTrackingSlot {
...
struct FAISpawnEval_TeamIntensity {
	float IntensityThreshold; // 0x40
	ECompareOp Op; // 0x44
};
...
struct FGameplayEval_MovementMode {
...
struct FAISpawnEval_CheckCharacterTagsByDifficulty {
	FGameplayTagContainer ScenarioCardEvalTags; // 0x40
...
struct FGameplayEval_HasVisibility {
	UAnimContext_Actor* VisibilityTo; // 0x48
	float VisibilityTimeWindow; // 0x50
};

struct FGameplayEval_CheckAmmoReserve {
...
struct FScenarioHeroEval_HeroInVolume {
	FGameplayTag VolumeTag; // 0x40
	TArray<ATriggerVolume*> TriggerVolumes; // 0x48
...
struct FAnimNode_BlendListByGameplayTagQuery {
...
struct FAISpawnEval_TeamInSafeRoom {
...
struct FGameplayEval_FixedScore {
	float FixedScore; // 0x48
};

struct FLipsyncLocalizationRow {
...
struct FScenarioEval_FixedScore {
	float FixedScore; // 0x40
};
...
struct FGameplayEval_RandomChance {
...
struct FGameplayEval_DamageBone {
	FName HitBoneBelow; // 0x48
