...
struct FSFPSMapLabel {
	FText Caption; // 0x0
	int32_t FontSize; // 0x18
...
struct FSFPSMaterialPair {
	UMaterialInterface* Material; // 0x0
	UMaterialInterface* MaterialLow; // 0x8
};
...
struct FSFPSCraftItem {
	FGuid UID; // 0x0
	int32_t CraftItemActorLibraryIndex; // 0x10
	int32_t CraftItemCount; // 0x14
	int32_t CraftTime; // 0x18
	TArray<FSFPSCraftComponent> Components; // 0x20
};
...
struct FSFPSCharacterSpeeds {
	...
	float Swimming_Motionless; // 0x44
	float Swimming_Walk; // 0x48
	float Swimming_Run; // 0x4c
	float Swimming_Sprint; // 0x50
};
...
struct FSFPSCharacterDeadParams {
	FVector DamagePoint; // 0x0
	FVector DamageNormal; // 0xc
	ESFPSItemSubType WeaponType; // 0x18
	FName WeaponClassName; // 0x1c
	ESFPSAmmoType AmmoType; // 0x24
	FVector StartPoint; // 0x28
	ESFPSBone Bone; // 0x34
	float Multiplier; // 0x38
	FSFPSLoginData KillerLoginData; // 0x40
};
...
struct FSFPSDownloadFile {
	ESFPSDownloadFileType Type; // 0x0
	FString Filename; // 0x8
	FString ServerId; // 0x18
	int32_t Index; // 0x28
	bool bFirst; // 0x2c
	bool Blast; // 0x2d
	TArray<FString> Data; // 0x30
};
...
struct FTalkSetStateTable {
	int32_t StateIndex; // 0x0
	int32_t StatePosInSentenceTable; // 0x4
};
...
struct FSFPSCraftComponent {
	int32_t ComponentActorLibraryIndex; // 0x0
...
struct FSFPSMonsterSpawnedInfo {
	USFPSAICharacterSets* CharacterSets; // 0x0
	USFPSAIConfig* AIConfig; // 0x8
	bool bBoss; // 0x10
};
...
struct FSFPSAIParamsStateSearch {
	float MinTime; // 0x0
	float MaxTime; // 0x4
};
...
struct FSFPSHUDChatBoxLabel {
	UTextBlock* Label; // 0x0
};
...
struct FSFPSAchievement {
	ESFPSAchievementType Type; // 0x0
	int32_t MaxValue; // 0x4
	int32_t ClientProgressNotifyValue; // 0x8
	bool bClientFirstProgressNotify; // 0xc
	TArray<FSFPSAchievementItem> NeedItemList; // 0x10
	int32_t CurValue; // 0x20
	TArray<int32_t> CurItems; // 0x28
...
struct FSFPSAICharacterSetsElement {
	USFPSAICharacterSet* Item; // 0x0
	int32_t ChanceWeight; // 0x8
...
struct FSFPSLootItem {
	float Chance; // 0x0
	ASFPSBaseItem* ItemRef; // 0x8
	int32_t MinCount; // 0x10
	int32_t MaxCount; // 0x14
	ASFPSBaseItem* DependedItemRef; // 0x18
	int32_t DependedMinCount; // 0x20
	int32_t DependedMaxCount; // 0x24
};
...
struct FSFPSItemSetElement : FTableRowBase {
	ASFPSBaseItem* Item; // 0x8
	int32_t MinCount; // 0x10
	int32_t MaxCount; // 0x14
	char SkinID; // 0x18
	int32_t ChanceWeight; // 0x1c
	float NormalizedChance; // 0x20
};
...
struct FSFPSCharacterDefaultMeshes {
	ESFPSCharacterDefaultMeshesType Type; // 0x0
	USkeletalMesh* HeadMesh; // 0x8
	UMaterialInterface* BodyMaterial; // 0x10
	UMaterialInterface* BodyMaterialLow; // 0x18
};
...
struct FSFPSTradeItem : FTableRowBase {
	ASFPSBaseItem* ItemClass; // 0x8
	char SkinID; // 0x10
	int32_t Price; // 0x14
	int32_t ReputationPointsPrice; // 0x18
	int32_t SteamcoinsPrice; // 0x1c
};

struct FSFPSDebug_GameplayManager_PatrolPoint {
	FVector Position; // 0x0
	int32_t CurrentWaypoint; // 0xc
	int32_t NextWaypoint; // 0x10
	TArray<FVector> SpawnedMonsters; // 0x18
};
...
struct FSFPSChatItemInfo {
	FSFPSLoginData LoginData0; // 0x0
	FSFPSLoginData LoginData1; // 0x28
	ESFPSChatItemType Type; // 0x50
	FString Msg; // 0x58
};
...
struct FSFPSAIParamsStatePatrol {
...
struct FSFPSActorLibraryItem {
	AActor* Actor; // 0x0
	FName Name; // 0x8
	int32_t Index; // 0x10
	int32_t SteamInventoryCost; // 0x14
};
...
struct FSFPSRegisteredBaseData {
	FVector Center; // 0x0
	int64_t LastAction; // 0x10
	char FreeBaseItemsCount; // 0x18
	char FreeBaseRespawns; // 0x19
	char FreeBaseStashesCount; // 0x1a
};

struct FSFPSSkinData_Wearable : FSFPSSkinData {
	TArray<UMaterialInstance*> HoodShownMaterials; // 0x38
	TArray<UMaterialInstance*> HoodHiddenMaterials; // 0x48
};
...
struct FSFPSWeaponMF_Sight_WeaponSettings {
	FVector CameraOrigin; // 0x0
	FVector CameraOriginSecondary; // 0xc
};
...
struct FSFPSAllPlayersInfoArray : FFastArraySerializer {
	TArray<FSFPSAllPlayersInfo> Players; // 0x108
};
...
struct FSFPSMissionStaticParams {
...
struct FSFPSCharacterProjectileRecord {
	TWeakObjectPtr<AActor> Projectile; // 0x0
	TWeakObjectPtr<AActor> Shooter; // 0x8
	TWeakObjectPtr<AActor> Weapon; // 0x10
	TWeakObjectPtr<AActor> Victim; // 0x18
	TWeakObjectPtr<UPhysicalMaterial> Material; // 0x20
	float Timer; // 0x28
	FVector CreatePos; // 0x2c
	FVector ShooterPos; // 0x38
	FVector DamagePos; // 0x44
	int8_t AmmoNumber; // 0x50
	bool bServerCharacterDamageDone; // 0x51
	bool bServerVehicleDamageDone; // 0x52
	ESFPSBone DamageBone; // 0x53
	bool bHeadShot; // 0x54
};
...
struct FSFPSACSpawnerCharacterGroup {
	USFPSAICharacterSet* CharacterSet; // 0x0
	bool bOptional; // 0x8
};
...
struct FSFPSCharacterCapsuleHalfHeightChangeTimes {
...
struct FSFPSAIParamsSwitchFromPeace {
...
struct FSFPSCraftGroup {
	FText Caption; // 0x0
	UPaperSprite* Icon; // 0x18
	TArray<FSFPSCraftItem> Items; // 0x20
};
...
struct FSFPSTraceParams {
	AActor* TraceActor; // 0x0
	FVector TracePoint; // 0x8
	UPrimitiveComponent* TraceComponent; // 0x18
...
struct FSFPSSkinData_Weapon : FSFPSSkinData {
	UMaterialInstance* MagMaterial; // 0x38
};
...
struct FSFPSServerAdminParams {
	bool bValid; // 0x0
	FString ServerId; // 0x8
	FString ServerAdminID; // 0x18
	FString ServerAdminName; // 0x28
	int32_t ServerPlayersCount; // 0x38
	int32_t ServerPlayersMaxCountGPortal; // 0x3c
	int32_t ServerPlayersMaxCountAdmin; // 0x40
	FString ServerPassword; // 0x48
	bool bServerPasswordValid; // 0x58
	ESFPSServerCameraType ServerCameraType; // 0x59
	bool bServerCameraTypeValid; // 0x5a
	FString ServerRestartList; // 0x60
	bool bServerRestartListValid; // 0x70
	int64_t ServerTime; // 0x78
	int32_t ServerLootSpawnChance; // 0x80
	int32_t ServerSquadMaxSize; // 0x84
	int32_t ServerAdminSlotReserv; // 0x88
	ESFPSServerBattleType ServerBattleType; // 0x8c
	bool bServerBattleTypeValid; // 0x8d
	int32_t ServerInactiveBaseLifeTime; // 0x90
	bool bServerVAC; // 0x94
	int32_t ServerRespawnDeadMarkerDist; // 0x98
	float GameTime; // 0x9c
	float MissionTimeScale; // 0xa0
	bool bMissionTimeScaleValid; // 0xa4
	float EncounterTimeScale; // 0xa8
	bool bEncounterTimeScaleValid; // 0xac
	float AirDropTimeScale; // 0xb0
	bool bAirDropTimeScaleValid; // 0xb4
	float ConvoyTimeScale; // 0xb8
	bool bConvoyTimeScaleValid; // 0xbc
	float HeliCrashTimeScale; // 0xc0
	bool bHeliCrashTimeScaleValid; // 0xc4
	float RoamingTraderTimeScale; // 0xc8
	bool bRoamingTraderTimeScaleValid; // 0xcc
	bool bPatrolEnable; // 0xcd
	bool bDynamicTimeScaleEnable; // 0xce
	float AIDamageMultiplier; // 0xd0
	bool bAIDamageMultiplierValid; // 0xd4
	float AIHealthMultiplier; // 0xd8
	bool bAIHealthMultiplierValid; // 0xdc
	TArray<FSFPSLoginData> Players; // 0xe0
	TArray<FSFPSLoginData> Banned; // 0xf0
	TArray<FSFPSLoginData> Admins; // 0x100
	TArray<FIntVector> StartKit; // 0x110
	FString MOTD; // 0x120
	FString Msg; // 0x130
	int32_t MsgTime; // 0x140
	int32_t BaseStormDropKeyChance; // 0x144
	int32_t BaseStormLifeTime; // 0x148
};
...
struct FSFPSAllBasesInfoArray : FFastArraySerializer {
	TArray<FSFPSAllBaseInfo> Bases; // 0x108
};
...
struct FSFPSAdminItem : FTableRowBase {
	int32_t Index; // 0x8
	ASFPSBaseItem* ItemClass; // 0x10
	char SkinID; // 0x18
};
...
struct FSFPSAIParamsStateCover {
	float MinTime; // 0x0
	float MaxTime; // 0x4
...
struct FSFPSBaseStormData {
	int32_t ID; // 0x0
	int64_t Time; // 0x8
	ESFPSBaseStormType Type; // 0x10
};
...
struct FSFPSMissionVariant {
	ESFPSMissionDifficulty Difficulty; // 0x0
	char MissionTextID; // 0x1
	int32_t MinCount; // 0x4
	int32_t MaxCount; // 0x8
	USFPSItemSetStructSet* RewardSet; // 0x10
};

struct FSFPSStaticItemParams {
	FText ItemName; // 0x0
	FText ItemDesc; // 0x18
	UPaperSprite* Image_63x60; // 0x30
	UPaperSprite* Image_80x60; // 0x38
	UPaperSprite* Image_100x100; // 0x40
	UPaperSprite* Image_338x121; // 0x48
	ESFPSItemType ItemType; // 0x50
	ESFPSItemSubType ItemSubType; // 0x51
	int32_t MaxCount; // 0x54
...
struct FSFPSTradeGroupList {
	TArray<FSFPSTradeGroup> Groups; // 0x0
};

struct FSFPSUnresolvedDeadMarkerInfo {
	FSFPSLoginData LoginData; // 0x0
	FGuid MarkerUID; // 0x28
};
...
struct FSFPSCharacterStairAnimations {
	UAnimMontage* OnStair_Down; // 0x0
	UAnimMontage* OnStair_Up; // 0x8
	UAnimMontage* OffStair_Down; // 0x10
	UAnimMontage* OffStair_Up; // 0x18
};
...
struct FSFPSAIParamsStateGuard {
	bool bAiming; // 0x0
	int32_t CrouchChance; // 0x4
};
...
struct FSFPSSaverCache {
	FString JsonStringMain; // 0x0
	FString JsonStringNoWipe; // 0x10
	FSFPSLoginData LoginData; // 0x20
};
...
struct FSFPSCharacterObstacleAnimations {
	UAnimMontage* Over10; // 0x0
	UAnimMontage* Over30; // 0x8
	UAnimMontage* Over50; // 0x10
	UAnimMontage* Over70; // 0x18
	UAnimMontage* Over90; // 0x20
	UAnimMontage* Over110; // 0x28
	UAnimMontage* Over130; // 0x30
	UAnimMontage* Over150; // 0x38
	UAnimMontage* Over170; // 0x40
	UAnimMontage* Over190; // 0x48
	UAnimMontage* Over210; // 0x50
	UAnimMontage* Over230; // 0x58
	UAnimMontage* Over250; // 0x60
	UAnimMontage* Over270; // 0x68
	UAnimMontage* Over290; // 0x70
	UAnimMontage* On10; // 0x78
	UAnimMontage* On30; // 0x80
	UAnimMontage* On50; // 0x88
	UAnimMontage* On70; // 0x90
	UAnimMontage* On90; // 0x98
	UAnimMontage* On110; // 0xa0
	UAnimMontage* On130; // 0xa8
	UAnimMontage* On150; // 0xb0
	UAnimMontage* On170; // 0xb8
	UAnimMontage* On190; // 0xc0
	UAnimMontage* On210; // 0xc8
	UAnimMontage* On230; // 0xd0
	UAnimMontage* On250; // 0xd8
	UAnimMontage* On270; // 0xe0
	UAnimMontage* On290; // 0xe8
	UAnimMontage* OverWindow10; // 0xf0
	UAnimMontage* OverWindow30; // 0xf8
	UAnimMontage* OverWindow50; // 0x100
	UAnimMontage* OverWindow70; // 0x108
	UAnimMontage* OverWindow90; // 0x110
	UAnimMontage* OverWindow110; // 0x118
	UAnimMontage* OverWindow130; // 0x120
	UAnimMontage* OverWindow150; // 0x128
	UAnimMontage* OverWindow170; // 0x130
	UAnimMontage* OverWindow190; // 0x138
	UAnimMontage* OverWindow210; // 0x140
	UAnimMontage* OverWindow230; // 0x148
	UAnimMontage* OverWindow250; // 0x150
	UAnimMontage* OverWindow270; // 0x158
	UAnimMontage* OverWindow290; // 0x160
};
...
struct FSFPSTradeGroup {
	FText Caption; // 0x0
	UPaperSprite* Icon; // 0x18
	UDataTable* DataTable; // 0x20
...
struct FSFPSCharacterCraftParams {
	int32_t Count; // 0x0
	FName ActorName; // 0x4
	int32_t ActorIndex; // 0xc
};
...
struct FSFPSDebug_GameplayManager_Mission {
	ESFPSMissionState State; // 0x0
	TArray<FVector> Monsters; // 0x8
};
...
struct FSFPSGameplayEventInfoArray : FFastArraySerializer {
	TArray<FSFPSGameplayEventInfo> Items; // 0x108
};
...
struct FComponentPos {
	FVector EnginePos; // 0x0
	FVector TiresPos; // 0xc
	FVector SuspendPos; // 0x18
	FVector StopPos; // 0x24
	FVector WheelsFrontCenterPos; // 0x30
	FVector WheelsBackCenterPos; // 0x3c
	FVector ExhaustPipePos; // 0x48
};
...
struct FSFPSAIParamsLookAround {
	float WaitMin; // 0x0
	float WaitMax; // 0x4
	int32_t LookAtMin; // 0x8
	int32_t LookAtMax; // 0xc
	float AngleMin; // 0x10
	float AngleMax; // 0x14
};
...
struct FSFPSTalkSentenceElement : FTableRowBase {
	FString Sentence; // 0x8
	float StartTime; // 0x18
	float EndTime; // 0x1c
	int32_t State; // 0x20
	int32_t ChanceWeight; // 0x24
	float NormalizedChance; // 0x28
	USoundBase* SoundBase; // 0x30
};
...
struct FSFPSActorLibraryGroupForSortedByName {
	TArray<FSFPSActorLibraryItem> Items; // 0x0
};

struct FSFPSInventoryHintTimer {
	UObject* Label; // 0x0
	FText Text; // 0x8
	float Timer; // 0x20
};
...
struct FSFPSServerInfo {
	FString Name; // 0x0
	int32_t Ping; // 0x10
	int32_t PlayersCount; // 0x14
	int32_t PlayersMaxCount; // 0x18
	bool Official; // 0x1c
	bool bFavorite; // 0x1d
	int64_t LastTime; // 0x20
	FString URL; // 0x28
	FString IP; // 0x38
	int32_t Index; // 0x48
	bool bValid; // 0x4c
	bool bNeedUpdate; // 0x4d
	bool bPassword; // 0x4e
	ESFPSServerCameraType CameraType; // 0x4f
	ESFPSServerBattleType BattleType; // 0x50
};
...
struct FSFPSSquadInfo {
	FSFPSLoginData LoginData; // 0x0
	FVector Position; // 0x28
	TWeakObjectPtr<AActor> ServerCharacterPtr; // 0x34
};
...
struct FSFPSAdminItemsGroup {
	FText Caption; // 0x0
	UPaperSprite* Icon; // 0x18
	UDataTable* DataTable; // 0x20
};

struct FSFPSLootList {
	FText Caption; // 0x0
	FGuid UID; // 0x18
	TArray<FSFPSLootItem> Items; // 0x28
};
...
struct FDcxVehicleWheelConfiguration {
	FName ParentComponentName; // 0x0
	FVector Offset; // 0x10
	UStaticMesh* CollisionMesh; // 0x20
	bool bUsePresetShape; // 0x28
	FDcxVehicleWheelData WheelData; // 0x2c
	FDcxVehicleSuspensionData SuspensionData; // 0x4c
	UDcxVehicleTire* Tire; // 0x70
	bool bIsDriven; // 0x78
	EDcxVehicleWheelSweep SweepType; // 0x79
};
...
struct FSFPSItemPrice {
	int32_t MoneyPrice; // 0x0
	int32_t ReputationPointsPrice; // 0x4
	int32_t SteamcoinsPrice; // 0x8
	bool bGameplayItem; // 0xc
};
...
struct FSFPSCharacterDefaultBodyMeshes {
	USkeletalMesh* BodyMesh; // 0x0
	USkeletalMesh* LegsMesh; // 0x8
	USkeletalMesh* TorsoMesh; // 0x10
	USkeletalMesh* NoneMesh; // 0x18
};
...
struct FSFPSAIParamsStateAttack {
	int32_t StandUpChance; // 0x0
...
struct FSFPSSkinData {
	ASFPSItemSkin* SkinItem; // 0x0
	TArray<UMaterialInstance*> MeshMaterials; // 0x8
	UPaperSprite* Image_63x60; // 0x18
	UPaperSprite* Image_80x60; // 0x20
	UPaperSprite* Image_100x100; // 0x28
	UPaperSprite* Image_338x121; // 0x30
};
...
struct FSFPSAIParams {
	FSFPSAIParamsLookAround LookAround; // 0x0
	FSFPSAIParamsLookAround AggroLookAround; // 0x18
	FSFPSAIParamsStatePatrol Patrol; // 0x30
	FSFPSAIParamsStateGuard Guard; // 0x34
	FSFPSAIParamsStateCover Cover; // 0x3c
	FSFPSAIParamsStateAttack Attack; // 0x58
	FSFPSAIParamsStateSearch Search; // 0x84
	FSFPSAIParamsSwitchFromPeace SwitchFromPeace; // 0x8c
};
...
struct FSFPSDebug_GameplayManager_Patrol {
	TArray<FVector> Waypoints; // 0x0
	TArray<FSFPSDebug_GameplayManager_PatrolPoint> PatrolPoints; // 0x10
};
...
struct FSFPSItemStruct {
	int32_t ActorLibraryIndex; // 0x0
	int32_t Count; // 0x4
	char SkinID; // 0x8
	char AmmoCount; // 0x9
};

struct FSFPSBaseItemComponent {
	int32_t ComponentActorLibraryIndex; // 0x0
	int32_t Count; // 0x4
};
...
struct FSFPSMissionStaticParamsList {
	TArray<FSFPSMissionStaticParams> Missions; // 0x0
};
...
struct FSFPSLoggedCharacterRecord {
	FSFPSLoginData LoginData; // 0x0
	int64_t CreateTime; // 0x28
};
...
struct FSFPSActorLibraryGroup {
	FText Caption; // 0x0
	UPaperSprite* Icon; // 0x18
	TArray<FSFPSActorLibraryItem> Items; // 0x20
};
...
struct FSFPSDebug_GameplayManager_LootSpawners {
	int32_t NumTotal; // 0x0
	int32_t NumSpawned; // 0x4
};
...
struct FSFPSSteamInventoryAction {
	int32_t ItemActorLibraryID; // 0x0
	int32_t Count; // 0x4
	TWeakObjectPtr<AActor> EquipItem; // 0x8
	int32_t EquipSlotIndex; // 0x10
	TWeakObjectPtr<AActor> Terminal; // 0x14
	int32_t ActionNumber; // 0x1c
	ESFPSItemSlotType EquipSlotType; // 0x20
};
...
struct FSFPSClientLockPasswordsCache {
	FVector LockActorPosition; // 0x0
...
struct FSFPSDecalData {
	UMaterialInterface* DecalMaterial; // 0x0
	float DecalMinSize; // 0x8
	float DecalMaxSize; // 0xc
	float HeightOverlay; // 0x10
	float LifeTime; // 0x14
};
...
struct FSFPSMetabolismParams {
	float Health; // 0x0
	float Food; // 0x4
	float Water; // 0x8
};

struct FSFPSShotRandomParams {
...
struct FSFPSServerInfoTime {
	FString ServerName; // 0x0
	int64_t LastTime; // 0x10
};
...
struct FSFPSItemSetStruct {
	USFPSItemSet* ItemSet; // 0x0
	int32_t Chance; // 0x8
	int32_t MinRolls; // 0xc
	int32_t MaxRolls; // 0x10
};
...
struct FSFPSDeathLogRecord {
	FDateTime Time; // 0x0
	FSFPSLoginData Killer; // 0x8
	FSFPSLoginData Victim; // 0x30
	FString Weapon; // 0x58
...
struct FSFPSEncounterVariant {
	int32_t MinCount; // 0x0
	int32_t MaxCount; // 0x4
};
...
struct FSFPSServerDamageInfoForEAC {
	uint32_t BoneId; // 0x0
	uint32_t WeaponId; // 0x4
};
