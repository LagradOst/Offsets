...
struct UPortalWarsInviteMenuWidget {
...
struct UPortalWarsRaceMatchResultWidget {
...
struct UPortalWarsChallengeButtonWidget {
...
struct UPortalWarsRoundIntermissionWidget {
...
struct UPortalWarsChallengeCompleteEntry {
...
struct APortalWarsBaseGameState {
...
struct UPortalWarsPlaylistEntryWidget {
...
struct UPortalWarsKillcamWidget {
...
struct UPortalWarsDamageNumberEntryWidget {
...
struct UPortalWarsGamepadSettingsWidget {
...
struct UPortalWarsCustomGameFiltersWidget {
...
struct UPortalWarsLobbyPlayerEntryWidget {
...
struct UPortalWarsCurrencyPurchaseDialog {
...
struct UPortalWarsDropIndicatorWidget {
	UTextBlock* DropsText; // 0x260
	bool bHideWhenEmpty; // 0x26c
};

struct UPortalWarsKillStackEntryWidget {
	UWidgetAnimation* FadeInAnimation; // 0x268
	UWidgetAnimation* FadeOutAnimation; // 0x270
...
struct UBTTask_UsePortal {
	float Timeout; // 0x70
};

struct UPortalWarsMapSelectorWidget {
...
struct UPortalWarsReticleWidget {
...
struct UPWTutorialHUDOverlayWidget {
...
struct UPortalWarsStatsEntryWidget {
...
struct UPortalWarsRankLeaderboardWidget {
...
struct UPortalWarsReplayPlayerWidget {
...
struct APortalWarsTeabagConfirmed {
...
struct UPortalWarsGamepadBindingActionWidget {
...
struct UPWTutorialStepEntryWidget {
...
struct UPortalWarsRoundResultWidget {
...
struct UPortalWarsLeaderboardsWidget {
...
struct UPortalWarsRecentPlayersWidget {
...
struct UPortalWarsPortalIndicatorWidget {
...
struct UPortalWarsNotificationOverlayWidget {
...
struct UPortalWarsServerEntryWidget {
...
struct UPortalWarsHostMenuWidget {
...
struct UPortalWarsTutorialStepsWidget {
...
struct UPortalWarsProgressRadialWidget {
...
struct UPortalWarsNotificationEntryWidget {
...
struct UEnvQueryGenerator_PathGridOffset {
...
struct APortalWarsLobbyPlayerController {
...
struct UPortalWarsMessageDialogWidget {
...
struct UPortalWarsContaminationHUDOverlayWidget {
...
struct UPortalWarsIndicatorWidget {
...
struct APortalWarsVIPPlayerState {
...
struct UPortalWarsIntroVideoWidget {
...
struct UPortalWarsWaitingAreaHUDWidget {
...
struct UPortalWarsPickupZoneIndicator {
...
struct UPortalWarsRadioGroupWidget {
...
struct UPortalWarsTeamSelectWidget {
	int32_t Value; // 0x3a0
...
struct UPortalWarsAddFriendsWidget {
...
struct UPortalWarsRankLeaderboardEntry {
...
struct UPortalWarsNewsFeedEntryWidget {
	UTextBlock* DescriptionText; // 0x420
	UImage* NewsImage; // 0x428
};

struct UPortalWarsLobbySelectorButtonWidget {
	UImage* DisplayImage; // 0x428
...
struct UPortalWarsLoginMenuWidget {
...
struct UPortalWarsVIPHUDOverlayWidget {
...
struct UPortalWarsGoalIndicatorWidget {
	UWidget* Pointer; // 0x2b8
...
struct UPortalWarsTakedownVIPPlayerStatusWidget {
...
struct UPortalWarsLineupAnimInstance {
...
struct UPortalWarsKillFeedEntryWidget {
...
struct APortalWarsLineUpCharacter {
...
struct UPortalWarsContaminationPlayerStatusWidget {
...
struct UPortalWarsAmmoCounterWidget {
...
struct UPortalWarsNewsFeedWidget {
...
struct UBTService_StuckMonitor {
...
struct APortalWarsMediaSoundActor {
...
struct APortalWarsTutorialCharacter {
...
struct UPortalWarsMenuCarouselWidget {
...
struct APortalWarsContamination {
...
struct UPortalWarsPrivacySettingsWidget {
...
struct UPortalWarsReplaysWidget {
...
struct UPortalWarsFriendsListSubWidget {
	UPortalWarsButtonWidget* RefreshButton; // 0x340
...
struct UPortalWarsEmoteWheelWidget {
...
struct APortalWarsGGPlayerState {
...
struct UPortalWarsOutOfBoundsWidget {
...
struct UPortalWarsDropdownWidget {
...
struct UPortalWarsLeaderboardEntryWidget {
...
struct UPortalWarsRedeemKeyDialogWidget {
...
struct UPortalWarsModeSelectorWidget {
...
struct UPortalWarsLoadingScreenWidget {
...
struct UPortalWarsEscapeMenuWidget {
...
struct UPortalWarsItemShopInspectWidget {
...
struct UPortalWarsEvolutionHUDOverlayWidget {
...
struct UPortalWarsChallengesWidget {
...
struct UPortalWarsBlockedPlayersWidget {
	UPortalWarsButtonWidget* RefreshButton; // 0x340
...
struct UPortalWarsBPRedeemableButton {
...
struct UPortalWarsFlagIndicatorWidget {
	UWidget* Pointer; // 0x2b8
...
struct UPortalWarsPlaylistCrossplayDialogWidget {
...
struct UPortalWarsGGHUDOverlayWidget {
...
struct UPortalWarsHillIndicatorWidget {
	UWidget* Pointer; // 0x2b8
...
struct APortalWarsContaminationHUD {
...
struct UAmmoCounterWidgetComponent {
	UPortalWarsAmmoCounterWidget* AmmoCounterWidget; // 0x5a0
	float TickInterval; // 0x5b0
};

struct UPortalWarsTutorialVideoReminderWidget {
...
struct UPortalWarsPostGamePlayerEntry {
...
struct UPortalWarsMKBSettingsWidget {
...
struct UPortalWarsRewardEntryWidget {
...
struct UPortalWarsRaceLeaderboardEntry {
	UTextBlock* TimeText; // 0xbd8
};

struct UBTTaskNode_FindNearbyPortalWall {
...
struct UPortalWarsCurrencyStoreWidget {
...
struct UPortalWarsKOTHHillStatusWidget {
...
struct UPortalWarsChallengesSubWidget {
...
struct UPortalWarsNavBarWidget {
...
struct UPortalWarsGameSessionReconnectDialog {
...
struct UPortalWarsFlagResetStatusWidget {
...
struct UPortalWarsPostGameStatsWidget {
...
struct UPortalWarsPickupWidget {
	UWidget* Root; // 0x2a8
...
struct UPortalWarsUnlockNoteEntryWidget {
...
struct UPortalWarsHappyHourStatusWidget {
...
struct UPortalWarsReplayHUDOverlayWidget {
...
struct UPortalWarsGamepadBindingCustomizeButtonWidget {
...
struct UPortalWarsGamepadBindingMissingDialogWidget {
...
struct UPortalWarsPlaylistActiveDialog {
	UTextBlock* TitleText; // 0x390
...
struct UPortalWarsRewardReceivedWidget {
...
struct UPortalWarsScoreboardStatEntry {
...
struct AScoreboardScoreComponent {
	char Index; // 0x288
};
...
struct APortalWarsTakedownPlayerState {
...
struct UPortalWarsScoreboardWidget {
...
struct UPortalWarsDOMHillIndicator {
...
struct UPortalWarsNavButtonWidget {
...
struct AEMPExplosiveProjectile {
...
struct UPortalWarsPathFollowingComponent {
...
struct UPortalWarsChallengesInspectWidget {
	UWidget* ItemsRoot; // 0x3c0
	UPortalWarsCustomScrollWidget* ItemsPanel; // 0x3c8
...
struct UPortalWarsCustomSettingsWidget {
...
struct UPortalWarsLockerWidget {
...
struct APortalWarsGrenadePickupZone {
...
struct UBTDecorator_LOSToEnemy {
...
struct UPortalWarsItemShopEntry {
...
struct APortalWarsForcedTeleportTrigger {
...
struct UPortalWarsPostGameLobbyWidget {
...
struct UPortalWarsControllerPresetWidget {
...
struct UPortalWarsDailyPlayStreakWidget {
...
struct UPortalWarsKillcamKilledByWidget {
...
struct UPortalWarsLimitedTimeOfferDialogWidget {
...
struct UPortalWarsPlayButtonWidget {
	UTextBlock* ButtonText; // 0x3c8
};

struct UBTService_RefreshFocus {
...
struct UPortalWarsChallengeEntryWidget {
...
struct UPortalWarsSocialPlayerEntry {
...
struct UPortalWarsItemShopWidget {
...
struct UPortalWarsReferFriendWidget {
...
struct UPortalWarsCareerWidget {
...
struct UPortalWarsCancelButtonWidget {
...
struct UPWProjectileMovementComponent {
...
struct UPortalWarsPlaylistGameModeSelect {
...
struct UPortalWarsTakedownHUDOverlayWidget {
...
struct APortalWarsNavLink_Jump {
...
struct UPortalWarsInputDecoratorWidget {
...
struct UPortalWarsChatEntryWidget {
...
struct UPortalWarsQuitMenuWidget {
...
struct UPortalWarsEmoteWheelWedgeWidget {
...
struct UPortalWarsTeamNumericCarouselWidget {
...
struct UPortalWarsScoreboardPlayerWidget {
...
struct APWTutorialPlayerController {
...
struct UPortalWarsAnimInstance {
...
struct UPortalWarsMedalsWidget {
...
struct UPortalWarsTeamDecimalCarouselWidget {
...
struct UPortalWarsClaimChallengeIndicatorWidget {
...
struct UPortalWarsDropsMenuWidget {
...
struct APortalWarsRaceLobbyGameMode {
...
struct UPortalWarsPlaylistSelectWidget {
...
struct UPortalWarsSettingsSubWidget {
...
struct UPortalWarsRoundHUDOverlayWidget {
...
struct UPortalWarsPriceEntryWidget {
...
struct UPortalWarsAnimInstanceV2 {
...
struct APWReplayPlayerController {
...
struct APortalWarsGunPickupZone {
...
struct UPortalWarsTrainingWidget {
...
struct UPortalWarsNameTagWidget {
...
struct UPortalWarsProgressionUpdateDialogWidget {
...
struct UPortalWarsDamageIndicatorWidget {
	UImage* HitImage; // 0x260
	UMaterialInterface* ThruPortalMaterial; // 0x268
};

struct UPortalWarsLockerButtonWidget {
...
struct UPortalWarsRewardPassEntryWidget {
...
struct UPortalWarsServerBrowserWidget {
...
struct UPortalWarsNetworkInfoWidget {
...
struct UPortalWarsRewardPassWidget {
...
struct UPortalWarsStreamStatusWidget {
...
struct UPortalWarsPlayerCardWidget {
...
struct UPortalWarsFileOptionsDialogWidget {
...
struct UPortalWarsItemShopSectionWidget {
...
struct UPortalWarsStatsPlaylistWidget {
...
struct UPortalWarsWidgetSwitcher {
...
struct UPortalWarsInspectWidget {
...
struct UPortalWarsInspectItemWidget {
...
struct UPortalWarsGameplaySettingsWidget {
...
struct UPortalWarsPlayStreakRewardWidget {
...
struct UPortalWarsTxnDialogWidget {
...
struct UPortalWarsKilledByBannerWidget {
...
struct UPortalWarsRoundScoreboardWidget {
...
struct APortalWarsPostGameState {
...
struct UPortalWarsDOMHUDOverlayWidget {
...
struct UPortalWarsPlayerActionsWidget {
...
struct APortalWarsDOMGameState {
...
struct APortalWarsRoundGameState {
...
struct UPortalWarsGGGunStatusWidget {
...
struct UPortalWarsChallengeDialogWidget {
...
struct UPortalWarsBattlePassEntryWidget {
	UProgressBar* XPProgressBar; // 0x798
	UWidget* FreeIndicator; // 0x7b0
};

struct APortalWarsRaceHUD {
...
struct APortalWarsOddballGameState {
...
struct UPortalWarsCareerProgressWidget {
	UTextBlock* PlayerNameText; // 0x2a8
...
struct UPortalWarsReferralPassWidget {
...
struct UPortalWarsCurrencyStoreEntry {
...
struct UPortalWarsAudioSettingsWidget {
...
struct UPortalWarsSeasonRewardsWidget {
...
struct UPWKillcamTransitionWidget {
...
struct UPortalWarsGamepadSelectWidget {
...
struct UPortalWarsPlayerEntryWidget {
...
struct UPortalWarsPlayStreakDialogWidget {
...
struct UPortalWarsPartyEntryWidget {
...
struct UPortalWarsReplayEntryWidget {
...
struct UPortalWarsVoteEntryWidget {
...
struct UBTDecorator_WeaponCheck {
...
struct UPortalWarsCustomScrollWidget {
...
struct APortalWarsTakedownVIPHUD {
...
struct UPortalWarsCheckInRewardWidget {
...
struct UPortalWarsPickupZoneAnimInstance {
	bool bIsActive; // 0x2b8
	APortalWarsGunPickupZone* PickupZone; // 0x2c0
};

struct UPortalWarsTakedownNotificationWidget {
...
struct UBTDecorator_PortalIsNearTarget {
	float XYRange; // 0x90
...
struct UPortalWarsCheckInDialogWidget {
	UTextBlock* CurrencyText; // 0x3c8
...
struct UBTDecorator_WithinRange {
	FBlackboardKeySelector BlackboardKey; // 0x68
...
struct UPortalWarsDecimalCarouselWidget {
	float Value; // 0x3a0
...
struct UBTService_AssignTarget {
...
struct UPortalWarsXPUpdateWidget {
...
struct UPortalWarsNumericCarouselWidget {
	int32_t Value; // 0x3a0
...
struct UPortalWarsTeamCheckboxWidget {
...
struct UPortalWarsRoundCountdownWidget {
...
struct UPortalWarsPlaySelectionWidget {
...
struct APortalWarsVotingGameState {
...
struct APortalWarsTutorialGameMode {
	TArray<FDefaultInventoryClass> TutorialDefaultInventoryClasses; // 0x6a8
};

struct UPortalWarsCrosshairSelectWidget {
...
struct UPortalWarsMatchResultWidget {
	UTextBlock* TitleText; // 0x260
	UImage* LeftStarImage; // 0x268
	UImage* RightStarImage; // 0x270
	UImage* TopBorderImage; // 0x278
...
struct UPortalWarsTutorialVideoWidget {
...
struct APortalWarsKOTHPlayerState {
...
struct UPortalWarsInputCarouselWidget {
...
struct UPortalWarsLeaderboardWidget {
	UWidgetSwitcher* WidgetSwitcher; // 0x2b8
	UTextBlock* ErrorText; // 0x2c0
...
struct UPortalWarsVideoSettingsWidget {
...
struct UPortalWarsRewardReceivedEntry {
...
struct UPortalWarsRankUpdateWidget {
...
struct UPortalWarsSettingsMenuWidget {
	TArray<UUserWidget*> Widgets; // 0x338
	TArray<UUserWidget*> ConsoleWidgets; // 0x348
};

struct UPortalWarsItemShopPurchasePanel {
	UTextBlock* TitleText; // 0x2a8
...
struct UPortalWarsGameConfigWidget {
	UTextBlock* MapNameText; // 0x260
...
struct UPortalWarsOddballIndicator {
	UWidget* Pointer; // 0x2b8
...
struct UPortalWarsJoinInProgressWidget {
...
struct UPortalWarsRenameReplayDialogWidget {
...
struct UPortalWarsDialogWidget {
...
struct UPortalWarsPostGameOverviewWidget {
...
struct UPortalWarsPickupIndicatorWidget {
...
struct APortalWarsAIController {
...
struct UPortalWarsGateIndicatorWidget {
	UWidget* Pointer; // 0x2b8
...
struct UPortalWarsKeybindWidget {
...
struct APortalWarsTutorialGoal {
...
struct UPortalWarsCustomAntiCheat {
...
struct UPortalWarsButtonWidget {
...
struct UPortalWarsCustomGameWidget {
...
struct UPortalWarsStatsOverviewWidget {
...
struct UPortalWarsIKAnimInstance {
...
struct UPortalWarsRespawnWidget {
...
struct UPortalWarsDailyCheckInWidget {
	UPanelWidget* RewardPanel; // 0x338
...
struct UPortalWarsNameIndicatorWidget {
...
struct UPortalWarsStreakIncreaseWidget {
...
struct UPortalWarsGamepadBindingCategoryWidget {
...
struct APortalWarsLobbyPlayerStart {
...
struct UPortalWarsGamepadBindingOverlayWidget {
...
struct APortalWarsLobbyGameMode {
...
struct UPortalWarsRoundScoreboardEntryWidget {
...
struct UPortalWarsGameUserSettings {
...
struct UPortalWarsPostGameCardWidget {
...
struct UPortalWarsBPPurchaseDialogWidget {
...
struct UPortalWarsScreenFadeWidget {
	UWidgetAnimation* FadeInAnimation; // 0x260
	UWidgetAnimation* FadeOutAnimation; // 0x268
...
struct UPortalWarsMedalEntryWidget {
...
struct UPortalWarsRoundPlayerStatusWidget {
...
struct UPortalWarsLootboxWidget {
...
struct UPortalWarsLockerSubWidget {
...
struct UBTDecorator_HasReceivedKillRecently {
	float MaxTime; // 0x68
};
...
struct APortalWarsNeutralCTFHUD {
...
struct UPortalWarsVotingMenuWidget {
...
struct UPortalWarsKillcamHeaderWidget {
...
struct APortalWarsCTFGameState {
...
struct UPortalWarsCustomLobbyWidget {
...
struct UPortalWarsEvolutionGunStatusWidget {
	UImage* WeaponImage; // 0x2b0
	USizeBox* IconSizeBox; // 0x2b8
};

struct UPortalWarsRaceScoreboardWidget {
	UTextBlock* PlayerNameText; // 0x340
...
struct UPortalWarsBattlePassPanelWidget {
...
struct APortalWarsTakedownVIPPlayerState {
	char bIsVIP : 1; // 0xad0
};
...
struct UPortalWarsDOMHillStatusWidget {
...
struct UPortalWarsDiscardSettingsDialog {
	UPortalWarsButtonWidget* AcceptButton; // 0x3a0
};
...
struct UPortalWarsUnlockDialogWidget {
...
struct UPortalWarsJoinServerDialogWidget {
...
struct UPortalWarsFlagZoneIndicator {
	UWidget* Pointer; // 0x2b8
};
...
struct UPortalWarsReportPlayerWidget {
...
struct UBTDecorator_Probability {
	float SuccessChance; // 0x68
};

struct UPortalWarsModeSelectorEntryWidget {
	UWidget* CustomIndicator; // 0x420
	UPortalWarsButton* EditButton; // 0x680
};

struct UBTDecorator_CheckGameMode {
...
struct UPortalWarsLockerEntryWidget {
...
struct UPortalWarsInventoryWidget {
...
struct UPortalWarsKOTHHUDOverlayWidget {
...
struct UPortalWarsTutorialBookmarkWidget {
	UHorizontalBox* MarksHorizontalBox; // 0x260
	UTexture2D* CurrentMarkTexture; // 0x268
	UTexture2D* IncompleteMarkTexture; // 0x270
	UTexture2D* CompleteMarkTexture; // 0x278
...
struct UPortalWarsColorPickerWidget {
...
struct UPortalWarsSpinSliderWidget {
...
struct UPortalWarsMainMenuWidget {
...
struct UPortalWarsRadarMarkerWidget {
...
struct UPortalWarsCTFHUDOverlayWidget {
...
struct UPortalWarsPausePlayersMenuWidget {
...
struct APortalWarsEvolutionGameState {
...
struct UPortalWarsChallengePanelWidget {
...
struct UPortalWarsPartyInspectWidget {
...
struct UPortalWarsKeybindOverlayWidget {
	UTextBlock* TitleText; // 0x3a0
};
...
struct UPortalWarsRaceHUDOverlay {
...
struct UPortalWarsCheckBoxWidget {
...
struct UPortalWarsProgressionIconWidget {
...
struct UPortalWarsPlaylistGameModeEntry {
	UTextBlock* DescriptionText; // 0x420
	UImage* DisplayImage; // 0x428
...
struct AGunImpactEffectManager {
...
struct UPortalWarsPurchaseButtonWidget {
...
struct UPortalWarsRootHUDWidget {
...
struct APortalWarsNeutralCTFGameState {
	AActor* Flag; // 0x7c8
...
struct UPortalWarsGamepadBindingWidget {
...
struct UPortalWarsHealthWidget {
...
struct UPortalWarsMatchCanceledWidget {
	UTextBlock* CountdownText; // 0x260
};
