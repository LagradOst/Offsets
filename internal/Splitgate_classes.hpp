...
struct UPortalWarsForgeHUDOverlayWidget : UPortalWarsUserWidget {
	UPortalWarsForgeBuildMenuWidget* BuildMenu; // 0x2a8
	UWidgetAnimation* OpenBuildMenuAnimation; // 0x2b0
	UWidget* ControlsDisplay; // 0x2b8
	UWidgetAnimation* OpenControlsDisplayAnimation; // 0x2c0
	UPortalWarsForgeReticleWidget* BuildReticle; // 0x2c8
	UWidgetSwitcher* MoveSpeedSwitcher; // 0x2d0
	UTextBlock* MoveSpeedText; // 0x2d8
	UTextBlock* InteractMoveSpeedText; // 0x2e0
};
...
struct APortalWarsInteractable : ATeleportableActor {
	UStaticMeshComponent* StaticMeshComponent; // 0x230
	UPortalWarsInteractableComponent* InteractableComponent; // 0x238
};
...
struct UPortalWarsForgeMapSelectorWidget : UPortalWarsMapSelectorWidget {
	UPortalWarsButtonWidget* MapOptionsButton; // 0x370
	UPortalWarsMapFileOptionsDialogWidget* MapOptionsDialogClass; // 0x378
};
...
struct APortalWarsLobbyGameState : APortalWarsBaseGameState {
	FMatchSummaryInfo PrevGameData; // 0x7d8
	TArray<APortalWarsLobbyPlayerStart*> PlayerStarts; // 0x938
	TArray<APortalWarsLobbyPlayerStart*> EmptyPlayerStarts; // 0x948
	TArray<APortalWarsLobbyPlayerStart*> NeutralPlayerStarts; // 0x958
	AStaticMeshActor* TVScreen; // 0x968
};

struct UPortalWarsForgeBuildMenuWidget : UPortalWarsMenuWidget {
	UPortalWarsForgeObjectsMenuWidget* ObjectsMenu; // 0x338
	UPortalWarsForgeToolsMenuWidget* ToolsMenu; // 0x340
	UPortalWarsForgeMapMenuWidget* MapMenu; // 0x348
};
...
struct APortalWarsOneFlagCTFHUD : APortalWarsRoundHUD {
	UPortalWarsFlagIndicatorWidget* AlphaTeamIndicator; // 0x440
	UPortalWarsFlagIndicatorWidget* BravoTeamIndicator; // 0x448
	UPortalWarsIndicatorWidget* FlagIndicatorWidgetClass; // 0x450
	UPortalWarsIndicatorWidget* FlagCaptureZoneWidgetClass; // 0x458
};
...
struct UPortalWarsGlobals : UObject {
	...
	UDataTable* ForgeMapRequirements; // 0x558
	UDataTable* ForgeInteractables; // 0x560
	UDataTable* GameModes; // 0x568
	UDataTable* GameModeTypes; // 0x570
	UDataTable* Medals; // 0x578
	UDataTable* RaceDifficulties; // 0x580
	TMap<EChallengeType, UDataTable*> ChallengeTables; // 0x588
	UDataTable* CheckInRewards; // 0x5d8
	UDataTable* PlayStreakRewards; // 0x5e0
	UDataTable* PlayStreakIcons; // 0x5e8
	UDataTable* Progression; // 0x5f0
	UDataTable* ProgressionIcons; // 0x5f8
	UDataTable* BattlePass; // 0x600
	UDataTable* ReferralPass; // 0x608
	TMap<ERewardType, TSoftObjectPtr<UTexture2D>> RewardIcons; // 0x610
	UDataTable* Unlocks; // 0x660
	UDataTable* Ranks; // 0x668
	UDataTable* RankDivisions; // 0x670
	UDataTable* Playlists; // 0x678
	UDataTable* Regions; // 0x680
	UDataTable* MicroTxnPurchasables; // 0x688
	UDataTable* Redeemables; // 0x690
	UDataTable* Announcer; // 0x698
	UDataTable* BotProfiles; // 0x6a0
	UDataTable* CustomBotProfiles; // 0x6a8
	UDataTable* BannedWords; // 0x6b0
	UDataTable* NiceTexts; // 0x6b8
	UDataTable* WeaponReticles; // 0x6c0
	UDataTable* CustomReticles; // 0x6c8
	UTexture2D* DefaultAvatar; // 0x6d0
	TMap<FString, UTexture2D*> PlatformAvatars; // 0x6d8
	UDataTable* Tutorial; // 0x728
	UDataTable* XboxButtons; // 0x730
	UDataTable* PlayStationButtons; // 0x738
	UDataTable* MouseButtons; // 0x740
	UDataTable* Tips; // 0x748
	UDataTable* LockerTips; // 0x750
	UDataTable* WeaponPoses; // 0x758
	TArray<UObject*> AlwaysLoadedSoundBanks; // 0x760
};
...
struct AFlagCaptureZone : AActor {
	...
	AFlagItemPickup* OneFlagPickupClass; // 0x250
	APortalWarsCTFGameState* CTFGameState; // 0x258
	APortalWarsNeutralCTFGameState* NeutralCTFGameState; // 0x260
	APortalWarsOneFlagCTFGameState* OneFlagCTFGameState; // 0x268
};
...
struct APortalWarsNeutralCTFGameState : APortalWarsGameState {
	AActor* Flag; // 0x8b8
	EFlagState FlagState; // 0x8c0
	float CapturedFlagRespawnTime; // 0x8c4
};
...
struct APortalWarsDomination : APortalWarsGameMode {
	int32_t HillTeamScore; // 0x6f0
	int32_t HillCaptureScore; // 0x6f4
	int32_t HillNeutralizeScore; // 0x6f8
};
...
struct UPortalWarsForgeInteractableComponent : UPortalWarsInteractableComponent {
	FForgeInteractableInfo InteractableInfo; // 0xb8
	int32_t FocusStencilValue; // 0xf8
	int32_t HeldStencilValue; // 0xfc
	int32_t ErrorStencilValue; // 0x100
	UCurveFloat* RotateTimelineFloatCurve; // 0x108
	float AngularDistanceForMaxTime; // 0x110
	UTimelineComponent* RotateTimelineComponent; // 0x118
	UCurveFloat* ScaleTimelineFloatCurve; // 0x148
	float ScaleDistanceForMaxTime; // 0x150
	UTimelineComponent* ScaleTimelineComponent; // 0x158
	bool bShouldDisplayIndicator; // 0x179
	FText DisplayText; // 0x180
	FVector IndicatorOffset; // 0x198
	FForgeInteractableRepData InteractableRepData; // 0x1a8
	FTransform Transform; // 0x1c0
	bool bCannotOverlapAnything; // 0x1f0
	UPortalWarsForgeInteractableIndicator* InteractableIndicatorWidget; // 0x1f8
};
...
struct UPortalWarsRaceLobbyWidget : UPortalWarsCustomLobbyWidget {
	UPortalWarsRaceLobbySelectorButtonWidget* DifficultySelectorButton; // 0x388
	UPortalWarsMenuWidget* DifficultyMenuClass; // 0x390
	UPortalWarsRaceLeaderboardWidget* RaceLeaderboard; // 0x398
	UPortalWarsButtonWidget* SwitchLeaderboardButton; // 0x3a0
	UPortalWarsButtonWidget* ToggleCrossPlayButton; // 0x3a8
};
...
struct APortalWarsVIPGameState : APortalWarsGameState {
	TMap<int32_t, APortalWarsPlayerState*> VIPs; // 0x8b8
	TMap<int32_t, APortalWarsPlayerState*> PreviousVIPs; // 0x908
};
...
struct UPortalWarsGamepadSelectWidget : UPortalWarsSettingsSubWidget {
	UPortalWarsTextCarouselWidget* ModeCarousel; // 0x358
	UPortalWarsTextCarouselWidget* GameplayPreset; // 0x360
	UWidgetSwitcher* ControllerSwitcher; // 0x368
	UPortalWarsControllerPresetWidget* XboxButtonLayout; // 0x370
	UPortalWarsControllerPresetWidget* PS4ButtonLayout; // 0x378
	UPortalWarsGamepadBindingMissingDialogWidget* BindingWarningDialogClass; // 0x380
	UPortalWarsGamepadBindingRestoreDialogWidget* BindingDefaultsDialogClass; // 0x388
	UPortalWarsGamepadBindingCustomizeButtonWidget* CustomizeButton; // 0x390
};
...
struct APortalWarsTakedownVIPGameState : APortalWarsTakedownGameState {
	APortalWarsPlayerState* SurvivingVIP; // 0x918
	TMap<int32_t, APortalWarsPlayerState*> VIPs; // 0x920
};
...
struct UPortalWarsForgeToolsMenuWidget : UPortalWarsMenuWidget {
	UWidget* PropertiesRoot; // 0x338
	UPortalWarsButtonWidget* DropToGroundButton; // 0x340
	UPortalWarsTextCarouselWidget* MovementSnapCarousel; // 0x348
	UPortalWarsDecimalCarouselWidget* MovementXCarousel; // 0x350
	UPortalWarsDecimalCarouselWidget* MovementYCarousel; // 0x358
	UPortalWarsDecimalCarouselWidget* MovementZCarousel; // 0x360
	UPortalWarsTextCarouselWidget* RotationSnapCarousel; // 0x368
	UPortalWarsDecimalCarouselWidget* RotationXCarousel; // 0x370
	UPortalWarsDecimalCarouselWidget* RotationYCarousel; // 0x378
	UPortalWarsDecimalCarouselWidget* RotationZCarousel; // 0x380
	UPortalWarsTextCarouselWidget* ScaleSnapCarousel; // 0x388
	UPortalWarsDecimalCarouselWidget* ScaleXCarousel; // 0x390
	UPortalWarsDecimalCarouselWidget* ScaleYCarousel; // 0x398
	UPortalWarsDecimalCarouselWidget* ScaleZCarousel; // 0x3a0
	UPortalWarsForgeCharInteractionComponent* InteractionComponent; // 0x3a8
	UPortalWarsForgeInteractableComponent* InteractableComponent; // 0x3b0
};
...
struct APortalWarsOITC : APortalWarsGameMode {
	bool bAllowAmmoStacking; // 0x6e0
	bool bMeleeRequiredForAmmoStacking; // 0x6e1
	int32_t MaxAmmo; // 0x6e4
};
...
struct APortalWarsForgeGameMode : APortalWarsGameMode {
	APortalWarsForgeBuildCharacter* DefaultBuildPawnClass; // 0x6e0
};
...
struct UPortalWarsForgeCharInteractionComponent : UPortalWarsCharInteractionComponent {
	float MaxRotationPerSecond; // 0xf0
	float MinRotationPerSecond; // 0xf4
	float MaxScalePerSeconds; // 0xf8
	float MinScalePerSeconds; // 0xfc
	float MinTargetArmLength; // 0x100
	float MaxTargetArmLength; // 0x104
	float TargetArmLengthIncreasePerSecond; // 0x108
	float LerpTargetArmLengthSpeed; // 0x10c
	FVector GameplayObjectsResetAreaPosition; // 0x110
	UPortalWarsForgeInteractableComponent* HeldInteractableComponent; // 0x120
	UPortalWarsForgeInteractableComponent* FocusedInteractableComponent; // 0x128
	UAkAudioEvent* GrabSound; // 0x158
	UAkAudioEvent* ReleaseSound; // 0x160
	UAkAudioEvent* DeleteSound; // 0x168
	UAkAudioEvent* InvalidActionSound; // 0x170
};
...
struct APortalWarsDOMGameState : APortalWarsGameState {
	TArray<ADominationHill*> Hills; // 0x8b8
};
...
struct APortalWarsPickup : ATeleportableActor {
	...
	bool bLowerNetUpdateFreqWhenIdle; // 0x24c
...
struct APortalWall : AActor {
	bool validForAI; // 0x220
	bool isDoubleSided; // 0x221
	bool shouldDisableForCTF; // 0x222
...
struct APortalWarsRoundGameState : APortalWarsGameState {
	int32_t CurrentRound; // 0x8b8
	int32_t ReplicatedElapsedServerTime; // 0x8c0
	TArray<int32_t> TeamRoundScores; // 0x8c8
	TArray<int32_t> RoundWinners; // 0x8d8
	ACameraActor* IntermissionCam; // 0x8f0
};
...
struct APortalWarsForgeLobbyGameMode : APortalWarsLobbyGameMode {
	FString ForgeGameModeAlias; // 0x358
};

struct UPortalWarsForgeObjectsMenuWidget : UPortalWarsMenuWidget {
	UPortalWarsButtonWidget* GameplayButton; // 0x338
	UPortalWarsButtonWidget* ObjectsButton; // 0x340
	UPortalWarsButtonWidget* WeaponsButton; // 0x348
	UPortalWarsButtonWidget* SpawnsButton; // 0x350
	UPortalWarsButtonWidget* VolumesButton; // 0x358
	UPortalWarsButtonWidget* ModesButton; // 0x360
	UPortalWarsButtonWidget* PortalWallsButton; // 0x368
	UPortalWarsButtonWidget* BlocksButton; // 0x370
	UPortalWarsButtonWidget* BlockPiecesButton; // 0x378
	UPortalWarsButtonWidget* FloorsButton; // 0x380
	UPortalWarsButtonWidget* RailingsButton; // 0x388
	UPortalWarsButtonWidget* RampsButton; // 0x390
	UPortalWarsButtonWidget* TunnelsButton; // 0x398
	UPortalWarsButtonWidget* WallsButton; // 0x3a0
	UPortalWarsButtonWidget* WedgesButton; // 0x3a8
	UPortalWarsButtonWidget* PropsButton; // 0x3b0
	UPortalWarsButtonWidget* EnvironmentButton; // 0x3b8
};
...
struct UPortalWarsBindingDisplayWidget : UPortalWarsUserWidget {
	UTextBlock* ActionText; // 0x2a8
	UWidgetSwitcher* BindSwitcher; // 0x2b0
	UTextBlock* KeyText; // 0x2b8
	UImage* KeyImage; // 0x2c0
	FString ActionName; // 0x2c8
	bool bIsControllerOnly; // 0x2d8
	bool bIsMKBOnly; // 0x2d9
};
...
struct APortalWarsEvolutionGameState : APortalWarsShowdownGameState {
	TArray<char> TeamInventoryIndexes; // 0x928
};

struct APortalWarsVIP : APortalWarsGameMode {
	TArray<TSoftClassPtr<UObject>> VIPDefaultInventoryClasses; // 0x6e0
	int32_t VIPKillScore; // 0x6f0
	int32_t VIPSuicideScore; // 0x6f4
};

struct APortalWarsVotingGameState : APortalWarsLobbyGameState {
	TArray<APortalWarsVoteInfo*> VoteInfoList; // 0x970
};
...
struct AOneFlagItem : AFlagItem {
	APortalWarsOneFlagCTFGameState* OneFlagCTFGameState; // 0x6d8
};
...
struct APortalWarsExponentialHeightFog : AInfo {
	USceneComponent* SceneRoot; // 0x220
	UExponentialHeightFogComponent* HighQualityFog; // 0x228
	UExponentialHeightFogComponent* LowQualityFog; // 0x230
};
...
struct APortalWarsForgePlayerController : APortalWarsPlayerController {
	float MaxFlySpeed; // 0x6c8
	float MaxInteractFlySpeed; // 0x6cc
	bool bIsBuilding; // 0x760
};
...
struct UPortalWarsSaveGame : USaveGame {
	...
	int32_t ControllerForgePreset; // 0x140
	FControllerKeybindPreset CustomControllerForgeBindings; // 0x148
	bool ShouldShowBlood; // 0x1b9
	int32_t PlayKillcamMode; // 0x1bc
	bool ShouldPlayKillcam; // 0x1c0
	bool ShouldRecordReplay; // 0x1c1
	int32_t ClamberMode; // 0x1c4
	int32_t InputDevice; // 0x1c8
	FLinearColor EnemyColor; // 0x1cc
	FLinearColor EnemyOutlineColor; // 0x1dc
	FLinearColor AllyOutlineColor; // 0x1ec
	FLinearColor AllyColorThroughWalls; // 0x1fc
	bool ShowFPS; // 0x20c
	bool ShowLatency; // 0x20d
	bool ShowPing; // 0x20e
	bool ShowNetInfo; // 0x20f
	bool ShowSubtitles; // 0x210
	bool ShowDamageNumbers; // 0x211
	bool ShowLowAmmo; // 0x212
	bool ShowSprintCrosshair; // 0x213
	TMap<int32_t, int32_t> CustomCrosshairs; // 0x218
	FLinearColor CustomCrosshairColor; // 0x268
	FLinearColor EnemyCustomCrosshairColor; // 0x278
	bool WantsToCrossPlay; // 0x288
	bool bAnonymousMode; // 0x289
	bool bHideNames; // 0x28a
	bool bPartyChatOnly; // 0x28b
	bool bHasCompletedTutorial; // 0x28c
	int32_t TutorialStageID; // 0x290
	bool bHasWatchedIntroVideo; // 0x294
	bool bHasSeenBattlePassDialog; // 0x295
	TArray<FCustomizationId> EquippedCustomizations; // 0x298
	TArray<FCustomizationId> ViewedCustomizations; // 0x2a8
	TSet<FCustomizationCategory> ViewedCustomizationCategories; // 0x2b8
	bool bHasSeenLocker; // 0x308
	TSet<FCustomizationId> PrevNewCustomizations; // 0x310
	bool bHasSyncedNewCustomizations; // 0x360
	TArray<FStoreItemInfo> ViewedStoreItems; // 0x368
	TArray<FString> ViewedLimitedTimeOffers; // 0x378
	TArray<FStoreItemInfo> LastViewedStore; // 0x388
	TArray<FChallengeData> ViewedChallenges; // 0x398
	TArray<FString> MuteList; // 0x3a8
	FDateTime LastLoginTime; // 0x3b8
	FString LoginAuthToken; // 0x3c0
	int32_t PreferredMatchmakingRegionID; // 0x3d0
	int32_t PreferredCustomRegionID; // 0x3d4
	TArray<FString> UnselectedPlaylists; // 0x3d8
	TMap<FString, FPlaylistPreference> PlaylistPreferences; // 0x3e8
	FCustomGameBrowserFilters CustomGamesFilters; // 0x438
	TMap<FString, FGameModeData> CustomGamePresets; // 0x468
	TMap<FString, FForgeMap> ForgeMaps; // 0x4b8
	FString LastGameVersion; // 0x508
};
...
struct APortalWarsGameState : APortalWarsBaseGameState {
	UAnnouncerInterface* AnnouncerInterface; // 0x7c0
	UPortalWarsCustomAntiCheat* AntiCheat; // 0x7c8
	char bTeamGame : 1; // 0x7e8
	TArray<int32_t> TeamScores; // 0x7f0
	TArray<APortalWarsPickup*> Pickups; // 0x870
	TArray<AOutOfBoundsVolume*> OOBVolumes; // 0x880
	TArray<APlayAreaVolume*> PlayAreaVolumes; // 0x890
	APortalWarsCrowd* Crowd; // 0x8a0
	TArray<APortal*> Portals; // 0x8a8
};
...
struct UPortalWarsForgeReticleWidget : UUserWidget {
	UWidgetSwitcher* ReticleSwitcher; // 0x260
};
...
struct APortalWarsLineUpCharacter : AActor {
	APortalWarsPlayerState* PlayerState; // 0x250
	FEndGamePlayerInfo PlayerInfo; // 0x260
	UAnimSequence* EmoteSequence; // 0x498
	UPortalWarsPlayerEntryWidget* PlayerEntryWidgetClass; // 0x4b8
	ECustomizationType CurrentWeaponType; // 0x4d8
	float MinWeaponPosePlayRate; // 0x4e8
	float MaxWeaponPosePlayRate; // 0x4ec
	USceneComponent* SceneRoot; // 0x4f8
	USkeletalMeshComponent* Suit; // 0x500
	USkeletalMeshComponent* Jetpack; // 0x508
	UStaticMeshComponent* PortalGun; // 0x510
	UWidgetComponent* Name; // 0x518
	UMaterialInstance* DefaultMaterial; // 0x520
	UStaticMeshComponent* Weapon; // 0x528
};
...
struct UPortalWarsPlaylistSelectWidget : UPortalWarsMenuWidget {
	TMap<EPlaylistType, UPortalWarsPlaylistEntryWidget*> PlaylistEntryWidgetClasses; // 0x338
	UPanelWidget* PlaylistPanel; // 0x388
	UPortalWarsPlaylistCrossplayDialogWidget* PlaylistCrossplayDialogWidgetClass; // 0x390
	UPortalWarsButtonWidget* PlayButton; // 0x398
	UWidget* SeasonRewards; // 0x3a0
	UTextBlock* NoteText; // 0x3a8
	UWidget* NoteRoot; // 0x3b0
};
...
struct APortalWarsGunPickupZone : APortalWarsGunPickup {
	...
	bool bMaterialDrivenAnimation; // 0x320
	TArray<UMaterialInterface*> ActiveMaterials; // 0x328
	UPortalWarsPickupZoneIndicator* PickupIndicatorWidget; // 0x338
	UPortalWarsAkComponent* AkComponent; // 0x340
	UAkAudioEvent* PlayAmbientLoopEvent; // 0x348
	UAkAudioEvent* StopAmbientLoopEvent; // 0x350
	bool bHidePickupPlatform; // 0x35c
};
...
struct APortalWarsGameMode : APortalWarsBaseGameMode {
	...
	TArray<TSoftClassPtr<UObject>> DefaultInventoryClasses; // 0x670
	bool bAllowReplayRecording; // 0x680
	bool bObjectiveGame; // 0x681
	TArray<FString> RelevantStats; // 0x688
};
...
struct UPortalWarsCharInteractionComponent : UActorComponent {
	float TraceDistance; // 0xb0
	float TraceRadius; // 0xb4
};
...
struct UPortalWarsModeSelectorWidget : UPortalWarsMenuWidget {
	...
	UPortalWarsGameModeFileOptionsDialogWidget* PresetOptionsDialogClass; // 0x378
};
...
struct APortalWarsGG : APortalWarsGameMode {
	TArray<AGun*> WeaponClasses; // 0x6e0
	bool bHumiliationEnabled; // 0x6f0
};
...
struct ARailGun : AMultiKillGun {
	FWeaponAnimMontage ChargeAnim; // 0x788
	FWeaponAnimMontage DischargeAnim; // 0x798
	UAkAudioEvent* ChargeStartEvent; // 0x7a8
	UAkAudioEvent* ChargeStopEvent; // 0x7b0
	UAkAudioEvent* DischargeEvent; // 0x7b8
	UParticleSystem* ChargeFX_1P; // 0x7c0
	UParticleSystem* ChargeFX_3P; // 0x7c8
	UParticleSystemComponent* ChargePSC_1P; // 0x7d0
	UParticleSystemComponent* ChargePSC_3P; // 0x7d8
	float timeToCharge; // 0x7e0
	float BatteryPercentagePerShot; // 0x7e4
	UAmmoCounterWidgetComponent* ChargeCounter; // 0x7e8
};
...
struct APortalWarsForgeGameState : APortalWarsGameState {
	float AutoSaveInterval; // 0x8d8
	UPortalWarsEntryWidget* SaveMessageWidget; // 0x8e8
	UPortalWarsEntryWidget* SaveMessageWidgetClass; // 0x8f0
	TArray<AActor*> BuildLimitAreas; // 0x8f8
	UAkAudioEvent* SaveSuccededSound; // 0x908
	UAkAudioEvent* SaveFailedSound; // 0x910
	bool bPlaySoundOnAutoSave; // 0x918
};
...
struct UPortalWarsForgeInteractableIndicator : UPortalWarsIndicatorWidget {
	UTextBlock* DisplayName; // 0x2b8
};
...
struct UPortalWarsForgeSelectorButtonWidget : UPortalWarsEntryWidget {
	UImage* DisplayImage; // 0x420
	UWidgetSwitcher* SelectedSwitcher; // 0x428
	UTexture2D* BackgroundImage; // 0x430
};
...
struct UPortalWarsForgeBuildNameIndicator : UPortalWarsIndicatorWidget {
	UTextBlock* PlayerNameText; // 0x2b8
};
...
struct APortalWarsGrenadePickupZone : APortalWarsGunPickupZone {
	FText GrenadeName; // 0x360
	UAkAudioEvent* PickupEvent; // 0x378
};
...
struct UPortalWarsMapSelectorEntryWidget : UPortalWarsEntryWidget {
	UPortalWarsButton* EditButton; // 0x538
	UImage* CustomIndicator; // 0x540
};
...
struct APortalWarsTutorialGameMode : APortalWarsGameMode {
	TArray<FDefaultInventoryClass> TutorialDefaultInventoryClasses; // 0x6e0
};
...
struct APortalWarsLobbyGameMode : APortalWarsBaseGameMode {
	APortalWarsLineUpCharacter* LineUpCharacterClass; // 0x340
	ACameraActor* LobbyCam; // 0x348
};
...
struct UPortalWarsRaceDifficultySelectorWidget : UPortalWarsMenuWidget {
	UPanelWidget* ItemsPanel; // 0x338
	UPortalWarsRaceDifficultySelectorEntryWidget* DifficultySelectorEntryClass; // 0x340
	UTextBlock* DifficultyName; // 0x348
	UTextBlock* DifficultyDescription; // 0x350
	UTextBlock* MapName; // 0x358
};
...
struct UPortalWarsOneFlagCTFNotice : UUserWidget {
	UTextBlock* NoticeText; // 0x260
};
...
struct UPortalWarsPauseMenuWidget : UPortalWarsMenuSelectWidget {
	...
	UPortalWarsButtonWidget* SaveMapButton; // 0x3f0
};
...
struct APortalWarsTeabagConfirmed : APortalWarsGameMode {
	APortalWarsTeabagZone* TeabagZoneClass; // 0x6e0
};
...
struct APortalWarsRaceLobbyGameMode : APortalWarsLobbyGameMode {
	FString RaceGameModeAlias; // 0x358
};
...
struct UPortalWarsDecimalCarouselWidget : UPortalWarsInputCarouselWidget {
	...
	bool bShouldWrap; // 0x3b0
	USpinBox* SpinBox; // 0x3b8
};
...
struct UPortalWarsForgeHostMenuWidget : UPortalWarsHostMenuWidget {
	UVerticalBox* MultiplayerSettingsWidget; // 0x378
	UPortalWarsCheckBoxWidget* MultiplayerCheckBox; // 0x380
};
...
struct APortalWarsTakedownVIP : APortalWarsTakedown {
	TArray<TSoftClassPtr<UObject>> VIPDefaultInventoryClasses; // 0x710
	APortalWarsTakedownVIPGameState* TakedownVIPGameState; // 0x720
	int32_t VIPKillScore; // 0x728
};
...
struct APortalWarsForgeHUD : APortalWarsHUD {
	UPortalWarsForgeHUDOverlayWidget* ForgeHUDOverlayWidget; // 0x400
	UPortalWarsForgeHUDOverlayWidget* ForgeHUDOverlayWidgetClass; // 0x408
	UPortalWarsForgeInteractableIndicator* ForgeInteractableIndicatorClass; // 0x410
	UPortalWarsForgeBuildNameIndicator* ForgeBuildNameIndicatorClass; // 0x418
};
...
struct APortalWarsForgeBuildCharacter : ACharacter {
	UPortalWarsForgeCharInteractionComponent* InteractionComponent; // 0x4b8
	USceneComponent* InteractablePlaceholder; // 0x4c0
	USpringArmComponent* SpringArmComponent; // 0x4c8
	FVector NameIndicatorOffset; // 0x4d0
	UPortalWarsIndicatorWidget* NameIndicatorWidget; // 0x4e0
	float BaseTurnRate; // 0x4e8
	float BaseLookUpRate; // 0x4ec
	float MaxMoveSpeed; // 0x4f0
	float MinMoveSpeed; // 0x4f4
	float MaxInteractMoveSpeed; // 0x4f8
	float MinInteractMoveSpeed; // 0x4fc
	float TimeToReachMaxAccel; // 0x500
	float ControllerMaxAccelMultiplier; // 0x504
	float DeleteTime; // 0x528
	UTimelineComponent* InteractionTimelineComponent; // 0x530
	UCurveFloat* UpdateCameraRotationFloatCurve; // 0x538
	AActor* CameraTargetClass; // 0x540
	AActor* CameraTarget; // 0x548
};
...
struct UPortalWarsForgeObjectsMenuEntryWidget : UPortalWarsEntryWidget {
	TSoftClassPtr<UObject> InteractableToSpawnClass; // 0x420
};
...
struct APortalWarsKOTH : APortalWarsGameMode {
	APortalWarsKOTHHill* ActiveHill; // 0x6e0
	APortalWarsKOTHHill* NextHill; // 0x6e8
	APortalWarsKOTHGameState* KOTHGameState; // 0x6f0
	int32_t HillScore; // 0x6f8
	int32_t HillTime; // 0x6fc
	int32_t NextHillTime; // 0x700
	TArray<APortalWarsKOTHHill*> Hills; // 0x710
};
...
struct AOneFlagItemPickup : AFlagItemPickup {
	APortalWarsOneFlagCTFGameState* OneFlagCTFGameState; // 0x320
};
...
struct UPortalWarsGamepadBindingWidget : UPortalWarsUserWidget {
	...
	UPortalWarsGamepadBindingOverlayWidget* ForgeBindingOverlayClass; // 0x370
};
...
struct APortalWarsCTFGameState : APortalWarsGameState {
	AActor* AlphaFlag; // 0x8b8
	AActor* BravoFlag; // 0x8c0
	EFlagState AlphaFlagState; // 0x8c8
	EFlagState BravoFlagState; // 0x8c9
	float CapturedFlagRespawnTime; // 0x8cc
};
...
struct APortalWarsOneFlagCTFGameState : APortalWarsRoundGameState {
	AActor* AlphaFlag; // 0x900
	AActor* BravoFlag; // 0x908
	EFlagState AlphaFlagState; // 0x980
	EFlagState BravoFlagState; // 0x981
	float CapturedFlagRespawnTime; // 0x984
};
...
struct UPortalWarsForgeBuildCharMovementComponent : UCharacterMovementComponent {
	float FlyingFriction; // 0xb10
	UCurveFloat* MoveTimelineFloatCurve; // 0xb20
	float MoveDistanceForMaxTime; // 0xb28
	UTimelineComponent* MoveTimelineComponent; // 0xb30
};
...
struct APortalWarsCharacter : ACharacter {
	...
	float rotateToUprightSpeed; // 0xb70
	char DoRep_collisionProfile; // 0xb74
...
struct APortalWarsRaceGameMode : APortalWarsGameMode {
	UAkAudioEvent* NewRecordEvent; // 0x718
};
...
struct UPortalWarsPlaySelectionWidget : UPortalWarsMenuWidget {
	...
	UPortalWarsButtonWidget* UnrankedButton; // 0x340
	UPortalWarsPlaylistEntryWidget* FeaturedEntry; // 0x348
	UPortalWarsButtonWidget* RankedButton; // 0x350
	UPortalWarsPlaylistSelectWidget* PlaylistSelectWidgetClass; // 0x358
	UPortalWarsButtonWidget* CustomButton; // 0x360
	UPortalWarsCustomGameWidget* CustomMenuWidgetClass; // 0x368
	UPortalWarsButtonWidget* TrainingButton; // 0x370
	UPortalWarsTrainingWidget* TrainingMenuWidgetClass; // 0x378
	UPortalWarsButtonWidget* ForgeButton; // 0x380
	UPortalWarsForgeGameWidget* ForgeMenuWidgetClass; // 0x388
};
...
struct APortalWarsOddballGameState : APortalWarsGameState {
	AActor* Oddball; // 0x8b8
	EBallState OddballState; // 0x8c0
};
...
struct APortalWarsContamination : APortalWarsRoundGameMode {
	TArray<TSoftClassPtr<UObject>> ContaminationDefaultInventoryClasses; // 0x6f8
};
...
struct UPortalWarsMapSelectorWidget : UPortalWarsMenuWidget {
	UPortalWarsMapSelectorEntryWidget* SelectedWidget; // 0x338
	UPanelWidget* ItemsPanel; // 0x340
	UPanelWidget* CustomItemsPanel; // 0x348
	UPortalWarsMapSelectorEntryWidget* MapSelectorEntryClass; // 0x350
	UImage* MapImage; // 0x358
	UTextBlock* MapName; // 0x360
	UTextBlock* MapDescription; // 0x368
};
...
struct UPortalWarsEvolutionGunStatusWidget : UPortalWarsUserWidget {
	UImage* WeaponImage; // 0x2b8
	USizeBox* IconSizeBox; // 0x2c0
	UImage* SecondaryWeaponImage; // 0x2c8
	USizeBox* SecondaryIconSizeBox; // 0x2d0
};
...
struct APortalWarsKOTHGameState : APortalWarsGameState {
	APortalWarsKOTHHill* ActiveHill; // 0x8b8
	APortalWarsKOTHHill* NextHill; // 0x8c0
};
...
struct UPortalWarsOneFlagCTFHUDOverlayWidget : UPortalWarsRoundHUDOverlayWidget {
	UPortalWarsOneFlagCTFNotice* OneFlagCTFNotice; // 0x278
	UPortalWarsOneFlagCTFNotice* OvertimeOneFlagCTFNotice; // 0x280
	UWidgetSwitcher* OvertimeSwitcher; // 0x288
	UWidget* DefenseIcon; // 0x290
	UWidget* OffenseIcon; // 0x298
	UTextBlock* NotificationText; // 0x2a0
	UWidgetAnimation* NotificationFadeAnimation; // 0x2b0
	UPortalWarsFlagResetStatusWidget* FlagResetStatus; // 0x2b8
};
...
struct APortalWarsTakedown : APortalWarsRoundGameMode {
	APortalWarsTakedownGameState* TakedownGameState; // 0x6f0
	int32_t RespawnChangePerKill; // 0x6f8
	int32_t RespawnChangePerDeath; // 0x6fc
	int32_t MinRespawnTime; // 0x700
	int32_t MaxRespawnTime; // 0x704
	int32_t FinalKillScore; // 0x708
};
...
struct APortalWarsEvolution : APortalWarsTakedown {
	TArray<FInventoryClass> InventoryClasses; // 0x710
};
...
struct UPortalWarsTrainingWidget : UPortalWarsMenuWidget {
	...
	UPortalWarsButtonWidget* RaceButton; // 0x348
};
...
struct ABoxOutOfBoundsVolume : AOutOfBoundsVolume {
	UBoxComponent* BoxComponent; // 0x258
};
