...
enum class EPlaySelectionMenuState : uint8_t {
	Main = 0,
	Inspect = 1,
...
enum class ERewardCenterMenuState : uint8_t {
	ReferFriend = 0,
	DailyCheckIn = 1,
	DailyPlayStreak = 2,
	Drops = 3,
...
enum class EPlayerActionsMenuState : uint8_t {
	Main = 0,
	Report = 1,
...
enum class ERewardReceivedState : uint8_t {
	Rewards = 0,
	Inspect = 1,
...
enum class ECareerMenuState : uint8_t {
	Main = 0,
	Stats = 1,
	Leaderboards = 2,
	Replays = 3,
...
enum class EStatsMenuState : uint8_t {
	Overview = 0,
	Social = 1,
	Ranked = 2,
...
enum class EFriendsListMenuState : uint8_t {
	PlatformFriends = 0,
	Friends = 1,
...
enum class EPortalScreenSize : uint8_t {
	None = 0,
	Near = 1,
	Medium = 2,
	Far = 3,
...
enum class ECheckInType : uint8_t {
	Claim = 0,
	Repair = 1,
	ECheckInType_MAX = 2,
};
...
enum class EFriendRequestType : uint8_t {
	Incoming = 0,
	Outgoing = 1,
...
enum class ECommunicationType : uint8_t {
	Voice = 0,
	Text = 1,
...
enum class EFileOptionsState : uint8_t {
	Main = 0,
	SaveAs = 1,
	Rename = 2,
	Delete = 3,
	EFileOptionsState_MAX = 4,
};
...
enum class EPlayMenuState : uint8_t {
	Main = 0,
	Selection = 1,
...
enum class ESettingsMenuState : uint8_t {
	Video = 0,
	Gameplay = 1,
	Gamepad = 2,
	Audio = 3,
...
enum class ECustomizationAvailability : uint8_t {
	Normal = 0,
	Default = 1,
	Challenge = 2,
	Reward = 3,
...
enum class EInviteMenuState : uint8_t {
	Friends = 0,
	RecentPlayers = 1,
	AddFriends = 2,
	Invites = 3,
...
enum class EFuzzyDesirability : uint8_t {
	Undesirable = 0,
	Desirable = 1,
	VeryDesirable = 2,
...
enum class EScrollCenterLocation : uint8_t {
	TopOrLeft = 0,
	Center = 1,
...
enum class ELockerMenuState : uint8_t {
	Main = 0,
	Inspect = 1,
...
enum class EGameModeSelectability : uint8_t {
	None = 0,
	Custom = 1,
	MAX = 2,
};

enum class EServerBrowserState : uint8_t {
	None = 0,
	Searching = 1,
	Succeeded = 2,
	Failed = 3,
...
enum class ERewardReceivedType : uint8_t {
	Drops = 0,
	Challenges = 1,
	BattlePass = 2,
	ReferralPass = 3,
...
enum class EChallengeMenuState : uint8_t {
	Main = 0,
	Inspect = 1,
...
enum class ELootboxMenuState : uint8_t {
	Main = 0,
	Opening = 1,
...
enum class EObjectsMenuState : uint8_t {
	Main = 0,
	Gameplay = 1,
	Objects = 2,
	Weapons = 3,
...
enum class EItemShopMenuState : uint8_t {
	Main = 0,
	Inspect = 1,
...
enum class EKOTHHillState : uint8_t {
	None = 0,
	Uncontrolled = 1,
	Contested = 2,
	AlphaTeamControls = 3,
...
enum class ETxnDialogState : uint8_t {
	Confirmation = 0,
	Processing = 1,
	Success = 2,
	Fail = 3,
...
enum class ERecentPlayersState : uint8_t {
	Succeeded = 0,
	Searching = 1,
	Failed = 2,
...
enum class EPlaylistGameModeType : uint8_t {
	Standard = 0,
	Featured = 1,
...
enum class EPWSoundClass : uint8_t {
	Master = 0,
	Music = 1,
	Gameplay = 2,
	Announcer = 3,
...
enum class EFriendsListState : uint8_t {
	Succeeded = 0,
	Searching = 1,
	Failed = 2,
...
enum class ECustomGameMenuState : uint8_t {
	Browser = 0,
	Host = 1,
	Error = 2,
...
enum class EVotingPriority : uint8_t {
	Normal = 0,
	High = 1,
...
enum class EPurchasableType : uint8_t {
	Currency = 0,
	LimitedTimeOffer = 1,
	Bundle = 2,
	EPurchasableType_MAX = 3,
};
...
enum class EChallengesSubMenuState : uint8_t {
	Main = 0,
	Inspect = 1,
...
enum class EBattlePassPurchaseType : uint8_t {
	Premium = 0,
	PremiumBundle = 1,
	Levels = 2,
...
enum class EPauseMenuState : uint8_t {
	Main = 0,
	Settings = 1,
	Players = 2,
	Quit = 3,
...
enum class EFFAScoreState : uint8_t {
	None = 0,
	Tie = 1,
	Losing = 2,
	Winning = 3,
...
enum class EStoreSectionType : uint8_t {
	Small = 0,
	Medium = 1,
	Big = 2,
	Featured = 3,
...
enum class ECheatViolationType : uint8_t {
	MAX = 0,
};
...
enum class ETakedownState : uint8_t {
	Default = 0,
	OneAllyLeft = 1,
	OneEnemyLeft = 2,
	OneOnOne = 3,
...
enum class EMainMenuWidgetState : uint8_t {
	Play = 0,
	BattlePass = 1,
	Challenges = 2,
	Locker = 3,
...
enum class EWidgetPlatformVisibility : uint8_t {
	AllPlatforms = 0,
	PCOnly = 1,
	ConsoleOnly = 2,
...
enum class ECustomSettingsState : uint8_t {
	Main = 0,
	TeamNames = 1,
	ModeMain = 2,
	BotSettings = 3,
...
enum class ECurrencyStoreState : uint8_t {
	Full = 0,
	Loading = 1,
	Empty = 2,
...
enum class EFriendRequestDialogType : uint8_t {
	AddFriendCode = 0,
	AddFriendId = 1,
...
enum class ELeaderboardsMenuState : uint8_t {
	Ranked = 0,
...
enum class ENiagaraDebugHudSystemVerbosity : uint8_t {
	None = 0,
	Minimal = 1,
	Basic = 2,
	Verbose = 3,
	ENiagaraDebugHudSystemVerbosity_MAX = 4,
};
...
enum class ERegionSelectability : uint8_t {
	Matchmaking = 0,
	Custom = 1,
	MAX = 2,
};
...
enum class ELobbySelectorType : uint8_t {
	Map = 0,
	Mode = 1,
	Settings = 2,
	ELobbySelectorType_MAX = 3,
};
...
enum class ELeaderboardScope : uint8_t {
	Global = 0,
	Friends = 1,
	ELeaderboardScope_MAX = 2,
};
...
enum class EFuzzyConfig : uint8_t {
	Close_High = 0,
	Close_Okay = 1,
	Close_Low = 2,
	Medium_High = 3,
...
enum class EBlockedPlayersState : uint8_t {
	Succeeded = 0,
	Searching = 1,
	Failed = 2,
...
enum class EReportCategory : uint8_t {
	Cheating = 0,
	Exploiting = 1,
	Profile = 2,
	VerbalAbuse = 3,
...
enum class EMapSelectability : uint8_t {
	None = 0,
	Default = 1,
	Race = 2,
	Forge = 3,
...
enum class EControlSettingsMenuState : uint8_t {
	Settings = 0,
	Controls = 1,
...
enum class EModeSelectorState : uint8_t {
	Categories = 0,
	Modes = 1,
	EModeSelectorState_MAX = 2,
};
...
enum class ELeaderboardState : uint8_t {
	Succeeded = 0,
	Searching = 1,
	Failed = 2,
	ELeaderboardState_MAX = 3,
};
...
enum class EControllerMode : uint8_t {
	Default = 0,
	Forge = 1,
	EControllerMode_MAX = 2,
};
...
enum class EItemPreviewType : uint8_t {
	Inspect = 0,
	Locker = 1,
	Lootbox = 2,
...
enum class EToolsMenuState : uint8_t {
	General = 0,
	Movement = 1,
	Rotation = 2,
	Scale = 3,
	EToolsMenuState_MAX = 4,
};
...
enum class EDOMHillState : uint8_t {
	None = 0,
	Uncontrolled = 1,
	AlphaTeamControls = 2,
	BravoTeamControls = 3,
...
enum class ELoginMenuState : uint8_t {
	Welcome = 0,
	Connecting = 1,
	Error = 2,
...
enum class EStoreItemType : uint8_t {
	Customization = 0,
	Bundle = 1,
...
enum class EFuzzyHedge : uint8_t {
	None = 0,
	Fairly = 1,
	Very = 2,
	EFuzzyHedge_MAX = 3,
...
enum class EAddFriendsState : uint8_t {
	Enabled = 0,
	Disabled = 1,
...
enum class EOnlineSessionClientState : uint8_t {
	None = 0,
	CreatingCustom = 1,
	JoiningCustom = 2,
	Matchmaking = 3,
...
enum class ETeamScoreState : uint8_t {
	None = 0,
	Tie = 1,
	AlphaTeamLeads = 2,
	BravoTeamLeads = 3,
...
enum class ENavRecoveryType : uint8_t {
	OffNavMesh = 0,
	OnNavMeshIsland = 1,
