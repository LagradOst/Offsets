...
enum class EMOSpawnSequence : uint8_t {
	Instant = 0,
	Login = 1,
	EnterWorld = 2,
	Hidden = 3,
	AppearFromHidden = 4,
	EMOSpawnSequence_MAX = 5,
};
...
enum class EGatherTypes : uint8_t {
	Gather = 0,
	Mining = 1,
	Lumber = 2,
	MAX = 3,
...
enum class EMovementPace : uint8_t {
	Stopped = 0,
	RotatingStationary = 1,
	Walking = 2,
	Jogging = 3,
	Running = 4,
	Sprinting = 5,
...
enum class EBrokerPanel : uint8_t {
	EBrowsePanel = 0,
	EBuyOrdersPanel = 1,
	EMyMarketPanel = 2,
	ECreateOrdersPanel = 3,
	ESellPanel = 4,
	ESellPetsPanel = 5,
	EBrowseMyPetsPanel = 6,
	EMax = 7,
	EBrokerPanel_MAX = 8,
};
...
enum class EVisualMaterialType : uint8_t {
	EPhysicalObjectType_None = 0,
	EPhysicalObjectType_Living = 1,
	EPhysicalObjectType_Enviorment = 2,
	EPhysicalObjectType_Equipment = 3,
	EPhysicalObjectType_MAX = 4,
};
...
enum class ECachedFacePoseCurveSource : uint8_t {
	None = 0,
	ARKitPoses = 1,
	CustomizationShapes = 2,
	AnyPose = 3,
	ECachedFacePoseCurveSource_MAX = 4,
};
...
enum class EBowConstructionGroup : uint8_t {
	None = 0,
	Self = 1,
	Composite = 2,
	EBowConstructionGroup_MAX = 3,
};
...
enum class ECharacterParticle : uint8_t {
	None = 0,
	BloodSpray = 1,
	BloodSlash = 2,
	BloodPiercing = 3,
...
enum class EExportMode : uint8_t {
	Metre = 0,
	Centimeter = 1,
	EExportMode_MAX = 2,
};
...
enum class EComparitor : uint8_t {
	None = 0,
	GreaterEqualThan = 1,
	LesserEqualThan = 2,
	GreaterThan = 3,
...
enum class EAudioComponentPoolGroup : uint8_t {
	Effects = 0,
	Voice = 1,
	EAudioComponentPoolGroup_MAX = 2,
};
...
enum class EPetEquipmentType : uint8_t {
	None = 0,
	HorseEquipment = 1,
	BearEquipment = 2,
	EPetEquipmentType_MAX = 3,
};
...
enum class EMOTutorialStepGroup : uint8_t {
	Default = 0,
	Combat = 1,
	Crafting = 2,
	EMOTutorialStepGroup_MAX = 3,
};
...
enum class ELogoutZoneRules : uint8_t {
	SafeLogout = 0,
	NormalLogout = 1,
	NoLogout = 2,
	HardInstant = 3,
	NoLogoutCriminal = 4,
	ELogoutZoneRules_MAX = 5,
};
...
enum class EResourceGroup : uint8_t {
	None = 0,
	Bone = 1,
	Carapace = 2,
	Crystal = 3,
...
enum class EEquipmentChangeReason : uint8_t {
...
enum class EAttackAnimationState : uint8_t {
	Idle = 0,
	Charge = 1,
	Hold = 2,
	Release = 3,
...
enum class EAtlasServerHitBoneID : uint8_t {
	None = 0,
	Blocked = 1,
	Parry = 2,
	Mount = 3,
...
enum class EDialogStandingNation : uint8_t {
	Tindremene = 0,
	Sidoian = 1,
	Khurite = 2,
	Sarducaan = 3,
...
enum class EEquipmentQuality : uint8_t {
	Horrible = 0,
	Bad = 1,
	Poor = 2,
	Common = 3,
...
enum class ECombatStyle : uint8_t {
	EClickDrag = 0,
	EDragClick = 1,
	EMovementKeys = 2,
	EMax = 3,
...
enum class EMessageBoxButtons : uint8_t {
	...
	eYesNo = 2,
	eCancel = 3,
	eEditableTextWithOKCancel = 4,
	EMessageBoxButtons_MAX = 5,
};
...
enum class EBloodDecalType : uint8_t {
	Small = 0,
	Large = 1,
	Spray = 2,
	Max = 3,
...
enum class EKeybindPanels : uint8_t {
	EKP_ActionsPanel = 0,
	EKP_ActionBarsPanel = 1,
	EKP_MAX = 2,
};
...
enum class ELevelStreamingGroup : uint8_t {
	None = 0,
	Global = 1,
	GlobalLight = 2,
	TerrainLOD0 = 3,
...
enum class EOptionsPanels : uint8_t {
	EAudioPanel = 0,
	EVideoPanel = 1,
	EKeybindsPanel = 2,
	EChatPanel = 3,
...
enum class EBowShapeGroup : uint8_t {
	None = 0,
	Decurve = 1,
	Flat = 2,
	Recurve = 3,
	EBowShapeGroup_MAX = 4,
};
...
enum class EMODespawnSequence : uint8_t {
	Instant = 0,
	Logout = 1,
	LeaveWorld = 2,
	EMODespawnSequence_MAX = 3,
};
...
enum class EDialogRestrictionType : uint8_t {
	Other = 0,
	Item = 1,
	Race = 2,
	Skill = 3,
...
enum class EFishingSounds : uint8_t {
	ReelinSound = 0,
	ReelIsPulledbyFish = 1,
	ReelThrow = 2,
	FishingRodCreeklow = 3,
	FishingRodCreekMedium = 4,
	FishingRodCreekHard = 5,
	LineStrainLow = 6,
	LineStrainMedium = 7,
	LineStrainHard = 8,
	FishingRodCreekloop = 9,
	EFishingSounds_MAX = 10,
};
...
enum class EProjectileHitResponse : uint8_t {
	BadResponse = 0,
	HitNothing = 1,
	HitEquipmentContinue = 2,
	HitEquipmentStop = 3,
	HitCharacter = 4,
	HitEnvironment = 5,
	MAX = 6,
...
enum class EMOAIAttack : uint8_t {
	None = 0,
	SelfHeal = 1,
	MercyKill = 2,
	MAX = 3,
...
enum class ECharacterAttachedEffectSound : uint8_t {
	None = 0,
	TakeFallDamage = 1,
	Max = 2,
};
...
enum class EDamageSoundType : uint8_t {
	Generic = 0,
	Swing = 1,
	Stab = 2,
	Handle = 3,
...
enum class EDragItemFrom : uint8_t {
	None = 0,
	Container = 1,
	Paperdoll = 2,
	ActionBar = 3,
...
enum class EBowTypeGroup : uint8_t {
	None = 0,
	Asymmetrical = 1,
	Short = 2,
	Long = 3,
...
enum class ENation : uint8_t {
	eNation_None = 0,
	eNation_Tindremene = 1,
	eNation_Sidoian = 2,
	eNation_Khurite = 3,
	eNation_Sarducaan = 4,
	eNation_Kallard = 5,
...
enum class SkillAnimation : uint8_t {
	None = 0,
	Mining = 1,
	Woodcutting = 2,
	Blacksmithing = 3,
...
enum class EEquipmentGroup : uint8_t {
	None = 0,
	Weapon = 1,
	Bow = 2,
	Shield = 3,
...
enum class EMONamedOctagonalDirection : uint8_t {
	Forward = 0,
	ForwardRight = 1,
	Right = 2,
	BackwardRight = 3,
	...
	Left = 6,
	ForwardLeft = 7,
	EMONamedOctagonalDirection_MAX = 8,
};
...
enum class EMagicReleaseType : uint8_t {
	Self = 0,
	Instant = 1,
	Projectile = 2,
	EMagicReleaseType_MAX = 3,
};
...
enum class EArmorSound : uint8_t {
	None = 0,
	Hit = 1,
	FootStep = 2,
	Jump = 3,
...
enum class ECellProperties : uint8_t {
	None = 0,
	Inside = 1,
	Occupied = 2,
	Buildable = 3,
	SafeLogout = 4,
	ECellProperties_MAX = 5,
};
...
enum class EShieldGroup : uint8_t {
	None = 0,
	Buckler = 1,
	Round = 2,
	Kite = 3,
...
enum class EStatisticsUpdate : uint8_t {
	LongtermHealth = 0,
	LongtermStamina = 1,
	LongtermMana = 2,
	Thirst = 3,
...
enum class EMOAIReaction : uint8_t {
	None = 0,
	Hostile = 1,
	Scared = 2,
	Victorious = 3,
...
enum class EEquipmentHitEffect : uint8_t {
	None = 0,
	Generic = 1,
	Block = 2,
	PerfectBlock = 3,
...
enum class EMagicSchools : uint8_t {
	Ecumenical = 0,
	Spiritism = 1,
	Necromancy = 2,
	Elementalism = 3,
...
enum class EPlayerEquipmentSlot : uint8_t {
	None = 0,
	HipLeft = 1,
	HipRight = 2,
	BackLeft = 3,
...
enum class EMOAvatarPathLastCommand : uint8_t {
	Stop = 0,
	Move = 1,
	StopAtP1 = 2,
	StopImmediately = 3,
	Clear = 4,
	EMOAvatarPathLastCommand_MAX = 5,
};
...
enum class EColorEntryType : uint8_t {
	EEyeColor = 0,
	EHairColor = 1,
	ESkinColor = 2,
	EBeardColor = 3,
	ESkinDecorationC = 4,
	EFaceTattooDecoration = 5,
	EBodyTattooDecoration = 6,
	EMax = 7,
	EColorEntryType_MAX = 8,
};
...
enum class EGMTabsPanels : uint8_t {
	ETeleportPanel = 0,
	EVoipChatPanel = 1,
	EUserActionsPanel = 2,
	EQoLPanel = 3,
...
enum class ETattooEffectType : uint8_t {
	ETattoo = 0,
	EPaint = 1,
	EHenna = 2,
	EScarification = 3,
	EScarificationPainted = 4,
	EScarificationPaintedMetal = 5,
	EMud = 6,
	ECoal = 7,
	EMax = 8,
	ETattooEffectType_MAX = 9,
};
...
enum class EMOAvatarVisualLOD : uint8_t {
	Hidden = 0,
	Proxy = 1,
	Minimal = 2,
	Optimized = 3,
...
enum class EPostMeshMergeAction : uint8_t {
	HideSourceComponents = 0,
	DestroySourceComponents = 1,
	EPostMeshMergeAction_MAX = 2,
};
...
enum class ECharacterSound : uint8_t {
	None = 0,
	Pain = 1,
	Death = 2,
	HeavyBreathing = 3,
...
enum class EObjectUse : uint8_t {
	None = 0,
	OpenCraftingMelee = 1,
	OpenCraftingShield = 2,
	OpenCraftingBows = 3,
	OpenCraftingArmor = 4,
	OpenCraftingArrows = 5,
	OpenExtraction = 6,
	OpenRefining = 7,
	OpenSkinning = 8,
	OpenCooking = 9,
	OpenPotionMaking = 10,
	OpenGuildStone = 11,
	OpenCraftingPetEquipment = 12,
	OpenHouseChestOwner = 13,
	OpenHouseChestGuild0 = 14,
	OpenHouseChestGuild3 = 15,
	OpenHouseChestGuild6 = 16,
	OpenHouseChestGuild9 = 17,
	MAX = 18,
};
...
enum class ECharacterCompositionPartType : uint8_t {
	SkeletalMesh = 0,
	StaticMesh = 1,
	ChildActorBlueprint = 2,
	ECharacterCompositionPartType_MAX = 3,
};
...
enum class ECharCreationTattooType : uint8_t {
	EClade = 0,
	ENation = 1,
	EMax = 2,
	ECharCreationTattooType_MAX = 3,
};
...
enum class EJournalPanel : uint8_t {
	EJournalPanel_Entries = 0,
	EJournalPanel_Notes = 1,
	EMax = 2,
	EJournalPanel_MAX = 3,
};
...
enum class ETitlePlacement : uint8_t {
	RightOfName = 0,
	LeftOfName = 1,
	ETitlePlacement_MAX = 2,
};
...
enum class EMOPaperdollActorType : uint8_t {
	None = 0,
	InGame = 1,
	CharacterCreation = 2,
	LoginScreenVista = 3,
	EMOPaperdollActorType_MAX = 4,
};
...
enum class EMOAnimNotifyStateHoldItemState : uint8_t {
	Grab = 0,
	Holster = 1,
	Drop = 2,
	EMOAnimNotifyStateHoldItemState_MAX = 3,
};
...
enum class EMODeathSequence : uint8_t {
	Instant = 0,
	RagdollAndDissolve = 1,
	EMODeathSequence_MAX = 2,
};
...
enum class EBrokerState : uint8_t {
	EBrokerStateItems = 0,
	EBrokerStatePets = 1,
	EMax = 2,
	EBrokerState_MAX = 3,
...
enum class EWeaponDamageType : uint8_t {
	None = 0,
	Slash = 1,
	Blunt = 2,
	Pierce = 3,
...
enum class ELevelStreamingDesiredState : uint8_t {
	Unloaded = 0,
	LoadedHidden = 1,
	Visible = 2,
	MAX = 3,
...
enum class EMessageBoxType : uint8_t {
	...
	eGuildInvite = 15,
	eResurrectPlayer = 16,
	ePaymentPromptMail = 17,
	EMessageBoxType_MAX = 18,
};
...
enum class EMOAnimNodeReport : uint8_t {
	EMOAnimNodeReport_None = 0,
	EMOAnimNodeReport_CombatChargeLeft = 1,
	EMOAnimNodeReport_CombatReleaseLeft = 2,
	EMOAnimNodeReport_CombatChargeRight = 3,
	EMOAnimNodeReport_CombatReleaseRight = 4,
	EMOAnimNodeReport_CombatChargeMiddle = 5,
	EMOAnimNodeReport_CombatReleaseMiddle = 6,
	EMOAnimNodeReport_MAX = 7,
};
...
enum class ECharacterDeaths : uint8_t {
	None = 0,
	SlashingDeath = 1,
	PiercingDeath = 2,
	BluntDeath = 3,
...
enum class EMOAvatarType : uint8_t {
	None = 0,
	Player = 1,
	NPC = 2,
	Environment = 3,
...
enum class EFishingActions : uint8_t {
	Line = 0,
	Hook = 1,
	Tug = 2,
	Landed = 3,
...
enum class EHintAvailabillity : uint8_t {
	Activated = 0,
	Possible = 1,
	ConditionsNotMet = 2,
	Disabled = 3,
	EHintAvailabillity_MAX = 4,
};
...
enum class EClientOpenGFXIndex : uint8_t {
	eNone = 0,
	eLibrary = 1,
	eHelp = 2,
	eGames = 3,
	...
	eCraftTinkering = 91,
	eCraftTailoring = 92,
	eCraftSculpturing = 93,
	eModularBuildingSign = 94,
	eTerritoryLumberjack = 95,
	eThiefBribe = 96,
	eUNUSED_98 = 97,
	eUNUSED_99 = 98,
	eUNUSED_100 = 99,
	eFactionScout = 100,
	eFactionRecruitment_2 = 101,
	eFactionRecruitment_3 = 102,
	eFactionRecruitment_4 = 103,
	EClientOpenGFXIndex_MAX = 104,
};
...
enum class EMOGuildWarState : uint8_t {
	IncomingWar = 0,
	OutgoingWar = 1,
	ActiveWar = 2,
	EMOGuildWarState_MAX = 3,
};
...
enum class EMOMouseHardwareCursorStyle : uint8_t {
	DefaultSmall = 0,
	DefaultMedium = 1,
	DefaultLarge = 2,
	BrightSmall = 3,
...
enum class EHint : uint8_t {
	...
	Rest = 4,
	Sleep = 5,
	DrawWeaponOutOfCombat = 6,
	ShowMouse = 7,
	Sprint = 8,
	StandStillToRegenStamina = 9,
	EquipWeapon = 10,
	AutoRun = 11,
	FollowPillarsWhenDead = 12,
	TooMuchWeight = 13,
	CantDamageOnHaven = 14,
	HavenVendors = 15,
	HavenArmorVendors = 16,
	HavenWeaponVendors = 17,
	HavenReagentVendors = 18,
	HavenPriest = 19,
	HavenCrafting = 20,
	HavenCooking = 21,
	HavenLeaveFaber = 22,
...
enum class EMOCollisionPoolShapeType : uint8_t {
	Sphere = 0,
	Capsule = 1,
	EMOCollisionPoolShapeType_MAX = 2,
};
...
enum class ENetworkedCombatState : uint8_t {
	None = 0,
	BlockThrust = 1,
	BlockRight = 2,
	BlockLeft = 3,
	...
	MeleeCancel = 7,
	MeleeQuickSwing = 8,
	MeleeFullChargeSwing = 9,
	MeleeHardChargeSwing = 10,
	MagicReleasePing = 11,
	MAX = 12,
};
...
enum class EMOMainMenuCameraAssignment : uint8_t {
	Unassigned = 0,
	Main = 1,
	CharacterSelect = 2,
	CharacterCreation = 3,
	CharacterCreationCloseup = 4,
	CharacterCreationFaceCustomization = 5,
	MAX = 6,
};
...
enum class ECombatInputDirection : uint8_t {
	Middle = 0,
	Left = 1,
	Right = 2,
	Up = 3,
	ECombatInputDirection_MAX = 4,
};
