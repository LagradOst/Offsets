...
struct FLevelLoadingStepAnalytics {
...
struct FBloodstoreRowUnlockThreshold {
...
struct FCustomizationBaseAnalytics {
...
struct FAtlantaPerkSelectionAnalytics {
	FString characterName; // 0x18
	int32_t CharacterLevel; // 0x28
	int32_t CharacterPrestigeLevel; // 0x2c
	FString SelectedPerkId; // 0x30
	int32_t SelectedPerkLevel; // 0x40
	bool IsSelectedPerkTeachable; // 0x44
	FString NotSelectedPerkId; // 0x48
	int32_t NotSelectedPerkLevel; // 0x58
	bool IsNotSelectedPerkTeachable; // 0x5c
};
...
struct FAtlantaKillerSoundDistanceData {
...
struct FUniquelyIdentifiedAnalytic {
...
struct FSaveDataV8 {
	...
	TArray<FSavedStatsDataV7> PlayerStatProgression; // 0x2e0
	TArray<FString> OwnedContent; // 0x2f0
	TArray<FSavedSpecialEventDataV7> SpecialEvent; // 0x300
	FLegacySavedBloodWebPersistentData BloodStoreKillers; // 0x310
	FLegacySavedBloodWebPersistentData BloodStoreSurvivors; // 0x350
	TArray<FKeyTupleBool> OnboardingCompleted; // 0x390
	bool IsCrossplayAllowed; // 0x3a0
	bool AutoDeclineFriendInvites; // 0x3a1
	bool HasBeginnerTooltipsBeenDisabledAtLevel; // 0x3a2
	bool ShowPortraitBorder; // 0x3a3
};
...
struct FCharacterAnimationDropdown {
...
struct FEmblemProgressionAnalytics {
	FString MatchID; // 0x98
...
struct FArchiveVignetteVideoAnalytics {
...
struct FCheatExecutedAnalytics {
	FString NetMode; // 0x98
	FString Requester; // 0xa8
	FString Command; // 0xb8
	bool Successful; // 0xc8
};

struct FTexturegroupChartingAnalytics {
...
struct FAtlantaTutorialLevelData {
	FName ID; // 0x8
	FText Title; // 0x18
...
struct FStoreMenuFlowAnalytics {
...
struct FAtlantaSettingMenuData {
...
struct FFallOutOfWorldAnalytics {
	FString MatchID; // 0x98
...
struct FArchiveVignetteEntryAnalytics {
	FString ArchiveId; // 0x98
	FString VignetteId; // 0xa8
...
struct FCrowdChoiceVoteResultAnalytics {
	FString PollId; // 0x98
...
struct FPartyJoinFailureAnalytics {
...
struct Faf_complete_registrationAnalytics {
	FString LoginMethod; // 0x18
};
...
struct FCustomizationLobbyAnalytics {
...
struct FMaterialMapForClip {
	UMaterialInterface* SrcMaterial; // 0x8
	UMaterialInterface* DstMaterial; // 0x10
};

struct FTinkererUndetectableHitNearGeneratorAnalytics {
...
struct FConsoleUserSettings {
	...
	TArray<FInputAxisKeyMapping> AxisMappings; // 0x10
	int32_t MenuScaleFactor; // 0x20
	int32_t HudScaleFactor; // 0x24
	int32_t SkillCheckScaleFactor; // 0x28
	bool LargeText; // 0x2c
	int32_t Gamma; // 0x30
	bool HUDPlayerNamesVisibility; // 0x34
	bool HUDScoreEventsVisibility; // 0x35
	bool HUDKillerHookCountVisibility; // 0x36
	int32_t MainVolume; // 0x38
	int32_t MenuMusicVolume; // 0x3c
	bool UseHeadphones; // 0x40
	bool MuteOnFocusLost; // 0x41
	int32_t KillerMouseSensitivity; // 0x44
	int32_t SurvivorMouseSensitivity; // 0x48
	int32_t KillerControllerSensitivity; // 0x4c
	int32_t SurvivorControllerSensitivity; // 0x50
	bool InvertY; // 0x54
	bool SurvivorInvertY; // 0x55
	int32_t HighestWeightSeenNews; // 0x58
	bool UseAtlantaCustomizedHuds; // 0x5c
	bool UseAtlantaSurvivorQuickTurn; // 0x5d
	bool UseAtlantaKillerQuickTurn; // 0x5e
	TArray<FAtlantaCustomizedHudSettings> AtlantaCustomizedHuds; // 0x60
	bool HasAcceptedCrossplayPopup; // 0x70
	bool HasAcceptedCrossProgressionPopup; // 0x71
	FString PartyPrivacyState; // 0x78
	int32_t ColorBlindMode; // 0x88
	int32_t ColorBlindModeIntensity; // 0x8c
	bool BeginnerMode; // 0x90
	bool Subtitles; // 0x91
	int32_t SubtitlesBackgroundOpacity; // 0x94
	int32_t SubtitlesSize; // 0x98
};
...
struct FSkillCheckViewData {
	FKey InputKey; // 0x0
	float HitAreaStart; // 0x20
	float HitAreaLength; // 0x24
	float BonusAreaStart; // 0x28
	float BonusAreaLength; // 0x2c
	bool IsHexed; // 0x30
	bool IsSpectating; // 0x31
	bool IsReversed; // 0x32
	bool IsMirrored; // 0x33
	bool IsInsane; // 0x34
};

struct FAtlantaOnBoardingData {
...
struct FNewKillerTutorialAnalytics {
...
struct FAtlantaGenericEventUIData {
	TArray<FAtlantaEventElementUIData> elementsUIData; // 0xe8
};

struct FEnvironmentAnalytics {
...
struct FKillerTutorialAnalytics {
	int32_t SecondsSpentInTutorial; // 0x98
	int32_t SecondsSpentInIntroSection; // 0x9c
	int32_t SecondsSpentInChaseSection; // 0xa0
	int32_t SecondsSpentInEscapeSection; // 0xa4
	bool WasLungeAttackObjectiveCompleted; // 0xa8
};
...
struct FPlagueSurvivorAnalytics {
	FString MatchID; // 0x98
...
struct FPreLevelGenerationModifierProperties {
...
struct FSaveGameSummaryCharacterStatsAnalytics {
	FString SavedCharacterStats; // 0x98
};

struct FCannibalAnalytics {
...
struct FMobilePostGameAnalytics {
	int32_t PostGameEarnedBp; // 0x18
	int32_t PostGamePlayerEarnedXp; // 0x1c
	int32_t PostGameCharacterEarnedXp; // 0x20
	FString characterName; // 0x28
	FString ticketId; // 0x38
	FString MatchID; // 0x48
	FString KrakenMatchId; // 0x58
};

struct FErrorAnalytics {
	FString ErrorCategory; // 0x98
	FString LogMessage; // 0xa8
};
...
struct FChainsawEventWhileCamping {
	float DistanceFromClosestHook; // 0x4
};

struct FBloodwebMandatoryContentByLevel {
	int32_t Level; // 0x8
...
struct FTemplateSequenceInstanceData {
...
struct FCharacterDescriptionOverride {
...
struct FOnboardingTutorialDefinition {
...
struct FDBDCustomizationToolData {
	...
	FCustomizationItemData Torso; // 0x318
	FCustomizationItemData Leg; // 0x630
	FCustomizationItemData Bodies; // 0x948
	FString characterName; // 0xc60
	FString RoleName; // 0xc70
	USkeletalMesh* BaseSkeleton; // 0xc80
	UTexture2D* MaskTexture; // 0xc88
	UAnimationAsset* AnimationToPlay; // 0xc90
	FString StrHeadDLC; // 0xc98
	FString StrTorsoDLC; // 0xca8
	FString StrLegDLC; // 0xcb8
	FString StrBodiesDLC; // 0xcc8
};
...
struct FOutfitData {
	...
	bool IsAvailableInAtlantaBuild; // 0x148
};
...
struct FGeneratedLevelData {
	...
	TArray<AActor*> FixedMapTileIds; // 0x228
	TArray<AActor*> FixedMapOrphanSpawners; // 0x238
	FName SpecialEventId; // 0x248
	bool UseForcedMap; // 0x254
	bool UsePremadeMap; // 0x255
	FString GenerationLogs; // 0x258
	FString GenerationErrors; // 0x268
	int32_t GenerationPlayerCount; // 0x278
	TArray<FForceSpawnTileData> ForceSpawnTileData; // 0x280
	TArray<AActor*> LevelLightings; // 0x290
};
...
struct FCharacterCustomizationDataTable {
...
struct FPerkAcquisitionAnalytics {
...
struct FMobileCdnDownloadAnalytics {
	FString CdnDownloadState; // 0x18
	int32_t CdnDownloadTimeInSeconds; // 0x28
};
...
struct FRoleItemCategoryDropdown {
...
struct FAtlantaTutorialEndReward {
...
struct FFeaturedPurchaseAnalytics {
	FString ItemId; // 0x98
	FString Price; // 0xa8
};
...
struct FBotReplacementAnalytics {
	FString MatchID; // 0x98
...
struct FArchiveQuestObjectiveDefinition {
	FText Description; // 0x18
...
struct FCrowdChoiceOnGameRoundStartedAnalytics {
	FString PollId; // 0x98
...
struct FMatchmakingJoinCompleteAnalytics {
...
struct FBloodwebProgressionValue {
...
struct FSurvivorTutorialAnalytics {
	int32_t SecondsSpentInTutorial; // 0x98
	int32_t SecondsSpentInIntroSection; // 0x9c
	int32_t SecondsSpentInSkillchecksSection; // 0xa0
	int32_t SecondsSpentInKillerSection; // 0xa4
	int32_t SecondsSpentInStealthSection; // 0xa8
	int32_t SecondsSpentInHookSection; // 0xac
	int32_t SecondsSpentInHealthSection; // 0xb0
	int32_t SecondsSpentInRescueSection; // 0xb4
	int32_t SecondsSpentInEscapeSection; // 0xb8
	bool WasScratchMarksAndWildlifeEventTriggered; // 0xbc
	bool WasRushedActionEventTriggered; // 0xbd
	bool WasSuccessfulStealthEventTriggered; // 0xbe
	bool WasStealthObjectiveCompleted; // 0xbf
	bool WasHatchEscapeObjectiveCompleted; // 0xc0
};
...
struct FCrowdPlayLobbyResultsAnalytics {
...
struct FDetailedScoreAnalytics {
...
struct FAkObservedPlayerSoundLoop {
...
struct FDisconnectionDetailsAnalytics {
...
struct FRandomGuestNameRejectedAnalytics {
	FString playerName; // 0x18
	int32_t RandomGuestNameRetryCount; // 0x28
};
...
struct FPlayerLevelTooltipData {
...
struct FLoadoutSlotUnlockLevelValue {
...
struct FBloodwebNodeRarityCost {
	EItemRarity Rarity; // 0x8
	int32_t Cost; // 0xc
};
...
struct FStadiaStorefrontDlcData {
...
struct FMatchmakingQueueAnalytics {
...
struct FDedicatedServerStatusAnalytics {
...
struct FDependencyElementSubstitutions {
...
struct FArchiveQuestSpecialBehaviour {
	FText Description; // 0x18
...
struct FKillerClosetActorsTypes {
	TSoftClassPtr<UObject> ClosetActorClass; // 0x8
};

struct FLogMirrorsAnalytics {
...
struct FProceduralGenerationAnalytics {
...
struct FBloodMarketRefreshAnalytics {
	FString CharacterRole; // 0x18
	int32_t CurrencyCost; // 0x28
	FString CurrencyUsed; // 0x30
	FString RefreshMethod; // 0x40
};

struct FDailyRitualAnalytics {
	FString Status; // 0x98
...
struct FGameplay_PigKillerAnalytics {
	FString MatchID; // 0x98
...
struct FMatchmakingSearchCompleteAnalytics {
	bool success; // 0x98
...
struct FTinkererUndetectableInterruptAnalytics {
...
struct FDailyCalendarRewardAnalytics {
	FString ItemId; // 0x18
	int32_t NumberOfRewards; // 0x28
	int32_t rewardIndex; // 0x2c
	int32_t ItemAmount; // 0x30
};
...
struct FLogPresencePluginAnalytics {
...
struct FVideoThumbnailProperties {
	FName _id; // 0x8
	bool _hasAudio; // 0x14
...
struct FAtlantaDuplicatesRefundAnalytics {
	FString DuplicatesItems; // 0x18
	FString RefundItem; // 0x28
	int32_t RefundItemAmount; // 0x38
	FString FragmentItem; // 0x40
	int32_t FragmentItemAmount; // 0x50
	FString FromSystem; // 0x58
};
...
struct FTooltipWidgetData {
	ETooltipType TooltipType; // 0x8
	UUserWidget* WidgetClass; // 0x10
};

struct FAICamperDodgeTunableRowData {
...
struct FAtlantaKillerSoundIndicatorData {
	float MinRadiusSoundDistance; // 0x8
	float MaxRadiusSoundDistance; // 0xc
	float MinRangeSoundHeard; // 0x10
...
struct FCustomizationCategoryData {
	FName ID; // 0x8
...
struct FAtlantaSurvivorTutorialAnalytics {
	bool SurvivorTutorialCompleted; // 0x18
	bool SurvivorTutorialSkipped; // 0x19
};
...
struct FLegionSurvivorAnalytics {
	FString MatchID; // 0x98
...
struct FAttackEventTypeDetails {
...
struct FAtlantaPlayerLevelAnalytics {
	int32_t PlayerLevel; // 0x18
	int32_t PlayerPrestigeLevel; // 0x1c
};
...
struct FAtlantaControlsSettingsAnalytics {
	bool IsUsingCustomizedHuds; // 0x98
	int32_t NbKillerCustomizedHuds; // 0x9c
	int32_t NbSurvivorCustomizedHuds; // 0xa0
	bool IsKillerInvertY; // 0xa4
	bool IsSurvivorInvertY; // 0xa5
	FString ControlType; // 0xa8
};
...
struct FAtlantaFreeTicketUIData {
...
struct FFeaturedBrowsingAnalytics {
	FString ItemId; // 0x98
	FString Price; // 0xa8
	FString contentGroupID; // 0xb8
	FString startDate; // 0xc8
	FString endDate; // 0xd8
	FString StringId; // 0xe8
};
...
struct FBloodwebPrestigeModifiers {
...
struct FBotSpawnAnalytics {
	FString MatchID; // 0x98
	int32_t BotNumber; // 0xa8
	FString KrakenMatchId; // 0xb0
	EPlayerRole Role; // 0xc0
	FString characterName; // 0xc8
	EAIDifficultyLevel BotDifficultyLevel; // 0xd8
};

struct FMatchmakingHostCreatedAnalytics {
...
struct FAssetNetIdRow {
	int32_t NetId; // 0x8
};

struct FOnboardingAnalytics {
...
struct FCheatValidatedAnalytics {
	FString NetMode; // 0x98
	FString Requester; // 0xa8
	FString Command; // 0xb8
	bool Validated; // 0xc8
...
struct FProgressionUIDataRow {
	EProgressionType ProgressionType; // 0x8
	FCurrencyProgressionUIData CurrencyProgressionUIData; // 0x10
};

struct FWalesCypherAnalytics {
...
struct FDDoSDetectionAnalytics {
...
struct FSaveGameErrorAnalytics {
...
struct FFranklinsHitNearDroppedItemAnalytics {
	FString HitSurvivorMirrorsId; // 0xb0
	FString AttackingSlasherMirrorsId; // 0xc0
};
...
struct FMapCoordAnalytics {
	FString MatchID; // 0x98
	TArray<FMapCoordData> MapItem; // 0xa8
};

struct FFreeTicketAnalytics {
	FString ticketId; // 0x18
	FString TicketTransactionType; // 0x28
	FString TicketSource; // 0x38
	int32_t DurationInSeconds; // 0x48
	FString CharacterUsed; // 0x50
};
...
struct FHtmlToRichTagConvertRow {
	FString HtmlTag; // 0x8
	FString RichTextTag; // 0x18
};
...
struct FBloodMarketAdsAnalytics {
	FString ItemId; // 0x18
	int32_t BloodMarketAdDepth; // 0x28
};

struct FDisconnectionAnalytics {
...
struct FSaveGameLoadResultAnalytics {
...
struct FMatchmakingJoinSessionAnalytics {
	FString Log; // 0x98
};
...
struct FS3CommandErrorAnalytics {
	FString URL; // 0x98
	FString Verb; // 0xa8
...
struct FNodeContentDistributionValue {
...
struct FRarityDistributionValue {
...
struct FPurchasableOperationData {
	FName ID; // 0x8
};
...
struct FLightbornAuraRevealedAnalytics {
...
struct FBloodwebContentTypePerRingDistribution {
...
struct FInvalidLoadoutAnalytics {
...
struct FInteractionProficiencyProperties {
...
struct FPlayerStatusEffectUpdateAnalytics {
	FString MatchID; // 0x98
...
struct FCrowdChoiceSummaryResultAnalytics {
	FString PollId; // 0x98
...
struct FSecretBotMatchNamesDefinition {
	char ID; // 0x8
	FString Name; // 0x10
};
...
struct FCustomizationItemData {
	ECustomizationCategory Category; // 0x110
	TSoftObjectPtr<USkeletalMesh> ItemMesh; // 0x118
	TSoftClassPtr<UObject> AnimClass; // 0x148
	TSoftClassPtr<UObject> ItemBlueprint; // 0x178
	TArray<FMaterialReplacerData> MaterialsMap; // 0x1a8
	FConditionalMaterialReplacer ConditionalMaterialReplacer; // 0x1b8
	TArray<FName> SkeletalComponentTags; // 0x218
	FText CollectionName; // 0x228
	FText CollectionDescription; // 0x240
	int32_t PrestigeUlockLevel; // 0x258
	FString PrestigeUnlockDate; // 0x260
	FName EventId; // 0x270
	ECharmCategory CharmCategory; // 0x27c
	TArray<FBPAttachementSocketData> SocketAttachements; // 0x280
	TArray<FUnlockSaveStatCondition> UnlockingConditions; // 0x290
	bool IsInStore; // 0x2a0
	bool IsInNonViolentBuild; // 0x2a1
	bool IsAvailableInAtlantaBuild; // 0x2a2
	uint32_t PlatformExclusiveFlag; // 0x2a4
	TArray<FCustomSoundFXData> CustomSFXs; // 0x2a8
	FCustomAnimData AnimationData; // 0x2b8
};
...
struct FCustomizationAnalytics {
	FString MatchID; // 0x100
};
...
struct FAtlantaGraphicsSettingsAnalytics {
	int32_t scalabilityValue; // 0x18
	bool isAutoScalabilitySet; // 0x1c
	int32_t fpsValue; // 0x20
};
...
struct FAtlantaBonusACEventsUIData {
...
struct FCustomerSupportClientLoginAnalytics {
...
struct FTutorialNotificationData {
	FText Title; // 0x8
	FText Description; // 0x20
	FString IconPath; // 0x38
...
struct FCharacterCustomizationDropdown {
	FName OutfitId; // 0x8
...
struct FGameplay_PigSurvivorAnalytics {
	FString MatchID; // 0x98
...
struct FFeaturedPurchaseOptionAnalytics {
	FString ItemId; // 0x98
	FString Price; // 0xa8
};
...
struct FEndpointLatencyAnalytics {
...
struct FPCDeviceProfiles {
	FName Cpu; // 0x8
	FName GPU; // 0x14
	TArray<FResolutionQualityPair> Pairs; // 0x20
};

struct FGhostKillerAnalytics {
	FString MatchID; // 0x98
	int32_t Stalk; // 0xa8
...
struct FSubscriptionRewardsAnalytics {
	FString SubscriptionId; // 0x98
	FString InventoryRewards; // 0xa8
	FString CurrencyRewards; // 0xb8
	FString EventSourceId; // 0xc8
};
...
struct FAIDifficultyTunableRowData {
	float VeryEasy; // 0x8
	float Easy; // 0xc
	float Medium; // 0x10
	float Hard; // 0x14
...
struct FAtlantaDeepLinkAnalytics {
	FString DeepLinkURL; // 0x18
	FString CampaignName; // 0x28
};
...
struct FHelpContextMappingData {
	FString ContextName; // 0x8
	TArray<FName> TopicIds; // 0x18
};

struct FPerformanceChartingAnalytics {
...
struct FHitValidationEditorConfig {
...
struct FAtlantaFreeTicketCatalogItem {
	...
	FString Role; // 0x10
	int32_t DurationInMinutes; // 0x20
};
...
struct FAtlantaActivablePerkAnalytics {
	FString perkId; // 0x98
	bool clickedOnPerksWidget; // 0xa8
};
...
struct FFranklinsDemiseConsumedItemAnalytics {
...
struct FMatchmakingApproveLoginAnalytics {
...
struct FPlayerPersistentData {
	...
	EPlatformFlag PlayerPlatform; // 0x700
	EProviderFlag PlayerProvider; // 0x704
	uint32_t _playerId; // 0x708
	FString _contentVersion; // 0x720
	FDateTime _startSessionTime; // 0x730
};
...
struct FStadiaLivestreamAnalytics {
...
struct FAtlantaPurchasePopupAnalytics {
	FString OfferId; // 0x18
	FString Price; // 0x28
	bool IsPurchased; // 0x38
};
...
struct FLevelLoadingTimeoutAnalytics {
	FString MatchID; // 0x98
	FString MapName; // 0xa8
	int32_t Seed; // 0xb8
	float TimeElapsed; // 0xbc
...
struct FAtlantaQuitGameAnalytics {
	FString QuitGameReason; // 0x18
};
...
struct FFrameTravelTimeAnalytics {
	FString MatchID; // 0x98
	FString DynamicRange; // 0xa8
	FString PixelDensity; // 0xb8
	FString RenderResolution; // 0xc8
...
struct FBloodwebRarityPerRingDistribution {
...
struct FGameplayElementSubstitutions {
	TArray<FSubstitutionElements> _replacements; // 0x10
...
struct FDedicatedServerPlayerEquipDisabledItemAnalytics {
...
struct FPlayerStateData {
	...
	bool IsLeavingMatch; // 0x30
	EGameState _playerGameState; // 0x31
	bool _isEscapeHatch; // 0x32
...
struct FAtlantaNoiseIndicatorDistanceData {
...
struct FAtlantaPartyGameAnalytics {
	int32_t PartySize; // 0x18
	FString KrakenMatchId; // 0x20
	FString FriendIdOne; // 0x30
	FString FriendIdTwo; // 0x40
	FString FriendIdThree; // 0x50
	FString FriendIdFour; // 0x60
};
...
struct FNewSurvivorTutorialAnalytics {
...
struct FBloodMarketTransactionAnalytics {
	FString ItemId; // 0x18
	FString CurrencyUsed; // 0x28
	int32_t CurrencyCost; // 0x38
	int32_t CurrencyRemaining; // 0x3c
	bool IsNextRowUnlocked; // 0x40
	int32_t NumberOfItemsBoughtOnRow; // 0x44
	int32_t RowIndex; // 0x48
	FString CharacterRole; // 0x50
};

struct FGarantiedRarityRingDistributionValues {
...
struct FBloodwebNodesPerRingDistribution {
	int32_t MinCount; // 0x8
	int32_t MaxCount; // 0xc
};
...
struct FReplicatedTrailPointList {
...
struct FLamentConfigurationPlayerPossessionAnalytics {
	FString MatchID; // 0x98
...
struct FSaveGameSummaryPlayerStatsAnalytics {
...
struct FAtlantaKillerSoundConditionData {
...
struct FAtlantaRitualsAdsRefreshAnalytics {
	FString Status; // 0x98
	FString AdsId; // 0xa8
};
...
struct FSaveGameSaveResultAnalytics {
...
struct FLoadingTimeoutAnalytics {
...
struct FTemplateSequenceSectionTemplate {
...
struct FMatchmakingLobbyAnalytics {
...
struct FOnboardingBotMatchDefinition {
	FText DisplayName; // 0x18
	FText Description; // 0x30
...
struct FCrowdPlayLobbyEventsAnalytics {
	FString CrowdPlayId; // 0x98
...
struct FAtlantaKillerTutorialAnalytics {
	bool KillerTutorialCompleted; // 0x18
	bool KillerTutorialSkipped; // 0x19
};
...
struct FLegacyPlayerSavedProfileData {
	FString PlayerUID; // 0x10
...
struct FAtlantaCampaignEventAnalytics {
	FString EventName; // 0x98
	FString EffectType; // 0xa8
	float Value; // 0xb8
	float BaseGained; // 0xbc
	float BonusGained; // 0xc0
	FString AffectedRole; // 0xc8
	FString characterName; // 0xd8
};

struct FEACClientInitAnalytics {
...
struct FGameConsoleLogAnalytics {
...
struct FAtlantaRitualDefinition {
	FText DisplayName; // 0x8
	FText Description; // 0x20
...
struct FEACClientViolationAnalytics {
...
struct FKnockoutSurvivorFoundAnalytics {
	FString RescuingSurvivorMirrorsId; // 0xb0
	FString FoundSurvivorMirrorsId; // 0xc0
};

struct FAtlantaTutorialNotificationData {
...
struct FGameplay_ChaseAnalytics {
	FString MatchID; // 0x98
	bool IsABot; // 0xa8
...
struct FMobileLoginAnalytics {
	FString LoginMethod; // 0x18
	FString AuthenticationContext; // 0x28
	bool IsMigrationAccount; // 0x38
};
...
struct FKrakenRequestAnalytics {
...
struct FAkXSXAdvancedInitializationSettings {
	uint16_t MaximumNumberOfXMAVoices; // 0x38
	bool UseHardwareCodecLowLatencyMode; // 0x3a
};
...
struct FChainsawHitWithPowerCharge {
	int32_t NumPowerCharges; // 0x4
};

struct FSecretBotMatchLoadoutDefinition {
	char BotRank; // 0x8
...
struct FPerformanceAnalytics {
	...
	int32_t MatchCount; // 0x1ac
	int32_t TotalFrames; // 0x1b0
	float ResolutionQuality; // 0x1b4
	int32_t ViewDistanceQuality; // 0x1b8
	int32_t AntiAliasingQuality; // 0x1bc
	int32_t ShadowQuality; // 0x1c0
	int32_t TextureQuality; // 0x1c4
	int32_t EffectsQuality; // 0x1c8
	int32_t FoliageQuality; // 0x1cc
	FString Scenario; // 0x1d0
	FString Theme; // 0x1e0
	FString MapName; // 0x1f0
	int32_t TileListCount; // 0x200
	int32_t Seed; // 0x204
	FString characterName; // 0x208
	FString Cpu; // 0x218
	FString GpuAdapter; // 0x228
	FString MatchID; // 0x238
};
...
struct FCurrencyBalanceAnalytics {
