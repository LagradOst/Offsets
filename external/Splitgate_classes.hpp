...
namespace off {
	constexpr auto GNames = 0x52c1cc0;
	constexpr auto GObjects = 0x52fe1f0;
	constexpr auto GWorld = 0x54425f0;

	namespace n_UPortalWarsMKBSettingsWidget { // : UPortalWarsSettingsSubWidget
	...
	namespace n_UPortalWarsGamepadBindingRestoreDialogWidget { // : UPortalWarsDialogWidget
	...
	namespace n_UBTTask_Crouch { // : UBTTaskNode
		constexpr auto shouldCrouch = 0x70; // bool
	}

	namespace n_AExplosiveProjectile { // : AProjectile
	...
	namespace n_UPortalWarsForgeHUDOverlayWidget { // : UPortalWarsUserWidget
		constexpr auto BuildMenu = 0x2a8; // UPortalWarsForgeBuildMenuWidget*
		constexpr auto OpenBuildMenuAnimation = 0x2b0; // UWidgetAnimation*
		constexpr auto ControlsDisplay = 0x2b8; // UWidget*
		constexpr auto OpenControlsDisplayAnimation = 0x2c0; // UWidgetAnimation*
		constexpr auto BuildReticle = 0x2c8; // UPortalWarsForgeReticleWidget*
		constexpr auto MoveSpeedSwitcher = 0x2d0; // UWidgetSwitcher*
		constexpr auto MoveSpeedText = 0x2d8; // UTextBlock*
		constexpr auto InteractMoveSpeedText = 0x2e0; // UTextBlock*
	}
	...
	namespace n_UPortalWarsInputWidget { // : UPortalWarsUserWidget
	...
	namespace n_UPortalWarsRewardEntryWidget { // : UPortalWarsEntryWidget
	...
	namespace n_AScoreboardNameComponent { // : AScoreboardComponent
	...
	namespace n_APortalLauncher { // : ABaseGun
	...
	namespace n_APortalWarsInteractable { // : ATeleportableActor
		constexpr auto StaticMeshComponent = 0x230; // UStaticMeshComponent*
		constexpr auto InteractableComponent = 0x238; // UPortalWarsInteractableComponent*
	}
	...
	namespace n_APortalWarsTutorialGoal { // : AActor
	...
	namespace n_UPWTutorialHUDOverlayWidget { // : UUserWidget
	...
	namespace n_APortalWarsContaminationHUD { // : APortalWarsRoundHUD
	...
	namespace n_UPortalWarsRewardPassEntryWidget { // : UPortalWarsRewardEntryWidget
	...
	namespace n_UPortalWarsInspectWidget { // : UPortalWarsMenuWidget
	...
	namespace n_UPortalWarsScrollBox { // : UScrollBox
		constexpr auto bAllowGamepadRightStickScrolling = 0x888; // bool
		constexpr auto GamepadScrollSpeed = 0x88c; // float
	}

	namespace n_UPortalWarsInventoryWidget { // : UPortalWarsUserWidget
	...
	namespace n_UPortalWarsInputCarouselWidget { // : UPortalWarsInputWidget
	...
	namespace n_UBTDecorator_PortalIsNearTarget { // : UBTDecorator_BlackboardBase
		constexpr auto XYRange = 0x90; // float
		constexpr auto MinZRange = 0x94; // float
	}

	namespace n_UPortalWarsVIPHUDOverlayWidget { // : UUserWidget
	...
	namespace n_UPortalWarsReferFriendWidget { // : UPortalWarsMenuWidget
	...
	namespace n_UPortalWarsForgeMapSelectorWidget { // : UPortalWarsMapSelectorWidget
		constexpr auto MapOptionsButton = 0x370; // UPortalWarsButtonWidget*
		constexpr auto MapOptionsDialogClass = 0x378; // UPortalWarsMapFileOptionsDialogWidget*
	}
	...
	namespace n_UPortalWarsBPRedeemableButton { // : UPortalWarsRedeemableButtonWidget
	...
	namespace n_UPortalWarsSettingsMenuWidget { // : UPortalWarsMenuWidget
	...
	namespace n_APortalWarsRoundHUD { // : APortalWarsHUD
	...
	namespace n_UPortalWarsLowAmmoIndicatorWidget { // : UUserWidget
	...
	namespace n_AMainMenuGameState { // : AGameStateBase
	...
	namespace n_UBTDecorator_HasReceivedKillRecently { // : UBTDecorator
	...
	namespace n_APortalWarsLobbyGameState { // : APortalWarsBaseGameState
		constexpr auto PrevGameData = 0x7d8; // FMatchSummaryInfo
		constexpr auto PlayerStarts = 0x938; // TArray<APortalWarsLobbyPlayerStart*>
		constexpr auto EmptyPlayerStarts = 0x948; // TArray<APortalWarsLobbyPlayerStart*>
		constexpr auto NeutralPlayerStarts = 0x958; // TArray<APortalWarsLobbyPlayerStart*>
		constexpr auto TVScreen = 0x968; // AStaticMeshActor*
	}

	namespace n_UPortalWarsForgeBuildMenuWidget { // : UPortalWarsMenuWidget
		constexpr auto ObjectsMenu = 0x338; // UPortalWarsForgeObjectsMenuWidget*
		constexpr auto ToolsMenu = 0x340; // UPortalWarsForgeToolsMenuWidget*
		constexpr auto MapMenu = 0x348; // UPortalWarsForgeMapMenuWidget*
	}

	namespace n_UPortalWarsWidgetSwitcher { // : UWidgetSwitcher
		constexpr auto Widgets = 0x148; // TArray<UUserWidget*>
	}

	namespace n_APortalWarsOneFlagCTFHUD { // : APortalWarsRoundHUD
		constexpr auto AlphaTeamIndicator = 0x440; // UPortalWarsFlagIndicatorWidget*
		constexpr auto BravoTeamIndicator = 0x448; // UPortalWarsFlagIndicatorWidget*
		constexpr auto FlagIndicatorWidgetClass = 0x450; // UPortalWarsIndicatorWidget*
		constexpr auto FlagCaptureZoneWidgetClass = 0x458; // UPortalWarsIndicatorWidget*
	}
	...
	namespace n_UPortalWarsRadioGroupWidget { // : UPortalWarsInputWidget
	...
	namespace n_UPortalWarsColorPickerWidget { // : UPortalWarsInputWidget
	...
	namespace n_UPortalWarsButton { // : UButton
	...
	namespace n_UPortalWarsTeamDecimalCarouselWidget { // : UPortalWarsInputWidget
	...
	namespace n_UPortalWarsMenuSelectWidget { // : UPortalWarsDialogWidget
	...
	namespace n_UPortalWarsInputDecoratorWidget { // : UPortalWarsUserWidget
	...
	namespace n_UPortalWarsCheckListWidget { // : UPortalWarsInputWidget
	...
	namespace n_UPortalWarsLoginMenuWidget { // : UPortalWarsUserWidget
	...
	namespace n_UPortalWarsGlobals { // : UObject
		...
		constexpr auto ForgeMapRequirements = 0x558; // UDataTable*
		constexpr auto ForgeInteractables = 0x560; // UDataTable*
		constexpr auto GameModes = 0x568; // UDataTable*
		constexpr auto GameModeTypes = 0x570; // UDataTable*
		constexpr auto Medals = 0x578; // UDataTable*
		constexpr auto RaceDifficulties = 0x580; // UDataTable*
		constexpr auto ChallengeTables = 0x588; // TMap<EChallengeType, UDataTable*>
		constexpr auto CheckInRewards = 0x5d8; // UDataTable*
		constexpr auto PlayStreakRewards = 0x5e0; // UDataTable*
		constexpr auto PlayStreakIcons = 0x5e8; // UDataTable*
		constexpr auto Progression = 0x5f0; // UDataTable*
		constexpr auto ProgressionIcons = 0x5f8; // UDataTable*
		constexpr auto BattlePass = 0x600; // UDataTable*
		constexpr auto ReferralPass = 0x608; // UDataTable*
		constexpr auto RewardIcons = 0x610; // TMap<ERewardType, TSoftObjectPtr<UTexture2D>>
		constexpr auto Unlocks = 0x660; // UDataTable*
		constexpr auto Ranks = 0x668; // UDataTable*
		constexpr auto RankDivisions = 0x670; // UDataTable*
		constexpr auto Playlists = 0x678; // UDataTable*
		constexpr auto Regions = 0x680; // UDataTable*
		constexpr auto MicroTxnPurchasables = 0x688; // UDataTable*
		constexpr auto Redeemables = 0x690; // UDataTable*
		constexpr auto Announcer = 0x698; // UDataTable*
		constexpr auto BotProfiles = 0x6a0; // UDataTable*
		constexpr auto CustomBotProfiles = 0x6a8; // UDataTable*
		constexpr auto BannedWords = 0x6b0; // UDataTable*
		constexpr auto NiceTexts = 0x6b8; // UDataTable*
		constexpr auto WeaponReticles = 0x6c0; // UDataTable*
		constexpr auto CustomReticles = 0x6c8; // UDataTable*
		constexpr auto DefaultAvatar = 0x6d0; // UTexture2D*
		constexpr auto PlatformAvatars = 0x6d8; // TMap<FString, UTexture2D*>
		constexpr auto Tutorial = 0x728; // UDataTable*
		constexpr auto XboxButtons = 0x730; // UDataTable*
		constexpr auto PlayStationButtons = 0x738; // UDataTable*
		constexpr auto MouseButtons = 0x740; // UDataTable*
		constexpr auto Tips = 0x748; // UDataTable*
		constexpr auto LockerTips = 0x750; // UDataTable*
		constexpr auto WeaponPoses = 0x758; // UDataTable*
		constexpr auto AlwaysLoadedSoundBanks = 0x760; // TArray<UObject*>
	}
	...
	namespace n_UPortalWarsDamageNumberEntryWidget { // : UUserWidget
	...
	namespace n_UPortalWarsGameModeInfoWidget { // : UUserWidget
	...
	namespace n_UPortalWarsLimitedTimeOfferDialogWidget { // : UPortalWarsDialogWidget
	...
	namespace n_UPortalWarsRankListEntryWidget { // : UUserWidget
	...
	namespace n_UEnvQueryGenerator_PathGridOffset { // : UEnvQueryGenerator_SimpleGrid
	...
	namespace n_AFlagCaptureZone { // : AActor
		...
		constexpr auto OneFlagPickupClass = 0x250; // AFlagItemPickup*
		constexpr auto CTFGameState = 0x258; // APortalWarsCTFGameState*
		constexpr auto NeutralCTFGameState = 0x260; // APortalWarsNeutralCTFGameState*
		constexpr auto OneFlagCTFGameState = 0x268; // APortalWarsOneFlagCTFGameState*
	}
	...
	namespace n_UPortalWarsAnimInstance { // : UAnimInstance
	...
	namespace n_APortalWarsNeutralCTFGameState { // : APortalWarsGameState
		constexpr auto Flag = 0x8b8; // AActor*
		constexpr auto FlagState = 0x8c0; // EFlagState
		constexpr auto CapturedFlagRespawnTime = 0x8c4; // float
	}
	...
	namespace n_APortalWarsDomination { // : APortalWarsGameMode
		constexpr auto HillTeamScore = 0x6f0; // int32_t
		constexpr auto HillCaptureScore = 0x6f4; // int32_t
		constexpr auto HillNeutralizeScore = 0x6f8; // int32_t
	}
	...
	namespace n_UPortalWarsRadarWidget { // : UUserWidget
	...
	namespace n_UPortalWarsUserWidget { // : UUserWidget
	...
	namespace n_UPortalWarsProgressionIconWidget { // : UUserWidget
	...
	namespace n_UPortalWarsEntryWidget { // : UPortalWarsButtonWidget
	...
	namespace n_UPortalWarsForgeInteractableComponent { // : UPortalWarsInteractableComponent
		constexpr auto InteractableInfo = 0xb8; // FForgeInteractableInfo
		constexpr auto FocusStencilValue = 0xf8; // int32_t
		constexpr auto HeldStencilValue = 0xfc; // int32_t
		constexpr auto ErrorStencilValue = 0x100; // int32_t
		constexpr auto RotateTimelineFloatCurve = 0x108; // UCurveFloat*
		constexpr auto AngularDistanceForMaxTime = 0x110; // float
		constexpr auto RotateTimelineComponent = 0x118; // UTimelineComponent*
		constexpr auto ScaleTimelineFloatCurve = 0x148; // UCurveFloat*
		constexpr auto ScaleDistanceForMaxTime = 0x150; // float
		constexpr auto ScaleTimelineComponent = 0x158; // UTimelineComponent*
		constexpr auto bShouldDisplayIndicator = 0x179; // bool
		constexpr auto DisplayText = 0x180; // FText
		constexpr auto IndicatorOffset = 0x198; // FVector
		constexpr auto InteractableRepData = 0x1a8; // FForgeInteractableRepData
		constexpr auto Transform = 0x1c0; // FTransform
		constexpr auto bCannotOverlapAnything = 0x1f0; // bool
		constexpr auto InteractableIndicatorWidget = 0x1f8; // UPortalWarsForgeInteractableIndicator*
	}
	...
	namespace n_UPortalWarsRaceLeaderboardEntry { // : UPortalWarsLeaderboardEntryWidget
	...
	namespace n_UPortalWarsVotingMenuWidget { // : UPortalWarsLobbyWidget
	...
	namespace n_UPortalWarsDropIndicatorWidget { // : UUserWidget
	...
	namespace n_UPortalWarsRoundResultWidget { // : UUserWidget
	...
	namespace n_UPortalWarsRootHUDWidget { // : UPortalWarsUserWidget
	...
	namespace n_UPortalWarsChallengesSubWidget { // : UPortalWarsMenuWidget
	...
	namespace n_UPortalWarsRaceLobbyWidget { // : UPortalWarsCustomLobbyWidget
		constexpr auto DifficultySelectorButton = 0x388; // UPortalWarsRaceLobbySelectorButtonWidget*
		constexpr auto DifficultyMenuClass = 0x390; // UPortalWarsMenuWidget*
		constexpr auto RaceLeaderboard = 0x398; // UPortalWarsRaceLeaderboardWidget*
		constexpr auto SwitchLeaderboardButton = 0x3a0; // UPortalWarsButtonWidget*
		constexpr auto ToggleCrossPlayButton = 0x3a8; // UPortalWarsButtonWidget*
	}

	namespace n_UBTTask_SpawnPortal { // : UBTTaskNode
	...
	namespace n_APortalWarsLobbyPlayerController { // : APortalWarsPlayerController
	...
	namespace n_UPortalWarsPlaylistActiveDialog { // : UPortalWarsDialogWidget
	...
	namespace n_UPortalWarsTeamCheckboxWidget { // : UPortalWarsInputWidget
	...
	namespace n_UPortalWarsPlayStreakDialogWidget { // : UPortalWarsTxnDialogWidget
		constexpr auto CurrencyText = 0x3c8; // UTextBlock*
		constexpr auto PlayStreakReward = 0x3d0; // UPortalWarsPlayStreakRewardWidget*
	}

	namespace n_UPortalWarsStatsEntryWidget { // : UPortalWarsUserWidget
	...
	namespace n_APortalWarsRaceHUD { // : APortalWarsHUD
	...
	namespace n_UPortalWarsControlSettingsWidget { // : UPortalWarsSettingsSubWidget
	...
	namespace n_UPWVoiceNotificationItem { // : UUserWidget
	...
	namespace n_UPortalWarsLeaderboardEntryWidget { // : UPortalWarsPlayerEntryWidget
	...
	namespace n_UPortalWarsCareerProgressWidget { // : UPortalWarsUserWidget
	...
	namespace n_UPortalWarsChunkInstallWidget { // : UPortalWarsUserWidget
	...
	namespace n_UPortalWarsKOTHHillStatusWidget { // : UUserWidget
	...
	namespace n_UPortalWarsKillcam { // : UObject
	...
	namespace n_ABaseGun { // : ACullableActor
	...
	namespace n_APortalWarsVIPGameState { // : APortalWarsGameState
		constexpr auto VIPs = 0x8b8; // TMap<int32_t, APortalWarsPlayerState*>
		constexpr auto PreviousVIPs = 0x908; // TMap<int32_t, APortalWarsPlayerState*>
	}
	...
	namespace n_UPortalWarsTxnDialogWidget { // : UPortalWarsDialogWidget
	...
	namespace n_AShotgun { // : ALineTraceGun
	...
	namespace n_UPortalWarsGamepadSelectWidget { // : UPortalWarsSettingsSubWidget
		constexpr auto ModeCarousel = 0x358; // UPortalWarsTextCarouselWidget*
		constexpr auto GameplayPreset = 0x360; // UPortalWarsTextCarouselWidget*
		constexpr auto ControllerSwitcher = 0x368; // UWidgetSwitcher*
		constexpr auto XboxButtonLayout = 0x370; // UPortalWarsControllerPresetWidget*
		constexpr auto PS4ButtonLayout = 0x378; // UPortalWarsControllerPresetWidget*
		constexpr auto BindingWarningDialogClass = 0x380; // UPortalWarsGamepadBindingMissingDialogWidget*
		constexpr auto BindingDefaultsDialogClass = 0x388; // UPortalWarsGamepadBindingRestoreDialogWidget*
		constexpr auto CustomizeButton = 0x390; // UPortalWarsGamepadBindingCustomizeButtonWidget*
	}
	...
	namespace n_UPortalWarsBattlePassPanelWidget { // : UPortalWarsCareerProgressWidget
	...
	namespace n_UPortalWarsTextInputWidget { // : UPortalWarsInputWidget
	...
	namespace n_UPortalWarsPortalIndicatorWidget { // : UPortalWarsIndicatorWidget
	...
	namespace n_UPortalWarsRewardPassWidget { // : UPortalWarsInspectWidget
	...
	namespace n_APortalWarsTakedownVIPHUD { // : APortalWarsTakedownHUD
	...
	namespace n_UPortalWarsGamepadBindingCategoryWidget { // : UUserWidget
	...
	namespace n_UPortalWarsGamepadBindingActionWidget { // : UPortalWarsUserWidget
	...
	namespace n_ANeutralFlagItemPickup { // : AFlagItemPickup
	...
	namespace n_APortalWarsTakedownVIPGameState { // : APortalWarsTakedownGameState
		constexpr auto SurvivingVIP = 0x918; // APortalWarsPlayerState*
		constexpr auto VIPs = 0x920; // TMap<int32_t, APortalWarsPlayerState*>
	}
	...
	namespace n_UPortalWarsForgeToolsMenuWidget { // : UPortalWarsMenuWidget
		constexpr auto PropertiesRoot = 0x338; // UWidget*
		constexpr auto DropToGroundButton = 0x340; // UPortalWarsButtonWidget*
		constexpr auto MovementSnapCarousel = 0x348; // UPortalWarsTextCarouselWidget*
		constexpr auto MovementXCarousel = 0x350; // UPortalWarsDecimalCarouselWidget*
		constexpr auto MovementYCarousel = 0x358; // UPortalWarsDecimalCarouselWidget*
		constexpr auto MovementZCarousel = 0x360; // UPortalWarsDecimalCarouselWidget*
		constexpr auto RotationSnapCarousel = 0x368; // UPortalWarsTextCarouselWidget*
		constexpr auto RotationXCarousel = 0x370; // UPortalWarsDecimalCarouselWidget*
		constexpr auto RotationYCarousel = 0x378; // UPortalWarsDecimalCarouselWidget*
		constexpr auto RotationZCarousel = 0x380; // UPortalWarsDecimalCarouselWidget*
		constexpr auto ScaleSnapCarousel = 0x388; // UPortalWarsTextCarouselWidget*
		constexpr auto ScaleXCarousel = 0x390; // UPortalWarsDecimalCarouselWidget*
		constexpr auto ScaleYCarousel = 0x398; // UPortalWarsDecimalCarouselWidget*
		constexpr auto ScaleZCarousel = 0x3a0; // UPortalWarsDecimalCarouselWidget*
		constexpr auto InteractionComponent = 0x3a8; // UPortalWarsForgeCharInteractionComponent*
		constexpr auto InteractableComponent = 0x3b0; // UPortalWarsForgeInteractableComponent*
	}
	...
	namespace n_UBTDecorator_Probability { // : UBTDecorator
		constexpr auto SuccessChance = 0x68; // float
	}

	namespace n_UPortalWarsInviteMenuWidget { // : UPortalWarsMenuWidget
	...
	namespace n_UPortalWarsHillIndicatorWidget { // : UPortalWarsIndicatorWidget
		constexpr auto Pointer = 0x2b8; // UWidget*
	...
	namespace n_UPortalWarsPlayerCardWidget { // : UPortalWarsCareerProgressWidget
	...
	namespace n_APortalWarsRaceGate { // : AActor
	...
	namespace n_APortalWarsOITC { // : APortalWarsGameMode
		constexpr auto bAllowAmmoStacking = 0x6e0; // bool
		constexpr auto bMeleeRequiredForAmmoStacking = 0x6e1; // bool
		constexpr auto MaxAmmo = 0x6e4; // int32_t
	}
	...
	namespace n_UPortalWarsNavBarWidget { // : UPortalWarsUserWidget
	...
	namespace n_UPortalWarsDiscardSettingsDialog { // : UPortalWarsDialogWidget
	...
	namespace n_ARocketLauncher { // : AProjectileGun
	...
	namespace n_UPortalWarsCustomScrollWidget { // : UPortalWarsUserWidget
	...
	namespace n_UPortalWarsHappyHourStatusWidget { // : UUserWidget
	...
	namespace n_UBTDecorator_WithinRange { // : UBTDecorator
	...
	namespace n_UPortalWarsPickupWidget { // : UPortalWarsUserWidget
	...
	namespace n_ABurstLineTraceGun { // : ALineTraceGun
	...
	namespace n_APortalWarsMediaSoundActor { // : AActor
	...
	namespace n_UPortalWarsLocalPlayer { // : ULocalPlayer
	...
	namespace n_UPortalWarsInspectItemWidget { // : UUserWidget
	...
	namespace n_UPortalWarsReferralPassWidget { // : UPortalWarsRewardPassWidget
	...
	namespace n_APortalSceneCapture2D { // : ASceneCapture2D
	...
	namespace n_UPortalWarsCurrencyPurchaseDialog { // : UPortalWarsTxnDialogWidget
	...
	namespace n_URaceBookmarkWidget { // : UUserWidget
	...
	namespace n_UPortalWarsRankLeaderboardWidget { // : UPortalWarsMenuWidget
	...
	namespace n_UPortalWarsFlagIndicatorWidget { // : UPortalWarsIndicatorWidget
		constexpr auto Pointer = 0x2b8; // UWidget*
	...
	namespace n_UPortalWarsUnlockDialogWidget { // : UPortalWarsDialogWidget
	...
	namespace n_UPortalWarsCurrencyStoreWidget { // : UPortalWarsItemShopSectionWidget
	...
	namespace n_UPortalWarsDropdownWidget { // : UPortalWarsInputWidget
		constexpr auto DefaultOptions = 0x368; // TArray<FText>
		constexpr auto DefaultIndex = 0x378; // int32_t
		constexpr auto ComboBox = 0x380; // UComboBoxString*
	}

	namespace n_UPortalWarsGameInstance { // : UGameInstance
	...
	namespace n_UPortalWarsKeybindOverlayWidget { // : UPortalWarsDialogWidget
		constexpr auto TitleText = 0x3a0; // UTextBlock*
	}

	namespace n_UPortalWarsKillcamKilledByWidget { // : UUserWidget
	...
	namespace n_UPortalWarsPostGameLobbyWidget { // : UPortalWarsLobbyWidget
	...
	namespace n_UPortalWarsRedeemKeyDialogWidget { // : UPortalWarsTxnDialogWidget
	...
	namespace n_UPortalWarsRoundIntermissionWidget { // : UUserWidget
	...
	namespace n_APortalWarsForgeGameMode { // : APortalWarsGameMode
		constexpr auto DefaultBuildPawnClass = 0x6e0; // APortalWarsForgeBuildCharacter*
	}
	...
	namespace n_UPortalWarsStreamStatusWidget { // : UPortalWarsUserWidget
	...
	namespace n_AEMPExplosiveProjectile { // : AExplosiveProjectile
	...
	namespace n_UPortalWarsCheckInRewardWidget { // : UPortalWarsRewardEntryWidget
	...
	namespace n_UPortalWarsRewardReceivedWidget { // : UPortalWarsDialogWidget
	...
	namespace n_UPortalWarsContaminationPlayerStatusWidget { // : UPortalWarsRoundPlayerStatusWidget
	...
	namespace n_UPortalWarsForgeCharInteractionComponent { // : UPortalWarsCharInteractionComponent
		constexpr auto MaxRotationPerSecond = 0xf0; // float
		constexpr auto MinRotationPerSecond = 0xf4; // float
		constexpr auto MaxScalePerSeconds = 0xf8; // float
		constexpr auto MinScalePerSeconds = 0xfc; // float
		constexpr auto MinTargetArmLength = 0x100; // float
		constexpr auto MaxTargetArmLength = 0x104; // float
		constexpr auto TargetArmLengthIncreasePerSecond = 0x108; // float
		constexpr auto LerpTargetArmLengthSpeed = 0x10c; // float
		constexpr auto GameplayObjectsResetAreaPosition = 0x110; // FVector
		constexpr auto HeldInteractableComponent = 0x120; // UPortalWarsForgeInteractableComponent*
		constexpr auto FocusedInteractableComponent = 0x128; // UPortalWarsForgeInteractableComponent*
		constexpr auto GrabSound = 0x158; // UAkAudioEvent*
		constexpr auto ReleaseSound = 0x160; // UAkAudioEvent*
		constexpr auto DeleteSound = 0x168; // UAkAudioEvent*
		constexpr auto InvalidActionSound = 0x170; // UAkAudioEvent*
	}
	...
	namespace n_UPortalWarsLobbySelectorButtonWidget { // : UPortalWarsEntryWidget
	...
	namespace n_UPortalWarsNameIndicatorWidget { // : UPortalWarsIndicatorWidget
	...
	namespace n_UPortalWarsMenuWidget { // : UPortalWarsUserWidget
	...
	namespace n_APortalWarsDOMGameState { // : APortalWarsGameState
		constexpr auto Hills = 0x8b8; // TArray<ADominationHill*>
	}
	...
	namespace n_UPortalWarsPartyInspectWidget { // : UPortalWarsMenuSelectWidget
	...
	namespace n_UBTTask_StrafeQuick { // : UBTTask_MoveTo
	...
	namespace n_UPortalWarsGamepadBindingCustomizeButtonWidget { // : UPortalWarsUserWidget
	...
	namespace n_UPortalWarsPostGameStatsWidget { // : UPortalWarsDialogWidget
	...
	namespace n_AOddballItemPickup { // : APortalWarsGunPickup
	...
	namespace n_UPortalWarsChallengesInspectWidget { // : UPortalWarsInspectWidget
	...
	namespace n_UPortalWarsNewsFeedWidget { // : UPortalWarsMenuCarouselWidget
	...
	namespace n_UPortalWarsStreakIncreaseWidget { // : UPortalWarsDialogWidget
	...
	namespace n_UPortalWarsAmmoCounterWidget { // : UUserWidget
	...
	namespace n_UBTTask_UsePortal { // : UBTTaskNode
		constexpr auto Timeout = 0x70; // float
	}

	namespace n_APortalWarsKOTHPlayerState { // : APortalWarsPlayerState
	...
	namespace n_UPortalWarsPlaylistEntryWidget { // : UPortalWarsEntryWidget
	...
	namespace n_UPortalWarsKillcamWidget { // : UUserWidget
	...
	namespace n_UPortalWarsPlayButtonWidget { // : UPortalWarsButtonWidget
	...
	namespace n_UPortalWarsReticleWidget { // : UUserWidget
	...
	namespace n_APortalWarsTakedownVIPPlayerState { // : APortalWarsTakedownPlayerState
	...
	namespace n_APortalWarsTakedownHUD { // : APortalWarsRoundHUD
	...
	namespace n_APortalWarsPickup { // : ATeleportableActor
		...
		constexpr auto bLowerNetUpdateFreqWhenIdle = 0x24c; // bool
		constexpr auto Goal = 0x260; // APortalWarsTutorialGoal*
		constexpr auto HiddenUntilGoal = 0x268; // int32_t
	}

	namespace n_UPortalWarsCountdownWidget { // : UUserWidget
	...
	namespace n_UPortalWarsModeSelectorEntryWidget { // : UPortalWarsEntryWidget
		constexpr auto CustomIndicator = 0x420; // UWidget*
		constexpr auto EditButton = 0x680; // UPortalWarsButton*
	}

	namespace n_UPortalWarsEvolutionHUDOverlayWidget { // : UPortalWarsTakedownHUDOverlayWidget
		constexpr auto EnemyGunStatus = 0x280; // UPortalWarsEvolutionGunStatusWidget*
	}

	namespace n_UPortalWarsCancelButtonWidget { // : UPortalWarsButtonWidget
	...
	namespace n_UPortalWarsProgressionUpdateDialogWidget { // : UPortalWarsDialogWidget
		constexpr auto XPUpdateWidget = 0x390; // UPortalWarsXPUpdateWidget*
	}

	namespace n_UPortalWarsRewardReceivedEntry { // : UPortalWarsRewardEntryWidget
	...
	namespace n_APortalWarsGGHUD { // : APortalWarsHUD
	...
	namespace n_UPortalWarsItemShopInspectWidget { // : UPortalWarsInspectWidget
		constexpr auto ItemsRoot = 0x3c0; // UWidget*
		constexpr auto ItemsPanel = 0x3c8; // UPortalWarsCustomScrollWidget*
	...
	namespace n_UPortalWarsMatchResultWidget { // : UUserWidget
		constexpr auto TitleText = 0x260; // UTextBlock*
		constexpr auto LeftStarImage = 0x268; // UImage*
		constexpr auto RightStarImage = 0x270; // UImage*
		constexpr auto TopBorderImage = 0x278; // UImage*
	...
	namespace n_UPortalWarsSeasonRewardsWidget { // : UUserWidget
	...
	namespace n_UPortalWarsNotificationEntryWidget { // : UPortalWarsPlayerEntryWidget
	...
	namespace n_UPortalWarsComboBoxString { // : UComboBoxString
	...
	namespace n_UPortalWarsAddFriendsWidget { // : UPortalWarsMenuWidget
	...
	namespace n_APortalWarsForcedTeleportTrigger { // : ATriggerBox
	...
	namespace n_UPortalWarsJoinInProgressWidget { // : UUserWidget
		constexpr auto FadeOutAnimation = 0x260; // UWidgetAnimation*
		constexpr auto TimeBeforeFadingOut = 0x268; // float
	}

	namespace n_UPortalWarsRaceScoreboardWidget { // : UPortalWarsScoreboardWidget
	...
	namespace n_APortalWarsGGPlayerState { // : APortalWarsPlayerState
	...
	namespace n_UPortalWarsRankLeaderboardEntry { // : UPortalWarsLeaderboardEntryWidget
	...
	namespace n_APortalWall { // : AActor
		constexpr auto validForAI = 0x220; // bool
		constexpr auto isDoubleSided = 0x221; // bool
		constexpr auto shouldDisableForCTF = 0x222; // bool
	...
	namespace n_UPortalWarsRoundScoreboardEntryWidget { // : UUserWidget
	...
	namespace n_APortalWarsGunPickup { // : APortalWarsPickup
	...
	namespace n_UPortalWarsCurrencyStoreEntry { // : UPortalWarsEntryWidget
	...
	namespace n_UPortalWarsChallengeButtonWidget { // : UPortalWarsEntryWidget
	...
	namespace n_APortalWarsRoundGameState { // : APortalWarsGameState
		constexpr auto CurrentRound = 0x8b8; // int32_t
		constexpr auto ReplicatedElapsedServerTime = 0x8c0; // int32_t
		constexpr auto TeamRoundScores = 0x8c8; // TArray<int32_t>
		constexpr auto RoundWinners = 0x8d8; // TArray<int32_t>
		constexpr auto IntermissionCam = 0x8f0; // ACameraActor*
	}
	...
	namespace n_APortalWarsForgeLobbyGameMode { // : APortalWarsLobbyGameMode
		constexpr auto ForgeGameModeAlias = 0x358; // FString
	}

	namespace n_UPortalWarsForgeObjectsMenuWidget { // : UPortalWarsMenuWidget
		constexpr auto GameplayButton = 0x338; // UPortalWarsButtonWidget*
		constexpr auto ObjectsButton = 0x340; // UPortalWarsButtonWidget*
		constexpr auto WeaponsButton = 0x348; // UPortalWarsButtonWidget*
		constexpr auto SpawnsButton = 0x350; // UPortalWarsButtonWidget*
		constexpr auto VolumesButton = 0x358; // UPortalWarsButtonWidget*
		constexpr auto ModesButton = 0x360; // UPortalWarsButtonWidget*
		constexpr auto PortalWallsButton = 0x368; // UPortalWarsButtonWidget*
		constexpr auto BlocksButton = 0x370; // UPortalWarsButtonWidget*
		constexpr auto BlockPiecesButton = 0x378; // UPortalWarsButtonWidget*
		constexpr auto FloorsButton = 0x380; // UPortalWarsButtonWidget*
		constexpr auto RailingsButton = 0x388; // UPortalWarsButtonWidget*
		constexpr auto RampsButton = 0x390; // UPortalWarsButtonWidget*
		constexpr auto TunnelsButton = 0x398; // UPortalWarsButtonWidget*
		constexpr auto WallsButton = 0x3a0; // UPortalWarsButtonWidget*
		constexpr auto WedgesButton = 0x3a8; // UPortalWarsButtonWidget*
		constexpr auto PropsButton = 0x3b0; // UPortalWarsButtonWidget*
		constexpr auto EnvironmentButton = 0x3b8; // UPortalWarsButtonWidget*
	}

	namespace n_UBTDecorator_CheckGameMode { // : UBTDecorator
	...
	namespace n_UPortalWarsPurchaseButtonWidget { // : UPortalWarsEntryWidget
	...
	namespace n_UPortalWarsBindingDisplayWidget { // : UPortalWarsUserWidget
		constexpr auto ActionText = 0x2a8; // UTextBlock*
		constexpr auto BindSwitcher = 0x2b0; // UWidgetSwitcher*
		constexpr auto KeyText = 0x2b8; // UTextBlock*
		constexpr auto KeyImage = 0x2c0; // UImage*
		constexpr auto ActionName = 0x2c8; // FString
		constexpr auto bIsControllerOnly = 0x2d8; // bool
		constexpr auto bIsMKBOnly = 0x2d9; // bool
	}
	...
	namespace n_UPortalWarsAnimInstanceV2 { // : UAnimInstance
	...
	namespace n_APortalWarsEvolutionGameState { // : APortalWarsShowdownGameState
		constexpr auto TeamInventoryIndexes = 0x928; // TArray<char>
	}

	namespace n_APortalWarsVIP { // : APortalWarsGameMode
		constexpr auto VIPDefaultInventoryClasses = 0x6e0; // TArray<TSoftClassPtr<UObject>>
		constexpr auto VIPKillScore = 0x6f0; // int32_t
		constexpr auto VIPSuicideScore = 0x6f4; // int32_t
	}

	namespace n_APortalWarsVotingGameState { // : APortalWarsLobbyGameState
		constexpr auto VoteInfoList = 0x970; // TArray<APortalWarsVoteInfo*>
	}
	...
	namespace n_UPortalWarsGlobalCarouselWidget { // : UPortalWarsInputCarouselWidget
	...
	namespace n_UPortalWarsMedalEntryWidget { // : UUserWidget
	...
	namespace n_AProjectileGun { // : AGun
	...
	namespace n_UPortalWarsStatsWidget { // : UPortalWarsMenuWidget
	...
	namespace n_UPortalWarsChallengeDialogWidget { // : UPortalWarsDialogWidget
	...
	namespace n_UBTTask_Strafe { // : UBTTaskNode
	...
	namespace n_APortalWarsEvolutionHUD { // : APortalWarsTakedownHUD
	...
	namespace n_UPortalWarsLoadingScreenWidget { // : UPortalWarsUserWidget
	...
	namespace n_UPortalWarsCheckBoxWidget { // : UPortalWarsInputWidget
	...
	namespace n_UPortalWarsCheckInDialogWidget { // : UPortalWarsTxnDialogWidget
		constexpr auto CurrencyText = 0x3c8; // UTextBlock*
	...
	namespace n_AOneFlagItem { // : AFlagItem
		constexpr auto OneFlagCTFGameState = 0x6d8; // APortalWarsOneFlagCTFGameState*
	}
	...
	namespace n_APortalWarsExponentialHeightFog { // : AInfo
		constexpr auto SceneRoot = 0x220; // USceneComponent*
		constexpr auto HighQualityFog = 0x228; // UExponentialHeightFogComponent*
		constexpr auto LowQualityFog = 0x230; // UExponentialHeightFogComponent*
	}
	...
	namespace n_APortalWarsForgePlayerController { // : APortalWarsPlayerController
		constexpr auto MaxFlySpeed = 0x6c8; // float
		constexpr auto MaxInteractFlySpeed = 0x6cc; // float
		constexpr auto bIsBuilding = 0x760; // bool
	}
	...
	namespace n_UPortalWarsSaveGame { // : USaveGame
		...
		constexpr auto ControllerForgePreset = 0x140; // int32_t
		constexpr auto CustomControllerForgeBindings = 0x148; // FControllerKeybindPreset
		constexpr auto ShouldShowBlood = 0x1b9; // bool
		constexpr auto PlayKillcamMode = 0x1bc; // int32_t
		constexpr auto ShouldPlayKillcam = 0x1c0; // bool
		constexpr auto ShouldRecordReplay = 0x1c1; // bool
		constexpr auto ClamberMode = 0x1c4; // int32_t
		constexpr auto InputDevice = 0x1c8; // int32_t
		constexpr auto EnemyColor = 0x1cc; // FLinearColor
		constexpr auto EnemyOutlineColor = 0x1dc; // FLinearColor
		constexpr auto AllyOutlineColor = 0x1ec; // FLinearColor
		constexpr auto AllyColorThroughWalls = 0x1fc; // FLinearColor
		constexpr auto ShowFPS = 0x20c; // bool
		constexpr auto ShowLatency = 0x20d; // bool
		constexpr auto ShowPing = 0x20e; // bool
		constexpr auto ShowNetInfo = 0x20f; // bool
		constexpr auto ShowSubtitles = 0x210; // bool
		constexpr auto ShowDamageNumbers = 0x211; // bool
		constexpr auto ShowLowAmmo = 0x212; // bool
		constexpr auto ShowSprintCrosshair = 0x213; // bool
		constexpr auto CustomCrosshairs = 0x218; // TMap<int32_t, int32_t>
		constexpr auto CustomCrosshairColor = 0x268; // FLinearColor
		constexpr auto EnemyCustomCrosshairColor = 0x278; // FLinearColor
		constexpr auto WantsToCrossPlay = 0x288; // bool
		constexpr auto bAnonymousMode = 0x289; // bool
		constexpr auto bHideNames = 0x28a; // bool
		constexpr auto bPartyChatOnly = 0x28b; // bool
		constexpr auto bHasCompletedTutorial = 0x28c; // bool
		constexpr auto TutorialStageID = 0x290; // int32_t
		constexpr auto bHasWatchedIntroVideo = 0x294; // bool
		constexpr auto bHasSeenBattlePassDialog = 0x295; // bool
		constexpr auto EquippedCustomizations = 0x298; // TArray<FCustomizationId>
		constexpr auto ViewedCustomizations = 0x2a8; // TArray<FCustomizationId>
		constexpr auto ViewedCustomizationCategories = 0x2b8; // TSet<FCustomizationCategory>
		constexpr auto bHasSeenLocker = 0x308; // bool
		constexpr auto PrevNewCustomizations = 0x310; // TSet<FCustomizationId>
		constexpr auto bHasSyncedNewCustomizations = 0x360; // bool
		constexpr auto ViewedStoreItems = 0x368; // TArray<FStoreItemInfo>
		constexpr auto ViewedLimitedTimeOffers = 0x378; // TArray<FString>
		constexpr auto LastViewedStore = 0x388; // TArray<FStoreItemInfo>
		constexpr auto ViewedChallenges = 0x398; // TArray<FChallengeData>
		constexpr auto MuteList = 0x3a8; // TArray<FString>
		constexpr auto LastLoginTime = 0x3b8; // FDateTime
		constexpr auto LoginAuthToken = 0x3c0; // FString
		constexpr auto PreferredMatchmakingRegionID = 0x3d0; // int32_t
		constexpr auto PreferredCustomRegionID = 0x3d4; // int32_t
		constexpr auto UnselectedPlaylists = 0x3d8; // TArray<FString>
		constexpr auto PlaylistPreferences = 0x3e8; // TMap<FString, FPlaylistPreference>
		constexpr auto CustomGamesFilters = 0x438; // FCustomGameBrowserFilters
		constexpr auto CustomGamePresets = 0x468; // TMap<FString, FGameModeData>
		constexpr auto ForgeMaps = 0x4b8; // TMap<FString, FForgeMap>
		constexpr auto LastGameVersion = 0x508; // FString
	}
	...
	namespace n_UPortalWarsDailyPlayStreakWidget { // : UPortalWarsMenuWidget
	...
	namespace n_UPortalWarsNotificationOverlayWidget { // : UPortalWarsUserWidget
	...
	namespace n_APortalWarsGameState { // : APortalWarsBaseGameState
		constexpr auto AnnouncerInterface = 0x7c0; // UAnnouncerInterface*
		constexpr auto AntiCheat = 0x7c8; // UPortalWarsCustomAntiCheat*
		constexpr auto bTeamGame = 0x7e8; // char : 1
		constexpr auto TeamScores = 0x7f0; // TArray<int32_t>
		constexpr auto Pickups = 0x870; // TArray<APortalWarsPickup*>
		constexpr auto OOBVolumes = 0x880; // TArray<AOutOfBoundsVolume*>
		constexpr auto PlayAreaVolumes = 0x890; // TArray<APlayAreaVolume*>
		constexpr auto Crowd = 0x8a0; // APortalWarsCrowd*
		constexpr auto Portals = 0x8a8; // TArray<APortal*>
	}
	...
	namespace n_UPortalWarsForgeReticleWidget { // : UUserWidget
		constexpr auto ReticleSwitcher = 0x260; // UWidgetSwitcher*
	}
	...
	namespace n_APlasmaRifle { // : AProjectileGun
	...
	namespace n_UPortalWarsPriceEntryWidget { // : UUserWidget
	...
	namespace n_UPortalWarsTutorialStepsWidget { // : UUserWidget
	...
	namespace n_UPortalWarsRaceLeaderboardWidget { // : UPortalWarsLeaderboardWidget
	...
	namespace n_UPortalWarsKeybindWidget { // : UPortalWarsInputWidget
	...
	namespace n_UPortalWarsPartyEntryWidget { // : UPortalWarsPlayerEntryWidget
	...
	namespace n_APortalWarsLineUpCharacter { // : AActor
		constexpr auto PlayerState = 0x250; // APortalWarsPlayerState*
		constexpr auto PlayerInfo = 0x260; // FEndGamePlayerInfo
		constexpr auto EmoteSequence = 0x498; // UAnimSequence*
		constexpr auto PlayerEntryWidgetClass = 0x4b8; // UPortalWarsPlayerEntryWidget*
		constexpr auto CurrentWeaponType = 0x4d8; // ECustomizationType
		constexpr auto MinWeaponPosePlayRate = 0x4e8; // float
		constexpr auto MaxWeaponPosePlayRate = 0x4ec; // float
		constexpr auto SceneRoot = 0x4f8; // USceneComponent*
		constexpr auto Suit = 0x500; // USkeletalMeshComponent*
		constexpr auto Jetpack = 0x508; // USkeletalMeshComponent*
		constexpr auto PortalGun = 0x510; // UStaticMeshComponent*
		constexpr auto Name = 0x518; // UWidgetComponent*
		constexpr auto DefaultMaterial = 0x520; // UMaterialInstance*
		constexpr auto Weapon = 0x528; // UStaticMeshComponent*
	}

	namespace n_UPortalWarsXPUpdateEntryWidget { // : UPortalWarsEntryWidget
	...
	namespace n_APortalWarsCTFHUD { // : APortalWarsHUD
	...
	namespace n_UPortalWarsCustomGameWidget { // : UPortalWarsMenuWidget
	...
	namespace n_UPortalWarsSettingsSubWidget { // : UPortalWarsMenuWidget
	...
	namespace n_UPortalWarsDOMHillIndicator { // : UPortalWarsHillIndicatorWidget
	...
	namespace n_UPortalWarsNetworkInfoWidget { // : UUserWidget
	...
	namespace n_UPortalWarsPlaylistSelectWidget { // : UPortalWarsMenuWidget
		constexpr auto PlaylistEntryWidgetClasses = 0x338; // TMap<EPlaylistType, UPortalWarsPlaylistEntryWidget*>
		constexpr auto PlaylistPanel = 0x388; // UPanelWidget*
		constexpr auto PlaylistCrossplayDialogWidgetClass = 0x390; // UPortalWarsPlaylistCrossplayDialogWidget*
		constexpr auto PlayButton = 0x398; // UPortalWarsButtonWidget*
		constexpr auto SeasonRewards = 0x3a0; // UWidget*
		constexpr auto NoteText = 0x3a8; // UTextBlock*
		constexpr auto NoteRoot = 0x3b0; // UWidget*
	}
	...
	namespace n_UPortalWarsPickupZoneAnimInstance { // : UAnimInstance
	...
	namespace n_APortalWarsBot { // : APortalWarsCharacter
	...
	namespace n_UPortalWarsScreenFadeWidget { // : UUserWidget
	...
	namespace n_UPortalWarsReportPlayerWidget { // : UPortalWarsMenuWidget
	...
	namespace n_UPWVoiceNotifications { // : UUserWidget
	...
	namespace n_UBTService_RefreshFocus { // : UBTService
	...
	namespace n_AAmbianceVolume { // : ATriggerVolume
	...
	namespace n_UPortalWarsBlockedPlayersWidget { // : UPortalWarsMenuWidget
	...
	namespace n_UPortalWarsLeaderboardsWidget { // : UPortalWarsMenuWidget
		constexpr auto RankLeaderboardWidget = 0x338; // UPortalWarsMenuWidget*
	}

	namespace n_UPortalWarsLobbyPlayerEntryWidget { // : UPortalWarsPlayerEntryWidget
	...
	namespace n_APortalWarsGunPickupZone { // : APortalWarsGunPickup
		...
		constexpr auto bMaterialDrivenAnimation = 0x320; // bool
		constexpr auto ActiveMaterials = 0x328; // TArray<UMaterialInterface*>
		constexpr auto PickupIndicatorWidget = 0x338; // UPortalWarsPickupZoneIndicator*
		constexpr auto AkComponent = 0x340; // UPortalWarsAkComponent*
		constexpr auto PlayAmbientLoopEvent = 0x348; // UAkAudioEvent*
		constexpr auto StopAmbientLoopEvent = 0x350; // UAkAudioEvent*
		constexpr auto bHidePickupPlatform = 0x35c; // bool
	}
	...
	namespace n_UBTService_ShootEnemy { // : UBTService
		constexpr auto defaultRange = 0x70; // float
		constexpr auto MinDifficultyToMelee = 0x74; // float
	}

	namespace n_UPortalWarsHUDWidget { // : UUserWidget
	...
	namespace n_APortalWarsPlayerController { // : APortalWarsBasePlayerController
	...
	namespace n_APortalWarsVIPPlayerState { // : APortalWarsPlayerState
		constexpr auto VIPInfo = 0xac9; // FVIPInfo
	}

	namespace n_UPortalWarsLockerButtonWidget { // : UPortalWarsEntryWidget
	...
	namespace n_UPortalWarsProgressRadialWidget { // : UUserWidget
	...
	namespace n_APortalWarsGameMode { // : APortalWarsBaseGameMode
		...
		constexpr auto DefaultInventoryClasses = 0x670; // TArray<TSoftClassPtr<UObject>>
		constexpr auto bAllowReplayRecording = 0x680; // bool
		constexpr auto bObjectiveGame = 0x681; // bool
		constexpr auto RelevantStats = 0x688; // TArray<FString>
	}
	...
	namespace n_UPortalWarsRadarMarkerWidget { // : UPortalWarsIndicatorWidget
	...
	namespace n_APreviewItem { // : AActor
	...
	namespace n_UPortalWarsMessageDialogWidget { // : UPortalWarsDialogWidget
		constexpr auto TitleText = 0x390; // UTextBlock*
	...
	namespace n_UBTService_AssignTarget { // : UBTService
	...
	namespace n_UBTDecorator_PortalIsNearSelf { // : UBTDecorator
		constexpr auto IdealXYRange = 0x68; // float
		constexpr auto bLinkedPortalsOnly = 0x6c; // bool
	}

	namespace n_UPortalWarsCharInteractionComponent { // : UActorComponent
		constexpr auto TraceDistance = 0xb0; // float
		constexpr auto TraceRadius = 0xb4; // float
	}
	...
	namespace n_AFlagItem { // : ASpecialItem
	...
	namespace n_UPortalWarsIKAnimInstance { // : UAnimInstance
	...
	namespace n_UPortalWarsMatchCanceledWidget { // : UUserWidget
		constexpr auto CountdownText = 0x260; // UTextBlock*
	}

	namespace n_UPortalWarsModeSelectorWidget { // : UPortalWarsMenuWidget
		...
		constexpr auto PresetOptionsDialogClass = 0x378; // UPortalWarsGameModeFileOptionsDialogWidget*
	}
	...
	namespace n_UPortalWarsVoteEntryWidget { // : UPortalWarsEntryWidget
	...
	namespace n_UPortalWarsDamageType { // : UDamageType
	...
	namespace n_UPortalWarsCareerWidget { // : UPortalWarsMenuWidget
	...
	namespace n_UAkAudioEvent { // : UObject
		constexpr auto RequiredBank = 0x28; // UAkAudioBank*
	...
	namespace n_UPortalWarsGameUserSettings { // : UGameUserSettings
	...
	namespace n_UPortalWarsChatWidget { // : UPortalWarsUserWidget
	...
	namespace n_APortalWarsGG { // : APortalWarsGameMode
		constexpr auto WeaponClasses = 0x6e0; // TArray<AGun*>
		constexpr auto bHumiliationEnabled = 0x6f0; // bool
	}
	...
	namespace n_ARailGun { // : AMultiKillGun
		constexpr auto ChargeAnim = 0x788; // FWeaponAnimMontage
		constexpr auto DischargeAnim = 0x798; // FWeaponAnimMontage
		constexpr auto ChargeStartEvent = 0x7a8; // UAkAudioEvent*
		constexpr auto ChargeStopEvent = 0x7b0; // UAkAudioEvent*
		constexpr auto DischargeEvent = 0x7b8; // UAkAudioEvent*
		constexpr auto ChargeFX_1P = 0x7c0; // UParticleSystem*
		constexpr auto ChargeFX_3P = 0x7c8; // UParticleSystem*
		constexpr auto ChargePSC_1P = 0x7d0; // UParticleSystemComponent*
		constexpr auto ChargePSC_3P = 0x7d8; // UParticleSystemComponent*
		constexpr auto timeToCharge = 0x7e0; // float
		constexpr auto BatteryPercentagePerShot = 0x7e4; // float
		constexpr auto ChargeCounter = 0x7e8; // UAmmoCounterWidgetComponent*
	}
	...
	namespace n_APortalWarsForgeGameState { // : APortalWarsGameState
		constexpr auto AutoSaveInterval = 0x8d8; // float
		constexpr auto SaveMessageWidget = 0x8e8; // UPortalWarsEntryWidget*
		constexpr auto SaveMessageWidgetClass = 0x8f0; // UPortalWarsEntryWidget*
		constexpr auto BuildLimitAreas = 0x8f8; // TArray<AActor*>
		constexpr auto SaveSuccededSound = 0x908; // UAkAudioEvent*
		constexpr auto SaveFailedSound = 0x910; // UAkAudioEvent*
		constexpr auto bPlaySoundOnAutoSave = 0x918; // bool
	}
	...
	namespace n_UPortalWarsPathFollowingComponent { // : UPathFollowingComponent
		constexpr auto CharacterMoveComp = 0x250; // UCharacterMovementComponent*
	}

	namespace n_UPortalWarsGateIndicatorWidget { // : UPortalWarsIndicatorWidget
		constexpr auto Pointer = 0x2b8; // UWidget*
		constexpr auto Offset = 0x2c0; // FVector
	}

	namespace n_UPortalWarsGamepadBindingMissingDialogWidget { // : UPortalWarsDialogWidget
	...
	namespace n_UPortalWarsPostGameCardWidget { // : UUserWidget
	...
	namespace n_APortalWarsBaseGameMode { // : AGameMode
	...
	namespace n_UAkAudioBank { // : UObject
	...
	namespace n_APWSpectatorPawn { // : ASpectatorPawn
	...
	namespace n_UPortalWarsGameplaySettingsWidget { // : UPortalWarsSettingsSubWidget
	...
	namespace n_UBTService_StuckMonitor { // : UBTService
	...
	namespace n_UPortalWarsHealthWidget { // : UUserWidget
	...
	namespace n_APortalWarsLobbyPlayerStart { // : APlayerStart
	...
	namespace n_UPortalWarsStatsPlaylistWidget { // : UPortalWarsMenuWidget
	...
	namespace n_AFlagItemPickup { // : APortalWarsGunPickup
	...
	namespace n_UBTService_FindPickup { // : UBTService
	...
	namespace n_UPortalWarsForgeInteractableIndicator { // : UPortalWarsIndicatorWidget
		constexpr auto DisplayName = 0x2b8; // UTextBlock*
	}

	namespace n_UPWProjectileMovementComponent { // : UProjectileMovementComponent
		constexpr auto AddlUpdatedComponents = 0x1d0; // TArray<UPrimitiveComponent*>
	}

	namespace n_UPortalWarsForgeSelectorButtonWidget { // : UPortalWarsEntryWidget
		constexpr auto DisplayImage = 0x420; // UImage*
		constexpr auto SelectedSwitcher = 0x428; // UWidgetSwitcher*
		constexpr auto BackgroundImage = 0x430; // UTexture2D*
	}
	...
	namespace n_APortalWarsCrowd { // : AActor
		constexpr auto AkComp = 0x220; // UPortalWarsAkComponent*
	...
	namespace n_UPortalWarsNumericCarouselWidget { // : UPortalWarsInputCarouselWidget
	...
	namespace n_UPortalWarsForgeBuildNameIndicator { // : UPortalWarsIndicatorWidget
		constexpr auto PlayerNameText = 0x2b8; // UTextBlock*
	}
	...
	namespace n_UPortalWarsChallengeEntryWidget { // : UPortalWarsRewardEntryWidget
	...
	namespace n_UPortalWarsEscapeMenuWidget { // : UPortalWarsMenuSelectWidget
	...
	namespace n_UPortalWarsCopyButtonWidget { // : UPortalWarsButtonWidget
		constexpr auto TimeToDisplayCopiedText = 0x3c8; // float
	}

	namespace n_APortalWarsGrenadePickupZone { // : APortalWarsGunPickupZone
		constexpr auto GrenadeName = 0x360; // FText
		constexpr auto PickupEvent = 0x378; // UAkAudioEvent*
	}
	...
	namespace n_UPortalWarsRedeemableButtonWidget { // : UPortalWarsPurchaseButtonWidget
	...
	namespace n_UPortalWarsMapSelectorEntryWidget { // : UPortalWarsEntryWidget
		constexpr auto EditButton = 0x538; // UPortalWarsButton*
		constexpr auto CustomIndicator = 0x540; // UImage*
	}

	namespace n_UPortalWarsSocialPlayerEntry { // : UPortalWarsPlayerEntryWidget
	...
	namespace n_UPortalWarsDialogWidget { // : UPortalWarsMenuWidget
	...
	namespace n_APortalWarsTeabagZone { // : AActor
	...
	namespace n_APortalWarsTutorialGameMode { // : APortalWarsGameMode
		constexpr auto TutorialDefaultInventoryClasses = 0x6e0; // TArray<FDefaultInventoryClass>
	}
	...
	namespace n_UBTService_RandomJump { // : UBTService
	...
	namespace n_UPortalWarsRankUpdateWidget { // : UPortalWarsDialogWidget
	...
	namespace n_UPortalWarsKeybindSettingsWidget { // : UPortalWarsSettingsSubWidget
	...
	namespace n_UPortalWarsCTFHUDOverlayWidget { // : UUserWidget
	...
	namespace n_UPortalWarsFlagResetStatusWidget { // : UUserWidget
	...
	namespace n_ALineTraceGun { // : AGun
	...
	namespace n_UPortalWarsVideoSettingsWidget { // : UPortalWarsSettingsSubWidget
	...
	namespace n_APortalWarsLobbyGameMode { // : APortalWarsBaseGameMode
		constexpr auto LineUpCharacterClass = 0x340; // APortalWarsLineUpCharacter*
		constexpr auto LobbyCam = 0x348; // ACameraActor*
	}
	...
	namespace n_UPWTutorialStepEntryWidget { // : UPortalWarsUserWidget
	...
	namespace n_UPortalWarsRaceDifficultySelectorWidget { // : UPortalWarsMenuWidget
		constexpr auto ItemsPanel = 0x338; // UPanelWidget*
		constexpr auto DifficultySelectorEntryClass = 0x340; // UPortalWarsRaceDifficultySelectorEntryWidget*
		constexpr auto DifficultyName = 0x348; // UTextBlock*
		constexpr auto DifficultyDescription = 0x350; // UTextBlock*
		constexpr auto MapName = 0x358; // UTextBlock*
	}

	namespace n_UPortalWarsDOMHUDOverlayWidget { // : UUserWidget
	...
	namespace n_UBTTask_ChoosePortal { // : UBTTaskNode
		constexpr auto PortalTraceRadius = 0x70; // float
	}

	namespace n_UPortalWarsRoundPlayerStatusWidget { // : UUserWidget
	...
	namespace n_UPortalWarsOneFlagCTFNotice { // : UUserWidget
		constexpr auto NoticeText = 0x260; // UTextBlock*
	}
	...
	namespace n_UPortalWarsItemShopPurchasePanel { // : UPortalWarsUserWidget
	...
	namespace n_UPortalWarsPauseMenuWidget { // : UPortalWarsMenuSelectWidget
		...
		constexpr auto SaveMapButton = 0x3f0; // UPortalWarsButtonWidget*
	}
	...
	namespace n_UPortalWarsDOMControlledHillWidget { // : UUserWidget
	...
	namespace n_UPortalWarsMenuCarouselWidget { // : UPortalWarsUserWidget
	...
	namespace n_AScoreboardComponent { // : ACullableActor
	...
	namespace n_UPortalWarsCustomLobbyWidget { // : UPortalWarsLobbyWidget
	...
	namespace n_UPortalWarsMainMenuWidget { // : UPortalWarsMenuWidget
	...
	namespace n_UPortalWarsButtonWidget { // : UPortalWarsUserWidget
	...
	namespace n_APortalWarsTeabagConfirmed { // : APortalWarsGameMode
		constexpr auto TeabagZoneClass = 0x6e0; // APortalWarsTeabagZone*
	}
	...
	namespace n_UAnnouncerInterface { // : UObject
	...
	namespace n_APortalWarsPostGameState { // : APortalWarsLobbyGameState
		constexpr auto bIsContinuousLobby = 0x970; // bool
	}
	...
	namespace n_UPortalWarsOddballIndicator { // : UPortalWarsIndicatorWidget
		constexpr auto Pointer = 0x2b8; // UWidget*
	...
	namespace n_UPortalWarsWaitingAreaHUDWidget { // : UUserWidget
	...
	namespace n_UPortalWarsKillcamHeaderWidget { // : UUserWidget
	...
	namespace n_UPortalWarsControllerPresetWidget { // : UPortalWarsUserWidget
	...
	namespace n_UPortalWarsLobbyWidget { // : UPortalWarsUserWidget
	...
	namespace n_APortalWarsNavLink_Jump { // : ANavLinkProxy
	...
	namespace n_UPortalWarsKOTHHillIndicator { // : UPortalWarsHillIndicatorWidget
	...
	namespace n_UPortalWarsReplayEntryWidget { // : UPortalWarsEntryWidget
	...
	namespace n_UPortalWarsQuitMenuWidget { // : UPortalWarsMenuWidget
	...
	namespace n_UIntegerSpinBox { // : UWidget
	...
	namespace n_UAkRoomComponent { // : USceneComponent
	...
	namespace n_UPortalWarsPrivacySettingsWidget { // : UPortalWarsSettingsSubWidget
	...
	namespace n_APortalWarsTakedownPlayerState { // : APortalWarsRoundPlayerState
	...
	namespace n_APortalWarsRaceLobbyGameMode { // : APortalWarsLobbyGameMode
		constexpr auto RaceGameModeAlias = 0x358; // FString
	}

	namespace n_UPortalWarsAudioSettingsWidget { // : UPortalWarsSettingsSubWidget
	...
	namespace n_UPortalWarsDecimalCarouselWidget { // : UPortalWarsInputCarouselWidget
		...
		constexpr auto bShouldWrap = 0x3b0; // bool
		constexpr auto SpinBox = 0x3b8; // USpinBox*
	}
	...
	namespace n_ANeutralFlagItem { // : AFlagItem
		constexpr auto NeutralCTFGameState = 0x6d8; // APortalWarsNeutralCTFGameState*
	}

	namespace n_UPortalWarsBattlePassWidget { // : UPortalWarsRewardPassWidget
	...
	namespace n_UPortalWarsPlayStreakRewardWidget { // : UPortalWarsRewardEntryWidget
	...
	namespace n_UPortalWarsPostGamePlayerEntry { // : UPortalWarsUserWidget
		constexpr auto PlayerNameText = 0x2a8; // UTextBlock*
	...
	namespace n_UPortalWarsRespawnWidget { // : UUserWidget
	...
	namespace n_UPortalWarsForgeHostMenuWidget { // : UPortalWarsHostMenuWidget
		constexpr auto MultiplayerSettingsWidget = 0x378; // UVerticalBox*
		constexpr auto MultiplayerCheckBox = 0x380; // UPortalWarsCheckBoxWidget*
	}
	...
	namespace n_UBTTaskNode_FindNearbyPortalWall { // : UBTTaskNode
		constexpr auto NearPortalWallRadius = 0x70; // float
	}
	...
	namespace n_UPortalWarsBattlePassEntryWidget { // : UPortalWarsRewardPassEntryWidget
		constexpr auto XPProgressBar = 0x798; // UProgressBar*
		constexpr auto FreeIndicator = 0x7b0; // UWidget*
	}

	namespace n_AProjectile { // : ACullableActor
	...
	namespace n_UPortalWarsGGHUDOverlayWidget { // : UUserWidget
	...
	namespace n_UPortalWarsPlayerActionsWidget { // : UPortalWarsMenuSelectWidget
	...
	namespace n_APortalWarsTakedownVIP { // : APortalWarsTakedown
		constexpr auto VIPDefaultInventoryClasses = 0x710; // TArray<TSoftClassPtr<UObject>>
		constexpr auto TakedownVIPGameState = 0x720; // APortalWarsTakedownVIPGameState*
		constexpr auto VIPKillScore = 0x728; // int32_t
	}
	...
	namespace n_UVivoxSubsystem { // : ULocalPlayerSubsystem
	...
	namespace n_UPortalWarsJoinServerDialogWidget { // : UPortalWarsDialogWidget
	...
	namespace n_UPortalWarsDOMHillStatusWidget { // : UUserWidget
	...
	namespace n_APortalWarsForgeHUD { // : APortalWarsHUD
		constexpr auto ForgeHUDOverlayWidget = 0x400; // UPortalWarsForgeHUDOverlayWidget*
		constexpr auto ForgeHUDOverlayWidgetClass = 0x408; // UPortalWarsForgeHUDOverlayWidget*
		constexpr auto ForgeInteractableIndicatorClass = 0x410; // UPortalWarsForgeInteractableIndicator*
		constexpr auto ForgeBuildNameIndicatorClass = 0x418; // UPortalWarsForgeBuildNameIndicator*
	}
	...
	namespace n_UPortalWarsIndicatorWidget { // : UUserWidget
	...
	namespace n_APortalWarsForgeBuildCharacter { // : ACharacter
		constexpr auto InteractionComponent = 0x4b8; // UPortalWarsForgeCharInteractionComponent*
		constexpr auto InteractablePlaceholder = 0x4c0; // USceneComponent*
		constexpr auto SpringArmComponent = 0x4c8; // USpringArmComponent*
		constexpr auto NameIndicatorOffset = 0x4d0; // FVector
		constexpr auto NameIndicatorWidget = 0x4e0; // UPortalWarsIndicatorWidget*
		constexpr auto BaseTurnRate = 0x4e8; // float
		constexpr auto BaseLookUpRate = 0x4ec; // float
		constexpr auto MaxMoveSpeed = 0x4f0; // float
		constexpr auto MinMoveSpeed = 0x4f4; // float
		constexpr auto MaxInteractMoveSpeed = 0x4f8; // float
		constexpr auto MinInteractMoveSpeed = 0x4fc; // float
		constexpr auto TimeToReachMaxAccel = 0x500; // float
		constexpr auto ControllerMaxAccelMultiplier = 0x504; // float
		constexpr auto DeleteTime = 0x528; // float
		constexpr auto InteractionTimelineComponent = 0x530; // UTimelineComponent*
		constexpr auto UpdateCameraRotationFloatCurve = 0x538; // UCurveFloat*
		constexpr auto CameraTargetClass = 0x540; // AActor*
		constexpr auto CameraTarget = 0x548; // AActor*
	}
	...
	namespace n_UPortalWarsPickupZoneIndicator { // : UPortalWarsPickupIndicatorWidget
	...
	namespace n_UPortalWarsRoundScoreboardWidget { // : UUserWidget
	...
	namespace n_UPortalWarsLockerEntryWidget { // : UPortalWarsEntryWidget
	...
	namespace n_APortal { // : ACullableActor
	...
	namespace n_APortalWarsNeutralCTFHUD { // : APortalWarsHUD
	...
	namespace n_UPortalWarsRaceHUDOverlay { // : UUserWidget
	...
	namespace n_UPortalWarsKilledByBannerWidget { // : UUserWidget
	...
	namespace n_UPortalWarsPostGameOverviewWidget { // : UPortalWarsDialogWidget
	...
	namespace n_UPortalWarsForgeObjectsMenuEntryWidget { // : UPortalWarsEntryWidget
		constexpr auto InteractableToSpawnClass = 0x420; // TSoftClassPtr<UObject>
	}

	namespace n_UPortalWarsStatsOverviewWidget { // : UPortalWarsMenuWidget
	...
	namespace n_UPortalWarsTutorialBookmarkWidget { // : UUserWidget
		constexpr auto MarksHorizontalBox = 0x260; // UHorizontalBox*
		constexpr auto CurrentMarkTexture = 0x268; // UTexture2D*
		constexpr auto IncompleteMarkTexture = 0x270; // UTexture2D*
		constexpr auto CompleteMarkTexture = 0x278; // UTexture2D*
	...
	namespace n_UPortalWarsItemShopSectionWidget { // : UPortalWarsUserWidget
		constexpr auto TitleText = 0x2a8; // UTextBlock*
	...
	namespace n_APortalWarsKOTHHill { // : AActor
	...
	namespace n_UPortalWarsKillFeedEntryWidget { // : UUserWidget
	...
	namespace n_UPortalWarsRoundHUDOverlayWidget { // : UUserWidget
	...
	namespace n_APortalWarsTutorialHUD { // : APortalWarsHUD
	...
	namespace n_APortalWarsKOTH { // : APortalWarsGameMode
		constexpr auto ActiveHill = 0x6e0; // APortalWarsKOTHHill*
		constexpr auto NextHill = 0x6e8; // APortalWarsKOTHHill*
		constexpr auto KOTHGameState = 0x6f0; // APortalWarsKOTHGameState*
		constexpr auto HillScore = 0x6f8; // int32_t
		constexpr auto HillTime = 0x6fc; // int32_t
		constexpr auto NextHillTime = 0x700; // int32_t
		constexpr auto Hills = 0x710; // TArray<APortalWarsKOTHHill*>
	}

	namespace n_UPortalWarsHostMenuWidget { // : UPortalWarsMenuWidget
	...
	namespace n_UPortalWarsXPUpdateWidget { // : UUserWidget
	...
	namespace n_UPortalWarsReplayHUDOverlayWidget { // : UPortalWarsUserWidget
	...
	namespace n_AOneFlagItemPickup { // : AFlagItemPickup
		constexpr auto OneFlagCTFGameState = 0x320; // APortalWarsOneFlagCTFGameState*
	}
	...
	namespace n_UPWKillcamTransitionWidget { // : UUserWidget
		constexpr auto FadeInAnimation = 0x260; // UWidgetAnimation*
		constexpr auto FadeOutAnimation = 0x268; // UWidgetAnimation*
	}
	...
	namespace n_UPortalWarsScoreboardStatEntry { // : UPortalWarsUserWidget
	...
	namespace n_UPortalWarsGameConfigWidget { // : UUserWidget
	...
	namespace n_UBTTask_SetFocus { // : UBTTask_BlackboardBase
	...
	namespace n_UPortalWarsCustomGameFiltersWidget { // : UPortalWarsDialogWidget
	...
	namespace n_UPortalWarsPausePlayersMenuWidget { // : UPortalWarsMenuWidget
	...
	namespace n_UPortalWarsTeamSelectWidget { // : UPortalWarsInputCarouselWidget
		constexpr auto Value = 0x3a0; // int32_t
	...
	namespace n_UPortalWarsScoreboardWidget { // : UUserWidget
		constexpr auto MapNameText = 0x260; // UTextBlock*
	...
	namespace n_UPortalWarsGamepadBindingWidget { // : UPortalWarsUserWidget
		...
		constexpr auto ForgeBindingOverlayClass = 0x370; // UPortalWarsGamepadBindingOverlayWidget*
	}
	...
	namespace n_APWReplayPlayerController { // : APortalWarsPlayerController
	...
	namespace n_UPortalWarsReplayPlayerWidget { // : UPortalWarsScoreboardPlayerWidget
	...
	namespace n_UPortalWarsDamageIndicatorWidget { // : UUserWidget
	...
	namespace n_UPortalWarsPickupIndicatorWidget { // : UPortalWarsIndicatorWidget
	...
	namespace n_AGrenadeLauncher { // : AProjectileGun
	...
	namespace n_APortalWarsCTFGameState { // : APortalWarsGameState
		constexpr auto AlphaFlag = 0x8b8; // AActor*
		constexpr auto BravoFlag = 0x8c0; // AActor*
		constexpr auto AlphaFlagState = 0x8c8; // EFlagState
		constexpr auto BravoFlagState = 0x8c9; // EFlagState
		constexpr auto CapturedFlagRespawnTime = 0x8cc; // float
	}

	namespace n_UBTTask_Wander { // : UBTTask_MoveTo
	...
	namespace n_AScoreboardScoreComponent { // : AScoreboardComponent
		constexpr auto Index = 0x288; // char
	}
	...
	namespace n_UPortalWarsCharMovementComponent { // : UCharacterMovementComponent
		constexpr auto PWCharOwner = 0xaf0; // APortalWarsCharacter*
		constexpr auto ClamberInfo = 0xafc; // FClamberInfo
	}

	namespace n_UPortalWarsLeaderboardWidget { // : UPortalWarsUserWidget
		constexpr auto WidgetSwitcher = 0x2b8; // UWidgetSwitcher*
		constexpr auto ErrorText = 0x2c0; // UTextBlock*
	...
	namespace n_UPortalWarsRaceMatchResultWidget { // : UPortalWarsMatchResultWidget
	...
	namespace n_APortalWarsOneFlagCTFGameState { // : APortalWarsRoundGameState
		constexpr auto AlphaFlag = 0x900; // AActor*
		constexpr auto BravoFlag = 0x908; // AActor*
		constexpr auto AlphaFlagState = 0x980; // EFlagState
		constexpr auto BravoFlagState = 0x981; // EFlagState
		constexpr auto CapturedFlagRespawnTime = 0x984; // float
	}
	...
	namespace n_UPortalWarsChallengeCompleteEntry { // : UPortalWarsChallengeEntryWidget
	...
	namespace n_UPortalWarsForgeBuildCharMovementComponent { // : UCharacterMovementComponent
		constexpr auto FlyingFriction = 0xb10; // float
		constexpr auto MoveTimelineFloatCurve = 0xb20; // UCurveFloat*
		constexpr auto MoveDistanceForMaxTime = 0xb28; // float
		constexpr auto MoveTimelineComponent = 0xb30; // UTimelineComponent*
	}
	...
	namespace n_UPortalWarsContaminationHUDOverlayWidget { // : UPortalWarsRoundHUDOverlayWidget
	...
	namespace n_APortalWarsCharacter { // : ACharacter
		...
		constexpr auto rotateToUprightSpeed = 0xb70; // float
		constexpr auto DoRep_collisionProfile = 0xb74; // char
	...
	namespace n_UPortalWarsVIPNameIndicatorWidget { // : UPortalWarsNameIndicatorWidget
	...
	namespace n_AOddballItem { // : ASpecialItem
	...
	namespace n_UBTTask_FindPickup { // : UBTTaskNode
		constexpr auto NearPickupRadius = 0x70; // float
	}
	...
	namespace n_APortalWarsKOTHHUD { // : APortalWarsHUD
	...
	namespace n_UPortalWarsServerEntryWidget { // : UPortalWarsEntryWidget
	...
	namespace n_UPortalWarsUISettingsWidget { // : UPortalWarsSettingsSubWidget
	...
	namespace n_UPortalWarsIntroVideoWidget { // : UPortalWarsDialogWidget
		constexpr auto MediaPlayer = 0x390; // UMediaPlayer*
		constexpr auto MediaSource = 0x398; // UMediaSource*
	}

	namespace n_APortalWarsRaceGameMode { // : APortalWarsGameMode
		constexpr auto NewRecordEvent = 0x718; // UAkAudioEvent*
	}
	...
	namespace n_UPortalWarsGamepadBindingOverlayWidget { // : UPortalWarsDialogWidget
	...
	namespace n_UPortalWarsFlagZoneIndicator { // : UPortalWarsIndicatorWidget
		constexpr auto Pointer = 0x2b8; // UWidget*
	}
	...
	namespace n_UPortalWarsEmoteWheelWedgeWidget { // : UUserWidget
	...
	namespace n_UPortalWarsKOTHHUDOverlayWidget { // : UUserWidget
	...
	namespace n_APortalWarsBaseGameState { // : AGameState
		...
		constexpr auto MaxPlayers = 0x4b4; // int32_t
	}
	...
	namespace n_UPortalWarsTakedownHUDOverlayWidget { // : UPortalWarsRoundHUDOverlayWidget
	...
	namespace n_APortalWarsHUD { // : AHUD
	...
	namespace n_UPortalWarsEmoteWheelWidget { // : UPortalWarsUserWidget
	...
	namespace n_AMainMenuPlayerController { // : APortalWarsBasePlayerController
	...
	namespace n_UPortalWarsPriceWidget { // : UUserWidget
	...
	namespace n_UPortalWarsTeamGlobalCarouselWidget { // : UPortalWarsInputWidget
	...
	namespace n_UPortalWarsTutorialVideoWidget { // : UPortalWarsUserWidget
	...
	namespace n_UPortalWarsCheckBox { // : UCheckBox
	...
	namespace n_UPortalWarsPlaySelectionWidget { // : UPortalWarsMenuWidget
		constexpr auto InspectWidget = 0x338; // UPortalWarsMenuWidget*
		constexpr auto UnrankedButton = 0x340; // UPortalWarsButtonWidget*
		constexpr auto FeaturedEntry = 0x348; // UPortalWarsPlaylistEntryWidget*
		constexpr auto RankedButton = 0x350; // UPortalWarsButtonWidget*
		constexpr auto PlaylistSelectWidgetClass = 0x358; // UPortalWarsPlaylistSelectWidget*
		constexpr auto CustomButton = 0x360; // UPortalWarsButtonWidget*
		constexpr auto CustomMenuWidgetClass = 0x368; // UPortalWarsCustomGameWidget*
		constexpr auto TrainingButton = 0x370; // UPortalWarsButtonWidget*
		constexpr auto TrainingMenuWidgetClass = 0x378; // UPortalWarsTrainingWidget*
		constexpr auto ForgeButton = 0x380; // UPortalWarsButtonWidget*
		constexpr auto ForgeMenuWidgetClass = 0x388; // UPortalWarsForgeGameWidget*
	}
	...
	namespace n_UAkComponent { // : USceneComponent
	...
	namespace n_UPortalWarsNameTagWidget { // : UUserWidget
	...
	namespace n_UPortalWarsRenameReplayDialogWidget { // : UPortalWarsTxnDialogWidget
		constexpr auto NameInput = 0x3d8; // UPortalWarsTextInputWidget*
	}

	namespace n_APWTutorialPlayerController { // : APortalWarsPlayerController
	...
	namespace n_UPortalWarsPlayWidget { // : UPortalWarsMenuWidget
	...
	namespace n_UPortalWarsCrosshairSelectWidget { // : UPortalWarsInputWidget
	...
	namespace n_UPortalWarsUnlockNoteEntryWidget { // : UUserWidget
	...
	namespace n_APortalWarsTutorialCharacter { // : APortalWarsCharacter
	...
	namespace n_UPortalWarsRecentPlayersWidget { // : UPortalWarsMenuWidget
		constexpr auto RefreshButton = 0x340; // UPortalWarsButtonWidget*
	...
	namespace n_UPortalWarsLockerSubWidget { // : UPortalWarsInspectWidget
	...
	namespace n_UPortalWarsPartyWidget { // : UPortalWarsUserWidget
	...
	namespace n_APortalWarsAIController { // : AAIController
	...
	namespace n_ADominationHill { // : AActor
	...
	namespace n_UPortalWarsLootboxWidget { // : UPortalWarsInspectWidget
	...
	namespace n_UPortalWarsGoalIndicatorWidget { // : UPortalWarsIndicatorWidget
		constexpr auto Pointer = 0x2b8; // UWidget*
	...
	namespace n_UPortalWarsTakedownVIPPlayerStatusWidget { // : UPortalWarsRoundPlayerStatusWidget
	...
	namespace n_APortalWarsOddballGameState { // : APortalWarsGameState
		constexpr auto Oddball = 0x8b8; // AActor*
		constexpr auto OddballState = 0x8c0; // EBallState
	}
	...
	namespace n_AGunImpactEffectManager { // : AActor
	...
	namespace n_UPortalWarsOutOfBoundsWidget { // : UUserWidget
	...
	namespace n_UPortalWarsItemShopEntry { // : UPortalWarsEntryWidget
	...
	namespace n_APortalWarsContamination { // : APortalWarsRoundGameMode
		constexpr auto ContaminationDefaultInventoryClasses = 0x6f8; // TArray<TSoftClassPtr<UObject>>
	}
	...
	namespace n_UPortalWarsGGNotificationWidget { // : UUserWidget
	...
	namespace n_UPortalWarsMapSelectorWidget { // : UPortalWarsMenuWidget
		constexpr auto SelectedWidget = 0x338; // UPortalWarsMapSelectorEntryWidget*
		constexpr auto ItemsPanel = 0x340; // UPanelWidget*
		constexpr auto CustomItemsPanel = 0x348; // UPanelWidget*
		constexpr auto MapSelectorEntryClass = 0x350; // UPortalWarsMapSelectorEntryWidget*
		constexpr auto MapImage = 0x358; // UImage*
		constexpr auto MapName = 0x360; // UTextBlock*
		constexpr auto MapDescription = 0x368; // UTextBlock*
	}
	...
	namespace n_UPortalWarsCustomAntiCheat { // : UObject
	...
	namespace n_UPortalWarsGameSessionReconnectDialog { // : UPortalWarsDialogWidget
	...
	namespace n_APortalWarsOddballHUD { // : APortalWarsHUD
	...
	namespace n_UBTDecorator_LOSToEnemy { // : UBTDecorator
	...
	namespace n_APortalWarsVoteInfo { // : AInfo
	...
	namespace n_UBTDecorator_WeaponCheck { // : UBTDecorator
	...
	namespace n_UPortalWarsClaimChallengeIndicatorWidget { // : UUserWidget
		constexpr auto ClaimText = 0x260; // UTextBlock*
	}

	namespace n_UPortalWarsDailyCheckInWidget { // : UPortalWarsMenuWidget
		constexpr auto RewardPanel = 0x338; // UPanelWidget*
	...
	namespace n_UPortalWarsNavButtonWidget { // : UPortalWarsEntryWidget
	...
	namespace n_UPortalWarsServerBrowserWidget { // : UPortalWarsMenuWidget
	...
	namespace n_UPortalWarsLineupAnimInstance { // : UAnimInstance
	...
	namespace n_APortalWarsDOMHUD { // : APortalWarsHUD
	...
	namespace n_UPortalWarsLockerWidget { // : UPortalWarsMenuWidget
		constexpr auto InspectWidget = 0x338; // UPortalWarsLockerSubWidget*
	}

	namespace n_UPortalWarsTakedownNotificationWidget { // : UUserWidget
	...
	namespace n_UPortalWarsFriendsListSubWidget { // : UPortalWarsMenuWidget
		constexpr auto RefreshButton = 0x340; // UPortalWarsButtonWidget*
	...
	namespace n_UPortalWarsEvolutionGunStatusWidget { // : UPortalWarsUserWidget
		constexpr auto WeaponImage = 0x2b8; // UImage*
		constexpr auto IconSizeBox = 0x2c0; // USizeBox*
		constexpr auto SecondaryWeaponImage = 0x2c8; // UImage*
		constexpr auto SecondaryIconSizeBox = 0x2d0; // USizeBox*
	}

	namespace n_UPortalWarsGGGunStatusWidget { // : UPortalWarsUserWidget
	...
	namespace n_APortalWarsTeamStart { // : APlayerStart
	...
	namespace n_APortalWarsKOTHGameState { // : APortalWarsGameState
		constexpr auto ActiveHill = 0x8b8; // APortalWarsKOTHHill*
		constexpr auto NextHill = 0x8c0; // APortalWarsKOTHHill*
	}
	...
	namespace n_APortalWarsVIPHUD { // : APortalWarsHUD
	...
	namespace n_UPortalWarsCustomSettingsWidget { // : UPortalWarsMenuWidget
	...
	namespace n_UPortalWarsOneFlagCTFHUDOverlayWidget { // : UPortalWarsRoundHUDOverlayWidget
		constexpr auto OneFlagCTFNotice = 0x278; // UPortalWarsOneFlagCTFNotice*
		constexpr auto OvertimeOneFlagCTFNotice = 0x280; // UPortalWarsOneFlagCTFNotice*
		constexpr auto OvertimeSwitcher = 0x288; // UWidgetSwitcher*
		constexpr auto DefenseIcon = 0x290; // UWidget*
		constexpr auto OffenseIcon = 0x298; // UWidget*
		constexpr auto NotificationText = 0x2a0; // UTextBlock*
		constexpr auto NotificationFadeAnimation = 0x2b0; // UWidgetAnimation*
		constexpr auto FlagResetStatus = 0x2b8; // UPortalWarsFlagResetStatusWidget*
	}
	...
	namespace n_UPortalWarsChatEntryWidget { // : UUserWidget
	...
	namespace n_UPortalWarsKillStackEntryWidget { // : UUserWidget
		constexpr auto FadeInAnimation = 0x268; // UWidgetAnimation*
		constexpr auto FadeOutAnimation = 0x270; // UWidgetAnimation*
	...
	namespace n_UPortalWarsSpinSliderWidget { // : UPortalWarsInputWidget
	...
	namespace n_UPortalWarsPlayerEntryWidget { // : UPortalWarsEntryWidget
	...
	namespace n_UPortalWarsDropsMenuWidget { // : UPortalWarsMenuWidget
	...
	namespace n_UPortalWarsChallengesWidget { // : UPortalWarsMenuWidget
	...
	namespace n_UPortalWarsTeamNumericCarouselWidget { // : UPortalWarsInputWidget
	...
	namespace n_APortalWarsTakedown { // : APortalWarsRoundGameMode
		constexpr auto TakedownGameState = 0x6f0; // APortalWarsTakedownGameState*
		constexpr auto RespawnChangePerKill = 0x6f8; // int32_t
		constexpr auto RespawnChangePerDeath = 0x6fc; // int32_t
		constexpr auto MinRespawnTime = 0x700; // int32_t
		constexpr auto MaxRespawnTime = 0x704; // int32_t
		constexpr auto FinalKillScore = 0x708; // int32_t
	}
	...
	namespace n_APortalWarsEvolution { // : APortalWarsTakedown
		constexpr auto InventoryClasses = 0x710; // TArray<FInventoryClass>
	}

	namespace n_UPortalWarsTutorialVideoReminderWidget { // : UPortalWarsUserWidget
	...
	namespace n_UPortalWarsFileOptionsDialogWidget { // : UPortalWarsDialogWidget
	...
	namespace n_UPortalWarsGamepadSettingsWidget { // : UPortalWarsSettingsSubWidget
	...
	namespace n_UPortalWarsItemShopWidget { // : UPortalWarsMenuWidget
	...
	namespace n_UPortalWarsChallengePanelWidget { // : UPortalWarsUserWidget
	...
	namespace n_UPortalWarsMedalsWidget { // : UUserWidget
	...
	namespace n_AOddballSpawnPoint { // : AActor
	...
	namespace n_UPortalWarsReplaysWidget { // : UPortalWarsMenuWidget
	...
	namespace n_UPortalWarsInviteManager { // : UObject
	...
	namespace n_UPortalWarsBPPurchaseDialogWidget { // : UPortalWarsTxnDialogWidget
	...
	namespace n_ABoxOutOfBoundsVolume { // : AOutOfBoundsVolume
		constexpr auto BoxComponent = 0x258; // UBoxComponent*
	}
	...
	namespace n_UPortalWarsNewsFeedEntryWidget { // : UPortalWarsEntryWidget
		constexpr auto DescriptionText = 0x420; // UTextBlock*
	...
	namespace n_APortalWarsPlayerState { // : APlayerState
	...
	namespace n_UPortalWarsPlaylistCrossplayDialogWidget { // : UPortalWarsDialogWidget
	...
	namespace n_UPortalWarsScoreboardPlayerWidget { // : UPortalWarsUserWidget
	...
	namespace n_UPortalWarsRoundCountdownWidget { // : UPortalWarsCountdownWidget
