...
struct FCTImportedLevellingData {
...
struct FCTImportedResourceItem {
...
struct FPopcornFXPlaySectionTemplate {
...
struct FCTDragonOverviewStateEggData {
...
struct FCTMiscellanousShopData {
...
struct FCTInputActionKeyMapping {
...
struct FPlayerPositionImportStruct {
...
struct FOptionsParametersSection {
	...
	TArray<UCTOptionsParameterController*> ParameterControllers; // 0x10
};
...
struct FCTDragonOverviewStateBabyData {
	FString CameraName; // 0x10
...
struct FCTImportedDynamicSectionSetup {
...
struct FPWBaseLiveEvent {
	...
	int32_t Ratio; // 0x48
	TArray<FPWPEarnStep> Steps; // 0x50
	...
	int32_t Goal; // 0x98
	int32_t Count; // 0x9c
	TArray<FPWCommunityStats> Stats; // 0xa0
};
...
struct FCTImportedMiscellanousShopData {
...
struct FCTImportedExclusiveShopData {
...
struct FCTMiscellanousShopSection {
...
struct FCTImportedLocalization {
	FString Key; // 0x8
...
struct FCTImportedPackGiftKeyItem {
...
struct FCTDragonOverviewStateAdultData {
...
struct FCTLiveEventRewardsNotifs {
	TArray<UCTPlayerLiveNotif*> RewardNotifs; // 0x0
};
...
struct FCTImportedAchievementsData {
	int32_t Threshold; // 0x8
	ECTQuestGameMode GameMode; // 0xc
	ECharacClassType CharacClass; // 0xd
	EMapEnvironment MapEnvironment; // 0xe
