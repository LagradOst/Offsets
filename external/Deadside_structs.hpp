...
struct FSFPSLocalityRespawnInfo {
	int32_t X; // 0x0
	int32_t Y; // 0x4
	int64_t TimeEnd; // 0x8
};
...
struct FSFPSServerAdminParams {
	...
	float GameTime; // 0x98
	float MissionTimeScale; // 0x9c
	bool bMissionTimeScaleValid; // 0xa0
	float EncounterTimeScale; // 0xa4
	bool bEncounterTimeScaleValid; // 0xa8
	float AirDropTimeScale; // 0xac
	bool bAirDropTimeScaleValid; // 0xb0
	float ConvoyTimeScale; // 0xb4
	bool bConvoyTimeScaleValid; // 0xb8
	float HeliCrashTimeScale; // 0xbc
	bool bHeliCrashTimeScaleValid; // 0xc0
	float RoamingTraderTimeScale; // 0xc4
	bool bRoamingTraderTimeScaleValid; // 0xc8
	bool bPatrolEnable; // 0xc9
	bool bDynamicTimeScaleEnable; // 0xca
	float AIDamageMultiplier; // 0xcc
	bool bAIDamageMultiplierValid; // 0xd0
	float AIHealthMultiplier; // 0xd4
	bool bAIHealthMultiplierValid; // 0xd8
...
struct FSFPSItemPrice {
	...
	int32_t SteamcoinsPrice; // 0x4
	bool bGameplayItem; // 0x8
};
