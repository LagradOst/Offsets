...
struct FGreatBuildingStepTemplate : FTableRowBase {
	...
	int32_t ManufactureType; // 0x3c
	int32_t ManufactureKind; // 0x40
	int32_t ManufactureNum; // 0x44
	int32_t BuildingIdCondition01; // 0x48
	int32_t BuildingIdCondition02; // 0x4c
	int32_t BuildingIdCondition03; // 0x50
	int32_t NeedType01; // 0x54
	int32_t NeedID01; // 0x58
	int32_t NeedUseID01; // 0x5c
	int32_t NeedCount01; // 0x60
	int32_t NeedType02; // 0x64
	int32_t NeedID02; // 0x68
	int32_t NeedUseID02; // 0x6c
	int32_t NeedCount02; // 0x70
	int32_t NeedType03; // 0x74
	int32_t NeedID03; // 0x78
	int32_t NeedUseID03; // 0x7c
	int32_t NeedCount03; // 0x80
	int32_t NeedType04; // 0x84
	int32_t NeedID04; // 0x88
	int32_t NeedUseID04; // 0x8c
	int32_t NeedCount04; // 0x90
	int32_t UpgradeTime; // 0x94
	int32_t GuildHelpTime; // 0x98
	int32_t EffectType01; // 0x9c
	TArray<int32_t> EffectValue01; // 0xa0
	TArray<int32_t> EffectNum01; // 0xb0
	TArray<int32_t> EffectString01; // 0xc0
	TArray<int32_t> EffectIcon01; // 0xd0
	int32_t EffectType02; // 0xe0
	TArray<int32_t> EffectValue02; // 0xe8
	TArray<int32_t> EffectString02; // 0xf8
	TArray<int32_t> EffectNum02; // 0x108
	TArray<int32_t> EffectIcon02; // 0x118
	int32_t EffectType03; // 0x128
	TArray<int32_t> EffectValue03; // 0x130
	TArray<int32_t> EffectString03; // 0x140
	TArray<int32_t> EffectNum03; // 0x150
	TArray<int32_t> EffectIcon03; // 0x160
	int32_t EffectType04; // 0x170
	TArray<int32_t> EffectValue04; // 0x178
	TArray<int32_t> EffectString04; // 0x188
	TArray<int32_t> EffectNum04; // 0x198
	TArray<int32_t> EffectIcon04; // 0x1a8
};
...
struct FItemMakeTemplate : FTableRowBase {
	...
	int32_t MakeFailReward01Type; // 0x11c
	int32_t MakeFailReward02Type; // 0x120
	int32_t MakeFailReward03Type; // 0x124
	int32_t MakeFailReward04Type; // 0x128
	int32_t MakeFailReward01Id; // 0x12c
	int32_t MakeFailReward02Id; // 0x130
	int32_t MakeFailReward03Id; // 0x134
	int32_t MakeFailReward04Id; // 0x138
	int32_t MakeFailReward01Count; // 0x13c
	int32_t MakeFailReward02Count; // 0x140
	int32_t MakeFailReward03Count; // 0x144
	int32_t MakeFailReward04Count; // 0x148
};
...
struct FSystemDataTemplate : FTableRowBase {
	...
	int32_t Per_NormalAtk_Min; // 0x178
	int32_t SaleItemBasket_MaxCount; // 0x17c
	int32_t FT_BlackIron_to_Coin_Cost; // 0x180
	int32_t FT_Coin_to_BlackIron_Cost; // 0x184
	int32_t FT_Coin_to_Balckiron_Sum_Denominator; // 0x188
	int32_t FT_BlackIron_to_Coin_Success_Mail; // 0x18c
	int32_t FT_BlackIron_to_Coin_Fail_Mail; // 0x190
	int32_t FT_Coin_to_BlackIron_Success_Mail; // 0x194
	int32_t FT_Coin_to_BlackIron_Fail_Normal_Mail; // 0x198
	int32_t FT_Coin_to_BlackIron_Fail_DailyLimit_Mail; // 0x19c
	int32_t FT_Coin_to_BlackIron_Fail_MaxLimit_Mail; // 0x1a0
	int32_t FT_Coin_Derby_StartHour; // 0x1a4
	int32_t FT_Coin_Derby_StartMin; // 0x1a8
	int32_t FT_Coin_Derby_KeepTime; // 0x1ac
	int32_t FT_Coin_DailySmeltLimit; // 0x1b0
	int32_t FT_Coin_DelayTime; // 0x1b4
	int32_t FT_Coin_Delay_BuffId; // 0x1b8
	int32_t DarkSteel_MinimumReserve; // 0x1bc
	int32_t FT_Hydra_to_Coin_Cost_ItemID; // 0x1c0
	int32_t FT_Hydra_to_Coin_Cost_Draco; // 0x1c4
	int32_t WorldChattingLv; // 0x1c8
	int32_t ItemAutoOptionChangeLevelLimit; // 0x1cc
	int32_t DarkSteel_Block_Buff; // 0x1d0
	int32_t GuildMarkerGlobalCool; // 0x1d4
};
...
struct FObjectMonGenTemplate : FTableRowBase {
	int32_t ObjectInteractionMonGenID; // 0x8
	int32_t StageId; // 0xc
	int32_t ObjectID; // 0x10
	int32_t UseId; // 0x14
	int32_t ItemCount; // 0x18
	int32_t PosID; // 0x1c
	int32_t CastingDesc; // 0x20
	int32_t ChannelType; // 0x24
	int32_t MonsterAppearTitle; // 0x28
	int32_t MonsterAppearString; // 0x2c
	int32_t MonsterDie; // 0x30
	int32_t DropID; // 0x34
};
...
struct FObjectTemplate : FTableRowBase {
	...
	int32_t MonsterId; // 0x9c
	int32_t MonGenType; // 0xa0
	int32_t CollectIcon; // 0xa4
	FVector IconCoordinate; // 0xa8
	float DecalScale; // 0xb4
	int32_t LinkOccupationId; // 0xb8
	int32_t BroadcastingSize; // 0xbc
	bool IsBossDropRewardBox; // 0xc0
};
