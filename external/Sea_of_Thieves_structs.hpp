...
struct FDockableCutsceneActionStateParams {
...
struct FWeightedProbabilityRangeOfRanges {
	TArray<FWeightedProbabilityRangeOfRangesFloatPair> SubRanges; // 0x20
};

struct FPointLightTemplate {
...
struct FDebugFlyingActionStateConstructionInfo {
...
struct FServerCameraFadeCompleteAckNetworkEvent {
...
struct FAnimNode_HIKSetProperty {
...
struct FCrewSessionLeaveCustomServerEvent {
	FString CrewId; // 0x18
};
...
struct FFortWaveCompletedCustomServerEvent {
	FName EventID; // 0x8
...
struct FContestNotificationNetworkEvent {
	UPopUpMessageDesc* PopUpDesc; // 0x10
};

struct FIngestedByKrakenActionStateConstructionInfo {
	FNetActorPtr Tentacle; // 0x30
};

struct FDebugSuperSailorSetFwdSpeedRPCEvent {
	float FwdSpd; // 0x10
};

struct FCustomTriggerOverlapCustomServerEvent {
...
struct FTestActionStateMessage2 {
...
struct FContestLaunchStartBlinds {
	FGuid CrewId; // 0x10
...
struct FQuestVariableLinkEQSContext {
	FName ParamName; // 0x8
};
...
struct FCrewSessionMatchmakingFollowedTelemetryEvent {
...
struct FTutorialStepBuyClothes {
	FTutorialStepDependencies Dependencies; // 0x20
};

struct FRevivePlayerActionStateConstructionInfo {
...
struct FTrackCommodityPurchaseOnServerRpc {
...
struct FLocomotionActionStateConstructionInfo {
	TWeakObjectPtr<AActor> ActorOwner; // 0x28
};
...
struct FTestActorActionStateConstructionInfo {
...
struct FHideInObjectActionStateConstructionInfo {
...
struct FDebugSuperSailorSetSpeedAmpRPCEvent {
...
struct FFinishIntroAnimaticTutorialStepRpc {
...
struct FControlObjectActionStateConstructionInfo {
	FNetObjectPtr DockToObject; // 0x30
	bool IsInteractingActorFemale; // 0x44
};

struct FAmmoChestStateData {
	int32_t Id; // 0x0
...
struct FQuestVariableTextArray {
	FName ParamName; // 0x8
};
...
struct FEventPlayerWithdrewVoyage {
	FText Title; // 0x10
};
...
struct FPlayerEmoteCustomServerEvent {
	FString UserId; // 0x18
	FString Emote; // 0x28
};
...
struct FGlobalCustomServerEvent {
	FName EventID; // 0x8
	FDateTime ServerTimeUTC; // 0x10
};
...
struct FTaleQuestFailedNetworkEvent {
...
struct FGetCannonsDataResponse {
...
struct FTestActionStateSerialisableData {
	int32_t IntProp; // 0x30
};

struct FTinySharkKilledNetworkEvent {
	UScriptStruct* Type; // 0x8
};
...
struct FCanShowTertiaryActionButton {
	bool CanShow; // 0x4
	FText Text; // 0x8
};
...
struct FPlayerObjectUsageStartCustomServerEvent {
	FString UserId; // 0x18
};
...
struct FCrewSessionLeaveTelemetryEvent {
	FGuid CrewId; // 0x0
};

struct FRewardHandInPopupNetworkEvent {
	UPopUpMessageDesc* PopUpDesc; // 0x10
...
struct FObjectLeakDetectionTelemetryRpc {
...
struct FQuestBaseTelemetryFragmentInput {
	FGuid QuestId; // 0x0
};
...
struct FPlayerRequiresMermaidCustomServerEvent {
	FName EventID; // 0x8
	FDateTime ServerTimeUTC; // 0x10
};
...
struct FNetworkEventStruct {
	UScriptStruct* Type; // 0x8
};

struct FQuestVariableChecklistItemArray {
	FName ParamName; // 0x8
};
...
struct FCharacterActionStateConstructionInfo {
...
struct FPlayerItemUsageTelemetryFragmentInput {
	UNotificationInputId* InputID; // 0x0
...
struct FAIShipCaptainActionStateSerialisableData {
...
struct FPlayerGeneratedMapsContainerHealthChangedCloseInventoryRpc {
	UScriptStruct* Type; // 0x8
};
...
struct FContestLeaderboardEntry {
...
struct FQuestVariableClassArray {
	FName ParamName; // 0x8
};
...
struct FVoteAddedNetworkEvent {
	FName CompanyId; // 0x10
	FGuid CrewId; // 0x18
};

struct FEventPlayerTextChatMessageUINotification {
...
struct FCargoRunCrateMetaWrapper {
...
struct FPlayerAggregatePositionTelemetryFragmentInput {
...
struct FLevelUnloadCompletedTelemetryEvent {
	FString LevelName; // 0x0
	int32_t LodLevel; // 0x10
	FVector PlayerPosition; // 0x14
	float DistanceFromPlayer; // 0x20
...
struct FShipSpawnedCustomServerEvent {
	FString ShipId; // 0x18
...
struct FOutgoingServerMigrationAbortedEvent {
	FGuid ServerId; // 0x0
...
struct FSpikeMechanismMaterialAnimationContext {
...
struct FAIShipSpawnedNetworkEvent {
	UScriptStruct* Type; // 0x8
};
...
struct FPlayerActionBaseTelemetryFragmentInput {
...
struct FCrewBaseTelemetryFragmentPlayerControllerLookupInput {
...
struct FQuestVariableClueSiteArray {
	FName ParamName; // 0x8
};
...
struct FBountyQuestTargetDefeatedNetworkEvent {
...
struct FTutorialStepBeginTallTale {
	FTutorialStepDependencies Dependencies; // 0x20
};
...
struct FSittingActionStateSerialisableData {
	FVector UndockLocation; // 0x30
	bool UndockRequested; // 0x3c
};
...
struct FRadialInventoryClearHighlight {
	int32_t RadialIdentifier; // 0x0
};
...
struct FTakeItemFromContainerRPC {
	FNetSubObjectPtr Container; // 0x10
	int32_t IndexToTake; // 0x24
};

struct FKrakenTentacleDestroyedCustomServerEvent {
...
struct FControlCapstanArmActionStateParams {
	FLookAtOffsetParams LookAtOffsetParams; // 0x18
};
...
struct FNullActionStateConstructionInfo {
	TWeakObjectPtr<AActor> ActorOwner; // 0x28
};
...
struct FEmissaryLeaderboardScoreUpdatedNetworkEvent {
...
struct FGetGeysersDataResponse {
	TArray<FGeyserStateData> Data; // 0x8
};

struct FQuestVariableItemDescType {
	FName ParamName; // 0x8
};
...
struct FTreasureSoldCustomServerEvent {
	FString UserId; // 0x18
	FString CrewId; // 0x28
...
struct FCrewSessionCreatedTelemetryEvent {
...
struct FResponseContendedResourcesNetworkEvent {
...
struct FPlayerItemRetrievalFromContainerCustomServerEvent {
	FString UserId; // 0x18
};
...
struct FSetTriggerDetectingEntityData {
...
struct FUseMapTableActionStateParams {
...
struct FPlayerChangedShipLoadoutCustomServerEvent {
	FString UserId; // 0x18
	FString ShipId; // 0x28
};
...
struct FStorageContainerHealthChangedCloseInventoryRpc {
	UScriptStruct* Type; // 0x8
};
...
struct FCookEndCustomServerEvent {
	FString UserId; // 0x18
...
struct FRepairObjectActionStateSerialisableData {
...
struct FUIReturnedToPlayerEvent {
	UScriptStruct* Type; // 0x8
};
...
struct FPlayerEncounterStartCustomServerEvent {
	FName EventID; // 0x8
	FDateTime ServerTimeUTC; // 0x10
};
...
struct FCollectorsChestMetaWrapper {
...
struct FCanShowSecondaryActionButton {
	bool CanShow; // 0x4
	FText Text; // 0x8
};
...
struct FZoomedInOnWieldableMapActionStateConstructionInfo {
	TWeakObjectPtr<AActor> ActorOwner; // 0x28
};
...
struct FTunnelOfTheDamnedBaseTelemetryFragmentInput {
...
struct FTutorialStepReturnToStranger {
	FTutorialStepDependencies Dependencies; // 0x20
};
...
struct FQuestVariableActorAssetTypeArray {
	FName ParamName; // 0x8
};
...
struct FClientDeveloperTelemetryEvent {
...
struct FTutorialStepCycleWeapons {
	FTutorialStepDependencies Dependencies; // 0x20
};
...
struct FAIShipSinkNetworkEvent {
	UScriptStruct* Type; // 0x8
};

struct FResponseEventSchedulerStatusNetworkEvent {
	TArray<FString> EventStatus; // 0x10
};

struct FPlayerBucketScoopCustomServerEvent {
	FString UserId; // 0x18
};
...
struct FEventPetRefusedFood {
	AActor* FeedingActor; // 0x10
};

struct FQuestVariableShipwreck {
	FName ParamName; // 0x8
};
...
struct FHttpResponseTelemetryFragmentInput {
	FString Method; // 0x0
...
struct FQuestVarPLSectionBundle {
	FName ParamName; // 0x8
};
...
struct FMatineeActorSetPositionNetworkEvent {
...
struct FInteractionInputComponentTickFunction {
...
struct FTreasureChestSoldInAllianceNetworkEvent {
	FName RewardId; // 0x10
...
struct FMerchantQuestContractExpiredNetworkEvent {
	UPopUpMessageDesc* PopUpDesc; // 0x10
};
...
struct FPlayerBaseTelemetryFragmentInput {
...
struct FQuestVariableBountyTargetArray {
	FName ParamName; // 0x8
};
...
struct FRevivedActionStateConstructionInfo {
	TWeakObjectPtr<AActor> ActorOwner; // 0x28
};
...
struct FEmissaryDiscoveredLootNetworkEvent {
...
struct FUseLadderActionStateParams {
...
struct FCrewSessionMatchmakingEndedTelemetryEvent {
...
struct FEmissaryMaxLevelReachedNetworkEvent {
...
struct FQuestVariableClass {
	FName ParamName; // 0x8
};

struct FStagingPlayerWelcomingPopup {
	FGuid LiveryID; // 0x10
};
...
struct FPremiumStoreBundleItem {
...
struct FQueryContendedResourcesRpc {
	UScriptStruct* Type; // 0x8
};
...
struct FQuestVariableNameArray {
	FName ParamName; // 0x8
};
...
struct FPioneerObjectiveCompleteNetworkEvent {
	bool Granted; // 0x10
};
...
struct FSpawnLaunchableShotRpc {
...
struct FGetSkeletonThronesDataResponse {
...
struct FEventClientPlayerSpawnedBeforeGameState {
	UScriptStruct* Type; // 0x8
};
...
struct FSleepingActionStateParams {
...
struct FAnimNode_HIKReachRotator {
	float Alpha; // 0x48
	float ReachT; // 0x4c
	float ReachR; // 0x50
...
struct FItemBuriedHistoryMetaWrapper {
...
struct FDockToObjectActionStateConstructionInfo {
	FNetObjectPtr DockToObject; // 0x30
	bool IsInteractingActorFemale; // 0x44
};

struct FSplineTransitionLadderActionStateParams {
	float DockTime; // 0x0
	float DelayAfterDockingTime; // 0x4
	float ForcedFieldOfView; // 0x8
	bool ForceStash; // 0xc
...
struct FCommoditySourceMetaWrapper {
...
struct FLevelCancelRequestedTelemetryEvent {
	float TimeCancelRequested; // 0x30
};

struct FTreasureMapWidgetLocalisedText {
	FText Text; // 0x20
};
...
struct FCachedMovieSceneEvaluationTemplate {
...
struct FPlayerActionCannonCustomServerEvent {
	FString UserId; // 0x18
	FString ShipId; // 0x28
};

struct FContestRequestScoreBoardData {
	UScriptStruct* Type; // 0x8
};
...
struct FClientRequestTeleportCompleteAckNetworkEvent {
...
struct FSceneDialogueStartNetworkEvent {
	UScriptStruct* Type; // 0x8
};
...
struct FProjectileWeaponFiredCustomServerEvent {
	FString UserId; // 0x18
};

struct FClientRequestAsyncLoadingCompleteAckNetworkEvent {
...
struct FAshenLordEncounterServiceDesc {
...
struct FWatercraftSpawnCustomServerEvent {
...
struct FLoadoutRepairFailedTelemetryEvent {
...
struct FPlayerGeneratedMapsContainerUnregisterServerEventsRpc {
...
struct FAIShipDespawnCustomServerEvent {
...
struct FMigrationActionStateConstructionInfo {
...
struct FHullDamagePersistenceModel {
...
struct FSetRadialTitleText {
	FText Text; // 0x8
};

struct FAITelemetryFragmentInput {
...
struct FCinematicEmissaryNetworkEvent {
	int32_t Level; // 0x10
	FName Tag; // 0x14
};
...
struct FQueryMigrationStatusRpc {
...
struct FReviveableActionStateConstructionInfo {
...
struct FEntityCustomServerEvent {
...
struct FQuestVariableName {
	FName ParamName; // 0x8
};

struct FAllianceStatusChangedNetworkEvent {
	UPopUpMessageDesc* PopUpDesc; // 0x10
};
...
struct FPlayCutsceneNetworkEvent {
...
struct FFiredFromActorActionStateConstructionInfo {
...
struct FEmissaryEncounteredSkellyFortNetworkEvent {
	FName CompanyName; // 0x10
};
...
struct FCinematicQuestNetworkEvent {
...
struct FAIKnockbackActionStateConstructionInfo {
...
struct FLeaveGhostShipActionStateConstructionInfo {
...
struct FRadialInventorySlotHighlighted {
...
struct FCanShowQuaternaryActionButton {
	bool CanShow; // 0x4
	FText Text; // 0x8
};
...
struct FQuestVariableDataAsset {
	FName ParamName; // 0x8
};
...
struct FEmissaryProgressUpdatedNetworkEvent {
...
struct FPlayerRevivalCustomServerEvent {
	FString UserId; // 0x18
};
...
struct FAIShipSpawnCustomServerEvent {
	FString AIShipId; // 0x18
};
...
struct FPlayerLeftGhostShipCustomServerEvent {
	FName EventID; // 0x8
	FDateTime ServerTimeUTC; // 0x10
};

struct FEmissaryKilledAnotherEmissaryNetworkEvent {
	FName CompanyName; // 0x10
...
struct FShipOnFireEndCustomServerEvent {
	FString ShipId; // 0x18
};
...
struct FSkeletonThroneStateData {
	int32_t Id; // 0x0
	FVector Position; // 0x4
	FString IslandName; // 0x10
};

struct FHideRadialInventory {
...
struct FQuestVariableItemSpawnDataTypeArray {
	FName ParamName; // 0x8
};
...
struct FRequestBucketStateRpc {
	EBucketState RequestedBucketState; // 0x18
};

struct FQuestVariableTaleResourceHandle {
	FName ParamName; // 0x8
};
...
struct FTutorialStepSellTreasure {
...
struct FShovelCustomServerEvent {
	FString UserId; // 0x18
};
...
struct FCurrencyGrantedNetworkEvent {
	EWalletCurrencyId CurrencyId; // 0x10
...
struct FTreasureMapWidgetTextWithScaledWidthBackground {
...
struct FItemSpawnCustomServerEvent {
	FString ItemId; // 0x18
...
struct FTransitionLadderActionStateParams {
	float DockTime; // 0x0
	float DelayAfterDockingTime; // 0x4
	float ForcedFieldOfView; // 0x8
	bool ForceStash; // 0xc
...
struct FControlObjectActionStateSerialisableData {
	FVector UndockLocation; // 0x30
	bool UndockRequested; // 0x3c
};
...
struct FProjectileHitCustomServerEvent {
...
struct FSittingActionStateConstructionInfo {
...
struct FPickupObjectActionStateConstructionInfo {
...
struct FMeleeWeaponAttackCustomServerEvent {
	FString UserId; // 0x18
};

struct FBountySpawnerAudioChangedNetworkEvent {
...
struct FPlayerRadialChatCustomServerEvent {
	FString UserId; // 0x18
};
...
struct FPlayerObjectUsageTelemetryFragmentInput {
	TWeakObjectPtr<UObject> ObjectBeingUsed; // 0x0
};
...
struct FClamberActionStateConstructionInfo {
...
struct FClientScheduleShutdownNetworkEvent {
...
struct FWaitForDemoResetActionStateConstructionInfo {
	TWeakObjectPtr<AActor> ActorOwner; // 0x28
};
...
struct FQuestVariablePlayerActor {
	FName ParamName; // 0x8
};
...
struct FBeachNPCSpawnFlowNetworkEvent {
...
struct FTreasureChestSoldNetworkEvent {
	FName RewardId; // 0x10
};
...
struct FControlWheelActionStateParams {
	FLookAtOffsetParams LookAtOffsetParams; // 0x18
};
...
struct FModalInteractionActionStateSerialisableData {
...
struct FAIShipEncounterZoneEnteredNetworkEvent {
...
struct FLevelLoadRequestedTelemetryEvent {
	FString LevelName; // 0x0
	int32_t LodLevel; // 0x10
	FVector PlayerPosition; // 0x14
	float DistanceFromPlayer; // 0x20
...
struct FQuestVariableAISpawnerArray {
	FName ParamName; // 0x8
};
...
struct FServerAsyncLoadingCompleteAckNetworkEvent {
...
struct FMerchantQuestCrateFilledNetworkEvent {
...
struct FShipCustomizationPersistenceModel {
...
struct FAIShipDamagedCustomServerEvent {
	FString AIShipId; // 0x18
...
struct FShipFireLightRelativeSpawnDesc {
...
struct FSleepingActionStateSerialisableData {
	FVector UndockLocation; // 0x30
	bool UndockRequested; // 0x3c
};
...
struct FKrakenSpawnCustomServerEvent {
...
struct FControlPulleyActionStateParams {
	FLookAtOffsetParams LookAtOffsetParams; // 0x18
};
...
struct FTreasureMapWidgetLocalisedTextWithFontOverride {
...
struct FBeingRetractedActionStateConstructionInfo {
...
struct FModalInteractionActionStateConstructionInfo {
...
struct FEnableObjectLeakDetectionTelemetryRpc {
	float Interval; // 0x10
};
...
struct FUseLadderActionStateConstructionInfo {
...
struct FCharacterMovementComponentPreClothTickFunction {
	ETickingGroup TickGroup; // 0x30
	char bTickEvenWhenPaused : 1; // 0x32
	char bCanEverTick : 1; // 0x32
	char bStartWithTickEnabled : 1; // 0x32
...
struct FAggressiveGhostShipsEncounterServiceDesc {
	FStringAssetReference ServiceParamsAssetPath; // 0x0
};
...
struct FKrakenPlayerGrabbingBehaviourParams {
...
struct FEmergantVoyageQuestDesc {
	FString Title; // 0x8
	bool IsEmergent; // 0x18
	FName IslandName; // 0x1c
};
...
struct FBootyItemInfoMetaWrapper {
	FGuid BootyId; // 0x18
};
...
struct FGetStorageContainersDataResponse {
...
struct FRequestContestStateEvent {
	UScriptStruct* Type; // 0x8
};
...
struct FAIFixedWavesSpawnerArchive {
...
struct FQuestVariableChecklistItem {
	FName ParamName; // 0x8
};
...
struct FQuestVariableOrientedPoint {
	FName ParamName; // 0x8
};
...
struct FGetBeaconsDataResponse {
...
struct FEmissaryDiscoveredCargoRunCrateNetworkEvent {
	FName CompanyName; // 0x10
};
...
struct FOutgoingServerMigrationStartedEvent {
	FGuid ServerId; // 0x0
	FGuid MigrationId; // 0x10
};
...
struct FAISwimmingCreatureDeadActionStateParams {
...
struct FTakeAllItemsFromContainerRPC {
	FNetSubObjectPtr Container; // 0x10
	int32_t IndexToTake; // 0x24
};
...
struct FPlayerInReviveableStateCustomServerEvent {
	FString UserId; // 0x18
};

struct FPlayerHealthChangeCustomServerEvent {
	FString UserId; // 0x18
};
...
struct FMatineeActorPlayNetworkEvent {
	AMatineeActor* MatineeActor; // 0x10
};
...
struct FEventPetNotFed {
	AActor* FeedingActor; // 0x10
};

struct FNPCStateData {
	FString Name; // 0x20
};
...
struct FAIBountySpawnerArchive {
...
struct FWatercraftDespawnCustomServerEvent {
	FString WatercraftId; // 0x18
};
...
struct FMeleeBlockingActionStateConstructionInfo {
...
struct FGetAmmoChestsDataResponse {
	TArray<FAmmoChestStateData> Data; // 0x8
};

struct FContestShipSinkNetworkEvent {
...
struct FQuestVariableTinySharkExperience {
	FName ParamName; // 0x8
};
...
struct FClientRequestCameraFadeCompleteAckNetworkEvent {
...
struct FQuestVariablePlayerStat {
	FName ParamName; // 0x8
};
...
struct FAISpawnActionStateConstructionInfo {
...
struct FTeleportActionStateConstructionInfo {
...
struct FPlayerDeveloperTelemetryEvent {
	FString EventTag; // 0x0
	FJsonObjectWrapper Json; // 0x10
};

struct FBowSplashProbe {
...
struct FCrewBaseTelemetryFragmentPlayerCharacterLookupInput {
...
struct FPlayerItemUsageEndCustomServerEvent {
	FString UserId; // 0x18
};
...
struct FWeightedItemDescSpawnDataWithRandomQuantity {
...
struct FPermanentPromptNetworkEvent {
...
struct FTreasureMapWidgetStreamedTexture {
...
struct FUpdateScoreBalanceHUDEvent {
...
struct FFishingActionStateConstructionInfo {
	TWeakObjectPtr<AActor> ActorOwner; // 0x28
};
...
struct FMaterialInformationTranslationData {
...
struct FClientRequestExitControlObjectActionStateNetworkEvent {
	UScriptStruct* Type; // 0x8
};

struct FTakeControlActionStateConstructionInfo {
...
struct FQuestVariableMerchantItem {
	FName ParamName; // 0x8
};

struct FContestLeaderboardUpdateEvent {
...
struct FMovieSceneLegacyTrackInstanceTemplate {
...
struct FAIIncrementalWaveSpawnerArchive {
...
struct FMovieSceneAdditiveCameraAnimationTrackTemplate {
	EMovieSceneCompletionMode CompletionMode; // 0x10
};
...
struct FDebugSuperSailorActionStateConstructionInfo {
	TWeakObjectPtr<AActor> ActorOwner; // 0x28
};
...
struct FFireGridLowDetailRelativeSpawnDesc {
...
struct FPlayerActionCustomServerEvent {
	FString UserId; // 0x18
	FString Action; // 0x28
};
...
struct FPlayerCapstanUsageStartCustomServerEvent {
	FString UserId; // 0x18
	FString ShipId; // 0x28
};
...
struct FHideInObjectActionStateParams {
...
struct FMountedWeaponFireRejectionRpc {
...
struct FRepairLoadoutFromSeedRpc {
...
struct FClientRequestExitConcealingObjectNetworkEvent {
	UScriptStruct* Type; // 0x8
};
...
struct FMerchantQuestContractCompleteNetworkEvent {
	UPopUpMessageDesc* PopUpDesc; // 0x10
};
...
struct FShipDestroyedCustomServerEvent {
	FString ShipId; // 0x18
};
...
struct FEnterTunnelOfTheDamnedActionStateConstructionInfo {
...
struct FAnimNode_BlendListByObject {
...
struct FPlayerGameFishingCustomServerEvent {
	FString UserId; // 0x18
};

struct FPlayLandmarkReactionRPC {
...
struct FPlayerBucketEmptyCustomServerEvent {
	FString UserId; // 0x18
};
...
struct FWieldableItemFirstTimeEquipRpc {
...
struct FServerActionStateClientStartedAckNetworkEvent {
	UScriptStruct* Type; // 0x8
};
...
struct FMoveToLocationActionStateConstructionInfo {
...
struct FPlayerSetFootLocationCustomServerEvent {
	FString UserId; // 0x18
...
struct FUndoRepairActionStateConstructionInfo {
...
struct FShipBaseTelemetryFragmentInput {
...
struct FTeleportActionStateSerialisableData {
...
struct FHitRegRecordProjectileShotRpc {
	FGuid AttackId; // 0x10
...
struct FTreasureDroppedCustomServerEvent {
	FString UserId; // 0x18
...
struct FAISpawnCustomServerEvent {
	FString AIId; // 0x18
	FString AIType; // 0x28
};

struct FQuestVariableTransform {
...
struct FAIProgressiveWavesSpawnerArchive {
	int32_t CurrentWaveIndex; // 0x8
};
...
struct FShipMastCollapseStateCustomServerEvent {
	FString ShipId; // 0x18
	FString MastId; // 0x28
};

struct FQuestVariableNotificationDesc {
	FName ParamName; // 0x8
};
...
struct FTransitionLadderActionStateConstructionInfo {
	float StartingInteractionHeight; // 0x48
	char ClimbId; // 0x4c
...
struct FPostReviveLocomotionActionStateConstructionInfo {
	TWeakObjectPtr<AActor> ActorOwner; // 0x28
};
...
struct FContestCrewPositionTelemetryFragmentInput {
	FGuid CrewId; // 0x0
};

struct FRadialInventoryCenterUpdated {
	float X; // 0x4
	float Y; // 0x8
};
...
struct FPlayerHeartbeatCustomServerEvent {
	FString UserId; // 0x18
};
...
struct FGetShipwrecksDataResponse {
...
struct FEmergentContestVoyageRecipe {
...
struct FTutorialStepEndOfTutorial {
	FTutorialStepDependencies Dependencies; // 0x20
};
...
struct FAIShipEncounterCompleteNetEvent {
...
struct FRewardGrantedNetworkEvent {
...
struct FSceneDialogueEndNetworkEvent {
	UScriptStruct* Type; // 0x8
};
...
struct FNetworkDataTelemetryFragmentInput {
...
struct FStorageContainerMetaWrapper {
	FStringAssetReference StoredStructType; // 0x8
};
...
struct FMerchantCrateMetaWrapper {
	float Health; // 0x18
...
struct FContestStateChangedEvent {
...
struct FSwallowedByKrakenActionStateConstructionInfo {
	FNetActorPtr Tentacle; // 0x30
};
...
struct FCrewOwnershipTrackingComponentMetaWrapper {
...
struct FShovelDigActionStateConstructionInfo {
...
struct FAnimNode_HIKFloorContact {
...
struct FSittingActionStateParams {
	EControllableObjectType ControllableObjectType; // 0x18
...
struct FShipDamagedCustomServerEvent {
	FString ShipId; // 0x18
};
...
struct FClamberActionStateParams {
...
struct FCheatPerformedByClientNetworkEvent {
...
struct FOtherPartyTelemetryFragmentInput {
...
struct FQuestVariableSetEQSTaleContextValue {
	FName ParamName; // 0x8
};
...
struct FPlayerKillAICustomServerEvent {
	FString UserId; // 0x18
};
...
struct FOpenableItemMetaWrapper {
...
struct FTinySharkSpawnedNetworkEvent {
	UScriptStruct* Type; // 0x8
};
...
struct FLinearTransitionLadderActionStateConstructionInfo {
	float StartingInteractionHeight; // 0x48
	char ClimbId; // 0x4c
	ELadderTransitionMode LadderTransitionMode; // 0x4d
	FLadderDefinition LadderDefinition; // 0x50
...
struct FLevelCancelCompletedTelemetryEvent {
...
struct FStowAllItemsToContainerRPC {
	FNetSubObjectPtr Container; // 0x10
...
struct FEjectFromTunnelOfTheDamnedActionStateConstructionInfo {
	int32_t TunnelId; // 0x30
	int32_t TunnelStreamingLevelId; // 0x34
	FTeleportLocation TeleportLocation; // 0x38
};
...
struct FQuestVariableGuidArray {
	FName ParamName; // 0x8
};
...
struct FMaterialInformationAudioData {
...
struct FEmissarySoldLootNetworkEvent {
	FName CompanyName; // 0x10
};
...
struct FQuestVariableSharkPawn {
	FName ParamName; // 0x8
};

struct FPetSpawnActionStateConstructionInfo {
	TWeakObjectPtr<AActor> ActorOwner; // 0x28
};
...
struct FQuestVariableClueDescriptor {
	FName ParamName; // 0x8
};

struct FControlPulleyActionStateConstructionInfo {
...
struct FPlayDockableKeyedInstrumentActionStateParams {
	float CameraDockTime; // 0x18
};
...
struct FEmissaryDeactivatedNetworkEvent {
	UScriptStruct* Type; // 0x8
};
...
struct FLinearTransitionActionStateConstructionInfo {
...
struct FQuestVariableArray {
	FName ParamName; // 0x8
};

struct FQuestVariableActorArray {
	FName ParamName; // 0x8
};
...
struct FVoyageBaseTelemetryFragmentInput {
	FGuid VoyageId; // 0x0
};
...
struct FPlayerCapstanUsageEndCustomServerEvent {
	FString UserId; // 0x18
	FString ShipId; // 0x28
};
...
struct FTriggerPlayerControllerHitNotificationNetworkEvent {
	UScriptStruct* Type; // 0x8
};
...
struct FThrowGrenadeMulticastRpc {
	AActor* Wielder; // 0x10
...
struct FPetBaseTelemetryFragmentInput {
...
struct FMountedWeaponFireAcknowledgeRpc {
	UObject* MountedWeaponObject; // 0x10
};

struct FCargoRunQuestDesc {
...
struct FExitTunnelOfTheDamnedActionStateConstructionInfo {
...
struct FPlayerItemEquipCustomServerEvent {
	FString UserId; // 0x18
};
...
struct FEmissaryStoleLootNetworkEvent {
	FName CompanyName; // 0x10
};
...
struct FPlayerPositionTelemetryFragmentInput {
...
struct FServerDeveloperTelemetryEvent {
	FString EventTag; // 0x0
	FJsonObjectWrapper Json; // 0x10
};

struct FSwingMechanismMaterialAnimationContext {
	UMeshComponent* Mesh; // 0x8
	TArray<UMaterialInstanceDynamic*> DynamicMaterials; // 0x10
};
...
struct FAIShipEncounterZoneExitedNetworkEvent {
	UScriptStruct* Type; // 0x8
};
...
struct FOnCannonBallHitShipCustomServerEvent {
...
struct FHiddenActionStateConstructionInfo {
	TWeakObjectPtr<AActor> ActorOwner; // 0x28
};
...
struct FServerTeleportCompleteAckNetworkEvent {
...
struct FClientTallTaleDebugInfoNetworkEvent {
...
struct FShipPartDamagePersistenceModel {
...
struct FEndClothSimulationFunction {
	ETickingGroup TickGroup; // 0x30
	char bTickEvenWhenPaused : 1; // 0x32
	char bCanEverTick : 1; // 0x32
	char bStartWithTickEnabled : 1; // 0x32
...
struct FQuestVariablePageLayout {
	FName ParamName; // 0x8
};
...
struct FSeasonProgressionUITelemetryFragmentInput {
	TWeakObjectPtr<APlayerController> PlayerController; // 0x0
};

struct FInteractObjectActionStateConstructionInfo {
...
struct FQuestVariableTradeRouteData {
	FName ParamName; // 0x8
};

struct FCrewSessionBaseSessionTelemetryEvent {
...
struct FSplineTransitionLadderActionStateConstructionInfo {
	float StartingInteractionHeight; // 0x48
	char ClimbId; // 0x4c
	ELadderTransitionMode LadderTransitionMode; // 0x4d
	FLadderDefinition LadderDefinition; // 0x50
...
struct FPlayerStatusEffectActivatedCustomServerEvent {
	FString UserId; // 0x18
	FString Effect; // 0x28
};
...
struct FResponseMigrationStatusNetworkEvent {
...
struct FTestActionStateConstructionInfoWithObjPointers {
...
struct FPlayerStatusEffectDeactivatedCustomServerEvent {
	FString UserId; // 0x18
	FString Effect; // 0x28
};
...
struct FFocusRadialInventorySlot {
	int32_t SlotIndex; // 0x4
};
...
struct FTinySharkSpawnCustomServerEvent {
	FName EventID; // 0x8
	FDateTime ServerTimeUTC; // 0x10
};
...
struct FNPCDialogExecuteOptionOnServerRpc {
...
struct FKrakenAnchorDynamicsParams {
	float AnchorForce; // 0x0
	float VelocityDeadZoneThreshold; // 0x4
	UCurveFloat* UnaryWheelAngleBasedTorque; // 0x8
	UCurveFloat* ForwardSpeedBasedTorque; // 0x10
...
struct FDockableBaseActionStateParams {
	FLookAtOffsetParams LookAtOffsetParams; // 0x18
};
...
struct FStartClothSimulationFunction {
	ETickingGroup TickGroup; // 0x30
	char bTickEvenWhenPaused : 1; // 0x32
	char bCanEverTick : 1; // 0x32
	char bStartWithTickEnabled : 1; // 0x32
...
struct FKrakenIdleBehaviourParams {
	UEnvQuery* InactiveSpawnQueryTemplate; // 0x0
	float ChanceOfCannonSideSpawn; // 0x8
	UEnvQuery* ActiveCannonSideSpawnQueryTemplate; // 0x10
	UEnvQuery* ActiveNonCannonSideSpawnQueryTemplate; // 0x18
...
struct FTakeMapFromContainerRPC {
	FNetSubObjectPtr Container; // 0x10
...
struct FMapTablePersistenceModel {
	TArray<FVector2D> MapPins; // 0x0
};
...
struct FQuestVariableActorAssetType {
	FName ParamName; // 0x8
};
...
struct FEventNPCChatUINotification {
...
struct FAmmoTransferMetaWrapper {
	int32_t AmmoCount; // 0x18
};
...
struct FItemInfoHealthMetaWrapper {
...
struct FPlayerDeathCustomServerEvent {
	FString UserId; // 0x18
};
...
struct FTaleQuestVariableMapMarkType {
	FName ParamName; // 0x8
};
...
struct FSittingThirdPersonCameraActionStateConstructionInfo {
	UAthenaSpringArmComponentParams* SpringArmParams; // 0x30
	float VerticalOffsetFactorWhenZoomed; // 0x38
};

struct FStowItemToContainerRPC {
	FNetSubObjectPtr Container; // 0x10
	UItemDesc* ItemDescToStow; // 0x28
};

struct FQuestVariableObjectArray {
	FName ParamName; // 0x8
};
...
struct FWaitingToSpawnActionStateConstructionInfo {
...
struct FSplineTransitionLadderActionFinishedMessage {
...
struct FCrewPlayerLeftCustomServerEvent {
	FString CrewId; // 0x18
};
...
struct FSleepingActionStateConstructionInfo {
	FSleepingActionStateParams SleepingActionStateParams; // 0x48
};

struct FCrewBaseTelemetryFragmentInput {
	FGuid CrewId; // 0x0
};

struct FPlayerBrigStatusChanged {
...
struct FCapturedByKrakenActionStateConstructionInfo {
	FNetActorPtr Tentacle; // 0x30
};
...
struct FTalkToNPCActionStateConstructionInfo {
...
struct FCampaignCompletedNetworkEvent {
	FName Name; // 0x10
};
...
struct FTreasureChestSoldInContestNetworkEvent {
	FName RewardId; // 0x10
	FText CrewName; // 0x18
...
struct FPlayerSpawnCustomServerEvent {
	FString UserId; // 0x18
};
...
struct FTutorialStepPlayIntroAnimatic {
...
struct FActorActionStateConstructionInfo {
	TWeakObjectPtr<AActor> ActorOwner; // 0x28
};
...
struct FQuestVariableVectorArray {
	FName ParamName; // 0x8
};
...
struct FQuestVariableAIDioramaDesc {
	FName ParamName; // 0x8
};
...
struct FFlatWaterMeshTextureOverride {
...
struct FTestActionStateMessage {
...
struct FInteractLoadableActionStateConstructionInfo {
...
struct FTreasureSpawnedCustomServerEvent {
	FName EventID; // 0x8
	FDateTime ServerTimeUTC; // 0x10
};
...
struct FUseMountedWeaponActionStateParams {
	float CameraDockTime; // 0x18
...
struct FEmissarySunkNetworkEvent {
	UDataAsset* PopUpDesc; // 0x10
...
struct FVoteRemovedNetworkEvent {
	FName CompanyId; // 0x10
	FGuid CrewId; // 0x18
};
...
struct FMermaidSpawnedCustomServerEvent {
	FVector Position; // 0x18
};
...
struct FPlayerEncounterEndCustomServerEvent {
	FName EventID; // 0x8
	FDateTime ServerTimeUTC; // 0x10
};
...
struct FMermaidUsedCustomServerEvent {
	FString UserId; // 0x18
};
...
struct FMatineeActorStopNetworkEvent {
	AMatineeActor* MatineeActor; // 0x10
};

struct FQuestVariablePageBundle {
	FName ParamName; // 0x8
};
...
struct FMatchmakingVoyageRecipe {
...
struct FUpdateCameraPositionRpc {
	AAthenaPlayerController* AthenaPlayerController; // 0x10
	FVector Location; // 0x18
	FRotator Rotation; // 0x24
};
...
struct FAnimNode_WeightedLoadOnDemandSquencePlayer {
	float PlayRate; // 0x40
...
struct FAIPersistentSpawnerWave {
	bool CacheHealthOnDespawn; // 0x100
	UAIClassId* AITypeToCache; // 0x108
};

struct FTreasureMapWidgetTexture {
	UTexture* Image; // 0x18
...
struct FSetRadialItemsAggregate {
...
struct FCanShowPrimaryActionButton {
	bool CanShow; // 0x4
};
...
struct FUseItemNoParamsOnServerRpc {
	AWieldableItem* Item; // 0x10
};

struct FQuestVariableContestIslandArchetype {
	FName ParamName; // 0x8
};
...
struct FLevelMadeVisibleTelemetryEvent {
...
struct FTestTelemetryInheritanceLevel1Struct {
	FString B; // 0x10
};
...
struct FQuestVariableItemSpawnDataType {
	FName ParamName; // 0x8
};
...
struct FPlayNpcAnimationNetworkEvent {
	AActor* TargetActor; // 0x10
...
struct FRepairObjectActionStateConstructionInfo {
	FNetSubObjectPtr RepairableObject; // 0x30
...
struct FQuestVariableAISpawner {
	FName ParamName; // 0x8
};
...
struct FPremiumStoreBundleOffer {
...
struct FFortKeyUsedCustomServerEvent {
	FString UserId; // 0x18
};
...
struct FCollectionSkeleMeshLimits {
	int32_t MaxVerts; // 0x0
	int32_t MaxMemory; // 0x4
};
...
struct FQuestVariableAssetArray {
	FName ParamName; // 0x8
};
...
struct FTestControlObjectActionStateConstructionInfo {
	float DockTime; // 0x48
};
...
struct FTaleQuestNotificationStepEvent {
	UPopUpMessageDesc* PopUpDesc; // 0x10
	FNetActorPtr DiscoveringPlayerStateNetPtr; // 0x18
};

struct FWaterBarrelActionStateParams {
	FLookAtOffsetParams LookAtOffsetParams; // 0x18
};
...
struct FControlObjectActionStateParams {
...
struct FWaterSlideActionStateConstructionInfo {
	USceneComponent* SceneComponent; // 0x30
};

struct FShipwreckDiscoveredRpc {
...
struct FPrepareForWorldSwitchRpc {
	UScriptStruct* Type; // 0x8
};
...
struct FClientConditionsCompleteNetworkEvent {
	UScriptStruct* Type; // 0x8
};
...
struct FEventPetReactedToFood {
	EPetFeedingReactionType ReactionType; // 0x10
};

struct FAnimNode_HIKRelativePlant {
	float Alpha; // 0x48
	float Depth; // 0x4c
...
struct FEventPlayerTeleportToSafety {
	UScriptStruct* Type; // 0x8
};
...
struct FOutgoingServerMigrationCompletedEvent {
	FGuid ServerId; // 0x0
	FGuid MigrationId; // 0x10
};
...
struct FPirateGeneratorBakeFailureTelemetryEvent {
...
struct FStorageContainerStateData {
	TMap<FString, int32_t> Items; // 0x20
};

struct FQuestVariableText {
	FName ParamName; // 0x8
};
...
struct FHullCharringPersistenceModel {
...
struct FQueryEventSchedulerStatusRpc {
	UScriptStruct* Type; // 0x8
};
...
struct FCinematicCrewNetworkEvent {
	TArray<APlayerState*> CrewMembersPlayerStates; // 0x10
	FText Header; // 0x20
	FName Tag; // 0x58
};

struct FUseItemActionStateConstructionInfo {
	FNetActorPtr UsableObject; // 0x30
	UNotificationInputId* InputID; // 0x48
};
...
struct FSkeletalMeshComponentPreClothTickFunction {
	ETickingGroup TickGroup; // 0x30
	char bTickEvenWhenPaused : 1; // 0x32
	char bCanEverTick : 1; // 0x32
	char bStartWithTickEnabled : 1; // 0x32
...
struct FTreasureFoundCustomServerEvent {
	FString UserId; // 0x18
	FString TreasureType; // 0x28
};
...
struct FCollectionStaticMeshLimits {
	int32_t MaxVerts; // 0x0
	int32_t MaxMemory; // 0x4
};
...
struct FMaterialInformationVFXData {
...
struct FWieldingParamsAssetLookup {
...
struct FEnableRadialInventoryMouseControl {
	int32_t RadialIdentifier; // 0x0
};
...
struct FLevelUnloadRequestedTelemetryEvent {
	FString LevelName; // 0x0
	int32_t LodLevel; // 0x10
	FVector PlayerPosition; // 0x14
	float DistanceFromPlayer; // 0x20
...
struct FLevelLoadCompletedCustomServerEvent {
	FName EventID; // 0x8
	FDateTime ServerTimeUTC; // 0x10
};
...
struct FLinearTransitionLadderActionStateParams {
	float Duration; // 0x10
};
...
struct FStorageContainerUnregisterServerEventsRpc {
...
struct FEmissarySecuredLootOnShipNetworkEvent {
	FName CompanyName; // 0x10
};

struct FFirstPersonAnimaticActionStateConstructionInfo {
...
struct FQuestVariableItemDescTypeArray {
	FName ParamName; // 0x8
};
...
struct FLinearTransitionActionStateParams {
	float Duration; // 0x10
};
...
struct FTreasurePickedUpCustomServerEvent {
	FString UserId; // 0x18
};
...
struct FUndoRepairActionStateSerialisableData {
	bool SuccessfulUndo; // 0x30
};

struct FLevelMadeHiddenTelemetryEvent {
	FString LevelName; // 0x0
	int32_t LodLevel; // 0x10
	FVector PlayerPosition; // 0x14
	float DistanceFromPlayer; // 0x20
...
struct FPlayerCharacterEnteredShipCustomServerEvent {
	int32_t UserId; // 0x18
	int32_t ShipId; // 0x1c
};
...
struct FCrewSessionMatchmakingStartedTelemetryEvent {
...
struct FDeadActionStateConstructionInfo {
...
struct FDebugSuperSailorSetYawSpeedRPCEvent {
	float YawSpd; // 0x10
};
...
struct FQuestVariableCollection {
	FName ParamName; // 0x8
};
...
struct FStunnedActionStateConstructionInfo {
...
struct FXMarksTheSpotQuestParams {
...
struct FCookStartCustomServerEvent {
	FString UserId; // 0x18
	FString FoodType; // 0x28
};
...
struct FGetCampfiresDataResponse {
...
struct FLaunchedFromKrakenActionStateConstructionInfo {
...
struct FVoyageProposalCompletedNetworkEvent {
...
struct FPlayerItemAddToContainerCustomServerEvent {
	FString UserId; // 0x18
};
...
struct FQuestVariableCrewShipManifest {
	FName ParamName; // 0x8
};
...
struct FEmoteActionStateConstructionInfo {
...
struct FShowTutorialNotificationUIEvent {
	TArray<FText> Text; // 0x0
	TArray<FString> Images; // 0x10
	FString Background; // 0x20
	TArray<FString> FlagIcons; // 0x30
...
struct FPlayerChangedLoadoutCustomServerEvent {
	FString UserId; // 0x18
};
...
struct FTriggerPlaceableReactionEvent {
...
struct FLevelLoadCompletedTelemetryEvent {
...
struct FLoadoutRepairSuccessTelemetryEvent {
...
struct FGetVolcanoesDataResponse {
...
struct FCrewSessionJoinedTelemetryEvent {
...
struct FAIShipEncounterRevealNetEvent {
	int32_t BattleIdx; // 0x10
...
struct FResponseServerMemoryNetworkEvent {
...
struct FQuestVariablePrioritisedPrompt {
	FName ParamName; // 0x8
};
...
struct FShipRepairCustomServerEvent {
	FString UserId; // 0x18
	FString ShipId; // 0x28
};
...
struct FMigrationSetupCompleteNetworkEvent {
	UScriptStruct* Type; // 0x8
};
...
struct FSetNonVerbalOptionWithImages {
...
struct FVoyageChestDiscoveredInContest {
...
struct FSetNonVerbalOption {
	TArray<FString> Phrases; // 0x8
};

struct FStopNpcAnimationNetworkEvent {
	AActor* TargetActor; // 0x10
	APlaceableReaction* PlaceableReaction; // 0x18
};

struct FSceneDialogueBaseNetworkEvent {
	UScriptStruct* Type; // 0x8
};
...
struct FXMarksTheSpotQuestDesc {
...
struct FToggleCinematicModeRpc {
