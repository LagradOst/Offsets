...
struct FRigUnit_RigLogic_Data {
	TWeakObjectPtr<USkeletalMeshComponent> SkelMeshComponent; // 0x0
	uint32_t CurrentLOD; // 0x8
	TArray<int32_t> InputCurveIndices; // 0x20
	TArray<int32_t> HierarchyBoneIndices; // 0x30
	TArray<FRigUnit_RigLogic_IntArray> MorphTargetCurveIndices; // 0x40
	TArray<FRigUnit_RigLogic_IntArray> BlendShapeIndices; // 0x50
	TArray<FRigUnit_RigLogic_IntArray> CurveContainerIndicesForAnimMaps; // 0x60
	TArray<FRigUnit_RigLogic_IntArray> RigLogicIndicesForAnimMaps; // 0x70
	TArray<bool> UpdatedJoints; // 0x80
	uint32_t BlendShapeMappingCount; // 0x90
	int32_t NeckFemaleAverageCorCurveIndex; // 0x94
	int32_t NeckMaleMuscularCorExpCurveIndex; // 0x98
};
...
struct FCraftingRecipeParams {
	TSoftClassPtr<UObject> ProductClass; // 0x0
	TMap<USkill*, ESkillLevel> SkillLevels; // 0x28
	TArray<FCraftingSlotParams> Slots; // 0x78
};

struct FCraftingSlotParams {
	TArray<TScriptInterface<ICraftingIngredient>> Ingredients; // 0x0
};
...
struct FCustomZoneConfiguration {
	FString Name; // 0x0
	FLinearColor Color; // 0x10
	ECustomZoneEventHandlingMethod DamageHandlingMethod[0xf]; // 0x20
	ECustomZoneEventHandlingMethod PlayerLockpickingHandlingMethod; // 0x2f
	ECustomZoneEventHandlingMethod WorldLockpickingHandlingMethod; // 0x30
	ECustomZoneEventHandlingMethod BaseBuildingHandlingMethod; // 0x31
};
...
struct FGameplayRules {
	...
	bool AllowAdminChat; // 0x6
	bool AllowMapScreen; // 0x7
...
struct FCraftingSlot {
	...
	UCraftingSlotType* SlotType; // 0x10
};
...
struct FRigUnit_RigLogic : FRigUnitMutable {
	FRigUnit_RigLogic_Data Data; // 0x68
};
...
struct FExplosionRadialDamageEvent : FScumRadialDamageEvent {
	UDamageCustomization* DamageCustomizationClass; // 0x48
	float force; // 0x50
	UObject* DamageDealer; // 0x58
};
...
struct FCoordinateSystem {
	EDirection XAxis; // 0x0
	EDirection YAxis; // 0x1
	EDirection ZAxis; // 0x2
};
...
struct FCraftingProductDescription {
	TSoftClassPtr<UObject> ProductClass; // 0x0
	FString ProductClassName; // 0x28
	FText ProductCaption; // 0x38
	UTexture2D* ProductIcon; // 0x50
	TArray<FCraftingSlotRequirement> SlotRequirements; // 0x58
	TArray<UCraftingCondition*> Conditions; // 0x68
	TArray<UCraftingAction*> Actions; // 0x78
	FCraftingRecipeSkillReward SkillReward; // 0x88
};
...
struct FCraftingIngredientTypeModifier {
	UCraftingIngredientType* IngredientType; // 0x0
	float AmountMultiplier; // 0x8
};
...
struct FNetPackedProjectileDamageEvent : FScumPointDamageEvent {
	FVector_NetQuantize100 DealerLocation; // 0xb8
	FVector_NetQuantize100 TargetLocation; // 0xc4
	float ProjectileMass; // 0xd0
	float ProjectileSpeed; // 0xd4
	float ProjectileMuzzleVelocity; // 0xd8
	char SharpnessHardnessPacked; // 0xdc
	char ArmorPiercingFactorPacked; // 0xdd
	char EventDataPacked; // 0xde
	AActor* WeaponClass; // 0xe0
	UObject* DamageDealer; // 0xe8
	float DistanceTravelled; // 0xf0
	float ExperienceMultiplier; // 0xf4
};
...
struct FCraftingRecipeSkillReward {
	TSoftClassPtr<UObject> Skill; // 0x0
	int32_t NoSkillReward; // 0x28
	int32_t BasicReward; // 0x2c
	int32_t MediumReward; // 0x30
	int32_t AdvancedReward; // 0x34
	int32_t AboveAdvancedReward; // 0x38
};
...
struct FCraftingSlotRequirement {
	FString SlotName; // 0x0
	bool LimitIngredientTypes; // 0x10
	TArray<UCraftingIngredientType*> IngredientTypes; // 0x18
	ECraftingIngredientConsumptionHint ConsumptionHint; // 0x28
	int32_t AmountNeeded; // 0x2c
	bool OverrideAmountNeededSkill; // 0x30
	USkill* Skill; // 0x38
	FCraftingSlotAmountNeededPerSkillLevel AmountNeededSkillLevelOverride; // 0x40
	TArray<FCraftingIngredientTypeModifier> IngredientTypeModifiers; // 0x58
};
...
struct FCraftingSlotAmountNeededPerSkillLevel {
	int32_t NoSkillAmount; // 0x0
	int32_t BasicAmount; // 0x4
	int32_t MediumAmount; // 0x8
	int32_t AdvancedAmount; // 0xc
	int32_t AboveAdvancedAmount; // 0x10
};
