...
enum class EDamageDetailsType : uint8_t {
	AttackerDamageBase = 0,
	WeaponSprint = 1,
	WeaponQuality = 2,
	WeaponSkin = 3,
	WeaponOnHorse = 4,
	WeaponOffHand = 5,
	GeneralWildAttack = 6,
	GeneralWildAttackStructure = 7,
	GeneralLoyalModify = 8,
	AttackerWeaponSkill = 9,
	AttackerWeaponSkillLevelPunish = 10,
	AttackerBuffDamageMulAdd = 11,
	AttackerRidingSkill = 12,
	SpeedBonus = 13,
	SpeedRelative = 14,
	AttackerTired = 15,
	AttackerST = 16,
	GeneralCH = 17,
	ProjectileAfterPierce = 18,
	ProjectileDistanceAttenuation = 19,
	AttackerAG = 20,
	AttackerWI = 21,
	SiegeWork = 22,
	MAX = 23,
