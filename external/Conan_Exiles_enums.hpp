...
enum class ERadialItemActions : uint8_t {
	ItemActionInventory = 0,
	ItemActionMainMenu = 1,
	ItemActionBack = 2,
	ItemActionCancel = 3,
	ItemActionStopEmoting = 4,
	ERadialItemActions_MAX = 5,
};
...
enum class ERadialItemCategory : uint8_t {
	ItemCategoryEmoteCategory = 0,
	ItemCategoryEmotes = 1,
	ItemCategoryActions = 2,
	ERadialItemCategory_MAX = 3,
};
...
enum class EFailureDetails : uint8_t {
	...
	Queue = 37,
	MissingDLC = 38,
	MismatchGameTweakDataPatch = 39,
	EFailureDetails_MAX = 40,
};
