...
struct FZeuzMatchMakingPartyInit {
...
struct FZeuzAccountTeamDeleteIn {
	FString Team; // 0x10
};
...
struct FZeuzProfileItemTransferIn {
...
struct FHesitationNonNeutralZoneData {
...
struct FHesitationActionSetting_Custom {
	FString Name; // 0x1d8
};
...
struct FAnimNode_LazySpringBone {
...
struct FHesitationFailureSettings {
...
struct FPostProcessSetting_VectorParam {
	FVector Start; // 0x80
	FVector End; // 0x8c
...
struct FHesitationProfileTable {
...
struct FZeuzAccountTeamCreateIn {
	FString Title; // 0x10
	FString Desc; // 0x20
	FZeuzProperties Props; // 0x30
...
struct FZeuzAccountProjectDeleteIn {
	FString Proj; // 0x10
};
...
struct FPostProcessSetting_FloatParam {
	float Start; // 0x80
	float End; // 0x84
...
struct FZeuzAccountProjectCreateIn {
	FString Title; // 0x10
	FString Desc; // 0x20
	FZeuzProperties Props; // 0x30
};
