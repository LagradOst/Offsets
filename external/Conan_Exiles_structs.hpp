...
struct FAuthenticationActivateAPIKeyRequest {
	FString APIKeyId; // 0x8
	UPlayFabJsonObject* Entity; // 0x18
};

struct FStartAsyncSimulationFunction {
...
struct FBuildingStressTesterTickFunction {
	ETickingGroup TickGroup; // 0x8
	ETickingGroup EndTickGroup; // 0x9
	char bAllowAggregation : 1; // 0xc
	char bTickEvenWhenPaused : 1; // 0xc
...
struct FEconomyAddVirtualCurrenciesRequest {
	TArray<UPlayFabJsonObject*> Currencies; // 0x8
	UPlayFabJsonObject* Entity; // 0x18
...
struct FMultiplayerGetCognitiveServicesLocalesResponse {
...
struct FServerListViewEntry {
	...
	UServerInfoBase* m_Widget; // 0xe0
	bool m_ShouldShow; // 0xe8
	bool m_IsFavorite; // 0xe9
	bool m_IsLastPlayedSession; // 0xea
	bool m_IsSelected; // 0xeb
	EServerPopulation m_Population; // 0xec
	int32_t m_CharacterLevel; // 0xf0
	int32_t LocalizedRegionIndex; // 0xf4
};
...
struct FMultiplayerGetCognitiveServicesTokenResponse {
...
struct FEconomyPurchaseItemByIdRequest {
...
struct FEconomyUpdateBundleResult {
...
struct FEconomySearchForItemsContainingItemByIdRequest {
...
struct FFootstepDataTableStructure {
...
struct FEconomySetInventoryItemsResult {
...
struct FEconomyReportReviewRequest {
...
struct FEconomySearchForItemsContainingItemResult {
...
struct FEconomyGetReviewsRequest {
	UPlayFabJsonObject* Entity; // 0x8
	FString itemID; // 0x10
...
struct FEconomySetUgcItemModerationStateResult {
	UPlayFabJsonObject* Request; // 0x0
};
...
struct FEconomySearchRecipesResult {
	FString IdempotencyId; // 0x8
...
struct FEconomyUpdateSubscriptionResult {
	FString IdempotencyId; // 0x8
...
struct FEconomyUpdateStoreResult {
	FString IdempotencyId; // 0x8
...
struct FWeaponMaterialTableStructure {
	USoundCue* SoundToPlay; // 0x8
...
struct FEconomyDeleteSubscriptionResult {
	FString IdempotencyId; // 0x8
};
...
struct FMountMovementRatesTableRow {
...
struct FEconomyGetSubscriptionByMarketplaceOfferIdRequest {
...
struct FTiltComputeTickFunction {
	ETickingGroup TickGroup; // 0x8
	ETickingGroup EndTickGroup; // 0x9
	char bAllowAggregation : 1; // 0xc
	char bTickEvenWhenPaused : 1; // 0xc
...
struct FEconomyDeleteStoreByIdRequest {
	UPlayFabJsonObject* Entity; // 0x8
	FString ID; // 0x10
	FString IdempotencyId; // 0x20
	UPlayFabJsonObject* SourceEntityKey; // 0x30
...
struct FEconomyReportReviewResult {
	UPlayFabJsonObject* Request; // 0x0
};
...
struct FRichPresenceData {
	FText PresenceText; // 0x8
};

struct FEquipmentTemplateTableRow {
...
struct FAuthenticationDeleteAPIKeyRequest {
	FString APIKeyId; // 0x8
	UPlayFabJsonObject* Entity; // 0x18
};
...
struct FEconomyGetDraftItemsResult {
	FString ContinuationToken; // 0x8
	int32_t Count; // 0x18
	TArray<UPlayFabJsonObject*> Items; // 0x20
};
...
struct FEconomySearchSubscriptionsResult {
	FString IdempotencyId; // 0x8
...
struct FExperimentationGetLatestScorecardsForTitleRequest {
	UPlayFabAuthenticationContext* AuthenticationContext; // 0x0
};
...
struct FNiagaraConstant_Vector {
	FVector4 Value; // 0x10
};
...
struct FAuthenticationGetAPIKeysRequest {
	UPlayFabJsonObject* Entity; // 0x8
};
...
struct FGameItemStatModificationRow {
	TArray<FGameItemStatModification> Modifications; // 0x8
};

struct FStatModifierInt32 {
	int32_t m_Value; // 0x8
};
...
struct FEconomyGetCatalogConfigResult {
...
struct FEconomyGetPublishedItemResult {
...
struct FBuildingGeneratorTickFunction {
	ETickingGroup TickGroup; // 0x8
	ETickingGroup EndTickGroup; // 0x9
	char bAllowAggregation : 1; // 0xc
	char bTickEvenWhenPaused : 1; // 0xc
...
struct FEconomyDeleteItemResult {
	UPlayFabJsonObject* Request; // 0x0
};
...
struct FEconomyGetCurrencyByIdResult {
...
struct FStaminaRegenTickFunction {
	ETickingGroup TickGroup; // 0x8
	ETickingGroup EndTickGroup; // 0x9
	char bAllowAggregation : 1; // 0xc
	char bTickEvenWhenPaused : 1; // 0xc
...
struct FEquipmentGenderVariations {
...
struct FEconomyGetSubscriptionByIdRequest {
	bool ExpandReferencedItems; // 0x8
	FString ID; // 0x10
...
struct FEconomyDeleteStoreResult {
	FString IdempotencyId; // 0x8
};
...
struct FEconomyCraftRecipeByFriendlyIdRequest {
	bool AutoConsume; // 0x8
	UPlayFabJsonObject* Entity; // 0x10
	FString IdempotencyId; // 0x18
...
struct FEconomySubtractVirtualCurrenciesResult {
	TArray<UPlayFabJsonObject*> Currencies; // 0x8
	FString IdempotencyId; // 0x18
};
...
struct FEconomyGrantInventoryItemsRequest {
	UPlayFabJsonObject* Entity; // 0x8
	FString IdempotencyId; // 0x10
	TArray<UPlayFabJsonObject*> Items; // 0x20
};
...
struct FEconomyGetMyReviewResult {
...
struct FEconomyGetBundleByIdRequest {
	bool ExpandReferencedItems; // 0x8
	FString ID; // 0x10
	UPlayFabJsonObject* SourceEntityKey; // 0x20
};
...
struct FEconomySetUgcItemModerationStateRequest {
	UPlayFabJsonObject* Entity; // 0x8
	FString itemID; // 0x10
	FString reason; // 0x20
...
struct FMultiplayerRequestPartyResponse {
	FString BuildId; // 0x8
...
struct FExperimentationGetLatestScorecardsForTitleResult {
...
struct FGameItemVersionDataRow {
...
struct FEconomyCreateStoreRequest {
...
struct FEconomyGetUgcItemModerationStateResult {
	UPlayFabJsonObject* State; // 0x8
};

struct FEconomyPublishItemResult {
	UPlayFabJsonObject* Request; // 0x0
};

struct FEconomySubtractVirtualCurrenciesRequest {
	TArray<UPlayFabJsonObject*> Currencies; // 0x8
	UPlayFabJsonObject* Entity; // 0x18
	FString IdempotencyId; // 0x20
};
...
struct FNiagaraConstant_Matrix {
	FMatrix Value; // 0x10
};
...
struct FNPCProgressionCurveRow {
	FName CurveName; // 0x8
	int32_t Level; // 0x10
...
struct FMultiplayerRequestPartyRequest {
...
struct FEconomyCreateCurrencyResult {
...
struct FEconomyTakedownReviewsRequest {
	UPlayFabJsonObject* Entity; // 0x8
...
struct FEconomyUpdateStoreRequest {
	UPlayFabJsonObject* Entity; // 0x8
	FString IdempotencyId; // 0x10
...
struct FEconomyGrantInventoryItemsResult {
	FString IdempotencyId; // 0x8
	TArray<UPlayFabJsonObject*> Items; // 0x18
};
...
struct FAuthenticationActivateAPIKeyResponse {
	UPlayFabJsonObject* Request; // 0x0
};
...
struct FEconomyGetRecipeByMarketplaceOfferIdRequest {
	bool ExpandReferencedItems; // 0x8
	UPlayFabJsonObject* MarketplaceOfferId; // 0x10
	UPlayFabJsonObject* SourceEntityKey; // 0x18
};
...
struct FAdminGetCloudScriptAzureFunctionsTaskInstanceResult {
	UPlayFabJsonObject* Parameter; // 0x8
	UPlayFabJsonObject* Summary; // 0x10
};

struct FEconomyDeleteRecipeByFriendlyIdRequest {
...
struct FBlueprintCommandDataRow {
...
struct FRadialMenuTableRow {
	FText Label; // 0x8
	FText subtitle; // 0x20
	UTexture2D* IconTexture; // 0x38
	int32_t UserValue; // 0x40
	FName UserTag; // 0x48
	FName KeyShortcutName; // 0x50
};
...
struct FEconomyUpdateInventoryPropertiesItemsResult {
	FString IdempotencyId; // 0x8
	TArray<UPlayFabJsonObject*> Items; // 0x18
...
struct FMultiplayerEnablePartiesForTitleRequest {
	UPlayFabAuthenticationContext* AuthenticationContext; // 0x0
};
...
struct FServerFeatureToggleState {
	FName FeatureName; // 0x0
	bool FeatureEnabled; // 0x8
};

struct FProfilesSetAvatarUrlResponse {
	UPlayFabJsonObject* Entity; // 0x8
...
struct FSlowAIControllerTickFunction {
	ETickingGroup TickGroup; // 0x8
	ETickingGroup EndTickGroup; // 0x9
	char bAllowAggregation : 1; // 0xc
	char bTickEvenWhenPaused : 1; // 0xc
...
struct FEconomyDeleteRecipeResult {
	FString IdempotencyId; // 0x8
};

struct FEconomyCreateStoreResult {
	FString IdempotencyId; // 0x8
	UPlayFabJsonObject* Store; // 0x18
};
...
struct FEconomyCreateOrUpdateReviewRequest {
	UPlayFabJsonObject* Entity; // 0x8
	FString itemID; // 0x10
...
struct FEmoteTableRow {
	...
	UAnimMontage* EmoteAnimMontageMale; // 0x38
	UAnimMontage* EmoteAnimMontageFemale; // 0x58
	USkeleton* CompatibleSkeleton; // 0x78
	UTexture2D* Icon; // 0x98
	TArray<UTexture2D*> IconLayers; // 0xb8
	EEmoteCategories EmoteCategory; // 0xc8
	FName DLCPackage; // 0xd0
};

struct FHintsStructure {
...
struct FEconomyHelpfulnessVoteResult {
	UPlayFabJsonObject* Request; // 0x0
};

struct FAIDataTableRow {
...
struct FEconomyCatalogSearchRequest {
	UPlayFabJsonObject* Entity; // 0x8
	FString Filter; // 0x10
	FString OrderBy; // 0x20
	FString Search; // 0x30
...
struct FEconomyCreateCurrencyRequest {
	UPlayFabJsonObject* Currency; // 0x8
	UPlayFabJsonObject* Entity; // 0x10
};
...
struct FEconomyCraftRecipeResult {
...
struct FEconomyCreateBundleResult {
	UPlayFabJsonObject* Bundle; // 0x8
	FString IdempotencyId; // 0x10
};

struct FEconomyDeleteSubscriptionByIdRequest {
	FString ID; // 0x8
	FString IdempotencyId; // 0x18
	UPlayFabJsonObject* SourceEntityKey; // 0x28
};
...
struct FEconomyPurchaseItemResult {
	TArray<UPlayFabJsonObject*> Currencies; // 0x8
	FString IdempotencyId; // 0x18
...
struct FEconomyUpdateBundleRequest {
	UPlayFabJsonObject* Bundle; // 0x8
	FString IdempotencyId; // 0x10
};
...
struct FStatModifierFloat {
	float m_Value; // 0x8
};

struct FWeightedSpawnTableRow {
...
struct FEconomySearchStoresRequest {
	bool ExpandReferencedItems; // 0x8
	FString Filter; // 0x10
	FString IdempotencyId; // 0x20
...
struct FAuthenticationCreateAPIKeyRequest {
	UPlayFabJsonObject* Entity; // 0x8
};
...
struct FAuthenticationDeleteAPIKeyResponse {
	UPlayFabJsonObject* Request; // 0x0
};
...
struct FMultiplayerGetCognitiveServicesLocalesRequest {
...
struct FEconomyPurchaseItemByFriendlyIdRequest {
	bool AutoConsume; // 0x8
	TArray<UPlayFabJsonObject*> Currencies; // 0x10
	UPlayFabJsonObject* Entity; // 0x20
	FString IdempotencyId; // 0x28
...
struct FEconomyGetRecipeByFriendlyIdRequest {
	bool ExpandReferencedItems; // 0x8
	FString FriendlyId; // 0x10
	UPlayFabJsonObject* SourceEntityKey; // 0x20
};

struct FDataTableMergeControlRow {
...
struct FExperimentationGetLatestScorecardForExperimentRequest {
	FString ExperimentId; // 0x8
};
...
struct FEconomyReviewSummaryResult {
...
struct FEconomyCreateSubscriptionResult {
	FString IdempotencyId; // 0x8
	UPlayFabJsonObject* Subscription; // 0x18
};
...
struct FEconomyCraftRecipeByIdRequest {
	bool AutoConsume; // 0x8
	UPlayFabJsonObject* Entity; // 0x10
	FString IdempotencyId; // 0x18
	TArray<UPlayFabJsonObject*> Ingredients; // 0x28
...
struct FEconomySearchInStoreByIdRequest {
	FString Filter; // 0x8
	FString ID; // 0x18
	FString IdempotencyId; // 0x28
...
struct FEconomyGetRecipeResult {
	FString IdempotencyId; // 0x8
...
struct FEconomySearchStoresResult {
	FString IdempotencyId; // 0x8
...
struct FEconomyUpdateRecipeRequest {
	FString IdempotencyId; // 0x8
	UPlayFabJsonObject* recipe; // 0x18
};
...
struct FEconomyPublishItemRequest {
	UPlayFabJsonObject* Entity; // 0x8
	FString ETag; // 0x10
	FString itemID; // 0x20
};
...
struct FBuildingRecordingBuilderTickFunction {
	ETickingGroup TickGroup; // 0x8
	ETickingGroup EndTickGroup; // 0x9
	char bAllowAggregation : 1; // 0xc
	char bTickEvenWhenPaused : 1; // 0xc
...
struct FEconomyGetPublishedItemRequest {
	UPlayFabJsonObject* Entity; // 0x8
	FString itemID; // 0x10
};
...
struct FProfessionTemplateTableRow {
...
struct FEconomyCreateOrUpdateReviewResult {
	UPlayFabJsonObject* Request; // 0x0
};
...
struct FEconomySetVirtualCurrenciesRequest {
	TArray<UPlayFabJsonObject*> Currencies; // 0x8
	UPlayFabJsonObject* Entity; // 0x18
	FString IdempotencyId; // 0x20
};
...
struct FEconomyReportItemResult {
	UPlayFabJsonObject* Request; // 0x0
};
...
struct FEconomyGetCurrencyByIdRequest {
...
struct FEconomySearchInStoreByFriendlyIdRequest {
	FString Filter; // 0x8
...
struct FEconomySearchBundlesResult {
	TArray<UPlayFabJsonObject*> Bundles; // 0x8
	FString IdempotencyId; // 0x18
};

struct FEconomySearchForItemsContainingItemByFriendlyIdRequest {
	EContainerType ContainerType; // 0x8
...
struct FEconomyDeleteBundleByIdRequest {
	FString ID; // 0x8
	FString IdempotencyId; // 0x18
	UPlayFabJsonObject* SourceEntityKey; // 0x28
};
...
struct FEconomyHelpfulnessVoteRequest {
	UPlayFabJsonObject* Entity; // 0x8
	bool IsHelpful; // 0x10
	FString ReviewId; // 0x18
};
...
struct FBackgroundLoadingScreenStructure {
	FString BackgroundPath; // 0x8
	FString UltraWidePath; // 0x18
};

struct FEconomyGetVirtualCurrenciesRequest {
	UPlayFabJsonObject* Entity; // 0x8
	FString IdempotencyId; // 0x10
};
...
struct FEconomyGetSubscriptionByFriendlyIdRequest {
	bool ExpandReferencedItems; // 0x8
	FString FriendlyId; // 0x10
	UPlayFabJsonObject* SourceEntityKey; // 0x20
};
...
struct FEconomyGetSubscriptionResult {
	FString IdempotencyId; // 0x8
	TArray<UPlayFabJsonObject*> ReferencedItems; // 0x18
...
struct FEconomyGetInventoryItemsResult {
	FString IdempotencyId; // 0x8
	TArray<UPlayFabJsonObject*> Items; // 0x18
...
struct FMultiplayerGetCognitiveServicesTokenRequest {
	ECognitiveServicesType CognitiveServicesType; // 0x8
	FString Region; // 0x10
};
...
struct FEconomyUpdateRecipeResult {
	FString IdempotencyId; // 0x8
	UPlayFabJsonObject* recipe; // 0x18
};
...
struct FAuthenticationGetAPIKeysResponse {
	UPlayFabJsonObject* Entity; // 0x8
...
struct FEconomyTakedownReviewsResult {
	UPlayFabJsonObject* Request; // 0x0
};
...
struct FEconomyCreateSubscriptionRequest {
	bool AllowOverwrite; // 0x8
	FString IdempotencyId; // 0x10
...
struct FEconomyGetBundleByMarketplaceOfferIdRequest {
	bool ExpandReferencedItems; // 0x8
	UPlayFabJsonObject* MarketplaceOfferId; // 0x10
	UPlayFabJsonObject* SourceEntityKey; // 0x18
};
...
struct FEconomyDeleteBundleResult {
	FString IdempotencyId; // 0x8
};
...
struct FEconomyGetRecipeByIdRequest {
	bool ExpandReferencedItems; // 0x8
	FString ID; // 0x10
	UPlayFabJsonObject* SourceEntityKey; // 0x20
};

struct FEconomyGetBundleByFriendlyIdRequest {
	bool ExpandReferencedItems; // 0x8
	FString FriendlyId; // 0x10
	UPlayFabJsonObject* SourceEntityKey; // 0x20
};
...
struct FEconomyCreateUploadUrlsResult {
	TArray<UPlayFabJsonObject*> UploadUrls; // 0x8
};

struct FEconomyConsumeInventoryItemsResult {
	FString IdempotencyId; // 0x8
	TArray<UPlayFabJsonObject*> Items; // 0x18
};
...
struct FEconomyAddVirtualCurrenciesResult {
	TArray<UPlayFabJsonObject*> Currencies; // 0x8
	FString IdempotencyId; // 0x18
};
...
struct FSpatialQueryTickFunction {
	ETickingGroup TickGroup; // 0x8
	ETickingGroup EndTickGroup; // 0x9
	char bAllowAggregation : 1; // 0xc
	char bTickEvenWhenPaused : 1; // 0xc
...
struct FEconomyDeleteRecipeByIdRequest {
	FString ID; // 0x8
	FString IdempotencyId; // 0x18
	UPlayFabJsonObject* SourceEntityKey; // 0x28
};
...
struct FEconomyPublishStatusRequest {
	UPlayFabJsonObject* Entity; // 0x8
	FString itemID; // 0x10
};
...
struct FEconomyDeleteBundleByFriendlyIdRequest {
	FString FriendlyId; // 0x8
	FString IdempotencyId; // 0x18
	UPlayFabJsonObject* SourceEntityKey; // 0x28
};
...
struct FProfilesSetAvatarUrlRequest {
...
struct FEconomyGetStoreByFriendlyIdRequest {
	bool ExpandReferencedItems; // 0x8
	FString FriendlyId; // 0x10
	UPlayFabJsonObject* SourceEntityKey; // 0x20
};
...
struct FEconomyDeleteStoreByFriendlyIdRequest {
	UPlayFabJsonObject* Entity; // 0x8
	FString FriendlyId; // 0x10
	FString IdempotencyId; // 0x20
	UPlayFabJsonObject* SourceEntityKey; // 0x30
...
struct FBuildingReplicationTickFunction {
	ETickingGroup TickGroup; // 0x8
	ETickingGroup EndTickGroup; // 0x9
	char bAllowAggregation : 1; // 0xc
	char bTickEvenWhenPaused : 1; // 0xc
...
struct FEconomyCreateRecipeRequest {
	bool AllowOverwrite; // 0x8
	FString IdempotencyId; // 0x10
...
struct FCraftingStationNameTableRow {
	FText StationName; // 0x8
	UTexture2D* StationIconOverlay; // 0x20
};

struct FEconomyUpdateInventoryItemsPropertiesRequest {
	UPlayFabJsonObject* Entity; // 0x8
	FString IdempotencyId; // 0x10
	TArray<UPlayFabJsonObject*> Items; // 0x20
};
...
struct FEconomyGetMyReviewRequest {
	UPlayFabJsonObject* Entity; // 0x8
	FString itemID; // 0x10
};
...
struct FEconomySearchBundlesRequest {
	bool ExpandReferencedItems; // 0x8
	FString Filter; // 0x10
	FString IdempotencyId; // 0x20
	FString OrderBy; // 0x30
...
struct FEconomyGetStoreByIdRequest {
	bool ExpandReferencedItems; // 0x8
	FString ID; // 0x10
	UPlayFabJsonObject* SourceEntityKey; // 0x20
};

struct FFlsPeerRegistrationRequest {
...
struct FEconomyPublishStatusResult {
...
struct FEconomyUpdateCurrencyRequest {
	UPlayFabJsonObject* Currency; // 0x8
	UPlayFabJsonObject* Entity; // 0x10
};
...
struct FEconomyGetUgcItemModerationStateRequest {
	UPlayFabJsonObject* Entity; // 0x8
	FString itemID; // 0x10
};
...
struct FAuthenticationCreateAPIKeyResponse {
	UPlayFabJsonObject* Entity; // 0x8
...
struct FEconomyGetVirtualCurrenciesResult {
	TArray<UPlayFabJsonObject*> Currencies; // 0x8
	FString IdempotencyId; // 0x18
};
...
struct FEconomyUpdateDraftItemResult {
	UPlayFabJsonObject* Item; // 0x8
};
...
struct FEconomyUpdateSubscriptionRequest {
	FString IdempotencyId; // 0x8
	UPlayFabJsonObject* Subscription; // 0x18
};
...
struct FEconomyCreateBundleRequest {
	bool AllowOverwrite; // 0x8
...
struct FAuthenticationDeactivateAPIKeyRequest {
	FString APIKeyId; // 0x8
	UPlayFabJsonObject* Entity; // 0x18
};
...
struct FEconomySearchInStoreResult {
	FString IdempotencyId; // 0x8
	TArray<UPlayFabJsonObject*> Items; // 0x18
};
...
struct FAdminCreateCloudScriptAzureFunctionsTaskRequest {
	FString Description; // 0x8
	bool IsActive; // 0x18
	FString Name; // 0x20
	UPlayFabJsonObject* Parameter; // 0x30
...
struct FEconomyGetDraftItemResult {
	UPlayFabJsonObject* Item; // 0x8
};
...
struct FEconomySearchRecipesRequest {
	bool ExpandReferencedItems; // 0x8
	FString Filter; // 0x10
	FString IdempotencyId; // 0x20
	FString OrderBy; // 0x30
...
struct FEconomyDeleteSubscriptionByFriendlyIdRequest {
	FString FriendlyId; // 0x8
	FString IdempotencyId; // 0x18
	UPlayFabJsonObject* SourceEntityKey; // 0x28
};
...
struct FEconomyUpdateCurrencyResult {
	UPlayFabJsonObject* Currency; // 0x8
	UPlayFabJsonObject* Entity; // 0x10
};
...
struct FEconomySetInventoryItemsRequest {
	UPlayFabJsonObject* Entity; // 0x8
	FString IdempotencyId; // 0x10
	TArray<UPlayFabJsonObject*> Items; // 0x20
};
...
struct FFlsReserveSessionRequest {
	FString GameVersion; // 0x20
	FString Platform; // 0x30
};

struct FEconomyCatalogSearchResult {
	int32_t Count; // 0x8
...
struct FEconomyGetBundleResult {
	UPlayFabJsonObject* Bundle; // 0x8
	FString IdempotencyId; // 0x10
	TArray<UPlayFabJsonObject*> ReferencedItems; // 0x20
};
...
struct FBuildingPiecesInAreaData {
	...
	ABuildingBase* MasterBuilding; // 0x40
	TArray<APlaceableBase*> AllPlaceables; // 0x48
	int32_t NumBuildingPiecesInBuilding; // 0x58
};
...
struct FAuthenticationDeactivateAPIKeyResponse {
	UPlayFabJsonObject* Request; // 0x0
};
...
struct FExperimentationGetLatestScorecardForExperimentResult {
...
struct FEconomyUpdateCatalogConfigResult {
	UPlayFabJsonObject* Request; // 0x0
};
...
struct FEconomyCreateRecipeResult {
	FString IdempotencyId; // 0x8
	UPlayFabJsonObject* recipe; // 0x18
};
...
struct FEconomyGetReviewsResult {
	FString ContinuationToken; // 0x8
	int32_t Count; // 0x18
	UPlayFabJsonObject* Entity; // 0x20
...
struct FEconomySearchSubscriptionsRequest {
	bool ExpandReferencedItems; // 0x8
	FString Filter; // 0x10
	FString IdempotencyId; // 0x20
	FString OrderBy; // 0x30
...
struct FEconomyCreateDraftItemResult {
	UPlayFabJsonObject* Item; // 0x8
};
...
struct FServerRentalGameServer {
...
struct FEconomyReviewSummaryRequest {
	UPlayFabJsonObject* Entity; // 0x8
	FString itemID; // 0x10
};
