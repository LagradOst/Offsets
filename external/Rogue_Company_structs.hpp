...
struct FSingleSkinMapReplicatorEntry {
	UKSItem* Item; // 0x10
	UKSItem* Skin; // 0x18
};
...
struct FKSLimitedTimeEventMetadataRow {
	FText EventName; // 0x8
...
struct FKSMediaPlayerWidgetPlaylistEntry {
...
struct FAccountJobStatReplicator {
...
struct FWeaponAttachmentAnimationData {
...
struct FKSLootTableChanceTableRow {
...
struct FKSShotgunHitChangeList {
...
struct FKSPersistentMinPlayerDataContainer {
...
struct FKSBTDifficultyTableRow {
...
struct FPGame_ReplicatedTimerManagerBase {
...
struct FKSPlayerIdentitiesContainer {
...
struct FContextualPingMessagesRow {
...
struct FKSBTTargetSelectionTableRow {
...
struct FPGame_ReplicatedTimerManager {
...
struct FKSWeaponDropAttachmentContainer {
...
struct FGuidedCalloutSceneData {
...
struct FKSPlayerModOverridePropertyStatFloat {
...
struct FKSResourceInfoSerializerContainer {
...
struct FAnimNode_BSpaceEvalSkinned {
...
struct FAnimNode_BlendSpacePlayerSkinned {
...
struct FKSBTItemPriorityTableRow {
...
struct FKSWeaponDropAttachmentContainerEntry {
...
struct FAnimNode_BlendPoseNodeSkinned {
...
struct FKSBTWeaponRangeTableRow {
...
struct FKSAnimNode_OrientationWarp {
	float Angle; // 0xd8
...
struct FPGame_EffectManagerPropertyContainer {
...
struct FPGame_PersistentEffectRepData {
...
struct FKSShotgunHitChangeItem {
...
struct FAnimNode_RigidBodySkipServer {
...
struct FAcquisitionHeaderOverrides {
	FText Header; // 0x8
...
struct FAnimNode_SequenceSkinned {
...
struct FLoadingScreenTipTextRow {
	FText TipText; // 0x8
...
struct FPGame_ReplicatedTimerManagerEntry {
...
struct FMultiSkinMapReplicatorEntry {
...
struct FAccoladeTrackerTableRow {
...
struct FKSPlayerModOverridePropertyStatInteger {
...
struct FAnimNode_BlendByDedicatedServer {
...
struct FContextualPingTypesRow {
...
struct FKSRevealInfoSerializerContainer {
...
struct FAnimNode_AimOffsetSkinned {
...
struct FAnimNode_SeqEvalSkinned {
...
struct FKSPersistentMinPlayerData {
	FKSPersistentPlayerId ID; // 0x10
	int32_t TeamNum; // 0x20
...
struct FKSAssetOverrideTable_TableRow {
...
struct FRadialMenuItemEventItem {
...
struct FKSFreezeFramePawnWeaponProp {
...
struct FKSEquipmentContainerEntry {
...
struct FKSBotCharacterSkinTableRow {
...
struct FKSBTAbilityConditionTableRow {
...
struct FAnimNode_SeqCurveEvalSkinned {
...
struct FPGame_PersistentEffectRepDataContainer {
...
struct FKSBTObjectivePriorityTableRow {
...
struct FKSBotEquipmentSkinTableRow {
...
struct FKSPlayerModOverridePropertyStatBool {
	bool BoolValue; // 0x8
};
...
struct FAnimNode_SequenceSkinnedCurvePlay {
...
struct FKSRevealInfoSerializerItem {
...
struct FAccountJobStatReplicatorEntry {
...
struct FRadialMenuItemEventList {
...
struct FMultiPlayerSkinMapReplicator {
