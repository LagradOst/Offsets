...
struct FUpdatedPlayerSkillRating {
	float PrevMu; // 0x70
...
struct FPlaylistTierSkillRating {
	int32_t Playlist; // 0x20
};
...
struct FAnimatedMaterialParamColor {
...
struct FAnimatedMaterialParamVector {
...
struct FEngineAudioNativeState_InAir {
...
struct FAnimatedMaterialParamFloat {
	ComponentProperty Value; // 0x8
};
...
struct FUIPlayerBinding {
	FString UIKey; // 0x30
};

struct FPartyMemberLoadout {
	FUniqueNetId UniqueId; // 0x0
	FLoadoutData Loadout; // 0x48
	TArray<FOnlineProductData> OnlineLoadoutData; // 0x88
	int32_t GaragePreviewTeam; // 0x98
	ObjectProperty LocalPlayer; // 0xa0
	ComponentProperty ProductSet; // 0xa8
	char SortWeight; // 0xb0
};
...
struct FEngineAudioNativeState_OnGround {
...
struct FAchievementUpload {
	int32_t Id; // 0x0
	FString DisplayName; // 0x8
	uint32_t bOnlineUnlockAuthority : 1; // 0x18
};
...
struct FDemolishDataGoalExplosion {
...
struct FPlayerVoiceRoomCredentials {
...
struct FAnimatedLinearColorParam {
...
struct FEngineAudioNativeState_Clutched {
