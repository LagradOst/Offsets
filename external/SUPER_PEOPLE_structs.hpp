...
struct FItemSpawingInfoTableRow {
...
struct FTransportAircraftInfo {
	FVector StartBlueZone; // 0x0
	FVector DropBoxCurrentPos; // 0xc
	TArray<float> DropDistances; // 0x18
	TArray<ABravoHotelDropBoxActor*> DropBoxes; // 0x28
	FVector Target; // 0x38
	FVector Start; // 0x44
	FName RandomItemKey; // 0x50
	FVector End; // 0x58
	FVector SecondTarget; // 0x64
	FVector EndBlueZone; // 0x70
};
...
struct FSkeletonToMeshLinkup {
	TArray<int32_t> MeshToSkeletonTable; // 0x8
	TArray<int32_t> SkeletonToMeshTable; // 0x20
};
...
struct FRandomEquipClothesData {
...
struct FBravoHotelWeaponInfo {
	TSoftObjectPtr<UPaperSprite> SilhouetteIconTexture_PaperSprite; // 0x8
	UCurveVector* Curve_Sway_Move; // 0x30
	float FireIntervalBurst; // 0x38
	float FireRateAuto; // 0x3c
	TArray<EWeaponFireMode> AllowedFireModes; // 0x40
	FBravoHotelRecoilInfo Recoil; // 0x50
	FText DisplayName; // 0x170
	bool bIsBoltAction; // 0x188
	FName Display_AmmoInfo; // 0x18c
	UCurveVector* Curve_Sway_Idle; // 0x198
	float CrosshairDecreaseSpeed; // 0x1a0
	FName AllowedAmmoName; // 0x1a4
	int32_t BulletsPerShot; // 0x1ac
	FBravoHotelSpreadInfo Spread; // 0x1b0
	float MaxDamage; // 0x1f0
	FBravoHotelDeviation Deviation; // 0x1f4
	int32_t Display_EffectiveRange; // 0x220
	float FireRateBurst; // 0x224
	FName WeaponKey; // 0x228
	float Weight; // 0x230
	float MoveSpeedModifier; // 0x234
	FText DisplayRangeType; // 0x238
	FString AK_EventKey; // 0x250
	float Display_Accuracy; // 0x260
	int32_t Display_RateofFire; // 0x264
	FName CrosshairRowName; // 0x268
	float ProjectileVelocity; // 0x270
	FText DisplayWeaponType; // 0x278
	int32_t BurstCount; // 0x290
	EWeaponType WeaponType; // 0x294
	float Accuracy; // 0x298
	float MinDamage; // 0x29c
	float CrosshairInterpSpeed; // 0x2a0
	float ADSToReloadDelayTime; // 0x2a4
	FBravoHotelWeaponInfoADS ADS_Info; // 0x2a8
	FBravoHotelArmsLag ArmsLag; // 0x498
	FBravoHotelReloadInfo ReloadInfo; // 0x4a0
	float Display_Damage; // 0x558
	float TerminalVelocity; // 0x55c
	float CrosshairIncrease; // 0x560
	FText DisplayDesc; // 0x568
	float FireRateSingle; // 0x580
	FBravoHotelWeaponInfoFPSK FPSK_Info; // 0x588
	int32_t NormalMagSize; // 0x7a8
	FWeaponAttachmentInfo Attachment_Info; // 0x7b0
	int32_t LargeMagSize; // 0xac8
	float BoltActionTime; // 0xacc
	FBravoHotelDepthOfFieldBaseInfo DepthOfField; // 0xad0
	EThrowingWeaponType ThrowingWeaponType; // 0xb20
};
...
struct FBravoHotelGameData {
	...
	FBravoHotelPlayZoneData PlayZoneBaseData; // 0x180
	TArray<FBattleRoyalPhaseInfo> PlayZonePhaseList; // 0x308
	UBravoHotelWeightMapData* WeightMapInfo; // 0x318
};
...
struct FBattleRoyalPhaseInfo {
	float TransportAltitude; // 0x0
	FPersonalSupplyPhaseInfo PersonalSupplyPhaseInfo; // 0x4
	int32_t TransportMaxCount; // 0x34
	float TargetCircleRate; // 0x38
	float DelayTime; // 0x3c
	float DamagePerSecondOutOfCircle; // 0x40
	FName TransportRandomItemKey; // 0x44
	float FixTransportAltitude; // 0x4c
	bool UsingFixTransportAltitude; // 0x50
	float SurvivalCircleRaidus; // 0x54
	float TransportStartingAddValue; // 0x58
	float LocalDeviation; // 0x5c
	TArray<FTransportAircraftInfo> TransportAircraftInfos; // 0x60
	int32_t TransportMinCount; // 0x70
	TArray<float> TransportProbabilities; // 0x78
	float CriticalTimeLimitTime; // 0x88
	float ShrinkTime; // 0x8c
	bool EnableUsingDelayAddPerk; // 0x90
	TArray<FAddPerkInfo> AddPerkInfos; // 0x98
	bool bUsingWeightMap; // 0xa8
	float WaitingTime; // 0xac
	FVector SurvivalCirclePos; // 0xb0
};
...
struct FDataEventAbnormalDamage {
...
struct FBravoHotelTeamColorRow {
...
struct FDataEventClientGameWeapon {
...
struct FBravoHotelBlueZoneInfo {
...
struct FDataEventClientGameBattle {
...
struct FBravoHotelRenderSettings {
...
struct FBravoHotelSmartPingIconSettings {
...
struct FBravoHotelWeaponInfoFPSK {
...
struct FBravoHotelDamageEvent_Point {
...
struct FBoneNode {
	...
	EBoneTranslationRetargetingMode TranslationRetargetingMode; // 0x11
	FName Name; // 0x14
};
...
struct FBravoHotelPartyMemberInfo {
	bool bIsReady; // 0x98
...
struct FHitDamageLogInfo {
	int32_t DamageTypeRowID; // 0x0
	int32_t HitCount; // 0x4
	float Damage; // 0x8
	float Defense; // 0xc
	int32_t WeaponLevel; // 0x10
	bool bIsHeadShot; // 0x14
	ABravoHotelPlayerState* TargetPlayerState; // 0x18
	FBravoHotelWeaponInfo WeaponInfo; // 0x20
	bool bIsWeaponKill; // 0xb48
	EBroadCastKillMessageType DamageResult; // 0xb49
};
...
struct FGenerateOption {
	int32_t ID; // 0x8
	TArray<FName> GroupRewardIDs; // 0x10
};

struct FRepVehicleMovement {
...
struct FNewbieBuff {
	float SupplyProbabilityModifyer; // 0x8
	TArray<int32_t> CommonBuffNames; // 0x10
	TArray<FSpecificClassBuff> SuperPeopleClassBuffNames; // 0x20
	FName ExpertWeaponTableID; // 0x30
};

struct FDataEventClientGameRevival {
...
struct FPerkDeckNewbieAdvantage {
	bool bRecommend; // 0x0
	TArray<FExpertWeaponSimpleElement> ExpertWeaponOverride; // 0x8
	float PerkDeckWeightModifier; // 0x18
};
...
struct FDataEventClientGameKnockDowned {
	UBravoHotelDamageType* DamageTypeClass; // 0x60
	AActor* AttackerActor; // 0x68
	APlayerState* AttackerPlayerState; // 0x70
	AActor* VictimActor; // 0x78
...
struct FAICharacterSettingData {
...
struct FDataEventClientGameVehicle {
...
struct FCharacterClassTypeData {
	int32_t ID; // 0x8
	FText DisplayName; // 0x10
	FText Description; // 0x28
...
struct FDiedDamageInfo {
	...
	FDamageTypeTable DamageTypeRow; // 0xb30
	TArray<int32_t> HitPartsIndexes; // 0xb98
	int32_t HitCount; // 0xba8
	float DamageAmount; // 0xbac
	bool bKnockOut; // 0xbb0
	EDiedDamageInfoType DiedDamageInfoType; // 0xbb1
	TArray<FDamageBuffInfo> AttackerBuffs; // 0xbb8
	TArray<FDamageBuffInfo> DefenderBuffs; // 0xbc8
};
...
struct FItemRecipeMaterialElement {
...
struct FRigConfiguration {
	TArray<FNameMapping> BoneMappingTable; // 0x0
	URig* Rig; // 0x18
};
...
struct FDataEventClientGameIllegalUsers {
...
struct FKillBroadcastUIInfo {
	...
	FKillBroadcastKillerInfo KnockOut; // 0xba0
	ABravoHotelPlayerState* Killer; // 0x1740
	ABravoHotelPlayerState* SubKiller; // 0x1748
	ABravoHotelPlayerState* Died; // 0x1750
	TArray<ABravoHotelPlayerState*> Assist; // 0x1758
	bool IsFinallyKill; // 0x1768
	int32_t KillCount; // 0x176c
	EBroadCastKillMessageType BroadCastKillMessageType; // 0x1770
};
...
struct FDataEventClientGameDied {
	UBravoHotelDamageType* DamageTypeClass; // 0x60
...
struct FBravoHotelMatchRewardTableRow {
...
struct FBravoHotelPostProcessSettings {
	bool bEnable; // 0x8
...
struct FPerSkeletonAnimationSharingSetup {
	UAnimSharingAdditiveInstance* AdditiveAnimBlueprint; // 0x0
	USkeletalMesh* SkeletalMesh; // 0x8
	UAnimSharingTransitionInstance* BlendAnimBlueprint; // 0x10
	UAnimationSharingStateProcessor* StateProcessorClass; // 0x18
...
struct FBravoHotelDefaultBalanceData {
...
struct FBravoHotelHUDMessageRow {
...
struct FBravoHotelLevelStreamSettings {
	bool bEnable; // 0x8
...
struct FVirtualBone {
	FName SourceBoneName; // 0x4
	FName VirtualBoneName; // 0xc
	FName TargetBoneName; // 0x18
};
...
struct FSeasonTierUp {
	int32_t ID; // 0x8
	TArray<FSeasonTierUpElement> Tiers; // 0x10
};

struct FCharacterVoiceTableRow {
...
struct FBravoHotelWeaponInfoADS {
	bool bEnableADS; // 0x8
...
struct FBravoHotelErrorStringData {
...
struct FPerkDeckData {
	TArray<FName> SupplyItems; // 0x8
	TSoftObjectPtr<UObject> ClassIcon; // 0x18
	TArray<FPerkDeckNewbieAdvantage> Defeat_Advantage; // 0x40
	FText Description; // 0x50
	FName BoostTypeKey; // 0x68
	TMap<EWeaponType, float> SecondExpertWeapon; // 0x70
	TSoftObjectPtr<UObject> TeamInfoClassIcon; // 0xc0
	FPerkLevelUpData PerkLevelUpData; // 0xe8
	FPerkDeckNewbieAdvantage Beginner_Advantage; // 0x260
	TSoftObjectPtr<UObject> ClassIcon_Widget; // 0x280
	int32_t PerkDeckWeight; // 0x2a8
	TArray<FName> WeaponItems; // 0x2b0
	ESuperPeopleClass ClassEnum; // 0x2c0
	TSoftObjectPtr<UObject> TitleImage; // 0x2c8
	TArray<FName> ClassBuffNames; // 0x2f0
	TArray<int32_t> CraftedWeaponIDs; // 0x300
	bool bNotKeepClass; // 0x310
	FName WeaponKey; // 0x314
	TSoftObjectPtr<UObject> CohIcon; // 0x320
	FText WeaponDescription; // 0x348
	FText DisplayName; // 0x360
	int32_t ID; // 0x378
	TArray<FPerkDeckElement> PerkCards; // 0x380
	int32_t ClassType; // 0x390
	FText DisplayWeaponName; // 0x398
	TSoftObjectPtr<UObject> NoClassWeaponImage; // 0x3b0
	TMap<EWeaponType, float> FirstExpertWeapon; // 0x3d8
	TSoftObjectPtr<UObject> ClassSelectIcon; // 0x428
	FText DisplayClassName; // 0x450
	TMap<FName, float> ExpertWeaponModifier; // 0x468
};
