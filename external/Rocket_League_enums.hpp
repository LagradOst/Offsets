...
enum class ETrainingRoundAttempt : uint8_t {
	TrainingRoundProgress_NotAttempted = 0,
	TrainingRoundProgress_Attempted = 1,
	TrainingRoundProgress_Completed = 2,
	TrainingRoundProgress_MAX = 3,
};
...
enum class ETrainingNavigationCommand : uint8_t {
	TrainingNavigationCommand_PreviousShot = 0,
	TrainingNavigationCommand_NextShot = 1,
	TrainingNavigationCommand_MAX = 2,
};
