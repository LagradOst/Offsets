...
namespace off {
	constexpr auto client_state = 0x589fc4;
	constexpr auto client_state_generic_precache_table = 0x52a4;
	constexpr auto client_state_signon_state = 0x108;
	constexpr auto entity_list = 0x4dd1e1c;
	constexpr auto force_attack = 0x32022d0;
	constexpr auto force_attack2 = 0x32022dc;
	constexpr auto force_backward = 0x320230c;
	constexpr auto force_forward = 0x3202300;
	constexpr auto force_jump = 0x527bc98;
	constexpr auto force_left = 0x3202318;
	constexpr auto force_right = 0x3202324;
	constexpr auto gamerules_proxy = 0x52eecfc;
	constexpr auto global_vars = 0x589cc8;
	constexpr auto glow_object_manager = 0x531a118;
	constexpr auto input = 0x52233f0;
	constexpr auto local_player = 0xdb65ec;
	constexpr auto player_resource = 0x3200680;
	constexpr auto radar_base = 0x5206b94;
	constexpr auto view_matrix = 0x4dc3734;
	...
	constexpr auto engine_build_number = 0x38cf554;
