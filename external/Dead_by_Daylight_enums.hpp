...
enum class EContextualType : uint8_t {
	...
	IceBlueGlyph = 5,
	GlyphUpperBound = 6,
	ToxinPlantHalloween2020 = 7,
	PumpkinHalloween2021 = 8,
	EContextualType_MAX = 9,
};
...
enum class ELoadProgress : uint8_t {
	...
	LoadingExperimentalFeatures = 45,
	ELoadProgress_MAX = 46,
};
...
enum class ENearGameObjectQuestObjectType : uint8_t {
	Generator = 0,
	Count = 1,
	ENearGameObjectQuestObjectType_MAX = 2,
};
...
enum class SettingsId : uint8_t {
	...
	SurvivorToggleInteractions = 29,
	KillerToggleInteractions = 30,
	SprintToCancel = 31,
	ColorBarPalette = 32,
	ColorBlindMode = 33,
	ColorBlindModeIntensity = 34,
	BeginnerMode = 35,
	Subtitles = 36,
	SubtitlesBackgroundOpacity = 37,
	SubtitlesSize = 38,
	SurvivorCameraSensitivity = 39,
	KillerCameraSensitivity = 40,
	MenuMusicVolumeOn = 41,
	MainVolumeOn = 42,
	AimAssist = 43,
	SurvivorQuickTurn = 44,
	KillerQuickTurn = 45,
	FPSLimit = 46,
	AutoQuality = 47,
	ControlType = 48,
	CustomizedControls = 49,
	DynamicResolution = 50,
	InvertYAxisSurvivor = 51,
	BetaWiggleSkillCheck = 52,
	SettingsId_MAX = 53,
};
...
enum class ECustomDecalBlendModeChannels : uint8_t {
	None = 0,
	BaseColor = 1,
	Normal = 2,
	Emissive = 3,
	...
	Specular = 5,
	Roughness = 6,
	ECustomDecalBlendModeChannels_MAX = 7,
};
