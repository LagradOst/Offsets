...
namespace off {
	...
	namespace n_UResonanceAudioSpatializationSourceSettings { // : USpatializationPluginSourceSettingsBase
	...
	namespace n_UResonanceAudioReverbPluginPreset { // : USoundEffectSubmixPreset
	...
	namespace n_UResonanceAudioSettings { // : UObject
	...
	namespace n_AResonanceAudioDirectivityVisualizer { // : AActor
	...
	namespace n_UResonanceAudioSoundfieldSettings { // : USoundfieldEncodingSettingsBase
