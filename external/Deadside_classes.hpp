...
namespace off {
	...
	namespace n_At_Tool_C { // : ASFPSBaseItem
	...
	namespace n_UFormMap_C { // : UUserWidget
		...
		constexpr auto btnRespawn = 0x280; // UButton*
		constexpr auto imgRespawn = 0x288; // UImage*
		constexpr auto lbExit = 0x290; // UTextBlock*
		constexpr auto nsHint = 0x298; // UNamedSlot*
		constexpr auto SelectedMapElement = 0x2a0; // USFPSUserWidget_MapElement*
		constexpr auto WheelUp = 0x2a8; // bool
	}
	...
	namespace n_AProjectile_C { // : ASFPSProjectile
		constexpr auto DefaultSceneRoot = 0x310; // USceneComponent*
	}

	namespace n_Aweapon_firearms_gun_c1911_C { // : At_FireArm_C
	...
	namespace n_USFPSPhysicalMaterial { // : UPhysicalMaterial
	...
	namespace n_ABMF_Workbench_01_C { // : At_LocationCraftActor_C
		constexpr auto SFPSACBaseCollision = 0x358; // USFPSACBaseCollision*
	}

	namespace n_USFPSActorLibrary { // : UObject
	...
	namespace n_AUltra_Dynamic_Sky_BP_C { // : AActor
	...
	namespace n_USFPSACMission { // : USFPSACGameplayEvent
	...
	namespace n_ABM_Floor_01_C { // : At_LocationCraftActor_C
		constexpr auto SFPSACBaseCollision = 0x358; // USFPSACBaseCollision*
	...
	namespace n_ABMF_Sandbags_03_C { // : At_LocationCraftActor_C
	...
	namespace n_UCharacter_man_01_C { // : USFPSAnimInstance
	...
	namespace n_At_Material_C { // : ASFPSBaseItem
		constexpr auto Trace = 0x310; // UBoxComponent*
		constexpr auto Mesh = 0x318; // UStaticMeshComponent*
	}
	...
	namespace n_ABMF_Sandbags_02_C { // : At_LocationCraftActor_C
		constexpr auto SFPSACBaseCollision = 0x358; // USFPSACBaseCollision*
	}
	...
	namespace n_USFPSGameplayEventManager { // : UObject
	...
	namespace n_ABMF_Gates_lock_01_C { // : ABMF_Gates_01_C
	...
	namespace n_Ascope_opt_cod_4x_C { // : At_Sight_C
		constexpr auto cod_4x_reticles = 0x3d0; // UStaticMeshComponent*
	}

	namespace n_AM_TripwireTrap_02_C { // : At_LocationCraftActor_C
	...
	namespace n_ABM_WallWindow_01_C { // : At_LocationCraftActor_C
		constexpr auto SFPSACBaseCollision = 0x358; // USFPSACBaseCollision*
		constexpr auto SFPSACSnap = 0x360; // USFPSACSnapComponent*
	}
	...
	namespace n_ASFPSShootingRangeTarget { // : AActor
	...
	namespace n_ASFPSGameplayArea { // : AActor
	...
	namespace n_ABMF_Sandbags_01_C { // : At_LocationCraftActor_C
		constexpr auto SFPSACBaseCollision = 0x358; // USFPSACBaseCollision*
	}
	...
	namespace n_AShell_Gun0_C { // : ASFPSShell
	...
	namespace n_USFPSCraftLibrary { // : UObject
	...
	namespace n_Aweapon_firearms_smg_hkump_C { // : At_FireArm_C
	...
	namespace n_AM_Campfire_01_C { // : At_LocationCraftActor_C
	...
	namespace n_At_InventoryDevice_C { // : ASFPSInventoryDeviceItem
	...
	namespace n_USFPSAnimEvent_StairStepSound { // : UAnimNotify
		constexpr auto IsRightLeg = 0x38; // bool
	}

	namespace n_Aweapon_firearms_supp_rgm40_C { // : At_FireArm_C
	...
	namespace n_Aweapon_firearms_rifle_aks74u_mod_C { // : At_FireArm_C
		constexpr auto DTK = 0x7e0; // UStaticMeshComponent*
	...
	namespace n_AFlashGrenade_C { // : ASFPSFlashGrenade
	...
	namespace n_UABP_weapon_firearms_rifle_groza_C { // : USFPSWeaponAnimInstance_AR
	...
	namespace n_ASFPSWeaponMF_Sight { // : ASFPSBaseWeaponMF
	...
	namespace n_UfrmRadialMenu_C { // : USFPSUserWidget_RadialMenu
		constexpr auto UberGraphFrame = 0x278; // FPointerToUberGraphFrame
		constexpr auto rmMotions_Start = 0x280; // UUMG_RadialMenu_C*
	}
	...
	namespace n_ASFPSAmmo { // : ASFPSBaseItem
	...
	namespace n_UABP_weapon_firearms_gun_TT_C { // : USFPSWeaponAnimInstance_Gun
		constexpr auto UberGraphFrame = 0x2e0; // FPointerToUberGraphFrame
		constexpr auto AnimGraphNode_Root = 0x2e8; // FAnimNode_Root
		constexpr auto AnimGraphNode_Slot = 0x318; // FAnimNode_Slot
	...
	namespace n_USFPSACLocality { // : USceneComponent
		...
		constexpr auto RespawnCooldownSec = 0x23c; // int32_t
	...
	namespace n_ACharacter_man_01_C { // : ASFPSCharacter
	...
	namespace n_USoundNodeModulContOuterParam { // : USoundNode
	...
	namespace n_USFPSAnimEvent_Weap_Steel_Damage { // : UAnimNotify
		constexpr auto bFirstEvent = 0x38; // bool
	}

	namespace n_ASFPSAmbienceSpot { // : AActor
	...
	namespace n_ASFPSWeatherMan { // : AActor
	...
	namespace n_USFPSShellManager { // : UObject
	...
	namespace n_UfrmAAdminPanelGroup_C { // : USFPSUserWidget_CraftRolloutMan
		constexpr auto UberGraphFrame = 0x2b8; // FPointerToUberGraphFrame
		constexpr auto btnOpen = 0x2c0; // UCheckBox*
		constexpr auto imgBackground0 = 0x2c8; // UImage*
		constexpr auto imgIcon = 0x2d0; // UImage*
		constexpr auto sbMain = 0x2d8; // UScrollBox*
	}

	namespace n_USFPSUserWidget_ServerListItem { // : UUserWidget
		constexpr auto OnSelectEvent = 0x300; // FDelegate
		constexpr auto OnDblClickedEvent = 0x310; // FDelegate
		constexpr auto OnAddFavoriteEvent = 0x320; // FDelegate
	}
	...
	namespace n_AShootingRangeTarget01_C { // : ASFPSShootingRangeTarget
	...
	namespace n_ASFPSCommonGameState { // : AGameState
	...
	namespace n_ASFPSBaseCharacter { // : ACharacter
	...
	namespace n_ABM_WallTriaLow_02_C { // : At_LocationCraftActor_C
		constexpr auto SFPSACBaseCollision = 0x358; // USFPSACBaseCollision*
		constexpr auto SFPSACSnap = 0x360; // USFPSACSnapComponent*
	}

	namespace n_Aweapon_firearms_smg_bizon_C { // : At_FireArm_C
		constexpr auto DTK = 0x7e0; // UStaticMeshComponent*
		constexpr auto DeviceLeftMount = 0x7e8; // UStaticMeshComponent*
	...
	namespace n_UABP_weapon_firearms_sg_m4_C { // : USFPSWeaponAnimInstance_SG
	...
	namespace n_UShootCrossfadeOuterParams { // : UObject
	...
	namespace n_UfrmAllSettingsComboboxes_C { // : UUserWidget
		constexpr auto UberGraphFrame = 0x268; // FPointerToUberGraphFrame
		constexpr auto btnMain = 0x270; // UButton*
		constexpr auto lbtext = 0x278; // UTextBlock*
		constexpr auto FParentCombobox = 0x280; // UComboBoxString*
		constexpr auto FComboboxString = 0x288; // FString
	}
	...
	namespace n_USFPSAI_TGenerateRandomPoint { // : UBTTaskNode
	...
	namespace n_AStair_tower_wood_01_C { // : AActor
	...
	namespace n_UDcxVehicleTire { // : UDataAsset
	...
	namespace n_ASFPSInventoryDeviceItem { // : ASFPSBaseItem
	...
	namespace n_AMainMenuGameMode_C { // : AGameMode
	...
	namespace n_USFPSACVehicleSoundSystem { // : UActorComponent
	...
	namespace n_UfrmFilterCombobox_C { // : UUserWidget
		constexpr auto UberGraphFrame = 0x268; // FPointerToUberGraphFrame
		constexpr auto btnFitlter = 0x270; // UButton*
		constexpr auto lbtext = 0x278; // UTextBlock*
		constexpr auto FComboboxString = 0x280; // FString
		constexpr auto FParentCombobox = 0x290; // UComboBoxString*
	}
	...
	namespace n_Aweapmf_flashlight_02_C { // : At_HandguardDeviceLeft_C
	...
	namespace n_Aweapmf_DTK_762x39_02_C { // : At_MuzzleAttachement_C
	...
	namespace n_USFPSAI_TChangeAiming { // : UBTTaskNode
	...
	namespace n_UfrmSpriteViewInv_C { // : USFPSUserWidget_SpriteViewInv
	...
	namespace n_UDcxVehicleDriveRawInput { // : UDcxVehicleWheelsRawInput
	...
	namespace n_UFormAdmin_C { // : UUserWidget
		constexpr auto Base_btnCopyPlayer = 0x268; // UButton*
		constexpr auto Base_btnDelBase = 0x270; // UButton*
		constexpr auto Base_btnDelBoxes = 0x278; // UButton*
		constexpr auto Base_btnKeyChance = 0x280; // UButton*
		constexpr auto Base_btnSteamProfile = 0x288; // UButton*
		constexpr auto Base_btnStromTime = 0x290; // UButton*
		constexpr auto btnBase = 0x298; // UCheckBox*
		constexpr auto btnBattlePVEOnly = 0x2a0; // UCheckBox*
		constexpr auto btnBattlePVPPVE = 0x2a8; // UCheckBox*
		constexpr auto btnBuyServer = 0x2b0; // UButton*
		constexpr auto btnCameraFPS = 0x2b8; // UCheckBox*
		constexpr auto btnCameraFPSTPS = 0x2c0; // UCheckBox*
		constexpr auto btnCameraTPS = 0x2c8; // UCheckBox*
		constexpr auto btnDeathLog = 0x2d0; // UCheckBox*
		constexpr auto btnGameplay = 0x2d8; // UCheckBox*
		constexpr auto btnItems = 0x2e0; // UCheckBox*
		constexpr auto btnMessages = 0x2e8; // UCheckBox*
		constexpr auto btnPlayers = 0x2f0; // UCheckBox*
		constexpr auto btnServer = 0x2f8; // UCheckBox*
		constexpr auto btnServer_Teleport0 = 0x300; // UButton*
		constexpr auto btnServer_Teleport1 = 0x308; // UButton*
		constexpr auto btnServer_Teleport2 = 0x310; // UButton*
		constexpr auto btnServer_Teleport3 = 0x318; // UButton*
		constexpr auto btnServer_Teleport4 = 0x320; // UButton*
		constexpr auto btnServer_TeleportDead = 0x328; // UButton*
		constexpr auto btnVACNo = 0x330; // UCheckBox*
		constexpr auto btnVACYes = 0x338; // UCheckBox*
		constexpr auto DeathLog_btnCopy = 0x340; // UButton*
		constexpr auto DeathLog_btnDownload = 0x348; // UButton*
		constexpr auto frmAdminPanelDeathRecord = 0x350; // UfrmAdminPanelDeathRecord_C*
		constexpr auto frmAdminPanelDeathRecord_125 = 0x358; // UfrmAdminPanelDeathRecord_C*
		constexpr auto Gameplay_Background_2 = 0x360; // UImage*
		constexpr auto Gameplay_BackLine_2 = 0x368; // UImage*
		constexpr auto Gameplay_BackLine_3 = 0x370; // UImage*
		constexpr auto Gameplay_BackLine_4 = 0x378; // UImage*
		constexpr auto Gameplay_BackLine_5 = 0x380; // UImage*
		constexpr auto Gameplay_BackLine_6 = 0x388; // UImage*
		constexpr auto Gameplay_BackLine_7 = 0x390; // UImage*
		constexpr auto Gameplay_BackLine_8 = 0x398; // UImage*
		constexpr auto Gameplay_BackLine_9 = 0x3a0; // UImage*
		constexpr auto Gameplay_btnApplyAISettings = 0x3a8; // UButton*
		constexpr auto Gameplay_btnApplyEventsSettings = 0x3b0; // UButton*
		constexpr auto Gameplay_btnDynamicTimeScaleOff = 0x3b8; // UCheckBox*
		constexpr auto Gameplay_btnDynamicTimeScaleOn = 0x3c0; // UCheckBox*
		constexpr auto Gameplay_btnPatrolOff = 0x3c8; // UCheckBox*
		constexpr auto Gameplay_btnPatrolOn = 0x3d0; // UCheckBox*
		constexpr auto imgButtonsBackground = 0x3d8; // UImage*
		constexpr auto Messages_btnMsgTimer = 0x3e0; // UButton*
		constexpr auto Messages_btnSaveMOTD = 0x3e8; // UButton*
		constexpr auto Messages_btnSaveMsg = 0x3f0; // UButton*
		constexpr auto Messages_btnSendMOTD = 0x3f8; // UButton*
		constexpr auto Messages_btnSendMsg = 0x400; // UButton*
		constexpr auto Messages_mMOTD = 0x408; // UMultiLineEditableTextBox*
		constexpr auto Messages_mMsg = 0x410; // UMultiLineEditableTextBox*
		constexpr auto Players_btnAddToAdmins = 0x418; // UButton*
		constexpr auto Players_btnBan = 0x420; // UButton*
		constexpr auto Players_btnCopyBanned = 0x428; // UButton*
		constexpr auto Players_btnCopyPlayer = 0x430; // UButton*
		constexpr auto Players_btnDelFromAdmins = 0x438; // UButton*
		constexpr auto Players_btnHandBan = 0x440; // UButton*
		constexpr auto Players_btnSteamProfile = 0x448; // UButton*
		constexpr auto Players_btnSteamProfileAdmins = 0x450; // UButton*
		constexpr auto Players_btnSteamProfileBanned = 0x458; // UButton*
		constexpr auto Players_btnSteamProfileHandBan = 0x460; // UButton*
		constexpr auto Players_btnUnban = 0x468; // UButton*
	...
	namespace n_USFPSAI_TDebug { // : UBTTaskNode
	...
	namespace n_Adevice_flashlight_02_C { // : At_Device_C
	...
	namespace n_USFPSACInventory { // : USFPSACBaseInventory
	...
	namespace n_AScope_col_halosun_C { // : At_Sight_C
	...
	namespace n_Aweapon_firearms_gun_tt_C { // : At_FireArm_C
		constexpr auto SFPSACWeaponMFInventory = 0x7e0; // USFPSACWeaponMFInventory*
		constexpr auto MagazineFull = 0x7e8; // UStaticMeshComponent*
		constexpr auto MagazineEmpty = 0x7f0; // UStaticMeshComponent*
	}
	...
	namespace n_ASFPSWeaponMF_MuzzleAttachment { // : ASFPSBaseWeaponMF
	...
	namespace n_UfrmPopupMenu_C { // : UUserWidget
		constexpr auto imgBackgroun1 = 0x268; // UImage*
		constexpr auto imgBackgroun2 = 0x270; // UImage*
		constexpr auto imgBackgroun3 = 0x278; // UImage*
		constexpr auto imgBackgroun4 = 0x280; // UImage*
		constexpr auto imgBackgroun5 = 0x288; // UImage*
		constexpr auto imgBackgroun6 = 0x290; // UImage*
		constexpr auto imgBackgroun7 = 0x298; // UImage*
		constexpr auto imgBackgroun8 = 0x2a0; // UImage*
		constexpr auto pnBackground = 0x2a8; // UCanvasPanel*
	}
	...
	namespace n_USFPSCameraShake { // : UMatineeCameraShake
	...
	namespace n_USFPSMapHandler { // : UObject
		constexpr auto bVisible = 0x248; // bool
		constexpr auto FormMap = 0x250; // UUserWidget*
		constexpr auto MapElement_Player = 0x258; // USFPSUserWidget_MapElement*
		constexpr auto MapElement_Mission = 0x260; // USFPSUserWidget_MapElement*
		constexpr auto MapElement_SaveScaleMission = 0x268; // USFPSUserWidget_MapElement*
		constexpr auto MapElement_AllPlayersMarker = 0x270; // USFPSUserWidget_MapElement*
		constexpr auto MapElement_AllBasesMarker = 0x278; // USFPSUserWidget_MapElement*
		constexpr auto MapElement_AllBotsMarker = 0x280; // USFPSUserWidget_MapElement*
		constexpr auto MapElement_TacticalMarker = 0x288; // USFPSUserWidget_MapElement*
		constexpr auto MapElement_DeadMarker = 0x290; // USFPSUserWidget_MapElement*
		constexpr auto MapElement_LootStash = 0x298; // USFPSUserWidget_MapElement*
		constexpr auto MapElement_GreenArea = 0x2a0; // USFPSUserWidget_MapElement*
		constexpr auto MapElement_RedArea = 0x2a8; // USFPSUserWidget_MapElement*
		constexpr auto MapElement_Base = 0x2b0; // USFPSUserWidget_MapElement*
		constexpr auto MapElement_Location = 0x2b8; // USFPSUserWidget_MapElement*
		constexpr auto MapElement_SquadMarker = 0x2c0; // USFPSUserWidget_MapElement*
		constexpr auto MapElement_TripwireTrap = 0x2c8; // USFPSUserWidget_MapElement*
		constexpr auto TacticalMarkers = 0x2d0; // TArray<USFPSTacticalMarker*>
		constexpr auto DeadMarker = 0x2e0; // USFPSTacticalMarker*
		constexpr auto LootStashMarkers = 0x2e8; // TArray<USFPSLootStashMarker*>
		constexpr auto MissionMarkers = 0x2f8; // TArray<USFPSMissionMarker*>
		constexpr auto SaveScaleMissionMarkers = 0x308; // TArray<USFPSSaveScaleMissionMarker*>
		constexpr auto AllPlayersMarkers = 0x318; // TArray<USFPSAllPlayersMarker*>
		constexpr auto AllBasesMarkers = 0x328; // TArray<USFPSAllBasesMarker*>
		constexpr auto AllBotsMarkers = 0x338; // TArray<USFPSAllBotsMarker*>
		constexpr auto GreeenAreaMarkers = 0x348; // TArray<USFPSGreenAreaMarker*>
		constexpr auto BaseMarkers = 0x358; // TArray<USFPSBaseMarker*>
		constexpr auto LocalitiesMarkers = 0x368; // TArray<USFPSLocationMarker*>
		constexpr auto SquadMarkers = 0x378; // TArray<USFPSSquadMarker*>
		constexpr auto TripwireTrapMarkers = 0x388; // TArray<USFPSTripwireTrapMarker*>
	}

	namespace n_USFPSUserWidget_RadialMenu { // : UUserWidget
		constexpr auto SelectedIndex = 0x270; // int32_t
	}

	namespace n_ASFPSGameplayItem { // : ASFPSBaseItem
	...
	namespace n_ASFPSLootBoxSpawner { // : ASFPSBaseLootSpawner
	...
	namespace n_AShell_SR0_C { // : ASFPSShell
		constexpr auto Mesh = 0x250; // UStaticMeshComponent*
	}
	...
	namespace n_Adevice_lighter_02_C { // : At_Device_C
		constexpr auto Flame = 0x4a0; // UStaticMeshComponent*
		constexpr auto PointLight = 0x4a8; // UPointLightComponent*
	}

	namespace n_USFPSUserWidget_HUDChatBox { // : UUserWidget
		constexpr auto LabelsCount = 0x2dc; // int32_t
		constexpr auto Font = 0x2e0; // FSlateFontInfo
		constexpr auto ViewportScale = 0x338; // float
	}
	...
	namespace n_ABM_Stairs_01_C { // : At_LocationCraftActor_C
		constexpr auto SFPSACBaseCollision = 0x358; // USFPSACBaseCollision*
		constexpr auto SFPSACSnap = 0x360; // USFPSACSnapComponent*
	}
	...
	namespace n_Aweapmf_DTK_dot45_01_C { // : At_MuzzleAttachement_C
		constexpr auto Muzzle = 0x390; // USceneComponent*
	}
	...
	namespace n_ASFPSAmbientSound { // : AAmbientSound
	...
	namespace n_USFPSSaver { // : UObject
	...
	namespace n_ASFPSRecoveryItem { // : ASFPSHandheldItem
	...
	namespace n_USFPSUserWidget_TraderItem { // : UUserWidget
		constexpr auto ItemClass = 0x268; // ASFPSBaseItem*
		constexpr auto ActorGroupItemIndex = 0x274; // int32_t
		constexpr auto ActorLibraryItemIndex = 0x278; // int32_t
	...
	namespace n_USFPSServerListHandler { // : UObject
	...
	namespace n_USFPSAICharacterSet { // : UObject
	...
	namespace n_UfrmSpriteViewEquip_C { // : USFPSUserWidget_SpriteViewInv
		constexpr auto UberGraphFrame = 0x2e8; // FPointerToUberGraphFrame
		constexpr auto btnMain = 0x2f0; // UButton*
		constexpr auto pnMain = 0x2f8; // USFPSUserWidget_EquipItem*
	}
	...
	namespace n_USFPSACWeaponMFInventory { // : UActorComponent
	...
	namespace n_USFPSAI_TSetSightResolution { // : UBTTaskNode
	...
	namespace n_ASFPSLocality { // : AActor
	...
	namespace n_Aweapon_firearms_sg_m4_C { // : At_FireArm_C
		constexpr auto DeviceLeftMount = 0x7e0; // UStaticMeshComponent*
		constexpr auto SFPSACWeaponMFInventory = 0x7e8; // USFPSACWeaponMFInventory*
		constexpr auto Shell = 0x7f0; // UStaticMeshComponent*
	}

	namespace n_USFPSUserWidget_QuickSlot { // : UUserWidget
		constexpr auto bAvailable = 0x2c0; // bool
	}
	...
	namespace n_UMainGameInstance_C { // : USFPSGameInstance
		constexpr auto UberGraphFrame = 0x8d0; // FPointerToUberGraphFrame
	}
	...
	namespace n_Arecoveryitem_medikit_sterilizedrag_C { // : At_RecoveryItem_C
	...
	namespace n_AM_RadioTrap_01_C { // : At_LocationCraftActor_C
	...
	namespace n_UABP_weapon_firearms_sg_mossberg590_C { // : USFPSWeaponAnimInstance_SG
		constexpr auto UberGraphFrame = 0x310; // FPointerToUberGraphFrame
		constexpr auto AnimGraphNode_Root = 0x318; // FAnimNode_Root
	...
	namespace n_Aweapmf_DTK_556x45_01_C { // : At_MuzzleAttachement_C
		constexpr auto Muzzle = 0x390; // USceneComponent*
	}
	...
	namespace n_Aweapmf_silencer_762x39_01_C { // : At_MuzzleAttachement_C
		constexpr auto Muzzle = 0x390; // USceneComponent*
	}
	...
	namespace n_USFPSItemSetStructSet { // : UObject
	...
	namespace n_USFPSACStair { // : UActorComponent
	...
	namespace n_USFPSUserWidget_CraftRollout { // : UUserWidget
		constexpr auto OnBeginCraftEvent = 0x2e8; // FDelegate
	}

	namespace n_Aweapon_firearms_sg_mp43_C { // : At_FireArm_C
		constexpr auto DeviceLeftMount = 0x7e0; // UStaticMeshComponent*
		constexpr auto SFPSACWeaponMFInventory = 0x7e8; // USFPSACWeaponMFInventory*
	...
	namespace n_USFPSAnimEvent_WC_ChangingFlag { // : UAnimNotify
		constexpr auto bWeaponChanging = 0x38; // bool
		constexpr auto bForCursor = 0x39; // bool
	}

	namespace n_UDcxVehicleWheelsComponent { // : UPawnMovementComponent
	...
	namespace n_Ascope_opt_mosin_C { // : At_Sight_C
		constexpr auto cod_4x_reticles = 0x3d0; // UStaticMeshComponent*
	}

	namespace n_Aweapon_firearms_gun_pm_C { // : At_FireArm_C
		constexpr auto SFPSACWeaponMFInventory = 0x7e0; // USFPSACWeaponMFInventory*
		constexpr auto MagazineFull = 0x7e8; // UStaticMeshComponent*
		constexpr auto MagazineEmpty = 0x7f0; // UStaticMeshComponent*
	}
	...
	namespace n_USFPSAnimInstance { // : UAnimInstance
	...
	namespace n_ABM_WallTria_02_C { // : At_LocationCraftActor_C
		constexpr auto SFPSACBaseCollision = 0x358; // USFPSACBaseCollision*
		constexpr auto SFPSACSnap = 0x360; // USFPSACSnapComponent*
	}
	...
	namespace n_Ascope_opt_elcan_4x_C { // : At_Sight_C
	...
	namespace n_USFPSAI_TSwitchMoveMode { // : UBTTaskNode
		constexpr auto MoveMode = 0x70; // ESFPSAIMoveMode
	}

	namespace n_UDcxVehicleDriveComponent4W { // : UDcxVehicleDriveComponent
		constexpr auto DifferentialData = 0x3b8; // FDcxVehicleDifferentialData4W
		constexpr auto AckermannGeometryAccuracy = 0x3d4; // float
	}

	namespace n_ABM_WallTriaWindow_01_C { // : At_LocationCraftActor_C
		constexpr auto SFPSACBaseCollision = 0x358; // USFPSACBaseCollision*
		constexpr auto SFPSACSnap = 0x360; // USFPSACSnapComponent*
	}

	namespace n_UABP_weapon_firearms_gun_fiveseven_C { // : USFPSWeaponAnimInstance_Gun
		constexpr auto UberGraphFrame = 0x2e0; // FPointerToUberGraphFrame
		constexpr auto AnimGraphNode_Root = 0x2e8; // FAnimNode_Root
		constexpr auto AnimGraphNode_Slot = 0x318; // FAnimNode_Slot
		constexpr auto AnimGraphNode_TransitionResult_6 = 0x360; // FAnimNode_TransitionResult
	...
	namespace n_AScope_col_Trijicon_C { // : At_Sight_C
		constexpr auto deltapoint_collimator = 0x3d0; // UStaticMeshComponent*
	}
	...
	namespace n_Ascope_col_deltapoint_C { // : At_Sight_C
		constexpr auto deltapoint_collimator = 0x3d0; // UStaticMeshComponent*
	}
	...
	namespace n_USFPSAdminHandler { // : UObject
		constexpr auto CurrentDeathLog = 0x608; // TArray<FString>
	...
	namespace n_Arecoveryitem_medikit_bandage_C { // : At_RecoveryItem_C
		constexpr auto Timer = 0x420; // float
	}
	...
	namespace n_USFPSAISenseConfig_Sight { // : UAISenseConfig_Sight
	...
	namespace n_USFPSSoundTalkSet { // : UObject
	...
	namespace n_ASFPSBaseWeaponMF { // : ASFPSBaseItem
	...
	namespace n_USFPSAdminItemList { // : UObject
		constexpr auto Groups = 0x28; // TArray<FSFPSAdminItemsGroup>
	}

	namespace n_UABP_weapon_firearms_rifle_akm_C { // : USFPSWeaponAnimInstance_AR
		constexpr auto UberGraphFrame = 0x2e0; // FPointerToUberGraphFrame
		constexpr auto AnimGraphNode_Root = 0x2e8; // FAnimNode_Root
	...
	namespace n_UABP_weapon_firearms_rifle_steyraug_C { // : USFPSWeaponAnimInstance_AR
		constexpr auto UberGraphFrame = 0x2e0; // FPointerToUberGraphFrame
		constexpr auto AnimGraphNode_Root = 0x2e8; // FAnimNode_Root
		constexpr auto AnimGraphNode_Slot = 0x318; // FAnimNode_Slot
	...
	namespace n_ASFPSHandheldItem { // : ASFPSBaseItem
	...
	namespace n_UFormDlg_TimerInf_C { // : UUserWidget
		constexpr auto UberGraphFrame = 0x268; // FPointerToUberGraphFrame
		constexpr auto imgBackground = 0x270; // UImage*
		constexpr auto imgProrgess = 0x278; // UImage*
		constexpr auto Progress = 0x280; // UMaterialInstanceDynamic*
	}
	...
	namespace n_USFPSAI_TRandomLookAt { // : UBTTaskNode
	...
	namespace n_Aweapon_firearms_snip_svd_C { // : At_FireArm_C
		constexpr auto DeviceLeftMount = 0x7e0; // UStaticMeshComponent*
		constexpr auto MagazineFull = 0x7e8; // UStaticMeshComponent*
		constexpr auto MagazineEmpty = 0x7f0; // UStaticMeshComponent*
		constexpr auto SightClose = 0x7f8; // UStaticMeshComponent*
	...
	namespace n_At_Sight_C { // : ASFPSWeaponMF_Sight
	...
	namespace n_USFPSACEncounter { // : USFPSACGameplayEvent
	...
	namespace n_USFPSUserWidget_SpriteViewInv { // : UUserWidget
		constexpr auto DblClickTimer = 0x2e4; // float
	}

	namespace n_ASFPSMovingAmbientSound { // : ASFPSAmbientSound
	...
	namespace n_UFormNDA_C { // : UUserWidget
		constexpr auto btnAccept = 0x268; // UButton*
	}

	namespace n_AM_Campfire_02_C { // : At_LocationCraftActor_C
		constexpr auto ParticleSystem = 0x358; // UParticleSystemComponent*
		constexpr auto BigLight = 0x360; // UPointLightComponent*
		constexpr auto RedLight = 0x368; // UPointLightComponent*
		constexpr auto SFPSACBaseCollision1 = 0x370; // USFPSACBaseCollision*
	...
	namespace n_ABM_FloorSmall_01_C { // : At_LocationCraftActor_C
		constexpr auto SFPSACBaseCollision = 0x358; // USFPSACBaseCollision*
		constexpr auto SFPSACSnap = 0x360; // USFPSACSnapComponent*
	}
	...
	namespace n_USFPSSoundBoxCopm { // : UBoxComponent
	...
	namespace n_Aweapon_steelarms_axe_02_C { // : At_SteelArm_C
	...
	namespace n_USFPSAI_SSetRandomFocusPoint { // : UBTService
	...
	namespace n_USFPSACSoundSystem { // : UActorComponent
		...
		constexpr auto TinnitusAudioComponent = 0xe0; // UAudioComponent*
		constexpr auto TimerTalkDelHandle = 0x100; // FTimerHandle
		constexpr auto bUnderwaterIsActive = 0x108; // bool
		constexpr auto bDebug = 0x10a; // bool
		constexpr auto bDebugTrace = 0x10b; // bool
		constexpr auto CharDieCue = 0x110; // USoundCue*
		constexpr auto CharBreathCue = 0x118; // USoundCue*
		constexpr auto CharHeartCue = 0x120; // USoundCue*
		constexpr auto CharacterRollCue = 0x128; // USoundCue*
		constexpr auto CharPainShout = 0x130; // USoundCue*
		constexpr auto NoiceCue = 0x138; // USoundCue*
		constexpr auto NoiseBreathCue = 0x140; // USoundCue*
		constexpr auto CharBackMovCue = 0x148; // USoundCue*
		constexpr auto WeaponPressedCue = 0x150; // USoundCue*
		constexpr auto bUseCertainVoice = 0x158; // bool
		constexpr auto STS_Voice = 0x160; // USFPSSoundTalkSet*
		constexpr auto VoiceList = 0x168; // USFPSVoiceList*
		constexpr auto VoiceNumber = 0x170; // int32_t
		constexpr auto FallHeight = 0x1a8; // float
		constexpr auto CharacterPM = 0x1b0; // USFPSPhysicalMaterial*
		constexpr auto SwimmingCue = 0x1c8; // USoundCue*
		constexpr auto SwimmingIdleParticle = 0x1d0; // UParticleSystem*
		constexpr auto SwimmingParticle = 0x1d8; // UParticleSystem*
		constexpr auto SwimmingFastParticle = 0x1e0; // UParticleSystem*
		constexpr auto UnderwaterStep = 0x1e8; // USoundCue*
		constexpr auto UnderwaterReverbEffect = 0x1f0; // UReverbEffect*
		constexpr auto InVehicleReverbEffect = 0x1f8; // UReverbEffect*
	}
	...
	namespace n_USFPSUserWidget_ChatItem { // : UUserWidget
		constexpr auto Info = 0x298; // FSFPSChatItemInfo
	...
	namespace n_At_Device_C { // : ASFPSDeviceItem
	...
	namespace n_At_Ammo_C { // : ASFPSAmmo
		constexpr auto Trace = 0x328; // UBoxComponent*
		constexpr auto Mesh = 0x330; // UStaticMeshComponent*
	}
	...
	namespace n_At_Equipment_C { // : ASFPSWearableItem
	...
	namespace n_USFPSAICharacterSets { // : UObject
		constexpr auto Elements = 0x28; // TArray<FSFPSAICharacterSetsElement>
	}

	namespace n_UFormBase_C { // : UUserWidget
		constexpr auto btnClose = 0x268; // UButton*
		constexpr auto btnDelete = 0x270; // UButton*
		constexpr auto btnRegistration = 0x278; // UCheckBox*
		constexpr auto Registration_btnAdd = 0x280; // UButton*
		constexpr auto Registration_btnCopy = 0x288; // UButton*
		constexpr auto Registration_btnCopyAdded = 0x290; // UButton*
		constexpr auto Registration_btnDel = 0x298; // UButton*
		constexpr auto Registration_btnSteamProfile = 0x2a0; // UButton*
		constexpr auto Registration_btnSteamProfileAdded = 0x2a8; // UButton*
	}
	...
	namespace n_ABaseBounds_C { // : AActor
	...
	namespace n_UfrmAdminPanelDeathRecord_C { // : USFPSUserWidget_AdminPanel_DeathL
		constexpr auto btnSelected = 0x2e8; // UButton*
	}
	...
	namespace n_ABM_FloorTria_02_C { // : At_LocationCraftActor_C
		constexpr auto SFPSACBaseCollision = 0x358; // USFPSACBaseCollision*
		constexpr auto SFPSACSnap = 0x360; // USFPSACSnapComponent*
	}

	namespace n_UFormChat_C { // : UUserWidget
		constexpr auto UberGraphFrame = 0x268; // FPointerToUberGraphFrame
		constexpr auto frmPopupMenu = 0x270; // UfrmPopupMenu_C*
		constexpr auto nsPopupMenu = 0x278; // UNamedSlot*
		constexpr auto FSelectedChatItem = 0x280; // USFPSUserWidget_ChatItem*
		constexpr auto FMouseRightButtonIsDowned = 0x288; // bool
		constexpr auto FMouseLeftButtonIsDowned = 0x289; // bool
	}
	...
	namespace n_ASFPSActor { // : AActor
		constexpr auto bJumpForbidden = 0x220; // bool
		constexpr auto ActorLibraryIndex = 0x224; // int32_t
	}

	namespace n_Aweapon_firearms_sg_mp43_sawed_off_C { // : At_FireArm_C
		constexpr auto SFPSACWeaponMFInventory = 0x7e0; // USFPSACWeaponMFInventory*
		constexpr auto DeviceLeftMount = 0x7e8; // UStaticMeshComponent*
		constexpr auto RightShell = 0x7f0; // UStaticMeshComponent*
		constexpr auto LeftShellEmpty = 0x7f8; // UStaticMeshComponent*
	...
	namespace n_Ascope_opt_hamr_4x_empty_C { // : At_Sight_C
		constexpr auto hamr_4x_reticles = 0x3d0; // UStaticMeshComponent*
	}
	...
	namespace n_UFormDlg_ItemList_C { // : UUserWidget
		constexpr auto UberGraphFrame = 0x268; // FPointerToUberGraphFrame
		constexpr auto btnOk = 0x270; // UButton*
		constexpr auto lbOk = 0x278; // UTextBlock*
		constexpr auto sv0 = 0x280; // UfrmSpriteViewInv_C*
		constexpr auto sv1 = 0x288; // UfrmSpriteViewInv_C*
		constexpr auto sv2 = 0x290; // UfrmSpriteViewInv_C*
		constexpr auto sv3 = 0x298; // UfrmSpriteViewInv_C*
		constexpr auto sv4 = 0x2a0; // UfrmSpriteViewInv_C*
		constexpr auto sv5 = 0x2a8; // UfrmSpriteViewInv_C*
		constexpr auto sv6 = 0x2b0; // UfrmSpriteViewInv_C*
	}

	namespace n_USFPSGameplayManager { // : UObject
	...
	namespace n_USFPSACCraftKit { // : UActorComponent
		constexpr auto LocationCraftItem = 0xb0; // ASFPSBaseLocationCraftItem*
	}

	namespace n_Aweapon_firearms_rifle_aks74u_C { // : At_FireArm_C
		constexpr auto DTK = 0x7e0; // UStaticMeshComponent*
		constexpr auto DeviceLeftMount = 0x7e8; // UStaticMeshComponent*
		constexpr auto SightOpen = 0x7f0; // UStaticMeshComponent*
		constexpr auto SFPSACWeaponMFInventory = 0x7f8; // USFPSACWeaponMFInventory*
	...
	namespace n_USFPSLootLibrary { // : UObject
	...
	namespace n_USoundNodeLatencyByDistance { // : USoundNode
	...
	namespace n_Aweapmf_DTK_556x45_03_C { // : At_MuzzleAttachement_C
		constexpr auto Muzzle = 0x390; // USceneComponent*
	}
	...
	namespace n_ASFPSOnlineBeaconClient { // : AOnlineBeaconClient
	...
	namespace n_ASFPSAirDropCargo { // : AActor
	...
	namespace n_UFormMessageMemo_C { // : UUserWidget
		constexpr auto UberGraphFrame = 0x268; // FPointerToUberGraphFrame
		constexpr auto btnOk = 0x270; // UButton*
		constexpr auto lbOk = 0x278; // UTextBlock*
	}

	namespace n_ASFPSSoundTrigger { // : AActor
	...
	namespace n_Ascope_opt_hamr_4x_col_C { // : At_Sight_C
		constexpr auto hamr_4x_reticles = 0x3d0; // UStaticMeshComponent*
	}
	...
	namespace n_USFPSUserWidget_GroundItem { // : UUserWidget
		constexpr auto TagObject0 = 0x268; // TWeakObjectPtr<ASFPSBaseItem>
		constexpr auto TagObject1 = 0x270; // TWeakObjectPtr<ASFPSBaseItem>
		constexpr auto TagObject2 = 0x278; // TWeakObjectPtr<ASFPSBaseItem>
		constexpr auto bUsedObject0 = 0x280; // bool
		constexpr auto bUsedObject1 = 0x281; // bool
		constexpr auto bUsedObject2 = 0x282; // bool
		constexpr auto ScrollBoxType = 0x283; // ESFPSGroundScrollBoxType
		constexpr auto DblClickTimer = 0x284; // float
	}
	...
	namespace n_ASFPSPlayerController { // : APlayerController
	...
	namespace n_ABMF_Gates_01_C { // : At_LocationCraftActor_C
	...
	namespace n_USFPSBaseManager { // : UObject
	...
	namespace n_UABP_weapon_firearms_gun_c1911_C { // : USFPSWeaponAnimInstance_Gun
		constexpr auto UberGraphFrame = 0x2e0; // FPointerToUberGraphFrame
		constexpr auto AnimGraphNode_Root = 0x2e8; // FAnimNode_Root
		constexpr auto AnimGraphNode_Slot = 0x318; // FAnimNode_Slot
		constexpr auto AnimGraphNode_TransitionResult_6 = 0x360; // FAnimNode_TransitionResult
	...
	namespace n_USFPSBaseWeaponAnimInstance { // : UAnimInstance
	...
	namespace n_USFPSMainInterfaceHandler { // : UObject
	...
	namespace n_USFPSAI_TSwitchFromPeace { // : UBTTaskNode
	...
	namespace n_USFPSAIConfig { // : UObject
	...
	namespace n_UfrmCraftItem_C { // : USFPSUserWidget_CraftRollout
		constexpr auto btnCraft = 0x2f8; // UButton*
	}
	...
	namespace n_UABP_weapon_firearms_supp_rgm40_C { // : USFPSWeaponAnimInstance_GrenLnch
	...
	namespace n_ABox_mil_01_C { // : AActor
	...
	namespace n_ABMF_Storage_01_C { // : ASFPSLootBox
	...
	namespace n_UfrmAdminPanelStartKitItem_C { // : USFPSUserWidget_TraderItem
	...
	namespace n_At_Equipment_WithoutInventory_C { // : ASFPSWearableItem
		constexpr auto Mesh = 0x3a8; // UStaticMeshComponent*
		constexpr auto Trace = 0x3b0; // UBoxComponent*
	}
	...
	namespace n_Arecoveryitem_medikit_rag_C { // : At_RecoveryItem_C
		constexpr auto Timer = 0x420; // float
	}
	...
	namespace n_Aweapon_firearms_snip_mosin_long_C { // : At_FireArm_C
		constexpr auto DeviceLeftMount = 0x7e0; // UStaticMeshComponent*
	...
	namespace n_Aweapon_firearms_snip_s85_C { // : At_FireArm_C
		constexpr auto DeviceLeftMount = 0x7e0; // UStaticMeshComponent*
		constexpr auto ShellMagazine = 0x7e8; // UStaticMeshComponent*
		constexpr auto MagazineEmpty = 0x7f0; // UStaticMeshComponent*
	...
	namespace n_AShell_AR0_C { // : ASFPSShell
		constexpr auto Mesh = 0x250; // UStaticMeshComponent*
	}

	namespace n_UABP_weapon_firearms_gun_M9_C { // : USFPSWeaponAnimInstance_Gun
		constexpr auto UberGraphFrame = 0x2e0; // FPointerToUberGraphFrame
		constexpr auto AnimGraphNode_Root = 0x2e8; // FAnimNode_Root
		constexpr auto AnimGraphNode_Slot = 0x318; // FAnimNode_Slot
		constexpr auto AnimGraphNode_TransitionResult_6 = 0x360; // FAnimNode_TransitionResult
	...
	namespace n_UFormHUD_C { // : UUserWidget
		constexpr auto frmCompass = 0x268; // UfrmCompass_C*
		constexpr auto imgNoPVP = 0x270; // UImage*
		constexpr auto rmMain = 0x278; // UfrmRadialMenu_C*
		constexpr auto uwChat = 0x280; // UfrmHUDChatBox_C*
		constexpr auto imgShot0Visible = 0x288; // ESlateVisibility
		constexpr auto imgShot1Visible = 0x289; // ESlateVisibility
		constexpr auto imgShot2Visible = 0x28a; // ESlateVisibility
	}
	...
	namespace n_UfrmChatBox_C { // : USFPSUserWidget_ChatBox
		constexpr auto UberGraphFrame = 0x308; // FPointerToUberGraphFrame
		constexpr auto sbMain = 0x310; // UScrollBox*
	}
	...
	namespace n_UVaRestSettings { // : UObject
	...
	namespace n_USFPSSplitHandler { // : UObject
		constexpr auto FSplitForm = 0x28; // UUserWidget*
	}

	namespace n_UfrmPopupMenuItem_C { // : USFPSUserWidget_PopupMenuItem
		constexpr auto imgSeparator = 0x298; // UImage*
	}
	...
	namespace n_ULevelSequenceBurnIn { // : UUserWidget
		constexpr auto FrameInformation = 0x268; // FLevelSequencePlayerSnapshot
		constexpr auto LevelSequenceActor = 0x320; // ALevelSequenceActor*
	}

	namespace n_UABP_weapon_firearms_smg_scorpion_C { // : USFPSWeaponAnimInstance_AR
		constexpr auto UberGraphFrame = 0x2e0; // FPointerToUberGraphFrame
		constexpr auto AnimGraphNode_Root = 0x2e8; // FAnimNode_Root
		constexpr auto AnimGraphNode_Slot = 0x318; // FAnimNode_Slot
		constexpr auto AnimGraphNode_TransitionResult_2 = 0x360; // FAnimNode_TransitionResult
	...
	namespace n_At_AdditionalCartridge_C { // : ASFPSWeaponMF_AdditionalCartridge
		constexpr auto Trace = 0x398; // UBoxComponent*
		constexpr auto Mesh = 0x3a0; // UStaticMeshComponent*
	}

	namespace n_UUMG_RadialMenu_C { // : UUserWidget
		constexpr auto UberGraphFrame = 0x268; // FPointerToUberGraphFrame
		constexpr auto RadialBackground = 0x270; // UImage*
		constexpr auto RadiusDebug = 0x278; // UImage*
		constexpr auto RootOverlay = 0x280; // UOverlay*
		constexpr auto Segments = 0x288; // int32_t
		constexpr auto MaterialBase = 0x290; // UMaterialInterface*
		constexpr auto IndexRaw = 0x298; // float
		constexpr auto Index = 0x29c; // int32_t
		constexpr auto dynaMat = 0x2a0; // UMaterialInstanceDynamic*
		constexpr auto Children = 0x2a8; // TArray<UUserWidget*>
		constexpr auto AllowResizing = 0x2b8; // bool
		constexpr auto ItemOffsetRadius = 0x2bc; // float
		constexpr auto SelectionChanged = 0x2c0; // FMulticastInlineDelegate
		constexpr auto InputController = 0x2d0; // APlayerController*
		constexpr auto JoystickToUse = 0x2d8; // EJoystickTypes
		constexpr auto MouseDeadzone = 0x2dc; // float
		constexpr auto bInDeadzone = 0x2e0; // bool
		constexpr auto EnteredDeadzone = 0x2e8; // FMulticastInlineDelegate
		constexpr auto ExitedDeadzone = 0x2f8; // FMulticastInlineDelegate
		constexpr auto CurrentInput = 0x308; // FVector2D
		constexpr auto JoystickDeadzone = 0x310; // float
		constexpr auto DefaultToMouseIfNoJoystick = 0x314; // bool
		constexpr auto DefaultPlayerIndex = 0x318; // int32_t
		constexpr auto UseDeadzoneEvents = 0x31c; // bool
		constexpr auto SelectionChangedSound = 0x320; // USoundBase*
		constexpr auto AutoCenterMouse = 0x328; // bool
		constexpr auto AutoRotateForUp = 0x329; // bool
		constexpr auto bUseCustomInput = 0x32a; // bool
		constexpr auto CustomInput = 0x32c; // FVector2D
		constexpr auto UseCustomTexture = 0x334; // bool
		constexpr auto RadialTexture = 0x338; // UTexture*
		constexpr auto UseCustomColors = 0x340; // bool
		constexpr auto InnterRingColor = 0x344; // FLinearColor
		constexpr auto OuterRingColor = 0x354; // FLinearColor
		constexpr auto RingMainColor = 0x364; // FLinearColor
		constexpr auto UnhighlightColor = 0x374; // FLinearColor
		constexpr auto CorrectionVector = 0x384; // FVector2D
		constexpr auto bForceSetIndex = 0x38c; // bool
	}

	namespace n_ABM_WallTriaLow_01_C { // : At_LocationCraftActor_C
		constexpr auto SFPSACBaseCollision = 0x358; // USFPSACBaseCollision*
		constexpr auto SFPSACSnap = 0x360; // USFPSACSnapComponent*
	}
	...
	namespace n_Aweapmf_DTK_5-7x28_01_C { // : At_MuzzleAttachement_C
		constexpr auto Muzzle = 0x390; // USceneComponent*
	}
	...
	namespace n_USFPSUseObjectHandler { // : UObject
	...
	namespace n_Aweapmf_flashlight_01_C { // : At_HandguardDeviceLeft_C
		constexpr auto Glow = 0x358; // UStaticMeshComponent*
		constexpr auto Light = 0x360; // USpotLightComponent*
	}
	...
	namespace n_Arecoveryitem_medikit_medx_C { // : At_RecoveryItem_C
		constexpr auto Timer = 0x420; // float
	}
	...
	namespace n_Aweapmf_silencer_556x45_01_C { // : At_MuzzleAttachement_C
		constexpr auto Muzzle = 0x390; // USceneComponent*
	}
	...
	namespace n_UfrmAdminPanelPlayer_C { // : USFPSUserWidget_AdminPanel_Player
		constexpr auto btnSelected = 0x2b8; // UButton*
	}
	...
	namespace n_At_HandguardDeviceLeft_C { // : ASFPSWeaponMF_HandguardDeviceLeft
	...
	namespace n_USFPSACSpawner { // : USceneComponent
	...
	namespace n_ASFPSRepTestActor { // : AActor
	...
	namespace n_USFPSAnimEvent_PlaySound { // : UAnimNotify_PlaySound
	...
	namespace n_UDcxVehicleDriveComponentTank { // : UDcxVehicleDriveComponent
	...
	namespace n_USFPSACBaseInventory { // : UActorComponent
	...
	namespace n_USFPSPhysMatSoundTable { // : UObject
	...
	namespace n_AShell_SG0_C { // : ASFPSShell
		constexpr auto Mesh = 0x250; // UStaticMeshComponent*
	}
	...
	namespace n_USFPSACItemInventory { // : UActorComponent
	...
	namespace n_ASFPSSteelArms { // : ASFPSWeapon
	...
	namespace n_ASFPSWeaponMF_HandguardDeviceLeft { // : ASFPSBaseWeaponMF
	...
	namespace n_USFPSACRoute { // : USceneComponent
	...
	namespace n_At_Other_C { // : ASFPSBaseItem
		constexpr auto Trace = 0x310; // UBoxComponent*
		constexpr auto Mesh = 0x318; // UStaticMeshComponent*
	}
	...
	namespace n_USFPSACTrader { // : UActorComponent
	...
	namespace n_USFPSACBaseCollision { // : UBoxComponent
		constexpr auto Collisions = 0x478; // char [0x16]
	}

	namespace n_UABP_weapon_firearms_smg_Bizon_C { // : USFPSWeaponAnimInstance_AR
		constexpr auto UberGraphFrame = 0x2e0; // FPointerToUberGraphFrame
		constexpr auto AnimGraphNode_Root = 0x2e8; // FAnimNode_Root
		constexpr auto AnimGraphNode_Slot = 0x318; // FAnimNode_Slot
		constexpr auto AnimGraphNode_SequencePlayer = 0x360; // FAnimNode_SequencePlayer
	...
	namespace n_Aweapmf_DTK_545x39_02_C { // : At_MuzzleAttachement_C
		constexpr auto Muzzle = 0x390; // USceneComponent*
	}
	...
	namespace n_USFPSACDoor { // : UActorComponent
	...
	namespace n_USFPSInventoryHandler { // : UObject
		constexpr auto FormInventory = 0x570; // UUserWidget*
		constexpr auto FormGroundItem = 0x578; // USFPSUserWidget_GroundItem*
		constexpr auto FormPopupMenuItem = 0x580; // USFPSUserWidget_PopupMenuItem*
		constexpr auto FormCraftGroup = 0x588; // USFPSUserWidget_CraftRolloutMan*
		constexpr auto FormCraftItem = 0x590; // USFPSUserWidget_CraftRollout*
		constexpr auto FormTradeItem = 0x598; // USFPSUserWidget_TraderItem*
		constexpr auto frmHintPanelUse = 0x5a0; // UUserWidget*
		constexpr auto frmHintPanelMove = 0x5a8; // UUserWidget*
		constexpr auto frmHintPanelDrop = 0x5b0; // UUserWidget*
		constexpr auto FPopupMenuIcons = 0x5b8; // TArray<UPaperSprite*>
	}

	namespace n_USFPSItemSet { // : UObject
	...
	namespace n_USFPSSingleton { // : UObject
	...
	namespace n_ABM_WallLow_01_C { // : At_LocationCraftActor_C
		constexpr auto SFPSACBaseCollision = 0x358; // USFPSACBaseCollision*
		constexpr auto SFPSACSnap = 0x360; // USFPSACSnapComponent*
	}
	...
	namespace n_UfrmCraftGroup_C { // : USFPSUserWidget_CraftRolloutMan
		constexpr auto UberGraphFrame = 0x2b8; // FPointerToUberGraphFrame
		constexpr auto btnOpen = 0x2c0; // UCheckBox*
		constexpr auto imgBackground0 = 0x2c8; // UImage*
		constexpr auto imgIcon = 0x2d0; // UImage*
	...
	namespace n_ABM_Wall_01_C { // : At_LocationCraftActor_C
		constexpr auto SFPSACBaseCollision = 0x358; // USFPSACBaseCollision*
		constexpr auto SFPSACSnap = 0x360; // USFPSACSnapComponent*
	}
	...
	namespace n_USFPSSettingsHandler { // : UObject
	...
	namespace n_USFPSAI_TLookAtTarget { // : UBTTaskNode
	...
	namespace n_Aweapon_firearms_rifle_famas_C { // : At_FireArm_C
		constexpr auto DTK = 0x7e0; // UStaticMeshComponent*
	...
	namespace n_UABP_weapon_firearms_smg_ump_C { // : USFPSWeaponAnimInstance_AR
		constexpr auto UberGraphFrame = 0x2e0; // FPointerToUberGraphFrame
		constexpr auto AnimGraphNode_Root = 0x2e8; // FAnimNode_Root
		constexpr auto AnimGraphNode_SequencePlayer = 0x318; // FAnimNode_SequencePlayer
		constexpr auto AnimGraphNode_Slot = 0x398; // FAnimNode_Slot
	...
	namespace n_ASFPSBaseLocationCraftItem { // : ASFPSActor
	...
	namespace n_USFPSWeaponAnimInstance_SG { // : USFPSBaseWeaponAnimInstance
	...
	namespace n_Aweapon_firearms_rifle_steyraug_C { // : At_FireArm_C
		constexpr auto DTK = 0x7e0; // UStaticMeshComponent*
		constexpr auto DeviceLeftMount = 0x7e8; // UStaticMeshComponent*
		constexpr auto SightClose = 0x7f0; // UStaticMeshComponent*
	...
	namespace n_UABP_weapon_firearms_rifle_hunter85_C { // : USFPSWeaponAnimInstance_SR
	...
	namespace n_USFPSUserWidget_EquipItem { // : UCanvasPanel
	...
	namespace n_ABMF_Claim_C { // : At_LocationCraftActor_C
	...
	namespace n_ABox_mil_05_C { // : AActor
		constexpr auto Box_military_cap_01 = 0x220; // UStaticMeshComponent*
		constexpr auto Box_military_01 = 0x228; // UStaticMeshComponent*
	}

	namespace n_UFormSettings_C { // : UUserWidget
		constexpr auto cbVideo_Mode = 0x268; // UComboBoxString*
		constexpr auto cbVideo_Resolution = 0x270; // UComboBoxString*
	}
	...
	namespace n_Ascope_col_eotech_C { // : At_Sight_C
	...
	namespace n_ASFPSPlayerState { // : APlayerState
	...
	namespace n_Aweapon_firearms_sg_mossberg590_C { // : At_FireArm_C
		constexpr auto DeviceLeftMount = 0x7e0; // UStaticMeshComponent*
		constexpr auto SFPSACWeaponMFInventory = 0x7e8; // USFPSACWeaponMFInventory*
		constexpr auto SightOpen = 0x7f0; // UStaticMeshComponent*
	...
	namespace n_ABM_WallDoor_lock_01_C { // : ABM_WallDoor_01_C
	...
	namespace n_ABM_WallTriaWindow_02_C { // : At_LocationCraftActor_C
		constexpr auto SFPSACBaseCollision = 0x358; // USFPSACBaseCollision*
		constexpr auto SFPSACSnap = 0x360; // USFPSACSnapComponent*
	}
	...
	namespace n_UFormInGameMenu_C { // : UUserWidget
		constexpr auto btnDiscord = 0x268; // UButton*
		constexpr auto btnFacebook = 0x270; // UButton*
		constexpr auto btnGreenAreaTeleport = 0x278; // UButton*
		constexpr auto btnLeaveServer = 0x280; // UButton*
		constexpr auto btnQuitGame = 0x288; // UButton*
		constexpr auto btnResume = 0x290; // UButton*
		constexpr auto btnSettings = 0x298; // UButton*
		constexpr auto btnSteam = 0x2a0; // UButton*
		constexpr auto btnSuicide = 0x2a8; // UButton*
		constexpr auto btnTwitch = 0x2b0; // UButton*
		constexpr auto btnTwitter = 0x2b8; // UButton*
		constexpr auto btnVK = 0x2c0; // UButton*
	}
	...
	namespace n_UMainMenu_C { // : UUserWidget
		constexpr auto btnContinue_Steam = 0x268; // UButton*
		constexpr auto btnDiscord = 0x270; // UButton*
		constexpr auto btnExit = 0x278; // UButton*
		constexpr auto btnFacebook = 0x280; // UButton*
		constexpr auto btnJoinServer_LoginPassword = 0x288; // UButton*
		constexpr auto btnJoinServer_Steam = 0x290; // UButton*
		constexpr auto btnSettings = 0x298; // UButton*
		constexpr auto btnSteam = 0x2a0; // UButton*
	...
	namespace n_USFPSChatHandler { // : UObject
	...
	namespace n_Aweapmf_DTK_556x45_02_C { // : At_MuzzleAttachement_C
		constexpr auto Muzzle = 0x390; // USceneComponent*
	}
	...
	namespace n_AAfterDeathActor_C { // : AActor
		constexpr auto UberGraphFrame = 0x220; // FPointerToUberGraphFrame
	...
	namespace n_ASFPSSmallArms { // : ASFPSWeapon
	...
	namespace n_UFormDlg_InputBox_C { // : UUserWidget
		constexpr auto UberGraphFrame = 0x268; // FPointerToUberGraphFrame
		constexpr auto btnCancel = 0x270; // UButton*
		constexpr auto btnOk = 0x278; // UButton*
		constexpr auto lbCancel = 0x280; // UTextBlock*
		constexpr auto lbOk = 0x288; // UTextBlock*
	}
	...
	namespace n_USFPSSoundHandler { // : UObject
		constexpr auto AmbientSoundManager = 0x28; // USFPSAmbientSoundManager*
	}

	namespace n_Aweapon_firearms_smg_fnp90_C { // : At_FireArm_C
		constexpr auto DTK = 0x7e0; // UStaticMeshComponent*
		constexpr auto DeviceLeftMount = 0x7e8; // UStaticMeshComponent*
		constexpr auto SightOpen = 0x7f0; // UStaticMeshComponent*
		constexpr auto SFPSACWeaponMFInventory = 0x7f8; // USFPSACWeaponMFInventory*
	...
	namespace n_ASFPSBaseMissileProjectile { // : AActor
	...
	namespace n_Aweapon_firearms_rifle_groza_C { // : At_FireArm_C
	...
	namespace n_Aweapon_firearms_sg_mp133_C { // : At_FireArm_C
		constexpr auto DeviceLeftMount = 0x7e0; // UStaticMeshComponent*
		constexpr auto SFPSACWeaponMFInventory = 0x7e8; // USFPSACWeaponMFInventory*
		constexpr auto Shell = 0x7f0; // UStaticMeshComponent*
	}

	namespace n_UCreatePlayer_C { // : UUserWidget
		constexpr auto UberGraphFrame = 0x268; // FPointerToUberGraphFrame
		constexpr auto btnAfro01 = 0x270; // UCheckBox*
		constexpr auto btnArab01 = 0x278; // UCheckBox*
		constexpr auto btnArab02 = 0x280; // UCheckBox*
		constexpr auto btnCreate = 0x288; // UButton*
		constexpr auto btnEast01 = 0x290; // UCheckBox*
		constexpr auto btnEuro01 = 0x298; // UCheckBox*
		constexpr auto btnEuro02 = 0x2a0; // UCheckBox*
		constexpr auto btnEuro03 = 0x2a8; // UCheckBox*
		constexpr auto btnMenu = 0x2b0; // UButton*
		constexpr auto imgBackground = 0x2b8; // UImage*
		constexpr auto lbButtonLogin = 0x2c0; // UTextBlock*
		constexpr auto lbMenu = 0x2c8; // UTextBlock*
	}

	namespace n_USFPSUISoundTable { // : UObject
	...
	namespace n_UABP_weapon_firearms_mg_mg36_C { // : USFPSWeaponAnimInstance_AR
		constexpr auto UberGraphFrame = 0x2e0; // FPointerToUberGraphFrame
		constexpr auto AnimGraphNode_Root = 0x2e8; // FAnimNode_Root
		constexpr auto AnimGraphNode_Slot = 0x318; // FAnimNode_Slot
		constexpr auto AnimGraphNode_SequencePlayer = 0x360; // FAnimNode_SequencePlayer
	...
	namespace n_USFPSACBoxCollisionComponent { // : UBoxComponent
	...
	namespace n_Aweapon_firearms_rifle_scar_C { // : At_FireArm_C
		constexpr auto DTK = 0x7e0; // UStaticMeshComponent*
		constexpr auto DeviceLeftMount = 0x7e8; // UStaticMeshComponent*
		constexpr auto SightClose = 0x7f0; // UStaticMeshComponent*
		constexpr auto SightOpen = 0x7f8; // UStaticMeshComponent*
	...
	namespace n_USFPSAnimEvent_InverseKinematics { // : UAnimNotify
	...
	namespace n_AMainMenu_C { // : ALevelScriptActor
	...
	namespace n_Aweapon_firearms_smg_scorpion_C { // : At_FireArm_C
		constexpr auto DeviceLeftMount = 0x7e0; // UStaticMeshComponent*
		constexpr auto SFPSACWeaponMFInventory = 0x7e8; // USFPSACWeaponMFInventory*
		constexpr auto MagazineFull = 0x7f0; // UStaticMeshComponent*
		constexpr auto MagazineEmpty = 0x7f8; // UStaticMeshComponent*
	...
	namespace n_USFPSDebrisHandler { // : UObject
		constexpr auto ShellManager = 0x28; // USFPSShellManager*
	}

	namespace n_USoundNodeModulOuterParam { // : USoundNode
	...
	namespace n_USFPSACGameplayEvent { // : USceneComponent
	...
	namespace n_UUserWidget { // : UWidget
		constexpr auto ColorAndOpacity = 0x114; // FLinearColor
		constexpr auto ColorAndOpacityDelegate = 0x124; // FDelegate
		constexpr auto ForegroundColor = 0x138; // FSlateColor
		constexpr auto ForegroundColorDelegate = 0x160; // FDelegate
		constexpr auto OnVisibilityChanged = 0x170; // FMulticastInlineDelegate
		constexpr auto Padding = 0x198; // FMargin
		constexpr auto ActiveSequencePlayers = 0x1a8; // TArray<UUMGSequencePlayer*>
		constexpr auto AnimationTickManager = 0x1b8; // UUMGSequenceTickManager*
		...
		constexpr auto WidgetTree = 0x1e0; // UWidgetTree*
		constexpr auto Priority = 0x1e8; // int32_t
		constexpr auto bSupportsKeyboardFocus = 0x1ec; // char : 1
		constexpr auto bIsFocusable = 0x1ec; // char : 1
		constexpr auto bStopAction = 0x1ec; // char : 1
		constexpr auto bHasScriptImplementedTick = 0x1ec; // char : 1
		constexpr auto bHasScriptImplementedPaint = 0x1ec; // char : 1
		constexpr auto TickFrequency = 0x1f8; // EWidgetTickFrequency
		constexpr auto InputComponent = 0x200; // UInputComponent*
		constexpr auto AnimationCallbacks = 0x208; // TArray<FAnimationEventBinding>
	}
	...
	namespace n_USFPSACFISM { // : UFoliageInstancedStaticMeshComponent
	...
	namespace n_USFPSACSteamInventory { // : UActorComponent
		constexpr auto ClientInventory = 0xd8; // TArray<TWeakObjectPtr<ASFPSBaseItem>>
	}

	namespace n_Aweapon_steelarms_knife_02_C { // : At_SteelArm_C
		constexpr auto DamagePoint2 = 0x620; // USceneComponent*
		constexpr auto DamagePoint1 = 0x628; // USceneComponent*
		constexpr auto DamagePoint0 = 0x630; // USceneComponent*
	}
	...
	namespace n_ASFPSLootBox { // : ASFPSBaseLocationCraftItem
	...
	namespace n_UABP_weapon_firearms_snip_svd_C { // : USFPSWeaponAnimInstance_AR
		constexpr auto UberGraphFrame = 0x2e0; // FPointerToUberGraphFrame
		constexpr auto AnimGraphNode_Root = 0x2e8; // FAnimNode_Root
		constexpr auto AnimGraphNode_Slot = 0x318; // FAnimNode_Slot
		constexpr auto AnimGraphNode_TransitionResult_2 = 0x360; // FAnimNode_TransitionResult
	...
	namespace n_ABM_WallTria_01_C { // : At_LocationCraftActor_C
		constexpr auto SFPSACBaseCollision = 0x358; // USFPSACBaseCollision*
		constexpr auto SFPSACSnap = 0x360; // USFPSACSnapComponent*
	}
	...
	namespace n_AUAZ_01_Static_C { // : ASFPSWheeledVehicle
	...
	namespace n_UFormDlg_OkCancel_C { // : UUserWidget
		constexpr auto UberGraphFrame = 0x268; // FPointerToUberGraphFrame
		constexpr auto btnCancel = 0x270; // UButton*
		constexpr auto btnOk = 0x278; // UButton*
		constexpr auto lbCancel = 0x280; // UTextBlock*
	...
	namespace n_USFPSLockBreakingHandler { // : UObject
	...
	namespace n_ASFPSBaseLootSpawner { // : AActor
	...
	namespace n_UABP_weapon_firearms_rifle_scar_C { // : USFPSWeaponAnimInstance_AR
		constexpr auto UberGraphFrame = 0x2e0; // FPointerToUberGraphFrame
		constexpr auto AnimGraphNode_Root = 0x2e8; // FAnimNode_Root
		constexpr auto AnimGraphNode_Slot = 0x318; // FAnimNode_Slot
		constexpr auto AnimGraphNode_TransitionResult_2 = 0x360; // FAnimNode_TransitionResult
	...
	namespace n_UABP_weapon_firearms_smg_mp5_C { // : USFPSWeaponAnimInstance_AR
		constexpr auto UberGraphFrame = 0x2e0; // FPointerToUberGraphFrame
		constexpr auto AnimGraphNode_Root = 0x2e8; // FAnimNode_Root
		constexpr auto AnimGraphNode_SequencePlayer = 0x318; // FAnimNode_SequencePlayer
		constexpr auto AnimGraphNode_Slot = 0x398; // FAnimNode_Slot
	...
	namespace n_UFormItemMessage_C { // : UUserWidget
		constexpr auto svItem = 0x268; // UfrmSpriteViewMessage_C*
	}
	...
	namespace n_UfrmAdminPanelItem_C { // : USFPSUserWidget_TraderItem
		constexpr auto btnAction0 = 0x310; // UButton*
	...
	namespace n_UABP_weapon_firearms_rifle_famas_C { // : USFPSWeaponAnimInstance_AR
		constexpr auto UberGraphFrame = 0x2e0; // FPointerToUberGraphFrame
		constexpr auto AnimGraphNode_Root = 0x2e8; // FAnimNode_Root
		constexpr auto AnimGraphNode_SequencePlayer = 0x318; // FAnimNode_SequencePlayer
		constexpr auto AnimGraphNode_Slot = 0x398; // FAnimNode_Slot
	...
	namespace n_UfrmChatItem_C { // : USFPSUserWidget_ChatItem
		constexpr auto UberGraphFrame = 0x318; // FPointerToUberGraphFrame
		constexpr auto btnMain = 0x320; // UButton*
	}
	...
	namespace n_UModulatorContOuterParams { // : UObject
	...
	namespace n_ABox_mil_03_C { // : AActor
		constexpr auto Box_military_cap_01 = 0x220; // UStaticMeshComponent*
		constexpr auto Box_military_01 = 0x228; // UStaticMeshComponent*
	}
	...
	namespace n_UfrmHotKey_C { // : USFPSUserWidget_SettingsHotKey
		constexpr auto UberGraphFrame = 0x2e0; // FPointerToUberGraphFrame
		constexpr auto ikKey = 0x2e8; // UInputKeySelector*
	}
	...
	namespace n_ASFPSWeaponMF_AdditionalCartridge { // : ASFPSBaseWeaponMF
	...
	namespace n_USFPSAirDropManager { // : UObject
	...
	namespace n_Ascope_col_walter_mrs_C { // : At_Sight_C
	...
	namespace n_UFormInventory_C { // : UUserWidget
		constexpr auto UberGraphFrame = 0x268; // FPointerToUberGraphFrame
		constexpr auto btnCar = 0x270; // UCheckBox*
		constexpr auto btnCell = 0x278; // UCheckBox*
		constexpr auto btnCorpse = 0x280; // UCheckBox*
		constexpr auto btnCraft = 0x288; // UCheckBox*
		constexpr auto btnGround = 0x290; // UCheckBox*
		constexpr auto btnLootBox = 0x298; // UCheckBox*
		constexpr auto btnSteamInventory = 0x2a0; // UCheckBox*
		constexpr auto btnSteamInventoryRefresh = 0x2a8; // UButton*
		constexpr auto btnTrader = 0x2b0; // UCheckBox*
		constexpr auto cbFilterLeft = 0x2b8; // UComboBoxString*
		constexpr auto cbFilterSteamInventory = 0x2c0; // UComboBoxString*
		constexpr auto frmPopupMenu = 0x2c8; // UfrmPopupMenu_C*
		constexpr auto imgBackgroundAvailable = 0x2d0; // UImage*
		constexpr auto imgBackgroundAvailableSteam = 0x2d8; // UImage*
		constexpr auto imgBackgroundNotAvailableSteam = 0x2e0; // UImage*
		constexpr auto lbCar = 0x2e8; // UTextBlock*
		constexpr auto lbCell = 0x2f0; // UTextBlock*
		constexpr auto lbCorpse = 0x2f8; // UTextBlock*
		constexpr auto lbCraft = 0x300; // UTextBlock*
		constexpr auto lbGround = 0x308; // UTextBlock*
		constexpr auto lbLootBox = 0x310; // UTextBlock*
		constexpr auto lbSteamInventory = 0x318; // UTextBlock*
		constexpr auto lbTakeAll = 0x320; // UTextBlock*
		constexpr auto lbTrader = 0x328; // UTextBlock*
		constexpr auto nsDraggingItem = 0x330; // UNamedSlot*
		constexpr auto nsHint = 0x338; // UNamedSlot*
		constexpr auto nsPopupMenu = 0x340; // UNamedSlot*
		constexpr auto svBackPack = 0x348; // UfrmSpriteViewEquip_C*
		constexpr auto svBackPack0 = 0x350; // UfrmSpriteViewInv_C*
		constexpr auto svBackPack1 = 0x358; // UfrmSpriteViewInv_C*
		constexpr auto svBackPack10 = 0x360; // UfrmSpriteViewInv_C*
		constexpr auto svBackPack11 = 0x368; // UfrmSpriteViewInv_C*
		constexpr auto svBackPack12 = 0x370; // UfrmSpriteViewInv_C*
		constexpr auto svBackPack13 = 0x378; // UfrmSpriteViewInv_C*
		constexpr auto svBackPack14 = 0x380; // UfrmSpriteViewInv_C*
		constexpr auto svBackPack15 = 0x388; // UfrmSpriteViewInv_C*
		constexpr auto svBackPack16 = 0x390; // UfrmSpriteViewInv_C*
		constexpr auto svBackPack17 = 0x398; // UfrmSpriteViewInv_C*
		constexpr auto svBackPack18 = 0x3a0; // UfrmSpriteViewInv_C*
		constexpr auto svBackPack19 = 0x3a8; // UfrmSpriteViewInv_C*
		constexpr auto svBackPack2 = 0x3b0; // UfrmSpriteViewInv_C*
		constexpr auto svBackPack3 = 0x3b8; // UfrmSpriteViewInv_C*
		constexpr auto svBackPack4 = 0x3c0; // UfrmSpriteViewInv_C*
		constexpr auto svBackPack5 = 0x3c8; // UfrmSpriteViewInv_C*
		constexpr auto svBackPack6 = 0x3d0; // UfrmSpriteViewInv_C*
		constexpr auto svBackPack7 = 0x3d8; // UfrmSpriteViewInv_C*
		constexpr auto svBackPack8 = 0x3e0; // UfrmSpriteViewInv_C*
		constexpr auto svBackPack9 = 0x3e8; // UfrmSpriteViewInv_C*
		constexpr auto svCar0 = 0x3f0; // UfrmSpriteViewInv_C*
		constexpr auto svCar1 = 0x3f8; // UfrmSpriteViewInv_C*
		constexpr auto svCar10 = 0x400; // UfrmSpriteViewInv_C*
		constexpr auto svCar11 = 0x408; // UfrmSpriteViewInv_C*
		constexpr auto svCar12 = 0x410; // UfrmSpriteViewInv_C*
		constexpr auto svCar13 = 0x418; // UfrmSpriteViewInv_C*
		constexpr auto svCar14 = 0x420; // UfrmSpriteViewInv_C*
		constexpr auto svCar15 = 0x428; // UfrmSpriteViewInv_C*
		constexpr auto svCar16 = 0x430; // UfrmSpriteViewInv_C*
		constexpr auto svCar17 = 0x438; // UfrmSpriteViewInv_C*
		constexpr auto svCar18 = 0x440; // UfrmSpriteViewInv_C*
		constexpr auto svCar19 = 0x448; // UfrmSpriteViewInv_C*
		constexpr auto svCar2 = 0x450; // UfrmSpriteViewInv_C*
		constexpr auto svCar20 = 0x458; // UfrmSpriteViewInv_C*
		constexpr auto svCar21 = 0x460; // UfrmSpriteViewInv_C*
		constexpr auto svCar22 = 0x468; // UfrmSpriteViewInv_C*
		constexpr auto svCar23 = 0x470; // UfrmSpriteViewInv_C*
		constexpr auto svCar24 = 0x478; // UfrmSpriteViewInv_C*
		constexpr auto svCar25 = 0x480; // UfrmSpriteViewInv_C*
		constexpr auto svCar26 = 0x488; // UfrmSpriteViewInv_C*
		constexpr auto svCar27 = 0x490; // UfrmSpriteViewInv_C*
		constexpr auto svCar28 = 0x498; // UfrmSpriteViewInv_C*
		constexpr auto svCar29 = 0x4a0; // UfrmSpriteViewInv_C*
		constexpr auto svCar3 = 0x4a8; // UfrmSpriteViewInv_C*
		constexpr auto svCar30 = 0x4b0; // UfrmSpriteViewInv_C*
		constexpr auto svCar31 = 0x4b8; // UfrmSpriteViewInv_C*
		constexpr auto svCar32 = 0x4c0; // UfrmSpriteViewInv_C*
		constexpr auto svCar33 = 0x4c8; // UfrmSpriteViewInv_C*
		constexpr auto svCar34 = 0x4d0; // UfrmSpriteViewInv_C*
		constexpr auto svCar35 = 0x4d8; // UfrmSpriteViewInv_C*
		constexpr auto svCar4 = 0x4e0; // UfrmSpriteViewInv_C*
		constexpr auto svCar5 = 0x4e8; // UfrmSpriteViewInv_C*
		constexpr auto svCar6 = 0x4f0; // UfrmSpriteViewInv_C*
		constexpr auto svCar7 = 0x4f8; // UfrmSpriteViewInv_C*
		constexpr auto svCar8 = 0x500; // UfrmSpriteViewInv_C*
		constexpr auto svCar9 = 0x508; // UfrmSpriteViewInv_C*
		constexpr auto svCell0 = 0x510; // UfrmSpriteViewInv_C*
		constexpr auto svCell1 = 0x518; // UfrmSpriteViewInv_C*
		constexpr auto svCell10 = 0x520; // UfrmSpriteViewInv_C*
		constexpr auto svCell11 = 0x528; // UfrmSpriteViewInv_C*
		constexpr auto svCell12 = 0x530; // UfrmSpriteViewInv_C*
		constexpr auto svCell13 = 0x538; // UfrmSpriteViewInv_C*
		constexpr auto svCell14 = 0x540; // UfrmSpriteViewInv_C*
		constexpr auto svCell15 = 0x548; // UfrmSpriteViewInv_C*
		constexpr auto svCell16 = 0x550; // UfrmSpriteViewInv_C*
		constexpr auto svCell17 = 0x558; // UfrmSpriteViewInv_C*
		constexpr auto svCell18 = 0x560; // UfrmSpriteViewInv_C*
		constexpr auto svCell19 = 0x568; // UfrmSpriteViewInv_C*
		constexpr auto svCell2 = 0x570; // UfrmSpriteViewInv_C*
		constexpr auto svCell20 = 0x578; // UfrmSpriteViewInv_C*
		constexpr auto svCell21 = 0x580; // UfrmSpriteViewInv_C*
		constexpr auto svCell22 = 0x588; // UfrmSpriteViewInv_C*
		constexpr auto svCell23 = 0x590; // UfrmSpriteViewInv_C*
		constexpr auto svCell24 = 0x598; // UfrmSpriteViewInv_C*
		constexpr auto svCell25 = 0x5a0; // UfrmSpriteViewInv_C*
		constexpr auto svCell26 = 0x5a8; // UfrmSpriteViewInv_C*
		constexpr auto svCell27 = 0x5b0; // UfrmSpriteViewInv_C*
		constexpr auto svCell28 = 0x5b8; // UfrmSpriteViewInv_C*
		constexpr auto svCell29 = 0x5c0; // UfrmSpriteViewInv_C*
		constexpr auto svCell3 = 0x5c8; // UfrmSpriteViewInv_C*
		constexpr auto svCell30 = 0x5d0; // UfrmSpriteViewInv_C*
		constexpr auto svCell31 = 0x5d8; // UfrmSpriteViewInv_C*
		constexpr auto svCell32 = 0x5e0; // UfrmSpriteViewInv_C*
		constexpr auto svCell33 = 0x5e8; // UfrmSpriteViewInv_C*
		constexpr auto svCell34 = 0x5f0; // UfrmSpriteViewInv_C*
		constexpr auto svCell35 = 0x5f8; // UfrmSpriteViewInv_C*
		constexpr auto svCell4 = 0x600; // UfrmSpriteViewInv_C*
		constexpr auto svCell5 = 0x608; // UfrmSpriteViewInv_C*
		constexpr auto svCell6 = 0x610; // UfrmSpriteViewInv_C*
		constexpr auto svCell7 = 0x618; // UfrmSpriteViewInv_C*
		constexpr auto svCell8 = 0x620; // UfrmSpriteViewInv_C*
		constexpr auto svCell9 = 0x628; // UfrmSpriteViewInv_C*
		constexpr auto svGadget0 = 0x630; // UfrmSpriteViewInv_C*
		constexpr auto svGadget1 = 0x638; // UfrmSpriteViewInv_C*
		constexpr auto svGadget2 = 0x640; // UfrmSpriteViewInv_C*
		constexpr auto svGadget3 = 0x648; // UfrmSpriteViewInv_C*
		constexpr auto svGlasses = 0x650; // UfrmSpriteViewInv_C*
		constexpr auto svGloves = 0x658; // UfrmSpriteViewInv_C*
		constexpr auto svHelmet = 0x660; // UfrmSpriteViewInv_C*
		constexpr auto svJacket = 0x668; // UfrmSpriteViewEquip_C*
		constexpr auto svJacket0 = 0x670; // UfrmSpriteViewInv_C*
		constexpr auto svJacket1 = 0x678; // UfrmSpriteViewInv_C*
		constexpr auto svJacket2 = 0x680; // UfrmSpriteViewInv_C*
		constexpr auto svJacket3 = 0x688; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox0 = 0x690; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox1 = 0x698; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox10 = 0x6a0; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox11 = 0x6a8; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox12 = 0x6b0; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox13 = 0x6b8; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox14 = 0x6c0; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox15 = 0x6c8; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox16 = 0x6d0; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox17 = 0x6d8; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox18 = 0x6e0; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox19 = 0x6e8; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox2 = 0x6f0; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox20 = 0x6f8; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox21 = 0x700; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox22 = 0x708; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox23 = 0x710; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox24 = 0x718; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox25 = 0x720; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox26 = 0x728; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox27 = 0x730; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox28 = 0x738; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox29 = 0x740; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox3 = 0x748; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox30 = 0x750; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox31 = 0x758; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox32 = 0x760; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox33 = 0x768; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox34 = 0x770; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox35 = 0x778; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox4 = 0x780; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox5 = 0x788; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox6 = 0x790; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox7 = 0x798; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox8 = 0x7a0; // UfrmSpriteViewInv_C*
		constexpr auto svLootBox9 = 0x7a8; // UfrmSpriteViewInv_C*
		constexpr auto svMask = 0x7b0; // UfrmSpriteViewInv_C*
		constexpr auto svQuickSlot0 = 0x7b8; // UfrmQuickSlot_C*
		constexpr auto svQuickSlot1 = 0x7c0; // UfrmQuickSlot_C*
		constexpr auto svQuickSlot10 = 0x7c8; // UfrmQuickSlot_C*
		constexpr auto svQuickSlot2 = 0x7d0; // UfrmQuickSlot_C*
		constexpr auto svQuickSlot3 = 0x7d8; // UfrmQuickSlot_C*
		constexpr auto svQuickSlot4 = 0x7e0; // UfrmQuickSlot_C*
		constexpr auto svQuickSlot5 = 0x7e8; // UfrmQuickSlot_C*
		constexpr auto svQuickSlot6 = 0x7f0; // UfrmQuickSlot_C*
		constexpr auto svQuickSlot7 = 0x7f8; // UfrmQuickSlot_C*
		constexpr auto svQuickSlot8 = 0x800; // UfrmQuickSlot_C*
		constexpr auto svQuickSlot9 = 0x808; // UfrmQuickSlot_C*
		constexpr auto svTrous = 0x810; // UfrmSpriteViewEquip_C*
		constexpr auto svTrous0 = 0x818; // UfrmSpriteViewInv_C*
		constexpr auto svTrous1 = 0x820; // UfrmSpriteViewInv_C*
		constexpr auto svTrous2 = 0x828; // UfrmSpriteViewInv_C*
		constexpr auto svTrous3 = 0x830; // UfrmSpriteViewInv_C*
		constexpr auto svVest = 0x838; // UfrmSpriteViewEquip_C*
		constexpr auto svVest0 = 0x840; // UfrmSpriteViewInv_C*
		constexpr auto svVest1 = 0x848; // UfrmSpriteViewInv_C*
		constexpr auto svVest10 = 0x850; // UfrmSpriteViewInv_C*
		constexpr auto svVest11 = 0x858; // UfrmSpriteViewInv_C*
		constexpr auto svVest2 = 0x860; // UfrmSpriteViewInv_C*
		constexpr auto svVest3 = 0x868; // UfrmSpriteViewInv_C*
		constexpr auto svVest4 = 0x870; // UfrmSpriteViewInv_C*
		constexpr auto svVest5 = 0x878; // UfrmSpriteViewInv_C*
		constexpr auto svVest6 = 0x880; // UfrmSpriteViewInv_C*
		constexpr auto svVest7 = 0x888; // UfrmSpriteViewInv_C*
		constexpr auto svVest8 = 0x890; // UfrmSpriteViewInv_C*
		constexpr auto svVest9 = 0x898; // UfrmSpriteViewInv_C*
		constexpr auto svWeapon0 = 0x8a0; // UfrmSpriteViewInv_C*
		constexpr auto svWeapon0_SubItem0 = 0x8a8; // UfrmSpriteViewInv_C*
		constexpr auto svWeapon0_SubItem1 = 0x8b0; // UfrmSpriteViewInv_C*
		constexpr auto svWeapon0_SubItem2 = 0x8b8; // UfrmSpriteViewInv_C*
		constexpr auto svWeapon0_SubItem3 = 0x8c0; // UfrmSpriteViewInv_C*
		constexpr auto svWeapon0_SubItem4 = 0x8c8; // UfrmSpriteViewInv_C*
		constexpr auto svWeapon1 = 0x8d0; // UfrmSpriteViewInv_C*
		constexpr auto svWeapon1_SubItem0 = 0x8d8; // UfrmSpriteViewInv_C*
		constexpr auto svWeapon1_SubItem1 = 0x8e0; // UfrmSpriteViewInv_C*
		constexpr auto svWeapon1_SubItem2 = 0x8e8; // UfrmSpriteViewInv_C*
		constexpr auto svWeapon1_SubItem3 = 0x8f0; // UfrmSpriteViewInv_C*
		constexpr auto svWeapon1_SubItem4 = 0x8f8; // UfrmSpriteViewInv_C*
		constexpr auto svWeapon2 = 0x900; // UfrmSpriteViewInv_C*
		constexpr auto svWeapon2_SubItem0 = 0x908; // UfrmSpriteViewInv_C*
		constexpr auto svWeapon2_SubItem1 = 0x910; // UfrmSpriteViewInv_C*
		constexpr auto svWeapon2_SubItem2 = 0x918; // UfrmSpriteViewInv_C*
		constexpr auto svWeapon2_SubItem3 = 0x920; // UfrmSpriteViewInv_C*
		constexpr auto svWeapon2_SubItem4 = 0x928; // UfrmSpriteViewInv_C*
		constexpr auto FSelectedGroundSpriteView_ForHint = 0x930; // UfrmGroundItem_C*
		constexpr auto FSelectedGroundSpriteView_ForDraggingItem = 0x938; // UfrmGroundItem_C*
		constexpr auto FSelectedEquipSpriteView_ForDraggingItem = 0x940; // USFPSUserWidget_EquipItem*
		constexpr auto FSelectedEquipSpriteView_ForHint = 0x948; // USFPSUserWidget_EquipItem*
		constexpr auto FMouseRightButtonIsDowned = 0x950; // bool
		constexpr auto FMouseLeftButtonIsDowned = 0x951; // bool
	}

	namespace n_AM_TripwireTrap_03_C { // : At_LocationCraftActor_C
		constexpr auto Interaction = 0x358; // UBoxComponent*
		constexpr auto GrenadeCollision = 0x360; // UBoxComponent*
		constexpr auto ExplosionCollision = 0x368; // UBoxComponent*
		constexpr auto ACTripwireTrap = 0x370; // USFPSACTripwireTrap*
	...
	namespace n_UfrmQuickSlot_C { // : USFPSUserWidget_QuickSlot
		constexpr auto UberGraphFrame = 0x2c8; // FPointerToUberGraphFrame
		constexpr auto btnMain = 0x2d0; // UButton*
		constexpr auto pnMain = 0x2d8; // USFPSUserWidget_EquipItem*
	}
	...
	namespace n_UVaRestRequestJSON { // : UObject
	...
	namespace n_Aweapon_firearms_smg_hkmp5_C { // : At_FireArm_C
		constexpr auto DTK = 0x7e0; // UStaticMeshComponent*
	...
	namespace n_USFPSAI_DRandom { // : UBTDecorator
	...
	namespace n_UFormSplit_C { // : UUserWidget
		constexpr auto btnCancel = 0x268; // UButton*
		constexpr auto btnDown = 0x270; // UButton*
		constexpr auto btnMax = 0x278; // UButton*
		constexpr auto btnMin = 0x280; // UButton*
		constexpr auto btnOk = 0x288; // UButton*
		constexpr auto btnUp = 0x290; // UButton*
		constexpr auto edText = 0x298; // UEditableTextBox*
		constexpr auto imgBackground0 = 0x2a0; // UImage*
		constexpr auto svItem = 0x2a8; // UfrmSpriteViewInv_C*
	}
	...
	namespace n_ASFPSBaseItem { // : ASFPSActor
	...
	namespace n_USFPSAI_TSetStateTime { // : UBTTaskNode
	...
	namespace n_USFPSAmbientSoundManager { // : UObject
	...
	namespace n_Adevice_flashlight_01_C { // : At_Device_C
		constexpr auto Glow = 0x4a0; // UStaticMeshComponent*
		constexpr auto Light = 0x4a8; // USpotLightComponent*
	}

	namespace n_UfrmTraderItem_C { // : USFPSUserWidget_TraderItem
		constexpr auto btnAction0 = 0x310; // UButton*
	}
	...
	namespace n_ASFPSPatrol { // : AActor
	...
	namespace n_UFormLockBreaking_C { // : UUserWidget
		constexpr auto Image_85 = 0x268; // UImage*
	}
	...
	namespace n_UABP_weapon_firearms_rifle_aksu_C { // : USFPSWeaponAnimInstance_AR
		constexpr auto UberGraphFrame = 0x2e0; // FPointerToUberGraphFrame
		constexpr auto AnimGraphNode_Root = 0x2e8; // FAnimNode_Root
		constexpr auto AnimGraphNode_SequencePlayer = 0x318; // FAnimNode_SequencePlayer
		constexpr auto AnimGraphNode_Slot = 0x398; // FAnimNode_Slot
	...
	namespace n_At_MuzzleAttachement_C { // : ASFPSWeaponMF_MuzzleAttachment
	...
	namespace n_Ascope_opt_hunting_C { // : At_Sight_C
		constexpr auto hunting_reticles = 0x3d0; // UStaticMeshComponent*
	}

	namespace n_ASFPSItemSkin { // : ASFPSBaseItem
	...
	namespace n_UDcxVehicleDriveComponent { // : UDcxVehicleWheelsComponent
	...
	namespace n_USFPSAI_TChangePose { // : UBTTaskNode
	...
	namespace n_UABP_weapon_firearms_smg_p90_C { // : USFPSWeaponAnimInstance_AR
		constexpr auto UberGraphFrame = 0x2e0; // FPointerToUberGraphFrame
		constexpr auto AnimGraphNode_Root = 0x2e8; // FAnimNode_Root
		constexpr auto AnimGraphNode_SequencePlayer = 0x318; // FAnimNode_SequencePlayer
		constexpr auto AnimGraphNode_Slot = 0x398; // FAnimNode_Slot
	...
	namespace n_ABM_WallBig_01_C { // : At_LocationCraftActor_C
	...
	namespace n_USFPSHiddenStash { // : UObject
		constexpr auto LootBoxSpawner = 0x30; // ASFPSLootBoxSpawner*
	}

	namespace n_UFormDlg_Ok_C { // : UUserWidget
		constexpr auto UberGraphFrame = 0x268; // FPointerToUberGraphFrame
		constexpr auto btnOk = 0x270; // UButton*
		constexpr auto lbOk = 0x278; // UTextBlock*
	}
	...
	namespace n_ASFPSAirDropPlane { // : AActor
	...
	namespace n_Aweapon_firearms_snip_mosin_short_C { // : At_FireArm_C
		constexpr auto DeviceLeftMount = 0x7e0; // UStaticMeshComponent*
		constexpr auto ShellMagazine = 0x7e8; // UStaticMeshComponent*
		constexpr auto ShellBarrelEmpty = 0x7f0; // UStaticMeshComponent*
		constexpr auto ShellBarrelFull = 0x7f8; // UStaticMeshComponent*
	...
	namespace n_Aweapmf_DTK_762x39_01_C { // : At_MuzzleAttachement_C
		constexpr auto Muzzle = 0x390; // USceneComponent*
	}
	...
	namespace n_USFPSAnimEvent_Weap_ReloadingFlag { // : UAnimNotify
	...
	namespace n_USFPSACTripwireTrap { // : UActorComponent
	...
	namespace n_USFPSCreatePlayerHandler { // : UObject
	...
	namespace n_USFPSMessageHandler { // : UObject
	...
	namespace n_Aweapmf_DTK_762x25_01_C { // : At_MuzzleAttachement_C
		constexpr auto Muzzle = 0x390; // USceneComponent*
	}
	...
	namespace n_ABP_SFPSAIController_C { // : ASFPSAIController
		constexpr auto HomeLocation = 0x3d8; // FName
		constexpr auto State = 0x3e0; // FName
	}

	namespace n_ASFPSWheeledVehicle { // : ADcxVehicle4W
	...
	namespace n_ASFPSLootSpawner { // : ASFPSBaseLootSpawner
	...
	namespace n_Aweapon_steelarms_knife_01_C { // : At_SteelArm_C
		constexpr auto DamagePoint2 = 0x620; // USceneComponent*
		constexpr auto DamagePoint1 = 0x628; // USceneComponent*
		constexpr auto DamagePoint0 = 0x630; // USceneComponent*
	}
	...
	namespace n_UABP_weapon_firearms_gun_PM_C { // : USFPSWeaponAnimInstance_Gun
		constexpr auto UberGraphFrame = 0x2e0; // FPointerToUberGraphFrame
		constexpr auto AnimGraphNode_Root = 0x2e8; // FAnimNode_Root
		constexpr auto AnimGraphNode_Slot = 0x318; // FAnimNode_Slot
		constexpr auto AnimGraphNode_TransitionResult_6 = 0x360; // FAnimNode_TransitionResult
	...
	namespace n_Aweapon_firearms_snip_barrettm99_C { // : At_FireArm_C
	...
	namespace n_UABP_weapon_firearms_rifle_m4a1_C { // : USFPSWeaponAnimInstance_AR
		constexpr auto UberGraphFrame = 0x2e0; // FPointerToUberGraphFrame
		constexpr auto AnimGraphNode_Root = 0x2e8; // FAnimNode_Root
		constexpr auto AnimGraphNode_Slot = 0x318; // FAnimNode_Slot
		constexpr auto AnimGraphNode_TransitionResult_2 = 0x360; // FAnimNode_TransitionResult
	...
	namespace n_UABP_weapon_firearms_sg_mp133_C { // : USFPSWeaponAnimInstance_SG
		constexpr auto UberGraphFrame = 0x310; // FPointerToUberGraphFrame
		constexpr auto AnimGraphNode_Root = 0x318; // FAnimNode_Root
		constexpr auto AnimGraphNode_SequencePlayer = 0x348; // FAnimNode_SequencePlayer
		constexpr auto AnimGraphNode_Slot = 0x3c8; // FAnimNode_Slot
	...
	namespace n_AM_TripwireTrap_01_C { // : At_LocationCraftActor_C
		constexpr auto Interaction = 0x358; // UBoxComponent*
		constexpr auto GrenadeCollision = 0x360; // UBoxComponent*
		constexpr auto ExplosionCollision = 0x368; // UBoxComponent*
		constexpr auto ACTripwireTrap = 0x370; // USFPSACTripwireTrap*
	...
	namespace n_UABP_weapon_firearms_snip_mosin_C { // : USFPSWeaponAnimInstance_SR
		constexpr auto UberGraphFrame = 0x300; // FPointerToUberGraphFrame
		constexpr auto AnimGraphNode_Root = 0x308; // FAnimNode_Root
	...
	namespace n_UABP_weapon_firearms_snip_barrettm99_C { // : USFPSWeaponAnimInstance_SR
		constexpr auto UberGraphFrame = 0x300; // FPointerToUberGraphFrame
		constexpr auto AnimGraphNode_Root = 0x308; // FAnimNode_Root
		constexpr auto AnimGraphNode_SequencePlayer = 0x338; // FAnimNode_SequencePlayer
		constexpr auto AnimGraphNode_Slot = 0x3b8; // FAnimNode_Slot
	...
	namespace n_Aweapon_firearms_rifle_akm_C { // : At_FireArm_C
		constexpr auto DeviceLeftMount = 0x7e0; // UStaticMeshComponent*
	...
	namespace n_ASFPSProjectile { // : AActor
	...
	namespace n_UfrmHUDChatBox_C { // : USFPSUserWidget_HUDChatBox
	...
	namespace n_Aweapon_firearms_gun_M9_C { // : At_FireArm_C
		constexpr auto DeviceLeftMount = 0x7e0; // UStaticMeshComponent*
		constexpr auto SFPSACWeaponMFInventory = 0x7e8; // USFPSACWeaponMFInventory*
		constexpr auto MagazineFull = 0x7f0; // UStaticMeshComponent*
		constexpr auto MagazineEmpty = 0x7f8; // UStaticMeshComponent*
	...
	namespace n_USFPSAI_TSwitchState { // : UBTTaskNode
	...
	namespace n_At_LocationCraftActor_C { // : ASFPSBaseLocationCraftItem
		constexpr auto Mesh = 0x350; // UStaticMeshComponent*
	}

	namespace n_Aweapon_firearms_rifle_m4a1_C { // : At_FireArm_C
		constexpr auto DTK = 0x7e0; // UStaticMeshComponent*
		constexpr auto DeviceLeftMount = 0x7e8; // UStaticMeshComponent*
		constexpr auto SightClose = 0x7f0; // UStaticMeshComponent*
		constexpr auto SightOpen = 0x7f8; // UStaticMeshComponent*
	...
	namespace n_Amat_wood_logs_01_C { // : At_Material_C
	...
	namespace n_UModulatorOuterParams { // : UObject
		constexpr auto ValueMin = 0x28; // float
		constexpr auto ValueMax = 0x2c; // float
	}

	namespace n_ASFPSShell { // : AActor
	...
	namespace n_Arecoveryitem_medikit_painkillers_C { // : At_RecoveryItem_C
		constexpr auto Timer = 0x420; // float
	}
	...
	namespace n_USFPSAnimEvent_Weap_SRReloadFlag { // : UAnimNotify
	...
	namespace n_At_RecoveryItem_C { // : ASFPSRecoveryItem
		constexpr auto Trace = 0x410; // UBoxComponent*
		constexpr auto Mesh = 0x418; // UStaticMeshComponent*
	}

	namespace n_UFormDlg_Timer_C { // : UUserWidget
		constexpr auto UberGraphFrame = 0x268; // FPointerToUberGraphFrame
		constexpr auto btnCancel = 0x270; // UButton*
		constexpr auto imgProrgess = 0x278; // UImage*
		constexpr auto Progress = 0x280; // UMaterialInstanceDynamic*
	...
	namespace n_ABM_FloorTria_01_C { // : At_LocationCraftActor_C
		constexpr auto SFPSACBaseCollision = 0x358; // USFPSACBaseCollision*
		constexpr auto SFPSACSnap = 0x360; // USFPSACSnapComponent*
	}
	...
	namespace n_Ascope_opt_pso_C { // : At_Sight_C
		constexpr auto cod_4x_reticles = 0x3d0; // UStaticMeshComponent*
	}
	...
	namespace n_USFPSBaseHandler { // : UObject
	...
	namespace n_Aweapon_firearms_mg_mg36_C { // : At_FireArm_C
		constexpr auto DTK = 0x7e0; // UStaticMeshComponent*
	...
	namespace n_ASFPSCharacter { // : ASFPSBaseCharacter
		...
		constexpr auto Steamcoins = 0xdb4; // int32_t
		constexpr auto BaseCenter = 0xdc0; // FVector
	...
	namespace n_ABM_WallBig_lock_01_C { // : ABM_WallBig_01_C
		constexpr auto Base_lock_02 = 0x388; // UStaticMeshComponent*
		constexpr auto Base_lock_01 = 0x390; // UStaticMeshComponent*
	}
	...
	namespace n_USFPSTradeList { // : UObject
	...
	namespace n_ABM_WallDoor_01_C { // : At_LocationCraftActor_C
		constexpr auto SFPSACBaseCollision = 0x358; // USFPSACBaseCollision*
	...
	namespace n_Aweapon_steelarms_axe_01_C { // : At_SteelArm_C
		constexpr auto DamagePoint2 = 0x620; // USceneComponent*
		constexpr auto DamagePoint1 = 0x628; // USceneComponent*
		constexpr auto DamagePoint0 = 0x630; // USceneComponent*
	}
	...
	namespace n_At_SteelArm_C { // : ASFPSSteelArms
	...
	namespace n_USFPSACZoneManager { // : UActorComponent
	...
	namespace n_ARespawnActor_C { // : AActor
	...
	namespace n_AM_Stash_01_C { // : ASFPSLootBox
	...
	namespace n_USFPSUserWidget_AdminPanel_Player { // : UUserWidget
		constexpr auto OnSelectEvent = 0x2a8; // FDelegate
	}

	namespace n_USoundNodeCrossfadeShootByDistanceOuterParam { // : USoundNode
	...
	namespace n_ASFPSAICharacter { // : ASFPSBaseCharacter
	...
	namespace n_UfrmGroundItem_C { // : USFPSUserWidget_GroundItem
		constexpr auto UberGraphFrame = 0x288; // FPointerToUberGraphFrame
		constexpr auto btnItem0 = 0x290; // UButton*
		constexpr auto btnItem1 = 0x298; // UButton*
		constexpr auto btnItem2 = 0x2a0; // UButton*
	}
	...
	namespace n_ABMF_RespawnMarker_C { // : At_LocationCraftActor_C
		constexpr auto SFPSACBaseCollision = 0x358; // USFPSACBaseCollision*
	}
	...
	namespace n_USFPSPatrolManager { // : UObject
	...
	namespace n_ASFPSDeviceItem { // : ASFPSHandheldItem
	...
	namespace n_UServerList_C { // : UUserWidget
		constexpr auto btnBack = 0x268; // UButton*
		constexpr auto btnBuyServer = 0x270; // UButton*
		constexpr auto btnIP = 0x278; // UButton*
		constexpr auto btnJoin = 0x280; // UButton*
		constexpr auto btnRefresh = 0x288; // UButton*
		constexpr auto frmServerListItem = 0x290; // UfrmServerListItem_C*
		constexpr auto spGPortal = 0x298; // UImage*
		constexpr auto spVivox = 0x2a0; // UImage*
	}
	...
	namespace n_USFPSGameInstance { // : UGameInstance
		...
		constexpr auto FormMainMenu = 0x640; // UUserWidget*
		constexpr auto FormLoadingScreen = 0x648; // UUserWidget*
		constexpr auto KickMSGList = 0x6a8; // TArray<FText>
		constexpr auto bIsClientKick = 0x6b8; // bool
		constexpr auto BeaconHost = 0x6c0; // ASFPSOnlineBeaconHost*
		constexpr auto BeaconHostObject = 0x6c8; // ASFPSOnlineBeaconHostObject*
		constexpr auto InventoryHandler = 0x6d0; // USFPSInventoryHandler*
		constexpr auto MessageHandler = 0x6d8; // USFPSMessageHandler*
		constexpr auto FontHandler = 0x6e0; // USFPSFontHandler*
		constexpr auto UseObjectHandler = 0x6e8; // USFPSUseObjectHandler*
		constexpr auto SplitHandler = 0x6f0; // USFPSSplitHandler*
		constexpr auto MainInterfaceHandler = 0x6f8; // USFPSMainInterfaceHandler*
		constexpr auto SettingsHandler = 0x700; // USFPSSettingsHandler*
		constexpr auto LockBreakingHandler = 0x708; // USFPSLockBreakingHandler*
		constexpr auto DebrisHandler = 0x710; // USFPSDebrisHandler*
		constexpr auto MapHandler = 0x718; // USFPSMapHandler*
		constexpr auto CraftEditor = 0x720; // USFPSCraftEditor*
		constexpr auto SoundHandler = 0x728; // USFPSSoundHandler*
		constexpr auto ServerListHandler = 0x730; // USFPSServerListHandler*
		constexpr auto ChatHandler = 0x738; // USFPSChatHandler*
		constexpr auto CreatePlayerHandler = 0x740; // USFPSCreatePlayerHandler*
		constexpr auto AdminHandler = 0x748; // USFPSAdminHandler*
		constexpr auto BaseHandler = 0x750; // USFPSBaseHandler*
		constexpr auto b_dbg_BallisticsTracesEnabled = 0x758; // bool
		constexpr auto b_dbg_CraftDebugEnabled = 0x759; // bool
		constexpr auto ParametersCollection = 0x760; // UMaterialParameterCollection*
		constexpr auto BaseSphere = 0x768; // AActor*
		constexpr auto UISounds = 0x8b8; // USFPSUISoundTable*
		constexpr auto MusicAudioComponent = 0x8c0; // UAudioComponent*
		constexpr auto AfterDeathActorClass = 0x8c8; // UObject*
	}
	...
	namespace n_USFPSHiddenStashManager { // : UObject
	...
	namespace n_UfrmItemHint_C { // : UUserWidget
		constexpr auto imgBackgroun1 = 0x268; // UImage*
		constexpr auto imgBackgroun2 = 0x270; // UImage*
		constexpr auto imgBackgroun3 = 0x278; // UImage*
		constexpr auto imgBackgroun4 = 0x280; // UImage*
	...
	namespace n_Aweapmf_DTK_9x19_01_C { // : At_MuzzleAttachement_C
		constexpr auto Muzzle = 0x390; // USceneComponent*
	}
	...
	namespace n_ASFPSWeapon { // : ASFPSHandheldItem
	...
	namespace n_USFPSACLootBoxInventory { // : UActorComponent
	...
	namespace n_UFormDlg_InputCode_C { // : USFPSUserWidget_CodeInputBox
		constexpr auto UberGraphFrame = 0x3b0; // FPointerToUberGraphFrame
		constexpr auto btn0 = 0x3b8; // UButton*
		constexpr auto btn1 = 0x3c0; // UButton*
		constexpr auto btn2 = 0x3c8; // UButton*
		constexpr auto btn3 = 0x3d0; // UButton*
		constexpr auto btn4 = 0x3d8; // UButton*
		constexpr auto btn5 = 0x3e0; // UButton*
		constexpr auto btn6 = 0x3e8; // UButton*
		constexpr auto btn7 = 0x3f0; // UButton*
		constexpr auto btn8 = 0x3f8; // UButton*
		constexpr auto btn9 = 0x400; // UButton*
		constexpr auto btnB = 0x408; // UButton*
		constexpr auto btnE = 0x410; // UButton*
	}
	...
	namespace n_UDcxVehicleNoDriveComponent { // : UDcxVehicleWheelsComponent
	...
	namespace n_ASFPSGreenArea { // : AActor
	...
	namespace n_At_FireArm_C { // : ASFPSSmallArms
		constexpr auto Trace = 0x7d0; // UBoxComponent*
		constexpr auto Mesh = 0x7d8; // USkeletalMeshComponent*
	}

	namespace n_ASFPSProjectileGrenade { // : ASFPSBaseGrenade
	...
	namespace n_USFPSAI_TClearTargetAndFocus { // : UBTTaskNode
	...
	namespace n_ASFPSWearableItem { // : ASFPSBaseItem
	...
	namespace n_Aweapmf_DTK_762x39_03_C { // : At_MuzzleAttachement_C
		constexpr auto Muzzle = 0x390; // USceneComponent*
	}

	namespace n_ABMF_Tower_01_C { // : At_LocationCraftActor_C
	...
	namespace n_USFPSUserWidget_ChatBox { // : UUserWidget
		constexpr auto Font = 0x2a8; // FSlateFontInfo
		constexpr auto ViewportScale = 0x300; // float
		constexpr auto bUseCustomPanel = 0x304; // bool
	}
	...
	namespace n_ASFPSGameMode { // : AGameMode
	...
	namespace n_UFormDead_C { // : UUserWidget
		constexpr auto imgBlackBackground = 0x268; // UImage*
	}
	...
	namespace n_Aweapon_firearms_mg_rpk_C { // : At_FireArm_C
		constexpr auto DeviceLeftMount = 0x7e0; // UStaticMeshComponent*
		constexpr auto SideBracket_base = 0x7e8; // UStaticMeshComponent*
		constexpr auto SightClose = 0x7f0; // UStaticMeshComponent*
		constexpr auto SFPSACWeaponMFInventory = 0x7f8; // USFPSACWeaponMFInventory*
	...
	namespace n_USimpleFTPClientBPLibrary { // : UBlueprintFunctionLibrary
	...
	namespace n_UDcxVehicleWheelsRawInput { // : UObject
	...
	namespace n_UABP_weapon_firearms_sg_mp43_C { // : USFPSWeaponAnimInstance_SG
		constexpr auto UberGraphFrame = 0x310; // FPointerToUberGraphFrame
		constexpr auto AnimGraphNode_Root = 0x318; // FAnimNode_Root
		constexpr auto AnimGraphNode_SequencePlayer = 0x348; // FAnimNode_SequencePlayer
		constexpr auto AnimGraphNode_Slot = 0x3c8; // FAnimNode_Slot
	...
	namespace n_USFPSACSnapComponent { // : USphereComponent
	...
	namespace n_USFPSUserWidget_AdminPanel_DeathL { // : UUserWidget
		constexpr auto OnSelectEvent = 0x2d8; // FDelegate
	}
	...
	namespace n_ASFPSBaseGrenade { // : ASFPSBaseMissileProjectile
	...
	namespace n_At_CraftKit_C { // : ASFPSBaseItem
		constexpr auto Trace = 0x310; // UBoxComponent*
	...
	namespace n_AShell_SR1_C { // : ASFPSShell
		constexpr auto Mesh = 0x250; // UStaticMeshComponent*
	}
	...
	namespace n_Aweapmf_DTK_545x39_01_C { // : At_MuzzleAttachement_C
		constexpr auto Muzzle = 0x390; // USceneComponent*
	}
